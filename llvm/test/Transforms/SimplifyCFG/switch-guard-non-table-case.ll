...
; RUN: opt < %s -passes='simplifycfg<switch-to-lookup>' -S \
; RUN:   -simplifycfg-guard-non-table-case=false \
; RUN:   -simplifycfg-require-and-preserve-domtree=1 \
...
;.
; CHECK: @switch.table.guard_odd_case = private unnamed_addr constant [6 x i8] c"\0A\00\0C\0D\0E\0F", align 8
; CHECK: @switch.table.guard_keeps_profile = private unnamed_addr constant [6 x i8] c"\0A\00\0C\0D\0E\0F", align 8
; CHECK: @switch.table.guarded_slot_is_not_a_hole = private unnamed_addr constant [8 x i8] c"\0A\0B\0C\0A\0E\0F\10\11", align 8
...
; CHECK: @switch.table.two_hot_odd_cases = private unnamed_addr constant [7 x i8] c"\0A\0A\0C\0A\0E\0F\10", align 8
;.
