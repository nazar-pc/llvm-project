...
; AVX-NEXT:    vunpckhps {{.*#+}} xmm4 = xmm2[2],xmm3[2],xmm2[3],xmm3[3]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm6[1,2,3],ymm0[4],ymm6[5,6,7]
; AVX-NEXT:    vshufps {{.*#+}} xmm2 = xmm2[3,3],xmm3[3,3]
; AVX-NEXT:    vinsertps {{.*#+}} xmm1 = xmm1[3],xmm2[1,2,3]
...
; AVX-NEXT:    vunpcklps {{.*#+}} xmm13 = xmm11[0],xmm9[0],xmm11[1],xmm9[1]
; AVX-NEXT:    vinsertf128 $1, %xmm11, %ymm13, %ymm13
; AVX-NEXT:    vmovddup {{.*#+}} ymm13 = ymm13[0,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm4 = ymm4[0,1],ymm13[2,3],ymm4[4,5,6],ymm13[7]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm13 = mem[0,1,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm4 = ymm4[0,1,2,3],ymm13[4],ymm4[5,6,7]
; AVX-NEXT:    vunpckhps {{.*#+}} xmm11 = xmm11[2],xmm9[2],xmm11[3],xmm9[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm9 = xmm9[1,1,1,1]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm5 = ymm9[0,1],ymm5[2,3],ymm9[4,5],ymm5[6,7]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm6 = ymm7[0],ymm6[1,2,3,4],ymm7[5],ymm6[6,7]
; AVX-NEXT:    vshufps {{.*#+}} xmm8 = xmm12[3,3],xmm10[3,3]
; AVX-NEXT:    vunpckhps {{.*#+}} xmm9 = xmm12[2],xmm10[2],xmm12[3],xmm10[3]
; AVX-NEXT:    vinsertf128 $1, %xmm8, %ymm9, %ymm8
; AVX-NEXT:    vshufps {{.*#+}} ymm9 = ymm2[3,3],ymm0[3,3],ymm2[7,7],ymm0[7,7]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm9 = ymm9[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1,2],ymm9[3,4],ymm8[5,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm7 = ymm8[0,1],ymm7[2],ymm8[3,4,5,6],ymm7[7]
...
; SSE-NEXT:    shufps {{.*#+}} xmm12 = xmm12[1,1],xmm8[1,1]
; SSE-NEXT:    shufps {{.*#+}} xmm12 = xmm12[0,2],xmm0[0,1]
; SSE-NEXT:    movdqa %xmm3, %xmm0
; SSE-NEXT:    shufps {{.*#+}} xmm0 = xmm0[3,0],xmm8[2,0]
...
; SSE-NEXT:    punpckldq {{.*#+}} xmm1 = xmm1[0],xmm0[0],xmm1[1],xmm0[1]
; SSE-NEXT:    punpcklqdq {{.*#+}} xmm1 = xmm1[0],xmm8[0]
...
; SSE-NEXT:    shufps {{.*#+}} xmm4 = xmm4[0,2],xmm8[0,1]
; SSE-NEXT:    movdqa %xmm2, %xmm8
; SSE-NEXT:    shufps {{.*#+}} xmm8 = xmm8[3,1],xmm0[2,3]
; SSE-NEXT:    punpckhqdq {{.*#+}} xmm5 = xmm5[1],xmm10[1]
; SSE-NEXT:    shufps {{.*#+}} xmm5 = xmm5[2,0],xmm8[2,0]
...
; SSE-NEXT:    shufps {{.*#+}} xmm13 = xmm13[0,1],xmm8[2,0]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm8 # 16-byte Reload
; SSE-NEXT:    movss {{.*#+}} xmm13 = xmm8[0],xmm13[1,2,3]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm8 # 16-byte Reload
; SSE-NEXT:    shufps $85, {{[-0-9]+}}(%r{{[sb]}}p), %xmm8 # 16-byte Folded Reload
; SSE-NEXT:    # xmm8 = xmm8[1,1],mem[1,1]
; SSE-NEXT:    shufps {{.*#+}} xmm7 = xmm7[0,1],xmm8[2,0]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm8 # 16-byte Reload
; SSE-NEXT:    movss {{.*#+}} xmm7 = xmm8[0],xmm7[1,2,3]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm8 # 16-byte Reload
; SSE-NEXT:    shufps $85, {{[-0-9]+}}(%r{{[sb]}}p), %xmm8 # 16-byte Folded Reload
; SSE-NEXT:    # xmm8 = xmm8[1,1],mem[1,1]
; SSE-NEXT:    shufps {{.*#+}} xmm3 = xmm3[0,1],xmm8[2,0]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm8 # 16-byte Reload
; SSE-NEXT:    movss {{.*#+}} xmm3 = xmm8[0],xmm3[1,2,3]
; SSE-NEXT:    shufps $85, {{[-0-9]+}}(%r{{[sb]}}p), %xmm10 # 16-byte Folded Reload
; SSE-NEXT:    # xmm10 = xmm10[1,1],mem[1,1]
; SSE-NEXT:    shufps {{.*#+}} xmm2 = xmm2[0,1],xmm10[2,0]
; SSE-NEXT:    movss {{.*#+}} xmm2 = xmm0[0],xmm2[1,2,3]
; SSE-NEXT:    movaps %xmm5, 288(%r9)
...
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovaps 32(%rsi), %ymm4
; AVX-NEXT:    vmovaps 32(%rdx), %ymm1
; AVX-NEXT:    vmovaps 32(%rcx), %ymm3
...
; AVX-NEXT:    vmovaps 32(%rsi), %xmm15
; AVX-NEXT:    vunpcklps {{.*#+}} xmm6 = xmm7[0],xmm6[0],xmm7[1],xmm6[1]
; AVX-NEXT:    vinsertf128 $1, %xmm7, %ymm6, %ymm7
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm0 = mem[0,1,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm5 = ymm10[0],ymm0[1],ymm10[2,3,4,5],ymm0[6],ymm10[7]
; AVX-NEXT:    vmovups %ymm5, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovddup {{.*#+}} ymm7 = ymm7[0,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm7 = ymm13[0,1],ymm7[2,3],ymm13[4,5,6],ymm7[7]
; AVX-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1,2,3],ymm0[4],ymm7[5,6,7]
...
; AVX-NEXT:    vunpcklps {{.*#+}} xmm11 = xmm12[0],xmm11[0],xmm12[1],xmm11[1]
; AVX-NEXT:    vinsertf128 $1, %xmm12, %ymm11, %ymm11
; AVX-NEXT:    vmovddup {{.*#+}} ymm11 = ymm11[0,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm11[2,3],ymm0[4,5,6],ymm11[7]
; AVX-NEXT:    vblendps {{.*#+}} ymm11 = ymm0[0,1,2,3],ymm15[4],ymm0[5,6,7]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],ymm12[3,4],ymm0[5,6,7]
; AVX-NEXT:    vmovaps 48(%rcx), %xmm12
; AVX-NEXT:    vmovaps 48(%rdx), %xmm13
; AVX-NEXT:    vshufps {{.*#+}} xmm14 = xmm13[3,3],xmm12[3,3]
; AVX-NEXT:    vunpckhps {{.*#+}} xmm12 = xmm13[2],xmm12[2],xmm13[3],xmm12[3]
; AVX-NEXT:    vmovaps 16(%rdi), %xmm15
; AVX-NEXT:    vinsertf128 $1, %xmm14, %ymm12, %ymm12
; AVX-NEXT:    vshufps {{.*#+}} ymm13 = ymm4[3,3],ymm2[3,3],ymm4[7,7],ymm2[7,7]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm13 = ymm13[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm13 = ymm12[0,1,2],ymm13[3,4],ymm12[5,6,7]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm14 = mem[0,1,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm12 = ymm14[0],ymm0[1,2,3,4],ymm14[5],ymm0[6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0,1],ymm14[2],ymm13[3,4,5,6],ymm14[7]
; AVX-NEXT:    vshufps {{.*#+}} xmm0 = xmm9[3,3],xmm8[3,3]
...
; AVX-NEXT:    vshufps {{.*#+}} ymm8 = ymm1[3,3],ymm5[3,3],ymm1[7,7],ymm5[7,7]
...
; AVX-NEXT:    vshufps {{.*#+}} ymm15 = ymm9[1,1],ymm14[1,1],ymm9[5,5],ymm14[5,5]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm15 = ymm15[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1,2],ymm15[3,4],ymm8[5,6,7]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm15 = mem[0,1,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm15[2],ymm0[3,4,5,6],ymm15[7]
; AVX-NEXT:    vblendps {{.*#+}} ymm8 = ymm15[0],ymm8[1,2,3,4],ymm15[5],ymm8[6,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm4 = ymm4[3,0,2,3,7,4,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm4[0,1,2,3],ymm2[4],ymm4[5,6,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm4 = ymm3[0,1,3,0,4,5,7,4]
; AVX-NEXT:    vshufpd {{.*#+}} ymm3 = ymm6[1,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1],ymm4[2],ymm3[3,4,5,6],ymm4[7]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0],ymm3[1,2,3],ymm2[4,5],ymm3[6,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm1 = ymm1[3,0,2,3,7,4,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2,3],ymm5[4],ymm1[5,6,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm3 = ymm9[0,1,3,0,4,5,7,4]
; AVX-NEXT:    vshufpd {{.*#+}} ymm4 = ymm14[1,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm4[0,1],ymm3[2],ymm4[3,4,5,6],ymm3[7]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0],ymm3[1,2,3],ymm1[4,5],ymm3[6,7]
...
; AVX-NEXT:    vmovaps %ymm8, 96(%r9)
; AVX-NEXT:    vmovaps %ymm0, 128(%r9)
; AVX-NEXT:    vmovaps %ymm13, 288(%r9)
; AVX-NEXT:    vmovaps %ymm12, 256(%r9)
; AVX-NEXT:    vmovaps %ymm11, 160(%r9)
; AVX-NEXT:    vmovaps %ymm10, 192(%r9)
...
; AVX2-FCP-NEXT:    vunpckhps {{.*#+}} xmm4 = xmm8[2],xmm6[2],xmm8[3],xmm6[3]
...
; AVX2-FCP-NEXT:    vmovaps (%rcx), %xmm13
; AVX2-FCP-NEXT:    vmovaps 32(%rcx), %xmm15
; AVX2-FCP-NEXT:    vshufps {{.*#+}} xmm5 = xmm13[1,1,2,2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} xmm5 = xmm5[0,1],xmm11[2],xmm5[3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm5[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm4 = ymm5[0,1],ymm4[2,3],ymm5[4,5],ymm4[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm0[0,1,2,1]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm4[0],ymm5[1],ymm4[2,3,4,5],ymm5[6],ymm4[7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm5[0],ymm7[1],ymm5[2,3,4,5],ymm7[6],ymm5[7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps 32(%rdx), %ymm7
; AVX2-FCP-NEXT:    vunpcklps {{.*#+}} xmm11 = xmm11[0],xmm13[0],xmm11[1],xmm13[1]
; AVX2-FCP-NEXT:    vpermps %ymm11, %ymm12, %ymm11
; AVX2-FCP-NEXT:    vunpcklps {{.*#+}} xmm6 = xmm8[0],xmm6[0],xmm8[1],xmm6[1]
; AVX2-FCP-NEXT:    vmovaps {{.*#+}} ymm0 = [0,1,3,2,3,2,3,2]
; AVX2-FCP-NEXT:    vpermps %ymm6, %ymm0, %ymm8
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1],ymm11[2,3],ymm8[4,5,6],ymm11[7]
; AVX2-FCP-NEXT:    vmovaps 32(%rcx), %ymm11
; AVX2-FCP-NEXT:    vinsertf128 $1, (%r8), %ymm6, %ymm6
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0],ymm8[1,2,3],ymm6[4],ymm8[5,6,7]
...
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm4 = ymm7[2,3,2,3,6,7,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm4 = ymm4[0],ymm13[1,2],ymm4[3,4],ymm13[5,6],ymm4[7]
...
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm4 = ymm4[0,1,2],ymm13[3,4],ymm4[5,6,7]
; AVX2-FCP-NEXT:    vbroadcastsd 56(%r8), %ymm13
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm13 = ymm4[0,1],ymm13[2],ymm4[3,4,5,6],ymm13[7]
; AVX2-FCP-NEXT:    vunpcklps {{.*#+}} xmm4 = xmm14[0],xmm15[0],xmm14[1],xmm15[1]
; AVX2-FCP-NEXT:    vpermps %ymm4, %ymm12, %ymm4
...
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm4[2,3],ymm0[4,5,6],ymm4[7]
; AVX2-FCP-NEXT:    vinsertf128 $1, 32(%r8), %ymm9, %ymm4
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm9 = ymm4[0],ymm0[1,2,3],ymm4[4],ymm0[5,6,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm0 = ymm10[0,2,3,3,4,6,7,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm4 = ymm12[2,3,2,3,6,7,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm4[0],ymm0[1,2],ymm4[3,4],ymm0[5,6],ymm4[7]
; AVX2-FCP-NEXT:    vmovaps (%rdi), %ymm4
; AVX2-FCP-NEXT:    vmovaps (%rsi), %ymm14
; AVX2-FCP-NEXT:    vunpckhps {{.*#+}} ymm15 = ymm14[2],ymm4[2],ymm14[3],ymm4[3],ymm14[6],ymm4[6],ymm14[7],ymm4[7]
...
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm5 = ymm14[1,1,2,2,5,5,6,6]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0],ymm4[1,2],ymm5[3,4],ymm4[5,6],ymm5[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm5[2,2,2,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0,1,2],ymm15[3,4],ymm5[5,6,7]
; AVX2-FCP-NEXT:    vbroadcastsd 16(%r8), %ymm15
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm5 = ymm15[0],ymm5[1,2,3,4],ymm15[5],ymm5[6,7]
...
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1,2,3],ymm4[4],ymm2[5,6,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm3 = ymm10[0,1,3,0,4,5,7,4]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm4 = ymm12[2,3,0,1,6,7,4,5]
...
; SSE-NEXT:    shufps {{.*#+}} xmm10 = xmm10[1,1],xmm12[1,1]
...
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Reload
; SSE-NEXT:    movaps %xmm1, %xmm0
; SSE-NEXT:    unpcklps {{.*#+}} xmm0 = xmm0[0],xmm15[0],xmm0[1],xmm15[1]
...
; SSE-NEXT:    shufps {{.*#+}} xmm13 = xmm13[1,1],xmm15[1,1]
...
; SSE-NEXT:    movaps %xmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm5 # 16-byte Reload
; SSE-NEXT:    shufps $85, {{[-0-9]+}}(%r{{[sb]}}p), %xmm5 # 16-byte Folded Reload
; SSE-NEXT:    # xmm5 = xmm5[1,1],mem[1,1]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; SSE-NEXT:    shufps {{.*#+}} xmm4 = xmm4[0,1],xmm14[2,0]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movss {{.*#+}} xmm4 = xmm0[0],xmm4[1,2,3]
; SSE-NEXT:    shufps $85, {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Folded Reload
; SSE-NEXT:    # xmm1 = xmm1[1,1],mem[1,1]
; SSE-NEXT:    shufps {{.*#+}} xmm2 = xmm2[0,1],xmm1[2,0]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movss {{.*#+}} xmm2 = xmm0[0],xmm2[1,2,3]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 608(%r9)
; SSE-NEXT:    movaps %xmm13, 592(%r9)
; SSE-NEXT:    movaps %xmm3, 560(%r9)
; SSE-NEXT:    movaps %xmm6, 528(%r9)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 512(%r9)
; SSE-NEXT:    movaps %xmm7, 480(%r9)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 448(%r9)
; SSE-NEXT:    movaps %xmm12, 432(%r9)
; SSE-NEXT:    movaps %xmm11, 400(%r9)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; SSE-NEXT:    movaps %xmm2, 576(%r9)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 544(%r9)
; SSE-NEXT:    movaps %xmm4, 496(%r9)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 464(%r9)
; SSE-NEXT:    movaps %xmm8, 416(%r9)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; AVX-NEXT:    vshufps {{.*#+}} xmm8 = xmm5[1,1],xmm0[1,1]
; AVX-NEXT:    vunpcklps {{.*#+}} xmm9 = xmm5[0],xmm0[0],xmm5[1],xmm0[1]
; AVX-NEXT:    vinsertf128 $1, %xmm8, %ymm9, %ymm8
; AVX-NEXT:    vmovaps (%rcx), %xmm9
...
; AVX-NEXT:    vinsertf128 $1, %xmm11, %ymm13, %ymm13
; AVX-NEXT:    vmovddup {{.*#+}} ymm13 = ymm13[0,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1],ymm13[2,3],ymm8[4,5,6],ymm13[7]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm13 = mem[0,1,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm8[0,1,2,3],ymm13[4],ymm8[5,6,7]
; AVX-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vunpckhps {{.*#+}} xmm8 = xmm11[2],xmm9[2],xmm11[3],xmm9[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm9 = xmm9[1,1,1,1]
; AVX-NEXT:    vinsertf128 $1, %xmm8, %ymm9, %ymm8
; AVX-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[2,2,2,2]
; AVX-NEXT:    vblendps {{.*#+}} xmm0 = xmm5[0,1,2],xmm0[3]
; AVX-NEXT:    vinsertf128 $1, %xmm5, %ymm0, %ymm0
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm8[0,1],ymm0[2,3],ymm8[4,5],ymm0[6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm13[1],ymm0[2,3,4,5],ymm13[6],ymm0[7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufps {{.*#+}} xmm0 = xmm7[1,1],xmm1[1,1]
; AVX-NEXT:    vunpcklps {{.*#+}} xmm5 = xmm7[0],xmm1[0],xmm7[1],xmm1[1]
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm5, %ymm0
; AVX-NEXT:    vunpcklps {{.*#+}} xmm5 = xmm12[0],xmm10[0],xmm12[1],xmm10[1]
; AVX-NEXT:    vinsertf128 $1, %xmm12, %ymm5, %ymm5
; AVX-NEXT:    vmovddup {{.*#+}} ymm5 = ymm5[0,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm5[2,3],ymm0[4,5,6],ymm5[7]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm8 = mem[0,1,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2,3],ymm8[4],ymm0[5,6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm12[2],xmm10[2],xmm12[3],xmm10[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm9 = xmm10[1,1,1,1]
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm9, %ymm0
; AVX-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[2,2,2,2]
; AVX-NEXT:    vblendps {{.*#+}} xmm1 = xmm7[0,1,2],xmm1[3]
; AVX-NEXT:    vinsertf128 $1, %xmm7, %ymm1, %ymm1
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm1[2,3],ymm0[4,5],ymm1[6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm8[1],ymm0[2,3,4,5],ymm8[6],ymm0[7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovaps 64(%rsi), %xmm0
; AVX-NEXT:    vmovaps 64(%rdi), %xmm1
; AVX-NEXT:    vshufps {{.*#+}} xmm8 = xmm1[1,1],xmm0[1,1]
...
; AVX-NEXT:    vinsertf128 $1, %xmm10, %ymm11, %ymm11
; AVX-NEXT:    vmovddup {{.*#+}} ymm11 = ymm11[0,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1],ymm11[2,3],ymm8[4,5,6],ymm11[7]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm11 = mem[0,1,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm8[0,1,2,3],ymm11[4],ymm8[5,6,7]
; AVX-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vunpckhps {{.*#+}} xmm10 = xmm10[2],xmm9[2],xmm10[3],xmm9[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm9 = xmm9[1,1,1,1]
; AVX-NEXT:    vinsertf128 $1, %xmm10, %ymm9, %ymm9
; AVX-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[2,2,2,2]
; AVX-NEXT:    vblendps {{.*#+}} xmm0 = xmm1[0,1,2],xmm0[3]
; AVX-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm0
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm9[0,1],ymm0[2,3],ymm9[4,5],ymm0[6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm11[1],ymm0[2,3,4,5],ymm11[6],ymm0[7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovaps 96(%rsi), %xmm0
; AVX-NEXT:    vmovaps 96(%rdi), %xmm1
; AVX-NEXT:    vshufps {{.*#+}} xmm10 = xmm1[1,1],xmm0[1,1]
; AVX-NEXT:    vunpcklps {{.*#+}} xmm11 = xmm1[0],xmm0[0],xmm1[1],xmm0[1]
...
; AVX-NEXT:    vmovddup {{.*#+}} ymm13 = ymm13[0,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm10 = ymm10[0,1],ymm13[2,3],ymm10[4,5,6],ymm13[7]
; AVX-NEXT:    vmovaps 16(%rsi), %xmm13
; AVX-NEXT:    vunpckhps {{.*#+}} xmm12 = xmm12[2],xmm11[2],xmm12[3],xmm11[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm11 = xmm11[1,1,1,1]
; AVX-NEXT:    vinsertf128 $1, %xmm12, %ymm11, %ymm11
...
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm11[0,1],ymm0[2,3],ymm11[4,5],ymm0[6,7]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm11 = mem[0,1,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm10[0,1,2,3],ymm11[4],ymm10[5,6,7]
; AVX-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm11[1],ymm0[2,3,4,5],ymm11[6],ymm0[7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufps {{.*#+}} xmm0 = xmm13[2,2,2,2]
; AVX-NEXT:    vblendps {{.*#+}} xmm0 = xmm12[0,1,2],xmm0[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm12 = xmm12[1,1],xmm13[1,1]
; AVX-NEXT:    vmovaps 16(%rdx), %xmm13
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm12, %ymm0
; AVX-NEXT:    vshufps {{.*#+}} ymm12 = ymm14[1,1],ymm6[1,1],ymm14[5,5],ymm6[5,5]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm12 = ymm12[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],ymm12[3,4],ymm0[5,6,7]
; AVX-NEXT:    vshufps {{.*#+}} xmm14 = xmm13[3,3],xmm1[3,3]
; AVX-NEXT:    vunpckhps {{.*#+}} xmm1 = xmm13[2],xmm1[2],xmm13[3],xmm1[3]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm13 = mem[0,1,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm13[0],ymm0[1,2,3,4],ymm13[5],ymm0[6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vinsertf128 $1, %xmm14, %ymm1, %ymm0
; AVX-NEXT:    vmovaps %ymm3, %ymm11
; AVX-NEXT:    vshufps {{.*#+}} ymm1 = ymm4[3,3],ymm3[3,3],ymm4[7,7],ymm3[7,7]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm1[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],ymm1[3,4],ymm0[5,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm13[2],ymm0[3,4,5,6],ymm13[7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovaps 48(%rdi), %xmm0
; AVX-NEXT:    vmovaps 48(%rsi), %xmm1
; AVX-NEXT:    vshufps {{.*#+}} xmm14 = xmm1[2,2,2,2]
...
; AVX-NEXT:    vshufps {{.*#+}} ymm15 = ymm9[1,1],ymm0[1,1],ymm9[5,5],ymm0[5,5]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm15 = ymm15[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0,1,2],ymm15[3,4],ymm14[5,6,7]
; AVX-NEXT:    vmovaps 48(%rcx), %xmm15
; AVX-NEXT:    vmovaps 48(%rdx), %xmm0
; AVX-NEXT:    vshufps {{.*#+}} xmm1 = xmm0[3,3],xmm15[3,3]
; AVX-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm0[2],xmm15[2],xmm0[3],xmm15[3]
; AVX-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm0
; AVX-NEXT:    vmovaps 32(%rdi), %ymm6
; AVX-NEXT:    vmovaps 32(%rsi), %ymm15
; AVX-NEXT:    vshufps {{.*#+}} ymm5 = ymm15[3,3],ymm6[3,3],ymm15[7,7],ymm6[7,7]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm5 = ymm5[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],ymm5[3,4],ymm0[5,6,7]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm5 = mem[0,1,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm5[0],ymm14[1,2,3,4],ymm5[5],ymm14[6,7]
; AVX-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm5[2],ymm0[3,4,5,6],ymm5[7]
; AVX-NEXT:    vmovups %ymm0, (%rsp) # 32-byte Spill
; AVX-NEXT:    vmovaps 80(%rdi), %xmm5
; AVX-NEXT:    vmovaps 80(%rsi), %xmm0
; AVX-NEXT:    vshufps {{.*#+}} xmm7 = xmm0[2,2,2,2]
...
; AVX-NEXT:    vmovaps 64(%rcx), %ymm7
; AVX-NEXT:    vshufps {{.*#+}} ymm8 = ymm7[1,1],ymm5[1,1],ymm7[5,5],ymm5[5,5]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm8 = ymm8[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm0[0,1,2],ymm8[3,4],ymm0[5,6,7]
; AVX-NEXT:    vmovaps 80(%rcx), %xmm8
; AVX-NEXT:    vmovaps 80(%rdx), %xmm0
; AVX-NEXT:    vshufps {{.*#+}} xmm1 = xmm0[3,3],xmm8[3,3]
; AVX-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm0[2],xmm8[2],xmm0[3],xmm8[3]
; AVX-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm0
; AVX-NEXT:    vmovaps 64(%rdi), %ymm3
; AVX-NEXT:    vmovaps 64(%rsi), %ymm8
; AVX-NEXT:    vshufps {{.*#+}} ymm10 = ymm8[3,3],ymm3[3,3],ymm8[7,7],ymm3[7,7]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm10 = ymm10[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],ymm10[3,4],ymm0[5,6,7]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm10 = mem[0,1,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm10[0],ymm2[1,2,3,4],ymm10[5],ymm2[6,7]
; AVX-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm10[2],ymm0[3,4,5,6],ymm10[7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovaps 112(%rdi), %xmm10
; AVX-NEXT:    vmovaps 112(%rsi), %xmm0
; AVX-NEXT:    vshufps {{.*#+}} xmm12 = xmm0[2,2,2,2]
; AVX-NEXT:    vblendps {{.*#+}} xmm12 = xmm10[0,1,2],xmm12[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm0 = xmm10[1,1],xmm0[1,1]
; AVX-NEXT:    vinsertf128 $1, %xmm12, %ymm0, %ymm0
; AVX-NEXT:    vmovaps 96(%rdx), %ymm10
; AVX-NEXT:    vmovaps 96(%rcx), %ymm12
; AVX-NEXT:    vshufps {{.*#+}} ymm13 = ymm12[1,1],ymm10[1,1],ymm12[5,5],ymm10[5,5]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm13 = ymm13[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm0[0,1,2],ymm13[3,4],ymm0[5,6,7]
; AVX-NEXT:    vmovaps 112(%rcx), %xmm13
; AVX-NEXT:    vmovaps 112(%rdx), %xmm0
; AVX-NEXT:    vshufps {{.*#+}} xmm1 = xmm0[3,3],xmm13[3,3]
; AVX-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm0[2],xmm13[2],xmm0[3],xmm13[3]
; AVX-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm0
; AVX-NEXT:    vmovaps 96(%rdi), %ymm1
; AVX-NEXT:    vmovaps 96(%rsi), %ymm13
; AVX-NEXT:    vshufps {{.*#+}} ymm14 = ymm13[3,3],ymm1[3,3],ymm13[7,7],ymm1[7,7]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm14 = ymm14[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],ymm14[3,4],ymm0[5,6,7]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm14 = mem[0,1,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm4 = ymm14[0],ymm2[1,2,3,4],ymm14[5],ymm2[6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm0[0,1],ymm14[2],ymm0[3,4,5,6],ymm14[7]
; AVX-NEXT:    vpermilps $227, {{[-0-9]+}}(%r{{[sb]}}p), %ymm14 # 32-byte Folded Reload
; AVX-NEXT:    # ymm14 = mem[3,0,2,3,7,4,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0,1,2,3],ymm11[4],ymm14[5,6,7]
; AVX-NEXT:    vpermilps $52, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Folded Reload
; AVX-NEXT:    # ymm0 = mem[0,1,3,0,4,5,7,4]
; AVX-NEXT:    vpermilpd $1, {{[-0-9]+}}(%r{{[sb]}}p), %ymm11 # 32-byte Folded Reload
; AVX-NEXT:    # ymm11 = mem[1,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm11[0,1],ymm0[2],ymm11[3,4,5,6],ymm0[7]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm14[0],ymm0[1,2,3],ymm14[4,5],ymm0[6,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm11 = ymm15[3,0,2,3,7,4,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm6 = ymm11[0,1,2,3],ymm6[4],ymm11[5,6,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm9 = ymm9[0,1,3,0,4,5,7,4]
; AVX-NEXT:    vpermilpd $1, {{[-0-9]+}}(%r{{[sb]}}p), %ymm11 # 32-byte Folded Reload
; AVX-NEXT:    # ymm11 = mem[1,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm9 = ymm11[0,1],ymm9[2],ymm11[3,4,5,6],ymm9[7]
; AVX-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0],ymm9[1,2,3],ymm6[4,5],ymm9[6,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm8 = ymm8[3,0,2,3,7,4,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm8[0,1,2,3],ymm3[4],ymm8[5,6,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm7 = ymm7[0,1,3,0,4,5,7,4]
; AVX-NEXT:    vshufpd {{.*#+}} ymm5 = ymm5[1,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0,1],ymm7[2],ymm5[3,4,5,6],ymm7[7]
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0],ymm5[1,2,3],ymm3[4,5],ymm5[6,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm5 = ymm13[3,0,2,3,7,4,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm5[0,1,2,3],ymm1[4],ymm5[5,6,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm5 = ymm12[0,1,3,0,4,5,7,4]
; AVX-NEXT:    vshufpd {{.*#+}} ymm7 = ymm10[1,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm5 = ymm7[0,1],ymm5[2],ymm7[3,4,5,6],ymm5[7]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0],ymm5[1,2,3],ymm1[4,5],ymm5[6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],mem[3],ymm0[4,5,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm5 = ymm6[0,1,2],mem[3],ymm6[4,5,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1,2],mem[3],ymm3[4,5,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2],mem[3],ymm1[4,5,6,7]
; AVX-NEXT:    vmovaps %ymm1, 544(%r9)
; AVX-NEXT:    vmovaps %ymm3, 384(%r9)
; AVX-NEXT:    vmovaps %ymm5, 224(%r9)
; AVX-NEXT:    vmovaps %ymm0, 64(%r9)
; AVX-NEXT:    vmovaps %ymm2, 608(%r9)
; AVX-NEXT:    vmovaps %ymm4, 576(%r9)
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX2-NEXT:    vunpcklps {{.*#+}} xmm6 = xmm3[0],xmm1[0],xmm3[1],xmm1[1]
...
; AVX2-NEXT:    vunpcklps {{.*#+}} xmm12 = xmm11[0],xmm7[0],xmm11[1],xmm7[1]
; AVX2-NEXT:    vshufps {{.*#+}} xmm12 = xmm12[0,1,3,2]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm13 = ymm12[0,1,1,1]
; AVX2-NEXT:    vblendps {{.*#+}} ymm6 = ymm13[0,1],ymm6[2,3],ymm13[4,5,6],ymm6[7]
; AVX2-NEXT:    vmovaps 32(%rdi), %xmm13
; AVX2-NEXT:    vinsertf128 $1, (%r8), %ymm12, %ymm12
; AVX2-NEXT:    vblendps {{.*#+}} ymm6 = ymm12[0],ymm6[1,2,3],ymm12[4],ymm6[5,6,7]
; AVX2-NEXT:    vmovups %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovaps 64(%rdi), %xmm6
; AVX2-NEXT:    vunpckhps {{.*#+}} xmm7 = xmm11[2],xmm7[2],xmm11[3],xmm7[3]
; AVX2-NEXT:    vshufps {{.*#+}} xmm7 = xmm7[0,1,2,2]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[0,0,2,1]
; AVX2-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[1,1,2,2]
; AVX2-NEXT:    vblendps {{.*#+}} xmm1 = xmm1[0,1],xmm3[2],xmm1[3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,1,1,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm7[2,3],ymm1[4,5],ymm7[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm3 = ymm15[0,1,2,1]
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0],ymm3[1],ymm1[2,3,4,5],ymm3[6],ymm1[7]
; AVX2-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vunpcklps {{.*#+}} xmm1 = xmm4[0],xmm2[0],xmm4[1],xmm2[1]
; AVX2-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[0,1,2,2]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,0,2,1]
; AVX2-NEXT:    vunpcklps {{.*#+}} xmm3 = xmm13[0],xmm8[0],xmm13[1],xmm8[1]
; AVX2-NEXT:    vshufps {{.*#+}} xmm3 = xmm3[0,1,3,2]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm7 = ymm3[0,1,1,1]
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm7[0,1],ymm1[2,3],ymm7[4,5,6],ymm1[7]
; AVX2-NEXT:    vinsertf128 $1, 32(%r8), %ymm3, %ymm3
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm3[0],ymm1[1,2,3],ymm3[4],ymm1[5,6,7]
; AVX2-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vunpckhps {{.*#+}} xmm1 = xmm13[2],xmm8[2],xmm13[3],xmm8[3]
; AVX2-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[0,1,2,2]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,0,2,1]
; AVX2-NEXT:    vshufps {{.*#+}} xmm2 = xmm2[1,1,2,2]
; AVX2-NEXT:    vblendps {{.*#+}} xmm2 = xmm2[0,1],xmm4[2],xmm2[3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[0,1,1,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm2[0,1],ymm1[2,3],ymm2[4,5],ymm1[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm2 = ymm14[0,1,2,1]
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0],ymm2[1],ymm1[2,3,4,5],ymm2[6],ymm1[7]
; AVX2-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vunpcklps {{.*#+}} xmm1 = xmm5[0],xmm0[0],xmm5[1],xmm0[1]
; AVX2-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[0,1,2,2]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,0,2,1]
; AVX2-NEXT:    vunpcklps {{.*#+}} xmm2 = xmm6[0],xmm10[0],xmm6[1],xmm10[1]
; AVX2-NEXT:    vshufps {{.*#+}} xmm2 = xmm2[0,1,3,2]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm3 = ymm2[0,1,1,1]
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm3[0,1],ymm1[2,3],ymm3[4,5,6],ymm1[7]
; AVX2-NEXT:    vinsertf128 $1, 64(%r8), %ymm2, %ymm2
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm2[0],ymm1[1,2,3],ymm2[4],ymm1[5,6,7]
; AVX2-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vunpckhps {{.*#+}} xmm1 = xmm6[2],xmm10[2],xmm6[3],xmm10[3]
; AVX2-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[0,1,2,2]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,0,2,1]
; AVX2-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[1,1,2,2]
; AVX2-NEXT:    vblendps {{.*#+}} xmm0 = xmm0[0,1],xmm5[2],xmm0[3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,1,1,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm1[2,3],ymm0[4,5],ymm1[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm9[0,1,2,1]
...
; AVX2-NEXT:    vunpckhps {{.*#+}} ymm1 = ymm13[2],ymm6[2],ymm13[3],ymm6[3],ymm13[6],ymm6[6],ymm13[7],ymm6[7]
...
; AVX2-NEXT:    vmovaps 32(%rcx), %ymm11
; AVX2-NEXT:    vshufps {{.*#+}} ymm0 = ymm11[1,1,1,1,5,5,5,5]
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm12[1],ymm0[2,3,4],ymm12[5],ymm0[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm6 = ymm0[2,2,2,2]
; AVX2-NEXT:    vmovaps 32(%rdi), %ymm10
; AVX2-NEXT:    vmovaps 32(%rsi), %ymm9
; AVX2-NEXT:    vshufps {{.*#+}} ymm7 = ymm9[1,1,2,2,5,5,6,6]
; AVX2-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0],ymm10[1,2],ymm7[3,4],ymm10[5,6],ymm7[7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[2,2,2,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm6 = ymm7[0,1,2],ymm6[3,4],ymm7[5,6,7]
; AVX2-NEXT:    vbroadcastsd 48(%r8), %ymm7
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm7[0],ymm6[1,2,3,4],ymm7[5],ymm6[6,7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vshufps {{.*#+}} ymm6 = ymm11[0,2,3,3,4,6,7,7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm7 = ymm12[2,3,2,3,6,7,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm6 = ymm7[0],ymm6[1,2],ymm7[3,4],ymm6[5,6],ymm7[7]
; AVX2-NEXT:    vunpckhps {{.*#+}} ymm7 = ymm9[2],ymm10[2],ymm9[3],ymm10[3],ymm9[6],ymm10[6],ymm9[7],ymm10[7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[3,3,3,3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm6 = ymm6[2,1,3,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0,1,2],ymm7[3,4],ymm6[5,6,7]
; AVX2-NEXT:    vbroadcastsd 56(%r8), %ymm7
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm6[0,1],ymm7[2],ymm6[3,4,5,6],ymm7[7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovaps 64(%rdx), %ymm8
; AVX2-NEXT:    vmovaps 64(%rcx), %ymm5
; AVX2-NEXT:    vshufps {{.*#+}} ymm6 = ymm5[1,1,1,1,5,5,5,5]
; AVX2-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0],ymm8[1],ymm6[2,3,4],ymm8[5],ymm6[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm6 = ymm6[2,2,2,2]
; AVX2-NEXT:    vmovaps 64(%rdi), %ymm4
; AVX2-NEXT:    vmovaps 64(%rsi), %ymm3
; AVX2-NEXT:    vshufps {{.*#+}} ymm15 = ymm3[1,1,2,2,5,5,6,6]
; AVX2-NEXT:    vblendps {{.*#+}} ymm15 = ymm15[0],ymm4[1,2],ymm15[3,4],ymm4[5,6],ymm15[7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm15 = ymm15[2,2,2,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm6 = ymm15[0,1,2],ymm6[3,4],ymm15[5,6,7]
; AVX2-NEXT:    vbroadcastsd 80(%r8), %ymm15
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm15[0],ymm6[1,2,3,4],ymm15[5],ymm6[6,7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vshufps {{.*#+}} ymm15 = ymm5[0,2,3,3,4,6,7,7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm7 = ymm8[2,3,2,3,6,7,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0],ymm15[1,2],ymm7[3,4],ymm15[5,6],ymm7[7]
; AVX2-NEXT:    vunpckhps {{.*#+}} ymm15 = ymm3[2],ymm4[2],ymm3[3],ymm4[3],ymm3[6],ymm4[6],ymm3[7],ymm4[7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm15 = ymm15[3,3,3,3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[2,1,3,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1,2],ymm15[3,4],ymm7[5,6,7]
; AVX2-NEXT:    vbroadcastsd 88(%r8), %ymm15
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm7[0,1],ymm15[2],ymm7[3,4,5,6],ymm15[7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovaps 96(%rdx), %ymm15
; AVX2-NEXT:    vmovaps 96(%rcx), %ymm2
; AVX2-NEXT:    vshufps {{.*#+}} ymm6 = ymm2[1,1,1,1,5,5,5,5]
; AVX2-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0],ymm15[1],ymm6[2,3,4],ymm15[5],ymm6[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm6 = ymm6[2,2,2,2]
; AVX2-NEXT:    vmovaps 96(%rdi), %ymm1
; AVX2-NEXT:    vmovaps 96(%rsi), %ymm0
; AVX2-NEXT:    vshufps {{.*#+}} ymm7 = ymm0[1,1,2,2,5,5,6,6]
; AVX2-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0],ymm1[1,2],ymm7[3,4],ymm1[5,6],ymm7[7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[2,2,2,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm6 = ymm7[0,1,2],ymm6[3,4],ymm7[5,6,7]
; AVX2-NEXT:    vbroadcastsd 112(%r8), %ymm7
; AVX2-NEXT:    vblendps {{.*#+}} ymm6 = ymm7[0],ymm6[1,2,3,4],ymm7[5],ymm6[6,7]
; AVX2-NEXT:    vmovups %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vshufps {{.*#+}} ymm7 = ymm2[0,2,3,3,4,6,7,7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm6 = ymm15[2,3,2,3,6,7,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0],ymm7[1,2],ymm6[3,4],ymm7[5,6],ymm6[7]
; AVX2-NEXT:    vunpckhps {{.*#+}} ymm7 = ymm0[2],ymm1[2],ymm0[3],ymm1[3],ymm0[6],ymm1[6],ymm0[7],ymm1[7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[3,3,3,3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm6 = ymm6[2,1,3,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0,1,2],ymm7[3,4],ymm6[5,6,7]
; AVX2-NEXT:    vbroadcastsd 120(%r8), %ymm7
; AVX2-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0,1],ymm7[2],ymm6[3,4,5,6],ymm7[7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm7 = ymm13[3,0,2,3,7,4,6,7]
; AVX2-NEXT:    vblendps $16, {{[-0-9]+}}(%r{{[sb]}}p), %ymm7, %ymm7 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm7 = ymm7[0,1,2,3],mem[4],ymm7[5,6,7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm13 = ymm14[0,1,3,0,4,5,7,4]
; AVX2-NEXT:    vpermilps $78, (%rsp), %ymm14 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm14 = mem[2,3,0,1,6,7,4,5]
; AVX2-NEXT:    vblendps {{.*#+}} ymm13 = ymm14[0,1],ymm13[2],ymm14[3,4,5,6],ymm13[7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0],ymm13[1,2,3],ymm7[4,5],ymm13[6,7]
...
; AVX2-NEXT:    vshufps {{.*#+}} ymm10 = ymm11[0,1,3,0,4,5,7,4]
; AVX2-NEXT:    vshufps {{.*#+}} ymm11 = ymm12[2,3,0,1,6,7,4,5]
; AVX2-NEXT:    vblendps {{.*#+}} ymm10 = ymm11[0,1],ymm10[2],ymm11[3,4,5,6],ymm10[7]
...
; AVX2-NEXT:    vshufps {{.*#+}} ymm4 = ymm5[0,1,3,0,4,5,7,4]
; AVX2-NEXT:    vshufps {{.*#+}} ymm5 = ymm8[2,3,0,1,6,7,4,5]
; AVX2-NEXT:    vblendps {{.*#+}} ymm4 = ymm5[0,1],ymm4[2],ymm5[3,4,5,6],ymm4[7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0],ymm4[1,2,3],ymm3[4,5],ymm4[6,7]
...
; AVX2-NEXT:    vshufps {{.*#+}} ymm2 = ymm15[2,3,0,1,6,7,4,5]
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm2[0,1],ymm1[2],ymm2[3,4,5,6],ymm1[7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm1[1,2,3],ymm0[4,5],ymm1[6,7]
; AVX2-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm0 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm0 = ymm0[0,1,2],mem[3],ymm0[4,5,6,7]
; AVX2-NEXT:    vmovaps %ymm0, 544(%r9)
; AVX2-NEXT:    vmovaps %ymm3, 384(%r9)
; AVX2-NEXT:    vmovaps %ymm9, 224(%r9)
; AVX2-NEXT:    vmovaps %ymm7, 64(%r9)
; AVX2-NEXT:    vmovaps %ymm6, 608(%r9)
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX2-FP-NEXT:    vmovaps 64(%r8), %ymm9
; AVX2-FP-NEXT:    vmovups %ymm9, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps (%rcx), %xmm1
; AVX2-FP-NEXT:    vmovaps 32(%rcx), %xmm2
; AVX2-FP-NEXT:    vmovaps 64(%rcx), %xmm0
; AVX2-FP-NEXT:    vmovaps (%rdx), %xmm3
; AVX2-FP-NEXT:    vmovaps 32(%rdx), %xmm4
; AVX2-FP-NEXT:    vmovaps 64(%rdx), %xmm5
; AVX2-FP-NEXT:    vunpcklps {{.*#+}} xmm6 = xmm3[0],xmm1[0],xmm3[1],xmm1[1]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm6 = xmm6[0,1,2,2]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm6 = ymm6[0,0,2,1]
; AVX2-FP-NEXT:    vmovaps (%rsi), %xmm7
; AVX2-FP-NEXT:    vmovaps 32(%rsi), %xmm8
; AVX2-FP-NEXT:    vmovaps 64(%rsi), %xmm10
; AVX2-FP-NEXT:    vmovaps (%rdi), %xmm11
; AVX2-FP-NEXT:    vunpcklps {{.*#+}} xmm12 = xmm11[0],xmm7[0],xmm11[1],xmm7[1]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm12 = xmm12[0,1,3,2]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm13 = ymm12[0,1,1,1]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm6 = ymm13[0,1],ymm6[2,3],ymm13[4,5,6],ymm6[7]
; AVX2-FP-NEXT:    vmovaps 32(%rdi), %xmm13
; AVX2-FP-NEXT:    vinsertf128 $1, (%r8), %ymm12, %ymm12
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm6 = ymm12[0],ymm6[1,2,3],ymm12[4],ymm6[5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps 64(%rdi), %xmm6
; AVX2-FP-NEXT:    vunpckhps {{.*#+}} xmm7 = xmm11[2],xmm7[2],xmm11[3],xmm7[3]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm7 = xmm7[0,1,2,2]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[0,0,2,1]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[1,1,2,2]
; AVX2-FP-NEXT:    vblendps {{.*#+}} xmm1 = xmm1[0,1],xmm3[2],xmm1[3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm7[2,3],ymm1[4,5],ymm7[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm3 = ymm15[0,1,2,1]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0],ymm3[1],ymm1[2,3,4,5],ymm3[6],ymm1[7]
; AVX2-FP-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vunpcklps {{.*#+}} xmm1 = xmm4[0],xmm2[0],xmm4[1],xmm2[1]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[0,1,2,2]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,0,2,1]
; AVX2-FP-NEXT:    vunpcklps {{.*#+}} xmm3 = xmm13[0],xmm8[0],xmm13[1],xmm8[1]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm3 = xmm3[0,1,3,2]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm7 = ymm3[0,1,1,1]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm7[0,1],ymm1[2,3],ymm7[4,5,6],ymm1[7]
; AVX2-FP-NEXT:    vinsertf128 $1, 32(%r8), %ymm3, %ymm3
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm3[0],ymm1[1,2,3],ymm3[4],ymm1[5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vunpckhps {{.*#+}} xmm1 = xmm13[2],xmm8[2],xmm13[3],xmm8[3]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[0,1,2,2]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,0,2,1]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm2 = xmm2[1,1,2,2]
; AVX2-FP-NEXT:    vblendps {{.*#+}} xmm2 = xmm2[0,1],xmm4[2],xmm2[3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm2[0,1],ymm1[2,3],ymm2[4,5],ymm1[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm14[0,1,2,1]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0],ymm2[1],ymm1[2,3,4,5],ymm2[6],ymm1[7]
; AVX2-FP-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vunpcklps {{.*#+}} xmm1 = xmm5[0],xmm0[0],xmm5[1],xmm0[1]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[0,1,2,2]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,0,2,1]
; AVX2-FP-NEXT:    vunpcklps {{.*#+}} xmm2 = xmm6[0],xmm10[0],xmm6[1],xmm10[1]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm2 = xmm2[0,1,3,2]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm3 = ymm2[0,1,1,1]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm3[0,1],ymm1[2,3],ymm3[4,5,6],ymm1[7]
; AVX2-FP-NEXT:    vinsertf128 $1, 64(%r8), %ymm2, %ymm2
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm2[0],ymm1[1,2,3],ymm2[4],ymm1[5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vunpckhps {{.*#+}} xmm1 = xmm6[2],xmm10[2],xmm6[3],xmm10[3]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[0,1,2,2]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,0,2,1]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[1,1,2,2]
; AVX2-FP-NEXT:    vblendps {{.*#+}} xmm0 = xmm0[0,1],xmm5[2],xmm0[3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm1[2,3],ymm0[4,5],ymm1[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm9[0,1,2,1]
...
; AVX2-FP-NEXT:    vunpckhps {{.*#+}} ymm1 = ymm13[2],ymm6[2],ymm13[3],ymm6[3],ymm13[6],ymm6[6],ymm13[7],ymm6[7]
...
; AVX2-FP-NEXT:    vmovaps 32(%rcx), %ymm11
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm0 = ymm11[1,1,1,1,5,5,5,5]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm12[1],ymm0[2,3,4],ymm12[5],ymm0[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm6 = ymm0[2,2,2,2]
; AVX2-FP-NEXT:    vmovaps 32(%rdi), %ymm10
; AVX2-FP-NEXT:    vmovaps 32(%rsi), %ymm9
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm7 = ymm9[1,1,2,2,5,5,6,6]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0],ymm10[1,2],ymm7[3,4],ymm10[5,6],ymm7[7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[2,2,2,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm6 = ymm7[0,1,2],ymm6[3,4],ymm7[5,6,7]
; AVX2-FP-NEXT:    vbroadcastsd 48(%r8), %ymm7
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm7[0],ymm6[1,2,3,4],ymm7[5],ymm6[6,7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm6 = ymm11[0,2,3,3,4,6,7,7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm7 = ymm12[2,3,2,3,6,7,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm6 = ymm7[0],ymm6[1,2],ymm7[3,4],ymm6[5,6],ymm7[7]
; AVX2-FP-NEXT:    vunpckhps {{.*#+}} ymm7 = ymm9[2],ymm10[2],ymm9[3],ymm10[3],ymm9[6],ymm10[6],ymm9[7],ymm10[7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[3,3,3,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm6 = ymm6[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0,1,2],ymm7[3,4],ymm6[5,6,7]
; AVX2-FP-NEXT:    vbroadcastsd 56(%r8), %ymm7
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm6[0,1],ymm7[2],ymm6[3,4,5,6],ymm7[7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps 64(%rdx), %ymm8
; AVX2-FP-NEXT:    vmovaps 64(%rcx), %ymm5
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm6 = ymm5[1,1,1,1,5,5,5,5]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0],ymm8[1],ymm6[2,3,4],ymm8[5],ymm6[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm6 = ymm6[2,2,2,2]
; AVX2-FP-NEXT:    vmovaps 64(%rdi), %ymm4
; AVX2-FP-NEXT:    vmovaps 64(%rsi), %ymm3
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm15 = ymm3[1,1,2,2,5,5,6,6]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm15 = ymm15[0],ymm4[1,2],ymm15[3,4],ymm4[5,6],ymm15[7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm15[2,2,2,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm6 = ymm15[0,1,2],ymm6[3,4],ymm15[5,6,7]
; AVX2-FP-NEXT:    vbroadcastsd 80(%r8), %ymm15
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm15[0],ymm6[1,2,3,4],ymm15[5],ymm6[6,7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm15 = ymm5[0,2,3,3,4,6,7,7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm7 = ymm8[2,3,2,3,6,7,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0],ymm15[1,2],ymm7[3,4],ymm15[5,6],ymm7[7]
; AVX2-FP-NEXT:    vunpckhps {{.*#+}} ymm15 = ymm3[2],ymm4[2],ymm3[3],ymm4[3],ymm3[6],ymm4[6],ymm3[7],ymm4[7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm15[3,3,3,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1,2],ymm15[3,4],ymm7[5,6,7]
; AVX2-FP-NEXT:    vbroadcastsd 88(%r8), %ymm15
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm7[0,1],ymm15[2],ymm7[3,4,5,6],ymm15[7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps 96(%rdx), %ymm15
; AVX2-FP-NEXT:    vmovaps 96(%rcx), %ymm2
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm6 = ymm2[1,1,1,1,5,5,5,5]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0],ymm15[1],ymm6[2,3,4],ymm15[5],ymm6[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm6 = ymm6[2,2,2,2]
; AVX2-FP-NEXT:    vmovaps 96(%rdi), %ymm1
; AVX2-FP-NEXT:    vmovaps 96(%rsi), %ymm0
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm7 = ymm0[1,1,2,2,5,5,6,6]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0],ymm1[1,2],ymm7[3,4],ymm1[5,6],ymm7[7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[2,2,2,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm6 = ymm7[0,1,2],ymm6[3,4],ymm7[5,6,7]
; AVX2-FP-NEXT:    vbroadcastsd 112(%r8), %ymm7
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm6 = ymm7[0],ymm6[1,2,3,4],ymm7[5],ymm6[6,7]
; AVX2-FP-NEXT:    vmovups %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm7 = ymm2[0,2,3,3,4,6,7,7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm6 = ymm15[2,3,2,3,6,7,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0],ymm7[1,2],ymm6[3,4],ymm7[5,6],ymm6[7]
; AVX2-FP-NEXT:    vunpckhps {{.*#+}} ymm7 = ymm0[2],ymm1[2],ymm0[3],ymm1[3],ymm0[6],ymm1[6],ymm0[7],ymm1[7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[3,3,3,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm6 = ymm6[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0,1,2],ymm7[3,4],ymm6[5,6,7]
; AVX2-FP-NEXT:    vbroadcastsd 120(%r8), %ymm7
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0,1],ymm7[2],ymm6[3,4,5,6],ymm7[7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm7 = ymm13[3,0,2,3,7,4,6,7]
; AVX2-FP-NEXT:    vblendps $16, {{[-0-9]+}}(%r{{[sb]}}p), %ymm7, %ymm7 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm7 = ymm7[0,1,2,3],mem[4],ymm7[5,6,7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm13 = ymm14[0,1,3,0,4,5,7,4]
; AVX2-FP-NEXT:    vpermilps $78, (%rsp), %ymm14 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm14 = mem[2,3,0,1,6,7,4,5]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm13 = ymm14[0,1],ymm13[2],ymm14[3,4,5,6],ymm13[7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0],ymm13[1,2,3],ymm7[4,5],ymm13[6,7]
...
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm10 = ymm11[0,1,3,0,4,5,7,4]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm11 = ymm12[2,3,0,1,6,7,4,5]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm10 = ymm11[0,1],ymm10[2],ymm11[3,4,5,6],ymm10[7]
...
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm3 = ymm3[3,0,2,3,7,4,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1,2,3],ymm4[4],ymm3[5,6,7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm4 = ymm5[0,1,3,0,4,5,7,4]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm5 = ymm8[2,3,0,1,6,7,4,5]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm4 = ymm5[0,1],ymm4[2],ymm5[3,4,5,6],ymm4[7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0],ymm4[1,2,3],ymm3[4,5],ymm4[6,7]
...
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm2 = ymm15[2,3,0,1,6,7,4,5]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm2[0,1],ymm1[2],ymm2[3,4,5,6],ymm1[7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm1[1,2,3],ymm0[4,5],ymm1[6,7]
; AVX2-FP-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm0 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm0 = ymm0[0,1,2],mem[3],ymm0[4,5,6,7]
; AVX2-FP-NEXT:    vmovaps %ymm0, 544(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm3, 384(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm9, 224(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm7, 64(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm6, 608(%r9)
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1],ymm0[2,3],ymm1[4,5],ymm0[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm9[0,1,2,1]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm1[1],ymm0[2,3,4,5],ymm1[6],ymm0[7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm14[2],xmm11[2],xmm14[3],xmm11[3]
; AVX2-FCP-NEXT:    vpermps %ymm0, %ymm13, %ymm10
...
; AVX2-FCP-NEXT:    vmovaps 64(%r8), %ymm9
; AVX2-FCP-NEXT:    vmovups %ymm9, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm11 = ymm9[0,1,2,1]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm9 = ymm10[0],ymm11[1],ymm10[2,3,4,5],ymm11[6],ymm10[7]
; AVX2-FCP-NEXT:    vmovups %ymm9, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps 96(%rsi), %xmm9
...
; AVX2-FCP-NEXT:    vunpckhps {{.*#+}} xmm10 = xmm10[2],xmm9[2],xmm10[3],xmm9[3]
; AVX2-FCP-NEXT:    vpermps %ymm10, %ymm13, %ymm14
; AVX2-FCP-NEXT:    vmovaps 96(%rdx), %xmm9
; AVX2-FCP-NEXT:    vmovaps %xmm9, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FCP-NEXT:    vmovaps 96(%rcx), %xmm10
; AVX2-FCP-NEXT:    vshufps {{.*#+}} xmm15 = xmm10[1,1,2,2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} xmm15 = xmm15[0,1],xmm9[2],xmm15[3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm15[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm14 = ymm15[0,1],ymm14[2,3],ymm15[4,5],ymm14[6,7]
; AVX2-FCP-NEXT:    vmovaps 96(%r8), %ymm9
; AVX2-FCP-NEXT:    vmovups %ymm9, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm9[0,1,2,1]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm9 = ymm14[0],ymm15[1],ymm14[2,3,4,5],ymm15[6],ymm14[7]
; AVX2-FCP-NEXT:    vmovups %ymm9, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vunpcklps {{.*#+}} xmm8 = xmm8[0],xmm12[0],xmm8[1],xmm12[1]
; AVX2-FCP-NEXT:    vunpcklps {{.*#+}} xmm6 = xmm7[0],xmm6[0],xmm7[1],xmm6[1]
; AVX2-FCP-NEXT:    vpermps %ymm8, %ymm13, %ymm7
; AVX2-FCP-NEXT:    vmovaps {{.*#+}} ymm14 = [0,1,3,2,3,2,3,2]
; AVX2-FCP-NEXT:    vpermps %ymm6, %ymm14, %ymm8
...
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm12 = ymm6[2,2,2,2]
; AVX2-FCP-NEXT:    vmovaps (%rdi), %ymm11
; AVX2-FCP-NEXT:    vmovups %ymm11, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps (%rsi), %ymm9
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm15 = ymm9[1,1,2,2,5,5,6,6]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm15 = ymm15[0],ymm11[1,2],ymm15[3,4],ymm11[5,6],ymm15[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm15[2,2,2,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm12 = ymm15[0,1,2],ymm12[3,4],ymm15[5,6,7]
; AVX2-FCP-NEXT:    vbroadcastsd 16(%r8), %ymm15
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm6 = ymm15[0],ymm12[1,2,3,4],ymm15[5],ymm12[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm12 = ymm8[0,2,3,3,4,6,7,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm15 = ymm7[2,3,2,3,6,7,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm12 = ymm15[0],ymm12[1,2],ymm15[3,4],ymm12[5,6],ymm15[7]
; AVX2-FCP-NEXT:    vunpckhps {{.*#+}} ymm15 = ymm9[2],ymm11[2],ymm9[3],ymm11[3],ymm9[6],ymm11[6],ymm9[7],ymm11[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm15[3,3,3,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm12 = ymm12[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0,1,2],ymm15[3,4],ymm12[5,6,7]
; AVX2-FCP-NEXT:    vbroadcastsd 24(%r8), %ymm15
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm6 = ymm12[0,1],ymm15[2],ymm12[3,4,5,6],ymm15[7]
; AVX2-FCP-NEXT:    vmovups %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FCP-NEXT:    vpermps %ymm3, %ymm14, %ymm4
...
; AVX2-FCP-NEXT:    vmovaps 32(%rdx), %ymm8
; AVX2-FCP-NEXT:    vmovaps 32(%rcx), %ymm7
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm2 = ymm7[1,1,1,1,5,5,5,5]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0],ymm8[1],ymm2[2,3,4],ymm8[5],ymm2[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm12 = ymm2[2,2,2,2]
; AVX2-FCP-NEXT:    vmovaps 32(%rdi), %ymm6
; AVX2-FCP-NEXT:    vmovaps 32(%rsi), %ymm5
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm15 = ymm5[1,1,2,2,5,5,6,6]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm15 = ymm15[0],ymm6[1,2],ymm15[3,4],ymm6[5,6],ymm15[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm15[2,2,2,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm12 = ymm15[0,1,2],ymm12[3,4],ymm15[5,6,7]
; AVX2-FCP-NEXT:    vbroadcastsd 48(%r8), %ymm15
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm15[0],ymm12[1,2,3,4],ymm15[5],ymm12[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm12 = ymm7[0,2,3,3,4,6,7,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm15 = ymm8[2,3,2,3,6,7,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm12 = ymm15[0],ymm12[1,2],ymm15[3,4],ymm12[5,6],ymm15[7]
; AVX2-FCP-NEXT:    vunpckhps {{.*#+}} ymm15 = ymm5[2],ymm6[2],ymm5[3],ymm6[3],ymm5[6],ymm6[6],ymm5[7],ymm6[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm15[3,3,3,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm12 = ymm12[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0,1,2],ymm15[3,4],ymm12[5,6,7]
; AVX2-FCP-NEXT:    vbroadcastsd 56(%r8), %ymm15
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm12[0,1],ymm15[2],ymm12[3,4,5,6],ymm15[7]
; AVX2-FCP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FCP-NEXT:    vpermps %ymm0, %ymm13, %ymm0
; AVX2-FCP-NEXT:    vpermps %ymm1, %ymm14, %ymm12
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm12[0,1],ymm0[2,3],ymm12[4,5,6],ymm0[7]
; AVX2-FCP-NEXT:    vinsertf128 $1, 64(%r8), %ymm1, %ymm1
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0],ymm0[1,2,3],ymm1[4],ymm0[5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps 64(%rdx), %ymm4
; AVX2-FCP-NEXT:    vmovaps 64(%rcx), %ymm3
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm12 = ymm3[1,1,1,1,5,5,5,5]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0],ymm4[1],ymm12[2,3,4],ymm4[5],ymm12[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm12 = ymm12[2,2,2,2]
; AVX2-FCP-NEXT:    vmovaps 64(%rdi), %ymm15
; AVX2-FCP-NEXT:    vmovaps 64(%rsi), %ymm2
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm11 = ymm2[1,1,2,2,5,5,6,6]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0],ymm15[1,2],ymm11[3,4],ymm15[5,6],ymm11[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm11 = ymm11[2,2,2,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0,1,2],ymm12[3,4],ymm11[5,6,7]
; AVX2-FCP-NEXT:    vbroadcastsd 80(%r8), %ymm12
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm12[0],ymm11[1,2,3,4],ymm12[5],ymm11[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm11 = ymm3[0,2,3,3,4,6,7,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm12 = ymm4[2,3,2,3,6,7,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm11 = ymm12[0],ymm11[1,2],ymm12[3,4],ymm11[5,6],ymm12[7]
; AVX2-FCP-NEXT:    vunpckhps {{.*#+}} ymm12 = ymm2[2],ymm15[2],ymm2[3],ymm15[3],ymm2[6],ymm15[6],ymm2[7],ymm15[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm12 = ymm12[3,3,3,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm11 = ymm11[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0,1,2],ymm12[3,4],ymm11[5,6,7]
; AVX2-FCP-NEXT:    vbroadcastsd 88(%r8), %ymm12
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm11[0,1],ymm12[2],ymm11[3,4,5,6],ymm12[7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX2-FCP-NEXT:    vunpcklps {{.*#+}} xmm10 = xmm0[0],xmm10[0],xmm0[1],xmm10[1]
; AVX2-FCP-NEXT:    vpermps %ymm10, %ymm13, %ymm10
; AVX2-FCP-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX2-FCP-NEXT:    vunpcklps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm11 # 16-byte Folded Reload
; AVX2-FCP-NEXT:    # xmm11 = xmm0[0],mem[0],xmm0[1],mem[1]
; AVX2-FCP-NEXT:    vpermps %ymm11, %ymm14, %ymm13
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm10 = ymm13[0,1],ymm10[2,3],ymm13[4,5,6],ymm10[7]
; AVX2-FCP-NEXT:    vinsertf128 $1, 96(%r8), %ymm11, %ymm11
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm11[0],ymm10[1,2,3],ymm11[4],ymm10[5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps 96(%rdx), %ymm11
; AVX2-FCP-NEXT:    vmovaps 96(%rcx), %ymm13
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm12 = ymm13[1,1,1,1,5,5,5,5]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0],ymm11[1],ymm12[2,3,4],ymm11[5],ymm12[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm12 = ymm12[2,2,2,2]
; AVX2-FCP-NEXT:    vmovaps 96(%rdi), %ymm1
; AVX2-FCP-NEXT:    vmovaps 96(%rsi), %ymm0
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm10 = ymm0[1,1,2,2,5,5,6,6]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm10 = ymm10[0],ymm1[1,2],ymm10[3,4],ymm1[5,6],ymm10[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm10 = ymm10[2,2,2,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm10 = ymm10[0,1,2],ymm12[3,4],ymm10[5,6,7]
; AVX2-FCP-NEXT:    vbroadcastsd 112(%r8), %ymm12
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm10 = ymm12[0],ymm10[1,2,3,4],ymm12[5],ymm10[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm10, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm12 = ymm13[0,2,3,3,4,6,7,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm14 = ymm11[2,3,2,3,6,7,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm12 = ymm14[0],ymm12[1,2],ymm14[3,4],ymm12[5,6],ymm14[7]
; AVX2-FCP-NEXT:    vunpckhps {{.*#+}} ymm14 = ymm0[2],ymm1[2],ymm0[3],ymm1[3],ymm0[6],ymm1[6],ymm0[7],ymm1[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[3,3,3,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm12 = ymm12[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0,1,2],ymm14[3,4],ymm12[5,6,7]
; AVX2-FCP-NEXT:    vbroadcastsd 120(%r8), %ymm14
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0,1],ymm14[2],ymm12[3,4,5,6],ymm14[7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm9 = ymm9[3,0,2,3,7,4,6,7]
; AVX2-FCP-NEXT:    vblendps $16, {{[-0-9]+}}(%r{{[sb]}}p), %ymm9, %ymm9 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm9 = ymm9[0,1,2,3],mem[4],ymm9[5,6,7]
; AVX2-FCP-NEXT:    vpermilps $52, {{[-0-9]+}}(%r{{[sb]}}p), %ymm14 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm14 = mem[0,1,3,0,4,5,7,4]
; AVX2-FCP-NEXT:    vpermilps $78, {{[-0-9]+}}(%r{{[sb]}}p), %ymm10 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm10 = mem[2,3,0,1,6,7,4,5]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm10 = ymm10[0,1],ymm14[2],ymm10[3,4,5,6],ymm14[7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0],ymm10[1,2,3],ymm9[4,5],ymm10[6,7]
...
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm2 = ymm2[3,0,2,3,7,4,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1,2,3],ymm15[4],ymm2[5,6,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm3 = ymm3[0,1,3,0,4,5,7,4]
...
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm3 = ymm11[2,3,0,1,6,7,4,5]
...
; AVX2-FCP-NEXT:    vmovaps %ymm12, 608(%r9)
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Reload
; SSE-NEXT:    shufps {{.*#+}} xmm2 = xmm2[1,1],xmm1[1,1]
; SSE-NEXT:    shufps {{.*#+}} xmm2 = xmm2[0,2],xmm0[0,1]
; SSE-NEXT:    movaps %xmm5, %xmm0
; SSE-NEXT:    shufps {{.*#+}} xmm0 = xmm0[3,1],xmm1[2,3]
...
; SSE-NEXT:    movaps %xmm15, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm15 # 16-byte Reload
; SSE-NEXT:    shufps $85, {{[-0-9]+}}(%r{{[sb]}}p), %xmm15 # 16-byte Folded Reload
; SSE-NEXT:    # xmm15 = xmm15[1,1],mem[1,1]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movss {{.*#+}} xmm4 = xmm0[0],xmm4[1,2,3]
; SSE-NEXT:    shufps $85, {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Folded Reload
; SSE-NEXT:    # xmm3 = xmm3[1,1],mem[1,1]
; SSE-NEXT:    shufps {{.*#+}} xmm5 = xmm5[0,1],xmm3[2,0]
; SSE-NEXT:    movss {{.*#+}} xmm5 = xmm1[0],xmm5[1,2,3]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 1248(%r9)
; SSE-NEXT:    movaps %xmm2, 1232(%r9)
...
; AVX-NEXT:    vshufps {{.*#+}} xmm4 = xmm2[1,1],xmm0[1,1]
; AVX-NEXT:    vunpcklps {{.*#+}} xmm5 = xmm2[0],xmm0[0],xmm2[1],xmm0[1]
; AVX-NEXT:    vinsertf128 $1, %xmm4, %ymm5, %ymm4
...
; AVX-NEXT:    vmovddup {{.*#+}} ymm9 = ymm9[0,0,2,2]
...
; AVX-NEXT:    vshufps {{.*#+}} xmm5 = xmm5[1,1,1,1]
; AVX-NEXT:    vinsertf128 $1, %xmm4, %ymm5, %ymm4
; AVX-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[2,2,2,2]
; AVX-NEXT:    vblendps {{.*#+}} xmm0 = xmm2[0,1,2],xmm0[3]
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm0, %ymm0
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm4[0,1],ymm0[2,3],ymm4[4,5],ymm0[6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm9[1],ymm0[2,3,4,5],ymm9[6],ymm0[7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufps {{.*#+}} xmm0 = xmm3[1,1],xmm1[1,1]
; AVX-NEXT:    vunpcklps {{.*#+}} xmm2 = xmm3[0],xmm1[0],xmm3[1],xmm1[1]
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm2, %ymm0
; AVX-NEXT:    vunpcklps {{.*#+}} xmm2 = xmm8[0],xmm6[0],xmm8[1],xmm6[1]
; AVX-NEXT:    vinsertf128 $1, %xmm8, %ymm2, %ymm2
; AVX-NEXT:    vmovddup {{.*#+}} ymm2 = ymm2[0,0,2,2]
...
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm8[2],xmm6[2],xmm8[3],xmm6[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm4 = xmm6[1,1,1,1]
...
; AVX-NEXT:    vmovddup {{.*#+}} ymm5 = ymm5[0,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1],ymm5[2,3],ymm2[4,5,6],ymm5[7]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm5 = mem[0,1,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1,2,3],ymm5[4],ymm2[5,6,7]
; AVX-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vunpckhps {{.*#+}} xmm2 = xmm4[2],xmm3[2],xmm4[3],xmm3[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm3 = xmm3[1,1,1,1]
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm3, %ymm2
; AVX-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[2,2,2,2]
; AVX-NEXT:    vblendps {{.*#+}} xmm0 = xmm1[0,1,2],xmm0[3]
; AVX-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm0
...
; AVX-NEXT:    vmovddup {{.*#+}} ymm5 = ymm5[0,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1],ymm5[2,3],ymm2[4,5,6],ymm5[7]
; AVX-NEXT:    vunpckhps {{.*#+}} xmm4 = xmm4[2],xmm3[2],xmm4[3],xmm3[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm3 = xmm3[1,1,1,1]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1,2,3],ymm1[4],ymm2[5,6,7]
; AVX-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vshufps {{.*#+}} ymm1 = ymm7[1,1],ymm1[1,1],ymm7[5,5],ymm1[5,5]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm1[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],ymm1[3,4],ymm0[5,6,7]
; AVX-NEXT:    vmovaps 16(%rcx), %xmm1
...
; AVX-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufps {{.*#+}} ymm14 = ymm3[3,3],ymm2[3,3],ymm3[7,7],ymm2[7,7]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm14 = ymm14[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2],ymm14[3,4],ymm1[5,6,7]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm14 = mem[0,1,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm14[0],ymm0[1,2,3,4],ymm14[5],ymm0[6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1],ymm14[2],ymm1[3,4,5,6],ymm14[7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[1,1],xmm1[1,1]
; AVX-NEXT:    vinsertf128 $1, %xmm14, %ymm0, %ymm14
; AVX-NEXT:    vmovaps 96(%rdx), %ymm0
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovaps 96(%rcx), %ymm1
; AVX-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufps {{.*#+}} ymm15 = ymm1[1,1],ymm0[1,1],ymm1[5,5],ymm0[5,5]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm15 = ymm15[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0,1,2],ymm15[3,4],ymm14[5,6,7]
; AVX-NEXT:    vmovaps 112(%rcx), %xmm15
; AVX-NEXT:    vmovaps 112(%rdx), %xmm0
; AVX-NEXT:    vshufps {{.*#+}} xmm1 = xmm0[3,3],xmm15[3,3]
; AVX-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm0[2],xmm15[2],xmm0[3],xmm15[3]
; AVX-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm0
...
; AVX-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufps {{.*#+}} ymm13 = ymm2[3,3],ymm1[3,3],ymm2[7,7],ymm1[7,7]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm13 = ymm13[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],ymm13[3,4],ymm0[5,6,7]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm13 = mem[0,1,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm13[0],ymm14[1,2,3,4],ymm13[5],ymm14[6,7]
; AVX-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm13[2],ymm0[3,4,5,6],ymm13[7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovaps 144(%rdi), %xmm0
; AVX-NEXT:    vmovaps 144(%rsi), %xmm13
; AVX-NEXT:    vshufps {{.*#+}} xmm14 = xmm13[2,2,2,2]
; AVX-NEXT:    vblendps {{.*#+}} xmm14 = xmm0[0,1,2],xmm14[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[1,1],xmm13[1,1]
; AVX-NEXT:    vinsertf128 $1, %xmm14, %ymm0, %ymm0
; AVX-NEXT:    vmovaps 128(%rdx), %ymm1
; AVX-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovaps 128(%rcx), %ymm2
; AVX-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufps {{.*#+}} ymm14 = ymm2[1,1],ymm1[1,1],ymm2[5,5],ymm1[5,5]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm14 = ymm14[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm0[0,1,2],ymm14[3,4],ymm0[5,6,7]
; AVX-NEXT:    vmovaps 144(%rcx), %xmm14
; AVX-NEXT:    vmovaps 144(%rdx), %xmm0
; AVX-NEXT:    vshufps {{.*#+}} xmm1 = xmm0[3,3],xmm14[3,3]
; AVX-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm0[2],xmm14[2],xmm0[3],xmm14[3]
; AVX-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm0
; AVX-NEXT:    vmovaps 128(%rdi), %ymm1
; AVX-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovaps 128(%rsi), %ymm6
; AVX-NEXT:    vshufps {{.*#+}} ymm12 = ymm6[3,3],ymm1[3,3],ymm6[7,7],ymm1[7,7]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm12 = ymm12[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm12 = ymm0[0,1,2],ymm12[3,4],ymm0[5,6,7]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm0 = mem[0,1,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm0[0],ymm2[1,2,3,4],ymm0[5],ymm2[6,7]
; AVX-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm12[0,1],ymm0[2],ymm12[3,4,5,6],ymm0[7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovaps 176(%rdi), %xmm0
; AVX-NEXT:    vmovaps 176(%rsi), %xmm12
; AVX-NEXT:    vshufps {{.*#+}} xmm2 = xmm12[2,2,2,2]
; AVX-NEXT:    vblendps {{.*#+}} xmm2 = xmm0[0,1,2],xmm2[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[1,1],xmm12[1,1]
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm0, %ymm0
...
; AVX-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vshufps {{.*#+}} ymm11 = ymm2[1,1],ymm1[1,1],ymm2[5,5],ymm1[5,5]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm11 = ymm11[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm0[0,1,2],ymm11[3,4],ymm0[5,6,7]
; AVX-NEXT:    vmovaps 176(%rcx), %xmm11
; AVX-NEXT:    vmovaps 176(%rdx), %xmm0
; AVX-NEXT:    vshufps {{.*#+}} xmm1 = xmm0[3,3],xmm11[3,3]
; AVX-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm0[2],xmm11[2],xmm0[3],xmm11[3]
; AVX-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm0
; AVX-NEXT:    vmovaps 160(%rdi), %ymm1
; AVX-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovaps 160(%rsi), %ymm11
; AVX-NEXT:    vshufps {{.*#+}} ymm10 = ymm11[3,3],ymm1[3,3],ymm11[7,7],ymm1[7,7]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm10 = ymm10[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],ymm10[3,4],ymm0[5,6,7]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm10 = mem[0,1,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm10[0],ymm2[1,2,3,4],ymm10[5],ymm2[6,7]
...
; AVX-NEXT:    vshufps {{.*#+}} xmm0 = xmm10[1,1],xmm0[1,1]
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm0, %ymm0
; AVX-NEXT:    vmovaps 192(%rdx), %ymm5
; AVX-NEXT:    vmovaps 192(%rcx), %ymm10
; AVX-NEXT:    vshufps {{.*#+}} ymm9 = ymm10[1,1],ymm5[1,1],ymm10[5,5],ymm5[5,5]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm9 = ymm9[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm0[0,1,2],ymm9[3,4],ymm0[5,6,7]
; AVX-NEXT:    vmovaps 208(%rcx), %xmm9
; AVX-NEXT:    vmovaps 208(%rdx), %xmm0
; AVX-NEXT:    vshufps {{.*#+}} xmm1 = xmm0[3,3],xmm9[3,3]
; AVX-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm0[2],xmm9[2],xmm0[3],xmm9[3]
; AVX-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm0
; AVX-NEXT:    vmovaps 192(%rdi), %ymm4
; AVX-NEXT:    vmovaps 192(%rsi), %ymm9
; AVX-NEXT:    vshufps {{.*#+}} ymm8 = ymm9[3,3],ymm4[3,3],ymm9[7,7],ymm4[7,7]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm8 = ymm8[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],ymm8[3,4],ymm0[5,6,7]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm8 = mem[0,1,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm8[0],ymm2[1,2,3,4],ymm8[5],ymm2[6,7]
; AVX-NEXT:    vmovups %ymm1, (%rsp) # 32-byte Spill
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm8[2],ymm0[3,4,5,6],ymm8[7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovaps 240(%rdi), %xmm8
; AVX-NEXT:    vmovaps 240(%rsi), %xmm0
; AVX-NEXT:    vshufps {{.*#+}} xmm2 = xmm0[2,2,2,2]
; AVX-NEXT:    vblendps {{.*#+}} xmm2 = xmm8[0,1,2],xmm2[3]
; AVX-NEXT:    vshufps {{.*#+}} xmm0 = xmm8[1,1],xmm0[1,1]
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm0, %ymm0
; AVX-NEXT:    vmovaps 224(%rdx), %ymm3
; AVX-NEXT:    vmovaps 224(%rcx), %ymm8
; AVX-NEXT:    vshufps {{.*#+}} ymm15 = ymm8[1,1],ymm3[1,1],ymm8[5,5],ymm3[5,5]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm15 = ymm15[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm0[0,1,2],ymm15[3,4],ymm0[5,6,7]
; AVX-NEXT:    vmovaps 240(%rcx), %xmm15
; AVX-NEXT:    vmovaps 240(%rdx), %xmm0
; AVX-NEXT:    vshufps {{.*#+}} xmm1 = xmm0[3,3],xmm15[3,3]
; AVX-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm0[2],xmm15[2],xmm0[3],xmm15[3]
; AVX-NEXT:    vinsertf128 $1, %xmm1, %ymm0, %ymm0
; AVX-NEXT:    vmovaps 224(%rdi), %ymm1
; AVX-NEXT:    vmovaps 224(%rsi), %ymm15
; AVX-NEXT:    vshufps {{.*#+}} ymm13 = ymm15[3,3],ymm1[3,3],ymm15[7,7],ymm1[7,7]
; AVX-NEXT:    vperm2f128 {{.*#+}} ymm13 = ymm13[2,3,2,3]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],ymm13[3,4],ymm0[5,6,7]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm13 = mem[0,1,0,1]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm13[0],ymm2[1,2,3,4],ymm13[5],ymm2[6,7]
; AVX-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm13[2],ymm0[3,4,5,6],ymm13[7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vpermilps $227, {{[-0-9]+}}(%r{{[sb]}}p), %ymm13 # 32-byte Folded Reload
; AVX-NEXT:    # ymm13 = mem[3,0,2,3,7,4,6,7]
; AVX-NEXT:    vblendps $16, {{[-0-9]+}}(%r{{[sb]}}p), %ymm13, %ymm13 # 32-byte Folded Reload
; AVX-NEXT:    # ymm13 = ymm13[0,1,2,3],mem[4],ymm13[5,6,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm0 = ymm7[0,1,3,0,4,5,7,4]
; AVX-NEXT:    vpermilpd $1, {{[-0-9]+}}(%r{{[sb]}}p), %ymm2 # 32-byte Folded Reload
; AVX-NEXT:    # ymm2 = mem[1,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm2[0,1],ymm0[2],ymm2[3,4,5,6],ymm0[7]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm13[0],ymm0[1,2,3],ymm13[4,5],ymm0[6,7]
...
; AVX-NEXT:    vpermilps $52, {{[-0-9]+}}(%r{{[sb]}}p), %ymm13 # 32-byte Folded Reload
; AVX-NEXT:    # ymm13 = mem[0,1,3,0,4,5,7,4]
; AVX-NEXT:    vpermilpd $1, {{[-0-9]+}}(%r{{[sb]}}p), %ymm14 # 32-byte Folded Reload
; AVX-NEXT:    # ymm14 = mem[1,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm13 = ymm14[0,1],ymm13[2],ymm14[3,4,5,6],ymm13[7]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0],ymm13[1,2,3],ymm2[4,5],ymm13[6,7]
; AVX-NEXT:    vpermilps $227, {{[-0-9]+}}(%r{{[sb]}}p), %ymm13 # 32-byte Folded Reload
; AVX-NEXT:    # ymm13 = mem[3,0,2,3,7,4,6,7]
; AVX-NEXT:    vblendps $16, {{[-0-9]+}}(%r{{[sb]}}p), %ymm13, %ymm13 # 32-byte Folded Reload
; AVX-NEXT:    # ymm13 = ymm13[0,1,2,3],mem[4],ymm13[5,6,7]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1],ymm14[2],ymm7[3,4,5,6],ymm14[7]
; AVX-NEXT:    vblendps {{.*#+}} ymm7 = ymm13[0],ymm7[1,2,3],ymm13[4,5],ymm7[6,7]
; AVX-NEXT:    vpermilps $227, {{[-0-9]+}}(%r{{[sb]}}p), %ymm13 # 32-byte Folded Reload
; AVX-NEXT:    # ymm13 = mem[3,0,2,3,7,4,6,7]
; AVX-NEXT:    vblendps $16, {{[-0-9]+}}(%r{{[sb]}}p), %ymm13, %ymm13 # 32-byte Folded Reload
; AVX-NEXT:    # ymm13 = ymm13[0,1,2,3],mem[4],ymm13[5,6,7]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0,1],ymm14[2],ymm12[3,4,5,6],ymm14[7]
; AVX-NEXT:    vblendps {{.*#+}} ymm12 = ymm13[0],ymm12[1,2,3],ymm13[4,5],ymm12[6,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm13 = ymm6[3,0,2,3,7,4,6,7]
; AVX-NEXT:    vblendps $16, {{[-0-9]+}}(%r{{[sb]}}p), %ymm13, %ymm13 # 32-byte Folded Reload
; AVX-NEXT:    # ymm13 = ymm13[0,1,2,3],mem[4],ymm13[5,6,7]
; AVX-NEXT:    vpermilps $52, {{[-0-9]+}}(%r{{[sb]}}p), %ymm14 # 32-byte Folded Reload
; AVX-NEXT:    # ymm14 = mem[0,1,3,0,4,5,7,4]
; AVX-NEXT:    vpermilpd $1, {{[-0-9]+}}(%r{{[sb]}}p), %ymm6 # 32-byte Folded Reload
; AVX-NEXT:    # ymm6 = mem[1,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm6 = ymm6[0,1],ymm14[2],ymm6[3,4,5,6],ymm14[7]
; AVX-NEXT:    vblendps {{.*#+}} ymm6 = ymm13[0],ymm6[1,2,3],ymm13[4,5],ymm6[6,7]
...
; AVX-NEXT:    # ymm14 = mem[1,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm13 = ymm14[0,1],ymm13[2],ymm14[3,4,5,6],ymm13[7]
; AVX-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0],ymm13[1,2,3],ymm11[4,5],ymm13[6,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm9 = ymm9[3,0,2,3,7,4,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm4 = ymm9[0,1,2,3],ymm4[4],ymm9[5,6,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm9 = ymm10[0,1,3,0,4,5,7,4]
; AVX-NEXT:    vshufpd {{.*#+}} ymm5 = ymm5[1,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0,1],ymm9[2],ymm5[3,4,5,6],ymm9[7]
; AVX-NEXT:    vblendps {{.*#+}} ymm4 = ymm4[0],ymm5[1,2,3],ymm4[4,5],ymm5[6,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm5 = ymm15[3,0,2,3,7,4,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm5[0,1,2,3],ymm1[4],ymm5[5,6,7]
; AVX-NEXT:    vshufps {{.*#+}} ymm5 = ymm8[0,1,3,0,4,5,7,4]
; AVX-NEXT:    vshufpd {{.*#+}} ymm3 = ymm3[1,0,2,2]
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1],ymm5[2],ymm3[3,4,5,6],ymm5[7]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0],ymm3[1,2,3],ymm1[4,5],ymm3[6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],mem[3],ymm0[4,5,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1,2],mem[3],ymm2[4,5,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm7[0,1,2],mem[3],ymm7[4,5,6,7]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm4 = ymm4[0,1,2],mem[3],ymm4[4,5,6,7]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2],mem[3],ymm1[4,5,6,7]
; AVX-NEXT:    vmovaps %ymm1, 1184(%r9)
; AVX-NEXT:    vmovaps %ymm4, 1024(%r9)
; AVX-NEXT:    vmovaps %ymm7, 864(%r9)
; AVX-NEXT:    vmovaps %ymm6, 704(%r9)
; AVX-NEXT:    vmovaps %ymm5, 544(%r9)
; AVX-NEXT:    vmovaps %ymm3, 384(%r9)
; AVX-NEXT:    vmovaps %ymm2, 224(%r9)
; AVX-NEXT:    vmovaps %ymm0, 64(%r9)
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX2:       # %bb.0:
; AVX2-NEXT:    subq $1800, %rsp # imm = 0x708
; AVX2-NEXT:    vmovaps (%r8), %ymm15
; AVX2-NEXT:    vmovups %ymm15, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovaps 32(%r8), %ymm14
; AVX2-NEXT:    vmovups %ymm14, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-NEXT:    vmovaps 32(%rdx), %xmm4
; AVX2-NEXT:    vmovaps 64(%rdx), %xmm5
; AVX2-NEXT:    vunpcklps {{.*#+}} xmm6 = xmm3[0],xmm0[0],xmm3[1],xmm0[1]
; AVX2-NEXT:    vshufps {{.*#+}} xmm6 = xmm6[0,1,2,2]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm6 = ymm6[0,0,2,1]
; AVX2-NEXT:    vmovaps (%rsi), %xmm7
; AVX2-NEXT:    vmovaps 32(%rsi), %xmm8
; AVX2-NEXT:    vmovaps 64(%rsi), %xmm9
; AVX2-NEXT:    vmovaps (%rdi), %xmm10
; AVX2-NEXT:    vunpcklps {{.*#+}} xmm11 = xmm10[0],xmm7[0],xmm10[1],xmm7[1]
; AVX2-NEXT:    vshufps {{.*#+}} xmm11 = xmm11[0,1,3,2]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm12 = ymm11[0,1,1,1]
; AVX2-NEXT:    vblendps {{.*#+}} ymm6 = ymm12[0,1],ymm6[2,3],ymm12[4,5,6],ymm6[7]
; AVX2-NEXT:    vmovaps 32(%rdi), %xmm12
; AVX2-NEXT:    vinsertf128 $1, (%r8), %ymm11, %ymm11
; AVX2-NEXT:    vblendps {{.*#+}} ymm6 = ymm11[0],ymm6[1,2,3],ymm11[4],ymm6[5,6,7]
; AVX2-NEXT:    vmovups %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovaps 64(%rdi), %xmm6
; AVX2-NEXT:    vunpckhps {{.*#+}} xmm7 = xmm10[2],xmm7[2],xmm10[3],xmm7[3]
; AVX2-NEXT:    vshufps {{.*#+}} xmm7 = xmm7[0,1,2,2]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[0,0,2,1]
; AVX2-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[1,1,2,2]
; AVX2-NEXT:    vblendps {{.*#+}} xmm0 = xmm0[0,1],xmm3[2],xmm0[3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,1,1,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm7[2,3],ymm0[4,5],ymm7[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm3 = ymm15[0,1,2,1]
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm3[1],ymm0[2,3,4,5],ymm3[6],ymm0[7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vunpcklps {{.*#+}} xmm0 = xmm4[0],xmm1[0],xmm4[1],xmm1[1]
; AVX2-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[0,1,2,2]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,0,2,1]
; AVX2-NEXT:    vunpcklps {{.*#+}} xmm3 = xmm12[0],xmm8[0],xmm12[1],xmm8[1]
; AVX2-NEXT:    vshufps {{.*#+}} xmm3 = xmm3[0,1,3,2]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm7 = ymm3[0,1,1,1]
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm7[0,1],ymm0[2,3],ymm7[4,5,6],ymm0[7]
; AVX2-NEXT:    vinsertf128 $1, 32(%r8), %ymm3, %ymm3
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm3[0],ymm0[1,2,3],ymm3[4],ymm0[5,6,7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm12[2],xmm8[2],xmm12[3],xmm8[3]
; AVX2-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[0,1,2,2]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,0,2,1]
; AVX2-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[1,1,2,2]
; AVX2-NEXT:    vblendps {{.*#+}} xmm1 = xmm1[0,1],xmm4[2],xmm1[3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,1,1,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1],ymm0[2,3],ymm1[4,5],ymm0[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm14[0,1,2,1]
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm1[1],ymm0[2,3,4,5],ymm1[6],ymm0[7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vunpcklps {{.*#+}} xmm0 = xmm5[0],xmm2[0],xmm5[1],xmm2[1]
; AVX2-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[0,1,2,2]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,0,2,1]
; AVX2-NEXT:    vunpcklps {{.*#+}} xmm1 = xmm6[0],xmm9[0],xmm6[1],xmm9[1]
; AVX2-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[0,1,3,2]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm3 = ymm1[0,1,1,1]
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm3[0,1],ymm0[2,3],ymm3[4,5,6],ymm0[7]
; AVX2-NEXT:    vinsertf128 $1, 64(%r8), %ymm1, %ymm1
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0],ymm0[1,2,3],ymm1[4],ymm0[5,6,7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm6[2],xmm9[2],xmm6[3],xmm9[3]
; AVX2-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[0,1,2,2]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,0,2,1]
; AVX2-NEXT:    vshufps {{.*#+}} xmm1 = xmm2[1,1,2,2]
; AVX2-NEXT:    vblendps {{.*#+}} xmm1 = xmm1[0,1],xmm5[2],xmm1[3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,1,1,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1],ymm0[2,3],ymm1[4,5],ymm0[6,7]
...
; AVX2-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovaps (%rsi), %ymm10
; AVX2-NEXT:    vshufps {{.*#+}} ymm1 = ymm10[1,1,2,2,5,5,6,6]
...
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0],ymm0[1,2],ymm1[3,4],ymm0[5,6],ymm1[7]
; AVX2-NEXT:    vunpckhps {{.*#+}} ymm1 = ymm10[2],ymm3[2],ymm10[3],ymm3[3],ymm10[6],ymm3[6],ymm10[7],ymm3[7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[3,3,3,3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[2,1,3,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],ymm1[3,4],ymm0[5,6,7]
; AVX2-NEXT:    vbroadcastsd 24(%r8), %ymm1
...
; AVX2-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovaps 64(%rsi), %ymm10
; AVX2-NEXT:    vshufps {{.*#+}} ymm1 = ymm10[1,1,2,2,5,5,6,6]
; AVX2-NEXT:    vmovups %ymm10, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0],ymm3[1,2],ymm1[3,4],ymm3[5,6],ymm1[7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[2,2,2,3]
...
; AVX2-NEXT:    vshufps {{.*#+}} ymm14 = ymm1[1,1,1,1,5,5,5,5]
; AVX2-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0],ymm3[1],ymm14[2,3,4],ymm3[5],ymm14[6,7]
; AVX2-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[2,2,2,2]
; AVX2-NEXT:    vmovaps 96(%rdi), %ymm2
; AVX2-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovaps 96(%rsi), %ymm10
; AVX2-NEXT:    vshufps {{.*#+}} ymm15 = ymm10[1,1,2,2,5,5,6,6]
; AVX2-NEXT:    vblendps {{.*#+}} ymm15 = ymm15[0],ymm2[1,2],ymm15[3,4],ymm2[5,6],ymm15[7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm15 = ymm15[2,2,2,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm14 = ymm15[0,1,2],ymm14[3,4],ymm15[5,6,7]
; AVX2-NEXT:    vbroadcastsd 112(%r8), %ymm15
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm15[0],ymm14[1,2,3,4],ymm15[5],ymm14[6,7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vshufps {{.*#+}} ymm14 = ymm1[0,2,3,3,4,6,7,7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm15 = ymm3[2,3,2,3,6,7,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm14 = ymm15[0],ymm14[1,2],ymm15[3,4],ymm14[5,6],ymm15[7]
; AVX2-NEXT:    vunpckhps {{.*#+}} ymm15 = ymm10[2],ymm2[2],ymm10[3],ymm2[3],ymm10[6],ymm2[6],ymm10[7],ymm2[7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm15 = ymm15[3,3,3,3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[2,1,3,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0,1,2],ymm15[3,4],ymm14[5,6,7]
; AVX2-NEXT:    vbroadcastsd 120(%r8), %ymm15
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm14[0,1],ymm15[2],ymm14[3,4,5,6],ymm15[7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovaps 128(%rdx), %ymm0
; AVX2-NEXT:    vmovaps 128(%rcx), %ymm2
; AVX2-NEXT:    vshufps {{.*#+}} ymm14 = ymm2[1,1,1,1,5,5,5,5]
; AVX2-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0],ymm0[1],ymm14[2,3,4],ymm0[5],ymm14[6,7]
; AVX2-NEXT:    vmovaps %ymm0, %ymm1
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[2,2,2,2]
; AVX2-NEXT:    vmovaps 128(%rdi), %ymm3
; AVX2-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovaps 128(%rsi), %ymm4
; AVX2-NEXT:    vshufps {{.*#+}} ymm13 = ymm4[1,1,2,2,5,5,6,6]
; AVX2-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0],ymm3[1,2],ymm13[3,4],ymm3[5,6],ymm13[7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[2,2,2,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0,1,2],ymm14[3,4],ymm13[5,6,7]
; AVX2-NEXT:    vbroadcastsd 144(%r8), %ymm14
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm14[0],ymm13[1,2,3,4],ymm14[5],ymm13[6,7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vshufps {{.*#+}} ymm13 = ymm2[0,2,3,3,4,6,7,7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm14 = ymm1[2,3,2,3,6,7,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm13 = ymm14[0],ymm13[1,2],ymm14[3,4],ymm13[5,6],ymm14[7]
; AVX2-NEXT:    vunpckhps {{.*#+}} ymm14 = ymm4[2],ymm3[2],ymm4[3],ymm3[3],ymm4[6],ymm3[6],ymm4[7],ymm3[7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[3,3,3,3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[2,1,3,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0,1,2],ymm14[3,4],ymm13[5,6,7]
; AVX2-NEXT:    vbroadcastsd 152(%r8), %ymm14
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm13[0,1],ymm14[2],ymm13[3,4,5,6],ymm14[7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovaps 160(%rdx), %ymm1
; AVX2-NEXT:    vmovaps 160(%rcx), %ymm9
; AVX2-NEXT:    vshufps {{.*#+}} ymm14 = ymm9[1,1,1,1,5,5,5,5]
; AVX2-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0],ymm1[1],ymm14[2,3,4],ymm1[5],ymm14[6,7]
; AVX2-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[2,2,2,2]
; AVX2-NEXT:    vmovaps 160(%rdi), %ymm8
; AVX2-NEXT:    vmovaps 160(%rsi), %ymm7
; AVX2-NEXT:    vshufps {{.*#+}} ymm12 = ymm7[1,1,2,2,5,5,6,6]
; AVX2-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0],ymm8[1,2],ymm12[3,4],ymm8[5,6],ymm12[7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm12 = ymm12[2,2,2,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0,1,2],ymm14[3,4],ymm12[5,6,7]
; AVX2-NEXT:    vbroadcastsd 176(%r8), %ymm14
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm14[0],ymm12[1,2,3,4],ymm14[5],ymm12[6,7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vshufps {{.*#+}} ymm14 = ymm9[0,2,3,3,4,6,7,7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm12 = ymm1[2,3,2,3,6,7,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0],ymm14[1,2],ymm12[3,4],ymm14[5,6],ymm12[7]
; AVX2-NEXT:    vunpckhps {{.*#+}} ymm14 = ymm7[2],ymm8[2],ymm7[3],ymm8[3],ymm7[6],ymm8[6],ymm7[7],ymm8[7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[3,3,3,3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm12 = ymm12[2,1,3,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0,1,2],ymm14[3,4],ymm12[5,6,7]
; AVX2-NEXT:    vbroadcastsd 184(%r8), %ymm14
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm12[0,1],ymm14[2],ymm12[3,4,5,6],ymm14[7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovaps 192(%rdx), %ymm14
; AVX2-NEXT:    vmovaps 192(%rcx), %ymm6
; AVX2-NEXT:    vshufps {{.*#+}} ymm12 = ymm6[1,1,1,1,5,5,5,5]
...
; AVX2-NEXT:    vshufps {{.*#+}} ymm11 = ymm4[1,1,2,2,5,5,6,6]
; AVX2-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0],ymm5[1,2],ymm11[3,4],ymm5[5,6],ymm11[7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm11 = ymm11[2,2,2,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0,1,2],ymm12[3,4],ymm11[5,6,7]
; AVX2-NEXT:    vbroadcastsd 208(%r8), %ymm12
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm12[0],ymm11[1,2,3,4],ymm12[5],ymm11[6,7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vshufps {{.*#+}} ymm12 = ymm6[0,2,3,3,4,6,7,7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm11 = ymm14[2,3,2,3,6,7,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0],ymm12[1,2],ymm11[3,4],ymm12[5,6],ymm11[7]
; AVX2-NEXT:    vunpckhps {{.*#+}} ymm12 = ymm4[2],ymm5[2],ymm4[3],ymm5[3],ymm4[6],ymm5[6],ymm4[7],ymm5[7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm12 = ymm12[3,3,3,3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm11 = ymm11[2,1,3,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0,1,2],ymm12[3,4],ymm11[5,6,7]
; AVX2-NEXT:    vbroadcastsd 216(%r8), %ymm12
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm11[0,1],ymm12[2],ymm11[3,4,5,6],ymm12[7]
; AVX2-NEXT:    vmovups %ymm0, (%rsp) # 32-byte Spill
; AVX2-NEXT:    vmovaps 224(%rdx), %ymm12
; AVX2-NEXT:    vmovaps 224(%rcx), %ymm3
; AVX2-NEXT:    vshufps {{.*#+}} ymm11 = ymm3[1,1,1,1,5,5,5,5]
; AVX2-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0],ymm12[1],ymm11[2,3,4],ymm12[5],ymm11[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm11 = ymm11[2,2,2,2]
; AVX2-NEXT:    vmovaps 224(%rdi), %ymm2
; AVX2-NEXT:    vmovaps 224(%rsi), %ymm1
; AVX2-NEXT:    vshufps {{.*#+}} ymm15 = ymm1[1,1,2,2,5,5,6,6]
; AVX2-NEXT:    vblendps {{.*#+}} ymm15 = ymm15[0],ymm2[1,2],ymm15[3,4],ymm2[5,6],ymm15[7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm15 = ymm15[2,2,2,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm11 = ymm15[0,1,2],ymm11[3,4],ymm15[5,6,7]
; AVX2-NEXT:    vbroadcastsd 240(%r8), %ymm15
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm15[0],ymm11[1,2,3,4],ymm15[5],ymm11[6,7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vshufps {{.*#+}} ymm15 = ymm3[0,2,3,3,4,6,7,7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm11 = ymm12[2,3,2,3,6,7,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0],ymm15[1,2],ymm11[3,4],ymm15[5,6],ymm11[7]
; AVX2-NEXT:    vunpckhps {{.*#+}} ymm15 = ymm1[2],ymm2[2],ymm1[3],ymm2[3],ymm1[6],ymm2[6],ymm1[7],ymm2[7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm15 = ymm15[3,3,3,3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm11 = ymm11[2,1,3,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0,1,2],ymm15[3,4],ymm11[5,6,7]
; AVX2-NEXT:    vbroadcastsd 248(%r8), %ymm15
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm11[0,1],ymm15[2],ymm11[3,4,5,6],ymm15[7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpermilps $227, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm15 = mem[3,0,2,3,7,4,6,7]
; AVX2-NEXT:    vblendps $16, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15, %ymm15 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm15 = ymm15[0,1,2,3],mem[4],ymm15[5,6,7]
; AVX2-NEXT:    vpermilps $52, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm0 = mem[0,1,3,0,4,5,7,4]
; AVX2-NEXT:    vpermilps $78, {{[-0-9]+}}(%r{{[sb]}}p), %ymm11 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm11 = mem[2,3,0,1,6,7,4,5]
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm11[0,1],ymm0[2],ymm11[3,4,5,6],ymm0[7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm15[0],ymm0[1,2,3],ymm15[4,5],ymm0[6,7]
; AVX2-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm0 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm0 = ymm0[0,1,2],mem[3],ymm0[4,5,6,7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpermilps $227, {{[-0-9]+}}(%r{{[sb]}}p), %ymm11 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm11 = mem[3,0,2,3,7,4,6,7]
; AVX2-NEXT:    vblendps $16, {{[-0-9]+}}(%r{{[sb]}}p), %ymm11, %ymm11 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm11 = ymm11[0,1,2,3],mem[4],ymm11[5,6,7]
; AVX2-NEXT:    vpermilps $52, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm15 = mem[0,1,3,0,4,5,7,4]
; AVX2-NEXT:    vpermilps $78, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm0 = mem[2,3,0,1,6,7,4,5]
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm15[2],ymm0[3,4,5,6],ymm15[7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm11[0],ymm0[1,2,3],ymm11[4,5],ymm0[6,7]
; AVX2-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm0 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm0 = ymm0[0,1,2],mem[3],ymm0[4,5,6,7]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpermilps $227, {{[-0-9]+}}(%r{{[sb]}}p), %ymm11 # 32-byte Folded Reload
...
; AVX2-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm0 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm0 = ymm0[0,1,2],mem[3],ymm0[4,5,6,7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm11 = ymm10[3,0,2,3,7,4,6,7]
; AVX2-NEXT:    vblendps $16, {{[-0-9]+}}(%r{{[sb]}}p), %ymm11, %ymm11 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm11 = ymm11[0,1,2,3],mem[4],ymm11[5,6,7]
; AVX2-NEXT:    vpermilps $52, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm15 = mem[0,1,3,0,4,5,7,4]
; AVX2-NEXT:    vpermilps $78, {{[-0-9]+}}(%r{{[sb]}}p), %ymm10 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm10 = mem[2,3,0,1,6,7,4,5]
; AVX2-NEXT:    vblendps {{.*#+}} ymm10 = ymm10[0,1],ymm15[2],ymm10[3,4,5,6],ymm15[7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm10 = ymm11[0],ymm10[1,2,3],ymm11[4,5],ymm10[6,7]
; AVX2-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm10, %ymm10 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm10 = ymm10[0,1,2],mem[3],ymm10[4,5,6,7]
; AVX2-NEXT:    vpermilps $227, {{[-0-9]+}}(%r{{[sb]}}p), %ymm11 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm11 = mem[3,0,2,3,7,4,6,7]
; AVX2-NEXT:    vblendps $16, {{[-0-9]+}}(%r{{[sb]}}p), %ymm11, %ymm11 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm11 = ymm11[0,1,2,3],mem[4],ymm11[5,6,7]
...
; AVX2-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0],ymm13[1,2,3],ymm11[4,5],ymm13[6,7]
; AVX2-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm11, %ymm11 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm11 = ymm11[0,1,2],mem[3],ymm11[4,5,6,7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm7 = ymm7[3,0,2,3,7,4,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1,2,3],ymm8[4],ymm7[5,6,7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm8 = ymm9[0,1,3,0,4,5,7,4]
; AVX2-NEXT:    vpermilps $78, {{[-0-9]+}}(%r{{[sb]}}p), %ymm9 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm9 = mem[2,3,0,1,6,7,4,5]
; AVX2-NEXT:    vblendps {{.*#+}} ymm8 = ymm9[0,1],ymm8[2],ymm9[3,4,5,6],ymm8[7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0],ymm8[1,2,3],ymm7[4,5],ymm8[6,7]
; AVX2-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm7, %ymm7 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm7 = ymm7[0,1,2],mem[3],ymm7[4,5,6,7]
...
; AVX2-NEXT:    vshufps {{.*#+}} ymm6 = ymm14[2,3,0,1,6,7,4,5]
...
; AVX2-NEXT:    vshufps {{.*#+}} ymm1 = ymm1[3,0,2,3,7,4,6,7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2,3],ymm2[4],ymm1[5,6,7]
; AVX2-NEXT:    vshufps {{.*#+}} ymm2 = ymm3[0,1,3,0,4,5,7,4]
; AVX2-NEXT:    vshufps {{.*#+}} ymm3 = ymm12[2,3,0,1,6,7,4,5]
; AVX2-NEXT:    vblendps {{.*#+}} ymm2 = ymm3[0,1],ymm2[2],ymm3[3,4,5,6],ymm2[7]
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0],ymm2[1,2,3],ymm1[4,5],ymm2[6,7]
; AVX2-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm1 # 32-byte Folded Reload
; AVX2-NEXT:    # ymm1 = ymm1[0,1,2],mem[3],ymm1[4,5,6,7]
; AVX2-NEXT:    vmovaps %ymm1, 1184(%r9)
; AVX2-NEXT:    vmovaps %ymm4, 1024(%r9)
; AVX2-NEXT:    vmovaps %ymm7, 864(%r9)
; AVX2-NEXT:    vmovaps %ymm11, 704(%r9)
; AVX2-NEXT:    vmovaps %ymm10, 544(%r9)
...
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-NEXT:    vmovaps %ymm0, (%r9)
; AVX2-NEXT:    addq $1800, %rsp # imm = 0x708
; AVX2-NEXT:    vzeroupper
; AVX2-NEXT:    retq
;
; AVX2-FP-LABEL: store_i32_stride5_vf64:
; AVX2-FP:       # %bb.0:
; AVX2-FP-NEXT:    subq $1800, %rsp # imm = 0x708
; AVX2-FP-NEXT:    vmovaps (%r8), %ymm15
; AVX2-FP-NEXT:    vmovups %ymm15, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps 32(%r8), %ymm14
; AVX2-FP-NEXT:    vmovups %ymm14, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FP-NEXT:    vmovaps 32(%rdx), %xmm4
; AVX2-FP-NEXT:    vmovaps 64(%rdx), %xmm5
; AVX2-FP-NEXT:    vunpcklps {{.*#+}} xmm6 = xmm3[0],xmm0[0],xmm3[1],xmm0[1]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm6 = xmm6[0,1,2,2]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm6 = ymm6[0,0,2,1]
; AVX2-FP-NEXT:    vmovaps (%rsi), %xmm7
; AVX2-FP-NEXT:    vmovaps 32(%rsi), %xmm8
; AVX2-FP-NEXT:    vmovaps 64(%rsi), %xmm9
; AVX2-FP-NEXT:    vmovaps (%rdi), %xmm10
; AVX2-FP-NEXT:    vunpcklps {{.*#+}} xmm11 = xmm10[0],xmm7[0],xmm10[1],xmm7[1]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm11 = xmm11[0,1,3,2]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm12 = ymm11[0,1,1,1]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm6 = ymm12[0,1],ymm6[2,3],ymm12[4,5,6],ymm6[7]
; AVX2-FP-NEXT:    vmovaps 32(%rdi), %xmm12
; AVX2-FP-NEXT:    vinsertf128 $1, (%r8), %ymm11, %ymm11
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm6 = ymm11[0],ymm6[1,2,3],ymm11[4],ymm6[5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps 64(%rdi), %xmm6
; AVX2-FP-NEXT:    vunpckhps {{.*#+}} xmm7 = xmm10[2],xmm7[2],xmm10[3],xmm7[3]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm7 = xmm7[0,1,2,2]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[0,0,2,1]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[1,1,2,2]
; AVX2-FP-NEXT:    vblendps {{.*#+}} xmm0 = xmm0[0,1],xmm3[2],xmm0[3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm7[2,3],ymm0[4,5],ymm7[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm3 = ymm15[0,1,2,1]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm3[1],ymm0[2,3,4,5],ymm3[6],ymm0[7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vunpcklps {{.*#+}} xmm0 = xmm4[0],xmm1[0],xmm4[1],xmm1[1]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[0,1,2,2]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,0,2,1]
; AVX2-FP-NEXT:    vunpcklps {{.*#+}} xmm3 = xmm12[0],xmm8[0],xmm12[1],xmm8[1]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm3 = xmm3[0,1,3,2]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm7 = ymm3[0,1,1,1]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm7[0,1],ymm0[2,3],ymm7[4,5,6],ymm0[7]
; AVX2-FP-NEXT:    vinsertf128 $1, 32(%r8), %ymm3, %ymm3
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm3[0],ymm0[1,2,3],ymm3[4],ymm0[5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm12[2],xmm8[2],xmm12[3],xmm8[3]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[0,1,2,2]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,0,2,1]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[1,1,2,2]
; AVX2-FP-NEXT:    vblendps {{.*#+}} xmm1 = xmm1[0,1],xmm4[2],xmm1[3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1],ymm0[2,3],ymm1[4,5],ymm0[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm14[0,1,2,1]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm1[1],ymm0[2,3,4,5],ymm1[6],ymm0[7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vunpcklps {{.*#+}} xmm0 = xmm5[0],xmm2[0],xmm5[1],xmm2[1]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[0,1,2,2]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,0,2,1]
; AVX2-FP-NEXT:    vunpcklps {{.*#+}} xmm1 = xmm6[0],xmm9[0],xmm6[1],xmm9[1]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm1 = xmm1[0,1,3,2]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm3 = ymm1[0,1,1,1]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm3[0,1],ymm0[2,3],ymm3[4,5,6],ymm0[7]
; AVX2-FP-NEXT:    vinsertf128 $1, 64(%r8), %ymm1, %ymm1
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0],ymm0[1,2,3],ymm1[4],ymm0[5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm6[2],xmm9[2],xmm6[3],xmm9[3]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm0 = xmm0[0,1,2,2]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,0,2,1]
; AVX2-FP-NEXT:    vshufps {{.*#+}} xmm1 = xmm2[1,1,2,2]
; AVX2-FP-NEXT:    vblendps {{.*#+}} xmm1 = xmm1[0,1],xmm5[2],xmm1[3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1],ymm0[2,3],ymm1[4,5],ymm0[6,7]
...
; AVX2-FP-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps (%rsi), %ymm10
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm1 = ymm10[1,1,2,2,5,5,6,6]
...
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0],ymm0[1,2],ymm1[3,4],ymm0[5,6],ymm1[7]
; AVX2-FP-NEXT:    vunpckhps {{.*#+}} ymm1 = ymm10[2],ymm3[2],ymm10[3],ymm3[3],ymm10[6],ymm3[6],ymm10[7],ymm3[7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[3,3,3,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],ymm1[3,4],ymm0[5,6,7]
; AVX2-FP-NEXT:    vbroadcastsd 24(%r8), %ymm1
...
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps 32(%rdx), %ymm4
; AVX2-FP-NEXT:    vmovaps 32(%rcx), %ymm2
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm0 = ymm2[1,1,1,1,5,5,5,5]
; AVX2-FP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm4[1],ymm0[2,3,4],ymm4[5],ymm0[6,7]
; AVX2-FP-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FP-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps 64(%rsi), %ymm10
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm1 = ymm10[1,1,2,2,5,5,6,6]
; AVX2-FP-NEXT:    vmovups %ymm10, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0],ymm3[1,2],ymm1[3,4],ymm3[5,6],ymm1[7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[2,2,2,3]
...
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm14 = ymm1[1,1,1,1,5,5,5,5]
; AVX2-FP-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0],ymm3[1],ymm14[2,3,4],ymm3[5],ymm14[6,7]
; AVX2-FP-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[2,2,2,2]
; AVX2-FP-NEXT:    vmovaps 96(%rdi), %ymm2
; AVX2-FP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps 96(%rsi), %ymm10
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm15 = ymm10[1,1,2,2,5,5,6,6]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm15 = ymm15[0],ymm2[1,2],ymm15[3,4],ymm2[5,6],ymm15[7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm15[2,2,2,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm14 = ymm15[0,1,2],ymm14[3,4],ymm15[5,6,7]
; AVX2-FP-NEXT:    vbroadcastsd 112(%r8), %ymm15
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm15[0],ymm14[1,2,3,4],ymm15[5],ymm14[6,7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm14 = ymm1[0,2,3,3,4,6,7,7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm15 = ymm3[2,3,2,3,6,7,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm14 = ymm15[0],ymm14[1,2],ymm15[3,4],ymm14[5,6],ymm15[7]
; AVX2-FP-NEXT:    vunpckhps {{.*#+}} ymm15 = ymm10[2],ymm2[2],ymm10[3],ymm2[3],ymm10[6],ymm2[6],ymm10[7],ymm2[7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm15[3,3,3,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0,1,2],ymm15[3,4],ymm14[5,6,7]
; AVX2-FP-NEXT:    vbroadcastsd 120(%r8), %ymm15
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm14[0,1],ymm15[2],ymm14[3,4,5,6],ymm15[7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps 128(%rdx), %ymm0
; AVX2-FP-NEXT:    vmovaps 128(%rcx), %ymm2
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm14 = ymm2[1,1,1,1,5,5,5,5]
; AVX2-FP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0],ymm0[1],ymm14[2,3,4],ymm0[5],ymm14[6,7]
; AVX2-FP-NEXT:    vmovaps %ymm0, %ymm1
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[2,2,2,2]
; AVX2-FP-NEXT:    vmovaps 128(%rdi), %ymm3
; AVX2-FP-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps 128(%rsi), %ymm4
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm13 = ymm4[1,1,2,2,5,5,6,6]
; AVX2-FP-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0],ymm3[1,2],ymm13[3,4],ymm3[5,6],ymm13[7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[2,2,2,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0,1,2],ymm14[3,4],ymm13[5,6,7]
; AVX2-FP-NEXT:    vbroadcastsd 144(%r8), %ymm14
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm14[0],ymm13[1,2,3,4],ymm14[5],ymm13[6,7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm13 = ymm2[0,2,3,3,4,6,7,7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm14 = ymm1[2,3,2,3,6,7,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm13 = ymm14[0],ymm13[1,2],ymm14[3,4],ymm13[5,6],ymm14[7]
; AVX2-FP-NEXT:    vunpckhps {{.*#+}} ymm14 = ymm4[2],ymm3[2],ymm4[3],ymm3[3],ymm4[6],ymm3[6],ymm4[7],ymm3[7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[3,3,3,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0,1,2],ymm14[3,4],ymm13[5,6,7]
; AVX2-FP-NEXT:    vbroadcastsd 152(%r8), %ymm14
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm13[0,1],ymm14[2],ymm13[3,4,5,6],ymm14[7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps 160(%rdx), %ymm1
; AVX2-FP-NEXT:    vmovaps 160(%rcx), %ymm9
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm14 = ymm9[1,1,1,1,5,5,5,5]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0],ymm1[1],ymm14[2,3,4],ymm1[5],ymm14[6,7]
; AVX2-FP-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[2,2,2,2]
; AVX2-FP-NEXT:    vmovaps 160(%rdi), %ymm8
; AVX2-FP-NEXT:    vmovaps 160(%rsi), %ymm7
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm12 = ymm7[1,1,2,2,5,5,6,6]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0],ymm8[1,2],ymm12[3,4],ymm8[5,6],ymm12[7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm12 = ymm12[2,2,2,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0,1,2],ymm14[3,4],ymm12[5,6,7]
; AVX2-FP-NEXT:    vbroadcastsd 176(%r8), %ymm14
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm14[0],ymm12[1,2,3,4],ymm14[5],ymm12[6,7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm14 = ymm9[0,2,3,3,4,6,7,7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm12 = ymm1[2,3,2,3,6,7,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0],ymm14[1,2],ymm12[3,4],ymm14[5,6],ymm12[7]
; AVX2-FP-NEXT:    vunpckhps {{.*#+}} ymm14 = ymm7[2],ymm8[2],ymm7[3],ymm8[3],ymm7[6],ymm8[6],ymm7[7],ymm8[7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[3,3,3,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm12 = ymm12[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0,1,2],ymm14[3,4],ymm12[5,6,7]
; AVX2-FP-NEXT:    vbroadcastsd 184(%r8), %ymm14
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm12[0,1],ymm14[2],ymm12[3,4,5,6],ymm14[7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps 192(%rdx), %ymm14
; AVX2-FP-NEXT:    vmovaps 192(%rcx), %ymm6
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm12 = ymm6[1,1,1,1,5,5,5,5]
...
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm11 = ymm4[1,1,2,2,5,5,6,6]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0],ymm5[1,2],ymm11[3,4],ymm5[5,6],ymm11[7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm11 = ymm11[2,2,2,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0,1,2],ymm12[3,4],ymm11[5,6,7]
; AVX2-FP-NEXT:    vbroadcastsd 208(%r8), %ymm12
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm12[0],ymm11[1,2,3,4],ymm12[5],ymm11[6,7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm12 = ymm6[0,2,3,3,4,6,7,7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm11 = ymm14[2,3,2,3,6,7,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0],ymm12[1,2],ymm11[3,4],ymm12[5,6],ymm11[7]
; AVX2-FP-NEXT:    vunpckhps {{.*#+}} ymm12 = ymm4[2],ymm5[2],ymm4[3],ymm5[3],ymm4[6],ymm5[6],ymm4[7],ymm5[7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm12 = ymm12[3,3,3,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm11 = ymm11[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0,1,2],ymm12[3,4],ymm11[5,6,7]
; AVX2-FP-NEXT:    vbroadcastsd 216(%r8), %ymm12
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm11[0,1],ymm12[2],ymm11[3,4,5,6],ymm12[7]
; AVX2-FP-NEXT:    vmovups %ymm0, (%rsp) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps 224(%rdx), %ymm12
; AVX2-FP-NEXT:    vmovaps 224(%rcx), %ymm3
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm11 = ymm3[1,1,1,1,5,5,5,5]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0],ymm12[1],ymm11[2,3,4],ymm12[5],ymm11[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm11 = ymm11[2,2,2,2]
; AVX2-FP-NEXT:    vmovaps 224(%rdi), %ymm2
; AVX2-FP-NEXT:    vmovaps 224(%rsi), %ymm1
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm15 = ymm1[1,1,2,2,5,5,6,6]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm15 = ymm15[0],ymm2[1,2],ymm15[3,4],ymm2[5,6],ymm15[7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm15[2,2,2,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm11 = ymm15[0,1,2],ymm11[3,4],ymm15[5,6,7]
; AVX2-FP-NEXT:    vbroadcastsd 240(%r8), %ymm15
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm15[0],ymm11[1,2,3,4],ymm15[5],ymm11[6,7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm15 = ymm3[0,2,3,3,4,6,7,7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm11 = ymm12[2,3,2,3,6,7,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0],ymm15[1,2],ymm11[3,4],ymm15[5,6],ymm11[7]
; AVX2-FP-NEXT:    vunpckhps {{.*#+}} ymm15 = ymm1[2],ymm2[2],ymm1[3],ymm2[3],ymm1[6],ymm2[6],ymm1[7],ymm2[7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm15[3,3,3,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm11 = ymm11[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0,1,2],ymm15[3,4],ymm11[5,6,7]
; AVX2-FP-NEXT:    vbroadcastsd 248(%r8), %ymm15
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm11[0,1],ymm15[2],ymm11[3,4,5,6],ymm15[7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpermilps $227, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm15 = mem[3,0,2,3,7,4,6,7]
; AVX2-FP-NEXT:    vblendps $16, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15, %ymm15 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm15 = ymm15[0,1,2,3],mem[4],ymm15[5,6,7]
; AVX2-FP-NEXT:    vpermilps $52, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm0 = mem[0,1,3,0,4,5,7,4]
; AVX2-FP-NEXT:    vpermilps $78, {{[-0-9]+}}(%r{{[sb]}}p), %ymm11 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm11 = mem[2,3,0,1,6,7,4,5]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm11[0,1],ymm0[2],ymm11[3,4,5,6],ymm0[7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm15[0],ymm0[1,2,3],ymm15[4,5],ymm0[6,7]
; AVX2-FP-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm0 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm0 = ymm0[0,1,2],mem[3],ymm0[4,5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpermilps $227, {{[-0-9]+}}(%r{{[sb]}}p), %ymm11 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm11 = mem[3,0,2,3,7,4,6,7]
; AVX2-FP-NEXT:    vblendps $16, {{[-0-9]+}}(%r{{[sb]}}p), %ymm11, %ymm11 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm11 = ymm11[0,1,2,3],mem[4],ymm11[5,6,7]
; AVX2-FP-NEXT:    vpermilps $52, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm15 = mem[0,1,3,0,4,5,7,4]
; AVX2-FP-NEXT:    vpermilps $78, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm0 = mem[2,3,0,1,6,7,4,5]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm15[2],ymm0[3,4,5,6],ymm15[7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm11[0],ymm0[1,2,3],ymm11[4,5],ymm0[6,7]
; AVX2-FP-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm0 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm0 = ymm0[0,1,2],mem[3],ymm0[4,5,6,7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpermilps $227, {{[-0-9]+}}(%r{{[sb]}}p), %ymm11 # 32-byte Folded Reload
...
; AVX2-FP-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm0 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm0 = ymm0[0,1,2],mem[3],ymm0[4,5,6,7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm11 = ymm10[3,0,2,3,7,4,6,7]
; AVX2-FP-NEXT:    vblendps $16, {{[-0-9]+}}(%r{{[sb]}}p), %ymm11, %ymm11 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm11 = ymm11[0,1,2,3],mem[4],ymm11[5,6,7]
; AVX2-FP-NEXT:    vpermilps $52, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm15 = mem[0,1,3,0,4,5,7,4]
; AVX2-FP-NEXT:    vpermilps $78, {{[-0-9]+}}(%r{{[sb]}}p), %ymm10 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm10 = mem[2,3,0,1,6,7,4,5]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm10 = ymm10[0,1],ymm15[2],ymm10[3,4,5,6],ymm15[7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm10 = ymm11[0],ymm10[1,2,3],ymm11[4,5],ymm10[6,7]
; AVX2-FP-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm10, %ymm10 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm10 = ymm10[0,1,2],mem[3],ymm10[4,5,6,7]
; AVX2-FP-NEXT:    vpermilps $227, {{[-0-9]+}}(%r{{[sb]}}p), %ymm11 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm11 = mem[3,0,2,3,7,4,6,7]
; AVX2-FP-NEXT:    vblendps $16, {{[-0-9]+}}(%r{{[sb]}}p), %ymm11, %ymm11 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm11 = ymm11[0,1,2,3],mem[4],ymm11[5,6,7]
...
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0],ymm13[1,2,3],ymm11[4,5],ymm13[6,7]
; AVX2-FP-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm11, %ymm11 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm11 = ymm11[0,1,2],mem[3],ymm11[4,5,6,7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm7 = ymm7[3,0,2,3,7,4,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1,2,3],ymm8[4],ymm7[5,6,7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm8 = ymm9[0,1,3,0,4,5,7,4]
; AVX2-FP-NEXT:    vpermilps $78, {{[-0-9]+}}(%r{{[sb]}}p), %ymm9 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm9 = mem[2,3,0,1,6,7,4,5]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm8 = ymm9[0,1],ymm8[2],ymm9[3,4,5,6],ymm8[7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0],ymm8[1,2,3],ymm7[4,5],ymm8[6,7]
; AVX2-FP-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm7, %ymm7 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm7 = ymm7[0,1,2],mem[3],ymm7[4,5,6,7]
...
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm6 = ymm14[2,3,0,1,6,7,4,5]
...
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm1 = ymm1[3,0,2,3,7,4,6,7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2,3],ymm2[4],ymm1[5,6,7]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm2 = ymm3[0,1,3,0,4,5,7,4]
; AVX2-FP-NEXT:    vshufps {{.*#+}} ymm3 = ymm12[2,3,0,1,6,7,4,5]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm2 = ymm3[0,1],ymm2[2],ymm3[3,4,5,6],ymm2[7]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0],ymm2[1,2,3],ymm1[4,5],ymm2[6,7]
; AVX2-FP-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm1 # 32-byte Folded Reload
; AVX2-FP-NEXT:    # ymm1 = ymm1[0,1,2],mem[3],ymm1[4,5,6,7]
; AVX2-FP-NEXT:    vmovaps %ymm1, 1184(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm4, 1024(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm7, 864(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm11, 704(%r9)
; AVX2-FP-NEXT:    vmovaps %ymm10, 544(%r9)
...
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FP-NEXT:    vmovaps %ymm0, (%r9)
; AVX2-FP-NEXT:    addq $1800, %rsp # imm = 0x708
; AVX2-FP-NEXT:    vzeroupper
; AVX2-FP-NEXT:    retq
;
; AVX2-FCP-LABEL: store_i32_stride5_vf64:
; AVX2-FCP:       # %bb.0:
; AVX2-FCP-NEXT:    subq $1864, %rsp # imm = 0x748
...
; AVX2-FCP-NEXT:    vmovaps (%rcx), %xmm6
; AVX2-FCP-NEXT:    vmovaps 32(%rcx), %xmm12
; AVX2-FCP-NEXT:    vshufps {{.*#+}} xmm2 = xmm6[1,1,2,2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} xmm2 = xmm2[0,1],xmm15[2],xmm2[3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm2[0,1],ymm0[2,3],ymm2[4,5],ymm0[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm4[0,1,2,1]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm2[1],ymm0[2,3,4,5],ymm2[6],ymm0[7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm7[2],xmm8[2],xmm7[3],xmm8[3]
; AVX2-FCP-NEXT:    vpermps %ymm0, %ymm13, %ymm0
; AVX2-FCP-NEXT:    vshufps {{.*#+}} xmm2 = xmm12[1,1,2,2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} xmm2 = xmm2[0,1],xmm10[2],xmm2[3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm2[0,1],ymm0[2,3],ymm2[4,5],ymm0[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm3[0,1,2,1]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm2[1],ymm0[2,3,4,5],ymm2[6],ymm0[7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm5[2],xmm1[2],xmm5[3],xmm1[3]
; AVX2-FCP-NEXT:    vpermps %ymm0, %ymm13, %ymm0
; AVX2-FCP-NEXT:    vmovaps 64(%rdx), %xmm8
; AVX2-FCP-NEXT:    vmovaps 64(%rcx), %xmm9
; AVX2-FCP-NEXT:    vshufps {{.*#+}} xmm2 = xmm9[1,1,2,2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} xmm2 = xmm2[0,1],xmm8[2],xmm2[3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm2[0,1],ymm0[2,3],ymm2[4,5],ymm0[6,7]
...
; AVX2-FCP-NEXT:    vpermps %ymm2, %ymm13, %ymm0
; AVX2-FCP-NEXT:    vmovaps 96(%rdx), %xmm4
; AVX2-FCP-NEXT:    vmovaps 96(%rcx), %xmm3
; AVX2-FCP-NEXT:    vshufps {{.*#+}} xmm5 = xmm3[1,1,2,2]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} xmm5 = xmm5[0,1],xmm4[2],xmm5[3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm5[0,1,1,3]
...
; AVX2-FCP-NEXT:    vmovaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FCP-NEXT:    vunpckhps {{.*#+}} xmm0 = xmm0[2],xmm1[2],xmm0[3],xmm1[3]
; AVX2-FCP-NEXT:    vpermps %ymm0, %ymm13, %ymm2
...
; AVX2-FCP-NEXT:    vunpckhps {{.*#+}} ymm1 = ymm14[2],ymm6[2],ymm14[3],ymm6[3],ymm14[6],ymm6[6],ymm14[7],ymm6[7]
...
; AVX2-FCP-NEXT:    vunpcklps {{[-0-9]+}}(%r{{[sb]}}p), %xmm7, %xmm1 # 16-byte Folded Reload
; AVX2-FCP-NEXT:    # xmm1 = xmm7[0],mem[0],xmm7[1],mem[1]
; AVX2-FCP-NEXT:    vpermps %ymm0, %ymm13, %ymm0
; AVX2-FCP-NEXT:    vpermps %ymm1, %ymm11, %ymm5
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm5[0,1],ymm0[2,3],ymm5[4,5,6],ymm0[7]
...
; AVX2-FCP-NEXT:    vmovups %ymm5, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps 32(%rsi), %ymm6
...
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm1 = ymm7[2,3,2,3,6,7,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0],ymm0[1,2],ymm1[3,4],ymm0[5,6],ymm1[7]
; AVX2-FCP-NEXT:    vunpckhps {{.*#+}} ymm1 = ymm6[2],ymm5[2],ymm6[3],ymm5[3],ymm6[6],ymm5[6],ymm6[7],ymm5[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[3,3,3,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],ymm1[3,4],ymm0[5,6,7]
...
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm1[2],ymm0[3,4,5,6],ymm1[7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vunpcklps {{.*#+}} xmm0 = xmm8[0],xmm9[0],xmm8[1],xmm9[1]
; AVX2-FCP-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Reload
; AVX2-FCP-NEXT:    vunpcklps {{[-0-9]+}}(%r{{[sb]}}p), %xmm1, %xmm1 # 16-byte Folded Reload
; AVX2-FCP-NEXT:    # xmm1 = xmm1[0],mem[0],xmm1[1],mem[1]
; AVX2-FCP-NEXT:    vpermps %ymm0, %ymm13, %ymm0
...
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm1 = ymm9[1,1,2,2,5,5,6,6]
; AVX2-FCP-NEXT:    vmovups %ymm9, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0],ymm6[1,2],ymm1[3,4],ymm6[5,6],ymm1[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[2,2,2,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1,2],ymm0[3,4],ymm1[5,6,7]
...
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm1 = ymm2[2,3,2,3,6,7,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0],ymm0[1,2],ymm1[3,4],ymm0[5,6],ymm1[7]
; AVX2-FCP-NEXT:    vunpckhps {{.*#+}} ymm1 = ymm9[2],ymm6[2],ymm9[3],ymm6[3],ymm9[6],ymm6[6],ymm9[7],ymm6[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[3,3,3,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],ymm1[3,4],ymm0[5,6,7]
...
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm1[2],ymm0[3,4,5,6],ymm1[7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vunpcklps {{.*#+}} xmm0 = xmm4[0],xmm3[0],xmm4[1],xmm3[1]
; AVX2-FCP-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Reload
; AVX2-FCP-NEXT:    vunpcklps {{[-0-9]+}}(%r{{[sb]}}p), %xmm1, %xmm1 # 16-byte Folded Reload
; AVX2-FCP-NEXT:    # xmm1 = xmm1[0],mem[0],xmm1[1],mem[1]
; AVX2-FCP-NEXT:    vpermps %ymm0, %ymm13, %ymm0
...
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0],ymm4[1,2],ymm1[3,4],ymm4[5,6],ymm1[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[2,2,2,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1,2],ymm0[3,4],ymm1[5,6,7]
...
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm1 = ymm2[2,3,2,3,6,7,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0],ymm0[1,2],ymm1[3,4],ymm0[5,6],ymm1[7]
; AVX2-FCP-NEXT:    vunpckhps {{.*#+}} ymm1 = ymm7[2],ymm4[2],ymm7[3],ymm4[3],ymm7[6],ymm4[6],ymm7[7],ymm4[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[3,3,3,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],ymm1[3,4],ymm0[5,6,7]
...
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm15 = ymm4[1,1,2,2,5,5,6,6]
; AVX2-FCP-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm15 = ymm15[0],ymm3[1,2],ymm15[3,4],ymm3[5,6],ymm15[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm15[2,2,2,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm15[0,1,2],ymm0[3,4],ymm15[5,6,7]
; AVX2-FCP-NEXT:    vbroadcastsd 144(%r8), %ymm15
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm15[0],ymm0[1,2,3,4],ymm15[5],ymm0[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm0 = ymm2[0,2,3,3,4,6,7,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm15 = ymm1[2,3,2,3,6,7,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm15[0],ymm0[1,2],ymm15[3,4],ymm0[5,6],ymm15[7]
; AVX2-FCP-NEXT:    vunpckhps {{.*#+}} ymm15 = ymm4[2],ymm3[2],ymm4[3],ymm3[3],ymm4[6],ymm3[6],ymm4[7],ymm3[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm15[3,3,3,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1,2],ymm15[3,4],ymm0[5,6,7]
; AVX2-FCP-NEXT:    vbroadcastsd 152(%r8), %ymm15
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm15[2],ymm0[3,4,5,6],ymm15[7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FCP-NEXT:    # xmm0 = xmm0[0],mem[0],xmm0[1],mem[1]
; AVX2-FCP-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Reload
; AVX2-FCP-NEXT:    vunpcklps {{[-0-9]+}}(%r{{[sb]}}p), %xmm1, %xmm15 # 16-byte Folded Reload
; AVX2-FCP-NEXT:    # xmm15 = xmm1[0],mem[0],xmm1[1],mem[1]
; AVX2-FCP-NEXT:    vpermps %ymm0, %ymm13, %ymm0
; AVX2-FCP-NEXT:    vpermps %ymm15, %ymm11, %ymm12
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm12[0,1],ymm0[2,3],ymm12[4,5,6],ymm0[7]
; AVX2-FCP-NEXT:    vinsertf128 $1, 160(%r8), %ymm15, %ymm12
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm12[0],ymm0[1,2,3],ymm12[4],ymm0[5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps 160(%rdx), %ymm0
; AVX2-FCP-NEXT:    vmovaps 160(%rcx), %ymm2
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm15 = ymm2[1,1,1,1,5,5,5,5]
; AVX2-FCP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm15 = ymm15[0],ymm0[1],ymm15[2,3,4],ymm0[5],ymm15[6,7]
...
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm14 = ymm5[1,1,2,2,5,5,6,6]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0],ymm6[1,2],ymm14[3,4],ymm6[5,6],ymm14[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[2,2,2,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0,1,2],ymm15[3,4],ymm14[5,6,7]
; AVX2-FCP-NEXT:    vbroadcastsd 176(%r8), %ymm15
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm15[0],ymm14[1,2,3,4],ymm15[5],ymm14[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm14 = ymm2[0,2,3,3,4,6,7,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm15 = ymm1[2,3,2,3,6,7,6,7]
...
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm14 = ymm14[0,1,2],ymm15[3,4],ymm14[5,6,7]
; AVX2-FCP-NEXT:    vbroadcastsd 184(%r8), %ymm15
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm14[0,1],ymm15[2],ymm14[3,4,5,6],ymm15[7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX2-FCP-NEXT:    vunpcklps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm14 # 16-byte Folded Reload
; AVX2-FCP-NEXT:    # xmm14 = xmm0[0],mem[0],xmm0[1],mem[1]
; AVX2-FCP-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX2-FCP-NEXT:    vunpcklps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm15 # 16-byte Folded Reload
; AVX2-FCP-NEXT:    # xmm15 = xmm0[0],mem[0],xmm0[1],mem[1]
; AVX2-FCP-NEXT:    vpermps %ymm14, %ymm13, %ymm14
; AVX2-FCP-NEXT:    vpermps %ymm15, %ymm11, %ymm11
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0,1],ymm14[2,3],ymm11[4,5,6],ymm14[7]
; AVX2-FCP-NEXT:    vinsertf128 $1, 192(%r8), %ymm15, %ymm14
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm14[0],ymm11[1,2,3],ymm14[4],ymm11[5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps 192(%rdx), %ymm14
; AVX2-FCP-NEXT:    vmovaps 192(%rcx), %ymm15
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm11 = ymm15[1,1,1,1,5,5,5,5]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0],ymm14[1],ymm11[2,3,4],ymm14[5],ymm11[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm11 = ymm11[2,2,2,2]
; AVX2-FCP-NEXT:    vmovaps 192(%rdi), %ymm4
; AVX2-FCP-NEXT:    vmovaps 192(%rsi), %ymm3
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm10 = ymm3[1,1,2,2,5,5,6,6]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm10 = ymm10[0],ymm4[1,2],ymm10[3,4],ymm4[5,6],ymm10[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm10 = ymm10[2,2,2,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm10 = ymm10[0,1,2],ymm11[3,4],ymm10[5,6,7]
; AVX2-FCP-NEXT:    vbroadcastsd 208(%r8), %ymm11
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm11[0],ymm10[1,2,3,4],ymm11[5],ymm10[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm11 = ymm15[0,2,3,3,4,6,7,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm10 = ymm14[2,3,2,3,6,7,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm10 = ymm10[0],ymm11[1,2],ymm10[3,4],ymm11[5,6],ymm10[7]
; AVX2-FCP-NEXT:    vunpckhps {{.*#+}} ymm11 = ymm3[2],ymm4[2],ymm3[3],ymm4[3],ymm3[6],ymm4[6],ymm3[7],ymm4[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm11 = ymm11[3,3,3,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm10 = ymm10[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm10 = ymm10[0,1,2],ymm11[3,4],ymm10[5,6,7]
; AVX2-FCP-NEXT:    vbroadcastsd 216(%r8), %ymm11
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm10[0,1],ymm11[2],ymm10[3,4,5,6],ymm11[7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX2-FCP-NEXT:    vunpcklps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm11 # 16-byte Folded Reload
; AVX2-FCP-NEXT:    # xmm11 = xmm0[0],mem[0],xmm0[1],mem[1]
...
; AVX2-FCP-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX2-FCP-NEXT:    vunpcklps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0, %xmm13 # 16-byte Folded Reload
; AVX2-FCP-NEXT:    # xmm13 = xmm0[0],mem[0],xmm0[1],mem[1]
; AVX2-FCP-NEXT:    vpermps %ymm13, %ymm8, %ymm10
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm10 = ymm10[0,1],ymm11[2,3],ymm10[4,5,6],ymm11[7]
; AVX2-FCP-NEXT:    vinsertf128 $1, 224(%r8), %ymm13, %ymm11
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm11[0],ymm10[1,2,3],ymm11[4],ymm10[5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps 224(%rdx), %ymm11
; AVX2-FCP-NEXT:    vmovaps 224(%rcx), %ymm13
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm10 = ymm13[1,1,1,1,5,5,5,5]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm10 = ymm10[0],ymm11[1],ymm10[2,3,4],ymm11[5],ymm10[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm10 = ymm10[2,2,2,2]
; AVX2-FCP-NEXT:    vmovaps 224(%rdi), %ymm2
; AVX2-FCP-NEXT:    vmovaps 224(%rsi), %ymm1
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm9 = ymm1[1,1,2,2,5,5,6,6]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0],ymm2[1,2],ymm9[3,4],ymm2[5,6],ymm9[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm9 = ymm9[2,2,2,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0,1,2],ymm10[3,4],ymm9[5,6,7]
; AVX2-FCP-NEXT:    vbroadcastsd 240(%r8), %ymm10
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm10[0],ymm9[1,2,3,4],ymm10[5],ymm9[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm10 = ymm13[0,2,3,3,4,6,7,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm9 = ymm11[2,3,2,3,6,7,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0],ymm10[1,2],ymm9[3,4],ymm10[5,6],ymm9[7]
; AVX2-FCP-NEXT:    vunpckhps {{.*#+}} ymm10 = ymm1[2],ymm2[2],ymm1[3],ymm2[3],ymm1[6],ymm2[6],ymm1[7],ymm2[7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm10 = ymm10[3,3,3,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm9 = ymm9[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0,1,2],ymm10[3,4],ymm9[5,6,7]
; AVX2-FCP-NEXT:    vbroadcastsd 248(%r8), %ymm10
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm9[0,1],ymm10[2],ymm9[3,4,5,6],ymm10[7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpermilps $227, {{[-0-9]+}}(%r{{[sb]}}p), %ymm10 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm10 = mem[3,0,2,3,7,4,6,7]
; AVX2-FCP-NEXT:    vblendps $16, {{[-0-9]+}}(%r{{[sb]}}p), %ymm10, %ymm10 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm10 = ymm10[0,1,2,3],mem[4],ymm10[5,6,7]
; AVX2-FCP-NEXT:    vpermilps $52, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm0 = mem[0,1,3,0,4,5,7,4]
; AVX2-FCP-NEXT:    vpermilps $78, {{[-0-9]+}}(%r{{[sb]}}p), %ymm9 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm9 = mem[2,3,0,1,6,7,4,5]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm9[0,1],ymm0[2],ymm9[3,4,5,6],ymm0[7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm10[0],ymm0[1,2,3],ymm10[4,5],ymm0[6,7]
; AVX2-FCP-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm0 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm0 = ymm0[0,1,2],mem[3],ymm0[4,5,6,7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpermilps $227, {{[-0-9]+}}(%r{{[sb]}}p), %ymm9 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm9 = mem[3,0,2,3,7,4,6,7]
; AVX2-FCP-NEXT:    vblendps $16, {{[-0-9]+}}(%r{{[sb]}}p), %ymm9, %ymm9 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm9 = ymm9[0,1,2,3],mem[4],ymm9[5,6,7]
; AVX2-FCP-NEXT:    vpermilps $52, {{[-0-9]+}}(%r{{[sb]}}p), %ymm10 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm10 = mem[0,1,3,0,4,5,7,4]
; AVX2-FCP-NEXT:    vpermilps $78, {{[-0-9]+}}(%r{{[sb]}}p), %ymm8 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm8 = mem[2,3,0,1,6,7,4,5]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1],ymm10[2],ymm8[3,4,5,6],ymm10[7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm8 = ymm9[0],ymm8[1,2,3],ymm9[4,5],ymm8[6,7]
; AVX2-FCP-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm8, %ymm8 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm8 = ymm8[0,1,2],mem[3],ymm8[4,5,6,7]
; AVX2-FCP-NEXT:    vpermilps $227, {{[-0-9]+}}(%r{{[sb]}}p), %ymm9 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm9 = mem[3,0,2,3,7,4,6,7]
; AVX2-FCP-NEXT:    vblendps $16, {{[-0-9]+}}(%r{{[sb]}}p), %ymm9, %ymm9 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm9 = ymm9[0,1,2,3],mem[4],ymm9[5,6,7]
; AVX2-FCP-NEXT:    vpermilps $52, {{[-0-9]+}}(%r{{[sb]}}p), %ymm10 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm10 = mem[0,1,3,0,4,5,7,4]
; AVX2-FCP-NEXT:    vpermilps $78, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm0 = mem[2,3,0,1,6,7,4,5]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm10[2],ymm0[3,4,5,6],ymm10[7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm9[0],ymm0[1,2,3],ymm9[4,5],ymm0[6,7]
; AVX2-FCP-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm0, %ymm0 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm0 = ymm0[0,1,2],mem[3],ymm0[4,5,6,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm9 = ymm7[3,0,2,3,7,4,6,7]
; AVX2-FCP-NEXT:    vblendps $16, {{[-0-9]+}}(%r{{[sb]}}p), %ymm9, %ymm9 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm9 = ymm9[0,1,2,3],mem[4],ymm9[5,6,7]
; AVX2-FCP-NEXT:    vpermilps $52, {{[-0-9]+}}(%r{{[sb]}}p), %ymm10 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm10 = mem[0,1,3,0,4,5,7,4]
; AVX2-FCP-NEXT:    vpermilps $78, {{[-0-9]+}}(%r{{[sb]}}p), %ymm7 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm7 = mem[2,3,0,1,6,7,4,5]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1],ymm10[2],ymm7[3,4,5,6],ymm10[7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm7 = ymm9[0],ymm7[1,2,3],ymm9[4,5],ymm7[6,7]
...
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm10 = ymm12[0,1],ymm10[2],ymm12[3,4,5,6],ymm10[7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0],ymm10[1,2,3],ymm9[4,5],ymm10[6,7]
; AVX2-FCP-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm9, %ymm9 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm9 = ymm9[0,1,2],mem[3],ymm9[4,5,6,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm5 = ymm5[3,0,2,3,7,4,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0,1,2,3],ymm6[4],ymm5[5,6,7]
; AVX2-FCP-NEXT:    vpermilps $52, {{[-0-9]+}}(%r{{[sb]}}p), %ymm6 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm6 = mem[0,1,3,0,4,5,7,4]
; AVX2-FCP-NEXT:    vpermilps $78, (%rsp), %ymm10 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm10 = mem[2,3,0,1,6,7,4,5]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm6 = ymm10[0,1],ymm6[2],ymm10[3,4,5,6],ymm6[7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0],ymm6[1,2,3],ymm5[4,5],ymm6[6,7]
; AVX2-FCP-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm5, %ymm5 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm5 = ymm5[0,1,2],mem[3],ymm5[4,5,6,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm3 = ymm3[3,0,2,3,7,4,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1,2,3],ymm4[4],ymm3[5,6,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm4 = ymm15[0,1,3,0,4,5,7,4]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm6 = ymm14[2,3,0,1,6,7,4,5]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm4 = ymm6[0,1],ymm4[2],ymm6[3,4,5,6],ymm4[7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0],ymm4[1,2,3],ymm3[4,5],ymm4[6,7]
; AVX2-FCP-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm3, %ymm3 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm3 = ymm3[0,1,2],mem[3],ymm3[4,5,6,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm1 = ymm1[3,0,2,3,7,4,6,7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1,2,3],ymm2[4],ymm1[5,6,7]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm2 = ymm13[0,1,3,0,4,5,7,4]
; AVX2-FCP-NEXT:    vshufps {{.*#+}} ymm4 = ymm11[2,3,0,1,6,7,4,5]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm4[0,1],ymm2[2],ymm4[3,4,5,6],ymm2[7]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0],ymm2[1,2,3],ymm1[4,5],ymm2[6,7]
; AVX2-FCP-NEXT:    vblendps $8, {{[-0-9]+}}(%r{{[sb]}}p), %ymm1, %ymm1 # 32-byte Folded Reload
; AVX2-FCP-NEXT:    # ymm1 = ymm1[0,1,2],mem[3],ymm1[4,5,6,7]
; AVX2-FCP-NEXT:    vmovaps %ymm1, 1184(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm3, 1024(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm5, 864(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm9, 704(%r9)
; AVX2-FCP-NEXT:    vmovaps %ymm7, 544(%r9)
...
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX2-FCP-NEXT:    vmovaps %ymm0, 32(%r9)
; AVX2-FCP-NEXT:    addq $1864, %rsp # imm = 0x748
; AVX2-FCP-NEXT:    vzeroupper
; AVX2-FCP-NEXT:    retq
;
...
; AVX512-NEXT:    vmovdqa64 64(%rdx), %zmm2
...
; AVX512-NEXT:    # zmm7 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [14,30,0,13,29,15,31,0,14,30,0,13,29,15,31,0]
; AVX512-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vmovdqa64 %zmm15, %zmm3
; AVX512-NEXT:    vpermt2d %zmm17, %zmm1, %zmm3
; AVX512-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-NEXT:    vmovdqa64 %zmm1, %zmm3
; AVX512-NEXT:    vbroadcasti64x4 {{.*#+}} zmm16 = [0,13,29,15,31,0,14,30,0,13,29,15,31,0,14,30]
; AVX512-NEXT:    # zmm16 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vmovdqa64 %zmm23, %zmm1
; AVX512-NEXT:    vpermt2d %zmm18, %zmm16, %zmm1
; AVX512-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [27,0,10,26,12,28,0,11,27,0,10,26,12,28,0,11]
; AVX512-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vmovdqa64 %zmm23, %zmm5
; AVX512-NEXT:    vpermt2d %zmm18, %zmm1, %zmm5
...
; AVX512-NEXT:    vpermt2d %zmm17, %zmm13, %zmm20
; AVX512-NEXT:    vbroadcasti64x4 {{.*#+}} zmm30 = [0,3,19,5,21,0,4,20,0,3,19,5,21,0,4,20]
; AVX512-NEXT:    # zmm30 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vmovdqa64 %zmm15, %zmm5
; AVX512-NEXT:    vpermt2d %zmm17, %zmm30, %zmm5
; AVX512-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-NEXT:    vpermt2d %zmm17, %zmm28, %zmm15
; AVX512-NEXT:    vmovdqa64 %zmm29, %zmm5
; AVX512-NEXT:    vpermt2d %zmm24, %zmm3, %zmm5
; AVX512-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-NEXT:    vmovdqa64 %zmm24, %zmm17
; AVX512-NEXT:    vpermt2d %zmm29, %zmm14, %zmm17
; AVX512-NEXT:    vmovdqa64 %zmm29, %zmm27
; AVX512-NEXT:    vpermt2d %zmm24, %zmm13, %zmm27
; AVX512-NEXT:    vmovdqa64 %zmm29, %zmm5
; AVX512-NEXT:    vpermt2d %zmm24, %zmm30, %zmm5
; AVX512-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-NEXT:    vpermt2d %zmm24, %zmm28, %zmm29
; AVX512-NEXT:    vmovdqa64 %zmm2, %zmm5
; AVX512-NEXT:    vmovdqa64 %zmm25, %zmm24
; AVX512-NEXT:    vpermt2d %zmm2, %zmm14, %zmm24
; AVX512-NEXT:    vmovdqa64 %zmm2, %zmm26
; AVX512-NEXT:    vmovdqa64 %zmm2, %zmm6
; AVX512-NEXT:    vpermt2d %zmm25, %zmm28, %zmm2
...
; AVX512-NEXT:    # zmm28 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vpermt2d %zmm25, %zmm3, %zmm5
; AVX512-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-NEXT:    vpermt2d %zmm25, %zmm13, %zmm26
; AVX512-NEXT:    vpermt2d %zmm25, %zmm30, %zmm6
; AVX512-NEXT:    vmovdqu64 %zmm6, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-NEXT:    vmovdqa64 %zmm23, %zmm22
; AVX512-NEXT:    vpermt2d %zmm18, %zmm28, %zmm22
; AVX512-NEXT:    vpermi2d %zmm21, %zmm0, %zmm3
; AVX512-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-NEXT:    vpermi2d %zmm0, %zmm21, %zmm14
; AVX512-NEXT:    vpermi2d %zmm21, %zmm0, %zmm13
; AVX512-NEXT:    vpermt2d %zmm21, %zmm30, %zmm0
; AVX512-NEXT:    vmovdqu64 %zmm0, (%rsp) # 64-byte Spill
; AVX512-NEXT:    vbroadcasti64x4 {{.*#+}} zmm3 = [3,21,5,0,20,4,22,6,3,21,5,0,20,4,22,6]
; AVX512-NEXT:    # zmm3 = mem[0,1,2,3,0,1,2,3]
; AVX512-NEXT:    vmovdqa64 %zmm18, %zmm21
; AVX512-NEXT:    vpermt2d %zmm23, %zmm3, %zmm21
; AVX512-NEXT:    vpermt2d %zmm18, %zmm7, %zmm23
; AVX512-NEXT:    vmovdqa64 128(%rsi), %zmm25
; AVX512-NEXT:    vmovdqa64 %zmm19, %zmm18
; AVX512-NEXT:    vpermt2d %zmm25, %zmm16, %zmm18
; AVX512-NEXT:    vmovdqa64 %zmm19, %zmm12
; AVX512-NEXT:    vpermt2d %zmm25, %zmm1, %zmm12
; AVX512-NEXT:    vmovdqa64 %zmm19, %zmm11
; AVX512-NEXT:    vpermt2d %zmm25, %zmm28, %zmm11
; AVX512-NEXT:    vmovdqa64 %zmm25, %zmm30
; AVX512-NEXT:    vpermt2d %zmm19, %zmm3, %zmm30
; AVX512-NEXT:    vpermt2d %zmm25, %zmm7, %zmm19
; AVX512-NEXT:    vmovdqa64 (%rdi), %zmm25
; AVX512-NEXT:    vmovdqa64 (%rsi), %zmm2
; AVX512-NEXT:    vmovdqa64 %zmm25, %zmm8
; AVX512-NEXT:    vpermt2d %zmm2, %zmm7, %zmm8
; AVX512-NEXT:    vmovdqa64 64(%rdi), %zmm5
; AVX512-NEXT:    vmovdqa64 64(%rsi), %zmm0
; AVX512-NEXT:    vmovdqa64 %zmm0, %zmm4
; AVX512-NEXT:    vpermt2d %zmm5, %zmm3, %zmm4
; AVX512-NEXT:    vmovdqa64 %zmm5, %zmm6
; AVX512-NEXT:    vmovdqa64 %zmm5, %zmm10
; AVX512-NEXT:    vmovdqa64 %zmm5, %zmm9
; AVX512-NEXT:    vpermt2d %zmm0, %zmm7, %zmm5
; AVX512-NEXT:    vpermt2d %zmm0, %zmm16, %zmm6
; AVX512-NEXT:    vpermt2d %zmm0, %zmm1, %zmm10
; AVX512-NEXT:    vpermt2d %zmm0, %zmm28, %zmm9
; AVX512-NEXT:    vpermi2d %zmm2, %zmm25, %zmm16
; AVX512-NEXT:    vpermi2d %zmm2, %zmm25, %zmm1
; AVX512-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-NEXT:    vpermi2d %zmm2, %zmm25, %zmm28
; AVX512-NEXT:    vpermt2d %zmm25, %zmm3, %zmm2
; AVX512-NEXT:    movw $12684, %ax # imm = 0x318C
; AVX512-NEXT:    kmovw %eax, %k1
...
; AVX512-NEXT:    vmovdqa32 %zmm22, %zmm20 {%k2}
; AVX512-NEXT:    movw $6342, %ax # imm = 0x18C6
; AVX512-NEXT:    kmovw %eax, %k3
; AVX512-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512-NEXT:    vmovdqa32 %zmm0, %zmm21 {%k3}
; AVX512-NEXT:    vmovdqa32 %zmm15, %zmm23 {%k1}
; AVX512-NEXT:    vmovdqa64 192(%r8), %zmm0
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm1 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
; AVX512-NEXT:    vpermt2d %zmm0, %zmm1, %zmm3
; AVX512-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm15 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
; AVX512-NEXT:    vpermt2d %zmm0, %zmm15, %zmm31
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm22 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512-NEXT:    vpermt2d %zmm0, %zmm22, %zmm20
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm25 = [0,1,2,19,4,5,6,7,20,9,10,11,12,21,14,15]
; AVX512-NEXT:    vpermt2d %zmm0, %zmm25, %zmm21
; AVX512-NEXT:    vpmovsxbd {{.*#+}} zmm3 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
; AVX512-NEXT:    vpermt2d %zmm0, %zmm3, %zmm23
; AVX512-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512-NEXT:    vmovdqa32 %zmm0, %zmm18 {%k2}
; AVX512-NEXT:    vmovdqa32 %zmm12, %zmm17 {%k1}
; AVX512-NEXT:    vmovdqa32 %zmm11, %zmm27 {%k2}
; AVX512-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512-NEXT:    vmovdqa32 %zmm0, %zmm30 {%k3}
; AVX512-NEXT:    vmovdqa32 %zmm29, %zmm19 {%k1}
; AVX512-NEXT:    vmovdqa64 128(%r8), %zmm0
; AVX512-NEXT:    vpermt2d %zmm0, %zmm1, %zmm18
; AVX512-NEXT:    vpermt2d %zmm0, %zmm15, %zmm17
; AVX512-NEXT:    vpermt2d %zmm0, %zmm22, %zmm27
; AVX512-NEXT:    vpermt2d %zmm0, %zmm25, %zmm30
; AVX512-NEXT:    vpermt2d %zmm0, %zmm3, %zmm19
; AVX512-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512-NEXT:    vmovdqa32 %zmm0, %zmm6 {%k2}
; AVX512-NEXT:    vmovdqa32 %zmm10, %zmm24 {%k1}
; AVX512-NEXT:    vmovdqa32 %zmm9, %zmm26 {%k2}
; AVX512-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512-NEXT:    vmovdqa32 %zmm0, %zmm4 {%k3}
...
; AVX512-NEXT:    vpermt2d %zmm0, %zmm3, %zmm8
; AVX512-NEXT:    vpermt2d %zmm7, %zmm3, %zmm5
; AVX512-NEXT:    vpermt2d %zmm7, %zmm1, %zmm6
; AVX512-NEXT:    vpermt2d %zmm7, %zmm15, %zmm24
; AVX512-NEXT:    vpermt2d %zmm7, %zmm22, %zmm26
; AVX512-NEXT:    vpermt2d %zmm7, %zmm25, %zmm4
; AVX512-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm3 # 64-byte Reload
; AVX512-NEXT:    vmovdqa32 %zmm3, %zmm16 {%k2}
; AVX512-NEXT:    vpermt2d %zmm0, %zmm1, %zmm16
; AVX512-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm1 # 64-byte Reload
; AVX512-NEXT:    vmovdqa32 %zmm1, %zmm14 {%k1}
; AVX512-NEXT:    vpermt2d %zmm0, %zmm15, %zmm14
; AVX512-NEXT:    vmovdqa32 %zmm28, %zmm13 {%k2}
; AVX512-NEXT:    vpermt2d %zmm0, %zmm22, %zmm13
; AVX512-NEXT:    vmovdqu64 (%rsp), %zmm1 # 64-byte Reload
; AVX512-NEXT:    vmovdqa32 %zmm1, %zmm2 {%k3}
; AVX512-NEXT:    vpermt2d %zmm0, %zmm25, %zmm2
; AVX512-NEXT:    vmovdqa64 %zmm2, 64(%r9)
; AVX512-NEXT:    vmovdqa64 %zmm13, 128(%r9)
; AVX512-NEXT:    vmovdqa64 %zmm14, 192(%r9)
; AVX512-NEXT:    vmovdqa64 %zmm16, 256(%r9)
; AVX512-NEXT:    vmovdqa64 %zmm5, 320(%r9)
...
; AVX512-FCP-NEXT:    vmovdqa64 64(%rdx), %zmm2
...
; AVX512-FCP-NEXT:    # zmm7 = mem[0,1,2,3,0,1,2,3]
; AVX512-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [14,30,0,13,29,15,31,0,14,30,0,13,29,15,31,0]
; AVX512-FCP-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512-FCP-NEXT:    vmovdqa64 %zmm15, %zmm3
; AVX512-FCP-NEXT:    vpermt2d %zmm17, %zmm1, %zmm3
; AVX512-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vmovdqa64 %zmm1, %zmm3
; AVX512-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm16 = [0,13,29,15,31,0,14,30,0,13,29,15,31,0,14,30]
; AVX512-FCP-NEXT:    # zmm16 = mem[0,1,2,3,0,1,2,3]
; AVX512-FCP-NEXT:    vmovdqa64 %zmm23, %zmm1
; AVX512-FCP-NEXT:    vpermt2d %zmm18, %zmm16, %zmm1
; AVX512-FCP-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [27,0,10,26,12,28,0,11,27,0,10,26,12,28,0,11]
; AVX512-FCP-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512-FCP-NEXT:    vmovdqa64 %zmm23, %zmm5
; AVX512-FCP-NEXT:    vpermt2d %zmm18, %zmm1, %zmm5
...
; AVX512-FCP-NEXT:    vpermt2d %zmm17, %zmm13, %zmm20
...
; AVX512-FCP-NEXT:    vpermt2d %zmm17, %zmm30, %zmm5
; AVX512-FCP-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vpermt2d %zmm17, %zmm28, %zmm15
; AVX512-FCP-NEXT:    vmovdqa64 %zmm29, %zmm5
; AVX512-FCP-NEXT:    vpermt2d %zmm24, %zmm3, %zmm5
; AVX512-FCP-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vmovdqa64 %zmm24, %zmm17
; AVX512-FCP-NEXT:    vpermt2d %zmm29, %zmm14, %zmm17
...
; AVX512-FCP-NEXT:    vpermt2d %zmm2, %zmm14, %zmm24
; AVX512-FCP-NEXT:    vmovdqa64 %zmm2, %zmm26
; AVX512-FCP-NEXT:    vmovdqa64 %zmm2, %zmm6
; AVX512-FCP-NEXT:    vpermt2d %zmm25, %zmm28, %zmm2
...
; AVX512-FCP-NEXT:    # zmm28 = mem[0,1,2,3,0,1,2,3]
; AVX512-FCP-NEXT:    vpermt2d %zmm25, %zmm3, %zmm5
; AVX512-FCP-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vpermt2d %zmm25, %zmm13, %zmm26
; AVX512-FCP-NEXT:    vpermt2d %zmm25, %zmm30, %zmm6
; AVX512-FCP-NEXT:    vmovdqu64 %zmm6, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vmovdqa64 %zmm23, %zmm22
; AVX512-FCP-NEXT:    vpermt2d %zmm18, %zmm28, %zmm22
; AVX512-FCP-NEXT:    vpermi2d %zmm21, %zmm0, %zmm3
; AVX512-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vpermi2d %zmm0, %zmm21, %zmm14
; AVX512-FCP-NEXT:    vpermi2d %zmm21, %zmm0, %zmm13
; AVX512-FCP-NEXT:    vpermt2d %zmm21, %zmm30, %zmm0
; AVX512-FCP-NEXT:    vmovdqu64 %zmm0, (%rsp) # 64-byte Spill
; AVX512-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm3 = [3,21,5,0,20,4,22,6,3,21,5,0,20,4,22,6]
; AVX512-FCP-NEXT:    # zmm3 = mem[0,1,2,3,0,1,2,3]
; AVX512-FCP-NEXT:    vmovdqa64 %zmm18, %zmm21
; AVX512-FCP-NEXT:    vpermt2d %zmm23, %zmm3, %zmm21
; AVX512-FCP-NEXT:    vpermt2d %zmm18, %zmm7, %zmm23
; AVX512-FCP-NEXT:    vmovdqa64 128(%rsi), %zmm25
; AVX512-FCP-NEXT:    vmovdqa64 %zmm19, %zmm18
; AVX512-FCP-NEXT:    vpermt2d %zmm25, %zmm16, %zmm18
; AVX512-FCP-NEXT:    vmovdqa64 %zmm19, %zmm12
; AVX512-FCP-NEXT:    vpermt2d %zmm25, %zmm1, %zmm12
; AVX512-FCP-NEXT:    vmovdqa64 %zmm19, %zmm11
; AVX512-FCP-NEXT:    vpermt2d %zmm25, %zmm28, %zmm11
; AVX512-FCP-NEXT:    vmovdqa64 %zmm25, %zmm30
; AVX512-FCP-NEXT:    vpermt2d %zmm19, %zmm3, %zmm30
; AVX512-FCP-NEXT:    vpermt2d %zmm25, %zmm7, %zmm19
; AVX512-FCP-NEXT:    vmovdqa64 (%rdi), %zmm25
; AVX512-FCP-NEXT:    vmovdqa64 (%rsi), %zmm2
; AVX512-FCP-NEXT:    vmovdqa64 %zmm25, %zmm8
; AVX512-FCP-NEXT:    vpermt2d %zmm2, %zmm7, %zmm8
; AVX512-FCP-NEXT:    vmovdqa64 64(%rdi), %zmm5
; AVX512-FCP-NEXT:    vmovdqa64 64(%rsi), %zmm0
; AVX512-FCP-NEXT:    vmovdqa64 %zmm0, %zmm4
; AVX512-FCP-NEXT:    vpermt2d %zmm5, %zmm3, %zmm4
; AVX512-FCP-NEXT:    vmovdqa64 %zmm5, %zmm6
; AVX512-FCP-NEXT:    vmovdqa64 %zmm5, %zmm10
; AVX512-FCP-NEXT:    vmovdqa64 %zmm5, %zmm9
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm7, %zmm5
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm16, %zmm6
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm1, %zmm10
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm28, %zmm9
; AVX512-FCP-NEXT:    vpermi2d %zmm2, %zmm25, %zmm16
; AVX512-FCP-NEXT:    vpermi2d %zmm2, %zmm25, %zmm1
; AVX512-FCP-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vpermi2d %zmm2, %zmm25, %zmm28
; AVX512-FCP-NEXT:    vpermt2d %zmm25, %zmm3, %zmm2
; AVX512-FCP-NEXT:    movw $12684, %ax # imm = 0x318C
; AVX512-FCP-NEXT:    kmovw %eax, %k1
...
; AVX512-FCP-NEXT:    vmovdqa32 %zmm22, %zmm20 {%k2}
; AVX512-FCP-NEXT:    movw $6342, %ax # imm = 0x18C6
; AVX512-FCP-NEXT:    kmovw %eax, %k3
; AVX512-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512-FCP-NEXT:    vmovdqa32 %zmm0, %zmm21 {%k3}
; AVX512-FCP-NEXT:    vmovdqa32 %zmm15, %zmm23 {%k1}
; AVX512-FCP-NEXT:    vmovdqa64 192(%r8), %zmm0
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm1 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm1, %zmm3
; AVX512-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm15 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm15, %zmm31
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm22 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm22, %zmm20
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm25 = [0,1,2,19,4,5,6,7,20,9,10,11,12,21,14,15]
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm25, %zmm21
; AVX512-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm3 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm3, %zmm23
; AVX512-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512-FCP-NEXT:    vmovdqa32 %zmm0, %zmm18 {%k2}
; AVX512-FCP-NEXT:    vmovdqa32 %zmm12, %zmm17 {%k1}
; AVX512-FCP-NEXT:    vmovdqa32 %zmm11, %zmm27 {%k2}
; AVX512-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512-FCP-NEXT:    vmovdqa32 %zmm0, %zmm30 {%k3}
; AVX512-FCP-NEXT:    vmovdqa32 %zmm29, %zmm19 {%k1}
; AVX512-FCP-NEXT:    vmovdqa64 128(%r8), %zmm0
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm1, %zmm18
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm15, %zmm17
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm22, %zmm27
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm25, %zmm30
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm3, %zmm19
; AVX512-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512-FCP-NEXT:    vmovdqa32 %zmm0, %zmm6 {%k2}
; AVX512-FCP-NEXT:    vmovdqa32 %zmm10, %zmm24 {%k1}
; AVX512-FCP-NEXT:    vmovdqa32 %zmm9, %zmm26 {%k2}
; AVX512-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512-FCP-NEXT:    vmovdqa32 %zmm0, %zmm4 {%k3}
...
; AVX512-FCP-NEXT:    vpermt2d %zmm7, %zmm3, %zmm5
; AVX512-FCP-NEXT:    vpermt2d %zmm7, %zmm1, %zmm6
; AVX512-FCP-NEXT:    vpermt2d %zmm7, %zmm15, %zmm24
; AVX512-FCP-NEXT:    vpermt2d %zmm7, %zmm22, %zmm26
; AVX512-FCP-NEXT:    vpermt2d %zmm7, %zmm25, %zmm4
; AVX512-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm3 # 64-byte Reload
; AVX512-FCP-NEXT:    vmovdqa32 %zmm3, %zmm16 {%k2}
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm1, %zmm16
; AVX512-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm1 # 64-byte Reload
; AVX512-FCP-NEXT:    vmovdqa32 %zmm1, %zmm14 {%k1}
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm15, %zmm14
; AVX512-FCP-NEXT:    vmovdqa32 %zmm28, %zmm13 {%k2}
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm22, %zmm13
; AVX512-FCP-NEXT:    vmovdqu64 (%rsp), %zmm1 # 64-byte Reload
; AVX512-FCP-NEXT:    vmovdqa32 %zmm1, %zmm2 {%k3}
; AVX512-FCP-NEXT:    vpermt2d %zmm0, %zmm25, %zmm2
; AVX512-FCP-NEXT:    vmovdqa64 %zmm2, 64(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm13, 128(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm14, 192(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm16, 256(%r9)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm5, 320(%r9)
...
; AVX512DQ-NEXT:    vmovdqa64 64(%rdx), %zmm2
...
; AVX512DQ-NEXT:    # zmm7 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [14,30,0,13,29,15,31,0,14,30,0,13,29,15,31,0]
; AVX512DQ-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vmovdqa64 %zmm15, %zmm3
; AVX512DQ-NEXT:    vpermt2d %zmm17, %zmm1, %zmm3
; AVX512DQ-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-NEXT:    vmovdqa64 %zmm1, %zmm3
; AVX512DQ-NEXT:    vbroadcasti64x4 {{.*#+}} zmm16 = [0,13,29,15,31,0,14,30,0,13,29,15,31,0,14,30]
; AVX512DQ-NEXT:    # zmm16 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vmovdqa64 %zmm23, %zmm1
; AVX512DQ-NEXT:    vpermt2d %zmm18, %zmm16, %zmm1
; AVX512DQ-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [27,0,10,26,12,28,0,11,27,0,10,26,12,28,0,11]
; AVX512DQ-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vmovdqa64 %zmm23, %zmm5
; AVX512DQ-NEXT:    vpermt2d %zmm18, %zmm1, %zmm5
...
; AVX512DQ-NEXT:    vpermt2d %zmm17, %zmm13, %zmm20
; AVX512DQ-NEXT:    vbroadcasti64x4 {{.*#+}} zmm30 = [0,3,19,5,21,0,4,20,0,3,19,5,21,0,4,20]
; AVX512DQ-NEXT:    # zmm30 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vmovdqa64 %zmm15, %zmm5
; AVX512DQ-NEXT:    vpermt2d %zmm17, %zmm30, %zmm5
; AVX512DQ-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-NEXT:    vpermt2d %zmm17, %zmm28, %zmm15
; AVX512DQ-NEXT:    vmovdqa64 %zmm29, %zmm5
; AVX512DQ-NEXT:    vpermt2d %zmm24, %zmm3, %zmm5
; AVX512DQ-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-NEXT:    vmovdqa64 %zmm24, %zmm17
; AVX512DQ-NEXT:    vpermt2d %zmm29, %zmm14, %zmm17
; AVX512DQ-NEXT:    vmovdqa64 %zmm29, %zmm27
; AVX512DQ-NEXT:    vpermt2d %zmm24, %zmm13, %zmm27
; AVX512DQ-NEXT:    vmovdqa64 %zmm29, %zmm5
; AVX512DQ-NEXT:    vpermt2d %zmm24, %zmm30, %zmm5
; AVX512DQ-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-NEXT:    vpermt2d %zmm24, %zmm28, %zmm29
; AVX512DQ-NEXT:    vmovdqa64 %zmm2, %zmm5
; AVX512DQ-NEXT:    vmovdqa64 %zmm25, %zmm24
; AVX512DQ-NEXT:    vpermt2d %zmm2, %zmm14, %zmm24
; AVX512DQ-NEXT:    vmovdqa64 %zmm2, %zmm26
; AVX512DQ-NEXT:    vmovdqa64 %zmm2, %zmm6
; AVX512DQ-NEXT:    vpermt2d %zmm25, %zmm28, %zmm2
...
; AVX512DQ-NEXT:    # zmm28 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vpermt2d %zmm25, %zmm3, %zmm5
; AVX512DQ-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-NEXT:    vpermt2d %zmm25, %zmm13, %zmm26
; AVX512DQ-NEXT:    vpermt2d %zmm25, %zmm30, %zmm6
; AVX512DQ-NEXT:    vmovdqu64 %zmm6, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-NEXT:    vmovdqa64 %zmm23, %zmm22
; AVX512DQ-NEXT:    vpermt2d %zmm18, %zmm28, %zmm22
; AVX512DQ-NEXT:    vpermi2d %zmm21, %zmm0, %zmm3
; AVX512DQ-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-NEXT:    vpermi2d %zmm0, %zmm21, %zmm14
; AVX512DQ-NEXT:    vpermi2d %zmm21, %zmm0, %zmm13
; AVX512DQ-NEXT:    vpermt2d %zmm21, %zmm30, %zmm0
; AVX512DQ-NEXT:    vmovdqu64 %zmm0, (%rsp) # 64-byte Spill
; AVX512DQ-NEXT:    vbroadcasti64x4 {{.*#+}} zmm3 = [3,21,5,0,20,4,22,6,3,21,5,0,20,4,22,6]
; AVX512DQ-NEXT:    # zmm3 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-NEXT:    vmovdqa64 %zmm18, %zmm21
; AVX512DQ-NEXT:    vpermt2d %zmm23, %zmm3, %zmm21
; AVX512DQ-NEXT:    vpermt2d %zmm18, %zmm7, %zmm23
; AVX512DQ-NEXT:    vmovdqa64 128(%rsi), %zmm25
; AVX512DQ-NEXT:    vmovdqa64 %zmm19, %zmm18
; AVX512DQ-NEXT:    vpermt2d %zmm25, %zmm16, %zmm18
; AVX512DQ-NEXT:    vmovdqa64 %zmm19, %zmm12
; AVX512DQ-NEXT:    vpermt2d %zmm25, %zmm1, %zmm12
; AVX512DQ-NEXT:    vmovdqa64 %zmm19, %zmm11
; AVX512DQ-NEXT:    vpermt2d %zmm25, %zmm28, %zmm11
; AVX512DQ-NEXT:    vmovdqa64 %zmm25, %zmm30
; AVX512DQ-NEXT:    vpermt2d %zmm19, %zmm3, %zmm30
; AVX512DQ-NEXT:    vpermt2d %zmm25, %zmm7, %zmm19
; AVX512DQ-NEXT:    vmovdqa64 (%rdi), %zmm25
; AVX512DQ-NEXT:    vmovdqa64 (%rsi), %zmm2
; AVX512DQ-NEXT:    vmovdqa64 %zmm25, %zmm8
; AVX512DQ-NEXT:    vpermt2d %zmm2, %zmm7, %zmm8
; AVX512DQ-NEXT:    vmovdqa64 64(%rdi), %zmm5
; AVX512DQ-NEXT:    vmovdqa64 64(%rsi), %zmm0
; AVX512DQ-NEXT:    vmovdqa64 %zmm0, %zmm4
; AVX512DQ-NEXT:    vpermt2d %zmm5, %zmm3, %zmm4
; AVX512DQ-NEXT:    vmovdqa64 %zmm5, %zmm6
; AVX512DQ-NEXT:    vmovdqa64 %zmm5, %zmm10
; AVX512DQ-NEXT:    vmovdqa64 %zmm5, %zmm9
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm7, %zmm5
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm16, %zmm6
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm1, %zmm10
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm28, %zmm9
; AVX512DQ-NEXT:    vpermi2d %zmm2, %zmm25, %zmm16
; AVX512DQ-NEXT:    vpermi2d %zmm2, %zmm25, %zmm1
; AVX512DQ-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-NEXT:    vpermi2d %zmm2, %zmm25, %zmm28
; AVX512DQ-NEXT:    vpermt2d %zmm25, %zmm3, %zmm2
; AVX512DQ-NEXT:    movw $12684, %ax # imm = 0x318C
; AVX512DQ-NEXT:    kmovw %eax, %k1
...
; AVX512DQ-NEXT:    vmovdqa32 %zmm22, %zmm20 {%k2}
; AVX512DQ-NEXT:    movw $6342, %ax # imm = 0x18C6
; AVX512DQ-NEXT:    kmovw %eax, %k3
; AVX512DQ-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-NEXT:    vmovdqa32 %zmm0, %zmm21 {%k3}
; AVX512DQ-NEXT:    vmovdqa32 %zmm15, %zmm23 {%k1}
; AVX512DQ-NEXT:    vmovdqa64 192(%r8), %zmm0
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} zmm1 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm1, %zmm3
; AVX512DQ-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} zmm15 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm15, %zmm31
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} zmm22 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm22, %zmm20
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} zmm25 = [0,1,2,19,4,5,6,7,20,9,10,11,12,21,14,15]
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm25, %zmm21
; AVX512DQ-NEXT:    vpmovsxbd {{.*#+}} zmm3 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm3, %zmm23
; AVX512DQ-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-NEXT:    vmovdqa32 %zmm0, %zmm18 {%k2}
; AVX512DQ-NEXT:    vmovdqa32 %zmm12, %zmm17 {%k1}
; AVX512DQ-NEXT:    vmovdqa32 %zmm11, %zmm27 {%k2}
; AVX512DQ-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-NEXT:    vmovdqa32 %zmm0, %zmm30 {%k3}
; AVX512DQ-NEXT:    vmovdqa32 %zmm29, %zmm19 {%k1}
; AVX512DQ-NEXT:    vmovdqa64 128(%r8), %zmm0
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm1, %zmm18
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm15, %zmm17
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm22, %zmm27
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm25, %zmm30
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm3, %zmm19
; AVX512DQ-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-NEXT:    vmovdqa32 %zmm0, %zmm6 {%k2}
; AVX512DQ-NEXT:    vmovdqa32 %zmm10, %zmm24 {%k1}
; AVX512DQ-NEXT:    vmovdqa32 %zmm9, %zmm26 {%k2}
; AVX512DQ-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-NEXT:    vmovdqa32 %zmm0, %zmm4 {%k3}
; AVX512DQ-NEXT:    vmovdqa64 (%r8), %zmm0
; AVX512DQ-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm7 # 64-byte Reload
; AVX512DQ-NEXT:    vmovdqa32 %zmm7, %zmm5 {%k1}
; AVX512DQ-NEXT:    vmovdqa64 64(%r8), %zmm7
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm3, %zmm8
; AVX512DQ-NEXT:    vpermt2d %zmm7, %zmm3, %zmm5
; AVX512DQ-NEXT:    vpermt2d %zmm7, %zmm1, %zmm6
; AVX512DQ-NEXT:    vpermt2d %zmm7, %zmm15, %zmm24
; AVX512DQ-NEXT:    vpermt2d %zmm7, %zmm22, %zmm26
; AVX512DQ-NEXT:    vpermt2d %zmm7, %zmm25, %zmm4
; AVX512DQ-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm3 # 64-byte Reload
; AVX512DQ-NEXT:    vmovdqa32 %zmm3, %zmm16 {%k2}
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm1, %zmm16
; AVX512DQ-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm1 # 64-byte Reload
; AVX512DQ-NEXT:    vmovdqa32 %zmm1, %zmm14 {%k1}
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm15, %zmm14
; AVX512DQ-NEXT:    vmovdqa32 %zmm28, %zmm13 {%k2}
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm22, %zmm13
; AVX512DQ-NEXT:    vmovdqu64 (%rsp), %zmm1 # 64-byte Reload
; AVX512DQ-NEXT:    vmovdqa32 %zmm1, %zmm2 {%k3}
; AVX512DQ-NEXT:    vpermt2d %zmm0, %zmm25, %zmm2
; AVX512DQ-NEXT:    vmovdqa64 %zmm2, 64(%r9)
; AVX512DQ-NEXT:    vmovdqa64 %zmm13, 128(%r9)
; AVX512DQ-NEXT:    vmovdqa64 %zmm14, 192(%r9)
; AVX512DQ-NEXT:    vmovdqa64 %zmm16, 256(%r9)
; AVX512DQ-NEXT:    vmovdqa64 %zmm5, 320(%r9)
...
; AVX512DQ-FCP-NEXT:    vmovdqa64 64(%rdx), %zmm2
...
; AVX512DQ-FCP-NEXT:    # zmm7 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [14,30,0,13,29,15,31,0,14,30,0,13,29,15,31,0]
; AVX512DQ-FCP-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm15, %zmm3
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm17, %zmm1, %zmm3
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm1, %zmm3
; AVX512DQ-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm16 = [0,13,29,15,31,0,14,30,0,13,29,15,31,0,14,30]
; AVX512DQ-FCP-NEXT:    # zmm16 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm23, %zmm1
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm18, %zmm16, %zmm1
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [27,0,10,26,12,28,0,11,27,0,10,26,12,28,0,11]
; AVX512DQ-FCP-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm23, %zmm5
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm18, %zmm1, %zmm5
...
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm17, %zmm13, %zmm20
...
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm17, %zmm30, %zmm5
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm17, %zmm28, %zmm15
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm29, %zmm5
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm24, %zmm3, %zmm5
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm24, %zmm17
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm29, %zmm14, %zmm17
...
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm2, %zmm14, %zmm24
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm2, %zmm26
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm2, %zmm6
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm25, %zmm28, %zmm2
...
; AVX512DQ-FCP-NEXT:    # zmm28 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm25, %zmm3, %zmm5
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm25, %zmm13, %zmm26
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm25, %zmm30, %zmm6
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm6, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm23, %zmm22
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm18, %zmm28, %zmm22
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm21, %zmm0, %zmm3
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm0, %zmm21, %zmm14
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm21, %zmm0, %zmm13
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm21, %zmm30, %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm0, (%rsp) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm3 = [3,21,5,0,20,4,22,6,3,21,5,0,20,4,22,6]
; AVX512DQ-FCP-NEXT:    # zmm3 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm18, %zmm21
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm23, %zmm3, %zmm21
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm18, %zmm7, %zmm23
; AVX512DQ-FCP-NEXT:    vmovdqa64 128(%rsi), %zmm25
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm19, %zmm18
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm25, %zmm16, %zmm18
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm19, %zmm12
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm25, %zmm1, %zmm12
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm19, %zmm11
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm25, %zmm28, %zmm11
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm25, %zmm30
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm19, %zmm3, %zmm30
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm25, %zmm7, %zmm19
; AVX512DQ-FCP-NEXT:    vmovdqa64 (%rdi), %zmm25
; AVX512DQ-FCP-NEXT:    vmovdqa64 (%rsi), %zmm2
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm25, %zmm8
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm2, %zmm7, %zmm8
; AVX512DQ-FCP-NEXT:    vmovdqa64 64(%rdi), %zmm5
; AVX512DQ-FCP-NEXT:    vmovdqa64 64(%rsi), %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm0, %zmm4
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm5, %zmm3, %zmm4
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm5, %zmm6
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm5, %zmm10
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm5, %zmm9
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm7, %zmm5
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm16, %zmm6
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm1, %zmm10
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm28, %zmm9
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm2, %zmm25, %zmm16
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm2, %zmm25, %zmm1
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vpermi2d %zmm2, %zmm25, %zmm28
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm25, %zmm3, %zmm2
; AVX512DQ-FCP-NEXT:    movw $12684, %ax # imm = 0x318C
; AVX512DQ-FCP-NEXT:    kmovw %eax, %k1
...
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm22, %zmm20 {%k2}
; AVX512DQ-FCP-NEXT:    movw $6342, %ax # imm = 0x18C6
; AVX512DQ-FCP-NEXT:    kmovw %eax, %k3
; AVX512DQ-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm0, %zmm21 {%k3}
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm15, %zmm23 {%k1}
; AVX512DQ-FCP-NEXT:    vmovdqa64 192(%r8), %zmm0
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm1 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm1, %zmm3
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm15 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm15, %zmm31
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm22 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm22, %zmm20
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm25 = [0,1,2,19,4,5,6,7,20,9,10,11,12,21,14,15]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm25, %zmm21
; AVX512DQ-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm3 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm3, %zmm23
; AVX512DQ-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm0, %zmm18 {%k2}
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm12, %zmm17 {%k1}
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm11, %zmm27 {%k2}
; AVX512DQ-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm0, %zmm30 {%k3}
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm29, %zmm19 {%k1}
; AVX512DQ-FCP-NEXT:    vmovdqa64 128(%r8), %zmm0
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm1, %zmm18
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm15, %zmm17
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm22, %zmm27
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm25, %zmm30
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm3, %zmm19
; AVX512DQ-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
...
; AVX512DQ-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm0, %zmm4 {%k3}
; AVX512DQ-FCP-NEXT:    vmovdqa64 (%r8), %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm7 # 64-byte Reload
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm7, %zmm5 {%k1}
; AVX512DQ-FCP-NEXT:    vmovdqa64 64(%r8), %zmm7
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm3, %zmm8
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm7, %zmm3, %zmm5
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm7, %zmm1, %zmm6
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm7, %zmm15, %zmm24
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm7, %zmm22, %zmm26
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm7, %zmm25, %zmm4
; AVX512DQ-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm3 # 64-byte Reload
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm3, %zmm16 {%k2}
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm1, %zmm16
; AVX512DQ-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm1 # 64-byte Reload
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm1, %zmm14 {%k1}
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm15, %zmm14
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm28, %zmm13 {%k2}
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm22, %zmm13
; AVX512DQ-FCP-NEXT:    vmovdqu64 (%rsp), %zmm1 # 64-byte Reload
; AVX512DQ-FCP-NEXT:    vmovdqa32 %zmm1, %zmm2 {%k3}
; AVX512DQ-FCP-NEXT:    vpermt2d %zmm0, %zmm25, %zmm2
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm2, 64(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm13, 128(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm14, 192(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm16, 256(%r9)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm5, 320(%r9)
...
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm17, 832(%r9)
...
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm20, 1088(%r9)
...
; AVX512BW-NEXT:    # zmm7 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [14,30,0,13,29,15,31,0,14,30,0,13,29,15,31,0]
; AVX512BW-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vmovdqa64 %zmm15, %zmm3
; AVX512BW-NEXT:    vpermt2d %zmm17, %zmm1, %zmm3
; AVX512BW-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm1, %zmm3
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm16 = [0,13,29,15,31,0,14,30,0,13,29,15,31,0,14,30]
; AVX512BW-NEXT:    # zmm16 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vmovdqa64 %zmm23, %zmm1
; AVX512BW-NEXT:    vpermt2d %zmm18, %zmm16, %zmm1
; AVX512BW-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [27,0,10,26,12,28,0,11,27,0,10,26,12,28,0,11]
; AVX512BW-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vmovdqa64 %zmm23, %zmm5
; AVX512BW-NEXT:    vpermt2d %zmm18, %zmm1, %zmm5
...
; AVX512BW-NEXT:    vpermt2d %zmm17, %zmm13, %zmm20
...
; AVX512BW-NEXT:    # zmm28 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vpermt2d %zmm25, %zmm3, %zmm5
; AVX512BW-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermt2d %zmm25, %zmm13, %zmm26
; AVX512BW-NEXT:    vpermt2d %zmm25, %zmm30, %zmm6
; AVX512BW-NEXT:    vmovdqu64 %zmm6, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm23, %zmm22
; AVX512BW-NEXT:    vpermt2d %zmm18, %zmm28, %zmm22
; AVX512BW-NEXT:    vpermi2d %zmm21, %zmm0, %zmm3
; AVX512BW-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermi2d %zmm0, %zmm21, %zmm14
; AVX512BW-NEXT:    vpermi2d %zmm21, %zmm0, %zmm13
; AVX512BW-NEXT:    vpermt2d %zmm21, %zmm30, %zmm0
; AVX512BW-NEXT:    vmovdqu64 %zmm0, (%rsp) # 64-byte Spill
; AVX512BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm3 = [3,21,5,0,20,4,22,6,3,21,5,0,20,4,22,6]
; AVX512BW-NEXT:    # zmm3 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-NEXT:    vmovdqa64 %zmm18, %zmm21
; AVX512BW-NEXT:    vpermt2d %zmm23, %zmm3, %zmm21
; AVX512BW-NEXT:    vpermt2d %zmm18, %zmm7, %zmm23
; AVX512BW-NEXT:    vmovdqa64 128(%rsi), %zmm25
; AVX512BW-NEXT:    vmovdqa64 %zmm19, %zmm18
; AVX512BW-NEXT:    vpermt2d %zmm25, %zmm16, %zmm18
; AVX512BW-NEXT:    vmovdqa64 %zmm19, %zmm12
; AVX512BW-NEXT:    vpermt2d %zmm25, %zmm1, %zmm12
; AVX512BW-NEXT:    vmovdqa64 %zmm19, %zmm11
; AVX512BW-NEXT:    vpermt2d %zmm25, %zmm28, %zmm11
; AVX512BW-NEXT:    vmovdqa64 %zmm25, %zmm30
; AVX512BW-NEXT:    vpermt2d %zmm19, %zmm3, %zmm30
; AVX512BW-NEXT:    vpermt2d %zmm25, %zmm7, %zmm19
; AVX512BW-NEXT:    vmovdqa64 (%rdi), %zmm25
; AVX512BW-NEXT:    vmovdqa64 (%rsi), %zmm2
; AVX512BW-NEXT:    vmovdqa64 %zmm25, %zmm8
; AVX512BW-NEXT:    vpermt2d %zmm2, %zmm7, %zmm8
...
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm7, %zmm5
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm16, %zmm6
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm1, %zmm10
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm28, %zmm9
; AVX512BW-NEXT:    vpermi2d %zmm2, %zmm25, %zmm16
; AVX512BW-NEXT:    vpermi2d %zmm2, %zmm25, %zmm1
; AVX512BW-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermi2d %zmm2, %zmm25, %zmm28
; AVX512BW-NEXT:    vpermt2d %zmm25, %zmm3, %zmm2
; AVX512BW-NEXT:    movw $12684, %ax # imm = 0x318C
; AVX512BW-NEXT:    kmovd %eax, %k1
...
; AVX512BW-NEXT:    kmovd %eax, %k3
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqa32 %zmm0, %zmm21 {%k3}
; AVX512BW-NEXT:    vmovdqa32 %zmm15, %zmm23 {%k1}
; AVX512BW-NEXT:    vmovdqa64 192(%r8), %zmm0
; AVX512BW-NEXT:    vpmovsxbd {{.*#+}} zmm1 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm1, %zmm3
; AVX512BW-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpmovsxbd {{.*#+}} zmm15 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm15, %zmm31
; AVX512BW-NEXT:    vpmovsxbd {{.*#+}} zmm22 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm22, %zmm20
...
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqa32 %zmm0, %zmm18 {%k2}
; AVX512BW-NEXT:    vmovdqa32 %zmm12, %zmm17 {%k1}
; AVX512BW-NEXT:    vmovdqa32 %zmm11, %zmm27 {%k2}
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqa32 %zmm0, %zmm30 {%k3}
; AVX512BW-NEXT:    vmovdqa32 %zmm29, %zmm19 {%k1}
; AVX512BW-NEXT:    vmovdqa64 128(%r8), %zmm0
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm1, %zmm18
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm15, %zmm17
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm22, %zmm27
...
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqa32 %zmm0, %zmm4 {%k3}
...
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm3, %zmm8
; AVX512BW-NEXT:    vpermt2d %zmm7, %zmm3, %zmm5
; AVX512BW-NEXT:    vpermt2d %zmm7, %zmm1, %zmm6
; AVX512BW-NEXT:    vpermt2d %zmm7, %zmm15, %zmm24
; AVX512BW-NEXT:    vpermt2d %zmm7, %zmm22, %zmm26
; AVX512BW-NEXT:    vpermt2d %zmm7, %zmm25, %zmm4
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm3 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqa32 %zmm3, %zmm16 {%k2}
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm1, %zmm16
; AVX512BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm1 # 64-byte Reload
; AVX512BW-NEXT:    vmovdqa32 %zmm1, %zmm14 {%k1}
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm15, %zmm14
; AVX512BW-NEXT:    vmovdqa32 %zmm28, %zmm13 {%k2}
; AVX512BW-NEXT:    vpermt2d %zmm0, %zmm22, %zmm13
...
; AVX512BW-NEXT:    vmovdqa64 %zmm5, 320(%r9)
...
; AVX512BW-FCP-NEXT:    vmovdqa64 64(%rdx), %zmm2
...
; AVX512BW-FCP-NEXT:    # zmm7 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [14,30,0,13,29,15,31,0,14,30,0,13,29,15,31,0]
; AVX512BW-FCP-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm15, %zmm3
; AVX512BW-FCP-NEXT:    vpermt2d %zmm17, %zmm1, %zmm3
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm1, %zmm3
; AVX512BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm16 = [0,13,29,15,31,0,14,30,0,13,29,15,31,0,14,30]
; AVX512BW-FCP-NEXT:    # zmm16 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm23, %zmm1
; AVX512BW-FCP-NEXT:    vpermt2d %zmm18, %zmm16, %zmm1
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [27,0,10,26,12,28,0,11,27,0,10,26,12,28,0,11]
; AVX512BW-FCP-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm23, %zmm5
; AVX512BW-FCP-NEXT:    vpermt2d %zmm18, %zmm1, %zmm5
...
; AVX512BW-FCP-NEXT:    vpermt2d %zmm17, %zmm13, %zmm20
; AVX512BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm30 = [0,3,19,5,21,0,4,20,0,3,19,5,21,0,4,20]
; AVX512BW-FCP-NEXT:    # zmm30 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm15, %zmm5
; AVX512BW-FCP-NEXT:    vpermt2d %zmm17, %zmm30, %zmm5
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-FCP-NEXT:    vpermt2d %zmm17, %zmm28, %zmm15
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm29, %zmm5
; AVX512BW-FCP-NEXT:    vpermt2d %zmm24, %zmm3, %zmm5
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm24, %zmm17
; AVX512BW-FCP-NEXT:    vpermt2d %zmm29, %zmm14, %zmm17
...
; AVX512BW-FCP-NEXT:    vpermt2d %zmm2, %zmm14, %zmm24
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm2, %zmm26
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm2, %zmm6
; AVX512BW-FCP-NEXT:    vpermt2d %zmm25, %zmm28, %zmm2
...
; AVX512BW-FCP-NEXT:    # zmm28 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-FCP-NEXT:    vpermt2d %zmm25, %zmm3, %zmm5
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-FCP-NEXT:    vpermt2d %zmm25, %zmm13, %zmm26
; AVX512BW-FCP-NEXT:    vpermt2d %zmm25, %zmm30, %zmm6
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm6, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm23, %zmm22
; AVX512BW-FCP-NEXT:    vpermt2d %zmm18, %zmm28, %zmm22
; AVX512BW-FCP-NEXT:    vpermi2d %zmm21, %zmm0, %zmm3
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-FCP-NEXT:    vpermi2d %zmm0, %zmm21, %zmm14
; AVX512BW-FCP-NEXT:    vpermi2d %zmm21, %zmm0, %zmm13
; AVX512BW-FCP-NEXT:    vpermt2d %zmm21, %zmm30, %zmm0
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm0, (%rsp) # 64-byte Spill
; AVX512BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm3 = [3,21,5,0,20,4,22,6,3,21,5,0,20,4,22,6]
; AVX512BW-FCP-NEXT:    # zmm3 = mem[0,1,2,3,0,1,2,3]
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm18, %zmm21
; AVX512BW-FCP-NEXT:    vpermt2d %zmm23, %zmm3, %zmm21
; AVX512BW-FCP-NEXT:    vpermt2d %zmm18, %zmm7, %zmm23
; AVX512BW-FCP-NEXT:    vmovdqa64 128(%rsi), %zmm25
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm19, %zmm18
; AVX512BW-FCP-NEXT:    vpermt2d %zmm25, %zmm16, %zmm18
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm19, %zmm12
; AVX512BW-FCP-NEXT:    vpermt2d %zmm25, %zmm1, %zmm12
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm19, %zmm11
; AVX512BW-FCP-NEXT:    vpermt2d %zmm25, %zmm28, %zmm11
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm25, %zmm30
; AVX512BW-FCP-NEXT:    vpermt2d %zmm19, %zmm3, %zmm30
; AVX512BW-FCP-NEXT:    vpermt2d %zmm25, %zmm7, %zmm19
; AVX512BW-FCP-NEXT:    vmovdqa64 (%rdi), %zmm25
; AVX512BW-FCP-NEXT:    vmovdqa64 (%rsi), %zmm2
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm25, %zmm8
; AVX512BW-FCP-NEXT:    vpermt2d %zmm2, %zmm7, %zmm8
; AVX512BW-FCP-NEXT:    vmovdqa64 64(%rdi), %zmm5
; AVX512BW-FCP-NEXT:    vmovdqa64 64(%rsi), %zmm0
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm0, %zmm4
; AVX512BW-FCP-NEXT:    vpermt2d %zmm5, %zmm3, %zmm4
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm5, %zmm6
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm5, %zmm10
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm5, %zmm9
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm7, %zmm5
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm16, %zmm6
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm1, %zmm10
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm28, %zmm9
; AVX512BW-FCP-NEXT:    vpermi2d %zmm2, %zmm25, %zmm16
; AVX512BW-FCP-NEXT:    vpermi2d %zmm2, %zmm25, %zmm1
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-FCP-NEXT:    vpermi2d %zmm2, %zmm25, %zmm28
; AVX512BW-FCP-NEXT:    vpermt2d %zmm25, %zmm3, %zmm2
; AVX512BW-FCP-NEXT:    movw $12684, %ax # imm = 0x318C
; AVX512BW-FCP-NEXT:    kmovd %eax, %k1
...
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm22, %zmm20 {%k2}
; AVX512BW-FCP-NEXT:    movw $6342, %ax # imm = 0x18C6
; AVX512BW-FCP-NEXT:    kmovd %eax, %k3
; AVX512BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm0, %zmm21 {%k3}
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm15, %zmm23 {%k1}
; AVX512BW-FCP-NEXT:    vmovdqa64 192(%r8), %zmm0
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm1 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm1, %zmm3
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm15 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm15, %zmm31
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm22 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm22, %zmm20
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm25 = [0,1,2,19,4,5,6,7,20,9,10,11,12,21,14,15]
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm25, %zmm21
; AVX512BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm3 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm3, %zmm23
; AVX512BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm0, %zmm18 {%k2}
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm12, %zmm17 {%k1}
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm11, %zmm27 {%k2}
; AVX512BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm0, %zmm30 {%k3}
; AVX512BW-FCP-NEXT:    vmovdqa32 %zmm29, %zmm19 {%k1}
; AVX512BW-FCP-NEXT:    vmovdqa64 128(%r8), %zmm0
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm1, %zmm18
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm15, %zmm17
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm22, %zmm27
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm25, %zmm30
; AVX512BW-FCP-NEXT:    vpermt2d %zmm0, %zmm3, %zmm19
; AVX512BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
...
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm17, 832(%r9)
...
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm20, 1088(%r9)
...
; AVX512DQ-BW-NEXT:    vmovdqa64 64(%rdx), %zmm2
...
; AVX512DQ-BW-NEXT:    # zmm7 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [14,30,0,13,29,15,31,0,14,30,0,13,29,15,31,0]
; AVX512DQ-BW-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm15, %zmm3
; AVX512DQ-BW-NEXT:    vpermt2d %zmm17, %zmm1, %zmm3
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm1, %zmm3
; AVX512DQ-BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm16 = [0,13,29,15,31,0,14,30,0,13,29,15,31,0,14,30]
; AVX512DQ-BW-NEXT:    # zmm16 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm23, %zmm1
; AVX512DQ-BW-NEXT:    vpermt2d %zmm18, %zmm16, %zmm1
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [27,0,10,26,12,28,0,11,27,0,10,26,12,28,0,11]
; AVX512DQ-BW-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm23, %zmm5
; AVX512DQ-BW-NEXT:    vpermt2d %zmm18, %zmm1, %zmm5
...
; AVX512DQ-BW-NEXT:    vpermt2d %zmm17, %zmm13, %zmm20
; AVX512DQ-BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm30 = [0,3,19,5,21,0,4,20,0,3,19,5,21,0,4,20]
; AVX512DQ-BW-NEXT:    # zmm30 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm15, %zmm5
; AVX512DQ-BW-NEXT:    vpermt2d %zmm17, %zmm30, %zmm5
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vpermt2d %zmm17, %zmm28, %zmm15
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm29, %zmm5
; AVX512DQ-BW-NEXT:    vpermt2d %zmm24, %zmm3, %zmm5
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm24, %zmm17
; AVX512DQ-BW-NEXT:    vpermt2d %zmm29, %zmm14, %zmm17
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm29, %zmm27
; AVX512DQ-BW-NEXT:    vpermt2d %zmm24, %zmm13, %zmm27
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm29, %zmm5
; AVX512DQ-BW-NEXT:    vpermt2d %zmm24, %zmm30, %zmm5
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vpermt2d %zmm24, %zmm28, %zmm29
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm2, %zmm5
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm25, %zmm24
; AVX512DQ-BW-NEXT:    vpermt2d %zmm2, %zmm14, %zmm24
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm2, %zmm26
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm2, %zmm6
; AVX512DQ-BW-NEXT:    vpermt2d %zmm25, %zmm28, %zmm2
...
; AVX512DQ-BW-NEXT:    # zmm28 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-NEXT:    vpermt2d %zmm25, %zmm3, %zmm5
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vpermt2d %zmm25, %zmm13, %zmm26
; AVX512DQ-BW-NEXT:    vpermt2d %zmm25, %zmm30, %zmm6
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm6, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm23, %zmm22
; AVX512DQ-BW-NEXT:    vpermt2d %zmm18, %zmm28, %zmm22
; AVX512DQ-BW-NEXT:    vpermi2d %zmm21, %zmm0, %zmm3
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vpermi2d %zmm0, %zmm21, %zmm14
; AVX512DQ-BW-NEXT:    vpermi2d %zmm21, %zmm0, %zmm13
; AVX512DQ-BW-NEXT:    vpermt2d %zmm21, %zmm30, %zmm0
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm0, (%rsp) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vbroadcasti64x4 {{.*#+}} zmm3 = [3,21,5,0,20,4,22,6,3,21,5,0,20,4,22,6]
; AVX512DQ-BW-NEXT:    # zmm3 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm18, %zmm21
; AVX512DQ-BW-NEXT:    vpermt2d %zmm23, %zmm3, %zmm21
; AVX512DQ-BW-NEXT:    vpermt2d %zmm18, %zmm7, %zmm23
; AVX512DQ-BW-NEXT:    vmovdqa64 128(%rsi), %zmm25
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm19, %zmm18
; AVX512DQ-BW-NEXT:    vpermt2d %zmm25, %zmm16, %zmm18
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm19, %zmm12
; AVX512DQ-BW-NEXT:    vpermt2d %zmm25, %zmm1, %zmm12
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm19, %zmm11
; AVX512DQ-BW-NEXT:    vpermt2d %zmm25, %zmm28, %zmm11
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm25, %zmm30
; AVX512DQ-BW-NEXT:    vpermt2d %zmm19, %zmm3, %zmm30
; AVX512DQ-BW-NEXT:    vpermt2d %zmm25, %zmm7, %zmm19
; AVX512DQ-BW-NEXT:    vmovdqa64 (%rdi), %zmm25
; AVX512DQ-BW-NEXT:    vmovdqa64 (%rsi), %zmm2
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm25, %zmm8
; AVX512DQ-BW-NEXT:    vpermt2d %zmm2, %zmm7, %zmm8
; AVX512DQ-BW-NEXT:    vmovdqa64 64(%rdi), %zmm5
; AVX512DQ-BW-NEXT:    vmovdqa64 64(%rsi), %zmm0
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm0, %zmm4
; AVX512DQ-BW-NEXT:    vpermt2d %zmm5, %zmm3, %zmm4
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm5, %zmm6
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm5, %zmm10
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm5, %zmm9
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm7, %zmm5
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm16, %zmm6
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm1, %zmm10
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm28, %zmm9
; AVX512DQ-BW-NEXT:    vpermi2d %zmm2, %zmm25, %zmm16
; AVX512DQ-BW-NEXT:    vpermi2d %zmm2, %zmm25, %zmm1
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vpermi2d %zmm2, %zmm25, %zmm28
; AVX512DQ-BW-NEXT:    vpermt2d %zmm25, %zmm3, %zmm2
; AVX512DQ-BW-NEXT:    movw $12684, %ax # imm = 0x318C
; AVX512DQ-BW-NEXT:    kmovd %eax, %k1
...
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm22, %zmm20 {%k2}
; AVX512DQ-BW-NEXT:    movw $6342, %ax # imm = 0x18C6
; AVX512DQ-BW-NEXT:    kmovd %eax, %k3
; AVX512DQ-BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm0, %zmm21 {%k3}
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm15, %zmm23 {%k1}
; AVX512DQ-BW-NEXT:    vmovdqa64 192(%r8), %zmm0
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} zmm1 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm1, %zmm3
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} zmm15 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm15, %zmm31
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} zmm22 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm22, %zmm20
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} zmm25 = [0,1,2,19,4,5,6,7,20,9,10,11,12,21,14,15]
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm25, %zmm21
; AVX512DQ-BW-NEXT:    vpmovsxbd {{.*#+}} zmm3 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm3, %zmm23
; AVX512DQ-BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm0, %zmm18 {%k2}
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm12, %zmm17 {%k1}
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm11, %zmm27 {%k2}
; AVX512DQ-BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm0, %zmm30 {%k3}
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm29, %zmm19 {%k1}
; AVX512DQ-BW-NEXT:    vmovdqa64 128(%r8), %zmm0
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm1, %zmm18
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm15, %zmm17
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm22, %zmm27
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm25, %zmm30
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm3, %zmm19
; AVX512DQ-BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm0, %zmm6 {%k2}
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm10, %zmm24 {%k1}
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm9, %zmm26 {%k2}
; AVX512DQ-BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm0, %zmm4 {%k3}
; AVX512DQ-BW-NEXT:    vmovdqa64 (%r8), %zmm0
; AVX512DQ-BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm7 # 64-byte Reload
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm7, %zmm5 {%k1}
; AVX512DQ-BW-NEXT:    vmovdqa64 64(%r8), %zmm7
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm3, %zmm8
; AVX512DQ-BW-NEXT:    vpermt2d %zmm7, %zmm3, %zmm5
; AVX512DQ-BW-NEXT:    vpermt2d %zmm7, %zmm1, %zmm6
; AVX512DQ-BW-NEXT:    vpermt2d %zmm7, %zmm15, %zmm24
; AVX512DQ-BW-NEXT:    vpermt2d %zmm7, %zmm22, %zmm26
; AVX512DQ-BW-NEXT:    vpermt2d %zmm7, %zmm25, %zmm4
; AVX512DQ-BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm3 # 64-byte Reload
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm3, %zmm16 {%k2}
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm1, %zmm16
; AVX512DQ-BW-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm1 # 64-byte Reload
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm1, %zmm14 {%k1}
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm15, %zmm14
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm28, %zmm13 {%k2}
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm22, %zmm13
; AVX512DQ-BW-NEXT:    vmovdqu64 (%rsp), %zmm1 # 64-byte Reload
; AVX512DQ-BW-NEXT:    vmovdqa32 %zmm1, %zmm2 {%k3}
; AVX512DQ-BW-NEXT:    vpermt2d %zmm0, %zmm25, %zmm2
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm2, 64(%r9)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm13, 128(%r9)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm14, 192(%r9)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm16, 256(%r9)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm5, 320(%r9)
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 64(%rdx), %zmm2
...
; AVX512DQ-BW-FCP-NEXT:    # zmm7 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [14,30,0,13,29,15,31,0,14,30,0,13,29,15,31,0]
; AVX512DQ-BW-FCP-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm15, %zmm3
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm17, %zmm1, %zmm3
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm1, %zmm3
; AVX512DQ-BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm16 = [0,13,29,15,31,0,14,30,0,13,29,15,31,0,14,30]
; AVX512DQ-BW-FCP-NEXT:    # zmm16 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm23, %zmm1
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm18, %zmm16, %zmm1
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm1 = [27,0,10,26,12,28,0,11,27,0,10,26,12,28,0,11]
; AVX512DQ-BW-FCP-NEXT:    # zmm1 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm23, %zmm5
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm18, %zmm1, %zmm5
...
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm17, %zmm13, %zmm20
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm15, %zmm5
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm17, %zmm30, %zmm5
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm17, %zmm28, %zmm15
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm29, %zmm5
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm24, %zmm3, %zmm5
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm24, %zmm17
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm29, %zmm14, %zmm17
...
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm2, %zmm14, %zmm24
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm2, %zmm26
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm2, %zmm6
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm25, %zmm28, %zmm2
...
; AVX512DQ-BW-FCP-NEXT:    # zmm28 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm25, %zmm3, %zmm5
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm5, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm25, %zmm13, %zmm26
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm25, %zmm30, %zmm6
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm6, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm23, %zmm22
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm18, %zmm28, %zmm22
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm21, %zmm0, %zmm3
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm0, %zmm21, %zmm14
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm21, %zmm0, %zmm13
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm21, %zmm30, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm0, (%rsp) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vbroadcasti64x4 {{.*#+}} zmm3 = [3,21,5,0,20,4,22,6,3,21,5,0,20,4,22,6]
; AVX512DQ-BW-FCP-NEXT:    # zmm3 = mem[0,1,2,3,0,1,2,3]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm18, %zmm21
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm23, %zmm3, %zmm21
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm18, %zmm7, %zmm23
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 128(%rsi), %zmm25
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm19, %zmm18
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm25, %zmm16, %zmm18
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm19, %zmm12
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm25, %zmm1, %zmm12
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm19, %zmm11
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm25, %zmm28, %zmm11
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm25, %zmm30
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm19, %zmm3, %zmm30
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm25, %zmm7, %zmm19
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 (%rdi), %zmm25
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 (%rsi), %zmm2
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm25, %zmm8
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm2, %zmm7, %zmm8
...
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm5, %zmm3, %zmm4
...
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm7, %zmm5
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm16, %zmm6
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm1, %zmm10
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm28, %zmm9
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm2, %zmm25, %zmm16
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm2, %zmm25, %zmm1
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vpermi2d %zmm2, %zmm25, %zmm28
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm25, %zmm3, %zmm2
; AVX512DQ-BW-FCP-NEXT:    movw $12684, %ax # imm = 0x318C
; AVX512DQ-BW-FCP-NEXT:    kmovd %eax, %k1
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm22, %zmm20 {%k2}
; AVX512DQ-BW-FCP-NEXT:    movw $6342, %ax # imm = 0x18C6
; AVX512DQ-BW-FCP-NEXT:    kmovd %eax, %k3
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm0, %zmm21 {%k3}
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm15, %zmm23 {%k1}
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 192(%r8), %zmm0
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm1 = [28,1,2,3,4,29,6,7,8,9,30,11,12,13,14,31]
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm1, %zmm3
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm15 = [0,25,2,3,4,5,26,7,8,9,10,27,12,13,14,15]
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm15, %zmm31
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm22 = [0,1,22,3,4,5,6,23,8,9,10,11,24,13,14,15]
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm22, %zmm20
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm25 = [0,1,2,19,4,5,6,7,20,9,10,11,12,21,14,15]
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm25, %zmm21
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbd {{.*#+}} zmm3 = [0,1,2,3,16,5,6,7,8,17,10,11,12,13,18,15]
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm3, %zmm23
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm0, %zmm18 {%k2}
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm12, %zmm17 {%k1}
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm11, %zmm27 {%k2}
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm0, %zmm30 {%k3}
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm29, %zmm19 {%k1}
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 128(%r8), %zmm0
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm1, %zmm18
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm15, %zmm17
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm22, %zmm27
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm25, %zmm30
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm3, %zmm19
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm0 # 64-byte Reload
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm0, %zmm4 {%k3}
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 (%r8), %zmm0
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm7 # 64-byte Reload
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm7, %zmm5 {%k1}
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 64(%r8), %zmm7
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm3, %zmm8
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm7, %zmm3, %zmm5
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm7, %zmm1, %zmm6
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm7, %zmm15, %zmm24
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm7, %zmm22, %zmm26
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm7, %zmm25, %zmm4
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm3 # 64-byte Reload
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm3, %zmm16 {%k2}
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm1, %zmm16
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 {{[-0-9]+}}(%r{{[sb]}}p), %zmm1 # 64-byte Reload
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm1, %zmm14 {%k1}
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm15, %zmm14
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm28, %zmm13 {%k2}
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm22, %zmm13
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 (%rsp), %zmm1 # 64-byte Reload
; AVX512DQ-BW-FCP-NEXT:    vmovdqa32 %zmm1, %zmm2 {%k3}
; AVX512DQ-BW-FCP-NEXT:    vpermt2d %zmm0, %zmm25, %zmm2
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm16, 256(%r9)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm5, 320(%r9)
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm17, 832(%r9)
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm20, 1088(%r9)
