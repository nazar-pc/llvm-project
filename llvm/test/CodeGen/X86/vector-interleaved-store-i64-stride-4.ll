...
; SSE-NEXT:    unpckhpd {{.*#+}} xmm13 = xmm13[1],xmm14[1]
...
; SSE-NEXT:    movaps %xmm6, 928(%r8)
; SSE-NEXT:    movaps %xmm7, 912(%r8)
; SSE-NEXT:    movaps %xmm9, 896(%r8)
; SSE-NEXT:    movaps %xmm8, 880(%r8)
; SSE-NEXT:    movaps %xmm11, 864(%r8)
; SSE-NEXT:    movaps %xmm10, 848(%r8)
...
; AVX-NEXT:    vmovaps 32(%rdx), %ymm5
; AVX-NEXT:    vmovaps (%rdx), %ymm6
; AVX-NEXT:    vmovaps 160(%rcx), %ymm1
; AVX-NEXT:    vmovaps 128(%rcx), %ymm7
; AVX-NEXT:    vmovaps 96(%rcx), %ymm8
...
; AVX-NEXT:    vunpckhpd {{.*#+}} ymm6 = ymm6[1],ymm11[1],ymm6[3],ymm11[3]
...
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm6 = ymm5[0],ymm10[0],ymm5[2],ymm10[2]
; AVX-NEXT:    vmovaps 48(%rsi), %xmm11
; AVX-NEXT:    vmovaps 48(%rdi), %xmm12
; AVX-NEXT:    vmovlhps {{.*#+}} xmm13 = xmm12[0],xmm11[0]
; AVX-NEXT:    vblendps {{.*#+}} ymm6 = ymm13[0,1,2,3],ymm6[4,5,6,7]
; AVX-NEXT:    vmovups %ymm6, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vunpckhpd {{.*#+}} ymm5 = ymm5[1],ymm10[1],ymm5[3],ymm10[3]
; AVX-NEXT:    vunpckhpd {{.*#+}} xmm6 = xmm12[1],xmm11[1]
; AVX-NEXT:    vblendps {{.*#+}} ymm5 = ymm6[0,1,2,3],ymm5[4,5,6,7]
; AVX-NEXT:    vmovups %ymm5, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm5 = ymm4[0],ymm9[0],ymm4[2],ymm9[2]
; AVX-NEXT:    vmovaps 80(%rsi), %xmm6
; AVX-NEXT:    vmovaps 80(%rdi), %xmm10
; AVX-NEXT:    vmovlhps {{.*#+}} xmm11 = xmm10[0],xmm6[0]
; AVX-NEXT:    vblendps {{.*#+}} ymm5 = ymm11[0,1,2,3],ymm5[4,5,6,7]
; AVX-NEXT:    vmovups %ymm5, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vunpckhpd {{.*#+}} ymm4 = ymm4[1],ymm9[1],ymm4[3],ymm9[3]
; AVX-NEXT:    vunpckhpd {{.*#+}} xmm5 = xmm10[1],xmm6[1]
; AVX-NEXT:    vblendps {{.*#+}} ymm4 = ymm5[0,1,2,3],ymm4[4,5,6,7]
; AVX-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm4 = ymm3[0],ymm8[0],ymm3[2],ymm8[2]
; AVX-NEXT:    vmovaps 112(%rsi), %xmm5
; AVX-NEXT:    vmovaps 112(%rdi), %xmm6
; AVX-NEXT:    vmovlhps {{.*#+}} xmm9 = xmm6[0],xmm5[0]
; AVX-NEXT:    vblendps {{.*#+}} ymm4 = ymm9[0,1,2,3],ymm4[4,5,6,7]
; AVX-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vunpckhpd {{.*#+}} ymm3 = ymm3[1],ymm8[1],ymm3[3],ymm8[3]
; AVX-NEXT:    vunpckhpd {{.*#+}} xmm4 = xmm6[1],xmm5[1]
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm4[0,1,2,3],ymm3[4,5,6,7]
; AVX-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm3 = ymm2[0],ymm7[0],ymm2[2],ymm7[2]
; AVX-NEXT:    vmovaps 144(%rsi), %xmm4
; AVX-NEXT:    vmovaps 144(%rdi), %xmm5
...
; AVX-NEXT:    vunpckhpd {{.*#+}} xmm3 = xmm5[1],xmm4[1]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm3[0,1,2,3],ymm2[4,5,6,7]
...
; AVX-NEXT:    vmovlhps {{.*#+}} xmm2 = xmm0[0],xmm1[0]
; AVX-NEXT:    vmovaps %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vunpckhpd {{.*#+}} xmm15 = xmm0[1],xmm1[1]
; AVX-NEXT:    vmovaps 160(%rcx), %xmm1
; AVX-NEXT:    vmovaps 160(%rdx), %xmm0
; AVX-NEXT:    vmovlhps {{.*#+}} xmm14 = xmm0[0],xmm1[0]
; AVX-NEXT:    vunpckhpd {{.*#+}} xmm13 = xmm0[1],xmm1[1]
...
; AVX2-NEXT:    vmovaps 32(%rcx), %ymm0
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm4 = ymm2[0],ymm0[0],ymm2[2],ymm0[2]
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm7 = ymm3[0],ymm1[0],ymm3[2],ymm1[2]
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm4 = ymm7[2,3],ymm4[2,3]
; AVX2-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm7[0],ymm0[0],ymm7[2],ymm0[2]
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm9 = ymm1[0],ymm3[0],ymm1[2],ymm3[2]
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm10 = ymm9[2,3],ymm2[2,3]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm7[1],ymm0[1],ymm7[3],ymm0[3]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm1 = ymm1[1],ymm3[1],ymm1[3],ymm3[3]
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm8 = ymm1[2,3],ymm0[2,3]
; AVX2-NEXT:    vmovaps 96(%rdi), %ymm1
; AVX2-NEXT:    vmovaps 96(%rsi), %ymm3
; AVX2-NEXT:    vmovaps 96(%rdx), %ymm7
; AVX2-NEXT:    vmovaps 96(%rcx), %ymm9
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm7[0],ymm9[0],ymm7[2],ymm9[2]
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm11 = ymm1[0],ymm3[0],ymm1[2],ymm3[2]
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm11[2,3],ymm0[2,3]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm7 = ymm7[1],ymm9[1],ymm7[3],ymm9[3]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm1 = ymm1[1],ymm3[1],ymm1[3],ymm3[3]
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm5 = ymm1[2,3],ymm7[2,3]
; AVX2-NEXT:    vmovaps 128(%rdi), %ymm3
; AVX2-NEXT:    vmovaps 128(%rsi), %ymm7
; AVX2-NEXT:    vmovaps 128(%rdx), %ymm9
; AVX2-NEXT:    vmovaps 128(%rcx), %ymm11
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm9[0],ymm11[0],ymm9[2],ymm11[2]
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm13 = ymm3[0],ymm7[0],ymm3[2],ymm7[2]
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm4 = ymm13[2,3],ymm0[2,3]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm9 = ymm9[1],ymm11[1],ymm9[3],ymm11[3]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm3 = ymm3[1],ymm7[1],ymm3[3],ymm7[3]
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm3 = ymm3[2,3],ymm9[2,3]
...
; AVX2-NEXT:    vmovaps %ymm9, 864(%r8)
; AVX2-NEXT:    vmovaps %ymm1, 832(%r8)
; AVX2-NEXT:    vmovaps %ymm7, 736(%r8)
; AVX2-NEXT:    vmovaps %ymm2, 704(%r8)
; AVX2-NEXT:    vmovaps %ymm3, 608(%r8)
; AVX2-NEXT:    vmovaps %ymm4, 576(%r8)
; AVX2-NEXT:    vmovaps %ymm5, 480(%r8)
; AVX2-NEXT:    vmovaps %ymm6, 448(%r8)
; AVX2-NEXT:    vmovaps %ymm8, 352(%r8)
...
; AVX2-FP-NEXT:    vmovaps 32(%rcx), %ymm0
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm4 = ymm2[0],ymm0[0],ymm2[2],ymm0[2]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm7 = ymm3[0],ymm1[0],ymm3[2],ymm1[2]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm4 = ymm7[2,3],ymm4[2,3]
; AVX2-FP-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FP-NEXT:    vmovaps 64(%rcx), %ymm0
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm7[0],ymm0[0],ymm7[2],ymm0[2]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm9 = ymm1[0],ymm3[0],ymm1[2],ymm3[2]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm10 = ymm9[2,3],ymm2[2,3]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm7[1],ymm0[1],ymm7[3],ymm0[3]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm1 = ymm1[1],ymm3[1],ymm1[3],ymm3[3]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm8 = ymm1[2,3],ymm0[2,3]
; AVX2-FP-NEXT:    vmovaps 96(%rdi), %ymm1
; AVX2-FP-NEXT:    vmovaps 96(%rsi), %ymm3
; AVX2-FP-NEXT:    vmovaps 96(%rdx), %ymm7
; AVX2-FP-NEXT:    vmovaps 96(%rcx), %ymm9
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm7[0],ymm9[0],ymm7[2],ymm9[2]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm11 = ymm1[0],ymm3[0],ymm1[2],ymm3[2]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm11[2,3],ymm0[2,3]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm7 = ymm7[1],ymm9[1],ymm7[3],ymm9[3]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm1 = ymm1[1],ymm3[1],ymm1[3],ymm3[3]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm5 = ymm1[2,3],ymm7[2,3]
; AVX2-FP-NEXT:    vmovaps 128(%rdi), %ymm3
; AVX2-FP-NEXT:    vmovaps 128(%rsi), %ymm7
; AVX2-FP-NEXT:    vmovaps 128(%rdx), %ymm9
; AVX2-FP-NEXT:    vmovaps 128(%rcx), %ymm11
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm9[0],ymm11[0],ymm9[2],ymm11[2]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm13 = ymm3[0],ymm7[0],ymm3[2],ymm7[2]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm4 = ymm13[2,3],ymm0[2,3]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm9 = ymm9[1],ymm11[1],ymm9[3],ymm11[3]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm3 = ymm3[1],ymm7[1],ymm3[3],ymm7[3]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm3 = ymm3[2,3],ymm9[2,3]
...
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm15 = ymm7[0],ymm9[0],ymm7[2],ymm9[2]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm15[2,3],ymm0[2,3]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm11 = ymm11[1],ymm13[1],ymm11[3],ymm13[3]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm7 = ymm7[1],ymm9[1],ymm7[3],ymm9[3]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm7 = ymm7[2,3],ymm11[2,3]
; AVX2-FP-NEXT:    vmovaps 192(%rdi), %ymm9
; AVX2-FP-NEXT:    vmovaps 192(%rsi), %ymm11
; AVX2-FP-NEXT:    vmovaps 192(%rdx), %ymm13
; AVX2-FP-NEXT:    vmovaps 192(%rcx), %ymm15
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm13[0],ymm15[0],ymm13[2],ymm15[2]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm14 = ymm9[0],ymm11[0],ymm9[2],ymm11[2]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm14[2,3],ymm0[2,3]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm13 = ymm13[1],ymm15[1],ymm13[3],ymm15[3]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm9 = ymm9[1],ymm11[1],ymm9[3],ymm11[3]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm9 = ymm9[2,3],ymm13[2,3]
...
; AVX2-FP-NEXT:    vmovaps %ymm9, 864(%r8)
; AVX2-FP-NEXT:    vmovaps %ymm1, 832(%r8)
; AVX2-FP-NEXT:    vmovaps %ymm7, 736(%r8)
; AVX2-FP-NEXT:    vmovaps %ymm2, 704(%r8)
; AVX2-FP-NEXT:    vmovaps %ymm3, 608(%r8)
; AVX2-FP-NEXT:    vmovaps %ymm4, 576(%r8)
; AVX2-FP-NEXT:    vmovaps %ymm5, 480(%r8)
; AVX2-FP-NEXT:    vmovaps %ymm6, 448(%r8)
; AVX2-FP-NEXT:    vmovaps %ymm8, 352(%r8)
...
; AVX2-FCP-NEXT:    vmovaps 32(%rcx), %ymm0
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm4 = ymm2[0],ymm0[0],ymm2[2],ymm0[2]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm7 = ymm3[0],ymm1[0],ymm3[2],ymm1[2]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm4 = ymm7[2,3],ymm4[2,3]
; AVX2-FCP-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FCP-NEXT:    vmovaps 64(%rsi), %ymm3
; AVX2-FCP-NEXT:    vmovaps 64(%rdx), %ymm7
; AVX2-FCP-NEXT:    vmovaps 64(%rcx), %ymm0
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm7[0],ymm0[0],ymm7[2],ymm0[2]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm9 = ymm1[0],ymm3[0],ymm1[2],ymm3[2]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm10 = ymm9[2,3],ymm2[2,3]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm7[1],ymm0[1],ymm7[3],ymm0[3]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm1 = ymm1[1],ymm3[1],ymm1[3],ymm3[3]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm8 = ymm1[2,3],ymm0[2,3]
; AVX2-FCP-NEXT:    vmovaps 96(%rdi), %ymm1
; AVX2-FCP-NEXT:    vmovaps 96(%rsi), %ymm3
; AVX2-FCP-NEXT:    vmovaps 96(%rdx), %ymm7
; AVX2-FCP-NEXT:    vmovaps 96(%rcx), %ymm9
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm7[0],ymm9[0],ymm7[2],ymm9[2]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm11 = ymm1[0],ymm3[0],ymm1[2],ymm3[2]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm11[2,3],ymm0[2,3]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm7 = ymm7[1],ymm9[1],ymm7[3],ymm9[3]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm1 = ymm1[1],ymm3[1],ymm1[3],ymm3[3]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm5 = ymm1[2,3],ymm7[2,3]
; AVX2-FCP-NEXT:    vmovaps 128(%rdi), %ymm3
; AVX2-FCP-NEXT:    vmovaps 128(%rsi), %ymm7
; AVX2-FCP-NEXT:    vmovaps 128(%rdx), %ymm9
; AVX2-FCP-NEXT:    vmovaps 128(%rcx), %ymm11
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm9[0],ymm11[0],ymm9[2],ymm11[2]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm13 = ymm3[0],ymm7[0],ymm3[2],ymm7[2]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm4 = ymm13[2,3],ymm0[2,3]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm9 = ymm9[1],ymm11[1],ymm9[3],ymm11[3]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm3 = ymm3[1],ymm7[1],ymm3[3],ymm7[3]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm3 = ymm3[2,3],ymm9[2,3]
; AVX2-FCP-NEXT:    vmovaps 160(%rdi), %ymm7
; AVX2-FCP-NEXT:    vmovaps 160(%rsi), %ymm9
...
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm15 = ymm7[0],ymm9[0],ymm7[2],ymm9[2]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm15[2,3],ymm0[2,3]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm11 = ymm11[1],ymm13[1],ymm11[3],ymm13[3]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm7 = ymm7[1],ymm9[1],ymm7[3],ymm9[3]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm7 = ymm7[2,3],ymm11[2,3]
; AVX2-FCP-NEXT:    vmovaps 192(%rdi), %ymm9
; AVX2-FCP-NEXT:    vmovaps 192(%rsi), %ymm11
; AVX2-FCP-NEXT:    vmovaps 192(%rdx), %ymm13
; AVX2-FCP-NEXT:    vmovaps 192(%rcx), %ymm15
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm13[0],ymm15[0],ymm13[2],ymm15[2]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm14 = ymm9[0],ymm11[0],ymm9[2],ymm11[2]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm14[2,3],ymm0[2,3]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm13 = ymm13[1],ymm15[1],ymm13[3],ymm15[3]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm9 = ymm9[1],ymm11[1],ymm9[3],ymm11[3]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm9 = ymm9[2,3],ymm13[2,3]
...
; AVX2-FCP-NEXT:    vmovaps %ymm9, 864(%r8)
; AVX2-FCP-NEXT:    vmovaps %ymm1, 832(%r8)
; AVX2-FCP-NEXT:    vmovaps %ymm7, 736(%r8)
; AVX2-FCP-NEXT:    vmovaps %ymm2, 704(%r8)
; AVX2-FCP-NEXT:    vmovaps %ymm3, 608(%r8)
; AVX2-FCP-NEXT:    vmovaps %ymm4, 576(%r8)
; AVX2-FCP-NEXT:    vmovaps %ymm5, 480(%r8)
; AVX2-FCP-NEXT:    vmovaps %ymm6, 448(%r8)
; AVX2-FCP-NEXT:    vmovaps %ymm8, 352(%r8)
...
; SSE-NEXT:    movaps %xmm7, 1952(%r8)
; SSE-NEXT:    movaps %xmm6, 1936(%r8)
; SSE-NEXT:    movaps %xmm9, 1920(%r8)
; SSE-NEXT:    movaps %xmm8, 1904(%r8)
; SSE-NEXT:    movaps %xmm10, 1888(%r8)
; SSE-NEXT:    movaps %xmm11, 1872(%r8)
; SSE-NEXT:    movaps %xmm13, 1856(%r8)
; SSE-NEXT:    movaps %xmm12, 1840(%r8)
; SSE-NEXT:    movaps %xmm15, 1824(%r8)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 1808(%r8)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 1792(%r8)
; SSE-NEXT:    movaps %xmm14, 1776(%r8)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; AVX-NEXT:    vmovaps 32(%rcx), %ymm10
; AVX-NEXT:    vmovaps (%rcx), %ymm11
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm12 = ymm5[0],ymm11[0],ymm5[2],ymm11[2]
; AVX-NEXT:    vmovaps 16(%rsi), %xmm13
; AVX-NEXT:    vmovaps 16(%rdi), %xmm14
; AVX-NEXT:    vmovlhps {{.*#+}} xmm15 = xmm14[0],xmm13[0]
; AVX-NEXT:    vblendps {{.*#+}} ymm12 = ymm15[0,1,2,3],ymm12[4,5,6,7]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm5 = ymm11[0,1,2,3],ymm5[4,5,6,7]
; AVX-NEXT:    vmovups %ymm5, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm5 = ymm4[0],ymm10[0],ymm4[2],ymm10[2]
; AVX-NEXT:    vmovaps 48(%rsi), %xmm11
; AVX-NEXT:    vmovaps 48(%rdi), %xmm12
; AVX-NEXT:    vmovlhps {{.*#+}} xmm13 = xmm12[0],xmm11[0]
; AVX-NEXT:    vblendps {{.*#+}} ymm5 = ymm13[0,1,2,3],ymm5[4,5,6,7]
; AVX-NEXT:    vmovups %ymm5, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vunpckhpd {{.*#+}} ymm4 = ymm4[1],ymm10[1],ymm4[3],ymm10[3]
; AVX-NEXT:    vunpckhpd {{.*#+}} xmm5 = xmm12[1],xmm11[1]
; AVX-NEXT:    vblendps {{.*#+}} ymm4 = ymm5[0,1,2,3],ymm4[4,5,6,7]
; AVX-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm4 = ymm3[0],ymm9[0],ymm3[2],ymm9[2]
; AVX-NEXT:    vmovaps 80(%rsi), %xmm5
; AVX-NEXT:    vmovaps 80(%rdi), %xmm10
; AVX-NEXT:    vmovlhps {{.*#+}} xmm11 = xmm10[0],xmm5[0]
; AVX-NEXT:    vblendps {{.*#+}} ymm4 = ymm11[0,1,2,3],ymm4[4,5,6,7]
; AVX-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vunpckhpd {{.*#+}} ymm3 = ymm3[1],ymm9[1],ymm3[3],ymm9[3]
; AVX-NEXT:    vunpckhpd {{.*#+}} xmm4 = xmm10[1],xmm5[1]
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm4[0,1,2,3],ymm3[4,5,6,7]
; AVX-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm3 = ymm2[0],ymm8[0],ymm2[2],ymm8[2]
; AVX-NEXT:    vmovaps 112(%rsi), %xmm4
; AVX-NEXT:    vmovaps 112(%rdi), %xmm5
; AVX-NEXT:    vmovlhps {{.*#+}} xmm9 = xmm5[0],xmm4[0]
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm9[0,1,2,3],ymm3[4,5,6,7]
; AVX-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vunpckhpd {{.*#+}} ymm2 = ymm2[1],ymm8[1],ymm2[3],ymm8[3]
; AVX-NEXT:    vunpckhpd {{.*#+}} xmm3 = xmm5[1],xmm4[1]
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm3[0,1,2,3],ymm2[4,5,6,7]
; AVX-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm1[0],ymm7[0],ymm1[2],ymm7[2]
...
; AVX-NEXT:    vunpckhpd {{.*#+}} xmm2 = xmm4[1],xmm3[1]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm2[0,1,2,3],ymm1[4,5,6,7]
; AVX-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm1 = ymm0[0],ymm6[0],ymm0[2],ymm6[2]
; AVX-NEXT:    vmovaps 176(%rsi), %xmm2
; AVX-NEXT:    vmovaps 176(%rdi), %xmm3
; AVX-NEXT:    vmovlhps {{.*#+}} xmm4 = xmm3[0],xmm2[0]
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm4[0,1,2,3],ymm1[4,5,6,7]
; AVX-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vmovaps 192(%rdx), %ymm1
; AVX-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm0[1],ymm6[1],ymm0[3],ymm6[3]
; AVX-NEXT:    vmovaps 192(%rcx), %ymm4
; AVX-NEXT:    vunpckhpd {{.*#+}} xmm2 = xmm3[1],xmm2[1]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm2[0,1,2,3],ymm0[4,5,6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm1[0],ymm4[0],ymm1[2],ymm4[2]
; AVX-NEXT:    vmovaps 208(%rsi), %xmm2
; AVX-NEXT:    vmovaps 208(%rdi), %xmm3
; AVX-NEXT:    vmovlhps {{.*#+}} xmm5 = xmm3[0],xmm2[0]
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm5[0,1,2,3],ymm0[4,5,6,7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm1[1],ymm4[1],ymm1[3],ymm4[3]
...
; AVX-NEXT:    vunpckhpd {{.*#+}} xmm0 = xmm0[1],xmm1[1]
; AVX-NEXT:    vmovaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vmovaps 352(%rcx), %xmm1
; AVX-NEXT:    vmovaps 352(%rdx), %xmm0
; AVX-NEXT:    vmovlhps {{.*#+}} xmm2 = xmm0[0],xmm1[0]
; AVX-NEXT:    vmovaps %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vunpckhpd {{.*#+}} xmm0 = xmm0[1],xmm1[1]
; AVX-NEXT:    vmovaps %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vmovaps 320(%rsi), %xmm1
...
; AVX2-NEXT:    vmovaps 160(%rcx), %ymm0
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm4 = ymm2[0],ymm0[0],ymm2[2],ymm0[2]
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm15 = ymm3[0],ymm1[0],ymm3[2],ymm1[2]
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm4 = ymm15[2,3],ymm4[2,3]
; AVX2-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm2[1],ymm0[1],ymm2[3],ymm0[3]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm1 = ymm3[1],ymm1[1],ymm3[3],ymm1[3]
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm1[2,3],ymm0[2,3]
...
; AVX2-NEXT:    vmovaps 192(%rsi), %ymm3
; AVX2-NEXT:    vmovaps 192(%rdx), %ymm15
; AVX2-NEXT:    vmovaps 192(%rcx), %ymm0
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm15[0],ymm0[0],ymm15[2],ymm0[2]
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm14 = ymm1[0],ymm3[0],ymm1[2],ymm3[2]
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm14[2,3],ymm2[2,3]
; AVX2-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-NEXT:    vmovaps 256(%rsi), %ymm13
; AVX2-NEXT:    vmovaps 256(%rdx), %ymm14
; AVX2-NEXT:    vmovaps 256(%rcx), %ymm15
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm14[0],ymm15[0],ymm14[2],ymm15[2]
...
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm3[2,3],ymm12[2,3]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovaps 288(%rdi), %ymm12
; AVX2-NEXT:    vmovaps 288(%rsi), %ymm13
; AVX2-NEXT:    vmovaps 288(%rdx), %ymm14
; AVX2-NEXT:    vmovaps 288(%rcx), %ymm15
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm14[0],ymm15[0],ymm14[2],ymm15[2]
...
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm12[2,3],ymm11[2,3]
; AVX2-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovaps 320(%rdi), %ymm12
; AVX2-NEXT:    vmovaps 320(%rsi), %ymm13
; AVX2-NEXT:    vmovaps 320(%rdx), %ymm14
; AVX2-NEXT:    vmovaps 320(%rcx), %ymm15
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm14[0],ymm15[0],ymm14[2],ymm15[2]
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm10 = ymm12[0],ymm13[0],ymm12[2],ymm13[2]
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm5 = ymm10[2,3],ymm0[2,3]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm10 = ymm14[1],ymm15[1],ymm14[3],ymm15[3]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm12 = ymm12[1],ymm13[1],ymm12[3],ymm13[3]
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm10 = ymm12[2,3],ymm10[2,3]
; AVX2-NEXT:    vmovaps 352(%rdi), %ymm12
; AVX2-NEXT:    vmovaps 352(%rsi), %ymm13
; AVX2-NEXT:    vmovaps 352(%rdx), %ymm14
; AVX2-NEXT:    vmovaps 352(%rcx), %ymm15
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm14[0],ymm15[0],ymm14[2],ymm15[2]
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm9 = ymm12[0],ymm13[0],ymm12[2],ymm13[2]
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm4 = ymm9[2,3],ymm0[2,3]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm9 = ymm14[1],ymm15[1],ymm14[3],ymm15[3]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm12 = ymm12[1],ymm13[1],ymm12[3],ymm13[3]
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm9 = ymm12[2,3],ymm9[2,3]
; AVX2-NEXT:    vmovaps 384(%rdi), %ymm12
; AVX2-NEXT:    vmovaps 384(%rsi), %ymm13
; AVX2-NEXT:    vmovaps 384(%rdx), %ymm14
; AVX2-NEXT:    vmovaps 384(%rcx), %ymm15
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm14[0],ymm15[0],ymm14[2],ymm15[2]
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm8 = ymm12[0],ymm13[0],ymm12[2],ymm13[2]
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm3 = ymm8[2,3],ymm0[2,3]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm8 = ymm14[1],ymm15[1],ymm14[3],ymm15[3]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm12 = ymm12[1],ymm13[1],ymm12[3],ymm13[3]
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm8 = ymm12[2,3],ymm8[2,3]
; AVX2-NEXT:    vmovaps 416(%rdi), %ymm12
; AVX2-NEXT:    vmovaps 416(%rsi), %ymm13
; AVX2-NEXT:    vmovaps 416(%rdx), %ymm14
; AVX2-NEXT:    vmovaps 416(%rcx), %ymm15
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm14[0],ymm15[0],ymm14[2],ymm15[2]
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm7 = ymm12[0],ymm13[0],ymm12[2],ymm13[2]
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm7[2,3],ymm0[2,3]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm7 = ymm14[1],ymm15[1],ymm14[3],ymm15[3]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm12 = ymm12[1],ymm13[1],ymm12[3],ymm13[3]
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm7 = ymm12[2,3],ymm7[2,3]
...
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm14[0],ymm15[0],ymm14[2],ymm15[2]
; AVX2-NEXT:    vunpcklpd {{.*#+}} ymm6 = ymm12[0],ymm13[0],ymm12[2],ymm13[2]
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm6[2,3],ymm0[2,3]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm6 = ymm14[1],ymm15[1],ymm14[3],ymm15[3]
; AVX2-NEXT:    vunpckhpd {{.*#+}} ymm12 = ymm12[1],ymm13[1],ymm12[3],ymm13[3]
; AVX2-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm12[2,3],ymm6[2,3]
...
; AVX2-NEXT:    vmovaps %ymm6, 1888(%r8)
; AVX2-NEXT:    vmovaps %ymm1, 1856(%r8)
; AVX2-NEXT:    vmovaps %ymm7, 1760(%r8)
; AVX2-NEXT:    vmovaps %ymm2, 1728(%r8)
; AVX2-NEXT:    vmovaps %ymm8, 1632(%r8)
; AVX2-NEXT:    vmovaps %ymm3, 1600(%r8)
; AVX2-NEXT:    vmovaps %ymm9, 1504(%r8)
; AVX2-NEXT:    vmovaps %ymm4, 1472(%r8)
; AVX2-NEXT:    vmovaps %ymm10, 1376(%r8)
; AVX2-NEXT:    vmovaps %ymm5, 1344(%r8)
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX2-FP-NEXT:    vmovaps 160(%rcx), %ymm0
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm4 = ymm2[0],ymm0[0],ymm2[2],ymm0[2]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm15 = ymm3[0],ymm1[0],ymm3[2],ymm1[2]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm4 = ymm15[2,3],ymm4[2,3]
; AVX2-FP-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm2[1],ymm0[1],ymm2[3],ymm0[3]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm1 = ymm3[1],ymm1[1],ymm3[3],ymm1[3]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm1[2,3],ymm0[2,3]
...
; AVX2-FP-NEXT:    vmovaps 192(%rsi), %ymm3
; AVX2-FP-NEXT:    vmovaps 192(%rdx), %ymm15
; AVX2-FP-NEXT:    vmovaps 192(%rcx), %ymm0
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm15[0],ymm0[0],ymm15[2],ymm0[2]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm14 = ymm1[0],ymm3[0],ymm1[2],ymm3[2]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm14[2,3],ymm2[2,3]
; AVX2-FP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm1 = ymm1[1],ymm3[1],ymm1[3],ymm3[3]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm1[2,3],ymm13[2,3]
; AVX2-FP-NEXT:    vmovups %ymm0, (%rsp) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps 256(%rdi), %ymm3
; AVX2-FP-NEXT:    vmovaps 256(%rsi), %ymm13
; AVX2-FP-NEXT:    vmovaps 256(%rdx), %ymm14
; AVX2-FP-NEXT:    vmovaps 256(%rcx), %ymm15
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm14[0],ymm15[0],ymm14[2],ymm15[2]
...
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm3[2,3],ymm12[2,3]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps 288(%rdi), %ymm12
; AVX2-FP-NEXT:    vmovaps 288(%rsi), %ymm13
; AVX2-FP-NEXT:    vmovaps 288(%rdx), %ymm14
; AVX2-FP-NEXT:    vmovaps 288(%rcx), %ymm15
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm14[0],ymm15[0],ymm14[2],ymm15[2]
...
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm12[2,3],ymm11[2,3]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovaps 320(%rdi), %ymm12
; AVX2-FP-NEXT:    vmovaps 320(%rsi), %ymm13
; AVX2-FP-NEXT:    vmovaps 320(%rdx), %ymm14
; AVX2-FP-NEXT:    vmovaps 320(%rcx), %ymm15
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm14[0],ymm15[0],ymm14[2],ymm15[2]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm10 = ymm12[0],ymm13[0],ymm12[2],ymm13[2]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm5 = ymm10[2,3],ymm0[2,3]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm10 = ymm14[1],ymm15[1],ymm14[3],ymm15[3]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm12 = ymm12[1],ymm13[1],ymm12[3],ymm13[3]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm10 = ymm12[2,3],ymm10[2,3]
; AVX2-FP-NEXT:    vmovaps 352(%rdi), %ymm12
; AVX2-FP-NEXT:    vmovaps 352(%rsi), %ymm13
; AVX2-FP-NEXT:    vmovaps 352(%rdx), %ymm14
; AVX2-FP-NEXT:    vmovaps 352(%rcx), %ymm15
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm14[0],ymm15[0],ymm14[2],ymm15[2]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm9 = ymm12[0],ymm13[0],ymm12[2],ymm13[2]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm4 = ymm9[2,3],ymm0[2,3]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm9 = ymm14[1],ymm15[1],ymm14[3],ymm15[3]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm12 = ymm12[1],ymm13[1],ymm12[3],ymm13[3]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm9 = ymm12[2,3],ymm9[2,3]
; AVX2-FP-NEXT:    vmovaps 384(%rdi), %ymm12
; AVX2-FP-NEXT:    vmovaps 384(%rsi), %ymm13
; AVX2-FP-NEXT:    vmovaps 384(%rdx), %ymm14
; AVX2-FP-NEXT:    vmovaps 384(%rcx), %ymm15
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm14[0],ymm15[0],ymm14[2],ymm15[2]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm8 = ymm12[0],ymm13[0],ymm12[2],ymm13[2]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm3 = ymm8[2,3],ymm0[2,3]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm8 = ymm14[1],ymm15[1],ymm14[3],ymm15[3]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm12 = ymm12[1],ymm13[1],ymm12[3],ymm13[3]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm8 = ymm12[2,3],ymm8[2,3]
; AVX2-FP-NEXT:    vmovaps 416(%rdi), %ymm12
; AVX2-FP-NEXT:    vmovaps 416(%rsi), %ymm13
; AVX2-FP-NEXT:    vmovaps 416(%rdx), %ymm14
; AVX2-FP-NEXT:    vmovaps 416(%rcx), %ymm15
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm14[0],ymm15[0],ymm14[2],ymm15[2]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm7 = ymm12[0],ymm13[0],ymm12[2],ymm13[2]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm7[2,3],ymm0[2,3]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm7 = ymm14[1],ymm15[1],ymm14[3],ymm15[3]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm12 = ymm12[1],ymm13[1],ymm12[3],ymm13[3]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm7 = ymm12[2,3],ymm7[2,3]
...
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm14[0],ymm15[0],ymm14[2],ymm15[2]
; AVX2-FP-NEXT:    vunpcklpd {{.*#+}} ymm6 = ymm12[0],ymm13[0],ymm12[2],ymm13[2]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm6[2,3],ymm0[2,3]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm6 = ymm14[1],ymm15[1],ymm14[3],ymm15[3]
; AVX2-FP-NEXT:    vunpckhpd {{.*#+}} ymm12 = ymm12[1],ymm13[1],ymm12[3],ymm13[3]
; AVX2-FP-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm12[2,3],ymm6[2,3]
...
; AVX2-FP-NEXT:    vmovaps %ymm6, 1888(%r8)
; AVX2-FP-NEXT:    vmovaps %ymm1, 1856(%r8)
; AVX2-FP-NEXT:    vmovaps %ymm7, 1760(%r8)
; AVX2-FP-NEXT:    vmovaps %ymm2, 1728(%r8)
; AVX2-FP-NEXT:    vmovaps %ymm8, 1632(%r8)
; AVX2-FP-NEXT:    vmovaps %ymm3, 1600(%r8)
; AVX2-FP-NEXT:    vmovaps %ymm9, 1504(%r8)
; AVX2-FP-NEXT:    vmovaps %ymm4, 1472(%r8)
; AVX2-FP-NEXT:    vmovaps %ymm10, 1376(%r8)
; AVX2-FP-NEXT:    vmovaps %ymm5, 1344(%r8)
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX2-FCP-NEXT:    vmovaps 160(%rcx), %ymm0
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm4 = ymm2[0],ymm0[0],ymm2[2],ymm0[2]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm15 = ymm3[0],ymm1[0],ymm3[2],ymm1[2]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm4 = ymm15[2,3],ymm4[2,3]
; AVX2-FCP-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm0 = ymm2[1],ymm0[1],ymm2[3],ymm0[3]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm1 = ymm3[1],ymm1[1],ymm3[3],ymm1[3]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm1[2,3],ymm0[2,3]
...
; AVX2-FCP-NEXT:    vmovaps 192(%rdx), %ymm15
; AVX2-FCP-NEXT:    vmovaps 192(%rcx), %ymm0
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm2 = ymm15[0],ymm0[0],ymm15[2],ymm0[2]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm14 = ymm1[0],ymm3[0],ymm1[2],ymm3[2]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm14[2,3],ymm2[2,3]
; AVX2-FCP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm1 = ymm1[1],ymm3[1],ymm1[3],ymm3[3]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm1[2,3],ymm13[2,3]
; AVX2-FCP-NEXT:    vmovups %ymm0, (%rsp) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps 256(%rdi), %ymm3
; AVX2-FCP-NEXT:    vmovaps 256(%rsi), %ymm13
; AVX2-FCP-NEXT:    vmovaps 256(%rdx), %ymm14
; AVX2-FCP-NEXT:    vmovaps 256(%rcx), %ymm15
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm14[0],ymm15[0],ymm14[2],ymm15[2]
...
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm3[2,3],ymm12[2,3]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps 288(%rdi), %ymm12
; AVX2-FCP-NEXT:    vmovaps 288(%rsi), %ymm13
; AVX2-FCP-NEXT:    vmovaps 288(%rdx), %ymm14
; AVX2-FCP-NEXT:    vmovaps 288(%rcx), %ymm15
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm14[0],ymm15[0],ymm14[2],ymm15[2]
...
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm0 = ymm12[2,3],ymm11[2,3]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovaps 320(%rdi), %ymm12
; AVX2-FCP-NEXT:    vmovaps 320(%rsi), %ymm13
; AVX2-FCP-NEXT:    vmovaps 320(%rdx), %ymm14
; AVX2-FCP-NEXT:    vmovaps 320(%rcx), %ymm15
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm14[0],ymm15[0],ymm14[2],ymm15[2]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm10 = ymm12[0],ymm13[0],ymm12[2],ymm13[2]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm5 = ymm10[2,3],ymm0[2,3]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm10 = ymm14[1],ymm15[1],ymm14[3],ymm15[3]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm12 = ymm12[1],ymm13[1],ymm12[3],ymm13[3]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm10 = ymm12[2,3],ymm10[2,3]
; AVX2-FCP-NEXT:    vmovaps 352(%rdi), %ymm12
; AVX2-FCP-NEXT:    vmovaps 352(%rsi), %ymm13
; AVX2-FCP-NEXT:    vmovaps 352(%rdx), %ymm14
; AVX2-FCP-NEXT:    vmovaps 352(%rcx), %ymm15
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm14[0],ymm15[0],ymm14[2],ymm15[2]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm9 = ymm12[0],ymm13[0],ymm12[2],ymm13[2]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm4 = ymm9[2,3],ymm0[2,3]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm9 = ymm14[1],ymm15[1],ymm14[3],ymm15[3]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm12 = ymm12[1],ymm13[1],ymm12[3],ymm13[3]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm9 = ymm12[2,3],ymm9[2,3]
; AVX2-FCP-NEXT:    vmovaps 384(%rdi), %ymm12
; AVX2-FCP-NEXT:    vmovaps 384(%rsi), %ymm13
; AVX2-FCP-NEXT:    vmovaps 384(%rdx), %ymm14
; AVX2-FCP-NEXT:    vmovaps 384(%rcx), %ymm15
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm14[0],ymm15[0],ymm14[2],ymm15[2]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm8 = ymm12[0],ymm13[0],ymm12[2],ymm13[2]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm3 = ymm8[2,3],ymm0[2,3]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm8 = ymm14[1],ymm15[1],ymm14[3],ymm15[3]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm12 = ymm12[1],ymm13[1],ymm12[3],ymm13[3]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm8 = ymm12[2,3],ymm8[2,3]
; AVX2-FCP-NEXT:    vmovaps 416(%rdi), %ymm12
; AVX2-FCP-NEXT:    vmovaps 416(%rsi), %ymm13
; AVX2-FCP-NEXT:    vmovaps 416(%rdx), %ymm14
; AVX2-FCP-NEXT:    vmovaps 416(%rcx), %ymm15
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm14[0],ymm15[0],ymm14[2],ymm15[2]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm7 = ymm12[0],ymm13[0],ymm12[2],ymm13[2]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm2 = ymm7[2,3],ymm0[2,3]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm7 = ymm14[1],ymm15[1],ymm14[3],ymm15[3]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm12 = ymm12[1],ymm13[1],ymm12[3],ymm13[3]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm7 = ymm12[2,3],ymm7[2,3]
...
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm0 = ymm14[0],ymm15[0],ymm14[2],ymm15[2]
; AVX2-FCP-NEXT:    vunpcklpd {{.*#+}} ymm6 = ymm12[0],ymm13[0],ymm12[2],ymm13[2]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm1 = ymm6[2,3],ymm0[2,3]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm6 = ymm14[1],ymm15[1],ymm14[3],ymm15[3]
; AVX2-FCP-NEXT:    vunpckhpd {{.*#+}} ymm12 = ymm12[1],ymm13[1],ymm12[3],ymm13[3]
; AVX2-FCP-NEXT:    vperm2f128 {{.*#+}} ymm6 = ymm12[2,3],ymm6[2,3]
...
; AVX2-FCP-NEXT:    vmovaps %ymm6, 1888(%r8)
; AVX2-FCP-NEXT:    vmovaps %ymm1, 1856(%r8)
; AVX2-FCP-NEXT:    vmovaps %ymm7, 1760(%r8)
; AVX2-FCP-NEXT:    vmovaps %ymm2, 1728(%r8)
; AVX2-FCP-NEXT:    vmovaps %ymm8, 1632(%r8)
; AVX2-FCP-NEXT:    vmovaps %ymm3, 1600(%r8)
; AVX2-FCP-NEXT:    vmovaps %ymm9, 1504(%r8)
; AVX2-FCP-NEXT:    vmovaps %ymm4, 1472(%r8)
; AVX2-FCP-NEXT:    vmovaps %ymm10, 1376(%r8)
; AVX2-FCP-NEXT:    vmovaps %ymm5, 1344(%r8)
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX512-NEXT:    vmovdqa64 320(%rcx), %zmm5
; AVX512-NEXT:    vmovdqa64 256(%rcx), %zmm0
; AVX512-NEXT:    vmovdqa64 (%rcx), %zmm2
; AVX512-NEXT:    vmovdqa64 64(%rcx), %zmm3
; AVX512-NEXT:    vmovdqa64 128(%rcx), %zmm4
; AVX512-NEXT:    vmovdqa64 192(%rcx), %zmm1
; AVX512-NEXT:    vpmovsxbq {{.*#+}} zmm9 = [0,0,0,8,0,0,1,9]
; AVX512-NEXT:    vmovdqa64 %zmm14, %zmm13
; AVX512-NEXT:    vpermt2q %zmm2, %zmm9, %zmm13
...
; AVX512-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-NEXT:    vmovdqa64 %zmm10, %zmm3
; AVX512-NEXT:    vpermt2q %zmm1, %zmm15, %zmm3
; AVX512-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
...
; AVX512-NEXT:    vpermt2q %zmm5, %zmm9, %zmm0
...
; AVX512-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-NEXT:    vpermt2q %zmm5, %zmm26, %zmm7
...
; AVX512-NEXT:    vpmovsxbq {{.*#+}} zmm4 = [2,10,0,0,3,11,0,0]
; AVX512-NEXT:    vmovdqa64 %zmm26, %zmm0
; AVX512-NEXT:    vpermt2q %zmm3, %zmm4, %zmm0
; AVX512-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-NEXT:    vpmovsxbq {{.*#+}} zmm2 = [4,12,0,0,5,13,0,0]
; AVX512-NEXT:    vmovdqa64 %zmm26, %zmm0
; AVX512-NEXT:    vpermt2q %zmm3, %zmm2, %zmm0
; AVX512-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-NEXT:    vpmovsxbq {{.*#+}} zmm21 = [6,14,0,0,7,15,0,0]
; AVX512-NEXT:    vpermt2q %zmm3, %zmm21, %zmm26
...
; AVX512-NEXT:    vpermt2q %zmm3, %zmm21, %zmm23
; AVX512-NEXT:    vmovdqa64 128(%rdi), %zmm20
; AVX512-NEXT:    vmovdqa64 128(%rsi), %zmm0
; AVX512-NEXT:    vmovdqa64 %zmm20, %zmm27
; AVX512-NEXT:    vpermt2q %zmm0, %zmm5, %zmm27
; AVX512-NEXT:    vmovdqa64 %zmm20, %zmm25
; AVX512-NEXT:    vpermt2q %zmm0, %zmm4, %zmm25
; AVX512-NEXT:    vmovdqa64 %zmm20, %zmm24
; AVX512-NEXT:    vpermt2q %zmm0, %zmm2, %zmm24
; AVX512-NEXT:    vpermt2q %zmm0, %zmm21, %zmm20
; AVX512-NEXT:    vmovdqa64 192(%rdi), %zmm10
; AVX512-NEXT:    vmovdqa64 192(%rsi), %zmm0
; AVX512-NEXT:    vmovdqa64 %zmm10, %zmm22
; AVX512-NEXT:    vpermt2q %zmm0, %zmm5, %zmm22
; AVX512-NEXT:    vmovdqa64 %zmm10, %zmm19
; AVX512-NEXT:    vpermt2q %zmm0, %zmm4, %zmm19
; AVX512-NEXT:    vmovdqa64 %zmm10, %zmm18
; AVX512-NEXT:    vpermt2q %zmm0, %zmm2, %zmm18
; AVX512-NEXT:    vpermt2q %zmm0, %zmm21, %zmm10
; AVX512-NEXT:    vmovdqa64 256(%rdi), %zmm9
; AVX512-NEXT:    vmovdqa64 256(%rsi), %zmm0
; AVX512-NEXT:    vmovdqa64 %zmm9, %zmm17
; AVX512-NEXT:    vpermt2q %zmm0, %zmm5, %zmm17
; AVX512-NEXT:    vmovdqa64 %zmm9, %zmm16
; AVX512-NEXT:    vpermt2q %zmm0, %zmm4, %zmm16
; AVX512-NEXT:    vmovdqa64 %zmm9, %zmm15
; AVX512-NEXT:    vpermt2q %zmm0, %zmm2, %zmm15
; AVX512-NEXT:    vpermt2q %zmm0, %zmm21, %zmm9
; AVX512-NEXT:    vmovdqa64 320(%rdi), %zmm3
; AVX512-NEXT:    vmovdqa64 320(%rsi), %zmm0
; AVX512-NEXT:    vmovdqa64 %zmm3, %zmm14
; AVX512-NEXT:    vpermt2q %zmm0, %zmm5, %zmm14
; AVX512-NEXT:    vmovdqa64 %zmm3, %zmm13
; AVX512-NEXT:    vpermt2q %zmm0, %zmm4, %zmm13
; AVX512-NEXT:    vmovdqa64 %zmm3, %zmm12
; AVX512-NEXT:    vpermt2q %zmm0, %zmm2, %zmm12
; AVX512-NEXT:    vpermt2q %zmm0, %zmm21, %zmm3
; AVX512-NEXT:    vmovdqa64 384(%rdi), %zmm8
; AVX512-NEXT:    vmovdqa64 384(%rsi), %zmm0
; AVX512-NEXT:    vmovdqa64 %zmm8, %zmm11
; AVX512-NEXT:    vpermt2q %zmm0, %zmm5, %zmm11
; AVX512-NEXT:    vmovdqa64 %zmm8, %zmm7
; AVX512-NEXT:    vpermt2q %zmm0, %zmm4, %zmm7
; AVX512-NEXT:    vmovdqa64 %zmm8, %zmm6
; AVX512-NEXT:    vpermt2q %zmm0, %zmm2, %zmm6
; AVX512-NEXT:    vpermt2q %zmm0, %zmm21, %zmm8
; AVX512-NEXT:    vmovdqa64 448(%rdi), %zmm1
; AVX512-NEXT:    vmovdqa64 448(%rsi), %zmm0
; AVX512-NEXT:    vpermi2q %zmm0, %zmm1, %zmm5
; AVX512-NEXT:    vpermi2q %zmm0, %zmm1, %zmm4
...
; AVX512-NEXT:    vmovdqa64 %zmm4, 1856(%r8)
; AVX512-NEXT:    vmovdqa64 %zmm5, 1792(%r8)
; AVX512-NEXT:    vmovdqa64 %zmm8, 1728(%r8)
; AVX512-NEXT:    vmovdqa64 %zmm6, 1664(%r8)
; AVX512-NEXT:    vmovdqa64 %zmm7, 1600(%r8)
; AVX512-NEXT:    vmovdqa64 %zmm11, 1536(%r8)
; AVX512-NEXT:    vmovdqa64 %zmm3, 1472(%r8)
; AVX512-NEXT:    vmovdqa64 %zmm12, 1408(%r8)
; AVX512-NEXT:    vmovdqa64 %zmm13, 1344(%r8)
; AVX512-NEXT:    vmovdqa64 %zmm14, 1280(%r8)
; AVX512-NEXT:    vmovdqa64 %zmm9, 1216(%r8)
; AVX512-NEXT:    vmovdqa64 %zmm15, 1152(%r8)
; AVX512-NEXT:    vmovdqa64 %zmm16, 1088(%r8)
; AVX512-NEXT:    vmovdqa64 %zmm17, 1024(%r8)
; AVX512-NEXT:    vmovdqa64 %zmm10, 960(%r8)
; AVX512-NEXT:    vmovdqa64 %zmm18, 896(%r8)
; AVX512-NEXT:    vmovdqa64 %zmm19, 832(%r8)
; AVX512-NEXT:    vmovdqa64 %zmm22, 768(%r8)
; AVX512-NEXT:    vmovdqa64 %zmm20, 704(%r8)
; AVX512-NEXT:    vmovdqa64 %zmm24, 640(%r8)
; AVX512-NEXT:    vmovdqa64 %zmm25, 576(%r8)
; AVX512-NEXT:    vmovdqa64 %zmm27, 512(%r8)
; AVX512-NEXT:    vmovdqa64 %zmm23, 448(%r8)
...
; AVX512-FCP-NEXT:    vmovdqa64 320(%rcx), %zmm5
; AVX512-FCP-NEXT:    vmovdqa64 256(%rcx), %zmm0
; AVX512-FCP-NEXT:    vmovdqa64 (%rcx), %zmm2
; AVX512-FCP-NEXT:    vmovdqa64 64(%rcx), %zmm3
; AVX512-FCP-NEXT:    vmovdqa64 128(%rcx), %zmm4
; AVX512-FCP-NEXT:    vmovdqa64 192(%rcx), %zmm1
; AVX512-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm9 = [0,0,0,8,0,0,1,9]
; AVX512-FCP-NEXT:    vmovdqa64 %zmm14, %zmm13
; AVX512-FCP-NEXT:    vpermt2q %zmm2, %zmm9, %zmm13
...
; AVX512-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vmovdqa64 %zmm10, %zmm3
; AVX512-FCP-NEXT:    vpermt2q %zmm1, %zmm13, %zmm3
; AVX512-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vmovdqa64 %zmm10, %zmm3
; AVX512-FCP-NEXT:    vpermt2q %zmm1, %zmm15, %zmm3
; AVX512-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
...
; AVX512-FCP-NEXT:    vpermt2q %zmm5, %zmm9, %zmm0
; AVX512-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vmovdqa64 %zmm7, %zmm0
; AVX512-FCP-NEXT:    vpermt2q %zmm5, %zmm13, %zmm0
; AVX512-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vmovdqa64 %zmm7, %zmm0
; AVX512-FCP-NEXT:    vpermt2q %zmm5, %zmm15, %zmm0
; AVX512-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vpermt2q %zmm5, %zmm26, %zmm7
...
; AVX512-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm4 = [2,10,0,0,3,11,0,0]
; AVX512-FCP-NEXT:    vmovdqa64 %zmm26, %zmm0
; AVX512-FCP-NEXT:    vpermt2q %zmm3, %zmm4, %zmm0
; AVX512-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm2 = [4,12,0,0,5,13,0,0]
; AVX512-FCP-NEXT:    vmovdqa64 %zmm26, %zmm0
; AVX512-FCP-NEXT:    vpermt2q %zmm3, %zmm2, %zmm0
; AVX512-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm21 = [6,14,0,0,7,15,0,0]
; AVX512-FCP-NEXT:    vpermt2q %zmm3, %zmm21, %zmm26
...
; AVX512-FCP-NEXT:    vpermt2q %zmm3, %zmm21, %zmm23
; AVX512-FCP-NEXT:    vmovdqa64 128(%rdi), %zmm20
; AVX512-FCP-NEXT:    vmovdqa64 128(%rsi), %zmm0
; AVX512-FCP-NEXT:    vmovdqa64 %zmm20, %zmm27
; AVX512-FCP-NEXT:    vpermt2q %zmm0, %zmm5, %zmm27
; AVX512-FCP-NEXT:    vmovdqa64 %zmm20, %zmm25
; AVX512-FCP-NEXT:    vpermt2q %zmm0, %zmm4, %zmm25
; AVX512-FCP-NEXT:    vmovdqa64 %zmm20, %zmm24
; AVX512-FCP-NEXT:    vpermt2q %zmm0, %zmm2, %zmm24
; AVX512-FCP-NEXT:    vpermt2q %zmm0, %zmm21, %zmm20
; AVX512-FCP-NEXT:    vmovdqa64 192(%rdi), %zmm10
; AVX512-FCP-NEXT:    vmovdqa64 192(%rsi), %zmm0
; AVX512-FCP-NEXT:    vmovdqa64 %zmm10, %zmm22
; AVX512-FCP-NEXT:    vpermt2q %zmm0, %zmm5, %zmm22
; AVX512-FCP-NEXT:    vmovdqa64 %zmm10, %zmm19
; AVX512-FCP-NEXT:    vpermt2q %zmm0, %zmm4, %zmm19
; AVX512-FCP-NEXT:    vmovdqa64 %zmm10, %zmm18
; AVX512-FCP-NEXT:    vpermt2q %zmm0, %zmm2, %zmm18
; AVX512-FCP-NEXT:    vpermt2q %zmm0, %zmm21, %zmm10
; AVX512-FCP-NEXT:    vmovdqa64 256(%rdi), %zmm9
; AVX512-FCP-NEXT:    vmovdqa64 256(%rsi), %zmm0
; AVX512-FCP-NEXT:    vmovdqa64 %zmm9, %zmm17
; AVX512-FCP-NEXT:    vpermt2q %zmm0, %zmm5, %zmm17
; AVX512-FCP-NEXT:    vmovdqa64 %zmm9, %zmm16
; AVX512-FCP-NEXT:    vpermt2q %zmm0, %zmm4, %zmm16
; AVX512-FCP-NEXT:    vmovdqa64 %zmm9, %zmm15
; AVX512-FCP-NEXT:    vpermt2q %zmm0, %zmm2, %zmm15
; AVX512-FCP-NEXT:    vpermt2q %zmm0, %zmm21, %zmm9
; AVX512-FCP-NEXT:    vmovdqa64 320(%rdi), %zmm3
; AVX512-FCP-NEXT:    vmovdqa64 320(%rsi), %zmm0
; AVX512-FCP-NEXT:    vmovdqa64 %zmm3, %zmm14
; AVX512-FCP-NEXT:    vpermt2q %zmm0, %zmm5, %zmm14
; AVX512-FCP-NEXT:    vmovdqa64 %zmm3, %zmm13
; AVX512-FCP-NEXT:    vpermt2q %zmm0, %zmm4, %zmm13
; AVX512-FCP-NEXT:    vmovdqa64 %zmm3, %zmm12
; AVX512-FCP-NEXT:    vpermt2q %zmm0, %zmm2, %zmm12
...
; AVX512-FCP-NEXT:    vpermt2q %zmm0, %zmm5, %zmm11
; AVX512-FCP-NEXT:    vmovdqa64 %zmm8, %zmm7
; AVX512-FCP-NEXT:    vpermt2q %zmm0, %zmm4, %zmm7
; AVX512-FCP-NEXT:    vmovdqa64 %zmm8, %zmm6
; AVX512-FCP-NEXT:    vpermt2q %zmm0, %zmm2, %zmm6
; AVX512-FCP-NEXT:    vpermt2q %zmm0, %zmm21, %zmm8
...
; AVX512-FCP-NEXT:    vmovdqa64 %zmm30, %zmm21
...
; AVX512-FCP-NEXT:    vmovdqa64 %zmm4, 1856(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm5, 1792(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm8, 1728(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm6, 1664(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm7, 1600(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm11, 1536(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm3, 1472(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm12, 1408(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm13, 1344(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm14, 1280(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm9, 1216(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm15, 1152(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm16, 1088(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm17, 1024(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm10, 960(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm18, 896(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm19, 832(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm22, 768(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm20, 704(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm24, 640(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm25, 576(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm27, 512(%r8)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm23, 448(%r8)
...
; AVX512DQ-NEXT:    vmovdqa64 320(%rcx), %zmm5
; AVX512DQ-NEXT:    vmovdqa64 256(%rcx), %zmm0
; AVX512DQ-NEXT:    vmovdqa64 (%rcx), %zmm2
; AVX512DQ-NEXT:    vmovdqa64 64(%rcx), %zmm3
; AVX512DQ-NEXT:    vmovdqa64 128(%rcx), %zmm4
; AVX512DQ-NEXT:    vmovdqa64 192(%rcx), %zmm1
; AVX512DQ-NEXT:    vpmovsxbq {{.*#+}} zmm9 = [0,0,0,8,0,0,1,9]
; AVX512DQ-NEXT:    vmovdqa64 %zmm14, %zmm13
; AVX512DQ-NEXT:    vpermt2q %zmm2, %zmm9, %zmm13
...
; AVX512DQ-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-NEXT:    vmovdqa64 %zmm10, %zmm3
; AVX512DQ-NEXT:    vpermt2q %zmm1, %zmm13, %zmm3
; AVX512DQ-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-NEXT:    vmovdqa64 %zmm10, %zmm3
; AVX512DQ-NEXT:    vpermt2q %zmm1, %zmm15, %zmm3
; AVX512DQ-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
...
; AVX512DQ-NEXT:    vpermt2q %zmm5, %zmm9, %zmm0
; AVX512DQ-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-NEXT:    vmovdqa64 %zmm7, %zmm0
; AVX512DQ-NEXT:    vpermt2q %zmm5, %zmm13, %zmm0
; AVX512DQ-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-NEXT:    vmovdqa64 %zmm7, %zmm0
; AVX512DQ-NEXT:    vpermt2q %zmm5, %zmm15, %zmm0
; AVX512DQ-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-NEXT:    vpermt2q %zmm5, %zmm26, %zmm7
...
; AVX512DQ-NEXT:    vpmovsxbq {{.*#+}} zmm4 = [2,10,0,0,3,11,0,0]
; AVX512DQ-NEXT:    vmovdqa64 %zmm26, %zmm0
; AVX512DQ-NEXT:    vpermt2q %zmm3, %zmm4, %zmm0
; AVX512DQ-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-NEXT:    vpmovsxbq {{.*#+}} zmm2 = [4,12,0,0,5,13,0,0]
; AVX512DQ-NEXT:    vmovdqa64 %zmm26, %zmm0
; AVX512DQ-NEXT:    vpermt2q %zmm3, %zmm2, %zmm0
; AVX512DQ-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-NEXT:    vpmovsxbq {{.*#+}} zmm21 = [6,14,0,0,7,15,0,0]
; AVX512DQ-NEXT:    vpermt2q %zmm3, %zmm21, %zmm26
...
; AVX512DQ-NEXT:    vpermt2q %zmm3, %zmm21, %zmm23
; AVX512DQ-NEXT:    vmovdqa64 128(%rdi), %zmm20
; AVX512DQ-NEXT:    vmovdqa64 128(%rsi), %zmm0
; AVX512DQ-NEXT:    vmovdqa64 %zmm20, %zmm27
; AVX512DQ-NEXT:    vpermt2q %zmm0, %zmm5, %zmm27
; AVX512DQ-NEXT:    vmovdqa64 %zmm20, %zmm25
; AVX512DQ-NEXT:    vpermt2q %zmm0, %zmm4, %zmm25
; AVX512DQ-NEXT:    vmovdqa64 %zmm20, %zmm24
; AVX512DQ-NEXT:    vpermt2q %zmm0, %zmm2, %zmm24
; AVX512DQ-NEXT:    vpermt2q %zmm0, %zmm21, %zmm20
; AVX512DQ-NEXT:    vmovdqa64 192(%rdi), %zmm10
; AVX512DQ-NEXT:    vmovdqa64 192(%rsi), %zmm0
; AVX512DQ-NEXT:    vmovdqa64 %zmm10, %zmm22
; AVX512DQ-NEXT:    vpermt2q %zmm0, %zmm5, %zmm22
; AVX512DQ-NEXT:    vmovdqa64 %zmm10, %zmm19
; AVX512DQ-NEXT:    vpermt2q %zmm0, %zmm4, %zmm19
; AVX512DQ-NEXT:    vmovdqa64 %zmm10, %zmm18
; AVX512DQ-NEXT:    vpermt2q %zmm0, %zmm2, %zmm18
; AVX512DQ-NEXT:    vpermt2q %zmm0, %zmm21, %zmm10
; AVX512DQ-NEXT:    vmovdqa64 256(%rdi), %zmm9
; AVX512DQ-NEXT:    vmovdqa64 256(%rsi), %zmm0
; AVX512DQ-NEXT:    vmovdqa64 %zmm9, %zmm17
; AVX512DQ-NEXT:    vpermt2q %zmm0, %zmm5, %zmm17
; AVX512DQ-NEXT:    vmovdqa64 %zmm9, %zmm16
; AVX512DQ-NEXT:    vpermt2q %zmm0, %zmm4, %zmm16
; AVX512DQ-NEXT:    vmovdqa64 %zmm9, %zmm15
; AVX512DQ-NEXT:    vpermt2q %zmm0, %zmm2, %zmm15
; AVX512DQ-NEXT:    vpermt2q %zmm0, %zmm21, %zmm9
; AVX512DQ-NEXT:    vmovdqa64 320(%rdi), %zmm3
; AVX512DQ-NEXT:    vmovdqa64 320(%rsi), %zmm0
; AVX512DQ-NEXT:    vmovdqa64 %zmm3, %zmm14
; AVX512DQ-NEXT:    vpermt2q %zmm0, %zmm5, %zmm14
; AVX512DQ-NEXT:    vmovdqa64 %zmm3, %zmm13
; AVX512DQ-NEXT:    vpermt2q %zmm0, %zmm4, %zmm13
; AVX512DQ-NEXT:    vmovdqa64 %zmm3, %zmm12
; AVX512DQ-NEXT:    vpermt2q %zmm0, %zmm2, %zmm12
; AVX512DQ-NEXT:    vpermt2q %zmm0, %zmm21, %zmm3
; AVX512DQ-NEXT:    vmovdqa64 384(%rdi), %zmm8
; AVX512DQ-NEXT:    vmovdqa64 384(%rsi), %zmm0
; AVX512DQ-NEXT:    vmovdqa64 %zmm8, %zmm11
; AVX512DQ-NEXT:    vpermt2q %zmm0, %zmm5, %zmm11
; AVX512DQ-NEXT:    vmovdqa64 %zmm8, %zmm7
; AVX512DQ-NEXT:    vpermt2q %zmm0, %zmm4, %zmm7
; AVX512DQ-NEXT:    vmovdqa64 %zmm8, %zmm6
; AVX512DQ-NEXT:    vpermt2q %zmm0, %zmm2, %zmm6
; AVX512DQ-NEXT:    vpermt2q %zmm0, %zmm21, %zmm8
; AVX512DQ-NEXT:    vmovdqa64 448(%rdi), %zmm1
; AVX512DQ-NEXT:    vmovdqa64 448(%rsi), %zmm0
; AVX512DQ-NEXT:    vpermi2q %zmm0, %zmm1, %zmm5
; AVX512DQ-NEXT:    vpermi2q %zmm0, %zmm1, %zmm4
...
; AVX512DQ-NEXT:    vmovdqa64 %zmm4, 1856(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm5, 1792(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm8, 1728(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm6, 1664(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm7, 1600(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm11, 1536(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm3, 1472(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm12, 1408(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm13, 1344(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm14, 1280(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm9, 1216(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm15, 1152(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm16, 1088(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm17, 1024(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm10, 960(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm18, 896(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm19, 832(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm22, 768(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm20, 704(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm24, 640(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm25, 576(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm27, 512(%r8)
; AVX512DQ-NEXT:    vmovdqa64 %zmm23, 448(%r8)
...
; AVX512DQ-FCP-NEXT:    vmovdqa64 320(%rcx), %zmm5
; AVX512DQ-FCP-NEXT:    vmovdqa64 256(%rcx), %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqa64 (%rcx), %zmm2
; AVX512DQ-FCP-NEXT:    vmovdqa64 64(%rcx), %zmm3
; AVX512DQ-FCP-NEXT:    vmovdqa64 128(%rcx), %zmm4
; AVX512DQ-FCP-NEXT:    vmovdqa64 192(%rcx), %zmm1
; AVX512DQ-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm9 = [0,0,0,8,0,0,1,9]
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm14, %zmm13
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm2, %zmm9, %zmm13
...
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm10, %zmm3
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm1, %zmm13, %zmm3
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm10, %zmm3
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm1, %zmm15, %zmm3
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
...
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm5, %zmm9, %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm7, %zmm0
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm5, %zmm13, %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm7, %zmm0
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm5, %zmm15, %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm5, %zmm26, %zmm7
...
; AVX512DQ-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm4 = [2,10,0,0,3,11,0,0]
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm26, %zmm0
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm3, %zmm4, %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm2 = [4,12,0,0,5,13,0,0]
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm26, %zmm0
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm3, %zmm2, %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm21 = [6,14,0,0,7,15,0,0]
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm3, %zmm21, %zmm26
...
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm3, %zmm21, %zmm23
; AVX512DQ-FCP-NEXT:    vmovdqa64 128(%rdi), %zmm20
; AVX512DQ-FCP-NEXT:    vmovdqa64 128(%rsi), %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm20, %zmm27
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm0, %zmm5, %zmm27
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm20, %zmm25
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm0, %zmm4, %zmm25
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm20, %zmm24
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm0, %zmm2, %zmm24
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm0, %zmm21, %zmm20
; AVX512DQ-FCP-NEXT:    vmovdqa64 192(%rdi), %zmm10
; AVX512DQ-FCP-NEXT:    vmovdqa64 192(%rsi), %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm10, %zmm22
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm0, %zmm5, %zmm22
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm10, %zmm19
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm0, %zmm4, %zmm19
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm10, %zmm18
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm0, %zmm2, %zmm18
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm0, %zmm21, %zmm10
; AVX512DQ-FCP-NEXT:    vmovdqa64 256(%rdi), %zmm9
; AVX512DQ-FCP-NEXT:    vmovdqa64 256(%rsi), %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm9, %zmm17
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm0, %zmm5, %zmm17
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm9, %zmm16
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm0, %zmm4, %zmm16
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm9, %zmm15
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm0, %zmm2, %zmm15
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm0, %zmm21, %zmm9
; AVX512DQ-FCP-NEXT:    vmovdqa64 320(%rdi), %zmm3
; AVX512DQ-FCP-NEXT:    vmovdqa64 320(%rsi), %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm3, %zmm14
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm0, %zmm5, %zmm14
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm3, %zmm13
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm0, %zmm4, %zmm13
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm3, %zmm12
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm0, %zmm2, %zmm12
...
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm0, %zmm5, %zmm11
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm8, %zmm7
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm0, %zmm4, %zmm7
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm8, %zmm6
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm0, %zmm2, %zmm6
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm0, %zmm21, %zmm8
...
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm30, %zmm21
...
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm4, 1856(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm5, 1792(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm8, 1728(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm6, 1664(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm7, 1600(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm11, 1536(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm3, 1472(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm12, 1408(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm13, 1344(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm14, 1280(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm9, 1216(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm15, 1152(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm16, 1088(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm17, 1024(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm10, 960(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm18, 896(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm19, 832(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm22, 768(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm20, 704(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm24, 640(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm25, 576(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm27, 512(%r8)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm23, 448(%r8)
...
; AVX512BW-NEXT:    vmovdqa64 64(%rcx), %zmm3
; AVX512BW-NEXT:    vmovdqa64 128(%rcx), %zmm4
...
; AVX512BW-NEXT:    vpermt2q %zmm2, %zmm26, %zmm14
; AVX512BW-NEXT:    vmovdqu64 %zmm14, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm12, %zmm2
; AVX512BW-NEXT:    vpermt2q %zmm3, %zmm9, %zmm12
; AVX512BW-NEXT:    vmovdqu64 %zmm12, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm2, %zmm12
; AVX512BW-NEXT:    vpermt2q %zmm3, %zmm13, %zmm12
; AVX512BW-NEXT:    vmovdqu64 %zmm12, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm2, %zmm12
; AVX512BW-NEXT:    vpermt2q %zmm3, %zmm15, %zmm12
; AVX512BW-NEXT:    vmovdqu64 %zmm12, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermt2q %zmm3, %zmm26, %zmm2
...
; AVX512BW-NEXT:    vmovdqa64 %zmm11, %zmm3
; AVX512BW-NEXT:    vpermt2q %zmm4, %zmm13, %zmm3
; AVX512BW-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm11, %zmm3
; AVX512BW-NEXT:    vpermt2q %zmm4, %zmm15, %zmm3
; AVX512BW-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermt2q %zmm4, %zmm26, %zmm11
...
; AVX512BW-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vmovdqa64 %zmm10, %zmm3
; AVX512BW-NEXT:    vpermt2q %zmm1, %zmm15, %zmm3
; AVX512BW-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
...
; AVX512BW-NEXT:    vpermt2q %zmm5, %zmm9, %zmm0
...
; AVX512BW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpermt2q %zmm5, %zmm26, %zmm7
...
; AVX512BW-NEXT:    vpmovsxbq {{.*#+}} zmm4 = [2,10,0,0,3,11,0,0]
; AVX512BW-NEXT:    vmovdqa64 %zmm26, %zmm0
; AVX512BW-NEXT:    vpermt2q %zmm3, %zmm4, %zmm0
; AVX512BW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpmovsxbq {{.*#+}} zmm2 = [4,12,0,0,5,13,0,0]
; AVX512BW-NEXT:    vmovdqa64 %zmm26, %zmm0
; AVX512BW-NEXT:    vpermt2q %zmm3, %zmm2, %zmm0
; AVX512BW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-NEXT:    vpmovsxbq {{.*#+}} zmm21 = [6,14,0,0,7,15,0,0]
; AVX512BW-NEXT:    vpermt2q %zmm3, %zmm21, %zmm26
...
; AVX512BW-NEXT:    vpermt2q %zmm3, %zmm21, %zmm23
; AVX512BW-NEXT:    vmovdqa64 128(%rdi), %zmm20
...
; AVX512BW-NEXT:    vpermt2q %zmm0, %zmm5, %zmm17
; AVX512BW-NEXT:    vmovdqa64 %zmm9, %zmm16
; AVX512BW-NEXT:    vpermt2q %zmm0, %zmm4, %zmm16
; AVX512BW-NEXT:    vmovdqa64 %zmm9, %zmm15
; AVX512BW-NEXT:    vpermt2q %zmm0, %zmm2, %zmm15
; AVX512BW-NEXT:    vpermt2q %zmm0, %zmm21, %zmm9
...
; AVX512BW-NEXT:    vpermt2q %zmm0, %zmm21, %zmm3
...
; AVX512BW-NEXT:    vpermt2q %zmm0, %zmm4, %zmm7
; AVX512BW-NEXT:    vmovdqa64 %zmm8, %zmm6
; AVX512BW-NEXT:    vpermt2q %zmm0, %zmm2, %zmm6
; AVX512BW-NEXT:    vpermt2q %zmm0, %zmm21, %zmm8
...
; AVX512BW-NEXT:    vmovdqa64 %zmm4, 1856(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm5, 1792(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm8, 1728(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm6, 1664(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm7, 1600(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm11, 1536(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm3, 1472(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm12, 1408(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm13, 1344(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm14, 1280(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm9, 1216(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm15, 1152(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm16, 1088(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm17, 1024(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm10, 960(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm18, 896(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm19, 832(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm22, 768(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm20, 704(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm24, 640(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm25, 576(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm27, 512(%r8)
; AVX512BW-NEXT:    vmovdqa64 %zmm23, 448(%r8)
...
; AVX512BW-FCP-NEXT:    vmovdqa64 320(%rcx), %zmm5
; AVX512BW-FCP-NEXT:    vmovdqa64 256(%rcx), %zmm0
; AVX512BW-FCP-NEXT:    vmovdqa64 (%rcx), %zmm2
; AVX512BW-FCP-NEXT:    vmovdqa64 64(%rcx), %zmm3
; AVX512BW-FCP-NEXT:    vmovdqa64 128(%rcx), %zmm4
; AVX512BW-FCP-NEXT:    vmovdqa64 192(%rcx), %zmm1
; AVX512BW-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm9 = [0,0,0,8,0,0,1,9]
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm14, %zmm13
; AVX512BW-FCP-NEXT:    vpermt2q %zmm2, %zmm9, %zmm13
...
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm10, %zmm3
; AVX512BW-FCP-NEXT:    vpermt2q %zmm1, %zmm13, %zmm3
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm10, %zmm3
; AVX512BW-FCP-NEXT:    vpermt2q %zmm1, %zmm15, %zmm3
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
...
; AVX512BW-FCP-NEXT:    vpermt2q %zmm5, %zmm9, %zmm0
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm7, %zmm0
; AVX512BW-FCP-NEXT:    vpermt2q %zmm5, %zmm13, %zmm0
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm7, %zmm0
; AVX512BW-FCP-NEXT:    vpermt2q %zmm5, %zmm15, %zmm0
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-FCP-NEXT:    vpermt2q %zmm5, %zmm26, %zmm7
...
; AVX512BW-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm4 = [2,10,0,0,3,11,0,0]
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm26, %zmm0
; AVX512BW-FCP-NEXT:    vpermt2q %zmm3, %zmm4, %zmm0
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm2 = [4,12,0,0,5,13,0,0]
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm26, %zmm0
; AVX512BW-FCP-NEXT:    vpermt2q %zmm3, %zmm2, %zmm0
; AVX512BW-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512BW-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm21 = [6,14,0,0,7,15,0,0]
; AVX512BW-FCP-NEXT:    vpermt2q %zmm3, %zmm21, %zmm26
...
; AVX512BW-FCP-NEXT:    vpermt2q %zmm3, %zmm21, %zmm23
; AVX512BW-FCP-NEXT:    vmovdqa64 128(%rdi), %zmm20
; AVX512BW-FCP-NEXT:    vmovdqa64 128(%rsi), %zmm0
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm20, %zmm27
; AVX512BW-FCP-NEXT:    vpermt2q %zmm0, %zmm5, %zmm27
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm20, %zmm25
; AVX512BW-FCP-NEXT:    vpermt2q %zmm0, %zmm4, %zmm25
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm20, %zmm24
; AVX512BW-FCP-NEXT:    vpermt2q %zmm0, %zmm2, %zmm24
; AVX512BW-FCP-NEXT:    vpermt2q %zmm0, %zmm21, %zmm20
; AVX512BW-FCP-NEXT:    vmovdqa64 192(%rdi), %zmm10
; AVX512BW-FCP-NEXT:    vmovdqa64 192(%rsi), %zmm0
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm10, %zmm22
; AVX512BW-FCP-NEXT:    vpermt2q %zmm0, %zmm5, %zmm22
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm10, %zmm19
; AVX512BW-FCP-NEXT:    vpermt2q %zmm0, %zmm4, %zmm19
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm10, %zmm18
; AVX512BW-FCP-NEXT:    vpermt2q %zmm0, %zmm2, %zmm18
; AVX512BW-FCP-NEXT:    vpermt2q %zmm0, %zmm21, %zmm10
; AVX512BW-FCP-NEXT:    vmovdqa64 256(%rdi), %zmm9
; AVX512BW-FCP-NEXT:    vmovdqa64 256(%rsi), %zmm0
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm9, %zmm17
; AVX512BW-FCP-NEXT:    vpermt2q %zmm0, %zmm5, %zmm17
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm9, %zmm16
; AVX512BW-FCP-NEXT:    vpermt2q %zmm0, %zmm4, %zmm16
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm9, %zmm15
; AVX512BW-FCP-NEXT:    vpermt2q %zmm0, %zmm2, %zmm15
; AVX512BW-FCP-NEXT:    vpermt2q %zmm0, %zmm21, %zmm9
; AVX512BW-FCP-NEXT:    vmovdqa64 320(%rdi), %zmm3
; AVX512BW-FCP-NEXT:    vmovdqa64 320(%rsi), %zmm0
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm3, %zmm14
; AVX512BW-FCP-NEXT:    vpermt2q %zmm0, %zmm5, %zmm14
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm3, %zmm13
; AVX512BW-FCP-NEXT:    vpermt2q %zmm0, %zmm4, %zmm13
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm3, %zmm12
; AVX512BW-FCP-NEXT:    vpermt2q %zmm0, %zmm2, %zmm12
; AVX512BW-FCP-NEXT:    vpermt2q %zmm0, %zmm21, %zmm3
; AVX512BW-FCP-NEXT:    vmovdqa64 384(%rdi), %zmm8
; AVX512BW-FCP-NEXT:    vmovdqa64 384(%rsi), %zmm0
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm8, %zmm11
; AVX512BW-FCP-NEXT:    vpermt2q %zmm0, %zmm5, %zmm11
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm8, %zmm7
; AVX512BW-FCP-NEXT:    vpermt2q %zmm0, %zmm4, %zmm7
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm8, %zmm6
; AVX512BW-FCP-NEXT:    vpermt2q %zmm0, %zmm2, %zmm6
; AVX512BW-FCP-NEXT:    vpermt2q %zmm0, %zmm21, %zmm8
...
; AVX512BW-FCP-NEXT:    vpermi2q %zmm0, %zmm1, %zmm4
...
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm30, %zmm21
...
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm4, 1856(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm5, 1792(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm8, 1728(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm6, 1664(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm7, 1600(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm11, 1536(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm3, 1472(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm12, 1408(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm13, 1344(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm14, 1280(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm9, 1216(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm15, 1152(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm16, 1088(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm17, 1024(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm10, 960(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm18, 896(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm19, 832(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm22, 768(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm20, 704(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm24, 640(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm25, 576(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm27, 512(%r8)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm23, 448(%r8)
...
; AVX512DQ-BW-NEXT:    vmovdqa64 320(%rcx), %zmm5
; AVX512DQ-BW-NEXT:    vmovdqa64 256(%rcx), %zmm0
; AVX512DQ-BW-NEXT:    vmovdqa64 (%rcx), %zmm2
; AVX512DQ-BW-NEXT:    vmovdqa64 64(%rcx), %zmm3
; AVX512DQ-BW-NEXT:    vmovdqa64 128(%rcx), %zmm4
; AVX512DQ-BW-NEXT:    vmovdqa64 192(%rcx), %zmm1
; AVX512DQ-BW-NEXT:    vpmovsxbq {{.*#+}} zmm9 = [0,0,0,8,0,0,1,9]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm14, %zmm13
; AVX512DQ-BW-NEXT:    vpermt2q %zmm2, %zmm9, %zmm13
...
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm10, %zmm3
; AVX512DQ-BW-NEXT:    vpermt2q %zmm1, %zmm13, %zmm3
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm10, %zmm3
; AVX512DQ-BW-NEXT:    vpermt2q %zmm1, %zmm15, %zmm3
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
...
; AVX512DQ-BW-NEXT:    vpermt2q %zmm5, %zmm9, %zmm0
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm7, %zmm0
; AVX512DQ-BW-NEXT:    vpermt2q %zmm5, %zmm13, %zmm0
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm7, %zmm0
; AVX512DQ-BW-NEXT:    vpermt2q %zmm5, %zmm15, %zmm0
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vpermt2q %zmm5, %zmm26, %zmm7
...
; AVX512DQ-BW-NEXT:    vpmovsxbq {{.*#+}} zmm4 = [2,10,0,0,3,11,0,0]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm26, %zmm0
; AVX512DQ-BW-NEXT:    vpermt2q %zmm3, %zmm4, %zmm0
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vpmovsxbq {{.*#+}} zmm2 = [4,12,0,0,5,13,0,0]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm26, %zmm0
; AVX512DQ-BW-NEXT:    vpermt2q %zmm3, %zmm2, %zmm0
; AVX512DQ-BW-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-NEXT:    vpmovsxbq {{.*#+}} zmm21 = [6,14,0,0,7,15,0,0]
; AVX512DQ-BW-NEXT:    vpermt2q %zmm3, %zmm21, %zmm26
...
; AVX512DQ-BW-NEXT:    vpermt2q %zmm3, %zmm21, %zmm23
; AVX512DQ-BW-NEXT:    vmovdqa64 128(%rdi), %zmm20
; AVX512DQ-BW-NEXT:    vmovdqa64 128(%rsi), %zmm0
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm20, %zmm27
; AVX512DQ-BW-NEXT:    vpermt2q %zmm0, %zmm5, %zmm27
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm20, %zmm25
; AVX512DQ-BW-NEXT:    vpermt2q %zmm0, %zmm4, %zmm25
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm20, %zmm24
; AVX512DQ-BW-NEXT:    vpermt2q %zmm0, %zmm2, %zmm24
; AVX512DQ-BW-NEXT:    vpermt2q %zmm0, %zmm21, %zmm20
; AVX512DQ-BW-NEXT:    vmovdqa64 192(%rdi), %zmm10
; AVX512DQ-BW-NEXT:    vmovdqa64 192(%rsi), %zmm0
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm10, %zmm22
; AVX512DQ-BW-NEXT:    vpermt2q %zmm0, %zmm5, %zmm22
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm10, %zmm19
; AVX512DQ-BW-NEXT:    vpermt2q %zmm0, %zmm4, %zmm19
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm10, %zmm18
; AVX512DQ-BW-NEXT:    vpermt2q %zmm0, %zmm2, %zmm18
; AVX512DQ-BW-NEXT:    vpermt2q %zmm0, %zmm21, %zmm10
; AVX512DQ-BW-NEXT:    vmovdqa64 256(%rdi), %zmm9
; AVX512DQ-BW-NEXT:    vmovdqa64 256(%rsi), %zmm0
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm9, %zmm17
; AVX512DQ-BW-NEXT:    vpermt2q %zmm0, %zmm5, %zmm17
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm9, %zmm16
; AVX512DQ-BW-NEXT:    vpermt2q %zmm0, %zmm4, %zmm16
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm9, %zmm15
; AVX512DQ-BW-NEXT:    vpermt2q %zmm0, %zmm2, %zmm15
; AVX512DQ-BW-NEXT:    vpermt2q %zmm0, %zmm21, %zmm9
; AVX512DQ-BW-NEXT:    vmovdqa64 320(%rdi), %zmm3
; AVX512DQ-BW-NEXT:    vmovdqa64 320(%rsi), %zmm0
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm3, %zmm14
; AVX512DQ-BW-NEXT:    vpermt2q %zmm0, %zmm5, %zmm14
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm3, %zmm13
; AVX512DQ-BW-NEXT:    vpermt2q %zmm0, %zmm4, %zmm13
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm3, %zmm12
; AVX512DQ-BW-NEXT:    vpermt2q %zmm0, %zmm2, %zmm12
; AVX512DQ-BW-NEXT:    vpermt2q %zmm0, %zmm21, %zmm3
; AVX512DQ-BW-NEXT:    vmovdqa64 384(%rdi), %zmm8
; AVX512DQ-BW-NEXT:    vmovdqa64 384(%rsi), %zmm0
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm8, %zmm11
; AVX512DQ-BW-NEXT:    vpermt2q %zmm0, %zmm5, %zmm11
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm8, %zmm7
; AVX512DQ-BW-NEXT:    vpermt2q %zmm0, %zmm4, %zmm7
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm8, %zmm6
; AVX512DQ-BW-NEXT:    vpermt2q %zmm0, %zmm2, %zmm6
; AVX512DQ-BW-NEXT:    vpermt2q %zmm0, %zmm21, %zmm8
; AVX512DQ-BW-NEXT:    vmovdqa64 448(%rdi), %zmm1
; AVX512DQ-BW-NEXT:    vmovdqa64 448(%rsi), %zmm0
; AVX512DQ-BW-NEXT:    vpermi2q %zmm0, %zmm1, %zmm5
; AVX512DQ-BW-NEXT:    vpermi2q %zmm0, %zmm1, %zmm4
...
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm30, %zmm21
...
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm4, 1856(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm5, 1792(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm8, 1728(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm6, 1664(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm7, 1600(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm11, 1536(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm3, 1472(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm12, 1408(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm13, 1344(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm14, 1280(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm9, 1216(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm15, 1152(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm16, 1088(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm17, 1024(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm10, 960(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm18, 896(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm19, 832(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm22, 768(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm20, 704(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm24, 640(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm25, 576(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm27, 512(%r8)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm23, 448(%r8)
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 320(%rcx), %zmm5
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 256(%rcx), %zmm0
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 (%rcx), %zmm2
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 64(%rcx), %zmm3
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 128(%rcx), %zmm4
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 192(%rcx), %zmm1
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm9 = [0,0,0,8,0,0,1,9]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm14, %zmm13
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm2, %zmm9, %zmm13
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm10, %zmm3
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm1, %zmm13, %zmm3
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm10, %zmm3
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm1, %zmm15, %zmm3
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
...
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm5, %zmm9, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm7, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm5, %zmm13, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm7, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm5, %zmm15, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm5, %zmm26, %zmm7
...
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm4 = [2,10,0,0,3,11,0,0]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm26, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm3, %zmm4, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm2 = [4,12,0,0,5,13,0,0]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm26, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm3, %zmm2, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm21 = [6,14,0,0,7,15,0,0]
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm3, %zmm21, %zmm26
...
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm3, %zmm21, %zmm23
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 128(%rdi), %zmm20
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 128(%rsi), %zmm0
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm20, %zmm27
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm0, %zmm5, %zmm27
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm20, %zmm25
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm0, %zmm4, %zmm25
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm20, %zmm24
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm0, %zmm2, %zmm24
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm0, %zmm21, %zmm20
...
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm0, %zmm5, %zmm22
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm10, %zmm19
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm0, %zmm4, %zmm19
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm10, %zmm18
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm0, %zmm2, %zmm18
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm0, %zmm21, %zmm10
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 256(%rdi), %zmm9
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 256(%rsi), %zmm0
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm9, %zmm17
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm0, %zmm5, %zmm17
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm9, %zmm16
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm0, %zmm4, %zmm16
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm9, %zmm15
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm0, %zmm2, %zmm15
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm0, %zmm21, %zmm9
...
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm0, %zmm5, %zmm14
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm3, %zmm13
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm0, %zmm4, %zmm13
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm3, %zmm12
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm0, %zmm2, %zmm12
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm0, %zmm21, %zmm3
...
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm0, %zmm5, %zmm11
...
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm0, %zmm2, %zmm6
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm0, %zmm21, %zmm8
...
; AVX512DQ-BW-FCP-NEXT:    vpermi2q %zmm0, %zmm1, %zmm4
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm30, %zmm21
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm4, 1856(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm5, 1792(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm8, 1728(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm6, 1664(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm7, 1600(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm11, 1536(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm3, 1472(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm12, 1408(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm13, 1344(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm14, 1280(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm9, 1216(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm15, 1152(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm16, 1088(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm17, 1024(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm10, 960(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm18, 896(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm19, 832(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm22, 768(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm20, 704(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm24, 640(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm25, 576(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm27, 512(%r8)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm23, 448(%r8)
