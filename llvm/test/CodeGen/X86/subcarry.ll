...
; RUN: llc < %s -mtriple=x86_64-unknown | FileCheck %s --check-prefixes=X64,X64-SSE2
; RUN: llc < %s -mtriple=x86_64-unknown -mattr=+avx512f,+avx512vl,+avx512bw | FileCheck %s --check-prefixes=X64,X64-AVX512
...
; X64-NEXT:    sbbq 8(%rsp), %rdx
; X64-NEXT:    sbbq 16(%rsp), %rcx
; X64-NEXT:    sbbq 24(%rsp), %r8
...
; X86-NEXT:    movl 20(%esp), %edx
; X86-NEXT:    movl 12(%esp), %ecx
; X86-NEXT:    movl 16(%esp), %esi
; X86-NEXT:    subl 44(%esp), %ecx
; X86-NEXT:    sbbl 48(%esp), %esi
; X86-NEXT:    sbbl 52(%esp), %edx
; X86-NEXT:    movl %edx, 8(%eax)
...
; X86-NEXT:    sbbl 68(%esp), %ecx
; X86-NEXT:    movl %ecx, 24(%eax)
; X86-NEXT:    movl 40(%esp), %ecx
; X86-NEXT:    sbbl 72(%esp), %ecx
...
; X86-NEXT:    pushl %esi
; X86-NEXT:    subl $12, %esp
; X86-NEXT:    movl 36(%esp), %edx
; X86-NEXT:    movl 40(%esp), %eax
; X86-NEXT:    movl 44(%esp), %ecx
; X86-NEXT:    notl %eax
...
; X86-NEXT:    adcl 12(%edx), %ebp
; X86-NEXT:    setb %bl
; X86-NEXT:    notl %eax
; X86-NEXT:    addl %edi, %eax
; X86-NEXT:    movl %eax, (%esp) # 4-byte Spill
; X86-NEXT:    movl 52(%esp), %edi
...
; X86-NEXT:    setb %bh
; X86-NEXT:    addb $255, %bl
; X86-NEXT:    movzbl %bh, %ecx
; X86-NEXT:    adcl 16(%edx), %eax
; X86-NEXT:    adcl 20(%edx), %ecx
; X86-NEXT:    movl %edx, %esi
; X86-NEXT:    movl 56(%esp), %ebx
; X86-NEXT:    notl %ebx
; X86-NEXT:    setb %dl
; X86-NEXT:    addl %eax, %ebx
; X86-NEXT:    movl 60(%esp), %ebp
; X86-NEXT:    notl %ebp
...
; X86-NEXT:    adcl 24(%esi), %ecx
; X86-NEXT:    movzbl %al, %eax
; X86-NEXT:    adcl 28(%esi), %eax
; X86-NEXT:    movl 64(%esp), %edx
; X86-NEXT:    notl %edx
; X86-NEXT:    addl %ecx, %edx
; X86-NEXT:    movl 68(%esp), %ecx
; X86-NEXT:    notl %ecx
...
; X86-NEXT:    movl 12(%esp), %edx
; X86-NEXT:    addl 16(%esp), %ecx
; X86-NEXT:    adcl 20(%esp), %edx
; X86-NEXT:    setb %bl
; X86-NEXT:    movl %ecx, (%eax)
...
; X86-NEXT:    movl 20(%esp), %ecx
; X86-NEXT:    movl 24(%esp), %edx
; X86-NEXT:    movl 28(%esp), %edi
; X86-NEXT:    movl 32(%esp), %esi
; X86-NEXT:    subl 44(%esp), %edi
; X86-NEXT:    sbbl 48(%esp), %esi
; X86-NEXT:    setb %bl
; X86-NEXT:    subl 36(%esp), %ecx
; X86-NEXT:    sbbl 40(%esp), %edx
; X86-NEXT:    sbbl $0, %edi
; X86-NEXT:    sbbl $0, %esi
; X86-NEXT:    setb %bh
; X86-NEXT:    orb %bl, %bh
...
; X86-NEXT:    movl 8(%esp), %eax
; X86-NEXT:    movl 12(%esp), %edx
; X86-NEXT:    subl 16(%esp), %eax
; X86-NEXT:    sbbl 20(%esp), %edx
; X86-NEXT:    setb %ch
; X86-NEXT:    movzbl 24(%esp), %esi
; X86-NEXT:    andl $1, %esi
...
; X86-NEXT:    subl 12(%esp), %eax
; X86-NEXT:    sbbl 16(%esp), %edx
; X86-NEXT:    setb %ch
; X86-NEXT:    subl 20(%esp), %eax
; X86-NEXT:    sbbl 24(%esp), %edx
; X86-NEXT:    setb %cl
; X86-NEXT:    orb %ch, %cl
; X86-NEXT:    retl
    %t1 = call { i64, i1 } @llvm.usub.with.overflow.i64(i64 %a, i64 %b)
...
; X86-NEXT:    movl 52(%esp), %esi
; X86-NEXT:    movl 48(%esp), %edi
...
; X86-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NEXT:    setb %al
; X86-NEXT:    subl 76(%esp), %ebp
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %esi # 4-byte Reload
; X86-NEXT:    sbbl 80(%esp), %esi
; X86-NEXT:    setb {{[-0-9]+}}(%e{{[sb]}}p) # 1-byte Folded Spill
; X86-NEXT:    orb %dh, %al
; X86-NEXT:    movzbl %al, %eax
...
; X86-NEXT:    setb %al
; X86-NEXT:    subl 84(%esp), %ebx
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %edx # 4-byte Reload
; X86-NEXT:    sbbl 88(%esp), %edx
; X86-NEXT:    setb %ah
...
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %esi # 4-byte Reload
; X86-NEXT:    movl %esi, 12(%edi)
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %esi # 4-byte Reload
; X86-NEXT:    movl %esi, 16(%edi)
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %esi # 4-byte Reload
...
; X86-NEXT:    orb {{[-0-9]+}}(%e{{[sb]}}p), %al # 1-byte Folded Reload
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ecx # 4-byte Reload
; X86-NEXT:    subl 64(%esp), %ecx
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %esi # 4-byte Reload
; X86-NEXT:    sbbl 68(%esp), %esi
; X86-NEXT:    movzbl %al, %eax
; X86-NEXT:    setb {{[-0-9]+}}(%e{{[sb]}}p) # 1-byte Folded Spill
; X86-NEXT:    subl %eax, %ecx
; X86-NEXT:    sbbl $0, %esi
...
; X86-NEXT:    setb %al
; X86-NEXT:    orb {{[-0-9]+}}(%e{{[sb]}}p), %al # 1-byte Folded Reload
; X86-NEXT:    subl 72(%esp), %edi
; X86-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %esi # 4-byte Reload
; X86-NEXT:    sbbl 76(%esp), %esi
; X86-NEXT:    movzbl %al, %eax
; X86-NEXT:    setb {{[-0-9]+}}(%e{{[sb]}}p) # 1-byte Folded Spill
...
; X86-NEXT:    setb %al
; X86-NEXT:    orb {{[-0-9]+}}(%e{{[sb]}}p), %al # 1-byte Folded Reload
; X86-NEXT:    subl 80(%esp), %ebx
; X86-NEXT:    sbbl 84(%esp), %ebp
; X86-NEXT:    movzbl %al, %eax
; X86-NEXT:    setb {{[-0-9]+}}(%e{{[sb]}}p) # 1-byte Folded Spill
...
; X86-NEXT:    subl 36(%esp), %edx
; X86-NEXT:    sbbl 40(%esp), %esi
; X86-NEXT:    setb %bl
; X86-NEXT:    cmpl 28(%esp), %eax
; X86-NEXT:    sbbl 32(%esp), %ecx
; X86-NEXT:    sbbl $0, %edx
; X86-NEXT:    sbbl $0, %esi
; X86-NEXT:    setb %al
; X86-NEXT:    orb %bl, %al
...
; X86-NEXT:    movl 20(%esp), %ecx
; X86-NEXT:    movl 8(%esp), %edx
; X86-NEXT:    movl 12(%esp), %esi
; X86-NEXT:    cmpl 24(%esp), %edx
; X86-NEXT:    sbbl 28(%esp), %esi
; X86-NEXT:    sbbl 32(%esp), %eax
; X86-NEXT:    sbbl 36(%esp), %ecx
; X86-NEXT:    setb %al
; X86-NEXT:    popl %esi
; X86-NEXT:    retl
entry:
...
; X86-NEXT:    movl 8(%esp), %edx
; X86-NEXT:    cmpl 20(%esp), %ecx
; X86-NEXT:    sbbl 24(%esp), %edx
; X86-NEXT:    setb %cl
; X86-NEXT:    orl 16(%esp), %eax
; X86-NEXT:    sete %al
; X86-NEXT:    andb %cl, %al
; X86-NEXT:    retl
entry:
...
; X64-SSE2-LABEL: no_subcarry_vector:
; X64-SSE2:       # %bb.0:
...
; X64-SSE2-NEXT:    retq
;
; X64-AVX512-LABEL: no_subcarry_vector:
; X64-AVX512:       # %bb.0:
; X64-AVX512-NEXT:    vpcmpltud %xmm2, %xmm0, %k1
; X64-AVX512-NEXT:    vpcmpltud %xmm3, %xmm1, %k0
; X64-AVX512-NEXT:    vpcmpeqd %xmm3, %xmm1, %k1 {%k1}
; X64-AVX512-NEXT:    korw %k1, %k0, %k1
; X64-AVX512-NEXT:    vpcmpeqd %xmm0, %xmm0, %xmm0
; X64-AVX512-NEXT:    vmovdqa32 %xmm0, %xmm0 {%k1} {z}
; X64-AVX512-NEXT:    retq
;
