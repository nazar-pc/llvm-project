...
; SSE-NEXT:    pshufhw {{.*#+}} xmm8 = xmm4[0,1,2,3,7,5,4,5]
; SSE-NEXT:    pand %xmm0, %xmm8
; SSE-NEXT:    por %xmm1, %xmm8
; SSE-NEXT:    pshufd {{.*#+}} xmm1 = xmm3[1,1,2,2]
; SSE-NEXT:    pand %xmm0, %xmm1
; SSE-NEXT:    pshuflw {{.*#+}} xmm15 = xmm7[3,3,3,3,4,5,6,7]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm0 = xmm5[2,1,3,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm6 = xmm0[2,1,1,0,4,5,6,7]
; SSE-NEXT:    pand %xmm1, %xmm6
; SSE-NEXT:    por %xmm15, %xmm6
; SSE-NEXT:    pshufd $250, {{[-0-9]+}}(%r{{[sb]}}p), %xmm15 # 16-byte Folded Reload
; SSE-NEXT:    # xmm15 = mem[2,2,3,3]
; SSE-NEXT:    movdqa %xmm1, %xmm0
; SSE-NEXT:    pandn %xmm15, %xmm0
; SSE-NEXT:    movdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm5 # 16-byte Reload
; SSE-NEXT:    punpckhwd {{[-0-9]+}}(%r{{[sb]}}p), %xmm5 # 16-byte Folded Reload
; SSE-NEXT:    # xmm5 = xmm5[4],mem[4],xmm5[5],mem[5],xmm5[6],mem[6],xmm5[7],mem[7]
; SSE-NEXT:    pshufd {{.*#+}} xmm15 = xmm5[2,1,3,3]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm5 = xmm2[2,1,1,0,4,5,6,7]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm12[2,1,3,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm4 = xmm4[2,1,1,0,4,5,6,7]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm0 = xmm9[2,1,3,3]
; SSE-NEXT:    pshuflw {{.*#+}} xmm0 = xmm0[2,1,1,0,4,5,6,7]
...
; SSE-NEXT:    movdqa %xmm1, 368(%rcx)
; SSE-NEXT:    movdqa %xmm0, 320(%rcx)
; SSE-NEXT:    movdqa %xmm4, 272(%rcx)
; SSE-NEXT:    movdqa %xmm3, 224(%rcx)
; SSE-NEXT:    movdqa %xmm2, 176(%rcx)
; SSE-NEXT:    movdqa %xmm5, 128(%rcx)
; SSE-NEXT:    movdqa %xmm15, 80(%rcx)
; SSE-NEXT:    movdqa %xmm6, 32(%rcx)
; SSE-NEXT:    movdqa %xmm10, 352(%rcx)
; SSE-NEXT:    movdqa %xmm8, 336(%rcx)
; SSE-NEXT:    movdqa %xmm11, 304(%rcx)
...
; AVX-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vpunpcklwd {{.*#+}} xmm15 = xmm3[0],xmm0[0],xmm3[1],xmm0[1],xmm3[2],xmm0[2],xmm3[3],xmm0[3]
; AVX-NEXT:    vpshufb %xmm7, %xmm15, %xmm15
; AVX-NEXT:    vpshufd {{.*#+}} xmm10 = xmm10[0,0,0,0]
; AVX-NEXT:    vpblendw {{.*#+}} xmm0 = xmm15[0,1],xmm10[2],xmm15[3,4],xmm10[5],xmm15[6,7]
; AVX-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX-NEXT:    vpunpcklwd {{.*#+}} xmm15 = xmm13[0],xmm0[0],xmm13[1],xmm0[1],xmm13[2],xmm0[2],xmm13[3],xmm0[3]
; AVX-NEXT:    vpshufb %xmm7, %xmm15, %xmm15
...
; AVX-NEXT:    vpblendw {{.*#+}} xmm10 = xmm15[0],xmm10[1],xmm15[2,3],xmm10[4],xmm15[5,6],xmm10[7]
...
; AVX-NEXT:    vmovdqa %xmm10, 320(%rcx)
; AVX-NEXT:    vmovdqa %xmm14, 336(%rcx)
; AVX-NEXT:    vmovaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; AVX2-NEXT:    vpblendvb %ymm13, %ymm2, %ymm5, %ymm2
; AVX2-NEXT:    vmovdqa {{.*#+}} ymm5 = [10,11,0,1,12,13,12,13,2,3,2,3,14,15,4,5,26,27,16,17,28,29,28,29,18,19,18,19,30,31,20,21]
; AVX2-NEXT:    vpshufb %ymm5, %ymm11, %ymm11
...
; AVX2-NEXT:    vpblendvb %ymm14, %ymm5, %ymm12, %ymm5
...
; AVX2-NEXT:    vpblendvb %ymm14, %ymm11, %ymm4, %ymm4
...
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm4 = [10,11,0,1,12,13,12,13,2,3,2,3,14,15,4,5,26,27,16,17,28,29,28,29,18,19,18,19,30,31,20,21]
; AVX2-FP-NEXT:    vpshufb %ymm4, %ymm3, %ymm3
; AVX2-FP-NEXT:    vpmovsxbd {{.*#+}} ymm6 = [0,3,3,0,4,4,0,5]
; AVX2-FP-NEXT:    vpermd (%rdi), %ymm6, %ymm9
; AVX2-FP-NEXT:    vpmovsxbw {{.*#+}} ymm10 = [65535,0,0,65535,0,0,65535,0,0,65535,0,0,65535,0,0,65535]
; AVX2-FP-NEXT:    vpblendvb %ymm10, %ymm3, %ymm9, %ymm3
; AVX2-FP-NEXT:    vmovdqa 64(%rsi), %ymm9
; AVX2-FP-NEXT:    vpshufb %ymm4, %ymm9, %ymm9
; AVX2-FP-NEXT:    vpermd 64(%rdi), %ymm6, %ymm11
; AVX2-FP-NEXT:    vpblendvb %ymm10, %ymm9, %ymm11, %ymm9
; AVX2-FP-NEXT:    vmovdqa 32(%rsi), %ymm11
; AVX2-FP-NEXT:    vpshufb %ymm4, %ymm11, %ymm11
; AVX2-FP-NEXT:    vpermd 32(%rdi), %ymm6, %ymm14
; AVX2-FP-NEXT:    vpblendvb %ymm10, %ymm11, %ymm14, %ymm11
; AVX2-FP-NEXT:    vmovdqa 96(%rsi), %ymm14
; AVX2-FP-NEXT:    vpshufb %ymm4, %ymm14, %ymm4
; AVX2-FP-NEXT:    vpermd 96(%rdi), %ymm6, %ymm6
; AVX2-FP-NEXT:    vpblendvb %ymm10, %ymm4, %ymm6, %ymm4
; AVX2-FP-NEXT:    vpmovsxbd {{.*#+}} ymm6 = [2,0,3,3,0,4,4,0]
; AVX2-FP-NEXT:    vpermd %ymm2, %ymm6, %ymm2
...
; AVX2-FP-NEXT:    vpermd %ymm5, %ymm6, %ymm3
; AVX2-FP-NEXT:    vpblendvb %ymm10, %ymm11, %ymm3, %ymm3
; AVX2-FP-NEXT:    vpermd %ymm15, %ymm6, %ymm6
; AVX2-FP-NEXT:    vpblendvb %ymm10, %ymm4, %ymm6, %ymm4
; AVX2-FP-NEXT:    vmovdqa %ymm4, 320(%rcx)
; AVX2-FP-NEXT:    vmovdqa %ymm3, 128(%rcx)
...
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm4 = [10,11,0,1,12,13,12,13,2,3,2,3,14,15,4,5,26,27,16,17,28,29,28,29,18,19,18,19,30,31,20,21]
; AVX2-FCP-NEXT:    vpshufb %ymm4, %ymm3, %ymm3
; AVX2-FCP-NEXT:    vpmovsxbd {{.*#+}} ymm6 = [0,3,3,0,4,4,0,5]
; AVX2-FCP-NEXT:    vpermd (%rdi), %ymm6, %ymm9
; AVX2-FCP-NEXT:    vpmovsxbw {{.*#+}} ymm10 = [65535,0,0,65535,0,0,65535,0,0,65535,0,0,65535,0,0,65535]
; AVX2-FCP-NEXT:    vpblendvb %ymm10, %ymm3, %ymm9, %ymm3
; AVX2-FCP-NEXT:    vmovdqa 64(%rsi), %ymm9
; AVX2-FCP-NEXT:    vpshufb %ymm4, %ymm9, %ymm9
; AVX2-FCP-NEXT:    vpermd 64(%rdi), %ymm6, %ymm11
; AVX2-FCP-NEXT:    vpblendvb %ymm10, %ymm9, %ymm11, %ymm9
; AVX2-FCP-NEXT:    vmovdqa 32(%rsi), %ymm11
; AVX2-FCP-NEXT:    vpshufb %ymm4, %ymm11, %ymm11
; AVX2-FCP-NEXT:    vpermd 32(%rdi), %ymm6, %ymm14
; AVX2-FCP-NEXT:    vpblendvb %ymm10, %ymm11, %ymm14, %ymm11
; AVX2-FCP-NEXT:    vmovdqa 96(%rsi), %ymm14
; AVX2-FCP-NEXT:    vpshufb %ymm4, %ymm14, %ymm4
; AVX2-FCP-NEXT:    vpermd 96(%rdi), %ymm6, %ymm6
; AVX2-FCP-NEXT:    vpblendvb %ymm10, %ymm4, %ymm6, %ymm4
; AVX2-FCP-NEXT:    vpmovsxbd {{.*#+}} ymm6 = [2,0,3,3,0,4,4,0]
