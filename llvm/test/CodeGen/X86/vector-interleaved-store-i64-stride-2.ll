...
; SSE-NEXT:    retq
;
; AVX-LABEL: store_i64_stride2_vf2:
; AVX:       # %bb.0:
...
; AVX2-NEXT:    retq
;
; AVX2-FP-LABEL: store_i64_stride2_vf2:
; AVX2-FP:       # %bb.0:
...
; AVX2-FP-NEXT:    retq
;
; AVX2-FCP-LABEL: store_i64_stride2_vf2:
; AVX2-FCP:       # %bb.0:
...
; AVX512BW-NEXT:    retq
;
; AVX512BW-FCP-LABEL: store_i64_stride2_vf2:
; AVX512BW-FCP:       # %bb.0:
; AVX512BW-FCP-NEXT:    vmovaps (%rdi), %xmm0
; AVX512BW-FCP-NEXT:    vinsertf128 $1, (%rsi), %ymm0, %ymm0
; AVX512BW-FCP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,2,1,3]
; AVX512BW-FCP-NEXT:    vmovaps %ymm0, (%rdx)
; AVX512BW-FCP-NEXT:    vzeroupper
; AVX512BW-FCP-NEXT:    retq
;
; AVX512DQ-BW-LABEL: store_i64_stride2_vf2:
; AVX512DQ-BW:       # %bb.0:
...
;
; AVX512DQ-BW-FCP-LABEL: store_i64_stride2_vf2:
; AVX512DQ-BW-FCP:       # %bb.0:
; AVX512DQ-BW-FCP-NEXT:    vmovaps (%rdi), %xmm0
; AVX512DQ-BW-FCP-NEXT:    vinsertf128 $1, (%rsi), %ymm0, %ymm0
; AVX512DQ-BW-FCP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,2,1,3]
...
; AVX2-NEXT:    retq
;
; AVX2-FP-LABEL: store_i64_stride2_vf4:
; AVX2-FP:       # %bb.0:
; AVX2-FP-NEXT:    vmovaps (%rdi), %ymm0
; AVX2-FP-NEXT:    vmovaps (%rsi), %ymm1
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm1[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm3 = ymm0[0,1,1,3]
...
; AVX2-FP-NEXT:    retq
;
; AVX2-FCP-LABEL: store_i64_stride2_vf4:
; AVX2-FCP:       # %bb.0:
; AVX2-FCP-NEXT:    vmovaps (%rdi), %ymm0
; AVX2-FCP-NEXT:    vmovaps (%rsi), %ymm1
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm1[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm3 = ymm0[0,1,1,3]
...
; AVX512-NEXT:    retq
;
; AVX512-FCP-LABEL: store_i64_stride2_vf4:
; AVX512-FCP:       # %bb.0:
...
; AVX512-FCP-NEXT:    retq
;
; AVX512DQ-LABEL: store_i64_stride2_vf4:
; AVX512DQ:       # %bb.0:
...
; AVX512DQ-NEXT:    retq
;
; AVX512DQ-FCP-LABEL: store_i64_stride2_vf4:
; AVX512DQ-FCP:       # %bb.0:
...
; AVX512DQ-FCP-NEXT:    retq
;
; AVX512BW-LABEL: store_i64_stride2_vf4:
; AVX512BW:       # %bb.0:
...
; AVX512BW-NEXT:    retq
;
; AVX512BW-FCP-LABEL: store_i64_stride2_vf4:
; AVX512BW-FCP:       # %bb.0:
...
; AVX512BW-FCP-NEXT:    retq
;
; AVX512DQ-BW-LABEL: store_i64_stride2_vf4:
; AVX512DQ-BW:       # %bb.0:
...
; AVX512DQ-BW-NEXT:    retq
;
; AVX512DQ-BW-FCP-LABEL: store_i64_stride2_vf4:
; AVX512DQ-BW-FCP:       # %bb.0:
...
; AVX2-NEXT:    retq
;
; AVX2-FP-LABEL: store_i64_stride2_vf8:
; AVX2-FP:       # %bb.0:
; AVX2-FP-NEXT:    vmovaps (%rdi), %ymm0
...
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm0[2,1,3,3]
...
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm3[0,2,2,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm1[2,1,3,3]
...
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm3[2,3],ymm1[4,5],ymm3[6,7]
...
; AVX2-FP-NEXT:    retq
;
; AVX2-FCP-LABEL: store_i64_stride2_vf8:
; AVX2-FCP:       # %bb.0:
; AVX2-FCP-NEXT:    vmovaps (%rdi), %ymm0
...
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm0[2,1,3,3]
...
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm3[0,2,2,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm1[2,1,3,3]
...
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm3[2,3],ymm1[4,5],ymm3[6,7]
...
; AVX512-NEXT:    vpmovsxbq {{.*#+}} zmm2 = [0,8,1,9,2,10,3,11]
; AVX512-NEXT:    vpermi2q %zmm1, %zmm0, %zmm2
; AVX512-NEXT:    vpmovsxbq {{.*#+}} zmm3 = [4,12,5,13,6,14,7,15]
...
; AVX512-NEXT:    retq
;
; AVX512-FCP-LABEL: store_i64_stride2_vf8:
; AVX512-FCP:       # %bb.0:
; AVX512-FCP-NEXT:    vmovdqa64 (%rdi), %zmm0
; AVX512-FCP-NEXT:    vmovdqa64 (%rsi), %zmm1
; AVX512-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm2 = [0,8,1,9,2,10,3,11]
; AVX512-FCP-NEXT:    vpermi2q %zmm1, %zmm0, %zmm2
; AVX512-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm3 = [4,12,5,13,6,14,7,15]
...
; AVX512-FCP-NEXT:    retq
;
; AVX512DQ-LABEL: store_i64_stride2_vf8:
; AVX512DQ:       # %bb.0:
; AVX512DQ-NEXT:    vmovdqa64 (%rdi), %zmm0
; AVX512DQ-NEXT:    vmovdqa64 (%rsi), %zmm1
; AVX512DQ-NEXT:    vpmovsxbq {{.*#+}} zmm2 = [0,8,1,9,2,10,3,11]
; AVX512DQ-NEXT:    vpermi2q %zmm1, %zmm0, %zmm2
; AVX512DQ-NEXT:    vpmovsxbq {{.*#+}} zmm3 = [4,12,5,13,6,14,7,15]
...
; AVX512DQ-NEXT:    retq
;
; AVX512DQ-FCP-LABEL: store_i64_stride2_vf8:
; AVX512DQ-FCP:       # %bb.0:
; AVX512DQ-FCP-NEXT:    vmovdqa64 (%rdi), %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqa64 (%rsi), %zmm1
; AVX512DQ-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm2 = [0,8,1,9,2,10,3,11]
; AVX512DQ-FCP-NEXT:    vpermi2q %zmm1, %zmm0, %zmm2
; AVX512DQ-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm3 = [4,12,5,13,6,14,7,15]
...
; AVX512DQ-FCP-NEXT:    retq
;
; AVX512BW-LABEL: store_i64_stride2_vf8:
; AVX512BW:       # %bb.0:
; AVX512BW-NEXT:    vmovdqa64 (%rdi), %zmm0
; AVX512BW-NEXT:    vmovdqa64 (%rsi), %zmm1
; AVX512BW-NEXT:    vpmovsxbq {{.*#+}} zmm2 = [0,8,1,9,2,10,3,11]
; AVX512BW-NEXT:    vpermi2q %zmm1, %zmm0, %zmm2
; AVX512BW-NEXT:    vpmovsxbq {{.*#+}} zmm3 = [4,12,5,13,6,14,7,15]
...
; AVX512BW-NEXT:    retq
;
; AVX512BW-FCP-LABEL: store_i64_stride2_vf8:
; AVX512BW-FCP:       # %bb.0:
; AVX512BW-FCP-NEXT:    vmovdqa64 (%rdi), %zmm0
; AVX512BW-FCP-NEXT:    vmovdqa64 (%rsi), %zmm1
; AVX512BW-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm2 = [0,8,1,9,2,10,3,11]
; AVX512BW-FCP-NEXT:    vpermi2q %zmm1, %zmm0, %zmm2
; AVX512BW-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm3 = [4,12,5,13,6,14,7,15]
...
; AVX512BW-FCP-NEXT:    retq
;
; AVX512DQ-BW-LABEL: store_i64_stride2_vf8:
; AVX512DQ-BW:       # %bb.0:
; AVX512DQ-BW-NEXT:    vmovdqa64 (%rdi), %zmm0
; AVX512DQ-BW-NEXT:    vmovdqa64 (%rsi), %zmm1
; AVX512DQ-BW-NEXT:    vpmovsxbq {{.*#+}} zmm2 = [0,8,1,9,2,10,3,11]
; AVX512DQ-BW-NEXT:    vpermi2q %zmm1, %zmm0, %zmm2
; AVX512DQ-BW-NEXT:    vpmovsxbq {{.*#+}} zmm3 = [4,12,5,13,6,14,7,15]
...
; AVX512DQ-BW-NEXT:    retq
;
; AVX512DQ-BW-FCP-LABEL: store_i64_stride2_vf8:
; AVX512DQ-BW-FCP:       # %bb.0:
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 (%rdi), %zmm0
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 (%rsi), %zmm1
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm2 = [0,8,1,9,2,10,3,11]
; AVX512DQ-BW-FCP-NEXT:    vpermi2q %zmm1, %zmm0, %zmm2
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm3 = [4,12,5,13,6,14,7,15]
...
; AVX2-NEXT:    retq
;
; AVX2-FP-LABEL: store_i64_stride2_vf16:
; AVX2-FP:       # %bb.0:
; AVX2-FP-NEXT:    vmovaps (%rdi), %ymm0
; AVX2-FP-NEXT:    vmovaps 32(%rdi), %ymm1
...
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm8 = ymm4[0,2,2,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm9 = ymm0[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm8 = ymm9[0,1],ymm8[2,3],ymm9[4,5],ymm8[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm4[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm4[2,3],ymm0[4,5],ymm4[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm5[0,2,2,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm9 = ymm1[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm4 = ymm9[0,1],ymm4[2,3],ymm9[4,5],ymm4[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm5[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm5[2,3],ymm1[4,5],ymm5[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm6[0,2,2,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm9 = ymm2[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm5 = ymm9[0,1],ymm5[2,3],ymm9[4,5],ymm5[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm6 = ymm6[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1],ymm6[2,3],ymm2[4,5],ymm6[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm6 = ymm7[0,2,2,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm9 = ymm3[2,1,3,3]
...
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1],ymm7[2,3],ymm3[4,5],ymm7[6,7]
...
; AVX2-FP-NEXT:    retq
;
; AVX2-FCP-LABEL: store_i64_stride2_vf16:
; AVX2-FCP:       # %bb.0:
; AVX2-FCP-NEXT:    vmovaps (%rdi), %ymm0
; AVX2-FCP-NEXT:    vmovaps 32(%rdi), %ymm1
...
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm8 = ymm4[0,2,2,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm9 = ymm0[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm8 = ymm9[0,1],ymm8[2,3],ymm9[4,5],ymm8[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm4[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0,1],ymm4[2,3],ymm0[4,5],ymm4[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm5[0,2,2,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm9 = ymm1[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm4 = ymm9[0,1],ymm4[2,3],ymm9[4,5],ymm4[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm5[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm1[0,1],ymm5[2,3],ymm1[4,5],ymm5[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm6[0,2,2,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm9 = ymm2[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm5 = ymm9[0,1],ymm5[2,3],ymm9[4,5],ymm5[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm6 = ymm6[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1],ymm6[2,3],ymm2[4,5],ymm6[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm6 = ymm7[0,2,2,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm9 = ymm3[2,1,3,3]
...
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm3 = ymm3[0,1],ymm7[2,3],ymm3[4,5],ymm7[6,7]
...
; AVX512-NEXT:    vpmovsxbq {{.*#+}} zmm4 = [4,12,5,13,6,14,7,15]
; AVX512-NEXT:    vmovdqa64 %zmm0, %zmm5
; AVX512-NEXT:    vpermt2q %zmm2, %zmm4, %zmm5
; AVX512-NEXT:    vpmovsxbq {{.*#+}} zmm6 = [0,8,1,9,2,10,3,11]
...
; AVX512-NEXT:    retq
;
; AVX512-FCP-LABEL: store_i64_stride2_vf16:
; AVX512-FCP:       # %bb.0:
; AVX512-FCP-NEXT:    vmovdqa64 (%rdi), %zmm0
; AVX512-FCP-NEXT:    vmovdqa64 64(%rdi), %zmm1
; AVX512-FCP-NEXT:    vmovdqa64 (%rsi), %zmm2
; AVX512-FCP-NEXT:    vmovdqa64 64(%rsi), %zmm3
; AVX512-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm4 = [4,12,5,13,6,14,7,15]
; AVX512-FCP-NEXT:    vmovdqa64 %zmm0, %zmm5
; AVX512-FCP-NEXT:    vpermt2q %zmm2, %zmm4, %zmm5
; AVX512-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm6 = [0,8,1,9,2,10,3,11]
; AVX512-FCP-NEXT:    vpermt2q %zmm2, %zmm6, %zmm0
; AVX512-FCP-NEXT:    vpermi2q %zmm3, %zmm1, %zmm4
...
; AVX512-FCP-NEXT:    retq
;
; AVX512DQ-LABEL: store_i64_stride2_vf16:
; AVX512DQ:       # %bb.0:
; AVX512DQ-NEXT:    vmovdqa64 (%rdi), %zmm0
; AVX512DQ-NEXT:    vmovdqa64 64(%rdi), %zmm1
; AVX512DQ-NEXT:    vmovdqa64 (%rsi), %zmm2
; AVX512DQ-NEXT:    vmovdqa64 64(%rsi), %zmm3
; AVX512DQ-NEXT:    vpmovsxbq {{.*#+}} zmm4 = [4,12,5,13,6,14,7,15]
; AVX512DQ-NEXT:    vmovdqa64 %zmm0, %zmm5
; AVX512DQ-NEXT:    vpermt2q %zmm2, %zmm4, %zmm5
; AVX512DQ-NEXT:    vpmovsxbq {{.*#+}} zmm6 = [0,8,1,9,2,10,3,11]
; AVX512DQ-NEXT:    vpermt2q %zmm2, %zmm6, %zmm0
; AVX512DQ-NEXT:    vpermi2q %zmm3, %zmm1, %zmm4
...
; AVX512DQ-NEXT:    retq
;
; AVX512DQ-FCP-LABEL: store_i64_stride2_vf16:
; AVX512DQ-FCP:       # %bb.0:
; AVX512DQ-FCP-NEXT:    vmovdqa64 (%rdi), %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqa64 64(%rdi), %zmm1
; AVX512DQ-FCP-NEXT:    vmovdqa64 (%rsi), %zmm2
; AVX512DQ-FCP-NEXT:    vmovdqa64 64(%rsi), %zmm3
; AVX512DQ-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm4 = [4,12,5,13,6,14,7,15]
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm0, %zmm5
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm2, %zmm4, %zmm5
; AVX512DQ-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm6 = [0,8,1,9,2,10,3,11]
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm2, %zmm6, %zmm0
; AVX512DQ-FCP-NEXT:    vpermi2q %zmm3, %zmm1, %zmm4
...
; AVX512BW-NEXT:    retq
;
; AVX512BW-FCP-LABEL: store_i64_stride2_vf16:
; AVX512BW-FCP:       # %bb.0:
; AVX512BW-FCP-NEXT:    vmovdqa64 (%rdi), %zmm0
; AVX512BW-FCP-NEXT:    vmovdqa64 64(%rdi), %zmm1
; AVX512BW-FCP-NEXT:    vmovdqa64 (%rsi), %zmm2
; AVX512BW-FCP-NEXT:    vmovdqa64 64(%rsi), %zmm3
; AVX512BW-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm4 = [4,12,5,13,6,14,7,15]
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm0, %zmm5
; AVX512BW-FCP-NEXT:    vpermt2q %zmm2, %zmm4, %zmm5
; AVX512BW-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm6 = [0,8,1,9,2,10,3,11]
; AVX512BW-FCP-NEXT:    vpermt2q %zmm2, %zmm6, %zmm0
; AVX512BW-FCP-NEXT:    vpermi2q %zmm3, %zmm1, %zmm4
...
; AVX512BW-FCP-NEXT:    retq
;
; AVX512DQ-BW-LABEL: store_i64_stride2_vf16:
; AVX512DQ-BW:       # %bb.0:
; AVX512DQ-BW-NEXT:    vmovdqa64 (%rdi), %zmm0
; AVX512DQ-BW-NEXT:    vmovdqa64 64(%rdi), %zmm1
; AVX512DQ-BW-NEXT:    vmovdqa64 (%rsi), %zmm2
; AVX512DQ-BW-NEXT:    vmovdqa64 64(%rsi), %zmm3
; AVX512DQ-BW-NEXT:    vpmovsxbq {{.*#+}} zmm4 = [4,12,5,13,6,14,7,15]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm0, %zmm5
; AVX512DQ-BW-NEXT:    vpermt2q %zmm2, %zmm4, %zmm5
; AVX512DQ-BW-NEXT:    vpmovsxbq {{.*#+}} zmm6 = [0,8,1,9,2,10,3,11]
; AVX512DQ-BW-NEXT:    vpermt2q %zmm2, %zmm6, %zmm0
; AVX512DQ-BW-NEXT:    vpermi2q %zmm3, %zmm1, %zmm4
...
; AVX512DQ-BW-NEXT:    retq
;
; AVX512DQ-BW-FCP-LABEL: store_i64_stride2_vf16:
; AVX512DQ-BW-FCP:       # %bb.0:
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 (%rdi), %zmm0
...
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm4 = [4,12,5,13,6,14,7,15]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm0, %zmm5
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm2, %zmm4, %zmm5
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm6 = [0,8,1,9,2,10,3,11]
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm2, %zmm6, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vpermi2q %zmm3, %zmm1, %zmm4
...
; AVX-NEXT:    vmovapd %ymm13, 224(%rdx)
...
; AVX2-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0,1],ymm13[2,3],ymm9[4,5],ymm13[6,7]
...
; AVX2-NEXT:    vmovaps %ymm9, 256(%rdx)
...
; AVX2-NEXT:    retq
;
; AVX2-FP-LABEL: store_i64_stride2_vf32:
; AVX2-FP:       # %bb.0:
...
; AVX2-FP-NEXT:    vmovaps 192(%rsi), %ymm6
; AVX2-FP-NEXT:    vmovaps 160(%rsi), %ymm10
...
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm3[0,2,2,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm1[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm15[0,1],ymm0[2,3],ymm15[4,5],ymm0[6,7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm3 = ymm3[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1],ymm3[2,3],ymm1[4,5],ymm3[6,7]
; AVX2-FP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm3 = ymm7[0,2,2,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm4[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm3 = ymm15[0,1],ymm3[2,3],ymm15[4,5],ymm3[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm4[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm4 = ymm4[0,1],ymm7[2,3],ymm4[4,5],ymm7[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm7 = ymm11[0,2,2,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm8[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm7 = ymm15[0,1],ymm7[2,3],ymm15[4,5],ymm7[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm11 = ymm11[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm8 = ymm8[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1],ymm11[2,3],ymm8[4,5],ymm11[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm11 = ymm14[0,2,2,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm12[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm11 = ymm15[0,1],ymm11[2,3],ymm15[4,5],ymm11[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm12 = ymm12[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0,1],ymm14[2,3],ymm12[4,5],ymm14[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm13[0,2,2,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm9[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm14 = ymm15[0,1],ymm14[2,3],ymm15[4,5],ymm14[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm9 = ymm9[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0,1],ymm13[2,3],ymm9[4,5],ymm13[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm13 = ymm10[0,2,2,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm5[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm13 = ymm15[0,1],ymm13[2,3],ymm15[4,5],ymm13[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm10 = ymm10[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm5[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0,1],ymm10[2,3],ymm5[4,5],ymm10[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm10 = ymm6[0,2,2,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm2[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm10 = ymm15[0,1],ymm10[2,3],ymm15[4,5],ymm10[6,7]
; AVX2-FP-NEXT:    vmovaps 224(%rdi), %ymm15
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm6 = ymm6[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1],ymm6[2,3],ymm2[4,5],ymm6[6,7]
; AVX2-FP-NEXT:    vmovaps 224(%rsi), %ymm6
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm6[0,2,2,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm15[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1],ymm0[2,3],ymm1[4,5],ymm0[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm6[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm6 = ymm15[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm6[0,1],ymm1[2,3],ymm6[4,5],ymm1[6,7]
; AVX2-FP-NEXT:    vmovaps %ymm1, 448(%rdx)
; AVX2-FP-NEXT:    vmovaps %ymm0, 480(%rdx)
; AVX2-FP-NEXT:    vmovaps %ymm2, 384(%rdx)
; AVX2-FP-NEXT:    vmovaps %ymm10, 416(%rdx)
; AVX2-FP-NEXT:    vmovaps %ymm5, 320(%rdx)
; AVX2-FP-NEXT:    vmovaps %ymm13, 352(%rdx)
; AVX2-FP-NEXT:    vmovaps %ymm9, 256(%rdx)
; AVX2-FP-NEXT:    vmovaps %ymm14, 288(%rdx)
; AVX2-FP-NEXT:    vmovaps %ymm12, 192(%rdx)
...
; AVX2-FP-NEXT:    retq
;
; AVX2-FCP-LABEL: store_i64_stride2_vf32:
; AVX2-FCP:       # %bb.0:
...
; AVX2-FCP-NEXT:    vmovaps 192(%rsi), %ymm6
...
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm3[0,2,2,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm1[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm15[0,1],ymm0[2,3],ymm15[4,5],ymm0[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm3 = ymm3[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1],ymm3[2,3],ymm1[4,5],ymm3[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm3 = ymm7[0,2,2,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm4[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm3 = ymm15[0,1],ymm3[2,3],ymm15[4,5],ymm3[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm4[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm4 = ymm4[0,1],ymm7[2,3],ymm4[4,5],ymm7[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm7 = ymm11[0,2,2,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm8[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm7 = ymm15[0,1],ymm7[2,3],ymm15[4,5],ymm7[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm11 = ymm11[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm8 = ymm8[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm8 = ymm8[0,1],ymm11[2,3],ymm8[4,5],ymm11[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm11 = ymm14[0,2,2,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm12[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm11 = ymm15[0,1],ymm11[2,3],ymm15[4,5],ymm11[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm14[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm12 = ymm12[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm12 = ymm12[0,1],ymm14[2,3],ymm12[4,5],ymm14[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm13[0,2,2,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm9[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm14 = ymm15[0,1],ymm14[2,3],ymm15[4,5],ymm14[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm9 = ymm9[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0,1],ymm13[2,3],ymm9[4,5],ymm13[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm13 = ymm10[0,2,2,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm5[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm13 = ymm15[0,1],ymm13[2,3],ymm15[4,5],ymm13[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm10 = ymm10[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm5[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm5 = ymm5[0,1],ymm10[2,3],ymm5[4,5],ymm10[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm10 = ymm6[0,2,2,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm2[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm10 = ymm15[0,1],ymm10[2,3],ymm15[4,5],ymm10[6,7]
; AVX2-FCP-NEXT:    vmovaps 224(%rdi), %ymm15
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm6 = ymm6[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1],ymm6[2,3],ymm2[4,5],ymm6[6,7]
; AVX2-FCP-NEXT:    vmovaps 224(%rsi), %ymm6
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm6[0,2,2,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm15[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm1[0,1],ymm0[2,3],ymm1[4,5],ymm0[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm6[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm6 = ymm15[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm6[0,1],ymm1[2,3],ymm6[4,5],ymm1[6,7]
; AVX2-FCP-NEXT:    vmovaps %ymm1, 448(%rdx)
; AVX2-FCP-NEXT:    vmovaps %ymm0, 480(%rdx)
; AVX2-FCP-NEXT:    vmovaps %ymm2, 384(%rdx)
; AVX2-FCP-NEXT:    vmovaps %ymm10, 416(%rdx)
; AVX2-FCP-NEXT:    vmovaps %ymm5, 320(%rdx)
; AVX2-FCP-NEXT:    vmovaps %ymm13, 352(%rdx)
; AVX2-FCP-NEXT:    vmovaps %ymm9, 256(%rdx)
; AVX2-FCP-NEXT:    vmovaps %ymm14, 288(%rdx)
; AVX2-FCP-NEXT:    vmovaps %ymm12, 192(%rdx)
...
; AVX512-NEXT:    vpmovsxbq {{.*#+}} zmm8 = [4,12,5,13,6,14,7,15]
; AVX512-NEXT:    vmovdqa64 %zmm0, %zmm9
; AVX512-NEXT:    vpermt2q %zmm4, %zmm8, %zmm9
; AVX512-NEXT:    vpmovsxbq {{.*#+}} zmm10 = [0,8,1,9,2,10,3,11]
...
; AVX512-NEXT:    retq
;
; AVX512-FCP-LABEL: store_i64_stride2_vf32:
; AVX512-FCP:       # %bb.0:
; AVX512-FCP-NEXT:    vmovdqa64 (%rdi), %zmm0
; AVX512-FCP-NEXT:    vmovdqa64 64(%rdi), %zmm1
...
; AVX512-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm8 = [4,12,5,13,6,14,7,15]
; AVX512-FCP-NEXT:    vmovdqa64 %zmm0, %zmm9
; AVX512-FCP-NEXT:    vpermt2q %zmm4, %zmm8, %zmm9
; AVX512-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm10 = [0,8,1,9,2,10,3,11]
; AVX512-FCP-NEXT:    vpermt2q %zmm4, %zmm10, %zmm0
; AVX512-FCP-NEXT:    vmovdqa64 %zmm1, %zmm4
; AVX512-FCP-NEXT:    vpermt2q %zmm5, %zmm8, %zmm4
; AVX512-FCP-NEXT:    vpermt2q %zmm5, %zmm10, %zmm1
; AVX512-FCP-NEXT:    vmovdqa64 %zmm2, %zmm5
; AVX512-FCP-NEXT:    vpermt2q %zmm6, %zmm8, %zmm5
; AVX512-FCP-NEXT:    vpermt2q %zmm6, %zmm10, %zmm2
; AVX512-FCP-NEXT:    vpermi2q %zmm7, %zmm3, %zmm8
; AVX512-FCP-NEXT:    vpermt2q %zmm7, %zmm10, %zmm3
...
; AVX512-FCP-NEXT:    retq
;
; AVX512DQ-LABEL: store_i64_stride2_vf32:
; AVX512DQ:       # %bb.0:
; AVX512DQ-NEXT:    vmovdqa64 (%rdi), %zmm0
; AVX512DQ-NEXT:    vmovdqa64 64(%rdi), %zmm1
...
; AVX512DQ-NEXT:    vpmovsxbq {{.*#+}} zmm8 = [4,12,5,13,6,14,7,15]
; AVX512DQ-NEXT:    vmovdqa64 %zmm0, %zmm9
; AVX512DQ-NEXT:    vpermt2q %zmm4, %zmm8, %zmm9
; AVX512DQ-NEXT:    vpmovsxbq {{.*#+}} zmm10 = [0,8,1,9,2,10,3,11]
; AVX512DQ-NEXT:    vpermt2q %zmm4, %zmm10, %zmm0
; AVX512DQ-NEXT:    vmovdqa64 %zmm1, %zmm4
; AVX512DQ-NEXT:    vpermt2q %zmm5, %zmm8, %zmm4
; AVX512DQ-NEXT:    vpermt2q %zmm5, %zmm10, %zmm1
; AVX512DQ-NEXT:    vmovdqa64 %zmm2, %zmm5
; AVX512DQ-NEXT:    vpermt2q %zmm6, %zmm8, %zmm5
; AVX512DQ-NEXT:    vpermt2q %zmm6, %zmm10, %zmm2
; AVX512DQ-NEXT:    vpermi2q %zmm7, %zmm3, %zmm8
; AVX512DQ-NEXT:    vpermt2q %zmm7, %zmm10, %zmm3
...
; AVX512DQ-NEXT:    retq
;
; AVX512DQ-FCP-LABEL: store_i64_stride2_vf32:
; AVX512DQ-FCP:       # %bb.0:
; AVX512DQ-FCP-NEXT:    vmovdqa64 (%rdi), %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqa64 64(%rdi), %zmm1
...
; AVX512DQ-FCP-NEXT:    retq
;
; AVX512BW-LABEL: store_i64_stride2_vf32:
; AVX512BW:       # %bb.0:
; AVX512BW-NEXT:    vmovdqa64 (%rdi), %zmm0
; AVX512BW-NEXT:    vmovdqa64 64(%rdi), %zmm1
...
; AVX512BW-NEXT:    vpmovsxbq {{.*#+}} zmm8 = [4,12,5,13,6,14,7,15]
; AVX512BW-NEXT:    vmovdqa64 %zmm0, %zmm9
; AVX512BW-NEXT:    vpermt2q %zmm4, %zmm8, %zmm9
; AVX512BW-NEXT:    vpmovsxbq {{.*#+}} zmm10 = [0,8,1,9,2,10,3,11]
; AVX512BW-NEXT:    vpermt2q %zmm4, %zmm10, %zmm0
; AVX512BW-NEXT:    vmovdqa64 %zmm1, %zmm4
; AVX512BW-NEXT:    vpermt2q %zmm5, %zmm8, %zmm4
; AVX512BW-NEXT:    vpermt2q %zmm5, %zmm10, %zmm1
; AVX512BW-NEXT:    vmovdqa64 %zmm2, %zmm5
; AVX512BW-NEXT:    vpermt2q %zmm6, %zmm8, %zmm5
; AVX512BW-NEXT:    vpermt2q %zmm6, %zmm10, %zmm2
; AVX512BW-NEXT:    vpermi2q %zmm7, %zmm3, %zmm8
...
; AVX512BW-NEXT:    retq
;
; AVX512BW-FCP-LABEL: store_i64_stride2_vf32:
; AVX512BW-FCP:       # %bb.0:
; AVX512BW-FCP-NEXT:    vmovdqa64 (%rdi), %zmm0
; AVX512BW-FCP-NEXT:    vmovdqa64 64(%rdi), %zmm1
...
; AVX512BW-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm8 = [4,12,5,13,6,14,7,15]
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm0, %zmm9
; AVX512BW-FCP-NEXT:    vpermt2q %zmm4, %zmm8, %zmm9
; AVX512BW-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm10 = [0,8,1,9,2,10,3,11]
; AVX512BW-FCP-NEXT:    vpermt2q %zmm4, %zmm10, %zmm0
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm1, %zmm4
; AVX512BW-FCP-NEXT:    vpermt2q %zmm5, %zmm8, %zmm4
; AVX512BW-FCP-NEXT:    vpermt2q %zmm5, %zmm10, %zmm1
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm2, %zmm5
; AVX512BW-FCP-NEXT:    vpermt2q %zmm6, %zmm8, %zmm5
; AVX512BW-FCP-NEXT:    vpermt2q %zmm6, %zmm10, %zmm2
; AVX512BW-FCP-NEXT:    vpermi2q %zmm7, %zmm3, %zmm8
; AVX512BW-FCP-NEXT:    vpermt2q %zmm7, %zmm10, %zmm3
...
; AVX512BW-FCP-NEXT:    retq
;
; AVX512DQ-BW-LABEL: store_i64_stride2_vf32:
; AVX512DQ-BW:       # %bb.0:
; AVX512DQ-BW-NEXT:    vmovdqa64 (%rdi), %zmm0
; AVX512DQ-BW-NEXT:    vmovdqa64 64(%rdi), %zmm1
...
; AVX512DQ-BW-NEXT:    vpmovsxbq {{.*#+}} zmm8 = [4,12,5,13,6,14,7,15]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm0, %zmm9
; AVX512DQ-BW-NEXT:    vpermt2q %zmm4, %zmm8, %zmm9
; AVX512DQ-BW-NEXT:    vpmovsxbq {{.*#+}} zmm10 = [0,8,1,9,2,10,3,11]
; AVX512DQ-BW-NEXT:    vpermt2q %zmm4, %zmm10, %zmm0
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm1, %zmm4
; AVX512DQ-BW-NEXT:    vpermt2q %zmm5, %zmm8, %zmm4
; AVX512DQ-BW-NEXT:    vpermt2q %zmm5, %zmm10, %zmm1
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm2, %zmm5
; AVX512DQ-BW-NEXT:    vpermt2q %zmm6, %zmm8, %zmm5
; AVX512DQ-BW-NEXT:    vpermt2q %zmm6, %zmm10, %zmm2
; AVX512DQ-BW-NEXT:    vpermi2q %zmm7, %zmm3, %zmm8
; AVX512DQ-BW-NEXT:    vpermt2q %zmm7, %zmm10, %zmm3
...
; AVX512DQ-BW-NEXT:    retq
;
; AVX512DQ-BW-FCP-LABEL: store_i64_stride2_vf32:
; AVX512DQ-BW-FCP:       # %bb.0:
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 (%rdi), %zmm0
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 64(%rdi), %zmm1
...
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm8 = [4,12,5,13,6,14,7,15]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm0, %zmm9
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm4, %zmm8, %zmm9
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm10 = [0,8,1,9,2,10,3,11]
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm4, %zmm10, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm1, %zmm4
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm5, %zmm8, %zmm4
...
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm6, %zmm10, %zmm2
; AVX512DQ-BW-FCP-NEXT:    vpermi2q %zmm7, %zmm3, %zmm8
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm7, %zmm10, %zmm3
...
; SSE-NEXT:    movaps %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    unpckhpd {{.*#+}} xmm14 = xmm14[1],xmm0[1]
; SSE-NEXT:    movaps 384(%rdi), %xmm15
; SSE-NEXT:    movaps 384(%rsi), %xmm0
; SSE-NEXT:    movaps %xmm15, %xmm1
; SSE-NEXT:    movlhps {{.*#+}} xmm1 = xmm1[0],xmm0[0]
; SSE-NEXT:    movaps %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    unpckhpd {{.*#+}} xmm15 = xmm15[1],xmm0[1]
; SSE-NEXT:    movaps 400(%rdi), %xmm12
...
; SSE-NEXT:    movaps %xmm6, 928(%rdx)
; SSE-NEXT:    movaps %xmm7, 912(%rdx)
; SSE-NEXT:    movaps %xmm8, 896(%rdx)
; SSE-NEXT:    movaps %xmm9, 880(%rdx)
; SSE-NEXT:    movaps %xmm11, 864(%rdx)
; SSE-NEXT:    movaps %xmm10, 848(%rdx)
; SSE-NEXT:    movaps %xmm13, 832(%rdx)
; SSE-NEXT:    movaps %xmm12, 816(%rdx)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 800(%rdx)
; SSE-NEXT:    movaps %xmm15, 784(%rdx)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 768(%rdx)
; SSE-NEXT:    movaps %xmm14, 752(%rdx)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm0 = mem[0,1,0,1]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm7 = mem[0,1,0,1]
; AVX-NEXT:    vshufpd {{.*#+}} ymm0 = ymm7[0],ymm0[0],ymm7[3],ymm0[3]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm7 = mem[0,1,0,1]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm8 = mem[0,1,0,1]
; AVX-NEXT:    vshufpd {{.*#+}} ymm7 = ymm8[0],ymm7[0],ymm8[3],ymm7[3]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm8 = mem[0,1,0,1]
...
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm15 = mem[0,1,0,1]
; AVX-NEXT:    vbroadcastf128 {{.*#+}} ymm6 = mem[0,1,0,1]
; AVX-NEXT:    vshufpd {{.*#+}} ymm6 = ymm6[0],ymm15[0],ymm6[3],ymm15[3]
; AVX-NEXT:    vmovapd %ymm6, 992(%rdx)
; AVX-NEXT:    vmovapd %ymm14, 960(%rdx)
; AVX-NEXT:    vmovapd %ymm13, 928(%rdx)
; AVX-NEXT:    vmovapd %ymm12, 896(%rdx)
; AVX-NEXT:    vmovapd %ymm11, 864(%rdx)
; AVX-NEXT:    vmovapd %ymm10, 832(%rdx)
; AVX-NEXT:    vmovapd %ymm9, 800(%rdx)
; AVX-NEXT:    vmovapd %ymm8, 768(%rdx)
; AVX-NEXT:    vmovapd %ymm7, 736(%rdx)
; AVX-NEXT:    vmovapd %ymm0, 704(%rdx)
; AVX-NEXT:    vmovapd %ymm1, 672(%rdx)
; AVX-NEXT:    vmovapd %ymm2, 640(%rdx)
; AVX-NEXT:    vmovapd %ymm3, 608(%rdx)
; AVX-NEXT:    vmovapd %ymm4, 576(%rdx)
; AVX-NEXT:    vmovapd %ymm5, 544(%rdx)
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX-NEXT:    retq
;
; AVX2-LABEL: store_i64_stride2_vf64:
; AVX2:       # %bb.0:
...
; AVX2-NEXT:    vmovaps 128(%rsi), %ymm9
; AVX2-NEXT:    vmovaps (%rsi), %ymm8
; AVX2-NEXT:    vmovaps 32(%rsi), %ymm10
; AVX2-NEXT:    vmovaps 64(%rsi), %ymm12
; AVX2-NEXT:    vmovaps 96(%rsi), %ymm13
; AVX2-NEXT:    vpermpd {{.*#+}} ymm14 = ymm8[0,0,2,1]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm15 = ymm4[0,1,1,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm14 = ymm15[0,1],ymm14[2,3],ymm15[4,5],ymm14[6,7]
; AVX2-NEXT:    vmovups %ymm14, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpermpd {{.*#+}} ymm8 = ymm8[0,2,2,3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm4 = ymm4[2,1,3,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm4 = ymm4[0,1],ymm8[2,3],ymm4[4,5],ymm8[6,7]
; AVX2-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpermpd {{.*#+}} ymm4 = ymm10[0,0,2,1]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm8 = ymm5[0,1,1,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm4 = ymm8[0,1],ymm4[2,3],ymm8[4,5],ymm4[6,7]
; AVX2-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpermpd {{.*#+}} ymm4 = ymm10[0,2,2,3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm5 = ymm5[2,1,3,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm4 = ymm5[0,1],ymm4[2,3],ymm5[4,5],ymm4[6,7]
; AVX2-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpermpd {{.*#+}} ymm4 = ymm12[0,0,2,1]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm5 = ymm6[0,1,1,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm4 = ymm5[0,1],ymm4[2,3],ymm5[4,5],ymm4[6,7]
; AVX2-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpermpd {{.*#+}} ymm4 = ymm12[0,2,2,3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm5 = ymm6[2,1,3,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm4 = ymm5[0,1],ymm4[2,3],ymm5[4,5],ymm4[6,7]
; AVX2-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpermpd {{.*#+}} ymm4 = ymm13[0,0,2,1]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm5 = ymm7[0,1,1,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm4 = ymm5[0,1],ymm4[2,3],ymm5[4,5],ymm4[6,7]
; AVX2-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpermpd {{.*#+}} ymm4 = ymm13[0,2,2,3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm5 = ymm7[2,1,3,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm4 = ymm5[0,1],ymm4[2,3],ymm5[4,5],ymm4[6,7]
; AVX2-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpermpd {{.*#+}} ymm4 = ymm9[0,0,2,1]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm5 = ymm2[0,1,1,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm4 = ymm5[0,1],ymm4[2,3],ymm5[4,5],ymm4[6,7]
; AVX2-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpermpd {{.*#+}} ymm4 = ymm9[0,2,2,3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[2,1,3,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1],ymm4[2,3],ymm2[4,5],ymm4[6,7]
; AVX2-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpermpd {{.*#+}} ymm2 = ymm11[0,0,2,1]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm4 = ymm1[0,1,1,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm2 = ymm4[0,1],ymm2[2,3],ymm4[4,5],ymm2[6,7]
; AVX2-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpermpd {{.*#+}} ymm2 = ymm11[0,2,2,3]
...
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm3[0,0,2,1]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm2 = ymm0[0,1,1,3]
...
; AVX2-NEXT:    vpermpd {{.*#+}} ymm2 = ymm0[0,0,2,1]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm3 = ymm1[0,1,1,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm2 = ymm3[0,1],ymm2[2,3],ymm3[4,5],ymm2[6,7]
; AVX2-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-NEXT:    vpermpd {{.*#+}} ymm2 = ymm1[0,0,2,1]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm3 = ymm0[0,1,1,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm12 = ymm3[0,1],ymm2[2,3],ymm3[4,5],ymm2[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,2,2,3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[2,1,3,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm10 = ymm0[0,1],ymm1[2,3],ymm0[4,5],ymm1[6,7]
; AVX2-NEXT:    vmovaps 320(%rdi), %ymm1
; AVX2-NEXT:    vmovaps 320(%rsi), %ymm0
; AVX2-NEXT:    vpermpd {{.*#+}} ymm2 = ymm0[0,0,2,1]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm7 = ymm1[0,1,1,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm8 = ymm7[0,1],ymm2[2,3],ymm7[4,5],ymm2[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,2,2,3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[2,1,3,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm6 = ymm1[0,1],ymm0[2,3],ymm1[4,5],ymm0[6,7]
; AVX2-NEXT:    vmovaps 352(%rdi), %ymm1
; AVX2-NEXT:    vmovaps 352(%rsi), %ymm7
; AVX2-NEXT:    vpermpd {{.*#+}} ymm0 = ymm7[0,0,2,1]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm9 = ymm1[0,1,1,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm5 = ymm9[0,1],ymm0[2,3],ymm9[4,5],ymm0[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[0,2,2,3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[2,1,3,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm4 = ymm1[0,1],ymm7[2,3],ymm1[4,5],ymm7[6,7]
; AVX2-NEXT:    vmovaps 384(%rdi), %ymm7
; AVX2-NEXT:    vmovaps 384(%rsi), %ymm9
; AVX2-NEXT:    vpermpd {{.*#+}} ymm0 = ymm9[0,0,2,1]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm11 = ymm7[0,1,1,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm3 = ymm11[0,1],ymm0[2,3],ymm11[4,5],ymm0[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm9 = ymm9[0,2,2,3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[2,1,3,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1],ymm9[2,3],ymm7[4,5],ymm9[6,7]
; AVX2-NEXT:    vmovaps 416(%rdi), %ymm9
; AVX2-NEXT:    vmovaps 416(%rsi), %ymm11
; AVX2-NEXT:    vpermpd {{.*#+}} ymm0 = ymm11[0,0,2,1]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm13 = ymm9[0,1,1,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm2 = ymm13[0,1],ymm0[2,3],ymm13[4,5],ymm0[6,7]
...
; AVX2-NEXT:    vpermpd {{.*#+}} ymm0 = ymm13[0,0,2,1]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm15 = ymm11[0,1,1,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm1 = ymm15[0,1],ymm0[2,3],ymm15[4,5],ymm0[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[0,2,2,3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm11 = ymm11[2,1,3,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0,1],ymm13[2,3],ymm11[4,5],ymm13[6,7]
; AVX2-NEXT:    vmovaps 480(%rdi), %ymm13
; AVX2-NEXT:    vmovaps 480(%rsi), %ymm15
; AVX2-NEXT:    vpermpd {{.*#+}} ymm0 = ymm15[0,0,2,1]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm14 = ymm13[0,1,1,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm0 = ymm14[0,1],ymm0[2,3],ymm14[4,5],ymm0[6,7]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm14 = ymm15[0,2,2,3]
; AVX2-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[2,1,3,3]
; AVX2-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0,1],ymm14[2,3],ymm13[4,5],ymm14[6,7]
; AVX2-NEXT:    vmovaps %ymm13, 992(%rdx)
; AVX2-NEXT:    vmovaps %ymm0, 960(%rdx)
; AVX2-NEXT:    vmovaps %ymm11, 928(%rdx)
; AVX2-NEXT:    vmovaps %ymm1, 896(%rdx)
; AVX2-NEXT:    vmovaps %ymm9, 864(%rdx)
; AVX2-NEXT:    vmovaps %ymm2, 832(%rdx)
; AVX2-NEXT:    vmovaps %ymm7, 800(%rdx)
; AVX2-NEXT:    vmovaps %ymm3, 768(%rdx)
; AVX2-NEXT:    vmovaps %ymm4, 736(%rdx)
; AVX2-NEXT:    vmovaps %ymm5, 704(%rdx)
; AVX2-NEXT:    vmovaps %ymm6, 672(%rdx)
; AVX2-NEXT:    vmovaps %ymm8, 640(%rdx)
; AVX2-NEXT:    vmovaps %ymm10, 608(%rdx)
; AVX2-NEXT:    vmovaps %ymm12, 576(%rdx)
; AVX2-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX2-NEXT:    retq
;
; AVX2-FP-LABEL: store_i64_stride2_vf64:
; AVX2-FP:       # %bb.0:
...
; AVX2-FP-NEXT:    vmovaps 128(%rsi), %ymm9
; AVX2-FP-NEXT:    vmovaps (%rsi), %ymm8
; AVX2-FP-NEXT:    vmovaps 32(%rsi), %ymm10
; AVX2-FP-NEXT:    vmovaps 64(%rsi), %ymm12
; AVX2-FP-NEXT:    vmovaps 96(%rsi), %ymm13
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm8[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm4[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm14 = ymm15[0,1],ymm14[2,3],ymm15[4,5],ymm14[6,7]
...
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm4 = ymm4[0,1],ymm8[2,3],ymm4[4,5],ymm8[6,7]
; AVX2-FP-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm10[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm8 = ymm5[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm4 = ymm8[0,1],ymm4[2,3],ymm8[4,5],ymm4[6,7]
; AVX2-FP-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm10[0,2,2,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm5[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm4 = ymm5[0,1],ymm4[2,3],ymm5[4,5],ymm4[6,7]
; AVX2-FP-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm12[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm6[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm4 = ymm5[0,1],ymm4[2,3],ymm5[4,5],ymm4[6,7]
; AVX2-FP-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm12[0,2,2,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm6[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm4 = ymm5[0,1],ymm4[2,3],ymm5[4,5],ymm4[6,7]
; AVX2-FP-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm13[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm7[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm4 = ymm5[0,1],ymm4[2,3],ymm5[4,5],ymm4[6,7]
; AVX2-FP-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm13[0,2,2,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm7[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm4 = ymm5[0,1],ymm4[2,3],ymm5[4,5],ymm4[6,7]
; AVX2-FP-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm9[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm2[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm4 = ymm5[0,1],ymm4[2,3],ymm5[4,5],ymm4[6,7]
; AVX2-FP-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm9[0,2,2,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1],ymm4[2,3],ymm2[4,5],ymm4[6,7]
; AVX2-FP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm11[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm1[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm2 = ymm4[0,1],ymm2[2,3],ymm4[4,5],ymm2[6,7]
; AVX2-FP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm11[0,2,2,3]
...
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm3[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm0[0,1,1,3]
...
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm0[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm3 = ymm1[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm2 = ymm3[0,1],ymm2[2,3],ymm3[4,5],ymm2[6,7]
; AVX2-FP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm1[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm3 = ymm0[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm12 = ymm3[0,1],ymm2[2,3],ymm3[4,5],ymm2[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,2,2,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm10 = ymm0[0,1],ymm1[2,3],ymm0[4,5],ymm1[6,7]
; AVX2-FP-NEXT:    vmovaps 320(%rdi), %ymm1
; AVX2-FP-NEXT:    vmovaps 320(%rsi), %ymm0
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm0[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm7 = ymm1[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm8 = ymm7[0,1],ymm2[2,3],ymm7[4,5],ymm2[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,2,2,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm6 = ymm1[0,1],ymm0[2,3],ymm1[4,5],ymm0[6,7]
; AVX2-FP-NEXT:    vmovaps 352(%rdi), %ymm1
; AVX2-FP-NEXT:    vmovaps 352(%rsi), %ymm7
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm7[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm9 = ymm1[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm5 = ymm9[0,1],ymm0[2,3],ymm9[4,5],ymm0[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[0,2,2,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm4 = ymm1[0,1],ymm7[2,3],ymm1[4,5],ymm7[6,7]
; AVX2-FP-NEXT:    vmovaps 384(%rdi), %ymm7
; AVX2-FP-NEXT:    vmovaps 384(%rsi), %ymm9
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm9[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm11 = ymm7[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm3 = ymm11[0,1],ymm0[2,3],ymm11[4,5],ymm0[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm9 = ymm9[0,2,2,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1],ymm9[2,3],ymm7[4,5],ymm9[6,7]
; AVX2-FP-NEXT:    vmovaps 416(%rdi), %ymm9
; AVX2-FP-NEXT:    vmovaps 416(%rsi), %ymm11
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm11[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm13 = ymm9[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm2 = ymm13[0,1],ymm0[2,3],ymm13[4,5],ymm0[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm11 = ymm11[0,2,2,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm9 = ymm9[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0,1],ymm11[2,3],ymm9[4,5],ymm11[6,7]
; AVX2-FP-NEXT:    vmovaps 448(%rdi), %ymm11
; AVX2-FP-NEXT:    vmovaps 448(%rsi), %ymm13
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm13[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm11[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm1 = ymm15[0,1],ymm0[2,3],ymm15[4,5],ymm0[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[0,2,2,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm11 = ymm11[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0,1],ymm13[2,3],ymm11[4,5],ymm13[6,7]
; AVX2-FP-NEXT:    vmovaps 480(%rdi), %ymm13
; AVX2-FP-NEXT:    vmovaps 480(%rsi), %ymm15
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm15[0,0,2,1]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm13[0,1,1,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm0 = ymm14[0,1],ymm0[2,3],ymm14[4,5],ymm0[6,7]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm15[0,2,2,3]
; AVX2-FP-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[2,1,3,3]
; AVX2-FP-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0,1],ymm14[2,3],ymm13[4,5],ymm14[6,7]
; AVX2-FP-NEXT:    vmovaps %ymm13, 992(%rdx)
; AVX2-FP-NEXT:    vmovaps %ymm0, 960(%rdx)
; AVX2-FP-NEXT:    vmovaps %ymm11, 928(%rdx)
; AVX2-FP-NEXT:    vmovaps %ymm1, 896(%rdx)
; AVX2-FP-NEXT:    vmovaps %ymm9, 864(%rdx)
; AVX2-FP-NEXT:    vmovaps %ymm2, 832(%rdx)
; AVX2-FP-NEXT:    vmovaps %ymm7, 800(%rdx)
; AVX2-FP-NEXT:    vmovaps %ymm3, 768(%rdx)
; AVX2-FP-NEXT:    vmovaps %ymm4, 736(%rdx)
; AVX2-FP-NEXT:    vmovaps %ymm5, 704(%rdx)
; AVX2-FP-NEXT:    vmovaps %ymm6, 672(%rdx)
; AVX2-FP-NEXT:    vmovaps %ymm8, 640(%rdx)
; AVX2-FP-NEXT:    vmovaps %ymm10, 608(%rdx)
; AVX2-FP-NEXT:    vmovaps %ymm12, 576(%rdx)
; AVX2-FP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX2-FP-NEXT:    retq
;
; AVX2-FCP-LABEL: store_i64_stride2_vf64:
; AVX2-FCP:       # %bb.0:
...
; AVX2-FCP-NEXT:    vmovaps 128(%rsi), %ymm9
...
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm8[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm4[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm14 = ymm15[0,1],ymm14[2,3],ymm15[4,5],ymm14[6,7]
...
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm4 = ymm4[0,1],ymm8[2,3],ymm4[4,5],ymm8[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm10[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm8 = ymm5[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm4 = ymm8[0,1],ymm4[2,3],ymm8[4,5],ymm4[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm10[0,2,2,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm5[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm4 = ymm5[0,1],ymm4[2,3],ymm5[4,5],ymm4[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm12[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm6[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm4 = ymm5[0,1],ymm4[2,3],ymm5[4,5],ymm4[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm12[0,2,2,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm6[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm4 = ymm5[0,1],ymm4[2,3],ymm5[4,5],ymm4[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm13[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm7[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm4 = ymm5[0,1],ymm4[2,3],ymm5[4,5],ymm4[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm13[0,2,2,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm7[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm4 = ymm5[0,1],ymm4[2,3],ymm5[4,5],ymm4[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm9[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm5 = ymm2[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm4 = ymm5[0,1],ymm4[2,3],ymm5[4,5],ymm4[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm4, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm9[0,2,2,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm2[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm2[0,1],ymm4[2,3],ymm2[4,5],ymm4[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm11[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm4 = ymm1[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm4[0,1],ymm2[2,3],ymm4[4,5],ymm2[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm11[0,2,2,3]
...
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm3[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm0[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm2[0,1],ymm1[2,3],ymm2[4,5],ymm1[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm0[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm3 = ymm1[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm3[0,1],ymm2[2,3],ymm3[4,5],ymm2[6,7]
; AVX2-FCP-NEXT:    vmovups %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm1[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm3 = ymm0[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm12 = ymm3[0,1],ymm2[2,3],ymm3[4,5],ymm2[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[0,2,2,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm10 = ymm0[0,1],ymm1[2,3],ymm0[4,5],ymm1[6,7]
; AVX2-FCP-NEXT:    vmovaps 320(%rdi), %ymm1
; AVX2-FCP-NEXT:    vmovaps 320(%rsi), %ymm0
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm2 = ymm0[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm7 = ymm1[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm8 = ymm7[0,1],ymm2[2,3],ymm7[4,5],ymm2[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm0[0,2,2,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm6 = ymm1[0,1],ymm0[2,3],ymm1[4,5],ymm0[6,7]
; AVX2-FCP-NEXT:    vmovaps 352(%rdi), %ymm1
; AVX2-FCP-NEXT:    vmovaps 352(%rsi), %ymm7
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm7[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm9 = ymm1[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm5 = ymm9[0,1],ymm0[2,3],ymm9[4,5],ymm0[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[0,2,2,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm1 = ymm1[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm4 = ymm1[0,1],ymm7[2,3],ymm1[4,5],ymm7[6,7]
; AVX2-FCP-NEXT:    vmovaps 384(%rdi), %ymm7
; AVX2-FCP-NEXT:    vmovaps 384(%rsi), %ymm9
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm9[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm11 = ymm7[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm3 = ymm11[0,1],ymm0[2,3],ymm11[4,5],ymm0[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm9 = ymm9[0,2,2,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm7 = ymm7[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm7 = ymm7[0,1],ymm9[2,3],ymm7[4,5],ymm9[6,7]
; AVX2-FCP-NEXT:    vmovaps 416(%rdi), %ymm9
; AVX2-FCP-NEXT:    vmovaps 416(%rsi), %ymm11
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm11[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm13 = ymm9[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm2 = ymm13[0,1],ymm0[2,3],ymm13[4,5],ymm0[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm11 = ymm11[0,2,2,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm9 = ymm9[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm9 = ymm9[0,1],ymm11[2,3],ymm9[4,5],ymm11[6,7]
; AVX2-FCP-NEXT:    vmovaps 448(%rdi), %ymm11
; AVX2-FCP-NEXT:    vmovaps 448(%rsi), %ymm13
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm13[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm15 = ymm11[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm1 = ymm15[0,1],ymm0[2,3],ymm15[4,5],ymm0[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[0,2,2,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm11 = ymm11[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm11 = ymm11[0,1],ymm13[2,3],ymm11[4,5],ymm13[6,7]
; AVX2-FCP-NEXT:    vmovaps 480(%rdi), %ymm13
; AVX2-FCP-NEXT:    vmovaps 480(%rsi), %ymm15
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm0 = ymm15[0,0,2,1]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm13[0,1,1,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm0 = ymm14[0,1],ymm0[2,3],ymm14[4,5],ymm0[6,7]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm14 = ymm15[0,2,2,3]
; AVX2-FCP-NEXT:    vpermpd {{.*#+}} ymm13 = ymm13[2,1,3,3]
; AVX2-FCP-NEXT:    vblendps {{.*#+}} ymm13 = ymm13[0,1],ymm14[2,3],ymm13[4,5],ymm14[6,7]
; AVX2-FCP-NEXT:    vmovaps %ymm13, 992(%rdx)
; AVX2-FCP-NEXT:    vmovaps %ymm0, 960(%rdx)
; AVX2-FCP-NEXT:    vmovaps %ymm11, 928(%rdx)
; AVX2-FCP-NEXT:    vmovaps %ymm1, 896(%rdx)
; AVX2-FCP-NEXT:    vmovaps %ymm9, 864(%rdx)
; AVX2-FCP-NEXT:    vmovaps %ymm2, 832(%rdx)
; AVX2-FCP-NEXT:    vmovaps %ymm7, 800(%rdx)
; AVX2-FCP-NEXT:    vmovaps %ymm3, 768(%rdx)
; AVX2-FCP-NEXT:    vmovaps %ymm4, 736(%rdx)
; AVX2-FCP-NEXT:    vmovaps %ymm5, 704(%rdx)
; AVX2-FCP-NEXT:    vmovaps %ymm6, 672(%rdx)
; AVX2-FCP-NEXT:    vmovaps %ymm8, 640(%rdx)
; AVX2-FCP-NEXT:    vmovaps %ymm10, 608(%rdx)
; AVX2-FCP-NEXT:    vmovaps %ymm12, 576(%rdx)
; AVX2-FCP-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
...
; AVX512-NEXT:    vpmovsxbq {{.*#+}} zmm16 = [4,12,5,13,6,14,7,15]
; AVX512-NEXT:    vmovdqa64 %zmm4, %zmm17
; AVX512-NEXT:    vpermt2q %zmm12, %zmm16, %zmm17
; AVX512-NEXT:    vpmovsxbq {{.*#+}} zmm18 = [0,8,1,9,2,10,3,11]
...
; AVX512-NEXT:    retq
;
; AVX512-FCP-LABEL: store_i64_stride2_vf64:
; AVX512-FCP:       # %bb.0:
...
; AVX512-FCP-NEXT:    vmovdqa64 448(%rsi), %zmm8
; AVX512-FCP-NEXT:    vmovdqa64 384(%rsi), %zmm9
; AVX512-FCP-NEXT:    vmovdqa64 320(%rsi), %zmm10
; AVX512-FCP-NEXT:    vmovdqa64 256(%rsi), %zmm11
; AVX512-FCP-NEXT:    vmovdqa64 (%rsi), %zmm12
; AVX512-FCP-NEXT:    vmovdqa64 64(%rsi), %zmm13
; AVX512-FCP-NEXT:    vmovdqa64 128(%rsi), %zmm14
; AVX512-FCP-NEXT:    vmovdqa64 192(%rsi), %zmm15
; AVX512-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm16 = [4,12,5,13,6,14,7,15]
; AVX512-FCP-NEXT:    vmovdqa64 %zmm4, %zmm17
; AVX512-FCP-NEXT:    vpermt2q %zmm12, %zmm16, %zmm17
; AVX512-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm18 = [0,8,1,9,2,10,3,11]
; AVX512-FCP-NEXT:    vpermt2q %zmm12, %zmm18, %zmm4
; AVX512-FCP-NEXT:    vmovdqa64 %zmm5, %zmm12
; AVX512-FCP-NEXT:    vpermt2q %zmm13, %zmm16, %zmm12
; AVX512-FCP-NEXT:    vpermt2q %zmm13, %zmm18, %zmm5
; AVX512-FCP-NEXT:    vmovdqa64 %zmm6, %zmm13
; AVX512-FCP-NEXT:    vpermt2q %zmm14, %zmm16, %zmm13
; AVX512-FCP-NEXT:    vpermt2q %zmm14, %zmm18, %zmm6
; AVX512-FCP-NEXT:    vmovdqa64 %zmm7, %zmm14
; AVX512-FCP-NEXT:    vpermt2q %zmm15, %zmm16, %zmm14
; AVX512-FCP-NEXT:    vpermt2q %zmm15, %zmm18, %zmm7
; AVX512-FCP-NEXT:    vmovdqa64 %zmm3, %zmm15
; AVX512-FCP-NEXT:    vpermt2q %zmm11, %zmm16, %zmm15
; AVX512-FCP-NEXT:    vpermt2q %zmm11, %zmm18, %zmm3
; AVX512-FCP-NEXT:    vmovdqa64 %zmm2, %zmm11
; AVX512-FCP-NEXT:    vpermt2q %zmm10, %zmm16, %zmm11
; AVX512-FCP-NEXT:    vpermt2q %zmm10, %zmm18, %zmm2
; AVX512-FCP-NEXT:    vmovdqa64 %zmm1, %zmm10
; AVX512-FCP-NEXT:    vpermt2q %zmm9, %zmm16, %zmm10
; AVX512-FCP-NEXT:    vpermt2q %zmm9, %zmm18, %zmm1
; AVX512-FCP-NEXT:    vpermi2q %zmm8, %zmm0, %zmm16
; AVX512-FCP-NEXT:    vpermt2q %zmm8, %zmm18, %zmm0
; AVX512-FCP-NEXT:    vmovdqa64 %zmm0, 896(%rdx)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm16, 960(%rdx)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm1, 768(%rdx)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm10, 832(%rdx)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm2, 640(%rdx)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm11, 704(%rdx)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm3, 512(%rdx)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm15, 576(%rdx)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm7, 384(%rdx)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm14, 448(%rdx)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm6, 256(%rdx)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm13, 320(%rdx)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm5, 128(%rdx)
...
; AVX512-FCP-NEXT:    retq
;
; AVX512DQ-LABEL: store_i64_stride2_vf64:
; AVX512DQ:       # %bb.0:
...
; AVX512DQ-NEXT:    vmovdqa64 448(%rsi), %zmm8
; AVX512DQ-NEXT:    vmovdqa64 384(%rsi), %zmm9
; AVX512DQ-NEXT:    vmovdqa64 320(%rsi), %zmm10
; AVX512DQ-NEXT:    vmovdqa64 256(%rsi), %zmm11
; AVX512DQ-NEXT:    vmovdqa64 (%rsi), %zmm12
; AVX512DQ-NEXT:    vmovdqa64 64(%rsi), %zmm13
; AVX512DQ-NEXT:    vmovdqa64 128(%rsi), %zmm14
; AVX512DQ-NEXT:    vmovdqa64 192(%rsi), %zmm15
; AVX512DQ-NEXT:    vpmovsxbq {{.*#+}} zmm16 = [4,12,5,13,6,14,7,15]
; AVX512DQ-NEXT:    vmovdqa64 %zmm4, %zmm17
; AVX512DQ-NEXT:    vpermt2q %zmm12, %zmm16, %zmm17
; AVX512DQ-NEXT:    vpmovsxbq {{.*#+}} zmm18 = [0,8,1,9,2,10,3,11]
; AVX512DQ-NEXT:    vpermt2q %zmm12, %zmm18, %zmm4
; AVX512DQ-NEXT:    vmovdqa64 %zmm5, %zmm12
; AVX512DQ-NEXT:    vpermt2q %zmm13, %zmm16, %zmm12
; AVX512DQ-NEXT:    vpermt2q %zmm13, %zmm18, %zmm5
; AVX512DQ-NEXT:    vmovdqa64 %zmm6, %zmm13
; AVX512DQ-NEXT:    vpermt2q %zmm14, %zmm16, %zmm13
; AVX512DQ-NEXT:    vpermt2q %zmm14, %zmm18, %zmm6
; AVX512DQ-NEXT:    vmovdqa64 %zmm7, %zmm14
; AVX512DQ-NEXT:    vpermt2q %zmm15, %zmm16, %zmm14
; AVX512DQ-NEXT:    vpermt2q %zmm15, %zmm18, %zmm7
; AVX512DQ-NEXT:    vmovdqa64 %zmm3, %zmm15
; AVX512DQ-NEXT:    vpermt2q %zmm11, %zmm16, %zmm15
; AVX512DQ-NEXT:    vpermt2q %zmm11, %zmm18, %zmm3
; AVX512DQ-NEXT:    vmovdqa64 %zmm2, %zmm11
; AVX512DQ-NEXT:    vpermt2q %zmm10, %zmm16, %zmm11
; AVX512DQ-NEXT:    vpermt2q %zmm10, %zmm18, %zmm2
; AVX512DQ-NEXT:    vmovdqa64 %zmm1, %zmm10
; AVX512DQ-NEXT:    vpermt2q %zmm9, %zmm16, %zmm10
; AVX512DQ-NEXT:    vpermt2q %zmm9, %zmm18, %zmm1
; AVX512DQ-NEXT:    vpermi2q %zmm8, %zmm0, %zmm16
; AVX512DQ-NEXT:    vpermt2q %zmm8, %zmm18, %zmm0
; AVX512DQ-NEXT:    vmovdqa64 %zmm0, 896(%rdx)
; AVX512DQ-NEXT:    vmovdqa64 %zmm16, 960(%rdx)
; AVX512DQ-NEXT:    vmovdqa64 %zmm1, 768(%rdx)
; AVX512DQ-NEXT:    vmovdqa64 %zmm10, 832(%rdx)
; AVX512DQ-NEXT:    vmovdqa64 %zmm2, 640(%rdx)
; AVX512DQ-NEXT:    vmovdqa64 %zmm11, 704(%rdx)
; AVX512DQ-NEXT:    vmovdqa64 %zmm3, 512(%rdx)
; AVX512DQ-NEXT:    vmovdqa64 %zmm15, 576(%rdx)
; AVX512DQ-NEXT:    vmovdqa64 %zmm7, 384(%rdx)
; AVX512DQ-NEXT:    vmovdqa64 %zmm14, 448(%rdx)
; AVX512DQ-NEXT:    vmovdqa64 %zmm6, 256(%rdx)
; AVX512DQ-NEXT:    vmovdqa64 %zmm13, 320(%rdx)
...
; AVX512DQ-NEXT:    retq
;
; AVX512DQ-FCP-LABEL: store_i64_stride2_vf64:
; AVX512DQ-FCP:       # %bb.0:
...
; AVX512DQ-FCP-NEXT:    vmovdqa64 448(%rsi), %zmm8
; AVX512DQ-FCP-NEXT:    vmovdqa64 384(%rsi), %zmm9
; AVX512DQ-FCP-NEXT:    vmovdqa64 320(%rsi), %zmm10
; AVX512DQ-FCP-NEXT:    vmovdqa64 256(%rsi), %zmm11
; AVX512DQ-FCP-NEXT:    vmovdqa64 (%rsi), %zmm12
; AVX512DQ-FCP-NEXT:    vmovdqa64 64(%rsi), %zmm13
; AVX512DQ-FCP-NEXT:    vmovdqa64 128(%rsi), %zmm14
; AVX512DQ-FCP-NEXT:    vmovdqa64 192(%rsi), %zmm15
; AVX512DQ-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm16 = [4,12,5,13,6,14,7,15]
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm4, %zmm17
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm12, %zmm16, %zmm17
; AVX512DQ-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm18 = [0,8,1,9,2,10,3,11]
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm12, %zmm18, %zmm4
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm5, %zmm12
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm13, %zmm16, %zmm12
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm13, %zmm18, %zmm5
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm6, %zmm13
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm14, %zmm16, %zmm13
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm14, %zmm18, %zmm6
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm7, %zmm14
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm15, %zmm16, %zmm14
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm15, %zmm18, %zmm7
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm3, %zmm15
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm11, %zmm16, %zmm15
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm11, %zmm18, %zmm3
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm2, %zmm11
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm10, %zmm16, %zmm11
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm10, %zmm18, %zmm2
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm1, %zmm10
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm9, %zmm16, %zmm10
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm9, %zmm18, %zmm1
; AVX512DQ-FCP-NEXT:    vpermi2q %zmm8, %zmm0, %zmm16
; AVX512DQ-FCP-NEXT:    vpermt2q %zmm8, %zmm18, %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm0, 896(%rdx)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm16, 960(%rdx)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm1, 768(%rdx)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm10, 832(%rdx)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm2, 640(%rdx)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm11, 704(%rdx)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm3, 512(%rdx)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm15, 576(%rdx)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm7, 384(%rdx)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm14, 448(%rdx)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm6, 256(%rdx)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm13, 320(%rdx)
; AVX512DQ-FCP-NEXT:    vmovdqa64 %zmm5, 128(%rdx)
...
; AVX512DQ-FCP-NEXT:    retq
;
; AVX512BW-LABEL: store_i64_stride2_vf64:
; AVX512BW:       # %bb.0:
...
; AVX512BW-NEXT:    vmovdqa64 448(%rsi), %zmm8
; AVX512BW-NEXT:    vmovdqa64 384(%rsi), %zmm9
; AVX512BW-NEXT:    vmovdqa64 320(%rsi), %zmm10
; AVX512BW-NEXT:    vmovdqa64 256(%rsi), %zmm11
; AVX512BW-NEXT:    vmovdqa64 (%rsi), %zmm12
; AVX512BW-NEXT:    vmovdqa64 64(%rsi), %zmm13
; AVX512BW-NEXT:    vmovdqa64 128(%rsi), %zmm14
; AVX512BW-NEXT:    vmovdqa64 192(%rsi), %zmm15
; AVX512BW-NEXT:    vpmovsxbq {{.*#+}} zmm16 = [4,12,5,13,6,14,7,15]
; AVX512BW-NEXT:    vmovdqa64 %zmm4, %zmm17
; AVX512BW-NEXT:    vpermt2q %zmm12, %zmm16, %zmm17
; AVX512BW-NEXT:    vpmovsxbq {{.*#+}} zmm18 = [0,8,1,9,2,10,3,11]
; AVX512BW-NEXT:    vpermt2q %zmm12, %zmm18, %zmm4
; AVX512BW-NEXT:    vmovdqa64 %zmm5, %zmm12
; AVX512BW-NEXT:    vpermt2q %zmm13, %zmm16, %zmm12
; AVX512BW-NEXT:    vpermt2q %zmm13, %zmm18, %zmm5
; AVX512BW-NEXT:    vmovdqa64 %zmm6, %zmm13
; AVX512BW-NEXT:    vpermt2q %zmm14, %zmm16, %zmm13
; AVX512BW-NEXT:    vpermt2q %zmm14, %zmm18, %zmm6
; AVX512BW-NEXT:    vmovdqa64 %zmm7, %zmm14
; AVX512BW-NEXT:    vpermt2q %zmm15, %zmm16, %zmm14
; AVX512BW-NEXT:    vpermt2q %zmm15, %zmm18, %zmm7
; AVX512BW-NEXT:    vmovdqa64 %zmm3, %zmm15
; AVX512BW-NEXT:    vpermt2q %zmm11, %zmm16, %zmm15
; AVX512BW-NEXT:    vpermt2q %zmm11, %zmm18, %zmm3
; AVX512BW-NEXT:    vmovdqa64 %zmm2, %zmm11
; AVX512BW-NEXT:    vpermt2q %zmm10, %zmm16, %zmm11
; AVX512BW-NEXT:    vpermt2q %zmm10, %zmm18, %zmm2
; AVX512BW-NEXT:    vmovdqa64 %zmm1, %zmm10
; AVX512BW-NEXT:    vpermt2q %zmm9, %zmm16, %zmm10
; AVX512BW-NEXT:    vpermt2q %zmm9, %zmm18, %zmm1
; AVX512BW-NEXT:    vpermi2q %zmm8, %zmm0, %zmm16
; AVX512BW-NEXT:    vpermt2q %zmm8, %zmm18, %zmm0
; AVX512BW-NEXT:    vmovdqa64 %zmm0, 896(%rdx)
; AVX512BW-NEXT:    vmovdqa64 %zmm16, 960(%rdx)
; AVX512BW-NEXT:    vmovdqa64 %zmm1, 768(%rdx)
; AVX512BW-NEXT:    vmovdqa64 %zmm10, 832(%rdx)
; AVX512BW-NEXT:    vmovdqa64 %zmm2, 640(%rdx)
; AVX512BW-NEXT:    vmovdqa64 %zmm11, 704(%rdx)
; AVX512BW-NEXT:    vmovdqa64 %zmm3, 512(%rdx)
; AVX512BW-NEXT:    vmovdqa64 %zmm15, 576(%rdx)
...
; AVX512BW-NEXT:    retq
;
; AVX512BW-FCP-LABEL: store_i64_stride2_vf64:
; AVX512BW-FCP:       # %bb.0:
...
; AVX512BW-FCP-NEXT:    vmovdqa64 448(%rsi), %zmm8
; AVX512BW-FCP-NEXT:    vmovdqa64 384(%rsi), %zmm9
; AVX512BW-FCP-NEXT:    vmovdqa64 320(%rsi), %zmm10
; AVX512BW-FCP-NEXT:    vmovdqa64 256(%rsi), %zmm11
; AVX512BW-FCP-NEXT:    vmovdqa64 (%rsi), %zmm12
; AVX512BW-FCP-NEXT:    vmovdqa64 64(%rsi), %zmm13
; AVX512BW-FCP-NEXT:    vmovdqa64 128(%rsi), %zmm14
; AVX512BW-FCP-NEXT:    vmovdqa64 192(%rsi), %zmm15
; AVX512BW-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm16 = [4,12,5,13,6,14,7,15]
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm4, %zmm17
; AVX512BW-FCP-NEXT:    vpermt2q %zmm12, %zmm16, %zmm17
; AVX512BW-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm18 = [0,8,1,9,2,10,3,11]
; AVX512BW-FCP-NEXT:    vpermt2q %zmm12, %zmm18, %zmm4
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm5, %zmm12
; AVX512BW-FCP-NEXT:    vpermt2q %zmm13, %zmm16, %zmm12
; AVX512BW-FCP-NEXT:    vpermt2q %zmm13, %zmm18, %zmm5
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm6, %zmm13
; AVX512BW-FCP-NEXT:    vpermt2q %zmm14, %zmm16, %zmm13
; AVX512BW-FCP-NEXT:    vpermt2q %zmm14, %zmm18, %zmm6
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm7, %zmm14
; AVX512BW-FCP-NEXT:    vpermt2q %zmm15, %zmm16, %zmm14
; AVX512BW-FCP-NEXT:    vpermt2q %zmm15, %zmm18, %zmm7
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm3, %zmm15
; AVX512BW-FCP-NEXT:    vpermt2q %zmm11, %zmm16, %zmm15
; AVX512BW-FCP-NEXT:    vpermt2q %zmm11, %zmm18, %zmm3
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm2, %zmm11
; AVX512BW-FCP-NEXT:    vpermt2q %zmm10, %zmm16, %zmm11
; AVX512BW-FCP-NEXT:    vpermt2q %zmm10, %zmm18, %zmm2
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm1, %zmm10
; AVX512BW-FCP-NEXT:    vpermt2q %zmm9, %zmm16, %zmm10
; AVX512BW-FCP-NEXT:    vpermt2q %zmm9, %zmm18, %zmm1
; AVX512BW-FCP-NEXT:    vpermi2q %zmm8, %zmm0, %zmm16
; AVX512BW-FCP-NEXT:    vpermt2q %zmm8, %zmm18, %zmm0
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm0, 896(%rdx)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm16, 960(%rdx)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm1, 768(%rdx)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm10, 832(%rdx)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm2, 640(%rdx)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm11, 704(%rdx)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm3, 512(%rdx)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm15, 576(%rdx)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm7, 384(%rdx)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm14, 448(%rdx)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm6, 256(%rdx)
; AVX512BW-FCP-NEXT:    vmovdqa64 %zmm13, 320(%rdx)
...
; AVX512BW-FCP-NEXT:    retq
;
; AVX512DQ-BW-LABEL: store_i64_stride2_vf64:
; AVX512DQ-BW:       # %bb.0:
...
; AVX512DQ-BW-NEXT:    vmovdqa64 448(%rsi), %zmm8
; AVX512DQ-BW-NEXT:    vmovdqa64 384(%rsi), %zmm9
; AVX512DQ-BW-NEXT:    vmovdqa64 320(%rsi), %zmm10
; AVX512DQ-BW-NEXT:    vmovdqa64 256(%rsi), %zmm11
; AVX512DQ-BW-NEXT:    vmovdqa64 (%rsi), %zmm12
; AVX512DQ-BW-NEXT:    vmovdqa64 64(%rsi), %zmm13
; AVX512DQ-BW-NEXT:    vmovdqa64 128(%rsi), %zmm14
; AVX512DQ-BW-NEXT:    vmovdqa64 192(%rsi), %zmm15
; AVX512DQ-BW-NEXT:    vpmovsxbq {{.*#+}} zmm16 = [4,12,5,13,6,14,7,15]
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm4, %zmm17
; AVX512DQ-BW-NEXT:    vpermt2q %zmm12, %zmm16, %zmm17
; AVX512DQ-BW-NEXT:    vpmovsxbq {{.*#+}} zmm18 = [0,8,1,9,2,10,3,11]
; AVX512DQ-BW-NEXT:    vpermt2q %zmm12, %zmm18, %zmm4
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm5, %zmm12
; AVX512DQ-BW-NEXT:    vpermt2q %zmm13, %zmm16, %zmm12
; AVX512DQ-BW-NEXT:    vpermt2q %zmm13, %zmm18, %zmm5
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm6, %zmm13
; AVX512DQ-BW-NEXT:    vpermt2q %zmm14, %zmm16, %zmm13
; AVX512DQ-BW-NEXT:    vpermt2q %zmm14, %zmm18, %zmm6
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm7, %zmm14
; AVX512DQ-BW-NEXT:    vpermt2q %zmm15, %zmm16, %zmm14
; AVX512DQ-BW-NEXT:    vpermt2q %zmm15, %zmm18, %zmm7
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm3, %zmm15
; AVX512DQ-BW-NEXT:    vpermt2q %zmm11, %zmm16, %zmm15
; AVX512DQ-BW-NEXT:    vpermt2q %zmm11, %zmm18, %zmm3
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm2, %zmm11
; AVX512DQ-BW-NEXT:    vpermt2q %zmm10, %zmm16, %zmm11
; AVX512DQ-BW-NEXT:    vpermt2q %zmm10, %zmm18, %zmm2
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm1, %zmm10
; AVX512DQ-BW-NEXT:    vpermt2q %zmm9, %zmm16, %zmm10
; AVX512DQ-BW-NEXT:    vpermt2q %zmm9, %zmm18, %zmm1
; AVX512DQ-BW-NEXT:    vpermi2q %zmm8, %zmm0, %zmm16
; AVX512DQ-BW-NEXT:    vpermt2q %zmm8, %zmm18, %zmm0
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm0, 896(%rdx)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm16, 960(%rdx)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm1, 768(%rdx)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm10, 832(%rdx)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm2, 640(%rdx)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm11, 704(%rdx)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm3, 512(%rdx)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm15, 576(%rdx)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm7, 384(%rdx)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm14, 448(%rdx)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm6, 256(%rdx)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm13, 320(%rdx)
; AVX512DQ-BW-NEXT:    vmovdqa64 %zmm5, 128(%rdx)
...
; AVX512DQ-BW-NEXT:    retq
;
; AVX512DQ-BW-FCP-LABEL: store_i64_stride2_vf64:
; AVX512DQ-BW-FCP:       # %bb.0:
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 448(%rsi), %zmm8
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 384(%rsi), %zmm9
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 320(%rsi), %zmm10
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 256(%rsi), %zmm11
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 (%rsi), %zmm12
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 64(%rsi), %zmm13
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 128(%rsi), %zmm14
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 192(%rsi), %zmm15
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm16 = [4,12,5,13,6,14,7,15]
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm4, %zmm17
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm12, %zmm16, %zmm17
; AVX512DQ-BW-FCP-NEXT:    vpmovsxbq {{.*#+}} zmm18 = [0,8,1,9,2,10,3,11]
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm12, %zmm18, %zmm4
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm5, %zmm12
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm13, %zmm16, %zmm12
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm13, %zmm18, %zmm5
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm6, %zmm13
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm14, %zmm16, %zmm13
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm14, %zmm18, %zmm6
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm7, %zmm14
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm15, %zmm16, %zmm14
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm15, %zmm18, %zmm7
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm3, %zmm15
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm11, %zmm16, %zmm15
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm11, %zmm18, %zmm3
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm2, %zmm11
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm10, %zmm16, %zmm11
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm10, %zmm18, %zmm2
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm1, %zmm10
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm9, %zmm16, %zmm10
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm9, %zmm18, %zmm1
; AVX512DQ-BW-FCP-NEXT:    vpermi2q %zmm8, %zmm0, %zmm16
; AVX512DQ-BW-FCP-NEXT:    vpermt2q %zmm8, %zmm18, %zmm0
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm0, 896(%rdx)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm16, 960(%rdx)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm1, 768(%rdx)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm10, 832(%rdx)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm2, 640(%rdx)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm11, 704(%rdx)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm3, 512(%rdx)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm15, 576(%rdx)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm7, 384(%rdx)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm14, 448(%rdx)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm6, 256(%rdx)
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 %zmm13, 320(%rdx)
