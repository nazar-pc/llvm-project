...
; AVX512:       # %bb.0: # %entry
; AVX512-NEXT:    vpermpd {{.*#+}} zmm4 = zmm2[1,1,1,1,5,5,5,5]
; AVX512-NEXT:    vshuff64x2 {{.*#+}} zmm5 = zmm0[4,5,6,7,4,5,6,7]
; AVX512-NEXT:    vmulpd %zmm4, %zmm5, %zmm4
; AVX512-NEXT:    vpermpd {{.*#+}} zmm6 = zmm2[0,0,0,0,4,4,4,4]
; AVX512-NEXT:    vinsertf64x4 $1, %ymm0, %zmm0, %zmm7
; AVX512-NEXT:    vmulpd %zmm6, %zmm7, %zmm0
; AVX512-NEXT:    vaddpd %zmm4, %zmm0, %zmm0
; AVX512-NEXT:    vpermpd {{.*#+}} zmm4 = zmm2[2,2,2,2,6,6,6,6]
; AVX512-NEXT:    vinsertf64x4 $1, %ymm1, %zmm1, %zmm6
; AVX512-NEXT:    vmulpd %zmm4, %zmm6, %zmm4
; AVX512-NEXT:    vaddpd %zmm4, %zmm0, %zmm0
...
; AVX512-NEXT:    vpermpd {{.*#+}} zmm2 = zmm3[1,1,1,1,5,5,5,5]
; AVX512-NEXT:    vmulpd %zmm2, %zmm5, %zmm2
; AVX512-NEXT:    vpermpd {{.*#+}} zmm4 = zmm3[0,0,0,0,4,4,4,4]
; AVX512-NEXT:    vmulpd %zmm4, %zmm7, %zmm4
; AVX512-NEXT:    vaddpd %zmm2, %zmm4, %zmm2
; AVX512-NEXT:    vpermpd {{.*#+}} zmm4 = zmm3[2,2,2,2,6,6,6,6]
; AVX512-NEXT:    vmulpd %zmm4, %zmm6, %zmm4
...
; SSE-NEXT:    shufps {{.*#+}} xmm13 = xmm13[0,0],xmm14[0,0]
; SSE-NEXT:    movaps %xmm1, %xmm5
; SSE-NEXT:    movaps %xmm1, %xmm10
; SSE-NEXT:    mulps %xmm13, %xmm5
; SSE-NEXT:    mulps %xmm0, %xmm13
...
; SSE-NEXT:    addps %xmm1, %xmm4
; SSE-NEXT:    mulps %xmm6, %xmm0
; SSE-NEXT:    movaps %xmm6, %xmm10
; SSE-NEXT:    addps %xmm2, %xmm0
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm6
; SSE-NEXT:    movaps %xmm6, %xmm1
; SSE-NEXT:    shufps {{.*#+}} xmm1 = xmm1[0,0],xmm6[0,0]
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm2
; SSE-NEXT:    mulps %xmm1, %xmm2
; SSE-NEXT:    addps %xmm0, %xmm2
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm14
...
; SSE-NEXT:    addps %xmm2, %xmm0
; SSE-NEXT:    movaps %xmm6, %xmm1
; SSE-NEXT:    shufps {{.*#+}} xmm1 = xmm1[2,2],xmm6[2,2]
; SSE-NEXT:    movaps %xmm15, %xmm2
; SSE-NEXT:    mulps %xmm1, %xmm2
; SSE-NEXT:    addps %xmm0, %xmm2
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm0
...
; SSE-NEXT:    mulps %xmm13, %xmm2
; SSE-NEXT:    addps %xmm4, %xmm2
; SSE-NEXT:    mulps %xmm9, %xmm1
; SSE-NEXT:    mulps %xmm11, %xmm13
; SSE-NEXT:    addps %xmm1, %xmm13
; SSE-NEXT:    movaps %xmm0, %xmm1
; SSE-NEXT:    shufps {{.*#+}} xmm1 = xmm1[2,2],xmm0[2,2]
...
; SSE-NEXT:    movaps %xmm8, %xmm1
; SSE-NEXT:    mulps %xmm8, %xmm0
; SSE-NEXT:    addps %xmm3, %xmm0
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm5
; SSE-NEXT:    movaps %xmm5, %xmm4
; SSE-NEXT:    shufps {{.*#+}} xmm4 = xmm4[0,0],xmm5[0,0]
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm13
; SSE-NEXT:    mulps %xmm4, %xmm13
; SSE-NEXT:    addps %xmm0, %xmm13
; SSE-NEXT:    mulps {{[0-9]+}}(%rsp), %xmm4
...
; SSE-NEXT:    shufps {{.*#+}} xmm13 = xmm13[2,2],xmm5[2,2]
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm6
; SSE-NEXT:    mulps %xmm13, %xmm6
...
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm6
; SSE-NEXT:    movaps %xmm6, %xmm0
; SSE-NEXT:    shufps {{.*#+}} xmm0 = xmm0[0,0],xmm6[0,0]
...
; SSE-NEXT:    mulps %xmm13, %xmm9
; SSE-NEXT:    addps %xmm7, %xmm9
...
; SSE-NEXT:    movaps %xmm8, %xmm7
; SSE-NEXT:    mulps %xmm0, %xmm7
; SSE-NEXT:    addps %xmm13, %xmm7
; SSE-NEXT:    mulps %xmm15, %xmm0
; SSE-NEXT:    addps %xmm9, %xmm0
; SSE-NEXT:    shufps {{.*#+}} xmm6 = xmm6[3,3,3,3]
; SSE-NEXT:    movaps %xmm2, %xmm9
; SSE-NEXT:    mulps %xmm6, %xmm9
; SSE-NEXT:    addps %xmm0, %xmm9
; SSE-NEXT:    mulps %xmm1, %xmm6
; SSE-NEXT:    addps %xmm7, %xmm6
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm2
; SSE-NEXT:    movaps %xmm2, %xmm7
; SSE-NEXT:    shufps {{.*#+}} xmm7 = xmm7[0,0],xmm2[0,0]
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm0
; SSE-NEXT:    movaps %xmm0, %xmm13
; SSE-NEXT:    movaps %xmm0, %xmm1
; SSE-NEXT:    mulps %xmm7, %xmm13
; SSE-NEXT:    addps %xmm6, %xmm13
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm0
; SSE-NEXT:    mulps %xmm0, %xmm7
; SSE-NEXT:    addps %xmm9, %xmm7
; SSE-NEXT:    movaps %xmm2, %xmm6
; SSE-NEXT:    shufps {{.*#+}} xmm6 = xmm6[1,1],xmm2[1,1]
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm9
; SSE-NEXT:    mulps %xmm6, %xmm9
; SSE-NEXT:    addps %xmm7, %xmm9
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm0
; SSE-NEXT:    mulps %xmm0, %xmm6
; SSE-NEXT:    addps %xmm13, %xmm6
; SSE-NEXT:    movaps %xmm2, %xmm7
; SSE-NEXT:    shufps {{.*#+}} xmm7 = xmm7[2,2],xmm2[2,2]
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm13
; SSE-NEXT:    mulps %xmm7, %xmm13
; SSE-NEXT:    addps %xmm6, %xmm13
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm0
; SSE-NEXT:    mulps %xmm0, %xmm7
; SSE-NEXT:    addps %xmm9, %xmm7
; SSE-NEXT:    shufps {{.*#+}} xmm2 = xmm2[3,3,3,3]
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm6
; SSE-NEXT:    mulps %xmm2, %xmm6
; SSE-NEXT:    addps %xmm7, %xmm6
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm0
; SSE-NEXT:    mulps %xmm0, %xmm2
; SSE-NEXT:    addps %xmm13, %xmm2
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm9
; SSE-NEXT:    movaps %xmm9, %xmm0
; SSE-NEXT:    shufps {{.*#+}} xmm0 = xmm0[0,0],xmm9[0,0]
; SSE-NEXT:    movaps %xmm4, %xmm13
; SSE-NEXT:    movaps %xmm4, %xmm15
; SSE-NEXT:    mulps %xmm0, %xmm13
; SSE-NEXT:    movaps %xmm9, %xmm7
...
; SSE-NEXT:    mulps %xmm7, %xmm11
; SSE-NEXT:    addps %xmm13, %xmm11
; SSE-NEXT:    mulps %xmm3, %xmm0
; SSE-NEXT:    movaps %xmm3, %xmm12
; SSE-NEXT:    mulps %xmm14, %xmm7
; SSE-NEXT:    addps %xmm0, %xmm7
; SSE-NEXT:    movaps %xmm9, %xmm0
; SSE-NEXT:    shufps {{.*#+}} xmm0 = xmm0[2,2],xmm9[2,2]
; SSE-NEXT:    movaps %xmm8, %xmm13
; SSE-NEXT:    mulps %xmm0, %xmm13
; SSE-NEXT:    addps %xmm7, %xmm13
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Reload
; SSE-NEXT:    mulps %xmm3, %xmm0
; SSE-NEXT:    addps %xmm11, %xmm0
; SSE-NEXT:    shufps {{.*#+}} xmm9 = xmm9[3,3,3,3]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm7 # 16-byte Reload
; SSE-NEXT:    mulps %xmm9, %xmm7
; SSE-NEXT:    addps %xmm0, %xmm7
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm4 # 16-byte Reload
; SSE-NEXT:    mulps %xmm4, %xmm9
; SSE-NEXT:    addps %xmm13, %xmm9
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm0
; SSE-NEXT:    movaps %xmm0, %xmm11
; SSE-NEXT:    shufps {{.*#+}} xmm11 = xmm11[0,0],xmm0[0,0]
; SSE-NEXT:    movaps %xmm1, %xmm13
; SSE-NEXT:    mulps %xmm11, %xmm13
; SSE-NEXT:    addps %xmm9, %xmm13
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm1
; SSE-NEXT:    mulps %xmm1, %xmm11
; SSE-NEXT:    addps %xmm7, %xmm11
; SSE-NEXT:    movaps %xmm0, %xmm7
; SSE-NEXT:    shufps {{.*#+}} xmm7 = xmm7[1,1],xmm0[1,1]
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm9
; SSE-NEXT:    mulps %xmm7, %xmm9
; SSE-NEXT:    addps %xmm11, %xmm9
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm1
; SSE-NEXT:    mulps %xmm1, %xmm7
; SSE-NEXT:    addps %xmm13, %xmm7
; SSE-NEXT:    movaps %xmm0, %xmm11
; SSE-NEXT:    shufps {{.*#+}} xmm11 = xmm11[2,2],xmm0[2,2]
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm13
; SSE-NEXT:    mulps %xmm11, %xmm13
; SSE-NEXT:    addps %xmm7, %xmm13
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm1
; SSE-NEXT:    mulps %xmm1, %xmm11
; SSE-NEXT:    addps %xmm9, %xmm11
; SSE-NEXT:    shufps {{.*#+}} xmm0 = xmm0[3,3,3,3]
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm7
; SSE-NEXT:    mulps %xmm0, %xmm7
; SSE-NEXT:    addps %xmm11, %xmm7
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm1
; SSE-NEXT:    mulps %xmm1, %xmm0
; SSE-NEXT:    addps %xmm13, %xmm0
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm9
; SSE-NEXT:    movaps %xmm9, %xmm11
; SSE-NEXT:    shufps {{.*#+}} xmm11 = xmm11[0,0],xmm9[0,0]
; SSE-NEXT:    mulps %xmm11, %xmm15
; SSE-NEXT:    mulps %xmm12, %xmm11
; SSE-NEXT:    movaps %xmm9, %xmm13
; SSE-NEXT:    shufps {{.*#+}} xmm13 = xmm13[1,1],xmm9[1,1]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm12 # 16-byte Reload
; SSE-NEXT:    mulps %xmm13, %xmm12
; SSE-NEXT:    addps %xmm15, %xmm12
; SSE-NEXT:    mulps %xmm14, %xmm13
; SSE-NEXT:    addps %xmm11, %xmm13
; SSE-NEXT:    movaps %xmm9, %xmm11
; SSE-NEXT:    shufps {{.*#+}} xmm11 = xmm11[2,2],xmm9[2,2]
; SSE-NEXT:    mulps %xmm11, %xmm8
; SSE-NEXT:    addps %xmm13, %xmm8
; SSE-NEXT:    mulps %xmm3, %xmm11
; SSE-NEXT:    addps %xmm12, %xmm11
; SSE-NEXT:    shufps {{.*#+}} xmm9 = xmm9[3,3,3,3]
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm12 # 16-byte Reload
; SSE-NEXT:    mulps %xmm9, %xmm12
; SSE-NEXT:    addps %xmm11, %xmm12
; SSE-NEXT:    movaps %xmm12, %xmm13
; SSE-NEXT:    mulps %xmm4, %xmm9
; SSE-NEXT:    addps %xmm8, %xmm9
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm11
; SSE-NEXT:    movaps %xmm11, %xmm12
; SSE-NEXT:    shufps {{.*#+}} xmm12 = xmm12[0,0],xmm11[0,0]
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm15
; SSE-NEXT:    mulps %xmm12, %xmm15
; SSE-NEXT:    addps %xmm9, %xmm15
; SSE-NEXT:    mulps {{[0-9]+}}(%rsp), %xmm12
; SSE-NEXT:    addps %xmm13, %xmm12
; SSE-NEXT:    movaps %xmm11, %xmm9
; SSE-NEXT:    shufps {{.*#+}} xmm9 = xmm9[1,1],xmm11[1,1]
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm13
; SSE-NEXT:    mulps %xmm9, %xmm13
; SSE-NEXT:    addps %xmm12, %xmm13
; SSE-NEXT:    mulps {{[0-9]+}}(%rsp), %xmm9
; SSE-NEXT:    addps %xmm15, %xmm9
; SSE-NEXT:    movaps %xmm11, %xmm12
; SSE-NEXT:    shufps {{.*#+}} xmm12 = xmm12[2,2],xmm11[2,2]
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm3
; SSE-NEXT:    mulps %xmm12, %xmm3
; SSE-NEXT:    addps %xmm9, %xmm3
; SSE-NEXT:    mulps {{[0-9]+}}(%rsp), %xmm12
; SSE-NEXT:    addps %xmm13, %xmm12
; SSE-NEXT:    shufps {{.*#+}} xmm11 = xmm11[3,3,3,3]
; SSE-NEXT:    movaps {{[0-9]+}}(%rsp), %xmm4
; SSE-NEXT:    mulps %xmm11, %xmm4
; SSE-NEXT:    addps %xmm12, %xmm4
; SSE-NEXT:    mulps %xmm1, %xmm11
; SSE-NEXT:    addps %xmm3, %xmm11
; SSE-NEXT:    movaps %xmm4, 240(%rdi)
; SSE-NEXT:    movaps %xmm11, 224(%rdi)
; SSE-NEXT:    movaps %xmm7, 208(%rdi)
; SSE-NEXT:    movaps %xmm0, 192(%rdi)
; SSE-NEXT:    movaps %xmm6, 176(%rdi)
; SSE-NEXT:    movaps %xmm2, 160(%rdi)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 144(%rdi)
; SSE-NEXT:    movaps %xmm5, 128(%rdi)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; AVX1OR2-NEXT:    retq
;
; AVX512-LABEL: test_mul8x8_f32:
; AVX512:       # %bb.0: # %entry
; AVX512-NEXT:    vshufps {{.*#+}} zmm12 = zmm4[1,1,1,1,5,5,5,5,9,9,9,9,13,13,13,13]
; AVX512-NEXT:    vpermpd {{.*#+}} zmm9 = zmm12[0,1,0,1,4,5,4,5]
; AVX512-NEXT:    vshuff64x2 {{.*#+}} zmm8 = zmm0[4,5,6,7,4,5,6,7]
; AVX512-NEXT:    vmulps %zmm9, %zmm8, %zmm10
; AVX512-NEXT:    vshufps {{.*#+}} zmm11 = zmm4[0,0,0,0,4,4,4,4,8,8,8,8,12,12,12,12]
; AVX512-NEXT:    vpermpd {{.*#+}} zmm13 = zmm11[0,1,0,1,4,5,4,5]
; AVX512-NEXT:    vinsertf64x4 $1, %ymm0, %zmm0, %zmm9
; AVX512-NEXT:    vmulps %zmm13, %zmm9, %zmm0
; AVX512-NEXT:    vaddps %zmm10, %zmm0, %zmm0
; AVX512-NEXT:    vshufps {{.*#+}} zmm13 = zmm4[2,2,2,2,6,6,6,6,10,10,10,10,14,14,14,14]
; AVX512-NEXT:    vpermpd {{.*#+}} zmm14 = zmm13[0,1,0,1,4,5,4,5]
; AVX512-NEXT:    vinsertf64x4 $1, %ymm1, %zmm1, %zmm10
; AVX512-NEXT:    vmulps %zmm14, %zmm10, %zmm14
; AVX512-NEXT:    vaddps %zmm14, %zmm0, %zmm0
; AVX512-NEXT:    vshufps {{.*#+}} zmm14 = zmm4[3,3,3,3,7,7,7,7,11,11,11,11,15,15,15,15]
; AVX512-NEXT:    vpermpd {{.*#+}} zmm15 = zmm14[0,1,0,1,4,5,4,5]
; AVX512-NEXT:    vshuff64x2 {{.*#+}} zmm4 = zmm1[4,5,6,7,4,5,6,7]
; AVX512-NEXT:    vmulps %zmm15, %zmm4, %zmm1
; AVX512-NEXT:    vaddps %zmm1, %zmm0, %zmm0
; AVX512-NEXT:    vpermpd {{.*#+}} zmm1 = zmm11[2,3,2,3,6,7,6,7]
; AVX512-NEXT:    vinsertf64x4 $1, %ymm2, %zmm2, %zmm11
; AVX512-NEXT:    vmulps %zmm1, %zmm11, %zmm1
; AVX512-NEXT:    vaddps %zmm1, %zmm0, %zmm0
; AVX512-NEXT:    vpermpd {{.*#+}} zmm1 = zmm12[2,3,2,3,6,7,6,7]
; AVX512-NEXT:    vshuff64x2 {{.*#+}} zmm12 = zmm2[4,5,6,7,4,5,6,7]
; AVX512-NEXT:    vmulps %zmm1, %zmm12, %zmm1
; AVX512-NEXT:    vaddps %zmm1, %zmm0, %zmm0
; AVX512-NEXT:    vpermpd {{.*#+}} zmm1 = zmm13[2,3,2,3,6,7,6,7]
; AVX512-NEXT:    vinsertf64x4 $1, %ymm3, %zmm3, %zmm13
; AVX512-NEXT:    vmulps %zmm1, %zmm13, %zmm1
; AVX512-NEXT:    vaddps %zmm1, %zmm0, %zmm0
; AVX512-NEXT:    vpermpd {{.*#+}} zmm1 = zmm14[2,3,2,3,6,7,6,7]
; AVX512-NEXT:    vshuff64x2 {{.*#+}} zmm3 = zmm3[4,5,6,7,4,5,6,7]
; AVX512-NEXT:    vmulps %zmm1, %zmm3, %zmm1
; AVX512-NEXT:    vaddps %zmm1, %zmm0, %zmm0
; AVX512-NEXT:    vshufps {{.*#+}} zmm1 = zmm5[1,1,1,1,5,5,5,5,9,9,9,9,13,13,13,13]
; AVX512-NEXT:    vpermpd {{.*#+}} zmm2 = zmm1[0,1,0,1,4,5,4,5]
; AVX512-NEXT:    vmulps %zmm2, %zmm8, %zmm2
; AVX512-NEXT:    vshufps {{.*#+}} zmm14 = zmm5[0,0,0,0,4,4,4,4,8,8,8,8,12,12,12,12]
; AVX512-NEXT:    vpermpd {{.*#+}} zmm15 = zmm14[0,1,0,1,4,5,4,5]
; AVX512-NEXT:    vmulps %zmm15, %zmm9, %zmm15
; AVX512-NEXT:    vaddps %zmm2, %zmm15, %zmm2
; AVX512-NEXT:    vshufps {{.*#+}} zmm15 = zmm5[2,2,2,2,6,6,6,6,10,10,10,10,14,14,14,14]
; AVX512-NEXT:    vpermpd {{.*#+}} zmm16 = zmm15[0,1,0,1,4,5,4,5]
; AVX512-NEXT:    vmulps %zmm16, %zmm10, %zmm16
; AVX512-NEXT:    vaddps %zmm16, %zmm2, %zmm2
; AVX512-NEXT:    vshufps {{.*#+}} zmm5 = zmm5[3,3,3,3,7,7,7,7,11,11,11,11,15,15,15,15]
; AVX512-NEXT:    vpermpd {{.*#+}} zmm16 = zmm5[0,1,0,1,4,5,4,5]
; AVX512-NEXT:    vmulps %zmm16, %zmm4, %zmm16
; AVX512-NEXT:    vaddps %zmm16, %zmm2, %zmm2
; AVX512-NEXT:    vpermpd {{.*#+}} zmm14 = zmm14[2,3,2,3,6,7,6,7]
; AVX512-NEXT:    vmulps %zmm14, %zmm11, %zmm14
; AVX512-NEXT:    vaddps %zmm14, %zmm2, %zmm2
; AVX512-NEXT:    vpermpd {{.*#+}} zmm1 = zmm1[2,3,2,3,6,7,6,7]
; AVX512-NEXT:    vmulps %zmm1, %zmm12, %zmm1
; AVX512-NEXT:    vaddps %zmm1, %zmm2, %zmm1
; AVX512-NEXT:    vpermpd {{.*#+}} zmm2 = zmm15[2,3,2,3,6,7,6,7]
; AVX512-NEXT:    vmulps %zmm2, %zmm13, %zmm2
; AVX512-NEXT:    vaddps %zmm2, %zmm1, %zmm1
; AVX512-NEXT:    vpermpd {{.*#+}} zmm2 = zmm5[2,3,2,3,6,7,6,7]
; AVX512-NEXT:    vmulps %zmm2, %zmm3, %zmm2
; AVX512-NEXT:    vaddps %zmm2, %zmm1, %zmm1
; AVX512-NEXT:    vshufps {{.*#+}} zmm2 = zmm6[1,1,1,1,5,5,5,5,9,9,9,9,13,13,13,13]
; AVX512-NEXT:    vpermpd {{.*#+}} zmm5 = zmm2[0,1,0,1,4,5,4,5]
; AVX512-NEXT:    vmulps %zmm5, %zmm8, %zmm5
; AVX512-NEXT:    vshufps {{.*#+}} zmm14 = zmm6[0,0,0,0,4,4,4,4,8,8,8,8,12,12,12,12]
; AVX512-NEXT:    vpermpd {{.*#+}} zmm15 = zmm14[0,1,0,1,4,5,4,5]
; AVX512-NEXT:    vmulps %zmm15, %zmm9, %zmm15
; AVX512-NEXT:    vaddps %zmm5, %zmm15, %zmm5
; AVX512-NEXT:    vshufps {{.*#+}} zmm15 = zmm6[2,2,2,2,6,6,6,6,10,10,10,10,14,14,14,14]
; AVX512-NEXT:    vpermpd {{.*#+}} zmm16 = zmm15[0,1,0,1,4,5,4,5]
; AVX512-NEXT:    vmulps %zmm16, %zmm10, %zmm16
; AVX512-NEXT:    vaddps %zmm16, %zmm5, %zmm5
; AVX512-NEXT:    vshufps {{.*#+}} zmm6 = zmm6[3,3,3,3,7,7,7,7,11,11,11,11,15,15,15,15]
; AVX512-NEXT:    vpermpd {{.*#+}} zmm16 = zmm6[0,1,0,1,4,5,4,5]
; AVX512-NEXT:    vmulps %zmm16, %zmm4, %zmm16
; AVX512-NEXT:    vaddps %zmm16, %zmm5, %zmm5
; AVX512-NEXT:    vpermpd {{.*#+}} zmm14 = zmm14[2,3,2,3,6,7,6,7]
; AVX512-NEXT:    vmulps %zmm14, %zmm11, %zmm14
; AVX512-NEXT:    vaddps %zmm14, %zmm5, %zmm5
; AVX512-NEXT:    vpermpd {{.*#+}} zmm2 = zmm2[2,3,2,3,6,7,6,7]
; AVX512-NEXT:    vmulps %zmm2, %zmm12, %zmm2
; AVX512-NEXT:    vaddps %zmm2, %zmm5, %zmm2
; AVX512-NEXT:    vpermpd {{.*#+}} zmm5 = zmm15[2,3,2,3,6,7,6,7]
; AVX512-NEXT:    vmulps %zmm5, %zmm13, %zmm5
; AVX512-NEXT:    vaddps %zmm5, %zmm2, %zmm2
; AVX512-NEXT:    vpermpd {{.*#+}} zmm5 = zmm6[2,3,2,3,6,7,6,7]
; AVX512-NEXT:    vmulps %zmm5, %zmm3, %zmm5
; AVX512-NEXT:    vaddps %zmm5, %zmm2, %zmm2
; AVX512-NEXT:    vshufps {{.*#+}} zmm5 = zmm7[1,1,1,1,5,5,5,5,9,9,9,9,13,13,13,13]
; AVX512-NEXT:    vpermpd {{.*#+}} zmm6 = zmm5[0,1,0,1,4,5,4,5]
; AVX512-NEXT:    vmulps %zmm6, %zmm8, %zmm6
; AVX512-NEXT:    vshufps {{.*#+}} zmm8 = zmm7[0,0,0,0,4,4,4,4,8,8,8,8,12,12,12,12]
; AVX512-NEXT:    vpermpd {{.*#+}} zmm14 = zmm8[0,1,0,1,4,5,4,5]
; AVX512-NEXT:    vmulps %zmm14, %zmm9, %zmm9
; AVX512-NEXT:    vaddps %zmm6, %zmm9, %zmm6
; AVX512-NEXT:    vshufps {{.*#+}} zmm9 = zmm7[2,2,2,2,6,6,6,6,10,10,10,10,14,14,14,14]
; AVX512-NEXT:    vpermpd {{.*#+}} zmm14 = zmm9[0,1,0,1,4,5,4,5]
; AVX512-NEXT:    vmulps %zmm14, %zmm10, %zmm10
; AVX512-NEXT:    vaddps %zmm10, %zmm6, %zmm6
; AVX512-NEXT:    vshufps {{.*#+}} zmm7 = zmm7[3,3,3,3,7,7,7,7,11,11,11,11,15,15,15,15]
; AVX512-NEXT:    vpermpd {{.*#+}} zmm10 = zmm7[0,1,0,1,4,5,4,5]
; AVX512-NEXT:    vmulps %zmm10, %zmm4, %zmm4
; AVX512-NEXT:    vaddps %zmm4, %zmm6, %zmm4
; AVX512-NEXT:    vpermpd {{.*#+}} zmm6 = zmm8[2,3,2,3,6,7,6,7]
; AVX512-NEXT:    vmulps %zmm6, %zmm11, %zmm6
; AVX512-NEXT:    vaddps %zmm6, %zmm4, %zmm4
; AVX512-NEXT:    vpermpd {{.*#+}} zmm5 = zmm5[2,3,2,3,6,7,6,7]
; AVX512-NEXT:    vmulps %zmm5, %zmm12, %zmm5
; AVX512-NEXT:    vaddps %zmm5, %zmm4, %zmm4
; AVX512-NEXT:    vpermpd {{.*#+}} zmm5 = zmm9[2,3,2,3,6,7,6,7]
; AVX512-NEXT:    vmulps %zmm5, %zmm13, %zmm5
; AVX512-NEXT:    vaddps %zmm5, %zmm4, %zmm4
; AVX512-NEXT:    vpermpd {{.*#+}} zmm5 = zmm7[2,3,2,3,6,7,6,7]
; AVX512-NEXT:    vmulps %zmm5, %zmm3, %zmm3
...
; SSE-NEXT:    unpcklpd {{.*#+}} xmm2 = xmm2[0],xmm1[0]
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm8
; SSE-NEXT:    mulpd %xmm2, %xmm8
; SSE-NEXT:    addpd %xmm0, %xmm8
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm0
; SSE-NEXT:    mulpd %xmm2, %xmm0
; SSE-NEXT:    addpd %xmm6, %xmm0
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm6
...
; SSE-NEXT:    movapd %xmm12, %xmm8
; SSE-NEXT:    mulpd %xmm0, %xmm8
; SSE-NEXT:    addpd %xmm2, %xmm8
; SSE-NEXT:    mulpd %xmm7, %xmm1
; SSE-NEXT:    movapd %xmm7, %xmm15
; SSE-NEXT:    mulpd %xmm14, %xmm0
; SSE-NEXT:    addpd %xmm1, %xmm0
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm1
; SSE-NEXT:    movapd %xmm1, %xmm2
; SSE-NEXT:    unpcklpd {{.*#+}} xmm2 = xmm2[0],xmm1[0]
...
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm12
; SSE-NEXT:    movapd %xmm12, %xmm8
; SSE-NEXT:    unpcklpd {{.*#+}} xmm8 = xmm8[0],xmm12[0]
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm6
; SSE-NEXT:    mulpd %xmm8, %xmm6
; SSE-NEXT:    addpd %xmm0, %xmm6
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm0
; SSE-NEXT:    mulpd %xmm8, %xmm0
; SSE-NEXT:    addpd %xmm4, %xmm0
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm4
; SSE-NEXT:    mulpd %xmm8, %xmm4
; SSE-NEXT:    addpd %xmm2, %xmm4
; SSE-NEXT:    mulpd {{[0-9]+}}(%rsp), %xmm8
; SSE-NEXT:    addpd %xmm3, %xmm8
; SSE-NEXT:    unpckhpd {{.*#+}} xmm12 = xmm12[1,1]
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm1
; SSE-NEXT:    mulpd %xmm12, %xmm1
; SSE-NEXT:    addpd %xmm8, %xmm1
; SSE-NEXT:    movapd %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm1
; SSE-NEXT:    mulpd %xmm12, %xmm1
...
; SSE-NEXT:    mulpd %xmm0, %xmm5
; SSE-NEXT:    addpd %xmm11, %xmm5
; SSE-NEXT:    movapd {{[-0-9]+}}(%r{{[sb]}}p), %xmm10 # 16-byte Reload
; SSE-NEXT:    movapd %xmm10, %xmm6
; SSE-NEXT:    mulpd %xmm3, %xmm6
; SSE-NEXT:    movapd %xmm7, %xmm8
; SSE-NEXT:    movapd %xmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    movapd %xmm7, %xmm2
; SSE-NEXT:    mulpd %xmm0, %xmm2
; SSE-NEXT:    addpd %xmm6, %xmm2
; SSE-NEXT:    movapd %xmm9, %xmm11
; SSE-NEXT:    movapd %xmm9, %xmm6
; SSE-NEXT:    mulpd %xmm3, %xmm6
; SSE-NEXT:    movapd %xmm13, %xmm1
; SSE-NEXT:    mulpd %xmm0, %xmm1
; SSE-NEXT:    addpd %xmm6, %xmm1
; SSE-NEXT:    movapd %xmm15, %xmm13
; SSE-NEXT:    mulpd %xmm15, %xmm3
; SSE-NEXT:    movapd {{[-0-9]+}}(%r{{[sb]}}p), %xmm7 # 16-byte Reload
...
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm9
; SSE-NEXT:    movapd %xmm9, %xmm3
; SSE-NEXT:    unpcklpd {{.*#+}} xmm3 = xmm3[0],xmm9[0]
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm6
; SSE-NEXT:    mulpd %xmm3, %xmm6
; SSE-NEXT:    addpd %xmm4, %xmm6
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm4
...
; SSE-NEXT:    addpd %xmm6, %xmm3
; SSE-NEXT:    mulpd %xmm5, %xmm10
; SSE-NEXT:    mulpd %xmm4, %xmm8
; SSE-NEXT:    addpd %xmm10, %xmm8
; SSE-NEXT:    mulpd %xmm5, %xmm11
; SSE-NEXT:    movapd {{[-0-9]+}}(%r{{[sb]}}p), %xmm14 # 16-byte Reload
; SSE-NEXT:    movapd %xmm14, %xmm0
; SSE-NEXT:    mulpd %xmm4, %xmm0
; SSE-NEXT:    addpd %xmm11, %xmm0
; SSE-NEXT:    mulpd %xmm13, %xmm5
; SSE-NEXT:    mulpd %xmm7, %xmm4
; SSE-NEXT:    addpd %xmm5, %xmm4
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm5
; SSE-NEXT:    movapd %xmm5, %xmm6
; SSE-NEXT:    unpcklpd {{.*#+}} xmm6 = xmm6[0],xmm5[0]
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm2
; SSE-NEXT:    mulpd %xmm6, %xmm2
; SSE-NEXT:    addpd %xmm4, %xmm2
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm4
...
; SSE-NEXT:    movapd %xmm14, %xmm0
; SSE-NEXT:    mulpd {{[-0-9]+}}(%r{{[sb]}}p), %xmm2 # 16-byte Folded Reload
; SSE-NEXT:    addpd %xmm5, %xmm2
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm5
; SSE-NEXT:    movapd %xmm5, %xmm6
; SSE-NEXT:    unpcklpd {{.*#+}} xmm6 = xmm6[0],xmm5[0]
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm14
; SSE-NEXT:    mulpd %xmm6, %xmm14
...
; SSE-NEXT:    unpcklpd {{.*#+}} xmm6 = xmm6[0],xmm2[0]
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm1
; SSE-NEXT:    mulpd %xmm6, %xmm1
; SSE-NEXT:    addpd %xmm5, %xmm1
; SSE-NEXT:    movapd {{[0-9]+}}(%rsp), %xmm5
...
; SSE-NEXT:    mulpd {{[0-9]+}}(%rsp), %xmm5
; SSE-NEXT:    addpd %xmm1, %xmm5
; SSE-NEXT:    movapd %xmm0, 496(%rdi)
; SSE-NEXT:    movapd %xmm3, 480(%rdi)
; SSE-NEXT:    movapd %xmm6, 464(%rdi)
; SSE-NEXT:    movapd %xmm5, 448(%rdi)
; SSE-NEXT:    movapd %xmm11, 432(%rdi)
; SSE-NEXT:    movapd %xmm10, 416(%rdi)
; SSE-NEXT:    movapd %xmm8, 400(%rdi)
; SSE-NEXT:    movapd %xmm4, 384(%rdi)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 368(%rdi)
; SSE-NEXT:    movaps (%rsp), %xmm0 # 16-byte Reload
; SSE-NEXT:    movaps %xmm0, 352(%rdi)
; SSE-NEXT:    movapd %xmm15, 336(%rdi)
; SSE-NEXT:    movapd %xmm9, 320(%rdi)
; SSE-NEXT:    movaps {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
...
; AVX1OR2-NEXT:    vmovapd %ymm7, %ymm13
; AVX1OR2-NEXT:    vmovapd %ymm6, %ymm12
; AVX1OR2-NEXT:    vmovapd %ymm5, %ymm7
; AVX1OR2-NEXT:    vmovapd %ymm4, %ymm6
; AVX1OR2-NEXT:    vmovapd %ymm3, %ymm4
; AVX1OR2-NEXT:    vmovapd %ymm2, (%rsp) # 32-byte Spill
; AVX1OR2-NEXT:    vmovapd %ymm1, %ymm11
; AVX1OR2-NEXT:    vmovapd %ymm0, %ymm10
; AVX1OR2-NEXT:    movq %rdi, %rax
; AVX1OR2-NEXT:    vbroadcastsd 272(%rbp), %ymm8
; AVX1OR2-NEXT:    vmulpd %ymm1, %ymm8, %ymm9
; AVX1OR2-NEXT:    vmulpd %ymm0, %ymm8, %ymm8
; AVX1OR2-NEXT:    vbroadcastsd 280(%rbp), %ymm14
; AVX1OR2-NEXT:    vmulpd %ymm3, %ymm14, %ymm15
; AVX1OR2-NEXT:    vaddpd %ymm15, %ymm9, %ymm9
; AVX1OR2-NEXT:    vmulpd %ymm2, %ymm14, %ymm14
; AVX1OR2-NEXT:    vaddpd %ymm14, %ymm8, %ymm8
; AVX1OR2-NEXT:    vbroadcastsd 288(%rbp), %ymm14
; AVX1OR2-NEXT:    vmulpd %ymm6, %ymm14, %ymm15
; AVX1OR2-NEXT:    vaddpd %ymm15, %ymm8, %ymm8
; AVX1OR2-NEXT:    vmulpd %ymm5, %ymm14, %ymm14
; AVX1OR2-NEXT:    vaddpd %ymm14, %ymm9, %ymm9
; AVX1OR2-NEXT:    vbroadcastsd 296(%rbp), %ymm14
; AVX1OR2-NEXT:    vmovapd %ymm13, %ymm3
; AVX1OR2-NEXT:    vmulpd %ymm14, %ymm13, %ymm15
; AVX1OR2-NEXT:    vaddpd %ymm15, %ymm9, %ymm9
; AVX1OR2-NEXT:    vmovapd %ymm12, %ymm2
; AVX1OR2-NEXT:    vmulpd %ymm14, %ymm12, %ymm14
; AVX1OR2-NEXT:    vaddpd %ymm14, %ymm8, %ymm8
; AVX1OR2-NEXT:    vbroadcastsd 304(%rbp), %ymm14
; AVX1OR2-NEXT:    vmulpd 16(%rbp), %ymm14, %ymm15
; AVX1OR2-NEXT:    vaddpd %ymm15, %ymm8, %ymm8
; AVX1OR2-NEXT:    vmulpd 48(%rbp), %ymm14, %ymm14
; AVX1OR2-NEXT:    vaddpd %ymm14, %ymm9, %ymm9
; AVX1OR2-NEXT:    vbroadcastsd 312(%rbp), %ymm15
; AVX1OR2-NEXT:    vmulpd 112(%rbp), %ymm15, %ymm14
; AVX1OR2-NEXT:    vaddpd %ymm14, %ymm9, %ymm0
; AVX1OR2-NEXT:    vmulpd 80(%rbp), %ymm15, %ymm9
; AVX1OR2-NEXT:    vaddpd %ymm9, %ymm8, %ymm8
; AVX1OR2-NEXT:    vbroadcastsd 320(%rbp), %ymm15
; AVX1OR2-NEXT:    vmulpd 144(%rbp), %ymm15, %ymm9
; AVX1OR2-NEXT:    vaddpd %ymm9, %ymm8, %ymm8
; AVX1OR2-NEXT:    vmulpd 176(%rbp), %ymm15, %ymm15
; AVX1OR2-NEXT:    vaddpd %ymm0, %ymm15, %ymm0
; AVX1OR2-NEXT:    vbroadcastsd 328(%rbp), %ymm1
; AVX1OR2-NEXT:    vmulpd 240(%rbp), %ymm1, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm0, %ymm13, %ymm0
; AVX1OR2-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1OR2-NEXT:    vmulpd 208(%rbp), %ymm1, %ymm1
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm8, %ymm0
; AVX1OR2-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1OR2-NEXT:    vbroadcastsd 336(%rbp), %ymm1
; AVX1OR2-NEXT:    vmulpd %ymm1, %ymm11, %ymm8
; AVX1OR2-NEXT:    vbroadcastsd 344(%rbp), %ymm13
; AVX1OR2-NEXT:    vmulpd %ymm4, %ymm13, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm12, %ymm8, %ymm8
; AVX1OR2-NEXT:    vmulpd %ymm1, %ymm10, %ymm1
; AVX1OR2-NEXT:    vmovapd (%rsp), %ymm0 # 32-byte Reload
; AVX1OR2-NEXT:    vmulpd %ymm0, %ymm13, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm12, %ymm1
; AVX1OR2-NEXT:    vbroadcastsd 352(%rbp), %ymm12
; AVX1OR2-NEXT:    vmulpd %ymm6, %ymm12, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm13, %ymm1
; AVX1OR2-NEXT:    vmulpd %ymm5, %ymm12, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm12, %ymm8, %ymm8
; AVX1OR2-NEXT:    vbroadcastsd 360(%rbp), %ymm12
; AVX1OR2-NEXT:    vmulpd %ymm3, %ymm12, %ymm13
; AVX1OR2-NEXT:    vmovapd %ymm3, %ymm15
; AVX1OR2-NEXT:    vaddpd %ymm13, %ymm8, %ymm8
; AVX1OR2-NEXT:    vmulpd %ymm2, %ymm12, %ymm12
; AVX1OR2-NEXT:    vmovapd %ymm2, %ymm9
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm12, %ymm1
; AVX1OR2-NEXT:    vbroadcastsd 368(%rbp), %ymm12
; AVX1OR2-NEXT:    vmovapd 16(%rbp), %ymm3
; AVX1OR2-NEXT:    vmulpd %ymm3, %ymm12, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm13, %ymm1
; AVX1OR2-NEXT:    vmovapd 48(%rbp), %ymm2
; AVX1OR2-NEXT:    vmulpd %ymm2, %ymm12, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm12, %ymm8, %ymm8
; AVX1OR2-NEXT:    vbroadcastsd 376(%rbp), %ymm12
; AVX1OR2-NEXT:    vmovapd 112(%rbp), %ymm14
; AVX1OR2-NEXT:    vmulpd %ymm12, %ymm14, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm13, %ymm8, %ymm8
; AVX1OR2-NEXT:    vmovapd 80(%rbp), %ymm2
; AVX1OR2-NEXT:    vmulpd %ymm2, %ymm12, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm12, %ymm1
; AVX1OR2-NEXT:    vbroadcastsd 384(%rbp), %ymm12
; AVX1OR2-NEXT:    vmovapd 144(%rbp), %ymm2
; AVX1OR2-NEXT:    vmulpd %ymm2, %ymm12, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm13, %ymm1
; AVX1OR2-NEXT:    vmovapd 176(%rbp), %ymm2
; AVX1OR2-NEXT:    vmulpd %ymm2, %ymm12, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm12, %ymm8, %ymm8
; AVX1OR2-NEXT:    vbroadcastsd 392(%rbp), %ymm12
; AVX1OR2-NEXT:    vmovapd 240(%rbp), %ymm2
; AVX1OR2-NEXT:    vmulpd %ymm2, %ymm12, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm13, %ymm8, %ymm5
; AVX1OR2-NEXT:    vmovapd %ymm5, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1OR2-NEXT:    vmovapd 208(%rbp), %ymm2
; AVX1OR2-NEXT:    vmulpd %ymm2, %ymm12, %ymm8
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm8, %ymm1
; AVX1OR2-NEXT:    vmovapd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1OR2-NEXT:    vbroadcastsd 400(%rbp), %ymm1
; AVX1OR2-NEXT:    vmulpd %ymm1, %ymm11, %ymm8
; AVX1OR2-NEXT:    vbroadcastsd 408(%rbp), %ymm12
; AVX1OR2-NEXT:    vmulpd %ymm4, %ymm12, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm13, %ymm8, %ymm8
; AVX1OR2-NEXT:    vmulpd %ymm1, %ymm10, %ymm1
; AVX1OR2-NEXT:    vmovapd %ymm0, %ymm5
; AVX1OR2-NEXT:    vmulpd %ymm0, %ymm12, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm12, %ymm1
; AVX1OR2-NEXT:    vbroadcastsd 416(%rbp), %ymm12
; AVX1OR2-NEXT:    vmulpd %ymm6, %ymm12, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm13, %ymm1
; AVX1OR2-NEXT:    vmulpd %ymm7, %ymm12, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm12, %ymm8, %ymm8
; AVX1OR2-NEXT:    vbroadcastsd 424(%rbp), %ymm12
; AVX1OR2-NEXT:    vmulpd %ymm12, %ymm15, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm13, %ymm8, %ymm8
; AVX1OR2-NEXT:    vmulpd %ymm12, %ymm9, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm12, %ymm1
; AVX1OR2-NEXT:    vbroadcastsd 432(%rbp), %ymm12
; AVX1OR2-NEXT:    vmulpd %ymm3, %ymm12, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm13, %ymm1
; AVX1OR2-NEXT:    vmulpd 48(%rbp), %ymm12, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm12, %ymm8, %ymm8
; AVX1OR2-NEXT:    vbroadcastsd 440(%rbp), %ymm12
; AVX1OR2-NEXT:    vmulpd %ymm12, %ymm14, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm13, %ymm8, %ymm8
; AVX1OR2-NEXT:    vmulpd 80(%rbp), %ymm12, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm12, %ymm1
; AVX1OR2-NEXT:    vbroadcastsd 448(%rbp), %ymm12
; AVX1OR2-NEXT:    vmulpd 144(%rbp), %ymm12, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm13, %ymm1
; AVX1OR2-NEXT:    vmulpd 176(%rbp), %ymm12, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm12, %ymm8, %ymm8
; AVX1OR2-NEXT:    vbroadcastsd 456(%rbp), %ymm12
; AVX1OR2-NEXT:    vmulpd 240(%rbp), %ymm12, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm13, %ymm8, %ymm0
; AVX1OR2-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1OR2-NEXT:    vmulpd %ymm2, %ymm12, %ymm8
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm8, %ymm0
; AVX1OR2-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1OR2-NEXT:    vbroadcastsd 464(%rbp), %ymm1
; AVX1OR2-NEXT:    vmulpd %ymm1, %ymm11, %ymm8
; AVX1OR2-NEXT:    vbroadcastsd 472(%rbp), %ymm12
; AVX1OR2-NEXT:    vmulpd %ymm4, %ymm12, %ymm13
...
; AVX1OR2-NEXT:    vmulpd %ymm5, %ymm12, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm12, %ymm1
; AVX1OR2-NEXT:    vbroadcastsd 480(%rbp), %ymm12
; AVX1OR2-NEXT:    vmulpd %ymm6, %ymm12, %ymm13
; AVX1OR2-NEXT:    vmovapd %ymm6, %ymm2
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm13, %ymm1
; AVX1OR2-NEXT:    vmulpd %ymm7, %ymm12, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm12, %ymm8, %ymm8
; AVX1OR2-NEXT:    vbroadcastsd 488(%rbp), %ymm12
; AVX1OR2-NEXT:    vmulpd %ymm12, %ymm15, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm13, %ymm8, %ymm8
; AVX1OR2-NEXT:    vmulpd %ymm12, %ymm9, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm12, %ymm1
; AVX1OR2-NEXT:    vbroadcastsd 496(%rbp), %ymm12
; AVX1OR2-NEXT:    vmulpd 16(%rbp), %ymm12, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm13, %ymm1
; AVX1OR2-NEXT:    vmulpd 48(%rbp), %ymm12, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm12, %ymm8, %ymm8
; AVX1OR2-NEXT:    vbroadcastsd 504(%rbp), %ymm12
; AVX1OR2-NEXT:    vmulpd %ymm12, %ymm14, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm13, %ymm8, %ymm8
; AVX1OR2-NEXT:    vmulpd 80(%rbp), %ymm12, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm12, %ymm1
; AVX1OR2-NEXT:    vbroadcastsd 512(%rbp), %ymm12
; AVX1OR2-NEXT:    vmulpd 144(%rbp), %ymm12, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm13, %ymm1
; AVX1OR2-NEXT:    vmovapd 176(%rbp), %ymm0
; AVX1OR2-NEXT:    vmulpd %ymm0, %ymm12, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm12, %ymm8, %ymm8
; AVX1OR2-NEXT:    vbroadcastsd 520(%rbp), %ymm12
; AVX1OR2-NEXT:    vmovapd 240(%rbp), %ymm0
; AVX1OR2-NEXT:    vmulpd %ymm0, %ymm12, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm13, %ymm8, %ymm0
; AVX1OR2-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1OR2-NEXT:    vmovapd 208(%rbp), %ymm4
; AVX1OR2-NEXT:    vmulpd %ymm4, %ymm12, %ymm8
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm8, %ymm0
; AVX1OR2-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1OR2-NEXT:    vbroadcastsd 528(%rbp), %ymm1
; AVX1OR2-NEXT:    vmulpd %ymm1, %ymm11, %ymm8
; AVX1OR2-NEXT:    vbroadcastsd 536(%rbp), %ymm12
; AVX1OR2-NEXT:    vmovapd %ymm3, %ymm6
; AVX1OR2-NEXT:    vmulpd %ymm3, %ymm12, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm13, %ymm8, %ymm8
; AVX1OR2-NEXT:    vmulpd %ymm1, %ymm10, %ymm1
; AVX1OR2-NEXT:    vmovapd %ymm5, %ymm0
; AVX1OR2-NEXT:    vmulpd %ymm5, %ymm12, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm12, %ymm1
; AVX1OR2-NEXT:    vbroadcastsd 544(%rbp), %ymm12
; AVX1OR2-NEXT:    vmulpd %ymm2, %ymm12, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm13, %ymm1
; AVX1OR2-NEXT:    vmulpd %ymm7, %ymm12, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm12, %ymm8, %ymm8
; AVX1OR2-NEXT:    vbroadcastsd 552(%rbp), %ymm12
; AVX1OR2-NEXT:    vmulpd %ymm12, %ymm15, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm13, %ymm8, %ymm8
; AVX1OR2-NEXT:    vmulpd %ymm12, %ymm9, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm12, %ymm1
; AVX1OR2-NEXT:    vbroadcastsd 560(%rbp), %ymm12
; AVX1OR2-NEXT:    vmovapd 16(%rbp), %ymm14
; AVX1OR2-NEXT:    vmulpd %ymm12, %ymm14, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm13, %ymm1
; AVX1OR2-NEXT:    vmulpd 48(%rbp), %ymm12, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm12, %ymm8, %ymm8
; AVX1OR2-NEXT:    vbroadcastsd 568(%rbp), %ymm12
; AVX1OR2-NEXT:    vmulpd 112(%rbp), %ymm12, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm13, %ymm8, %ymm8
; AVX1OR2-NEXT:    vmulpd 80(%rbp), %ymm12, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm12, %ymm1
; AVX1OR2-NEXT:    vbroadcastsd 576(%rbp), %ymm12
; AVX1OR2-NEXT:    vmovapd 144(%rbp), %ymm3
; AVX1OR2-NEXT:    vmulpd %ymm3, %ymm12, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm13, %ymm1
; AVX1OR2-NEXT:    vmulpd 176(%rbp), %ymm12, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm12, %ymm8, %ymm8
; AVX1OR2-NEXT:    vbroadcastsd 584(%rbp), %ymm12
; AVX1OR2-NEXT:    vmulpd 240(%rbp), %ymm12, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm13, %ymm8, %ymm3
; AVX1OR2-NEXT:    vmovapd %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1OR2-NEXT:    vmulpd %ymm4, %ymm12, %ymm8
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm8, %ymm1
; AVX1OR2-NEXT:    vmovapd %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1OR2-NEXT:    vbroadcastsd 592(%rbp), %ymm1
; AVX1OR2-NEXT:    vmovapd %ymm11, %ymm3
; AVX1OR2-NEXT:    vmulpd %ymm1, %ymm11, %ymm8
; AVX1OR2-NEXT:    vbroadcastsd 600(%rbp), %ymm12
; AVX1OR2-NEXT:    vmulpd %ymm6, %ymm12, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm13, %ymm8, %ymm8
; AVX1OR2-NEXT:    vmulpd %ymm1, %ymm10, %ymm1
; AVX1OR2-NEXT:    vmovapd %ymm10, %ymm5
; AVX1OR2-NEXT:    vmulpd %ymm0, %ymm12, %ymm12
; AVX1OR2-NEXT:    vmovapd %ymm0, %ymm4
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm12, %ymm1
; AVX1OR2-NEXT:    vbroadcastsd 608(%rbp), %ymm12
; AVX1OR2-NEXT:    vmovapd %ymm2, %ymm10
; AVX1OR2-NEXT:    vmulpd %ymm2, %ymm12, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm13, %ymm1
; AVX1OR2-NEXT:    vmulpd %ymm7, %ymm12, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm12, %ymm8, %ymm8
; AVX1OR2-NEXT:    vbroadcastsd 616(%rbp), %ymm12
; AVX1OR2-NEXT:    vmulpd %ymm12, %ymm15, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm13, %ymm8, %ymm8
; AVX1OR2-NEXT:    vmulpd %ymm12, %ymm9, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm12, %ymm1
; AVX1OR2-NEXT:    vbroadcastsd 624(%rbp), %ymm12
; AVX1OR2-NEXT:    vmulpd %ymm12, %ymm14, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm13, %ymm1
; AVX1OR2-NEXT:    vmulpd 48(%rbp), %ymm12, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm12, %ymm8, %ymm8
; AVX1OR2-NEXT:    vbroadcastsd 632(%rbp), %ymm12
; AVX1OR2-NEXT:    vmulpd 112(%rbp), %ymm12, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm13, %ymm8, %ymm8
; AVX1OR2-NEXT:    vmulpd 80(%rbp), %ymm12, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm12, %ymm1
; AVX1OR2-NEXT:    vbroadcastsd 640(%rbp), %ymm12
; AVX1OR2-NEXT:    vmulpd 144(%rbp), %ymm12, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm13, %ymm1
; AVX1OR2-NEXT:    vmovapd 176(%rbp), %ymm0
; AVX1OR2-NEXT:    vmulpd %ymm0, %ymm12, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm12, %ymm8, %ymm8
; AVX1OR2-NEXT:    vbroadcastsd 648(%rbp), %ymm12
; AVX1OR2-NEXT:    vmovapd 240(%rbp), %ymm11
; AVX1OR2-NEXT:    vmulpd %ymm12, %ymm11, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm13, %ymm8, %ymm0
; AVX1OR2-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1OR2-NEXT:    vmulpd 208(%rbp), %ymm12, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm1, %ymm12, %ymm0
; AVX1OR2-NEXT:    vmovapd %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX1OR2-NEXT:    vbroadcastsd 656(%rbp), %ymm12
; AVX1OR2-NEXT:    vmulpd %ymm3, %ymm12, %ymm13
; AVX1OR2-NEXT:    vbroadcastsd 664(%rbp), %ymm0
; AVX1OR2-NEXT:    vmulpd %ymm0, %ymm6, %ymm14
; AVX1OR2-NEXT:    vaddpd %ymm14, %ymm13, %ymm13
; AVX1OR2-NEXT:    vmovapd %ymm5, %ymm2
; AVX1OR2-NEXT:    vmulpd %ymm5, %ymm12, %ymm12
; AVX1OR2-NEXT:    vmovapd %ymm4, %ymm5
; AVX1OR2-NEXT:    vmulpd %ymm0, %ymm4, %ymm0
; AVX1OR2-NEXT:    vaddpd %ymm0, %ymm12, %ymm0
; AVX1OR2-NEXT:    vbroadcastsd 672(%rbp), %ymm12
; AVX1OR2-NEXT:    vmulpd %ymm12, %ymm10, %ymm14
; AVX1OR2-NEXT:    vaddpd %ymm0, %ymm14, %ymm0
; AVX1OR2-NEXT:    vmulpd %ymm7, %ymm12, %ymm12
; AVX1OR2-NEXT:    vaddpd %ymm12, %ymm13, %ymm12
; AVX1OR2-NEXT:    vbroadcastsd 680(%rbp), %ymm13
; AVX1OR2-NEXT:    vmulpd %ymm13, %ymm15, %ymm14
; AVX1OR2-NEXT:    vaddpd %ymm14, %ymm12, %ymm12
; AVX1OR2-NEXT:    vmulpd %ymm13, %ymm9, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm0, %ymm13, %ymm0
; AVX1OR2-NEXT:    vbroadcastsd 688(%rbp), %ymm13
; AVX1OR2-NEXT:    vmovapd 16(%rbp), %ymm1
; AVX1OR2-NEXT:    vmulpd %ymm1, %ymm13, %ymm14
; AVX1OR2-NEXT:    vaddpd %ymm0, %ymm14, %ymm0
; AVX1OR2-NEXT:    vmulpd 48(%rbp), %ymm13, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm13, %ymm12, %ymm12
; AVX1OR2-NEXT:    vbroadcastsd 696(%rbp), %ymm13
; AVX1OR2-NEXT:    vmulpd 112(%rbp), %ymm13, %ymm14
; AVX1OR2-NEXT:    vaddpd %ymm14, %ymm12, %ymm12
; AVX1OR2-NEXT:    vmulpd 80(%rbp), %ymm13, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm0, %ymm13, %ymm0
; AVX1OR2-NEXT:    vbroadcastsd 704(%rbp), %ymm13
; AVX1OR2-NEXT:    vmovapd 144(%rbp), %ymm8
; AVX1OR2-NEXT:    vmulpd %ymm13, %ymm8, %ymm14
; AVX1OR2-NEXT:    vaddpd %ymm0, %ymm14, %ymm0
; AVX1OR2-NEXT:    vmovapd 176(%rbp), %ymm4
; AVX1OR2-NEXT:    vmulpd %ymm4, %ymm13, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm13, %ymm12, %ymm12
; AVX1OR2-NEXT:    vbroadcastsd 712(%rbp), %ymm13
; AVX1OR2-NEXT:    vmulpd %ymm13, %ymm11, %ymm14
; AVX1OR2-NEXT:    vaddpd %ymm14, %ymm12, %ymm12
; AVX1OR2-NEXT:    vmovapd 208(%rbp), %ymm14
; AVX1OR2-NEXT:    vmulpd %ymm13, %ymm14, %ymm13
; AVX1OR2-NEXT:    vaddpd %ymm0, %ymm13, %ymm0
; AVX1OR2-NEXT:    vbroadcastsd 720(%rbp), %ymm13
; AVX1OR2-NEXT:    vmulpd %ymm3, %ymm13, %ymm3
; AVX1OR2-NEXT:    vmulpd %ymm2, %ymm13, %ymm2
; AVX1OR2-NEXT:    vbroadcastsd 728(%rbp), %ymm13
; AVX1OR2-NEXT:    vmulpd %ymm6, %ymm13, %ymm4
; AVX1OR2-NEXT:    vaddpd %ymm4, %ymm3, %ymm3
; AVX1OR2-NEXT:    vmulpd %ymm5, %ymm13, %ymm4
...
; AVX1OR2-NEXT:    vmulpd %ymm4, %ymm15, %ymm5
; AVX1OR2-NEXT:    vaddpd %ymm5, %ymm3, %ymm3
; AVX1OR2-NEXT:    vmulpd %ymm4, %ymm9, %ymm4
; AVX1OR2-NEXT:    vaddpd %ymm4, %ymm2, %ymm2
; AVX1OR2-NEXT:    vbroadcastsd 752(%rbp), %ymm4
; AVX1OR2-NEXT:    vmulpd %ymm4, %ymm1, %ymm5
; AVX1OR2-NEXT:    vaddpd %ymm5, %ymm2, %ymm2
...
; AVX1OR2-NEXT:    vaddpd %ymm5, %ymm2, %ymm2
; AVX1OR2-NEXT:    vmulpd 176(%rbp), %ymm4, %ymm4
; AVX1OR2-NEXT:    vaddpd %ymm4, %ymm3, %ymm3
...
; AVX1OR2-NEXT:    vmovapd %ymm12, 416(%rdi)
