...
; SSE-NEXT:    movdqa {{.*#+}} xmm6 = [65535,65535,65535,0,65535,65535,65535,0]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm10 = xmm2[0,0,2,1]
...
; SSE-NEXT:    movdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    pshuflw {{.*#+}} xmm10 = xmm15[0,0,2,1,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm10 = xmm10[0,0,2,1]
; SSE-NEXT:    movdqa %xmm6, %xmm12
; SSE-NEXT:    pandn %xmm10, %xmm12
; SSE-NEXT:    pshuflw {{.*#+}} xmm10 = xmm3[0,1,1,3,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm10 = xmm10[0,0,2,1]
; SSE-NEXT:    pand %xmm6, %xmm10
; SSE-NEXT:    por %xmm12, %xmm10
; SSE-NEXT:    pshuflw {{.*#+}} xmm12 = xmm1[0,0,2,1,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm12 = xmm12[0,1,1,3]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm7 = xmm14[0,2,2,3,4,5,6,7]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm4 = xmm11[2,1,3,3,4,5,6,7]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm3 = xmm9[0,0,2,1,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm3 = xmm3[0,1,1,3]
; SSE-NEXT:    movdqa %xmm5, %xmm4
; SSE-NEXT:    pandn %xmm3, %xmm4
; SSE-NEXT:    pshufd {{.*#+}} xmm3 = xmm8[0,0,0,0]
; SSE-NEXT:    pshufhw {{.*#+}} xmm3 = xmm3[0,1,2,3,5,5,5,5]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm3 = xmm4[0,2,2,3,4,5,6,7]
; SSE-NEXT:    movdqa %xmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    pshufd {{.*#+}} xmm3 = xmm3[0,1,1,3]
...
; SSE-NEXT:    movdqa %xmm6, %xmm1
; SSE-NEXT:    pandn %xmm0, %xmm1
; SSE-NEXT:    pshufhw {{.*#+}} xmm0 = xmm7[0,1,2,3,4,5,5,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm0 = xmm0[0,2,2,3]
; SSE-NEXT:    pand %xmm6, %xmm0
; SSE-NEXT:    por %xmm1, %xmm0
...
; SSE-NEXT:    movdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm12 # 16-byte Reload
; SSE-NEXT:    pshufhw {{.*#+}} xmm2 = xmm12[0,1,2,3,6,5,7,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm2 = xmm2[0,2,2,3]
; SSE-NEXT:    pand %xmm6, %xmm2
...
; SSE-NEXT:    pshufd {{.*#+}} xmm7 = xmm11[3,3,3,3]
; SSE-NEXT:    pshufhw {{.*#+}} xmm7 = xmm7[0,1,2,3,5,5,5,5]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm8 = xmm11[2,2,2,2]
; SSE-NEXT:    pshufhw {{.*#+}} xmm8 = xmm8[0,1,2,3,5,5,5,5]
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm2 = xmm15[0,1,2,3,6,5,7,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm2 = xmm2[0,2,2,3]
; SSE-NEXT:    pand %xmm6, %xmm2
...
; SSE-NEXT:    por %xmm11, %xmm6
; SSE-NEXT:    pshufhw {{.*#+}} xmm2 = xmm13[0,1,2,3,4,4,6,5]
; SSE-NEXT:    pshufd {{.*#+}} xmm2 = xmm2[2,1,3,3]
...
; AVX-NEXT:    vmovdqa (%rax), %xmm13
; AVX-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm13[0],xmm0[0],xmm13[1],xmm0[1],xmm13[2],xmm0[2],xmm13[3],xmm0[3],xmm13[4],xmm0[4],xmm13[5],xmm0[5],xmm13[6],xmm0[6],xmm13[7],xmm0[7]
...
; AVX-NEXT:    vbroadcastsd {{.*#+}} ymm6 = [65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0]
...
; AVX-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm3[0,1,1,3,4,5,6,7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm8 = xmm3[2,1,3,3,4,5,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm8, %ymm5, %ymm5
; AVX-NEXT:    vshufps {{.*#+}} ymm5 = ymm5[0,0,2,1,4,4,6,5]
; AVX-NEXT:    vandps %ymm6, %ymm5, %ymm5
; AVX-NEXT:    vorps %ymm2, %ymm5, %ymm10
; AVX-NEXT:    vmovdqa (%rsi), %xmm0
; AVX-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vmovdqa (%rdi), %xmm2
; AVX-NEXT:    vmovdqa %xmm2, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vpunpcklbw {{.*#+}} xmm11 = xmm2[0],xmm0[0],xmm2[1],xmm0[1],xmm2[2],xmm0[2],xmm2[3],xmm0[3],xmm2[4],xmm0[4],xmm2[5],xmm0[5],xmm2[6],xmm0[6],xmm2[7],xmm0[7]
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm2 = xmm11[0],zero,zero,zero,xmm11[1],zero,zero,zero
; AVX-NEXT:    vpshufd {{.*#+}} xmm12 = xmm11[1,1,1,1]
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm12 = xmm12[0],zero,zero,zero,xmm12[1],zero,zero,zero
; AVX-NEXT:    vinsertf128 $1, %xmm12, %ymm2, %ymm12
; AVX-NEXT:    vmovdqa (%rcx), %xmm14
; AVX-NEXT:    vmovdqa (%rdx), %xmm0
; AVX-NEXT:    vpunpcklbw {{.*#+}} xmm15 = xmm0[0],xmm14[0],xmm0[1],xmm14[1],xmm0[2],xmm14[2],xmm0[3],xmm14[3],xmm0[4],xmm14[4],xmm0[5],xmm14[5],xmm0[6],xmm14[6],xmm0[7],xmm14[7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm15[0,0,2,1,4,5,6,7]
; AVX-NEXT:    vpmovzxdq {{.*#+}} xmm2 = xmm2[0],zero,xmm2[1],zero
; AVX-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm15[0,2,2,3,4,5,6,7]
; AVX-NEXT:    vpmovzxdq {{.*#+}} xmm5 = xmm5[0],zero,xmm5[1],zero
; AVX-NEXT:    vinsertf128 $1, %xmm5, %ymm2, %ymm5
; AVX-NEXT:    vbroadcastsd {{.*#+}} ymm4 = [65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535]
; AVX-NEXT:    vandps %ymm4, %ymm12, %ymm12
; AVX-NEXT:    vandnps %ymm5, %ymm4, %ymm5
; AVX-NEXT:    vorps %ymm5, %ymm12, %ymm5
; AVX-NEXT:    vblendps {{.*#+}} ymm2 = ymm5[0],ymm10[1],ymm5[2],ymm10[3],ymm5[4],ymm10[5],ymm5[6],ymm10[7]
...
; AVX-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm3[0,1,2,3,4,5,5,7]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm3[0,1,2,3,6,5,7,7]
; AVX-NEXT:    vinsertf128 $1, %xmm3, %ymm5, %ymm5
; AVX-NEXT:    vmovdqa 16(%r10), %xmm2
...
; AVX-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm15[0,1,2,3,4,4,6,5]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm15[0,1,2,3,4,6,6,7]
...
; AVX-NEXT:    vinsertf128 $1, %xmm11, %ymm1, %ymm11
; AVX-NEXT:    vmovdqa 16(%rax), %xmm8
; AVX-NEXT:    vshufps {{.*#+}} ymm10 = ymm10[2,1,3,3,6,5,7,7]
; AVX-NEXT:    vandnps %ymm10, %ymm4, %ymm10
; AVX-NEXT:    vandps %ymm4, %ymm11, %ymm11
; AVX-NEXT:    vorps %ymm10, %ymm11, %ymm10
; AVX-NEXT:    vmovdqa 16(%r9), %xmm3
; AVX-NEXT:    vmovdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm10[0],ymm5[1],ymm10[2],ymm5[3],ymm10[4],ymm5[5],ymm10[6],ymm5[7]
; AVX-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vpunpckhbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm13, %xmm1 # 16-byte Folded Reload
; AVX-NEXT:    # xmm1 = xmm13[8],mem[8],xmm13[9],mem[9],xmm13[10],mem[10],xmm13[11],mem[11],xmm13[12],mem[12],xmm13[13],mem[13],xmm13[14],mem[14],xmm13[15],mem[15]
; AVX-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm1[0,1,2,3,4,4,6,5]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm1[0,1,2,3,4,6,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm10, %ymm5, %ymm5
; AVX-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm9[8],xmm7[8],xmm9[9],xmm7[9],xmm9[10],xmm7[10],xmm9[11],xmm7[11],xmm9[12],xmm7[12],xmm9[13],xmm7[13],xmm9[14],xmm7[14],xmm9[15],xmm7[15]
; AVX-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm1[0,1,2,3,4,5,5,7]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm1[0,1,2,3,6,5,7,7]
...
; AVX-NEXT:    vmovaps %ymm6, %ymm1
; AVX-NEXT:    vorps %ymm5, %ymm9, %ymm5
; AVX-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm0[8],xmm14[8],xmm0[9],xmm14[9],xmm0[10],xmm14[10],xmm0[11],xmm14[11],xmm0[12],xmm14[12],xmm0[13],xmm14[13],xmm0[14],xmm14[14],xmm0[15],xmm14[15]
; AVX-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm0[0,1,2,3,4,4,6,5]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm0[0,1,2,3,4,6,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm10, %ymm9, %ymm9
; AVX-NEXT:    vshufps {{.*#+}} ymm9 = ymm9[2,1,3,3,6,5,7,7]
; AVX-NEXT:    vandnps %ymm9, %ymm4, %ymm9
...
; AVX-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vpshufd {{.*#+}} xmm10 = xmm0[2,3,2,3]
...
; AVX-NEXT:    vandps %ymm4, %ymm10, %ymm10
; AVX-NEXT:    vorps %ymm9, %ymm10, %ymm9
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm9[0],ymm5[1],ymm9[2],ymm5[3],ymm9[4],ymm5[5],ymm9[6],ymm5[7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vpunpcklbw {{.*#+}} xmm11 = xmm8[0],xmm2[0],xmm8[1],xmm2[1],xmm8[2],xmm2[2],xmm8[3],xmm2[3],xmm8[4],xmm2[4],xmm8[5],xmm2[5],xmm8[6],xmm2[6],xmm8[7],xmm2[7]
; AVX-NEXT:    vmovdqa %xmm2, %xmm6
; AVX-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm11[0,1,2,3,4,4,6,5]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm11[0,1,2,3,4,6,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm10, %ymm9, %ymm9
; AVX-NEXT:    vpunpcklbw {{.*#+}} xmm12 = xmm13[0],xmm3[0],xmm13[1],xmm3[1],xmm13[2],xmm3[2],xmm13[3],xmm3[3],xmm13[4],xmm3[4],xmm13[5],xmm3[5],xmm13[6],xmm3[6],xmm13[7],xmm3[7]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm12[0,1,2,3,4,5,5,7]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm14 = xmm12[0,1,2,3,6,5,7,7]
...
; AVX-NEXT:    vpunpcklbw {{.*#+}} xmm10 = xmm0[0],xmm3[0],xmm0[1],xmm3[1],xmm0[2],xmm3[2],xmm0[3],xmm3[3],xmm0[4],xmm3[4],xmm0[5],xmm3[5],xmm0[6],xmm3[6],xmm0[7],xmm3[7]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm14 = xmm10[0,1,2,3,4,4,6,5]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm10[0,1,2,3,4,6,6,7]
...
; AVX-NEXT:    vpshufd {{.*#+}} xmm7 = xmm14[2,3,2,3]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm9 = ymm5[0],ymm9[1],ymm5[2],ymm9[3],ymm5[4],ymm9[5],ymm5[6],ymm9[7]
; AVX-NEXT:    vpunpckhbw {{.*#+}} xmm5 = xmm8[8],xmm6[8],xmm8[9],xmm6[9],xmm8[10],xmm6[10],xmm8[11],xmm6[11],xmm8[12],xmm6[12],xmm8[13],xmm6[13],xmm8[14],xmm6[14],xmm8[15],xmm6[15]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm7 = xmm5[0,1,2,3,4,4,6,5]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm5[0,1,2,3,4,6,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm8, %ymm7, %ymm7
; AVX-NEXT:    vpunpckhbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm13, %xmm8 # 16-byte Folded Reload
; AVX-NEXT:    # xmm8 = xmm13[8],mem[8],xmm13[9],mem[9],xmm13[10],mem[10],xmm13[11],mem[11],xmm13[12],mem[12],xmm13[13],mem[13],xmm13[14],mem[14],xmm13[15],mem[15]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm13 = xmm8[0,1,2,3,4,5,5,7]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm15 = xmm8[0,1,2,3,6,5,7,7]
; AVX-NEXT:    vinsertf128 $1, %xmm15, %ymm13, %ymm13
; AVX-NEXT:    vshufps {{.*#+}} ymm7 = ymm7[0,2,2,3,4,6,6,7]
; AVX-NEXT:    vbroadcastsd {{.*#+}} ymm6 = [65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0]
; AVX-NEXT:    vandnps %ymm7, %ymm6, %ymm7
...
; AVX-NEXT:    vpshufhw {{.*#+}} xmm13 = xmm0[0,1,2,3,4,6,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm13, %ymm3, %ymm3
; AVX-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm1[8],xmm2[8],xmm1[9],xmm2[9],xmm1[10],xmm2[10],xmm1[11],xmm2[11],xmm1[12],xmm2[12],xmm1[13],xmm2[13],xmm1[14],xmm2[14],xmm1[15],xmm2[15]
; AVX-NEXT:    vpshufd {{.*#+}} xmm2 = xmm1[2,3,2,3]
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm2 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero
; AVX-NEXT:    vpshufd {{.*#+}} xmm13 = xmm1[3,3,3,3]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm13 = ymm2[0],ymm7[1],ymm2[2],ymm7[3],ymm2[4],ymm7[5],ymm2[6],ymm7[7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm5[0,0,2,1,4,5,6,7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm5[0,2,2,3,4,5,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm3, %ymm2, %ymm2
; AVX-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm8[0,1,1,3,4,5,6,7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm8[2,1,3,3,4,5,6,7]
...
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm3 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero
...
; AVX-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm11[0,0,2,1,4,5,6,7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm11[0,2,2,3,4,5,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm1, %ymm1
; AVX-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm12[0,1,1,3,4,5,6,7]
...
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm2 = xmm14[0],zero,zero,zero,xmm14[1],zero,zero,zero
; AVX-NEXT:    vpshufd {{.*#+}} xmm3 = xmm14[1,1,1,1]
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm3 = xmm3[0],zero,zero,zero,xmm3[1],zero,zero,zero
; AVX-NEXT:    vinsertf128 $1, %xmm3, %ymm2, %ymm2
; AVX-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm10[0,0,2,1,4,5,6,7]
; AVX-NEXT:    vpmovzxdq {{.*#+}} xmm3 = xmm3[0],zero,xmm3[1],zero
...
; AVX-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm5[0,1,1,3,4,5,6,7]
...
; AVX-NEXT:    vandnps %ymm5, %ymm4, %ymm4
...
; AVX2-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX2-NEXT:    movq {{[0-9]+}}(%rsp), %r10
; AVX2-NEXT:    vmovdqa (%r10), %xmm12
; AVX2-NEXT:    vmovdqa (%rax), %xmm4
; AVX2-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm4[0],xmm12[0],xmm4[1],xmm12[1],xmm4[2],xmm12[2],xmm4[3],xmm12[3],xmm4[4],xmm12[4],xmm4[5],xmm12[5],xmm4[6],xmm12[6],xmm4[7],xmm12[7]
...
; AVX2-NEXT:    vpunpcklbw {{.*#+}} xmm8 = xmm3[0],xmm6[0],xmm3[1],xmm6[1],xmm3[2],xmm6[2],xmm3[3],xmm6[3],xmm3[4],xmm6[4],xmm3[5],xmm6[5],xmm3[6],xmm6[6],xmm3[7],xmm6[7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm8[0,1,1,3,4,5,6,7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm8[2,1,3,3,4,5,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm7, %ymm5, %ymm5
; AVX2-NEXT:    vpblendw {{.*#+}} ymm10 = ymm5[0],ymm1[1],ymm5[2],ymm1[3],ymm5[4,5,6,7,8],ymm1[9],ymm5[10],ymm1[11],ymm5[12,13,14,15]
; AVX2-NEXT:    vmovdqa (%rsi), %xmm5
; AVX2-NEXT:    vmovdqa (%rdi), %xmm7
; AVX2-NEXT:    vpunpcklbw {{.*#+}} xmm11 = xmm7[0],xmm5[0],xmm7[1],xmm5[1],xmm7[2],xmm5[2],xmm7[3],xmm5[3],xmm7[4],xmm5[4],xmm7[5],xmm5[5],xmm7[6],xmm5[6],xmm7[7],xmm5[7]
; AVX2-NEXT:    vpmovzxwq {{.*#+}} ymm9 = xmm11[0],zero,zero,zero,xmm11[1],zero,zero,zero,xmm11[2],zero,zero,zero,xmm11[3],zero,zero,zero
; AVX2-NEXT:    vmovdqa (%rcx), %xmm13
; AVX2-NEXT:    vmovdqa (%rdx), %xmm0
; AVX2-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm0[0],xmm13[0],xmm0[1],xmm13[1],xmm0[2],xmm13[2],xmm0[3],xmm13[3],xmm0[4],xmm13[4],xmm0[5],xmm13[5],xmm0[6],xmm13[6],xmm0[7],xmm13[7]
; AVX2-NEXT:    vpshufb {{.*#+}} xmm14 = xmm1[0,1,0,1,4,5,2,3,0,1,4,5,4,5,6,7]
; AVX2-NEXT:    vpmovzxdq {{.*#+}} ymm14 = xmm14[0],zero,xmm14[1],zero,xmm14[2],zero,xmm14[3],zero
; AVX2-NEXT:    vpblendw {{.*#+}} ymm14 = ymm9[0],ymm14[1],ymm9[2,3,4],ymm14[5],ymm9[6,7,8],ymm14[9],ymm9[10,11,12],ymm14[13],ymm9[14,15]
; AVX2-NEXT:    vmovaps 16(%r10), %xmm9
; AVX2-NEXT:    vmovaps %xmm9, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-NEXT:    vpshufd {{.*#+}} ymm10 = ymm10[0,0,2,1,4,4,6,5]
; AVX2-NEXT:    vpblendd {{.*#+}} ymm9 = ymm14[0],ymm10[1],ymm14[2],ymm10[3],ymm14[4],ymm10[5],ymm14[6],ymm10[7]
; AVX2-NEXT:    vmovdqu %ymm9, (%rsp) # 32-byte Spill
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm2[0,1,2,3,4,4,6,5]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,4,6,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm2, %ymm10, %ymm10
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm8[0,1,2,3,4,5,5,7]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm8[0,1,2,3,6,5,7,7]
; AVX2-NEXT:    vinserti128 $1, %xmm8, %ymm2, %ymm8
; AVX2-NEXT:    vmovdqa 16(%rax), %xmm9
; AVX2-NEXT:    vpblendw {{.*#+}} ymm8 = ymm8[0,1,2,3,4],ymm10[5],ymm8[6],ymm10[7],ymm8[8,9,10,11,12],ymm10[13],ymm8[14],ymm10[15]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm1[0,1,2,3,4,4,6,5]
...
; AVX2-NEXT:    vpshufd {{.*#+}} xmm10 = xmm11[2,3,2,3]
; AVX2-NEXT:    vpmovzxwq {{.*#+}} ymm10 = xmm10[0],zero,zero,zero,xmm10[1],zero,zero,zero,xmm10[2],zero,zero,zero,xmm10[3],zero,zero,zero
; AVX2-NEXT:    vpblendw {{.*#+}} ymm1 = ymm10[0],ymm1[1],ymm10[2,3,4],ymm1[5],ymm10[6,7,8],ymm1[9],ymm10[10,11,12],ymm1[13],ymm10[14,15]
; AVX2-NEXT:    vmovdqa 16(%r8), %xmm15
; AVX2-NEXT:    vpshufd {{.*#+}} ymm8 = ymm8[0,2,2,3,4,6,6,7]
; AVX2-NEXT:    vpblendd {{.*#+}} ymm1 = ymm1[0],ymm8[1],ymm1[2],ymm8[3],ymm1[4],ymm8[5],ymm1[6],ymm8[7]
; AVX2-NEXT:    vmovdqu %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm4[8],xmm12[8],xmm4[9],xmm12[9],xmm4[10],xmm12[10],xmm4[11],xmm12[11],xmm4[12],xmm12[12],xmm4[13],xmm12[13],xmm4[14],xmm12[14],xmm4[15],xmm12[15]
; AVX2-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm1[0,1,2,3,4,4,6,5]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm1[0,1,2,3,4,6,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm8, %ymm4, %ymm8
; AVX2-NEXT:    vpunpckhbw {{.*#+}} xmm4 = xmm3[8],xmm6[8],xmm3[9],xmm6[9],xmm3[10],xmm6[10],xmm3[11],xmm6[11],xmm3[12],xmm6[12],xmm3[13],xmm6[13],xmm3[14],xmm6[14],xmm3[15],xmm6[15]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm4[0,1,2,3,4,5,5,7]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm6 = xmm4[0,1,2,3,6,5,7,7]
; AVX2-NEXT:    vinserti128 $1, %xmm6, %ymm3, %ymm3
; AVX2-NEXT:    vpblendw {{.*#+}} ymm3 = ymm3[0,1,2,3,4],ymm8[5],ymm3[6],ymm8[7],ymm3[8,9,10,11,12],ymm8[13],ymm3[14],ymm8[15]
; AVX2-NEXT:    vpshufd {{.*#+}} ymm3 = ymm3[0,2,2,3,4,6,6,7]
; AVX2-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm0[8],xmm13[8],xmm0[9],xmm13[9],xmm0[10],xmm13[10],xmm0[11],xmm13[11],xmm0[12],xmm13[12],xmm0[13],xmm13[13],xmm0[14],xmm13[14],xmm0[15],xmm13[15]
; AVX2-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX2-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm7[8],xmm5[8],xmm7[9],xmm5[9],xmm7[10],xmm5[10],xmm7[11],xmm5[11],xmm7[12],xmm5[12],xmm7[13],xmm5[13],xmm7[14],xmm5[14],xmm7[15],xmm5[15]
; AVX2-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX2-NEXT:    vpblendw {{.*#+}} ymm0 = ymm5[0],ymm0[1],ymm5[2,3,4],ymm0[5],ymm5[6,7,8],ymm0[9],ymm5[10,11,12],ymm0[13],ymm5[14,15]
; AVX2-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0],ymm3[1],ymm0[2],ymm3[3],ymm0[4],ymm3[5],ymm0[6],ymm3[7]
; AVX2-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm2 # 16-byte Reload
; AVX2-NEXT:    vpunpcklbw {{.*#+}} xmm10 = xmm9[0],xmm2[0],xmm9[1],xmm2[1],xmm9[2],xmm2[2],xmm9[3],xmm2[3],xmm9[4],xmm2[4],xmm9[5],xmm2[5],xmm9[6],xmm2[6],xmm9[7],xmm2[7]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm10[0,1,2,3,4,4,6,5]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm10[0,1,2,3,4,6,6,7]
...
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm11[0,1,2,3,4,5,5,7]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm11[0,1,2,3,6,5,7,7]
; AVX2-NEXT:    vinserti128 $1, %xmm8, %ymm3, %ymm3
; AVX2-NEXT:    vpblendw {{.*#+}} ymm3 = ymm3[0,1,2,3,4],ymm0[5],ymm3[6],ymm0[7],ymm3[8,9,10,11,12],ymm0[13],ymm3[14],ymm0[15]
; AVX2-NEXT:    vmovdqa 16(%rcx), %xmm12
; AVX2-NEXT:    vmovdqa 16(%rdx), %xmm8
; AVX2-NEXT:    vpunpcklbw {{.*#+}} xmm13 = xmm8[0],xmm12[0],xmm8[1],xmm12[1],xmm8[2],xmm12[2],xmm8[3],xmm12[3],xmm8[4],xmm12[4],xmm8[5],xmm12[5],xmm8[6],xmm12[6],xmm8[7],xmm12[7]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm13[0,1,2,3,4,4,6,5]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm13[0,1,2,3,4,6,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm5, %ymm0, %ymm0
; AVX2-NEXT:    vpshufd {{.*#+}} ymm5 = ymm0[2,1,3,3,6,5,7,7]
; AVX2-NEXT:    vmovdqa 16(%rsi), %xmm1
; AVX2-NEXT:    vmovdqa 16(%rdi), %xmm0
; AVX2-NEXT:    vpunpcklbw {{.*#+}} xmm6 = xmm0[0],xmm1[0],xmm0[1],xmm1[1],xmm0[2],xmm1[2],xmm0[3],xmm1[3],xmm0[4],xmm1[4],xmm0[5],xmm1[5],xmm0[6],xmm1[6],xmm0[7],xmm1[7]
...
; AVX2-NEXT:    vpunpckhbw {{.*#+}} xmm5 = xmm9[8],xmm2[8],xmm9[9],xmm2[9],xmm9[10],xmm2[10],xmm9[11],xmm2[11],xmm9[12],xmm2[12],xmm9[13],xmm2[13],xmm9[14],xmm2[14],xmm9[15],xmm2[15]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm7 = xmm5[0,1,2,3,4,4,6,5]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm5[0,1,2,3,4,6,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm9, %ymm7, %ymm7
; AVX2-NEXT:    vpunpckhbw {{.*#+}} xmm14 = xmm15[8],xmm14[8],xmm15[9],xmm14[9],xmm15[10],xmm14[10],xmm15[11],xmm14[11],xmm15[12],xmm14[12],xmm15[13],xmm14[13],xmm15[14],xmm14[14],xmm15[15],xmm14[15]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm14[0,1,2,3,4,5,5,7]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm15 = xmm14[0,1,2,3,6,5,7,7]
; AVX2-NEXT:    vinserti128 $1, %xmm15, %ymm9, %ymm9
; AVX2-NEXT:    vpblendw {{.*#+}} ymm7 = ymm9[0,1,2,3,4],ymm7[5],ymm9[6],ymm7[7],ymm9[8,9,10,11,12],ymm7[13],ymm9[14],ymm7[15]
; AVX2-NEXT:    vpunpckhbw {{.*#+}} xmm8 = xmm8[8],xmm12[8],xmm8[9],xmm12[9],xmm8[10],xmm12[10],xmm8[11],xmm12[11],xmm8[12],xmm12[12],xmm8[13],xmm12[13],xmm8[14],xmm12[14],xmm8[15],xmm12[15]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm8[0,1,2,3,4,4,6,5]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm12 = xmm8[0,1,2,3,4,6,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm12, %ymm9, %ymm9
...
; AVX2-NEXT:    vpshufd {{.*#+}} ymm1 = ymm9[2,1,3,3,6,5,7,7]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm9 = xmm0[2,3,2,3]
; AVX2-NEXT:    vpmovzxwq {{.*#+}} ymm9 = xmm9[0],zero,zero,zero,xmm9[1],zero,zero,zero,xmm9[2],zero,zero,zero,xmm9[3],zero,zero,zero
; AVX2-NEXT:    vpblendw {{.*#+}} ymm1 = ymm9[0],ymm1[1],ymm9[2,3,4],ymm1[5],ymm9[6,7,8],ymm1[9],ymm9[10,11,12],ymm1[13],ymm9[14,15]
; AVX2-NEXT:    vpshufd {{.*#+}} ymm7 = ymm7[0,2,2,3,4,6,6,7]
; AVX2-NEXT:    vpblendd {{.*#+}} ymm9 = ymm1[0],ymm7[1],ymm1[2],ymm7[3],ymm1[4],ymm7[5],ymm1[6],ymm7[7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm5[0,0,2,1,4,5,6,7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm5[0,2,2,3,4,5,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm5, %ymm1, %ymm1
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm14[0,1,1,3,4,5,6,7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm14[2,1,3,3,4,5,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm7, %ymm5, %ymm5
...
; AVX2-NEXT:    vmovdqa {{.*#+}} xmm12 = [0,1,0,1,4,5,2,3,0,1,4,5,4,5,6,7]
; AVX2-NEXT:    vpshufb %xmm12, %xmm8, %xmm5
; AVX2-NEXT:    vpmovzxdq {{.*#+}} ymm5 = xmm5[0],zero,xmm5[1],zero,xmm5[2],zero,xmm5[3],zero
; AVX2-NEXT:    vpblendw {{.*#+}} ymm0 = ymm0[0],ymm5[1],ymm0[2,3,4],ymm5[5],ymm0[6,7,8],ymm5[9],ymm0[10,11,12],ymm5[13],ymm0[14,15]
; AVX2-NEXT:    vpshufd {{.*#+}} ymm1 = ymm1[0,0,2,1,4,4,6,5]
; AVX2-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0],ymm1[1],ymm0[2],ymm1[3],ymm0[4],ymm1[5],ymm0[6],ymm1[7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm10[0,0,2,1,4,5,6,7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm10[0,2,2,3,4,5,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm5, %ymm1, %ymm1
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm11[0,1,1,3,4,5,6,7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm11[2,1,3,3,4,5,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm7, %ymm5, %ymm5
; AVX2-NEXT:    vpblendw {{.*#+}} ymm1 = ymm5[0],ymm1[1],ymm5[2],ymm1[3],ymm5[4,5,6,7,8],ymm1[9],ymm5[10],ymm1[11],ymm5[12,13,14,15]
; AVX2-NEXT:    vpmovzxwq {{.*#+}} ymm5 = xmm6[0],zero,zero,zero,xmm6[1],zero,zero,zero,xmm6[2],zero,zero,zero,xmm6[3],zero,zero,zero
; AVX2-NEXT:    vpshufb %xmm12, %xmm13, %xmm6
; AVX2-NEXT:    vpmovzxdq {{.*#+}} ymm6 = xmm6[0],zero,xmm6[1],zero,xmm6[2],zero,xmm6[3],zero
; AVX2-NEXT:    vpblendw {{.*#+}} ymm5 = ymm5[0],ymm6[1],ymm5[2,3,4],ymm6[5],ymm5[6,7,8],ymm6[9],ymm5[10,11,12],ymm6[13],ymm5[14,15]
; AVX2-NEXT:    vpshufd {{.*#+}} ymm1 = ymm1[0,0,2,1,4,4,6,5]
; AVX2-NEXT:    vpblendd {{.*#+}} ymm1 = ymm5[0],ymm1[1],ymm5[2],ymm1[3],ymm5[4],ymm1[5],ymm5[6],ymm1[7]
; AVX2-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm2 # 16-byte Reload
...
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm4[2,1,3,3,4,5,6,7]
...
; AVX2-NEXT:    vpshufb %xmm12, %xmm4, %xmm4
...
; AVX2-NEXT:    vmovdqa %ymm9, 224(%rax)
...
; AVX2-FP-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX2-FP-NEXT:    movq {{[0-9]+}}(%rsp), %r10
; AVX2-FP-NEXT:    vmovdqa (%r10), %xmm14
; AVX2-FP-NEXT:    vmovdqa (%rax), %xmm6
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm6[0],xmm14[0],xmm6[1],xmm14[1],xmm6[2],xmm14[2],xmm6[3],xmm14[3],xmm6[4],xmm14[4],xmm6[5],xmm14[5],xmm6[6],xmm14[6],xmm6[7],xmm14[7]
...
; AVX2-FP-NEXT:    vmovdqa (%r8), %xmm2
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm2[0],xmm5[0],xmm2[1],xmm5[1],xmm2[2],xmm5[2],xmm2[3],xmm5[3],xmm2[4],xmm5[4],xmm2[5],xmm5[5],xmm2[6],xmm5[6],xmm2[7],xmm5[7]
...
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm13 = ymm4[0,1,2],ymm3[3],ymm4[4,5,6],ymm3[7],ymm4[8,9,10],ymm3[11],ymm4[12,13,14],ymm3[15]
; AVX2-FP-NEXT:    vmovdqa (%rcx), %xmm7
; AVX2-FP-NEXT:    vmovdqa (%rsi), %xmm15
; AVX2-FP-NEXT:    vmovdqa (%rdi), %xmm1
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm12 = xmm1[0],xmm15[0],xmm1[1],xmm15[1],xmm1[2],xmm15[2],xmm1[3],xmm15[3],xmm1[4],xmm15[4],xmm1[5],xmm15[5],xmm1[6],xmm15[6],xmm1[7],xmm15[7]
; AVX2-FP-NEXT:    vpshufb {{.*#+}} xmm4 = xmm12[4,5,u,u,u,u,u,u,6,7,u,u,u,u,u,u]
; AVX2-FP-NEXT:    vpmovzxwq {{.*#+}} xmm11 = xmm12[0],zero,zero,zero,xmm12[1],zero,zero,zero
; AVX2-FP-NEXT:    vinserti128 $1, %xmm4, %ymm11, %ymm11
; AVX2-FP-NEXT:    vmovdqa (%rdx), %xmm10
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm10[0],xmm7[0],xmm10[1],xmm7[1],xmm10[2],xmm7[2],xmm10[3],xmm7[3],xmm10[4],xmm7[4],xmm10[5],xmm7[5],xmm10[6],xmm7[6],xmm10[7],xmm7[7]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm4, %ymm4, %ymm0
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm3 = ymm0[0,1,0,1,4,5,2,3,4,5,2,3,12,13,14,15,16,17,20,21,20,21,22,23,20,21,22,23,28,29,30,31]
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm3 = ymm11[0],ymm3[1],ymm11[2,3,4],ymm3[5],ymm11[6,7,8],ymm3[9],ymm11[10,11,12],ymm3[13],ymm11[14,15]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm3 = ymm3[0],ymm13[1],ymm3[2],ymm13[3],ymm3[4],ymm13[5],ymm3[6],ymm13[7]
; AVX2-FP-NEXT:    vmovdqu %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm13 = [0,1,2,3,8,9,8,9,8,9,8,9,12,13,10,11,0,1,2,3,8,9,12,13,8,9,12,13,12,13,14,15]
; AVX2-FP-NEXT:    vpshufb %ymm13, %ymm8, %ymm8
...
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm3 = [8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,8,9,12,13,4,5,6,7,12,13,14,15,12,13,14,15]
...
; AVX2-FP-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm6[8],xmm14[8],xmm6[9],xmm14[9],xmm6[10],xmm14[10],xmm6[11],xmm14[11],xmm6[12],xmm14[12],xmm6[13],xmm14[13],xmm6[14],xmm14[14],xmm6[15],xmm14[15]
...
; AVX2-FP-NEXT:    vmovdqa %ymm11, %ymm8
; AVX2-FP-NEXT:    vpshufb %ymm11, %ymm2, %ymm2
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm2[0,1,2],ymm0[3],ymm2[4,5,6],ymm0[7],ymm2[8,9,10],ymm0[11],ymm2[12,13,14],ymm0[15]
; AVX2-FP-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm10[8],xmm7[8],xmm10[9],xmm7[9],xmm10[10],xmm7[10],xmm10[11],xmm7[11],xmm10[12],xmm7[12],xmm10[13],xmm7[13],xmm10[14],xmm7[14],xmm10[15],xmm7[15]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; AVX2-FP-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpunpckhbw {{.*#+}} xmm10 = xmm1[8],xmm15[8],xmm1[9],xmm15[9],xmm1[10],xmm15[10],xmm1[11],xmm15[11],xmm1[12],xmm15[12],xmm1[13],xmm15[13],xmm1[14],xmm15[14],xmm1[15],xmm15[15]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm10, %ymm10, %ymm1
...
; AVX2-FP-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovdqa 16(%r10), %xmm7
; AVX2-FP-NEXT:    vmovdqa 16(%rax), %xmm14
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm14[0],xmm7[0],xmm14[1],xmm7[1],xmm14[2],xmm7[2],xmm14[3],xmm7[3],xmm14[4],xmm7[4],xmm14[5],xmm7[5],xmm14[6],xmm7[6],xmm14[7],xmm7[7]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm11
; AVX2-FP-NEXT:    vmovdqa 16(%r9), %xmm6
; AVX2-FP-NEXT:    vmovdqa 16(%r8), %xmm5
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm5[0],xmm6[0],xmm5[1],xmm6[1],xmm5[2],xmm6[2],xmm5[3],xmm6[3],xmm5[4],xmm6[4],xmm5[5],xmm6[5],xmm5[6],xmm6[6],xmm5[7],xmm6[7]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm9
; AVX2-FP-NEXT:    vpshufb %ymm13, %ymm11, %ymm2
; AVX2-FP-NEXT:    vpshufb %ymm8, %ymm9, %ymm15
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm15 = ymm15[0,1,2],ymm2[3],ymm15[4,5,6],ymm2[7],ymm15[8,9,10],ymm2[11],ymm15[12,13,14],ymm2[15]
; AVX2-FP-NEXT:    vmovdqa 16(%rcx), %xmm4
; AVX2-FP-NEXT:    vmovdqa 16(%rdx), %xmm3
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm3[0],xmm4[0],xmm3[1],xmm4[1],xmm3[2],xmm4[2],xmm3[3],xmm4[3],xmm3[4],xmm4[4],xmm3[5],xmm4[5],xmm3[6],xmm4[6],xmm3[7],xmm4[7]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm8
; AVX2-FP-NEXT:    vmovdqa 16(%rsi), %xmm1
; AVX2-FP-NEXT:    vmovdqa 16(%rdi), %xmm0
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm0[0],xmm1[0],xmm0[1],xmm1[1],xmm0[2],xmm1[2],xmm0[3],xmm1[3],xmm0[4],xmm1[4],xmm0[5],xmm1[5],xmm0[6],xmm1[6],xmm0[7],xmm1[7]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm13
; AVX2-FP-NEXT:    vpshufb %ymm12, %ymm13, %ymm13
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm12 = ymm8[8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,24,25,28,29,20,21,22,23,28,29,30,31,28,29,30,31]
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm12 = ymm13[0],ymm12[1],ymm13[2,3,4],ymm12[5],ymm13[6,7,8],ymm12[9],ymm13[10,11,12],ymm12[13],ymm13[14,15]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm15 = ymm12[0],ymm15[1],ymm12[2],ymm15[3],ymm12[4],ymm15[5],ymm12[6],ymm15[7]
; AVX2-FP-NEXT:    vpunpckhbw {{.*#+}} xmm7 = xmm14[8],xmm7[8],xmm14[9],xmm7[9],xmm14[10],xmm7[10],xmm14[11],xmm7[11],xmm14[12],xmm7[12],xmm14[13],xmm7[13],xmm14[14],xmm7[14],xmm14[15],xmm7[15]
; AVX2-FP-NEXT:    vpunpckhbw {{.*#+}} xmm5 = xmm5[8],xmm6[8],xmm5[9],xmm6[9],xmm5[10],xmm6[10],xmm5[11],xmm6[11],xmm5[12],xmm6[12],xmm5[13],xmm6[13],xmm5[14],xmm6[14],xmm5[15],xmm6[15]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm7, %ymm7, %ymm6
...
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm12 = ymm5[0,1,2,3,8,9,10,11,8,9,10,11,10,11,14,15,16,17,18,19,28,29,26,27,28,29,26,27,30,31,30,31]
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm7 = ymm12[0,1,2],ymm7[3],ymm12[4,5,6],ymm7[7],ymm12[8,9,10],ymm7[11],ymm12[12,13,14],ymm7[15]
...
; AVX2-FP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm1
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm1 = ymm1[8,9,u,u,u,u,u,u,10,11,u,u,u,u,u,u,28,29,u,u,u,u,u,u,30,31,u,u,u,u,u,u]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm3, %ymm3, %ymm3
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm4 = ymm3[8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,24,25,28,29,20,21,22,23,28,29,30,31,28,29,30,31]
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm1 = ymm1[0],ymm4[1],ymm1[2,3,4],ymm4[5],ymm1[6,7,8],ymm4[9],ymm1[10,11,12],ymm4[13],ymm1[14,15]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm1 = ymm1[0],ymm7[1],ymm1[2],ymm7[3],ymm1[4],ymm7[5],ymm1[6],ymm7[7]
...
; AVX2-FP-NEXT:    vpmovsxwq {{.*#+}} xmm12 = [1284,1798]
; AVX2-FP-NEXT:    vpshufb %xmm12, %xmm0, %xmm5
; AVX2-FP-NEXT:    vpmovzxwq {{.*#+}} xmm0 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; AVX2-FP-NEXT:    vinserti128 $1, %xmm5, %ymm0, %ymm0
...
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm0[0],ymm3[1],ymm0[2,3,4],ymm3[5],ymm0[6,7,8],ymm3[9],ymm0[10,11,12],ymm3[13],ymm0[14,15]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0],ymm4[1],ymm0[2],ymm4[3],ymm0[4],ymm4[5],ymm0[6],ymm4[7]
; AVX2-FP-NEXT:    vpshufb %ymm7, %ymm11, %ymm3
; AVX2-FP-NEXT:    vpshufb %ymm6, %ymm9, %ymm4
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm3 = ymm4[0,1,2],ymm3[3],ymm4[4,5,6],ymm3[7],ymm4[8,9,10],ymm3[11],ymm4[12,13,14],ymm3[15]
; AVX2-FP-NEXT:    vpshufb %xmm12, %xmm2, %xmm4
; AVX2-FP-NEXT:    vpmovzxwq {{.*#+}} xmm2 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero
; AVX2-FP-NEXT:    vinserti128 $1, %xmm4, %ymm2, %ymm2
; AVX2-FP-NEXT:    vpshufb %ymm5, %ymm8, %ymm4
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm2 = ymm2[0],ymm4[1],ymm2[2,3,4],ymm4[5],ymm2[6,7,8],ymm4[9],ymm2[10,11,12],ymm4[13],ymm2[14,15]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm2 = ymm2[0],ymm3[1],ymm2[2],ymm3[3],ymm2[4],ymm3[5],ymm2[6],ymm3[7]
...
; AVX2-FP-NEXT:    vpshufb %xmm12, %xmm10, %xmm5
; AVX2-FP-NEXT:    vpmovzxwq {{.*#+}} xmm6 = xmm10[0],zero,zero,zero,xmm10[1],zero,zero,zero
...
; AVX2-FCP-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX2-FCP-NEXT:    movq {{[0-9]+}}(%rsp), %r10
; AVX2-FCP-NEXT:    vmovdqa (%r10), %xmm14
; AVX2-FCP-NEXT:    vmovdqa (%rax), %xmm6
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm6[0],xmm14[0],xmm6[1],xmm14[1],xmm6[2],xmm14[2],xmm6[3],xmm14[3],xmm6[4],xmm14[4],xmm6[5],xmm14[5],xmm6[6],xmm14[6],xmm6[7],xmm14[7]
...
; AVX2-FCP-NEXT:    vmovdqa (%r9), %xmm5
; AVX2-FCP-NEXT:    vmovdqa (%r8), %xmm2
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm2[0],xmm5[0],xmm2[1],xmm5[1],xmm2[2],xmm5[2],xmm2[3],xmm5[3],xmm2[4],xmm5[4],xmm2[5],xmm5[5],xmm2[6],xmm5[6],xmm2[7],xmm5[7]
...
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm13 = ymm4[0,1,2],ymm3[3],ymm4[4,5,6],ymm3[7],ymm4[8,9,10],ymm3[11],ymm4[12,13,14],ymm3[15]
; AVX2-FCP-NEXT:    vmovdqa (%rcx), %xmm7
; AVX2-FCP-NEXT:    vmovdqa (%rsi), %xmm15
; AVX2-FCP-NEXT:    vmovdqa (%rdi), %xmm1
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm12 = xmm1[0],xmm15[0],xmm1[1],xmm15[1],xmm1[2],xmm15[2],xmm1[3],xmm15[3],xmm1[4],xmm15[4],xmm1[5],xmm15[5],xmm1[6],xmm15[6],xmm1[7],xmm15[7]
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} xmm4 = xmm12[4,5,u,u,u,u,u,u,6,7,u,u,u,u,u,u]
; AVX2-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm11 = xmm12[0],zero,zero,zero,xmm12[1],zero,zero,zero
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm4, %ymm11, %ymm11
; AVX2-FCP-NEXT:    vmovdqa (%rdx), %xmm10
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm10[0],xmm7[0],xmm10[1],xmm7[1],xmm10[2],xmm7[2],xmm10[3],xmm7[3],xmm10[4],xmm7[4],xmm10[5],xmm7[5],xmm10[6],xmm7[6],xmm10[7],xmm7[7]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm4, %ymm4, %ymm0
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm3 = ymm0[0,1,0,1,4,5,2,3,4,5,2,3,12,13,14,15,16,17,20,21,20,21,22,23,20,21,22,23,28,29,30,31]
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm3 = ymm11[0],ymm3[1],ymm11[2,3,4],ymm3[5],ymm11[6,7,8],ymm3[9],ymm11[10,11,12],ymm3[13],ymm11[14,15]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm3 = ymm3[0],ymm13[1],ymm3[2],ymm13[3],ymm3[4],ymm13[5],ymm3[6],ymm13[7]
; AVX2-FCP-NEXT:    vmovdqu %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm13 = [0,1,2,3,8,9,8,9,8,9,8,9,12,13,10,11,0,1,2,3,8,9,12,13,8,9,12,13,12,13,14,15]
...
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm3 = [8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,8,9,12,13,4,5,6,7,12,13,14,15,12,13,14,15]
...
; AVX2-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm6[8],xmm14[8],xmm6[9],xmm14[9],xmm6[10],xmm14[10],xmm6[11],xmm14[11],xmm6[12],xmm14[12],xmm6[13],xmm14[13],xmm6[14],xmm14[14],xmm6[15],xmm14[15]
...
; AVX2-FCP-NEXT:    vmovdqa %ymm11, %ymm8
; AVX2-FCP-NEXT:    vpshufb %ymm11, %ymm2, %ymm2
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm2[0,1,2],ymm0[3],ymm2[4,5,6],ymm0[7],ymm2[8,9,10],ymm0[11],ymm2[12,13,14],ymm0[15]
; AVX2-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm10[8],xmm7[8],xmm10[9],xmm7[9],xmm10[10],xmm7[10],xmm10[11],xmm7[11],xmm10[12],xmm7[12],xmm10[13],xmm7[13],xmm10[14],xmm7[14],xmm10[15],xmm7[15]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; AVX2-FCP-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm10 = xmm1[8],xmm15[8],xmm1[9],xmm15[9],xmm1[10],xmm15[10],xmm1[11],xmm15[11],xmm1[12],xmm15[12],xmm1[13],xmm15[13],xmm1[14],xmm15[14],xmm1[15],xmm15[15]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm10, %ymm10, %ymm1
...
; AVX2-FCP-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovdqa 16(%r10), %xmm7
; AVX2-FCP-NEXT:    vmovdqa 16(%rax), %xmm14
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm14[0],xmm7[0],xmm14[1],xmm7[1],xmm14[2],xmm7[2],xmm14[3],xmm7[3],xmm14[4],xmm7[4],xmm14[5],xmm7[5],xmm14[6],xmm7[6],xmm14[7],xmm7[7]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm11
; AVX2-FCP-NEXT:    vmovdqa 16(%r9), %xmm6
; AVX2-FCP-NEXT:    vmovdqa 16(%r8), %xmm5
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm5[0],xmm6[0],xmm5[1],xmm6[1],xmm5[2],xmm6[2],xmm5[3],xmm6[3],xmm5[4],xmm6[4],xmm5[5],xmm6[5],xmm5[6],xmm6[6],xmm5[7],xmm6[7]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm9
; AVX2-FCP-NEXT:    vpshufb %ymm13, %ymm11, %ymm2
; AVX2-FCP-NEXT:    vpshufb %ymm8, %ymm9, %ymm15
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm15 = ymm15[0,1,2],ymm2[3],ymm15[4,5,6],ymm2[7],ymm15[8,9,10],ymm2[11],ymm15[12,13,14],ymm2[15]
; AVX2-FCP-NEXT:    vmovdqa 16(%rcx), %xmm4
; AVX2-FCP-NEXT:    vmovdqa 16(%rdx), %xmm3
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm3[0],xmm4[0],xmm3[1],xmm4[1],xmm3[2],xmm4[2],xmm3[3],xmm4[3],xmm3[4],xmm4[4],xmm3[5],xmm4[5],xmm3[6],xmm4[6],xmm3[7],xmm4[7]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm8
; AVX2-FCP-NEXT:    vmovdqa 16(%rsi), %xmm1
; AVX2-FCP-NEXT:    vmovdqa 16(%rdi), %xmm0
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm0[0],xmm1[0],xmm0[1],xmm1[1],xmm0[2],xmm1[2],xmm0[3],xmm1[3],xmm0[4],xmm1[4],xmm0[5],xmm1[5],xmm0[6],xmm1[6],xmm0[7],xmm1[7]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm13
; AVX2-FCP-NEXT:    vpshufb %ymm12, %ymm13, %ymm13
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm12 = ymm8[8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,24,25,28,29,20,21,22,23,28,29,30,31,28,29,30,31]
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm12 = ymm13[0],ymm12[1],ymm13[2,3,4],ymm12[5],ymm13[6,7,8],ymm12[9],ymm13[10,11,12],ymm12[13],ymm13[14,15]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm15 = ymm12[0],ymm15[1],ymm12[2],ymm15[3],ymm12[4],ymm15[5],ymm12[6],ymm15[7]
; AVX2-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm7 = xmm14[8],xmm7[8],xmm14[9],xmm7[9],xmm14[10],xmm7[10],xmm14[11],xmm7[11],xmm14[12],xmm7[12],xmm14[13],xmm7[13],xmm14[14],xmm7[14],xmm14[15],xmm7[15]
...
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm7, %ymm7, %ymm6
...
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm12 = ymm5[0,1,2,3,8,9,10,11,8,9,10,11,10,11,14,15,16,17,18,19,28,29,26,27,28,29,26,27,30,31,30,31]
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm7 = ymm12[0,1,2],ymm7[3],ymm12[4,5,6],ymm7[7],ymm12[8,9,10],ymm7[11],ymm12[12,13,14],ymm7[15]
...
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm1 = ymm1[8,9,u,u,u,u,u,u,10,11,u,u,u,u,u,u,28,29,u,u,u,u,u,u,30,31,u,u,u,u,u,u]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm3, %ymm3, %ymm3
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm4 = ymm3[8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,24,25,28,29,20,21,22,23,28,29,30,31,28,29,30,31]
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm1 = ymm1[0],ymm4[1],ymm1[2,3,4],ymm4[5],ymm1[6,7,8],ymm4[9],ymm1[10,11,12],ymm4[13],ymm1[14,15]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm1 = ymm1[0],ymm7[1],ymm1[2],ymm7[3],ymm1[4],ymm7[5],ymm1[6],ymm7[7]
...
; AVX2-FCP-NEXT:    vpmovsxwq {{.*#+}} xmm12 = [1284,1798]
; AVX2-FCP-NEXT:    vpshufb %xmm12, %xmm0, %xmm5
; AVX2-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm0 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm5, %ymm0, %ymm0
...
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm0[0],ymm3[1],ymm0[2,3,4],ymm3[5],ymm0[6,7,8],ymm3[9],ymm0[10,11,12],ymm3[13],ymm0[14,15]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0],ymm4[1],ymm0[2],ymm4[3],ymm0[4],ymm4[5],ymm0[6],ymm4[7]
; AVX2-FCP-NEXT:    vpshufb %ymm7, %ymm11, %ymm3
; AVX2-FCP-NEXT:    vpshufb %ymm6, %ymm9, %ymm4
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm3 = ymm4[0,1,2],ymm3[3],ymm4[4,5,6],ymm3[7],ymm4[8,9,10],ymm3[11],ymm4[12,13,14],ymm3[15]
; AVX2-FCP-NEXT:    vpshufb %xmm12, %xmm2, %xmm4
; AVX2-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm2 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm4, %ymm2, %ymm2
; AVX2-FCP-NEXT:    vpshufb %ymm5, %ymm8, %ymm4
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm2 = ymm2[0],ymm4[1],ymm2[2,3,4],ymm4[5],ymm2[6,7,8],ymm4[9],ymm2[10,11,12],ymm4[13],ymm2[14,15]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm2 = ymm2[0],ymm3[1],ymm2[2],ymm3[3],ymm2[4],ymm3[5],ymm2[6],ymm3[7]
...
; AVX2-FCP-NEXT:    vpshufb %xmm12, %xmm10, %xmm5
; AVX2-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm6 = xmm10[0],zero,zero,zero,xmm10[1],zero,zero,zero
...
; AVX2-FCP-NEXT:    vmovdqa %ymm1, 224(%rax)
...
; AVX512-NEXT:    vmovdqa (%rdi), %xmm1
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm4 = xmm1[8],xmm0[8],xmm1[9],xmm0[9],xmm1[10],xmm0[10],xmm1[11],xmm0[11],xmm1[12],xmm0[12],xmm1[13],xmm0[13],xmm1[14],xmm0[14],xmm1[15],xmm0[15]
; AVX512-NEXT:    vmovdqa64 %xmm1, %xmm20
; AVX512-NEXT:    vmovdqa64 %xmm0, %xmm21
; AVX512-NEXT:    vmovdqa (%rcx), %xmm8
; AVX512-NEXT:    vmovdqa (%rdx), %xmm9
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm11 = xmm9[8],xmm8[8],xmm9[9],xmm8[9],xmm9[10],xmm8[10],xmm9[11],xmm8[11],xmm9[12],xmm8[12],xmm9[13],xmm8[13],xmm9[14],xmm8[14],xmm9[15],xmm8[15]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm11[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm11[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm0, %ymm10, %ymm16
; AVX512-NEXT:    vpmovzxwq {{.*#+}} ymm0 = xmm4[0],zero,zero,zero,xmm4[1],zero,zero,zero,xmm4[2],zero,zero,zero,xmm4[3],zero,zero,zero
; AVX512-NEXT:    vmovdqa {{.*#+}} xmm5 = [0,1,0,1,4,5,2,3,0,1,4,5,4,5,6,7]
; AVX512-NEXT:    vpshufb %xmm5, %xmm11, %xmm11
; AVX512-NEXT:    vpmovzxdq {{.*#+}} ymm11 = xmm11[0],zero,xmm11[1],zero,xmm11[2],zero,xmm11[3],zero
; AVX512-NEXT:    vpblendw {{.*#+}} ymm0 = ymm0[0],ymm11[1],ymm0[2,3,4],ymm11[5],ymm0[6,7,8],ymm11[9],ymm0[10,11,12],ymm11[13],ymm0[14,15]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm11 = ymm16[2,1,3,3,6,5,7,7]
...
; AVX512-NEXT:    vpblendw {{.*#+}} ymm4 = ymm4[0],ymm11[1],ymm4[2,3,4],ymm11[5],ymm4[6,7,8],ymm11[9],ymm4[10,11,12],ymm11[13],ymm4[14,15]
; AVX512-NEXT:    vinserti64x4 $1, %ymm4, %zmm0, %zmm19
...
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm11 = xmm0[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm0[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm10, %ymm11, %ymm10
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm11 = xmm15[0],xmm14[0],xmm15[1],xmm14[1],xmm15[2],xmm14[2],xmm15[3],xmm14[3],xmm15[4],xmm14[4],xmm15[5],xmm14[5],xmm15[6],xmm14[6],xmm15[7],xmm14[7]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm11[0,1,2,3,4,5,5,7]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm11[0,1,2,3,6,5,7,7]
; AVX512-NEXT:    vinserti128 $1, %xmm2, %ymm1, %ymm1
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm0[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm0[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm0, %ymm2, %ymm0
; AVX512-NEXT:    vpshufd {{.*#+}} ymm2 = ymm10[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm1 = ymm1[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vpblendw {{.*#+}} ymm1 = ymm1[0,1,2],ymm2[3],ymm1[4,5,6],ymm2[7],ymm1[8,9,10],ymm2[11],ymm1[12,13,14],ymm2[15]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm11[0,1,1,3,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm11[2,1,3,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm10, %ymm2, %ymm2
; AVX512-NEXT:    vpshufd {{.*#+}} ymm0 = ymm0[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm2 = ymm2[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpblendw {{.*#+}} ymm0 = ymm2[0,1,2],ymm0[3],ymm2[4,5,6],ymm0[7],ymm2[8,9,10],ymm0[11],ymm2[12,13,14],ymm0[15]
; AVX512-NEXT:    vmovdqa 16(%rcx), %xmm3
; AVX512-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm18
; AVX512-NEXT:    vmovdqa 16(%rdx), %xmm2
...
; AVX512-NEXT:    vmovdqa 16(%rsi), %xmm11
; AVX512-NEXT:    vmovdqa 16(%rdi), %xmm4
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm4[0],xmm11[0],xmm4[1],xmm11[1],xmm4[2],xmm11[2],xmm4[3],xmm11[3],xmm4[4],xmm11[4],xmm4[5],xmm11[5],xmm4[6],xmm11[6],xmm4[7],xmm11[7]
; AVX512-NEXT:    vpmovzxwq {{.*#+}} ymm5 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero,xmm0[2],zero,zero,zero,xmm0[3],zero,zero,zero
; AVX512-NEXT:    vpblendw {{.*#+}} ymm1 = ymm5[0],ymm1[1],ymm5[2,3,4],ymm1[5],ymm5[6,7,8],ymm1[9],ymm5[10,11,12],ymm1[13],ymm5[14,15]
; AVX512-NEXT:    vpshufd {{.*#+}} xmm0 = xmm0[2,3,2,3]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm5 = ymm10[2,1,3,3,6,5,7,7]
; AVX512-NEXT:    vpmovzxwq {{.*#+}} ymm0 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero,xmm0[2],zero,zero,zero,xmm0[3],zero,zero,zero
; AVX512-NEXT:    vpblendw {{.*#+}} ymm0 = ymm0[0],ymm5[1],ymm0[2,3,4],ymm5[5],ymm0[6,7,8],ymm5[9],ymm0[10,11,12],ymm5[13],ymm0[14,15]
; AVX512-NEXT:    vinserti64x4 $1, %ymm0, %zmm1, %zmm16
...
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm0[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm0[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm5, %ymm1, %ymm1
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm5 = xmm15[8],xmm14[8],xmm15[9],xmm14[9],xmm15[10],xmm14[10],xmm15[11],xmm14[11],xmm15[12],xmm14[12],xmm15[13],xmm14[13],xmm15[14],xmm14[14],xmm15[15],xmm14[15]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm5[0,1,2,3,4,5,5,7]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm12 = xmm5[0,1,2,3,6,5,7,7]
; AVX512-NEXT:    vinserti128 $1, %xmm12, %ymm10, %ymm10
...
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm5[0,1,1,3,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm5[2,1,3,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm5, %ymm10, %ymm5
; AVX512-NEXT:    vpshufd {{.*#+}} ymm0 = ymm0[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm5 = ymm5[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpblendw {{.*#+}} ymm0 = ymm5[0,1,2],ymm0[3],ymm5[4,5,6],ymm0[7],ymm5[8,9,10],ymm0[11],ymm5[12,13,14],ymm0[15]
; AVX512-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm12
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm2[8],xmm3[8],xmm2[9],xmm3[9],xmm2[10],xmm3[10],xmm2[11],xmm3[11],xmm2[12],xmm3[12],xmm2[13],xmm3[13],xmm2[14],xmm3[14],xmm2[15],xmm3[15]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm0[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm0[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm2, %ymm1, %ymm1
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm4[8],xmm11[8],xmm4[9],xmm11[9],xmm4[10],xmm11[10],xmm4[11],xmm11[11],xmm4[12],xmm11[12],xmm4[13],xmm11[13],xmm4[14],xmm11[14],xmm4[15],xmm11[15]
...
; AVX512-FCP-NEXT:    vpshufb {{.*#+}} ymm2 = ymm0[0,1,2,3,8,9,8,9,8,9,8,9,12,13,10,11,16,17,18,19,24,25,28,29,24,25,28,29,28,29,30,31]
; AVX512-FCP-NEXT:    vmovdqa (%r9), %xmm1
; AVX512-FCP-NEXT:    vmovdqa (%r8), %xmm3
; AVX512-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm6 = xmm3[8],xmm1[8],xmm3[9],xmm1[9],xmm3[10],xmm1[10],xmm3[11],xmm1[11],xmm3[12],xmm1[12],xmm3[13],xmm1[13],xmm3[14],xmm1[14],xmm3[15],xmm1[15]
; AVX512-FCP-NEXT:    vmovdqa64 %xmm3, %xmm24
; AVX512-FCP-NEXT:    vmovdqa64 %xmm1, %xmm25
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm6, %ymm6, %ymm9
; AVX512-FCP-NEXT:    vmovdqa {{.*#+}} ymm1 = [0,1,2,3,8,9,10,11,8,9,10,11,10,11,14,15,0,1,2,3,12,13,10,11,12,13,10,11,14,15,14,15]
; AVX512-FCP-NEXT:    vpshufb %ymm1, %ymm9, %ymm7
...
; AVX512-FCP-NEXT:    vmovdqa {{.*#+}} ymm1 = [0,1,0,1,0,1,0,1,8,9,10,11,4,5,2,3,0,1,4,5,0,1,4,5,8,9,10,11,4,5,6,7]
; AVX512-FCP-NEXT:    vpshufb %ymm1, %ymm0, %ymm0
; AVX512-FCP-NEXT:    vmovdqa64 %ymm1, %ymm26
; AVX512-FCP-NEXT:    vmovdqa {{.*#+}} ymm1 = [0,1,2,3,0,1,2,3,8,9,10,11,2,3,6,7,4,5,2,3,4,5,2,3,8,9,10,11,6,7,6,7]
; AVX512-FCP-NEXT:    vpshufb %ymm1, %ymm9, %ymm9
; AVX512-FCP-NEXT:    vmovdqa64 %ymm1, %ymm27
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm9[0,1,2],ymm0[3],ymm9[4,5,6],ymm0[7],ymm9[8,9,10],ymm0[11],ymm9[12,13,14],ymm0[15]
...
; AVX512-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm11 = xmm13[8],xmm12[8],xmm13[9],xmm12[9],xmm13[10],xmm12[10],xmm13[11],xmm12[11],xmm13[12],xmm12[12],xmm13[13],xmm12[13],xmm13[14],xmm12[14],xmm13[15],xmm12[15]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm11, %ymm11, %ymm2
; AVX512-FCP-NEXT:    vpmovsxwq {{.*#+}} ymm14 = [2312,2826,3340,3854]
; AVX512-FCP-NEXT:    vpshufb %ymm14, %ymm2, %ymm2
; AVX512-FCP-NEXT:    vmovdqa {{.*#+}} ymm1 = [8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,8,9,12,13,4,5,6,7,12,13,14,15,12,13,14,15]
; AVX512-FCP-NEXT:    vpshufb %ymm1, %ymm0, %ymm6
; AVX512-FCP-NEXT:    vmovdqa64 %ymm1, %ymm28
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} ymm6 = ymm2[0],ymm6[1],ymm2[2,3,4],ymm6[5],ymm2[6,7,8],ymm6[9],ymm2[10,11,12],ymm6[13],ymm2[14,15]
; AVX512-FCP-NEXT:    vmovdqa {{.*#+}} ymm1 = [0,1,0,1,4,5,2,3,4,5,2,3,12,13,14,15,0,1,4,5,4,5,6,7,4,5,6,7,12,13,14,15]
; AVX512-FCP-NEXT:    vpshufb %ymm1, %ymm0, %ymm0
; AVX512-FCP-NEXT:    vmovdqa64 %ymm1, %ymm29
; AVX512-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm17 = xmm11[0],zero,zero,zero,xmm11[1],zero,zero,zero
; AVX512-FCP-NEXT:    vpmovsxwq {{.*#+}} xmm9 = [1284,1798]
; AVX512-FCP-NEXT:    vpshufb %xmm9, %xmm11, %xmm11
; AVX512-FCP-NEXT:    vinserti32x4 $1, %xmm11, %ymm17, %ymm11
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm11[0],ymm0[1],ymm11[2,3,4],ymm0[5],ymm11[6,7,8],ymm0[9],ymm11[10,11,12],ymm0[13],ymm11[14,15]
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm6, %zmm0, %zmm19
; AVX512-FCP-NEXT:    vmovdqa 16(%r10), %xmm5
; AVX512-FCP-NEXT:    vmovdqa 16(%rax), %xmm6
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm8 = xmm6[0],xmm5[0],xmm6[1],xmm5[1],xmm6[2],xmm5[2],xmm6[3],xmm5[3],xmm6[4],xmm5[4],xmm6[5],xmm5[5],xmm6[6],xmm5[6],xmm6[7],xmm5[7]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm8, %ymm8, %ymm8
; AVX512-FCP-NEXT:    vmovdqa 16(%r9), %xmm11
; AVX512-FCP-NEXT:    vmovdqa 16(%r8), %xmm4
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm7 = xmm4[0],xmm11[0],xmm4[1],xmm11[1],xmm4[2],xmm11[2],xmm4[3],xmm11[3],xmm4[4],xmm11[4],xmm4[5],xmm11[5],xmm4[6],xmm11[6],xmm4[7],xmm11[7]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm7, %ymm7, %ymm7
; AVX512-FCP-NEXT:    vmovdqa {{.*#+}} ymm1 = [0,1,2,3,8,9,8,9,8,9,10,11,10,11,10,11,0,1,2,3,12,13,12,13,12,13,10,11,14,15,14,15]
...
; AVX512-FCP-NEXT:    vmovdqa {{.*#+}} ymm1 = [0,1,2,3,0,1,0,1,8,9,10,11,2,3,2,3,4,5,2,3,4,5,4,5,8,9,10,11,6,7,6,7]
; AVX512-FCP-NEXT:    vpshufb %ymm1, %ymm8, %ymm8
; AVX512-FCP-NEXT:    vpshufb %ymm1, %ymm7, %ymm1
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} ymm1 = ymm1[0,1,2],ymm8[3],ymm1[4,5,6],ymm8[7],ymm1[8,9,10],ymm8[11],ymm1[12,13,14],ymm8[15]
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm0, %zmm1, %zmm17
; AVX512-FCP-NEXT:    vmovdqa 16(%rsi), %xmm3
; AVX512-FCP-NEXT:    vmovdqa 16(%rdi), %xmm2
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm7 = xmm2[0],xmm3[0],xmm2[1],xmm3[1],xmm2[2],xmm3[2],xmm2[3],xmm3[3],xmm2[4],xmm3[4],xmm2[5],xmm3[5],xmm2[6],xmm3[6],xmm2[7],xmm3[7]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm7, %ymm7, %ymm8
; AVX512-FCP-NEXT:    vpshufb %ymm14, %ymm8, %ymm8
; AVX512-FCP-NEXT:    vmovdqa64 %ymm14, %ymm16
; AVX512-FCP-NEXT:    vmovdqa 16(%rcx), %xmm1
; AVX512-FCP-NEXT:    vmovdqa 16(%rdx), %xmm0
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm15 = xmm0[0],xmm1[0],xmm0[1],xmm1[1],xmm0[2],xmm1[2],xmm0[3],xmm1[3],xmm0[4],xmm1[4],xmm0[5],xmm1[5],xmm0[6],xmm1[6],xmm0[7],xmm1[7]
...
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} ymm8 = ymm8[0],ymm14[1],ymm8[2,3,4],ymm14[5],ymm8[6,7,8],ymm14[9],ymm8[10,11,12],ymm14[13],ymm8[14,15]
; AVX512-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm14 = xmm7[0],zero,zero,zero,xmm7[1],zero,zero,zero
; AVX512-FCP-NEXT:    vpshufb %xmm9, %xmm7, %xmm7
; AVX512-FCP-NEXT:    vmovdqa64 %xmm9, %xmm31
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm7, %ymm14, %ymm7
; AVX512-FCP-NEXT:    vpshufb {{.*#+}} ymm14 = ymm15[u,u,0,1,u,u,u,u,u,u,2,3,u,u,u,u,u,u,20,21,u,u,u,u,u,u,22,23,u,u,u,u]
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} ymm7 = ymm7[0],ymm14[1],ymm7[2,3,4],ymm14[5],ymm7[6,7,8],ymm14[9],ymm7[10,11,12],ymm14[13],ymm7[14,15]
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm8, %zmm7, %zmm18
; AVX512-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm5 = xmm6[8],xmm5[8],xmm6[9],xmm5[9],xmm6[10],xmm5[10],xmm6[11],xmm5[11],xmm6[12],xmm5[12],xmm6[13],xmm5[13],xmm6[14],xmm5[14],xmm6[15],xmm5[15]
; AVX512-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm4 = xmm4[8],xmm11[8],xmm4[9],xmm11[9],xmm4[10],xmm11[10],xmm4[11],xmm11[11],xmm4[12],xmm11[12],xmm4[13],xmm11[13],xmm4[14],xmm11[14],xmm4[15],xmm11[15]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm5, %ymm5, %ymm5
...
; AVX512-FCP-NEXT:    vpshufb %ymm8, %ymm5, %ymm6
; AVX512-FCP-NEXT:    vmovdqa64 %ymm20, %ymm11
; AVX512-FCP-NEXT:    vpshufb %ymm11, %ymm4, %ymm7
...
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} ymm4 = ymm4[0,1,2],ymm5[3],ymm4[4,5,6],ymm5[7],ymm4[8,9,10],ymm5[11],ymm4[12,13,14],ymm5[15]
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm6, %zmm4, %zmm20
...
; AVX512-FCP-NEXT:    vpshufb %ymm11, %ymm2, %ymm5
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} ymm3 = ymm5[0,1,2],ymm3[3],ymm5[4,5,6],ymm3[7],ymm5[8,9,10],ymm3[11],ymm5[12,13,14],ymm3[15]
; AVX512-FCP-NEXT:    vpshufb %ymm7, %ymm1, %ymm1
; AVX512-FCP-NEXT:    vpshufb %ymm14, %ymm2, %ymm2
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} ymm1 = ymm2[0,1,2],ymm1[3],ymm2[4,5,6],ymm1[7],ymm2[8,9,10],ymm1[11],ymm2[12,13,14],ymm1[15]
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm3, %zmm1, %zmm1
; AVX512-FCP-NEXT:    vmovdqa64 %xmm30, %xmm2
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm10[0],xmm2[0],xmm10[1],xmm2[1],xmm10[2],xmm2[2],xmm10[3],xmm2[3],xmm10[4],xmm2[4],xmm10[5],xmm2[5],xmm10[6],xmm2[6],xmm10[7],xmm2[7]
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm3 = xmm13[0],xmm12[0],xmm13[1],xmm12[1],xmm13[2],xmm12[2],xmm13[3],xmm12[3],xmm13[4],xmm12[4],xmm13[5],xmm12[5],xmm13[6],xmm12[6],xmm13[7],xmm12[7]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm3, %ymm3, %ymm5
...
; AVX512-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm3 = xmm3[0],zero,zero,zero,xmm3[1],zero,zero,zero
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm6, %ymm3, %ymm3
; AVX512-FCP-NEXT:    vpblendw {{.*#+}} ymm2 = ymm3[0],ymm2[1],ymm3[2,3,4],ymm2[5],ymm3[6,7,8],ymm2[9],ymm3[10,11,12],ymm2[13],ymm3[14,15]
...
; AVX512-FCP-NEXT:    vmovdqa32 %zmm20, %zmm0 {%k1}
...
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm0[0,1,2,3,4,6,6,7]
...
; AVX512DQ-NEXT:    vpblendw {{.*#+}} ymm13 = ymm7[0,1,2],ymm1[3],ymm7[4,5,6],ymm1[7],ymm7[8,9,10],ymm1[11],ymm7[12,13,14],ymm1[15]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm0[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm0[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm0, %ymm1, %ymm17
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm5[0,1,1,3,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm5[2,1,3,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm1, %ymm0, %ymm16
...
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm14[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm14[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm0, %ymm9, %ymm0
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} ymm15 = xmm5[0],zero,zero,zero,xmm5[1],zero,zero,zero,xmm5[2],zero,zero,zero,xmm5[3],zero,zero,zero
; AVX512DQ-NEXT:    vmovdqa {{.*#+}} xmm2 = [0,1,0,1,4,5,2,3,0,1,4,5,4,5,6,7]
; AVX512DQ-NEXT:    vpshufb %xmm2, %xmm14, %xmm14
; AVX512DQ-NEXT:    vpmovzxdq {{.*#+}} ymm14 = xmm14[0],zero,xmm14[1],zero,xmm14[2],zero,xmm14[3],zero
; AVX512DQ-NEXT:    vpblendw {{.*#+}} ymm15 = ymm15[0],ymm14[1],ymm15[2,3,4],ymm14[5],ymm15[6,7,8],ymm14[9],ymm15[10,11,12],ymm14[13],ymm15[14,15]
...
; AVX512DQ-NEXT:    vpblendw {{.*#+}} ymm0 = ymm5[0],ymm0[1],ymm5[2,3,4],ymm0[5],ymm5[6,7,8],ymm0[9],ymm5[10,11,12],ymm0[13],ymm5[14,15]
; AVX512DQ-NEXT:    vmovdqa 16(%r8), %xmm14
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm0, %zmm15, %zmm18
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm0 = ymm17[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm15 = ymm16[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpblendw {{.*#+}} ymm0 = ymm15[0,1,2],ymm0[3],ymm15[4,5,6],ymm0[7],ymm15[8,9,10],ymm0[11],ymm15[12,13,14],ymm0[15]
; AVX512DQ-NEXT:    movw $-21846, %ax # imm = 0xAAAA
; AVX512DQ-NEXT:    kmovw %eax, %k1
; AVX512DQ-NEXT:    vinserti32x8 $1, %ymm13, %zmm0, %zmm18 {%k1}
...
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm13 = xmm0[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm15 = xmm0[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm15, %ymm13, %ymm16
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm13 = xmm14[0],xmm12[0],xmm14[1],xmm12[1],xmm14[2],xmm12[2],xmm14[3],xmm12[3],xmm14[4],xmm12[4],xmm14[5],xmm12[5],xmm14[6],xmm12[6],xmm14[7],xmm12[7]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm15 = xmm13[0,1,2,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm13[0,1,2,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm9, %ymm15, %ymm19
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm15 = xmm0[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm0[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm0, %ymm15, %ymm20
; AVX512DQ-NEXT:    vmovdqa 16(%rcx), %xmm15
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm13[0,1,1,3,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm13 = xmm13[2,1,3,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm13, %ymm5, %ymm21
; AVX512DQ-NEXT:    vmovdqa 16(%rdx), %xmm13
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm9 = xmm13[0],xmm15[0],xmm13[1],xmm15[1],xmm13[2],xmm15[2],xmm13[3],xmm15[3],xmm13[4],xmm15[4],xmm13[5],xmm15[5],xmm13[6],xmm15[6],xmm13[7],xmm15[7]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm9[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm9[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm1, %ymm0, %ymm0
...
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm5 = xmm2[0],xmm9[0],xmm2[1],xmm9[1],xmm2[2],xmm9[2],xmm2[3],xmm9[3],xmm2[4],xmm9[4],xmm2[5],xmm9[5],xmm2[6],xmm9[6],xmm2[7],xmm9[7]
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} ymm3 = xmm5[0],zero,zero,zero,xmm5[1],zero,zero,zero,xmm5[2],zero,zero,zero,xmm5[3],zero,zero,zero
; AVX512DQ-NEXT:    vpblendw {{.*#+}} ymm1 = ymm3[0],ymm1[1],ymm3[2,3,4],ymm1[5],ymm3[6,7,8],ymm1[9],ymm3[10,11,12],ymm1[13],ymm3[14,15]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} xmm3 = xmm5[2,3,2,3]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm0 = ymm0[2,1,3,3,6,5,7,7]
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} ymm3 = xmm3[0],zero,zero,zero,xmm3[1],zero,zero,zero,xmm3[2],zero,zero,zero,xmm3[3],zero,zero,zero
; AVX512DQ-NEXT:    vpblendw {{.*#+}} ymm0 = ymm3[0],ymm0[1],ymm3[2,3,4],ymm0[5],ymm3[6,7,8],ymm0[9],ymm3[10,11,12],ymm0[13],ymm3[14,15]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm0, %zmm1, %zmm17
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm0 = ymm16[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm1 = ymm19[0,2,2,3,4,6,6,7]
...
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm3 = ymm21[0,0,2,1,4,4,6,5]
...
; AVX512DQ-NEXT:    vinserti128 $1, %xmm3, %ymm1, %ymm1
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm3 = xmm14[8],xmm12[8],xmm14[9],xmm12[9],xmm14[10],xmm12[10],xmm14[11],xmm12[11],xmm14[12],xmm12[12],xmm14[13],xmm12[13],xmm14[14],xmm12[14],xmm14[15],xmm12[15]
...
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm10 = xmm13[8],xmm15[8],xmm13[9],xmm15[9],xmm13[10],xmm15[10],xmm13[11],xmm15[11],xmm13[12],xmm15[12],xmm13[13],xmm15[13],xmm13[14],xmm15[14],xmm13[15],xmm15[15]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm11 = xmm10[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm12 = xmm10[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm12, %ymm11, %ymm11
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm1 = ymm1[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm5 = ymm5[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vpblendw {{.*#+}} ymm1 = ymm5[0,1,2],ymm1[3],ymm5[4,5,6],ymm1[7],ymm5[8,9,10],ymm1[11],ymm5[12,13,14],ymm1[15]
...
; AVX512DQ-NEXT:    vpshufb %xmm12, %xmm10, %xmm9
...
; AVX512DQ-NEXT:    vpblendw {{.*#+}} ymm2 = ymm2[0],ymm9[1],ymm2[2,3,4],ymm9[5],ymm2[6,7,8],ymm9[9],ymm2[10,11,12],ymm9[13],ymm2[14,15]
...
; AVX512DQ-NEXT:    vinserti32x8 $1, %ymm1, %zmm0, %zmm2 {%k1}
...
; AVX512DQ-NEXT:    vmovdqa64 %xmm23, %xmm7
...
; AVX512DQ-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm9 = xmm3[8],xmm2[8],xmm3[9],xmm2[9],xmm3[10],xmm2[10],xmm3[11],xmm2[11],xmm3[12],xmm2[12],xmm3[13],xmm2[13],xmm3[14],xmm2[14],xmm3[15],xmm2[15]
; AVX512DQ-FCP-NEXT:    vmovdqa64 %xmm3, %xmm21
; AVX512DQ-FCP-NEXT:    vmovdqa64 %xmm2, %xmm22
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm9, %ymm9, %ymm6
; AVX512DQ-FCP-NEXT:    vpmovsxwq {{.*#+}} ymm3 = [2312,2826,3340,3854]
; AVX512DQ-FCP-NEXT:    vpshufb %ymm3, %ymm6, %ymm6
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} ymm1 = ymm6[0],ymm1[1],ymm6[2,3,4],ymm1[5],ymm6[6,7,8],ymm1[9],ymm6[10,11,12],ymm1[13],ymm6[14,15]
; AVX512DQ-FCP-NEXT:    vmovdqa {{.*#+}} ymm2 = [0,1,0,1,4,5,2,3,4,5,2,3,12,13,14,15,0,1,4,5,4,5,6,7,4,5,6,7,12,13,14,15]
...
; AVX512DQ-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm9 = xmm9[0],zero,zero,zero,xmm9[1],zero,zero,zero
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm10, %ymm9, %ymm9
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm9[0],ymm0[1],ymm9[2,3,4],ymm0[5],ymm9[6,7,8],ymm0[9],ymm9[10,11,12],ymm0[13],ymm9[14,15]
...
; AVX512DQ-FCP-NEXT:    vmovdqa {{.*#+}} ymm0 = [0,1,2,3,8,9,8,9,8,9,8,9,12,13,10,11,0,1,2,3,8,9,12,13,8,9,12,13,12,13,14,15]
...
; AVX512DQ-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm14 = xmm13[8],xmm12[8],xmm13[9],xmm12[9],xmm13[10],xmm12[10],xmm13[11],xmm12[11],xmm13[12],xmm12[12],xmm13[13],xmm12[13],xmm13[14],xmm12[14],xmm13[15],xmm12[15]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm14, %ymm14, %ymm0
; AVX512DQ-FCP-NEXT:    vmovdqa {{.*#+}} ymm2 = [0,1,2,3,8,9,10,11,8,9,10,11,10,11,14,15,0,1,2,3,12,13,10,11,12,13,10,11,14,15,14,15]
; AVX512DQ-FCP-NEXT:    vpshufb %ymm2, %ymm0, %ymm6
; AVX512DQ-FCP-NEXT:    vmovdqa64 %ymm2, %ymm25
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} ymm6 = ymm6[0,1,2],ymm15[3],ymm6[4,5,6],ymm15[7],ymm6[8,9,10],ymm15[11],ymm6[12,13,14],ymm15[15]
; AVX512DQ-FCP-NEXT:    vmovdqa {{.*#+}} ymm2 = [0,1,0,1,0,1,0,1,8,9,10,11,4,5,2,3,0,1,4,5,0,1,4,5,8,9,10,11,4,5,6,7]
; AVX512DQ-FCP-NEXT:    vpshufb %ymm2, %ymm1, %ymm1
; AVX512DQ-FCP-NEXT:    vmovdqa64 %ymm2, %ymm26
; AVX512DQ-FCP-NEXT:    vmovdqa {{.*#+}} ymm2 = [0,1,2,3,0,1,2,3,8,9,10,11,2,3,6,7,4,5,2,3,4,5,2,3,8,9,10,11,6,7,6,7]
; AVX512DQ-FCP-NEXT:    vpshufb %ymm2, %ymm0, %ymm0
; AVX512DQ-FCP-NEXT:    vmovdqa64 %ymm2, %ymm27
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm0[0,1,2],ymm1[3],ymm0[4,5,6],ymm1[7],ymm0[8,9,10],ymm1[11],ymm0[12,13,14],ymm1[15]
; AVX512DQ-FCP-NEXT:    movw $-21846, %r11w # imm = 0xAAAA
; AVX512DQ-FCP-NEXT:    kmovw %r11d, %k1
; AVX512DQ-FCP-NEXT:    vinserti32x8 $1, %ymm6, %zmm0, %zmm17 {%k1}
; AVX512DQ-FCP-NEXT:    vmovdqa 16(%rsi), %xmm7
; AVX512DQ-FCP-NEXT:    vmovdqa 16(%rdi), %xmm5
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm6 = xmm5[0],xmm7[0],xmm5[1],xmm7[1],xmm5[2],xmm7[2],xmm5[3],xmm7[3],xmm5[4],xmm7[4],xmm5[5],xmm7[5],xmm5[6],xmm7[6],xmm5[7],xmm7[7]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm6, %ymm6, %ymm14
; AVX512DQ-FCP-NEXT:    vmovdqa %ymm3, %ymm9
; AVX512DQ-FCP-NEXT:    vpshufb %ymm3, %ymm14, %ymm14
; AVX512DQ-FCP-NEXT:    vmovdqa 16(%rcx), %xmm3
; AVX512DQ-FCP-NEXT:    vmovdqa 16(%rdx), %xmm2
...
; AVX512DQ-FCP-NEXT:    vpshufb {{.*#+}} ymm10 = ymm15[u,u,8,9,u,u,u,u,u,u,10,11,u,u,u,u,u,u,28,29,u,u,u,u,u,u,30,31,u,u,u,u]
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} ymm10 = ymm14[0],ymm10[1],ymm14[2,3,4],ymm10[5],ymm14[6,7,8],ymm10[9],ymm14[10,11,12],ymm10[13],ymm14[14,15]
; AVX512DQ-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm14 = xmm6[0],zero,zero,zero,xmm6[1],zero,zero,zero
; AVX512DQ-FCP-NEXT:    vpshufb %xmm4, %xmm6, %xmm6
; AVX512DQ-FCP-NEXT:    vmovdqa64 %xmm4, %xmm29
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm6, %ymm14, %ymm6
; AVX512DQ-FCP-NEXT:    vpshufb {{.*#+}} ymm14 = ymm15[u,u,0,1,u,u,u,u,u,u,2,3,u,u,u,u,u,u,20,21,u,u,u,u,u,u,22,23,u,u,u,u]
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} ymm6 = ymm6[0],ymm14[1],ymm6[2,3,4],ymm14[5],ymm6[6,7,8],ymm14[9],ymm6[10,11,12],ymm14[13],ymm6[14,15]
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm10, %zmm6, %zmm16
; AVX512DQ-FCP-NEXT:    vmovdqa 16(%r10), %xmm6
; AVX512DQ-FCP-NEXT:    vmovdqa 16(%rax), %xmm10
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm14 = xmm10[0],xmm6[0],xmm10[1],xmm6[1],xmm10[2],xmm6[2],xmm10[3],xmm6[3],xmm10[4],xmm6[4],xmm10[5],xmm6[5],xmm10[6],xmm6[6],xmm10[7],xmm6[7]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm14, %ymm14, %ymm14
; AVX512DQ-FCP-NEXT:    vmovdqa 16(%r9), %xmm15
; AVX512DQ-FCP-NEXT:    vmovdqa 16(%r8), %xmm4
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm8 = xmm4[0],xmm15[0],xmm4[1],xmm15[1],xmm4[2],xmm15[2],xmm4[3],xmm15[3],xmm4[4],xmm15[4],xmm4[5],xmm15[5],xmm4[6],xmm15[6],xmm4[7],xmm15[7]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm8, %ymm8, %ymm8
; AVX512DQ-FCP-NEXT:    vmovdqa {{.*#+}} ymm1 = [0,1,2,3,8,9,8,9,8,9,10,11,10,11,10,11,0,1,2,3,12,13,12,13,12,13,10,11,14,15,14,15]
; AVX512DQ-FCP-NEXT:    vpshufb %ymm1, %ymm14, %ymm0
; AVX512DQ-FCP-NEXT:    vpshufb %ymm1, %ymm8, %ymm1
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm1[0,1,2],ymm0[3],ymm1[4,5,6],ymm0[7],ymm1[8,9,10],ymm0[11],ymm1[12,13,14],ymm0[15]
; AVX512DQ-FCP-NEXT:    vmovdqa {{.*#+}} ymm1 = [0,1,2,3,0,1,0,1,8,9,10,11,2,3,2,3,4,5,2,3,4,5,4,5,8,9,10,11,6,7,6,7]
; AVX512DQ-FCP-NEXT:    vpshufb %ymm1, %ymm14, %ymm14
; AVX512DQ-FCP-NEXT:    vpshufb %ymm1, %ymm8, %ymm1
; AVX512DQ-FCP-NEXT:    vpblendw {{.*#+}} ymm1 = ymm1[0,1,2],ymm14[3],ymm1[4,5,6],ymm14[7],ymm1[8,9,10],ymm14[11],ymm1[12,13,14],ymm14[15]
; AVX512DQ-FCP-NEXT:    vinserti32x8 $1, %ymm0, %zmm1, %zmm16 {%k1}
; AVX512DQ-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm2[8],xmm3[8],xmm2[9],xmm3[9],xmm2[10],xmm3[10],xmm2[11],xmm3[11],xmm2[12],xmm3[12],xmm2[13],xmm3[13],xmm2[14],xmm3[14],xmm2[15],xmm3[15]
; AVX512DQ-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm5[8],xmm7[8],xmm5[9],xmm7[9],xmm5[10],xmm7[10],xmm5[11],xmm7[11],xmm5[12],xmm7[12],xmm5[13],xmm7[13],xmm5[14],xmm7[14],xmm5[15],xmm7[15]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
...
; AVX512DQ-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm3 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero
...
; AVX512DQ-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm10[8],xmm6[8],xmm10[9],xmm6[9],xmm10[10],xmm6[10],xmm10[11],xmm6[11],xmm10[12],xmm6[12],xmm10[13],xmm6[13],xmm10[14],xmm6[14],xmm10[15],xmm6[15]
; AVX512DQ-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm4[8],xmm15[8],xmm4[9],xmm15[9],xmm4[10],xmm15[10],xmm4[11],xmm15[11],xmm4[12],xmm15[12],xmm4[13],xmm15[13],xmm4[14],xmm15[14],xmm4[15],xmm15[15]
...
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm1, %ymm1, %ymm1
; AVX512DQ-FCP-NEXT:    vpshufb %ymm5, %ymm1, %ymm4
...
; AVX512DQ-FCP-NEXT:    vpshufb %ymm10, %ymm3, %ymm5
...
; SSE-NEXT:    movdqa {{.*#+}} xmm14 = [65535,65535,65535,0,65535,65535,65535,0]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm13 = xmm2[0,0,2,1]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm2 = xmm11[0,0,2,1,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm2 = xmm2[0,1,1,3]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm4 = xmm12[2,1,3,3,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[0,0,2,1]
; SSE-NEXT:    pand %xmm14, %xmm4
; SSE-NEXT:    por %xmm13, %xmm4
; SSE-NEXT:    pshuflw {{.*#+}} xmm13 = xmm11[0,2,2,3,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm13 = xmm13[0,1,1,3]
; SSE-NEXT:    movdqa %xmm3, %xmm15
; SSE-NEXT:    pandn %xmm13, %xmm15
; SSE-NEXT:    pshufd {{.*#+}} xmm13 = xmm2[1,1,1,1]
; SSE-NEXT:    pshufhw {{.*#+}} xmm13 = xmm13[0,1,2,3,5,5,5,5]
...
; SSE-NEXT:    movdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    pshufhw {{.*#+}} xmm4 = xmm0[0,1,2,3,4,4,6,5]
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[0,2,2,3]
; SSE-NEXT:    movdqa %xmm14, %xmm13
; SSE-NEXT:    pandn %xmm4, %xmm13
; SSE-NEXT:    pshufhw {{.*#+}} xmm4 = xmm12[0,1,2,3,4,5,5,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[0,2,2,3]
; SSE-NEXT:    pand %xmm14, %xmm4
; SSE-NEXT:    por %xmm13, %xmm4
; SSE-NEXT:    pshufhw {{.*#+}} xmm13 = xmm11[0,1,2,3,4,4,6,5]
; SSE-NEXT:    pshufd {{.*#+}} xmm13 = xmm13[2,1,3,3]
; SSE-NEXT:    movdqa %xmm3, %xmm15
; SSE-NEXT:    pandn %xmm13, %xmm15
; SSE-NEXT:    pshufd {{.*#+}} xmm13 = xmm2[2,2,2,2]
; SSE-NEXT:    pshufhw {{.*#+}} xmm13 = xmm13[0,1,2,3,5,5,5,5]
; SSE-NEXT:    pand %xmm3, %xmm13
; SSE-NEXT:    por %xmm15, %xmm13
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[1,3,2,3]
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm11 = xmm0[0,1,2,3,5,5,5,5]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm4 = xmm9[0,0,2,1,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[0,0,2,1]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm4 = xmm7[0,1,1,3,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[0,0,2,1]
; SSE-NEXT:    pand %xmm14, %xmm4
; SSE-NEXT:    por %xmm10, %xmm4
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[1,3,2,3]
...
; SSE-NEXT:    punpckldq {{.*#+}} xmm0 = xmm0[0],xmm4[0],xmm0[1],xmm4[1]
; SSE-NEXT:    movdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    pshuflw {{.*#+}} xmm4 = xmm9[0,2,2,3,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[0,0,2,1]
; SSE-NEXT:    movdqa %xmm14, %xmm6
; SSE-NEXT:    pandn %xmm4, %xmm6
; SSE-NEXT:    pshuflw {{.*#+}} xmm4 = xmm7[2,1,3,3,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[0,0,2,1]
; SSE-NEXT:    pand %xmm14, %xmm4
; SSE-NEXT:    por %xmm6, %xmm4
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[1,3,2,3]
...
; SSE-NEXT:    movdqa %xmm14, %xmm6
; SSE-NEXT:    pandn %xmm4, %xmm6
; SSE-NEXT:    pshufhw {{.*#+}} xmm4 = xmm7[0,1,2,3,4,5,5,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[0,2,2,3]
; SSE-NEXT:    pand %xmm14, %xmm4
; SSE-NEXT:    por %xmm6, %xmm4
...
; SSE-NEXT:    pshufd {{.*#+}} xmm6 = xmm7[1,3,2,3]
; SSE-NEXT:    pshufhw {{.*#+}} xmm5 = xmm10[0,1,2,3,4,6,6,7]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm5 = xmm3[0,0,2,1,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm5 = xmm5[0,0,2,1]
; SSE-NEXT:    movdqa %xmm14, %xmm6
; SSE-NEXT:    pandn %xmm5, %xmm6
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm9 = xmm7[0,1,1,3,4,5,6,7]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm11 = xmm13[0,0,2,1,4,5,6,7]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm11 = xmm4[0,0,0,0]
; SSE-NEXT:    pshufhw {{.*#+}} xmm11 = xmm11[0,1,2,3,5,5,5,5]
...
; SSE-NEXT:    movdqa %xmm11, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    pshuflw {{.*#+}} xmm9 = xmm3[0,2,2,3,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm9 = xmm9[0,0,2,1]
; SSE-NEXT:    movdqa %xmm14, %xmm11
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm11 = xmm13[0,2,2,3,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm11 = xmm11[0,1,1,3]
; SSE-NEXT:    movdqa %xmm1, %xmm12
; SSE-NEXT:    pandn %xmm11, %xmm12
...
; SSE-NEXT:    punpckldq {{.*#+}} xmm11 = xmm11[0],xmm9[0],xmm11[1],xmm9[1]
; SSE-NEXT:    movdqa %xmm11, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; SSE-NEXT:    pshufhw {{.*#+}} xmm9 = xmm3[0,1,2,3,4,4,6,5]
; SSE-NEXT:    pshufd {{.*#+}} xmm9 = xmm9[0,2,2,3]
; SSE-NEXT:    movdqa %xmm14, %xmm11
; SSE-NEXT:    pandn %xmm9, %xmm11
; SSE-NEXT:    pshufhw {{.*#+}} xmm9 = xmm7[0,1,2,3,4,5,5,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm9 = xmm9[0,2,2,3]
; SSE-NEXT:    pand %xmm14, %xmm9
; SSE-NEXT:    por %xmm11, %xmm9
; SSE-NEXT:    pshufhw {{.*#+}} xmm11 = xmm13[0,1,2,3,4,4,6,5]
; SSE-NEXT:    pshufd {{.*#+}} xmm11 = xmm11[2,1,3,3]
; SSE-NEXT:    movdqa %xmm1, %xmm12
; SSE-NEXT:    pandn %xmm11, %xmm12
; SSE-NEXT:    pshufd {{.*#+}} xmm11 = xmm4[2,2,2,2]
; SSE-NEXT:    pshufhw {{.*#+}} xmm11 = xmm11[0,1,2,3,5,5,5,5]
; SSE-NEXT:    pand %xmm1, %xmm11
; SSE-NEXT:    por %xmm12, %xmm11
; SSE-NEXT:    pshufd {{.*#+}} xmm9 = xmm9[1,3,2,3]
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm3 = xmm7[0,1,2,3,6,5,7,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm3 = xmm3[0,2,2,3]
...
; SSE-NEXT:    punpckhbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm8 # 16-byte Folded Reload
; SSE-NEXT:    # xmm8 = xmm8[8],mem[8],xmm8[9],mem[9],xmm8[10],mem[10],xmm8[11],mem[11],xmm8[12],mem[12],xmm8[13],mem[13],xmm8[14],mem[14],xmm8[15],mem[15]
; SSE-NEXT:    pshuflw {{.*#+}} xmm3 = xmm8[0,0,2,1,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm3 = xmm3[0,0,2,1]
; SSE-NEXT:    movdqa %xmm14, %xmm4
; SSE-NEXT:    pandn %xmm3, %xmm4
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm3 = xmm2[0,1,1,3,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm3 = xmm3[0,0,2,1]
; SSE-NEXT:    pand %xmm14, %xmm3
; SSE-NEXT:    por %xmm4, %xmm3
...
; SSE-NEXT:    movdqa %xmm14, %xmm4
; SSE-NEXT:    pandn %xmm3, %xmm4
; SSE-NEXT:    pshufhw {{.*#+}} xmm3 = xmm2[0,1,2,3,4,5,5,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm3 = xmm3[0,2,2,3]
; SSE-NEXT:    pand %xmm14, %xmm3
; SSE-NEXT:    por %xmm4, %xmm3
; SSE-NEXT:    pshufhw {{.*#+}} xmm4 = xmm6[0,1,2,3,4,4,6,5]
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[2,1,3,3]
; SSE-NEXT:    movdqa %xmm1, %xmm5
; SSE-NEXT:    pandn %xmm4, %xmm5
...
; SSE-NEXT:    movdqa %xmm14, %xmm4
; SSE-NEXT:    pandn %xmm3, %xmm4
; SSE-NEXT:    pshufhw {{.*#+}} xmm3 = xmm2[0,1,2,3,6,5,7,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm3 = xmm3[0,2,2,3]
; SSE-NEXT:    pand %xmm14, %xmm3
; SSE-NEXT:    por %xmm4, %xmm3
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm4 = xmm3[0,0,2,1,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[0,0,2,1]
; SSE-NEXT:    movdqa %xmm14, %xmm5
; SSE-NEXT:    pandn %xmm4, %xmm5
; SSE-NEXT:    movdqa 32(%r8), %xmm9
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm10 = xmm5[0,0,2,1,4,5,6,7]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm7 = xmm6[2,1,3,3,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm7 = xmm7[0,0,2,1]
; SSE-NEXT:    pand %xmm14, %xmm7
; SSE-NEXT:    por %xmm11, %xmm7
; SSE-NEXT:    pshuflw {{.*#+}} xmm11 = xmm5[0,2,2,3,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm11 = xmm11[0,1,1,3]
; SSE-NEXT:    movdqa %xmm1, %xmm15
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm7 = xmm6[0,1,2,3,4,5,5,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm7 = xmm7[0,2,2,3]
; SSE-NEXT:    pand %xmm14, %xmm7
; SSE-NEXT:    por %xmm15, %xmm7
; SSE-NEXT:    pshufhw {{.*#+}} xmm15 = xmm5[0,1,2,3,4,4,6,5]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm7 = xmm15[0,2,2,3]
; SSE-NEXT:    punpckldq {{.*#+}} xmm7 = xmm7[0],xmm2[0],xmm7[1],xmm2[1]
; SSE-NEXT:    movdqa %xmm7, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; SSE-NEXT:    movdqa %xmm14, %xmm2
; SSE-NEXT:    pandn %xmm0, %xmm2
; SSE-NEXT:    pshuflw {{.*#+}} xmm0 = xmm9[2,1,3,3,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm0 = xmm0[0,0,2,1]
; SSE-NEXT:    pand %xmm14, %xmm0
; SSE-NEXT:    por %xmm2, %xmm0
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm9 = xmm8[0,0,2,1,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm9 = xmm9[0,0,2,1]
; SSE-NEXT:    movdqa %xmm14, %xmm10
; SSE-NEXT:    pandn %xmm9, %xmm10
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm11 = xmm15[0,1,1,3,4,5,6,7]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm13 = xmm10[0,0,2,1,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm13 = xmm13[0,1,1,3]
; SSE-NEXT:    movdqa %xmm6, %xmm1
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm1 = xmm15[2,1,3,3,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm1 = xmm1[0,0,2,1]
; SSE-NEXT:    pand %xmm14, %xmm1
; SSE-NEXT:    por %xmm11, %xmm1
; SSE-NEXT:    pshuflw {{.*#+}} xmm11 = xmm10[0,2,2,3,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm11 = xmm11[0,1,1,3]
; SSE-NEXT:    movdqa %xmm6, %xmm14
; SSE-NEXT:    pandn %xmm11, %xmm14
; SSE-NEXT:    pshufd {{.*#+}} xmm11 = xmm13[1,1,1,1]
; SSE-NEXT:    pshufhw {{.*#+}} xmm11 = xmm11[0,1,2,3,5,5,5,5]
; SSE-NEXT:    pand %xmm6, %xmm11
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm1 = xmm15[0,1,2,3,4,5,5,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm1 = xmm1[0,2,2,3]
; SSE-NEXT:    pand %xmm5, %xmm1
; SSE-NEXT:    por %xmm14, %xmm1
; SSE-NEXT:    pshufhw {{.*#+}} xmm14 = xmm10[0,1,2,3,4,4,6,5]
...
; SSE-NEXT:    pshufd {{.*#+}} xmm0 = xmm1[1,3,2,3]
...
; SSE-NEXT:    movdqa %xmm6, %xmm10
; SSE-NEXT:    pandn %xmm8, %xmm10
; SSE-NEXT:    pshufd {{.*#+}} xmm8 = xmm13[3,3,3,3]
; SSE-NEXT:    pshufhw {{.*#+}} xmm8 = xmm8[0,1,2,3,5,5,5,5]
...
; SSE-NEXT:    pshuflw {{.*#+}} xmm0 = xmm4[0,0,2,1,4,5,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm0 = xmm0[0,0,2,1]
; SSE-NEXT:    movdqa %xmm5, %xmm10
...
; SSE-NEXT:    pand %xmm14, %xmm0
; SSE-NEXT:    por %xmm10, %xmm0
; SSE-NEXT:    pshufhw {{.*#+}} xmm10 = xmm3[0,1,2,3,4,4,6,5]
; SSE-NEXT:    pshufd {{.*#+}} xmm10 = xmm10[2,1,3,3]
...
; SSE-NEXT:    pshufhw {{.*#+}} xmm0 = xmm4[0,1,2,3,4,6,6,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm0 = xmm0[0,2,2,3]
; SSE-NEXT:    pshufhw {{.*#+}} xmm4 = xmm9[0,1,2,3,6,5,7,7]
; SSE-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[0,2,2,3]
; SSE-NEXT:    movdqa %xmm14, %xmm9
; SSE-NEXT:    pand %xmm14, %xmm4
...
; SSE-NEXT:    punpckldq {{.*#+}} xmm2 = xmm2[0],xmm0[0],xmm2[1],xmm0[1]
; SSE-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; SSE-NEXT:    movdqa %xmm2, 496(%rax)
; SSE-NEXT:    movdqa %xmm10, 480(%rax)
; SSE-NEXT:    movdqa %xmm6, 464(%rax)
; SSE-NEXT:    movdqa %xmm5, 448(%rax)
; SSE-NEXT:    movdqa %xmm8, 432(%rax)
; SSE-NEXT:    movdqa %xmm1, 416(%rax)
; SSE-NEXT:    movdqa %xmm11, 400(%rax)
; SSE-NEXT:    movdqa %xmm7, 384(%rax)
...
; AVX:       # %bb.0:
; AVX-NEXT:    subq $344, %rsp # imm = 0x158
; AVX-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX-NEXT:    movq {{[0-9]+}}(%rsp), %r10
; AVX-NEXT:    vmovdqa (%r10), %xmm0
; AVX-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
...
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm0, %ymm0
; AVX-NEXT:    vshufps {{.*#+}} ymm2 = ymm0[0,2,2,3,4,6,6,7]
; AVX-NEXT:    vbroadcastsd {{.*#+}} ymm7 = [65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0]
; AVX-NEXT:    vandnps %ymm2, %ymm7, %ymm2
; AVX-NEXT:    vmovdqa (%r9), %xmm0
; AVX-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vmovdqa (%r8), %xmm3
; AVX-NEXT:    vmovdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vpunpcklbw {{.*#+}} xmm3 = xmm3[0],xmm0[0],xmm3[1],xmm0[1],xmm3[2],xmm0[2],xmm3[3],xmm0[3],xmm3[4],xmm0[4],xmm3[5],xmm0[5],xmm3[6],xmm0[6],xmm3[7],xmm0[7]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm3[0,1,2,3,4,5,5,7]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm3[0,1,2,3,6,5,7,7]
...
; AVX-NEXT:    vpshufhw {{.*#+}} xmm6 = xmm5[0,1,2,3,4,6,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm6, %ymm2, %ymm2
; AVX-NEXT:    vmovdqa (%rsi), %xmm0
; AVX-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vmovdqa (%rdi), %xmm6
; AVX-NEXT:    vmovdqa %xmm6, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX-NEXT:    vpunpcklbw {{.*#+}} xmm6 = xmm6[0],xmm0[0],xmm6[1],xmm0[1],xmm6[2],xmm0[2],xmm6[3],xmm0[3],xmm6[4],xmm0[4],xmm6[5],xmm0[5],xmm6[6],xmm0[6],xmm6[7],xmm0[7]
; AVX-NEXT:    vpshufd {{.*#+}} xmm15 = xmm6[2,3,2,3]
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm15 = xmm15[0],zero,zero,zero,xmm15[1],zero,zero,zero
; AVX-NEXT:    vpshufd {{.*#+}} xmm14 = xmm6[3,3,3,3]
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm14 = xmm14[0],zero,zero,zero,xmm14[1],zero,zero,zero
; AVX-NEXT:    vinsertf128 $1, %xmm14, %ymm15, %ymm14
; AVX-NEXT:    vshufps {{.*#+}} ymm15 = ymm2[2,1,3,3,6,5,7,7]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm14[0],ymm4[1],ymm14[2],ymm4[3],ymm14[4],ymm4[5],ymm14[6],ymm4[7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm1[0,0,2,1,4,5,6,7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm1[0,2,2,3,4,5,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm1, %ymm4, %ymm1
; AVX-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm3[0,1,1,3,4,5,6,7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm3[2,1,3,3,4,5,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm3, %ymm4, %ymm3
; AVX-NEXT:    vmovdqa 48(%r10), %xmm4
...
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm3 = xmm6[0],zero,zero,zero,xmm6[1],zero,zero,zero
...
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm3[0],ymm1[1],ymm3[2],ymm1[3],ymm3[4],ymm1[5],ymm3[6],ymm1[7]
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm8[8],xmm4[8],xmm8[9],xmm4[9],xmm8[10],xmm4[10],xmm8[11],xmm4[11],xmm8[12],xmm4[12],xmm8[13],xmm4[13],xmm8[14],xmm4[14],xmm8[15],xmm4[15]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm1[0,0,2,1,4,5,6,7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm1[0,2,2,3,4,5,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm5, %ymm3, %ymm3
; AVX-NEXT:    vmovdqa 48(%r9), %xmm6
; AVX-NEXT:    vmovdqa 48(%r8), %xmm14
; AVX-NEXT:    vpunpckhbw {{.*#+}} xmm15 = xmm14[8],xmm6[8],xmm14[9],xmm6[9],xmm14[10],xmm6[10],xmm14[11],xmm6[11],xmm14[12],xmm6[12],xmm14[13],xmm6[13],xmm14[14],xmm6[14],xmm14[15],xmm6[15]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm15[0,1,1,3,4,5,6,7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm13 = xmm15[2,1,3,3,4,5,6,7]
...
; AVX-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm13[8],xmm5[8],xmm13[9],xmm5[9],xmm13[10],xmm5[10],xmm13[11],xmm5[11],xmm13[12],xmm5[12],xmm13[13],xmm5[13],xmm13[14],xmm5[14],xmm13[15],xmm5[15]
; AVX-NEXT:    vpshufd {{.*#+}} xmm12 = xmm2[1,1,1,1]
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm12 = xmm12[0],zero,zero,zero,xmm12[1],zero,zero,zero
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm9 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero
; AVX-NEXT:    vinsertf128 $1, %xmm12, %ymm9, %ymm9
; AVX-NEXT:    vmovdqa 48(%rcx), %xmm12
; AVX-NEXT:    vmovdqa 48(%rdx), %xmm4
; AVX-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm4[8],xmm12[8],xmm4[9],xmm12[9],xmm4[10],xmm12[10],xmm4[11],xmm12[11],xmm4[12],xmm12[12],xmm4[13],xmm12[13],xmm4[14],xmm12[14],xmm4[15],xmm12[15]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm0[0,0,2,1,4,5,6,7]
; AVX-NEXT:    vpmovzxdq {{.*#+}} xmm11 = xmm11[0],zero,xmm11[1],zero
; AVX-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm0[0,2,2,3,4,5,6,7]
; AVX-NEXT:    vpmovzxdq {{.*#+}} xmm10 = xmm10[0],zero,xmm10[1],zero
; AVX-NEXT:    vinsertf128 $1, %xmm10, %ymm11, %ymm10
; AVX-NEXT:    vbroadcastsd {{.*#+}} ymm11 = [65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535]
; AVX-NEXT:    vandps %ymm11, %ymm9, %ymm9
; AVX-NEXT:    vandnps %ymm10, %ymm11, %ymm10
; AVX-NEXT:    vorps %ymm10, %ymm9, %ymm9
; AVX-NEXT:    vblendps {{.*#+}} ymm3 = ymm9[0],ymm3[1],ymm9[2],ymm3[3],ymm9[4],ymm3[5],ymm9[6],ymm3[7]
; AVX-NEXT:    vmovups %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm1[0,1,2,3,4,4,6,5]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,4,6,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm1, %ymm3, %ymm1
; AVX-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm15[0,1,2,3,4,5,5,7]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm15[0,1,2,3,6,5,7,7]
...
; AVX-NEXT:    vmovups %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm8, %xmm0 # 16-byte Folded Reload
; AVX-NEXT:    # xmm0 = xmm8[0],mem[0],xmm8[1],mem[1],xmm8[2],mem[2],xmm8[3],mem[3],xmm8[4],mem[4],xmm8[5],mem[5],xmm8[6],mem[6],xmm8[7],mem[7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm0[0,0,2,1,4,5,6,7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm0[0,2,2,3,4,5,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm1, %ymm1
; AVX-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm14[0],xmm6[0],xmm14[1],xmm6[1],xmm14[2],xmm6[2],xmm14[3],xmm6[3],xmm14[4],xmm6[4],xmm14[5],xmm6[5],xmm14[6],xmm6[6],xmm14[7],xmm6[7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[0,1,1,3,4,5,6,7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm6 = xmm2[2,1,3,3,4,5,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm6, %ymm3, %ymm3
; AVX-NEXT:    vshufps {{.*#+}} ymm1 = ymm1[0,0,2,1,4,4,6,5]
; AVX-NEXT:    vandnps %ymm1, %ymm7, %ymm1
; AVX-NEXT:    vshufps {{.*#+}} ymm3 = ymm3[0,0,2,1,4,4,6,5]
; AVX-NEXT:    vandps %ymm7, %ymm3, %ymm3
; AVX-NEXT:    vorps %ymm1, %ymm3, %ymm1
; AVX-NEXT:    vpunpcklbw {{.*#+}} xmm3 = xmm13[0],xmm5[0],xmm13[1],xmm5[1],xmm13[2],xmm5[2],xmm13[3],xmm5[3],xmm13[4],xmm5[4],xmm13[5],xmm5[5],xmm13[6],xmm5[6],xmm13[7],xmm5[7]
; AVX-NEXT:    vpshufd {{.*#+}} xmm5 = xmm3[1,1,1,1]
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm5 = xmm5[0],zero,zero,zero,xmm5[1],zero,zero,zero
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm6 = xmm3[0],zero,zero,zero,xmm3[1],zero,zero,zero
; AVX-NEXT:    vinsertf128 $1, %xmm5, %ymm6, %ymm5
; AVX-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm4[0],xmm12[0],xmm4[1],xmm12[1],xmm4[2],xmm12[2],xmm4[3],xmm12[3],xmm4[4],xmm12[4],xmm4[5],xmm12[5],xmm4[6],xmm12[6],xmm4[7],xmm12[7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm6 = xmm4[0,0,2,1,4,5,6,7]
; AVX-NEXT:    vpmovzxdq {{.*#+}} xmm6 = xmm6[0],zero,xmm6[1],zero
; AVX-NEXT:    vpshuflw {{.*#+}} xmm8 = xmm4[0,2,2,3,4,5,6,7]
; AVX-NEXT:    vpmovzxdq {{.*#+}} xmm8 = xmm8[0],zero,xmm8[1],zero
; AVX-NEXT:    vinsertf128 $1, %xmm8, %ymm6, %ymm6
; AVX-NEXT:    vandps %ymm5, %ymm11, %ymm5
; AVX-NEXT:    vandnps %ymm6, %ymm11, %ymm6
; AVX-NEXT:    vorps %ymm6, %ymm5, %ymm5
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm5[0],ymm1[1],ymm5[2],ymm1[3],ymm5[4],ymm1[5],ymm5[6],ymm1[7]
; AVX-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm0[0,1,2,3,4,4,6,5]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm1, %ymm0
; AVX-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm2[0,1,2,3,4,5,5,7]
...
; AVX-NEXT:    vorps %ymm0, %ymm1, %ymm0
; AVX-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm4[0,1,2,3,4,4,6,5]
...
; AVX-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[0,0,2,1,4,5,6,7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm2[0,2,2,3,4,5,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm4, %ymm3, %ymm3
; AVX-NEXT:    vmovdqa 32(%r9), %xmm4
; AVX-NEXT:    vmovdqa 32(%r8), %xmm8
; AVX-NEXT:    vpunpckhbw {{.*#+}} xmm5 = xmm8[8],xmm4[8],xmm8[9],xmm4[9],xmm8[10],xmm4[10],xmm8[11],xmm4[11],xmm8[12],xmm4[12],xmm8[13],xmm4[13],xmm8[14],xmm4[14],xmm8[15],xmm4[15]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm6 = xmm5[0,1,1,3,4,5,6,7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm9 = xmm5[2,1,3,3,4,5,6,7]
...
; AVX-NEXT:    vmovdqa 32(%rsi), %xmm9
; AVX-NEXT:    vmovdqa 32(%rdi), %xmm10
; AVX-NEXT:    vpunpckhbw {{.*#+}} xmm11 = xmm10[8],xmm9[8],xmm10[9],xmm9[9],xmm10[10],xmm9[10],xmm10[11],xmm9[11],xmm10[12],xmm9[12],xmm10[13],xmm9[13],xmm10[14],xmm9[14],xmm10[15],xmm9[15]
; AVX-NEXT:    vpshufd {{.*#+}} xmm6 = xmm11[1,1,1,1]
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm6 = xmm6[0],zero,zero,zero,xmm6[1],zero,zero,zero
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm12 = xmm11[0],zero,zero,zero,xmm11[1],zero,zero,zero
; AVX-NEXT:    vinsertf128 $1, %xmm6, %ymm12, %ymm6
; AVX-NEXT:    vmovdqa 32(%rcx), %xmm12
; AVX-NEXT:    vmovdqa 32(%rdx), %xmm13
; AVX-NEXT:    vpunpckhbw {{.*#+}} xmm14 = xmm13[8],xmm12[8],xmm13[9],xmm12[9],xmm13[10],xmm12[10],xmm13[11],xmm12[11],xmm13[12],xmm12[12],xmm13[13],xmm12[13],xmm13[14],xmm12[14],xmm13[15],xmm12[15]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm15 = xmm14[0,0,2,1,4,5,6,7]
; AVX-NEXT:    vpmovzxdq {{.*#+}} xmm15 = xmm15[0],zero,xmm15[1],zero
; AVX-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm14[0,2,2,3,4,5,6,7]
...
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm3, %ymm2
; AVX-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm5[0,1,2,3,4,5,5,7]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm5[0,1,2,3,6,5,7,7]
; AVX-NEXT:    vinsertf128 $1, %xmm5, %ymm3, %ymm3
...
; AVX-NEXT:    vandps %ymm6, %ymm3, %ymm3
; AVX-NEXT:    vorps %ymm2, %ymm3, %ymm2
; AVX-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm14[0,1,2,3,4,4,6,5]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm14[0,1,2,3,4,6,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm5, %ymm3, %ymm3
; AVX-NEXT:    vpshufd {{.*#+}} xmm5 = xmm11[2,3,2,3]
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm5 = xmm5[0],zero,zero,zero,xmm5[1],zero,zero,zero
; AVX-NEXT:    vpshufd {{.*#+}} xmm7 = xmm11[3,3,3,3]
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm7 = xmm7[0],zero,zero,zero,xmm7[1],zero,zero,zero
...
; AVX-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm0[0,2,2,3,4,5,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm1, %ymm1
; AVX-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm8[0],xmm4[0],xmm8[1],xmm4[1],xmm8[2],xmm4[2],xmm8[3],xmm4[3],xmm8[4],xmm4[4],xmm8[5],xmm4[5],xmm8[6],xmm4[6],xmm8[7],xmm4[7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[0,1,1,3,4,5,6,7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm2[2,1,3,3,4,5,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm4, %ymm3, %ymm3
; AVX-NEXT:    vshufps {{.*#+}} ymm1 = ymm1[0,0,2,1,4,4,6,5]
; AVX-NEXT:    vandnps %ymm1, %ymm6, %ymm1
; AVX-NEXT:    vshufps {{.*#+}} ymm3 = ymm3[0,0,2,1,4,4,6,5]
; AVX-NEXT:    vandps %ymm6, %ymm3, %ymm3
; AVX-NEXT:    vorps %ymm1, %ymm3, %ymm1
; AVX-NEXT:    vpunpcklbw {{.*#+}} xmm3 = xmm10[0],xmm9[0],xmm10[1],xmm9[1],xmm10[2],xmm9[2],xmm10[3],xmm9[3],xmm10[4],xmm9[4],xmm10[5],xmm9[5],xmm10[6],xmm9[6],xmm10[7],xmm9[7]
; AVX-NEXT:    vpshufd {{.*#+}} xmm4 = xmm3[1,1,1,1]
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm4 = xmm4[0],zero,zero,zero,xmm4[1],zero,zero,zero
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm7 = xmm3[0],zero,zero,zero,xmm3[1],zero,zero,zero
; AVX-NEXT:    vinsertf128 $1, %xmm4, %ymm7, %ymm4
; AVX-NEXT:    vpunpcklbw {{.*#+}} xmm7 = xmm13[0],xmm12[0],xmm13[1],xmm12[1],xmm13[2],xmm12[2],xmm13[3],xmm12[3],xmm13[4],xmm12[4],xmm13[5],xmm12[5],xmm13[6],xmm12[6],xmm13[7],xmm12[7]
...
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm4[0],ymm1[1],ymm4[2],ymm1[3],ymm4[4],ymm1[5],ymm4[6],ymm1[7]
; AVX-NEXT:    vmovups %ymm1, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm0[0,1,2,3,4,4,6,5]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm1, %ymm0
...
; AVX-NEXT:    vorps %ymm0, %ymm1, %ymm0
; AVX-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm7[0,1,2,3,4,4,6,5]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm7[0,1,2,3,4,6,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm2, %ymm1, %ymm1
; AVX-NEXT:    vpshufd {{.*#+}} xmm2 = xmm3[2,3,2,3]
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm2 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero
; AVX-NEXT:    vpshufd {{.*#+}} xmm3 = xmm3[3,3,3,3]
...
; AVX-NEXT:    vpunpckhbw {{.*#+}} xmm7 = xmm3[8],xmm4[8],xmm3[9],xmm4[9],xmm3[10],xmm4[10],xmm3[11],xmm4[11],xmm3[12],xmm4[12],xmm3[13],xmm4[13],xmm3[14],xmm4[14],xmm3[15],xmm4[15]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm7[0,0,2,1,4,5,6,7]
...
; AVX-NEXT:    vpunpckhbw {{.*#+}} xmm10 = xmm8[8],xmm0[8],xmm8[9],xmm0[9],xmm8[10],xmm0[10],xmm8[11],xmm0[11],xmm8[12],xmm0[12],xmm8[13],xmm0[13],xmm8[14],xmm0[14],xmm8[15],xmm0[15]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm10[0,1,1,3,4,5,6,7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm12 = xmm10[2,1,3,3,4,5,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm12, %ymm11, %ymm11
; AVX-NEXT:    vshufps {{.*#+}} ymm1 = ymm1[0,0,2,1,4,4,6,5]
; AVX-NEXT:    vandnps %ymm1, %ymm6, %ymm1
; AVX-NEXT:    vshufps {{.*#+}} ymm11 = ymm11[0,0,2,1,4,4,6,5]
; AVX-NEXT:    vandps %ymm6, %ymm11, %ymm11
; AVX-NEXT:    vorps %ymm1, %ymm11, %ymm2
; AVX-NEXT:    vmovdqa 16(%rsi), %xmm11
; AVX-NEXT:    vmovdqa 16(%rdi), %xmm12
; AVX-NEXT:    vpunpckhbw {{.*#+}} xmm13 = xmm12[8],xmm11[8],xmm12[9],xmm11[9],xmm12[10],xmm11[10],xmm12[11],xmm11[11],xmm12[12],xmm11[12],xmm12[13],xmm11[13],xmm12[14],xmm11[14],xmm12[15],xmm11[15]
; AVX-NEXT:    vpshufd {{.*#+}} xmm14 = xmm13[1,1,1,1]
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm14 = xmm14[0],zero,zero,zero,xmm14[1],zero,zero,zero
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm15 = xmm13[0],zero,zero,zero,xmm13[1],zero,zero,zero
; AVX-NEXT:    vinsertf128 $1, %xmm14, %ymm15, %ymm14
; AVX-NEXT:    vmovdqa 16(%rcx), %xmm15
; AVX-NEXT:    vmovdqa 16(%rdx), %xmm9
; AVX-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm9[8],xmm15[8],xmm9[9],xmm15[9],xmm9[10],xmm15[10],xmm9[11],xmm15[11],xmm9[12],xmm15[12],xmm9[13],xmm15[13],xmm9[14],xmm15[14],xmm9[15],xmm15[15]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm6 = xmm0[0,0,2,1,4,5,6,7]
; AVX-NEXT:    vpmovzxdq {{.*#+}} xmm6 = xmm6[0],zero,xmm6[1],zero
; AVX-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm0[0,2,2,3,4,5,6,7]
; AVX-NEXT:    vpmovzxdq {{.*#+}} xmm5 = xmm5[0],zero,xmm5[1],zero
; AVX-NEXT:    vinsertf128 $1, %xmm5, %ymm6, %ymm5
; AVX-NEXT:    vbroadcastsd {{.*#+}} ymm1 = [65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535]
; AVX-NEXT:    vandps %ymm1, %ymm14, %ymm6
; AVX-NEXT:    vandnps %ymm5, %ymm1, %ymm5
; AVX-NEXT:    vorps %ymm5, %ymm6, %ymm5
; AVX-NEXT:    vblendps {{.*#+}} ymm1 = ymm5[0],ymm2[1],ymm5[2],ymm2[3],ymm5[4],ymm2[5],ymm5[6],ymm2[7]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm7[0,1,2,3,4,4,6,5]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm6 = xmm7[0,1,2,3,4,6,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm6, %ymm5, %ymm5
; AVX-NEXT:    vpshufhw {{.*#+}} xmm6 = xmm10[0,1,2,3,4,5,5,7]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm7 = xmm10[0,1,2,3,6,5,7,7]
...
; AVX-NEXT:    vorps %ymm5, %ymm6, %ymm5
; AVX-NEXT:    vpshufhw {{.*#+}} xmm6 = xmm0[0,1,2,3,4,4,6,5]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm0, %ymm6, %ymm0
; AVX-NEXT:    vpshufd {{.*#+}} xmm6 = xmm13[2,3,2,3]
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm6 = xmm6[0],zero,zero,zero,xmm6[1],zero,zero,zero
; AVX-NEXT:    vpshufd {{.*#+}} xmm7 = xmm13[3,3,3,3]
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm7 = xmm7[0],zero,zero,zero,xmm7[1],zero,zero,zero
; AVX-NEXT:    vinsertf128 $1, %xmm7, %ymm6, %ymm6
; AVX-NEXT:    vshufps {{.*#+}} ymm0 = ymm0[2,1,3,3,6,5,7,7]
; AVX-NEXT:    vbroadcastsd {{.*#+}} ymm10 = [65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535]
; AVX-NEXT:    vandnps %ymm0, %ymm10, %ymm0
; AVX-NEXT:    vandps %ymm6, %ymm10, %ymm6
; AVX-NEXT:    vorps %ymm0, %ymm6, %ymm0
; AVX-NEXT:    vblendps {{.*#+}} ymm0 = ymm0[0],ymm5[1],ymm0[2],ymm5[3],ymm0[4],ymm5[5],ymm0[6],ymm5[7]
...
; AVX-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm3[0,2,2,3,4,5,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm5, %ymm4, %ymm4
; AVX-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm8, %xmm5 # 16-byte Folded Reload
; AVX-NEXT:    # xmm5 = xmm8[0],mem[0],xmm8[1],mem[1],xmm8[2],mem[2],xmm8[3],mem[3],xmm8[4],mem[4],xmm8[5],mem[5],xmm8[6],mem[6],xmm8[7],mem[7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm6 = xmm5[0,1,1,3,4,5,6,7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm5[2,1,3,3,4,5,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm7, %ymm6, %ymm6
...
; AVX-NEXT:    vpunpcklbw {{.*#+}} xmm6 = xmm12[0],xmm11[0],xmm12[1],xmm11[1],xmm12[2],xmm11[2],xmm12[3],xmm11[3],xmm12[4],xmm11[4],xmm12[5],xmm11[5],xmm12[6],xmm11[6],xmm12[7],xmm11[7]
; AVX-NEXT:    vpshufd {{.*#+}} xmm7 = xmm6[1,1,1,1]
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm7 = xmm7[0],zero,zero,zero,xmm7[1],zero,zero,zero
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm8 = xmm6[0],zero,zero,zero,xmm6[1],zero,zero,zero
; AVX-NEXT:    vinsertf128 $1, %xmm7, %ymm8, %ymm7
; AVX-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm9[0],xmm15[0],xmm9[1],xmm15[1],xmm9[2],xmm15[2],xmm9[3],xmm15[3],xmm9[4],xmm15[4],xmm9[5],xmm15[5],xmm9[6],xmm15[6],xmm9[7],xmm15[7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm8 = xmm2[0,0,2,1,4,5,6,7]
; AVX-NEXT:    vpmovzxdq {{.*#+}} xmm8 = xmm8[0],zero,xmm8[1],zero
; AVX-NEXT:    vpshuflw {{.*#+}} xmm9 = xmm2[0,2,2,3,4,5,6,7]
; AVX-NEXT:    vpmovzxdq {{.*#+}} xmm9 = xmm9[0],zero,xmm9[1],zero
; AVX-NEXT:    vinsertf128 $1, %xmm9, %ymm8, %ymm8
; AVX-NEXT:    vmovaps %ymm10, %ymm12
; AVX-NEXT:    vandps %ymm7, %ymm10, %ymm7
; AVX-NEXT:    vandnps %ymm8, %ymm10, %ymm8
; AVX-NEXT:    vorps %ymm7, %ymm8, %ymm7
; AVX-NEXT:    vblendps {{.*#+}} ymm4 = ymm7[0],ymm4[1],ymm7[2],ymm4[3],ymm7[4],ymm4[5],ymm7[6],ymm4[7]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm7 = xmm3[0,1,2,3,4,4,6,5]
...
; AVX-NEXT:    vorps %ymm3, %ymm5, %ymm3
; AVX-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm2[0,1,2,3,4,4,6,5]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,4,6,6,7]
...
; AVX-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Reload
; AVX-NEXT:    vpunpckhbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm3, %xmm3 # 16-byte Folded Reload
; AVX-NEXT:    # xmm3 = xmm3[8],mem[8],xmm3[9],mem[9],xmm3[10],mem[10],xmm3[11],mem[11],xmm3[12],mem[12],xmm3[13],mem[13],xmm3[14],mem[14],xmm3[15],mem[15]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm3[0,0,2,1,4,5,6,7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm6 = xmm3[0,2,2,3,4,5,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm6, %ymm5, %ymm5
; AVX-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm6 # 16-byte Reload
; AVX-NEXT:    vpunpckhbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm6, %xmm6 # 16-byte Folded Reload
; AVX-NEXT:    # xmm6 = xmm6[8],mem[8],xmm6[9],mem[9],xmm6[10],mem[10],xmm6[11],mem[11],xmm6[12],mem[12],xmm6[13],mem[13],xmm6[14],mem[14],xmm6[15],mem[15]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm6[0,1,1,3,4,5,6,7]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm8 = xmm6[2,1,3,3,4,5,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm8, %ymm7, %ymm7
; AVX-NEXT:    vshufps {{.*#+}} ymm5 = ymm5[0,0,2,1,4,4,6,5]
; AVX-NEXT:    vandnps %ymm5, %ymm14, %ymm5
...
; AVX-NEXT:    vpshufd {{.*#+}} xmm8 = xmm7[1,1,1,1]
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm8 = xmm8[0],zero,zero,zero,xmm8[1],zero,zero,zero
; AVX-NEXT:    vpmovzxwq {{.*#+}} xmm9 = xmm7[0],zero,zero,zero,xmm7[1],zero,zero,zero
; AVX-NEXT:    vinsertf128 $1, %xmm8, %ymm9, %ymm8
; AVX-NEXT:    vmovdqa (%rsp), %xmm9 # 16-byte Reload
; AVX-NEXT:    vpunpckhbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm9, %xmm9 # 16-byte Folded Reload
; AVX-NEXT:    # xmm9 = xmm9[8],mem[8],xmm9[9],mem[9],xmm9[10],mem[10],xmm9[11],mem[11],xmm9[12],mem[12],xmm9[13],mem[13],xmm9[14],mem[14],xmm9[15],mem[15]
; AVX-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm9[0,0,2,1,4,5,6,7]
; AVX-NEXT:    vpmovzxdq {{.*#+}} xmm10 = xmm10[0],zero,xmm10[1],zero
; AVX-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm9[0,2,2,3,4,5,6,7]
; AVX-NEXT:    vpmovzxdq {{.*#+}} xmm11 = xmm11[0],zero,xmm11[1],zero
; AVX-NEXT:    vinsertf128 $1, %xmm11, %ymm10, %ymm10
; AVX-NEXT:    vandps %ymm12, %ymm8, %ymm8
; AVX-NEXT:    vandnps %ymm10, %ymm12, %ymm10
; AVX-NEXT:    vorps %ymm10, %ymm8, %ymm8
; AVX-NEXT:    vblendps {{.*#+}} ymm5 = ymm8[0],ymm5[1],ymm8[2],ymm5[3],ymm8[4],ymm5[5],ymm8[6],ymm5[7]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm3[0,1,2,3,4,4,6,5]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm3[0,1,2,3,4,6,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm3, %ymm8, %ymm3
; AVX-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm6[0,1,2,3,4,5,5,7]
...
; AVX-NEXT:    vandps %ymm6, %ymm14, %ymm6
; AVX-NEXT:    vorps %ymm3, %ymm6, %ymm3
; AVX-NEXT:    vpshufhw {{.*#+}} xmm6 = xmm9[0,1,2,3,4,4,6,5]
; AVX-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm9[0,1,2,3,4,6,6,7]
; AVX-NEXT:    vinsertf128 $1, %xmm8, %ymm6, %ymm6
...
; AVX-NEXT:    vmovups {{[-0-9]+}}(%r{{[sb]}}p), %ymm0 # 32-byte Reload
; AVX-NEXT:    vmovaps %ymm0, 32(%rax)
; AVX-NEXT:    addq $344, %rsp # imm = 0x158
; AVX-NEXT:    vzeroupper
; AVX-NEXT:    retq
;
...
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm1[0,1,2,3,4,6,6,7]
...
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm3[0,1,2,3,4,5,5,7]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm7 = xmm3[0,1,2,3,6,5,7,7]
; AVX2-NEXT:    vinserti128 $1, %xmm7, %ymm5, %ymm5
; AVX2-NEXT:    vpblendw {{.*#+}} ymm2 = ymm5[0,1,2,3,4],ymm2[5],ymm5[6],ymm2[7],ymm5[8,9,10,11,12],ymm2[13],ymm5[14],ymm2[15]
; AVX2-NEXT:    vmovdqa (%rcx), %xmm0
; AVX2-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-NEXT:    vmovdqa (%rdx), %xmm4
; AVX2-NEXT:    vmovdqa %xmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-NEXT:    vpunpcklbw {{.*#+}} xmm13 = xmm4[0],xmm0[0],xmm4[1],xmm0[1],xmm4[2],xmm0[2],xmm4[3],xmm0[3],xmm4[4],xmm0[4],xmm4[5],xmm0[5],xmm4[6],xmm0[6],xmm4[7],xmm0[7]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm13[0,1,2,3,4,4,6,5]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm13[0,1,2,3,4,6,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm9, %ymm8, %ymm8
; AVX2-NEXT:    vpshufd {{.*#+}} ymm11 = ymm8[2,1,3,3,6,5,7,7]
; AVX2-NEXT:    vmovdqa (%rsi), %xmm0
; AVX2-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-NEXT:    vmovdqa (%rdi), %xmm4
; AVX2-NEXT:    vmovdqa %xmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-NEXT:    vpunpcklbw {{.*#+}} xmm14 = xmm4[0],xmm0[0],xmm4[1],xmm0[1],xmm4[2],xmm0[2],xmm4[3],xmm0[3],xmm4[4],xmm0[4],xmm4[5],xmm0[5],xmm4[6],xmm0[6],xmm4[7],xmm0[7]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm15 = xmm14[2,3,2,3]
; AVX2-NEXT:    vpmovzxwq {{.*#+}} ymm15 = xmm15[0],zero,zero,zero,xmm15[1],zero,zero,zero,xmm15[2],zero,zero,zero,xmm15[3],zero,zero,zero
; AVX2-NEXT:    vpblendw {{.*#+}} ymm11 = ymm15[0],ymm11[1],ymm15[2,3,4],ymm11[5],ymm15[6,7,8],ymm11[9],ymm15[10,11,12],ymm11[13],ymm15[14,15]
; AVX2-NEXT:    vmovdqa 48(%rax), %xmm15
; AVX2-NEXT:    vpshufd {{.*#+}} ymm2 = ymm2[0,2,2,3,4,6,6,7]
; AVX2-NEXT:    vpblendd {{.*#+}} ymm0 = ymm11[0],ymm2[1],ymm11[2],ymm2[3],ymm11[4],ymm2[5],ymm11[6],ymm2[7]
; AVX2-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-NEXT:    vinserti128 $1, %xmm3, %ymm2, %ymm2
; AVX2-NEXT:    vpblendw {{.*#+}} ymm1 = ymm2[0],ymm1[1],ymm2[2],ymm1[3],ymm2[4,5,6,7,8],ymm1[9],ymm2[10],ymm1[11],ymm2[12,13,14,15]
; AVX2-NEXT:    vpshufd {{.*#+}} ymm1 = ymm1[0,0,2,1,4,4,6,5]
; AVX2-NEXT:    vpmovzxwq {{.*#+}} ymm2 = xmm14[0],zero,zero,zero,xmm14[1],zero,zero,zero,xmm14[2],zero,zero,zero,xmm14[3],zero,zero,zero
; AVX2-NEXT:    vmovdqa {{.*#+}} xmm9 = [0,1,0,1,4,5,2,3,0,1,4,5,4,5,6,7]
; AVX2-NEXT:    vpshufb %xmm9, %xmm13, %xmm3
...
; AVX2-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm15[8],xmm6[8],xmm15[9],xmm6[9],xmm15[10],xmm6[10],xmm15[11],xmm6[11],xmm15[12],xmm6[12],xmm15[13],xmm6[13],xmm15[14],xmm6[14],xmm15[15],xmm6[15]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm1[0,0,2,1,4,5,6,7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm1[0,2,2,3,4,5,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm3, %ymm2, %ymm2
; AVX2-NEXT:    vmovdqa 48(%r9), %xmm6
; AVX2-NEXT:    vmovdqa 48(%r8), %xmm13
; AVX2-NEXT:    vpunpckhbw {{.*#+}} xmm14 = xmm13[8],xmm6[8],xmm13[9],xmm6[9],xmm13[10],xmm6[10],xmm13[11],xmm6[11],xmm13[12],xmm6[12],xmm13[13],xmm6[13],xmm13[14],xmm6[14],xmm13[15],xmm6[15]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm14[0,1,1,3,4,5,6,7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm12 = xmm14[2,1,3,3,4,5,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm12, %ymm0, %ymm0
; AVX2-NEXT:    vpblendw {{.*#+}} ymm3 = ymm0[0],ymm2[1],ymm0[2],ymm2[3],ymm0[4,5,6,7,8],ymm2[9],ymm0[10],ymm2[11],ymm0[12,13,14,15]
; AVX2-NEXT:    vmovdqa 48(%rcx), %xmm7
; AVX2-NEXT:    vmovdqa 48(%rdx), %xmm12
; AVX2-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm12[8],xmm7[8],xmm12[9],xmm7[9],xmm12[10],xmm7[10],xmm12[11],xmm7[11],xmm12[12],xmm7[12],xmm12[13],xmm7[13],xmm12[14],xmm7[14],xmm12[15],xmm7[15]
; AVX2-NEXT:    vpshufb %xmm9, %xmm0, %xmm10
; AVX2-NEXT:    vpmovzxdq {{.*#+}} ymm10 = xmm10[0],zero,xmm10[1],zero,xmm10[2],zero,xmm10[3],zero
; AVX2-NEXT:    vmovdqa 48(%rsi), %xmm5
; AVX2-NEXT:    vmovdqa 48(%rdi), %xmm4
; AVX2-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm4[8],xmm5[8],xmm4[9],xmm5[9],xmm4[10],xmm5[10],xmm4[11],xmm5[11],xmm4[12],xmm5[12],xmm4[13],xmm5[13],xmm4[14],xmm5[14],xmm4[15],xmm5[15]
; AVX2-NEXT:    vpmovzxwq {{.*#+}} ymm8 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero,xmm2[2],zero,zero,zero,xmm2[3],zero,zero,zero
; AVX2-NEXT:    vpblendw {{.*#+}} ymm8 = ymm8[0],ymm10[1],ymm8[2,3,4],ymm10[5],ymm8[6,7,8],ymm10[9],ymm8[10,11,12],ymm10[13],ymm8[14,15]
; AVX2-NEXT:    vpshufd {{.*#+}} ymm3 = ymm3[0,0,2,1,4,4,6,5]
; AVX2-NEXT:    vpblendd {{.*#+}} ymm3 = ymm8[0],ymm3[1],ymm8[2],ymm3[3],ymm8[4],ymm3[5],ymm8[6],ymm3[7]
...
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm14[0,1,2,3,4,5,5,7]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm14[0,1,2,3,6,5,7,7]
; AVX2-NEXT:    vinserti128 $1, %xmm8, %ymm3, %ymm3
; AVX2-NEXT:    vpblendw {{.*#+}} ymm1 = ymm3[0,1,2,3,4],ymm1[5],ymm3[6],ymm1[7],ymm3[8,9,10,11,12],ymm1[13],ymm3[14],ymm1[15]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm0[0,1,2,3,4,4,6,5]
...
; AVX2-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0],ymm1[1],ymm0[2],ymm1[3],ymm0[4],ymm1[5],ymm0[6],ymm1[7]
; AVX2-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm15[0],xmm11[0],xmm15[1],xmm11[1],xmm15[2],xmm11[2],xmm15[3],xmm11[3],xmm15[4],xmm11[4],xmm15[5],xmm11[5],xmm15[6],xmm11[6],xmm15[7],xmm11[7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm0[0,0,2,1,4,5,6,7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm0[0,2,2,3,4,5,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm2, %ymm1, %ymm1
; AVX2-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm13[0],xmm6[0],xmm13[1],xmm6[1],xmm13[2],xmm6[2],xmm13[3],xmm6[3],xmm13[4],xmm6[4],xmm13[5],xmm6[5],xmm13[6],xmm6[6],xmm13[7],xmm6[7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[0,1,1,3,4,5,6,7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm6 = xmm2[2,1,3,3,4,5,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm6, %ymm3, %ymm3
; AVX2-NEXT:    vpblendw {{.*#+}} ymm1 = ymm3[0],ymm1[1],ymm3[2],ymm1[3],ymm3[4,5,6,7,8],ymm1[9],ymm3[10],ymm1[11],ymm3[12,13,14,15]
; AVX2-NEXT:    vpunpcklbw {{.*#+}} xmm3 = xmm4[0],xmm5[0],xmm4[1],xmm5[1],xmm4[2],xmm5[2],xmm4[3],xmm5[3],xmm4[4],xmm5[4],xmm4[5],xmm5[5],xmm4[6],xmm5[6],xmm4[7],xmm5[7]
; AVX2-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm12[0],xmm7[0],xmm12[1],xmm7[1],xmm12[2],xmm7[2],xmm12[3],xmm7[3],xmm12[4],xmm7[4],xmm12[5],xmm7[5],xmm12[6],xmm7[6],xmm12[7],xmm7[7]
; AVX2-NEXT:    vmovdqa %xmm9, %xmm13
; AVX2-NEXT:    vpshufb %xmm9, %xmm4, %xmm5
; AVX2-NEXT:    vpmovzxdq {{.*#+}} ymm5 = xmm5[0],zero,xmm5[1],zero,xmm5[2],zero,xmm5[3],zero
...
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm4[0,1,2,3,4,6,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm2, %ymm1, %ymm1
; AVX2-NEXT:    vpshufd {{.*#+}} ymm1 = ymm1[2,1,3,3,6,5,7,7]
; AVX2-NEXT:    vpshufd {{.*#+}} xmm2 = xmm3[2,3,2,3]
; AVX2-NEXT:    vpmovzxwq {{.*#+}} ymm2 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero,xmm2[2],zero,zero,zero,xmm2[3],zero,zero,zero
...
; AVX2-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vmovdqa 32(%r10), %xmm11
; AVX2-NEXT:    vmovdqa 32(%rax), %xmm9
; AVX2-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm9[8],xmm11[8],xmm9[9],xmm11[9],xmm9[10],xmm11[10],xmm9[11],xmm11[11],xmm9[12],xmm11[12],xmm9[13],xmm11[13],xmm9[14],xmm11[14],xmm9[15],xmm11[15]
...
; AVX2-NEXT:    vpunpckhbw {{.*#+}} xmm6 = xmm5[8],xmm4[8],xmm5[9],xmm4[9],xmm5[10],xmm4[10],xmm5[11],xmm4[11],xmm5[12],xmm4[12],xmm5[13],xmm4[13],xmm5[14],xmm4[14],xmm5[15],xmm4[15]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm6[0,1,1,3,4,5,6,7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm8 = xmm6[2,1,3,3,4,5,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm8, %ymm7, %ymm7
; AVX2-NEXT:    vpblendw {{.*#+}} ymm3 = ymm7[0],ymm3[1],ymm7[2],ymm3[3],ymm7[4,5,6,7,8],ymm3[9],ymm7[10],ymm3[11],ymm7[12,13,14,15]
; AVX2-NEXT:    vmovdqa 32(%rcx), %xmm7
; AVX2-NEXT:    vmovdqa 32(%rdx), %xmm8
; AVX2-NEXT:    vpunpckhbw {{.*#+}} xmm10 = xmm8[8],xmm7[8],xmm8[9],xmm7[9],xmm8[10],xmm7[10],xmm8[11],xmm7[11],xmm8[12],xmm7[12],xmm8[13],xmm7[13],xmm8[14],xmm7[14],xmm8[15],xmm7[15]
; AVX2-NEXT:    vpshufb %xmm13, %xmm10, %xmm12
; AVX2-NEXT:    vmovdqa %xmm13, %xmm14
; AVX2-NEXT:    vpmovzxdq {{.*#+}} ymm12 = xmm12[0],zero,xmm12[1],zero,xmm12[2],zero,xmm12[3],zero
; AVX2-NEXT:    vmovdqa 32(%rsi), %xmm15
; AVX2-NEXT:    vmovdqa 32(%rdi), %xmm1
; AVX2-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm1[8],xmm15[8],xmm1[9],xmm15[9],xmm1[10],xmm15[10],xmm1[11],xmm15[11],xmm1[12],xmm15[12],xmm1[13],xmm15[13],xmm1[14],xmm15[14],xmm1[15],xmm15[15]
; AVX2-NEXT:    vpmovzxwq {{.*#+}} ymm13 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero,xmm0[2],zero,zero,zero,xmm0[3],zero,zero,zero
; AVX2-NEXT:    vpblendw {{.*#+}} ymm12 = ymm13[0],ymm12[1],ymm13[2,3,4],ymm12[5],ymm13[6,7,8],ymm12[9],ymm13[10,11,12],ymm12[13],ymm13[14,15]
; AVX2-NEXT:    vpshufd {{.*#+}} ymm3 = ymm3[0,0,2,1,4,4,6,5]
; AVX2-NEXT:    vpblendd {{.*#+}} ymm3 = ymm12[0],ymm3[1],ymm12[2],ymm3[3],ymm12[4],ymm3[5],ymm12[6],ymm3[7]
; AVX2-NEXT:    vmovdqu %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm2[0,1,2,3,4,4,6,5]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,4,6,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm2, %ymm3, %ymm2
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm6[0,1,2,3,4,5,5,7]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm6 = xmm6[0,1,2,3,6,5,7,7]
; AVX2-NEXT:    vinserti128 $1, %xmm6, %ymm3, %ymm3
; AVX2-NEXT:    vpblendw {{.*#+}} ymm2 = ymm3[0,1,2,3,4],ymm2[5],ymm3[6],ymm2[7],ymm3[8,9,10,11,12],ymm2[13],ymm3[14],ymm2[15]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm10[0,1,2,3,4,4,6,5]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm6 = xmm10[0,1,2,3,4,6,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm6, %ymm3, %ymm3
...
; AVX2-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm9[0],xmm11[0],xmm9[1],xmm11[1],xmm9[2],xmm11[2],xmm9[3],xmm11[3],xmm9[4],xmm11[4],xmm9[5],xmm11[5],xmm9[6],xmm11[6],xmm9[7],xmm11[7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm2 = xmm0[0,0,2,1,4,5,6,7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm6 = xmm0[0,2,2,3,4,5,6,7]
...
; AVX2-NEXT:    vpblendw {{.*#+}} ymm2 = ymm5[0],ymm2[1],ymm5[2],ymm2[3],ymm5[4,5,6,7,8],ymm2[9],ymm5[10],ymm2[11],ymm5[12,13,14,15]
; AVX2-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm1[0],xmm15[0],xmm1[1],xmm15[1],xmm1[2],xmm15[2],xmm1[3],xmm15[3],xmm1[4],xmm15[4],xmm1[5],xmm15[5],xmm1[6],xmm15[6],xmm1[7],xmm15[7]
; AVX2-NEXT:    vpunpcklbw {{.*#+}} xmm5 = xmm8[0],xmm7[0],xmm8[1],xmm7[1],xmm8[2],xmm7[2],xmm8[3],xmm7[3],xmm8[4],xmm7[4],xmm8[5],xmm7[5],xmm8[6],xmm7[6],xmm8[7],xmm7[7]
; AVX2-NEXT:    vmovdqa %xmm14, %xmm12
; AVX2-NEXT:    vpshufb %xmm14, %xmm5, %xmm6
; AVX2-NEXT:    vpmovzxdq {{.*#+}} ymm6 = xmm6[0],zero,xmm6[1],zero,xmm6[2],zero,xmm6[3],zero
; AVX2-NEXT:    vpmovzxwq {{.*#+}} ymm7 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero,xmm1[2],zero,zero,zero,xmm1[3],zero,zero,zero
; AVX2-NEXT:    vpblendw {{.*#+}} ymm6 = ymm7[0],ymm6[1],ymm7[2,3,4],ymm6[5],ymm7[6,7,8],ymm6[9],ymm7[10,11,12],ymm6[13],ymm7[14,15]
; AVX2-NEXT:    vpshufd {{.*#+}} ymm2 = ymm2[0,0,2,1,4,4,6,5]
; AVX2-NEXT:    vpblendd {{.*#+}} ymm2 = ymm6[0],ymm2[1],ymm6[2],ymm2[3],ymm6[4],ymm2[5],ymm6[6],ymm2[7]
; AVX2-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm6 = xmm0[0,1,2,3,4,4,6,5]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,4,6,6,7]
...
; AVX2-NEXT:    vpblendw {{.*#+}} ymm0 = ymm4[0,1,2,3,4],ymm0[5],ymm4[6],ymm0[7],ymm4[8,9,10,11,12],ymm0[13],ymm4[14],ymm0[15]
...
; AVX2-NEXT:    vpblendw {{.*#+}} ymm1 = ymm1[0],ymm4[1],ymm1[2,3,4],ymm4[5],ymm1[6,7,8],ymm4[9],ymm1[10,11,12],ymm4[13],ymm1[14,15]
; AVX2-NEXT:    vpshufd {{.*#+}} ymm0 = ymm0[0,2,2,3,4,6,6,7]
; AVX2-NEXT:    vpblendd {{.*#+}} ymm0 = ymm1[0],ymm0[1],ymm1[2],ymm0[3],ymm1[4],ymm0[5],ymm1[6],ymm0[7]
; AVX2-NEXT:    vmovdqu %ymm0, (%rsp) # 32-byte Spill
; AVX2-NEXT:    vmovdqa 16(%r10), %xmm4
; AVX2-NEXT:    vmovdqa 16(%rax), %xmm5
; AVX2-NEXT:    vpunpckhbw {{.*#+}} xmm6 = xmm5[8],xmm4[8],xmm5[9],xmm4[9],xmm5[10],xmm4[10],xmm5[11],xmm4[11],xmm5[12],xmm4[12],xmm5[13],xmm4[13],xmm5[14],xmm4[14],xmm5[15],xmm4[15]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm0 = xmm6[0,0,2,1,4,5,6,7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm6[0,2,2,3,4,5,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm7, %ymm0, %ymm0
; AVX2-NEXT:    vmovdqa 16(%r9), %xmm7
; AVX2-NEXT:    vmovdqa 16(%r8), %xmm8
; AVX2-NEXT:    vpunpckhbw {{.*#+}} xmm9 = xmm8[8],xmm7[8],xmm8[9],xmm7[9],xmm8[10],xmm7[10],xmm8[11],xmm7[11],xmm8[12],xmm7[12],xmm8[13],xmm7[13],xmm8[14],xmm7[14],xmm8[15],xmm7[15]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm9[0,1,1,3,4,5,6,7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm9[2,1,3,3,4,5,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm11, %ymm10, %ymm10
; AVX2-NEXT:    vpblendw {{.*#+}} ymm1 = ymm10[0],ymm0[1],ymm10[2],ymm0[3],ymm10[4,5,6,7,8],ymm0[9],ymm10[10],ymm0[11],ymm10[12,13,14,15]
; AVX2-NEXT:    vmovdqa 16(%rcx), %xmm10
; AVX2-NEXT:    vmovdqa 16(%rdx), %xmm11
; AVX2-NEXT:    vpunpckhbw {{.*#+}} xmm13 = xmm11[8],xmm10[8],xmm11[9],xmm10[9],xmm11[10],xmm10[10],xmm11[11],xmm10[11],xmm11[12],xmm10[12],xmm11[13],xmm10[13],xmm11[14],xmm10[14],xmm11[15],xmm10[15]
; AVX2-NEXT:    vpshufb %xmm14, %xmm13, %xmm15
...
; AVX2-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm2[8],xmm3[8],xmm2[9],xmm3[9],xmm2[10],xmm3[10],xmm2[11],xmm3[11],xmm2[12],xmm3[12],xmm2[13],xmm3[13],xmm2[14],xmm3[14],xmm2[15],xmm3[15]
; AVX2-NEXT:    vpmovzxwq {{.*#+}} ymm14 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero,xmm0[2],zero,zero,zero,xmm0[3],zero,zero,zero
; AVX2-NEXT:    vpblendw {{.*#+}} ymm14 = ymm14[0],ymm15[1],ymm14[2,3,4],ymm15[5],ymm14[6,7,8],ymm15[9],ymm14[10,11,12],ymm15[13],ymm14[14,15]
; AVX2-NEXT:    vpshufd {{.*#+}} ymm1 = ymm1[0,0,2,1,4,4,6,5]
; AVX2-NEXT:    vpblendd {{.*#+}} ymm15 = ymm14[0],ymm1[1],ymm14[2],ymm1[3],ymm14[4],ymm1[5],ymm14[6],ymm1[7]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm6[0,1,2,3,4,4,6,5]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm6 = xmm6[0,1,2,3,4,6,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm6, %ymm1, %ymm1
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm6 = xmm9[0,1,2,3,4,5,5,7]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm9[0,1,2,3,6,5,7,7]
; AVX2-NEXT:    vinserti128 $1, %xmm9, %ymm6, %ymm6
; AVX2-NEXT:    vpblendw {{.*#+}} ymm1 = ymm6[0,1,2,3,4],ymm1[5],ymm6[6],ymm1[7],ymm6[8,9,10,11,12],ymm1[13],ymm6[14],ymm1[15]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm6 = xmm13[0,1,2,3,4,4,6,5]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm13[0,1,2,3,4,6,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm9, %ymm6, %ymm6
...
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm1[0,2,2,3,4,5,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm5, %ymm4, %ymm4
; AVX2-NEXT:    vpunpcklbw {{.*#+}} xmm5 = xmm8[0],xmm7[0],xmm8[1],xmm7[1],xmm8[2],xmm7[2],xmm8[3],xmm7[3],xmm8[4],xmm7[4],xmm8[5],xmm7[5],xmm8[6],xmm7[6],xmm8[7],xmm7[7]
...
; AVX2-NEXT:    vpunpcklbw {{.*#+}} xmm3 = xmm11[0],xmm10[0],xmm11[1],xmm10[1],xmm11[2],xmm10[2],xmm11[3],xmm10[3],xmm11[4],xmm10[4],xmm11[5],xmm10[5],xmm11[6],xmm10[6],xmm11[7],xmm10[7]
; AVX2-NEXT:    vpshufb %xmm12, %xmm3, %xmm6
; AVX2-NEXT:    vpmovzxdq {{.*#+}} ymm6 = xmm6[0],zero,xmm6[1],zero,xmm6[2],zero,xmm6[3],zero
; AVX2-NEXT:    vpmovzxwq {{.*#+}} ymm7 = xmm2[0],zero,zero,zero,xmm2[1],zero,zero,zero,xmm2[2],zero,zero,zero,xmm2[3],zero,zero,zero
; AVX2-NEXT:    vpblendw {{.*#+}} ymm6 = ymm7[0],ymm6[1],ymm7[2,3,4],ymm6[5],ymm7[6,7,8],ymm6[9],ymm7[10,11,12],ymm6[13],ymm7[14,15]
...
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm6 = xmm1[0,1,2,3,4,4,6,5]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,4,6,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm1, %ymm6, %ymm1
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm6 = xmm5[0,1,2,3,4,5,5,7]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm5[0,1,2,3,6,5,7,7]
; AVX2-NEXT:    vinserti128 $1, %xmm5, %ymm6, %ymm5
; AVX2-NEXT:    vpblendw {{.*#+}} ymm1 = ymm5[0,1,2,3,4],ymm1[5],ymm5[6],ymm1[7],ymm5[8,9,10,11,12],ymm1[13],ymm5[14],ymm1[15]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm3[0,1,2,3,4,4,6,5]
...
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[0,0,2,1,4,5,6,7]
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm2[0,2,2,3,4,5,6,7]
...
; AVX2-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm5[2,1,3,3,4,5,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm7, %ymm6, %ymm6
; AVX2-NEXT:    vpblendw {{.*#+}} ymm3 = ymm6[0],ymm3[1],ymm6[2],ymm3[3],ymm6[4,5,6,7,8],ymm3[9],ymm6[10],ymm3[11],ymm6[12,13,14,15]
...
; AVX2-NEXT:    vpshufb %xmm12, %xmm7, %xmm8
; AVX2-NEXT:    vpmovzxdq {{.*#+}} ymm8 = xmm8[0],zero,xmm8[1],zero,xmm8[2],zero,xmm8[3],zero
; AVX2-NEXT:    vpmovzxwq {{.*#+}} ymm9 = xmm6[0],zero,zero,zero,xmm6[1],zero,zero,zero,xmm6[2],zero,zero,zero,xmm6[3],zero,zero,zero
; AVX2-NEXT:    vpblendw {{.*#+}} ymm8 = ymm9[0],ymm8[1],ymm9[2,3,4],ymm8[5],ymm9[6,7,8],ymm8[9],ymm9[10,11,12],ymm8[13],ymm9[14,15]
; AVX2-NEXT:    vpshufd {{.*#+}} ymm3 = ymm3[0,0,2,1,4,4,6,5]
; AVX2-NEXT:    vpblendd {{.*#+}} ymm3 = ymm8[0],ymm3[1],ymm8[2],ymm3[3],ymm8[4],ymm3[5],ymm8[6],ymm3[7]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm2[0,1,2,3,4,4,6,5]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,4,6,6,7]
; AVX2-NEXT:    vinserti128 $1, %xmm2, %ymm8, %ymm2
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm5[0,1,2,3,4,5,5,7]
; AVX2-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm5[0,1,2,3,6,5,7,7]
...
; AVX2-NEXT:    vpblendw {{.*#+}} ymm5 = ymm6[0],ymm5[1],ymm6[2,3,4],ymm5[5],ymm6[6,7,8],ymm5[9],ymm6[10,11,12],ymm5[13],ymm6[14,15]
; AVX2-NEXT:    vpshufd {{.*#+}} ymm2 = ymm2[0,2,2,3,4,6,6,7]
; AVX2-NEXT:    vpblendd {{.*#+}} ymm2 = ymm5[0],ymm2[1],ymm5[2],ymm2[3],ymm5[4],ymm2[5],ymm5[6],ymm2[7]
; AVX2-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX2-NEXT:    vmovdqa %ymm2, 96(%rax)
; AVX2-NEXT:    vmovdqa %ymm3, 64(%rax)
; AVX2-NEXT:    vmovdqa %ymm1, 160(%rax)
; AVX2-NEXT:    vmovdqa %ymm4, 128(%rax)
...
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm0[0],xmm1[0],xmm0[1],xmm1[1],xmm0[2],xmm1[2],xmm0[3],xmm1[3],xmm0[4],xmm1[4],xmm0[5],xmm1[5],xmm0[6],xmm1[6],xmm0[7],xmm1[7]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm1
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm0 = ymm1[0,1,2,3,8,9,8,9,8,9,8,9,12,13,10,11,16,17,18,19,24,25,28,29,24,25,28,29,28,29,30,31]
...
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm2[0],xmm3[0],xmm2[1],xmm3[1],xmm2[2],xmm3[2],xmm2[3],xmm3[3],xmm2[4],xmm3[4],xmm2[5],xmm3[5],xmm2[6],xmm3[6],xmm2[7],xmm3[7]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm5 = ymm2[0,1,2,3,8,9,10,11,8,9,10,11,10,11,14,15,16,17,18,19,28,29,26,27,28,29,26,27,30,31,30,31]
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm5[0,1,2],ymm0[3],ymm5[4,5,6],ymm0[7],ymm5[8,9,10],ymm0[11],ymm5[12,13,14],ymm0[15]
; AVX2-FP-NEXT:    vmovdqa (%rcx), %xmm3
; AVX2-FP-NEXT:    vmovdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FP-NEXT:    vmovdqa (%rdx), %xmm4
; AVX2-FP-NEXT:    vmovdqa %xmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm5 = xmm4[0],xmm3[0],xmm4[1],xmm3[1],xmm4[2],xmm3[2],xmm4[3],xmm3[3],xmm4[4],xmm3[4],xmm4[5],xmm3[5],xmm4[6],xmm3[6],xmm4[7],xmm3[7]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm5, %ymm5, %ymm5
; AVX2-FP-NEXT:    vmovdqa (%rsi), %xmm3
; AVX2-FP-NEXT:    vmovdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FP-NEXT:    vmovdqa (%rdi), %xmm4
; AVX2-FP-NEXT:    vmovdqa %xmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm6 = xmm4[0],xmm3[0],xmm4[1],xmm3[1],xmm4[2],xmm3[2],xmm4[3],xmm3[3],xmm4[4],xmm3[4],xmm4[5],xmm3[5],xmm4[6],xmm3[6],xmm4[7],xmm3[7]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm6, %ymm6, %ymm7
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm7 = ymm7[8,9,u,u,u,u,u,u,10,11,u,u,u,u,u,u,28,29,u,u,u,u,u,u,30,31,u,u,u,u,u,u]
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm14 = ymm5[8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,24,25,28,29,20,21,22,23,28,29,30,31,28,29,30,31]
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm7 = ymm7[0],ymm14[1],ymm7[2,3,4],ymm14[5],ymm7[6,7,8],ymm14[9],ymm7[10,11,12],ymm14[13],ymm7[14,15]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm7[0],ymm0[1],ymm7[2],ymm0[3],ymm7[4],ymm0[5],ymm7[6],ymm0[7]
; AVX2-FP-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm0 = [0,1,0,1,0,1,0,1,8,9,10,11,4,5,2,3,0,1,4,5,0,1,4,5,8,9,10,11,4,5,6,7]
; AVX2-FP-NEXT:    vpshufb %ymm0, %ymm1, %ymm7
; AVX2-FP-NEXT:    vmovdqa %ymm0, %ymm1
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm4 = [0,1,2,3,0,1,2,3,8,9,10,11,2,3,6,7,4,5,2,3,4,5,2,3,8,9,10,11,6,7,6,7]
; AVX2-FP-NEXT:    vpshufb %ymm4, %ymm2, %ymm2
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm2 = ymm2[0,1,2],ymm7[3],ymm2[4,5,6],ymm7[7],ymm2[8,9,10],ymm7[11],ymm2[12,13,14],ymm7[15]
; AVX2-FP-NEXT:    vpmovsxwq {{.*#+}} xmm12 = [1284,1798]
; AVX2-FP-NEXT:    vpshufb %xmm12, %xmm6, %xmm7
; AVX2-FP-NEXT:    vpmovzxwq {{.*#+}} xmm6 = xmm6[0],zero,zero,zero,xmm6[1],zero,zero,zero
; AVX2-FP-NEXT:    vinserti128 $1, %xmm7, %ymm6, %ymm6
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm11 = [0,1,0,1,4,5,2,3,4,5,2,3,12,13,14,15,0,1,4,5,4,5,6,7,4,5,6,7,12,13,14,15]
; AVX2-FP-NEXT:    vpshufb %ymm11, %ymm5, %ymm5
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm5 = ymm6[0],ymm5[1],ymm6[2,3,4],ymm5[5],ymm6[6,7,8],ymm5[9],ymm6[10,11,12],ymm5[13],ymm6[14,15]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm5[0],ymm2[1],ymm5[2],ymm2[3],ymm5[4],ymm2[5],ymm5[6],ymm2[7]
; AVX2-FP-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovdqa 48(%r10), %xmm9
; AVX2-FP-NEXT:    vmovdqa 48(%rax), %xmm5
; AVX2-FP-NEXT:    vpunpckhbw {{.*#+}} xmm6 = xmm5[8],xmm9[8],xmm5[9],xmm9[9],xmm5[10],xmm9[10],xmm5[11],xmm9[11],xmm5[12],xmm9[12],xmm5[13],xmm9[13],xmm5[14],xmm9[14],xmm5[15],xmm9[15]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm6, %ymm6, %ymm6
; AVX2-FP-NEXT:    vmovdqa 48(%r9), %xmm7
; AVX2-FP-NEXT:    vmovdqa 48(%r8), %xmm3
; AVX2-FP-NEXT:    vpunpckhbw {{.*#+}} xmm10 = xmm3[8],xmm7[8],xmm3[9],xmm7[9],xmm3[10],xmm7[10],xmm3[11],xmm7[11],xmm3[12],xmm7[12],xmm3[13],xmm7[13],xmm3[14],xmm7[14],xmm3[15],xmm7[15]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm10, %ymm10, %ymm10
; AVX2-FP-NEXT:    vpshufb %ymm1, %ymm6, %ymm0
; AVX2-FP-NEXT:    vpshufb %ymm4, %ymm10, %ymm13
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm4 = ymm13[0,1,2],ymm0[3],ymm13[4,5,6],ymm0[7],ymm13[8,9,10],ymm0[11],ymm13[12,13,14],ymm0[15]
; AVX2-FP-NEXT:    vmovdqa 48(%rsi), %xmm13
; AVX2-FP-NEXT:    vmovdqa 48(%rdi), %xmm8
; AVX2-FP-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm8[8],xmm13[8],xmm8[9],xmm13[9],xmm8[10],xmm13[10],xmm8[11],xmm13[11],xmm8[12],xmm13[12],xmm8[13],xmm13[13],xmm8[14],xmm13[14],xmm8[15],xmm13[15]
; AVX2-FP-NEXT:    vpshufb %xmm12, %xmm0, %xmm1
; AVX2-FP-NEXT:    vpmovzxwq {{.*#+}} xmm12 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; AVX2-FP-NEXT:    vinserti128 $1, %xmm1, %ymm12, %ymm1
; AVX2-FP-NEXT:    vmovdqa 48(%rcx), %xmm12
; AVX2-FP-NEXT:    vmovdqa 48(%rdx), %xmm2
; AVX2-FP-NEXT:    vpunpckhbw {{.*#+}} xmm15 = xmm2[8],xmm12[8],xmm2[9],xmm12[9],xmm2[10],xmm12[10],xmm2[11],xmm12[11],xmm2[12],xmm12[12],xmm2[13],xmm12[13],xmm2[14],xmm12[14],xmm2[15],xmm12[15]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm15, %ymm15, %ymm15
; AVX2-FP-NEXT:    vpshufb %ymm11, %ymm15, %ymm14
...
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm11 = [0,1,2,3,8,9,8,9,8,9,8,9,12,13,10,11,0,1,2,3,8,9,12,13,8,9,12,13,12,13,14,15]
; AVX2-FP-NEXT:    vpshufb %ymm11, %ymm6, %ymm1
...
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm1 = ymm4[0,1,2],ymm1[3],ymm4[4,5,6],ymm1[7],ymm4[8,9,10],ymm1[11],ymm4[12,13,14],ymm1[15]
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm14 = [8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,8,9,12,13,4,5,6,7,12,13,14,15,12,13,14,15]
; AVX2-FP-NEXT:    vpshufb %ymm14, %ymm15, %ymm4
; AVX2-FP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
...
; AVX2-FP-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm5[0],xmm9[0],xmm5[1],xmm9[1],xmm5[2],xmm9[2],xmm5[3],xmm9[3],xmm5[4],xmm9[4],xmm5[5],xmm9[5],xmm5[6],xmm9[6],xmm5[7],xmm9[7]
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm3[0],xmm7[0],xmm3[1],xmm7[1],xmm3[2],xmm7[2],xmm3[3],xmm7[3],xmm3[4],xmm7[4],xmm3[5],xmm7[5],xmm3[6],xmm7[6],xmm3[7],xmm7[7]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX2-FP-NEXT:    vinserti128 $1, %xmm1, %ymm1, %ymm1
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm7 = [0,1,0,1,0,1,0,1,8,9,10,11,4,5,2,3,0,1,4,5,0,1,4,5,8,9,10,11,4,5,6,7]
; AVX2-FP-NEXT:    vpshufb %ymm7, %ymm0, %ymm3
...
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm3 = ymm4[0,1,2],ymm3[3],ymm4[4,5,6],ymm3[7],ymm4[8,9,10],ymm3[11],ymm4[12,13,14],ymm3[15]
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm2[0],xmm12[0],xmm2[1],xmm12[1],xmm2[2],xmm12[2],xmm2[3],xmm12[3],xmm2[4],xmm12[4],xmm2[5],xmm12[5],xmm2[6],xmm12[6],xmm2[7],xmm12[7]
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm8[0],xmm13[0],xmm8[1],xmm13[1],xmm8[2],xmm13[2],xmm8[3],xmm13[3],xmm8[4],xmm13[4],xmm8[5],xmm13[5],xmm8[6],xmm13[6],xmm8[7],xmm13[7]
; AVX2-FP-NEXT:    vpmovsxwq {{.*#+}} xmm12 = [1284,1798]
; AVX2-FP-NEXT:    vpshufb %xmm12, %xmm4, %xmm5
; AVX2-FP-NEXT:    vpmovzxwq {{.*#+}} xmm6 = xmm4[0],zero,zero,zero,xmm4[1],zero,zero,zero
; AVX2-FP-NEXT:    vinserti128 $1, %xmm5, %ymm6, %ymm5
; AVX2-FP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm15 = [0,1,0,1,4,5,2,3,4,5,2,3,12,13,14,15,0,1,4,5,4,5,6,7,4,5,6,7,12,13,14,15]
; AVX2-FP-NEXT:    vpshufb %ymm15, %ymm2, %ymm6
...
; AVX2-FP-NEXT:    vmovdqu %ymm3, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vpshufb %ymm11, %ymm0, %ymm0
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm1 = ymm1[0,1,2,3,8,9,10,11,8,9,10,11,10,11,14,15,16,17,18,19,28,29,26,27,28,29,26,27,30,31,30,31]
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm1[0,1,2],ymm0[3],ymm1[4,5,6],ymm0[7],ymm1[8,9,10],ymm0[11],ymm1[12,13,14],ymm0[15]
; AVX2-FP-NEXT:    vpshufb %ymm14, %ymm2, %ymm1
...
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm1[0],ymm0[1],ymm1[2],ymm0[3],ymm1[4],ymm0[5],ymm1[6],ymm0[7]
; AVX2-FP-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovdqa 32(%r10), %xmm0
; AVX2-FP-NEXT:    vmovdqa 32(%rax), %xmm1
; AVX2-FP-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm1[8],xmm0[8],xmm1[9],xmm0[9],xmm1[10],xmm0[10],xmm1[11],xmm0[11],xmm1[12],xmm0[12],xmm1[13],xmm0[13],xmm1[14],xmm0[14],xmm1[15],xmm0[15]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; AVX2-FP-NEXT:    vmovdqa 32(%r9), %xmm3
; AVX2-FP-NEXT:    vmovdqa 32(%r8), %xmm4
; AVX2-FP-NEXT:    vpunpckhbw {{.*#+}} xmm5 = xmm4[8],xmm3[8],xmm4[9],xmm3[9],xmm4[10],xmm3[10],xmm4[11],xmm3[11],xmm4[12],xmm3[12],xmm4[13],xmm3[13],xmm4[14],xmm3[14],xmm4[15],xmm3[15]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm5, %ymm5, %ymm5
; AVX2-FP-NEXT:    vpshufb %ymm7, %ymm2, %ymm6
...
; AVX2-FP-NEXT:    vpunpckhbw {{.*#+}} xmm10 = xmm9[8],xmm8[8],xmm9[9],xmm8[9],xmm9[10],xmm8[10],xmm9[11],xmm8[11],xmm9[12],xmm8[12],xmm9[13],xmm8[13],xmm9[14],xmm8[14],xmm9[15],xmm8[15]
; AVX2-FP-NEXT:    vpshufb %xmm12, %xmm10, %xmm7
; AVX2-FP-NEXT:    vpmovzxwq {{.*#+}} xmm12 = xmm10[0],zero,zero,zero,xmm10[1],zero,zero,zero
; AVX2-FP-NEXT:    vinserti128 $1, %xmm7, %ymm12, %ymm7
; AVX2-FP-NEXT:    vmovdqa 32(%rcx), %xmm12
; AVX2-FP-NEXT:    vmovdqa 32(%rdx), %xmm13
; AVX2-FP-NEXT:    vpunpckhbw {{.*#+}} xmm14 = xmm13[8],xmm12[8],xmm13[9],xmm12[9],xmm13[10],xmm12[10],xmm13[11],xmm12[11],xmm13[12],xmm12[12],xmm13[13],xmm12[13],xmm13[14],xmm12[14],xmm13[15],xmm12[15]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm14, %ymm14, %ymm14
; AVX2-FP-NEXT:    vmovdqa %ymm15, %ymm11
; AVX2-FP-NEXT:    vpshufb %ymm15, %ymm14, %ymm15
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm7 = ymm7[0],ymm15[1],ymm7[2,3,4],ymm15[5],ymm7[6,7,8],ymm15[9],ymm7[10,11,12],ymm15[13],ymm7[14,15]
...
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm7 = [0,1,2,3,8,9,8,9,8,9,8,9,12,13,10,11,0,1,2,3,8,9,12,13,8,9,12,13,12,13,14,15]
...
; AVX2-FP-NEXT:    vpshufb %ymm15, %ymm5, %ymm5
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm2 = ymm5[0,1,2],ymm2[3],ymm5[4,5,6],ymm2[7],ymm5[8,9,10],ymm2[11],ymm5[12,13,14],ymm2[15]
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm5 = [8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,8,9,12,13,4,5,6,7,12,13,14,15,12,13,14,15]
; AVX2-FP-NEXT:    vpshufb %ymm5, %ymm14, %ymm5
; AVX2-FP-NEXT:    vinserti128 $1, %xmm10, %ymm10, %ymm6
; AVX2-FP-NEXT:    vpmovsxwq {{.*#+}} ymm10 = [2312,2826,3340,3854]
; AVX2-FP-NEXT:    vpshufb %ymm10, %ymm6, %ymm6
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm5 = ymm6[0],ymm5[1],ymm6[2,3,4],ymm5[5],ymm6[6,7,8],ymm5[9],ymm6[10,11,12],ymm5[13],ymm6[14,15]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm2 = ymm5[0],ymm2[1],ymm5[2],ymm2[3],ymm5[4],ymm2[5],ymm5[6],ymm2[7]
; AVX2-FP-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm4[0],xmm3[0],xmm4[1],xmm3[1],xmm4[2],xmm3[2],xmm4[3],xmm3[3],xmm4[4],xmm3[4],xmm4[5],xmm3[5],xmm4[6],xmm3[6],xmm4[7],xmm3[7]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX2-FP-NEXT:    vinserti128 $1, %xmm1, %ymm1, %ymm1
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm14 = [0,1,0,1,0,1,0,1,8,9,10,11,4,5,2,3,0,1,4,5,0,1,4,5,8,9,10,11,4,5,6,7]
; AVX2-FP-NEXT:    vpshufb %ymm14, %ymm0, %ymm2
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm6 = [0,1,2,3,0,1,2,3,8,9,10,11,2,3,6,7,4,5,2,3,4,5,2,3,8,9,10,11,6,7,6,7]
; AVX2-FP-NEXT:    vpshufb %ymm6, %ymm1, %ymm3
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm2 = ymm3[0,1,2],ymm2[3],ymm3[4,5,6],ymm2[7],ymm3[8,9,10],ymm2[11],ymm3[12,13,14],ymm2[15]
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm3 = xmm13[0],xmm12[0],xmm13[1],xmm12[1],xmm13[2],xmm12[2],xmm13[3],xmm12[3],xmm13[4],xmm12[4],xmm13[5],xmm12[5],xmm13[6],xmm12[6],xmm13[7],xmm12[7]
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm9[0],xmm8[0],xmm9[1],xmm8[1],xmm9[2],xmm8[2],xmm9[3],xmm8[3],xmm9[4],xmm8[4],xmm9[5],xmm8[5],xmm9[6],xmm8[6],xmm9[7],xmm8[7]
; AVX2-FP-NEXT:    vpshufb {{.*#+}} xmm5 = xmm4[4,5,u,u,u,u,u,u,6,7,u,u,u,u,u,u]
; AVX2-FP-NEXT:    vpmovzxwq {{.*#+}} xmm8 = xmm4[0],zero,zero,zero,xmm4[1],zero,zero,zero
; AVX2-FP-NEXT:    vinserti128 $1, %xmm5, %ymm8, %ymm5
; AVX2-FP-NEXT:    vinserti128 $1, %xmm3, %ymm3, %ymm3
; AVX2-FP-NEXT:    vpshufb %ymm11, %ymm3, %ymm8
...
; AVX2-FP-NEXT:    vmovdqa %ymm15, %ymm11
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm1[0,1,2],ymm0[3],ymm1[4,5,6],ymm0[7],ymm1[8,9,10],ymm0[11],ymm1[12,13,14],ymm0[15]
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm1 = ymm3[8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,24,25,28,29,20,21,22,23,28,29,30,31,28,29,30,31]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm4, %ymm4, %ymm2
; AVX2-FP-NEXT:    vpshufb %ymm10, %ymm2, %ymm2
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm1 = ymm2[0],ymm1[1],ymm2[2,3,4],ymm1[5],ymm2[6,7,8],ymm1[9],ymm2[10,11,12],ymm1[13],ymm2[14,15]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm1[0],ymm0[1],ymm1[2],ymm0[3],ymm1[4],ymm0[5],ymm1[6],ymm0[7]
; AVX2-FP-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FP-NEXT:    vmovdqa 16(%r10), %xmm2
; AVX2-FP-NEXT:    vmovdqa 16(%rax), %xmm1
; AVX2-FP-NEXT:    vpunpckhbw {{.*#+}} xmm3 = xmm1[8],xmm2[8],xmm1[9],xmm2[9],xmm1[10],xmm2[10],xmm1[11],xmm2[11],xmm1[12],xmm2[12],xmm1[13],xmm2[13],xmm1[14],xmm2[14],xmm1[15],xmm2[15]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm3, %ymm3, %ymm3
; AVX2-FP-NEXT:    vmovdqa 16(%r9), %xmm4
; AVX2-FP-NEXT:    vmovdqa 16(%r8), %xmm8
; AVX2-FP-NEXT:    vpunpckhbw {{.*#+}} xmm9 = xmm8[8],xmm4[8],xmm8[9],xmm4[9],xmm8[10],xmm4[10],xmm8[11],xmm4[11],xmm8[12],xmm4[12],xmm8[13],xmm4[13],xmm8[14],xmm4[14],xmm8[15],xmm4[15]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm9, %ymm9, %ymm9
; AVX2-FP-NEXT:    vpshufb %ymm14, %ymm3, %ymm10
; AVX2-FP-NEXT:    vpshufb %ymm6, %ymm9, %ymm12
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm10 = ymm12[0,1,2],ymm10[3],ymm12[4,5,6],ymm10[7],ymm12[8,9,10],ymm10[11],ymm12[12,13,14],ymm10[15]
; AVX2-FP-NEXT:    vmovdqa 16(%rsi), %xmm12
; AVX2-FP-NEXT:    vmovdqa 16(%rdi), %xmm13
; AVX2-FP-NEXT:    vpunpckhbw {{.*#+}} xmm14 = xmm13[8],xmm12[8],xmm13[9],xmm12[9],xmm13[10],xmm12[10],xmm13[11],xmm12[11],xmm13[12],xmm12[12],xmm13[13],xmm12[13],xmm13[14],xmm12[14],xmm13[15],xmm12[15]
; AVX2-FP-NEXT:    vpmovsxwq {{.*#+}} xmm0 = [1284,1798]
; AVX2-FP-NEXT:    vpshufb %xmm0, %xmm14, %xmm15
; AVX2-FP-NEXT:    vpmovzxwq {{.*#+}} xmm7 = xmm14[0],zero,zero,zero,xmm14[1],zero,zero,zero
; AVX2-FP-NEXT:    vinserti128 $1, %xmm15, %ymm7, %ymm7
; AVX2-FP-NEXT:    vmovdqa 16(%rcx), %xmm15
; AVX2-FP-NEXT:    vmovdqa 16(%rdx), %xmm0
; AVX2-FP-NEXT:    vpunpckhbw {{.*#+}} xmm6 = xmm0[8],xmm15[8],xmm0[9],xmm15[9],xmm0[10],xmm15[10],xmm0[11],xmm15[11],xmm0[12],xmm15[12],xmm0[13],xmm15[13],xmm0[14],xmm15[14],xmm0[15],xmm15[15]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm6, %ymm6, %ymm6
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm5 = ymm6[0,1,0,1,4,5,2,3,4,5,2,3,12,13,14,15,16,17,20,21,20,21,22,23,20,21,22,23,28,29,30,31]
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm5 = ymm7[0],ymm5[1],ymm7[2,3,4],ymm5[5],ymm7[6,7,8],ymm5[9],ymm7[10,11,12],ymm5[13],ymm7[14,15]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm5 = ymm5[0],ymm10[1],ymm5[2],ymm10[3],ymm5[4],ymm10[5],ymm5[6],ymm10[7]
; AVX2-FP-NEXT:    vmovdqu %ymm5, (%rsp) # 32-byte Spill
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm5 = [0,1,2,3,8,9,8,9,8,9,8,9,12,13,10,11,0,1,2,3,8,9,12,13,8,9,12,13,12,13,14,15]
; AVX2-FP-NEXT:    vpshufb %ymm5, %ymm3, %ymm3
; AVX2-FP-NEXT:    vpshufb %ymm11, %ymm9, %ymm7
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm3 = ymm7[0,1,2],ymm3[3],ymm7[4,5,6],ymm3[7],ymm7[8,9,10],ymm3[11],ymm7[12,13,14],ymm3[15]
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm10 = [8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,8,9,12,13,4,5,6,7,12,13,14,15,12,13,14,15]
; AVX2-FP-NEXT:    vpshufb %ymm10, %ymm6, %ymm6
; AVX2-FP-NEXT:    vinserti128 $1, %xmm14, %ymm14, %ymm7
; AVX2-FP-NEXT:    vpmovsxwq {{.*#+}} ymm9 = [2312,2826,3340,3854]
; AVX2-FP-NEXT:    vpshufb %ymm9, %ymm7, %ymm7
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm6 = ymm7[0],ymm6[1],ymm7[2,3,4],ymm6[5],ymm7[6,7,8],ymm6[9],ymm7[10,11,12],ymm6[13],ymm7[14,15]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm14 = ymm6[0],ymm3[1],ymm6[2],ymm3[3],ymm6[4],ymm3[5],ymm6[6],ymm3[7]
...
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm8[0],xmm4[0],xmm8[1],xmm4[1],xmm8[2],xmm4[2],xmm8[3],xmm4[3],xmm8[4],xmm4[4],xmm8[5],xmm4[5],xmm8[6],xmm4[6],xmm8[7],xmm4[7]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm1, %ymm1, %ymm1
; AVX2-FP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm3 = [0,1,0,1,0,1,0,1,8,9,10,11,4,5,2,3,0,1,4,5,0,1,4,5,8,9,10,11,4,5,6,7]
; AVX2-FP-NEXT:    vpshufb %ymm3, %ymm1, %ymm4
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm11 = [0,1,2,3,0,1,2,3,8,9,10,11,2,3,6,7,4,5,2,3,4,5,2,3,8,9,10,11,6,7,6,7]
; AVX2-FP-NEXT:    vpshufb %ymm11, %ymm2, %ymm6
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm4 = ymm6[0,1,2],ymm4[3],ymm6[4,5,6],ymm4[7],ymm6[8,9,10],ymm4[11],ymm6[12,13,14],ymm4[15]
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm0[0],xmm15[0],xmm0[1],xmm15[1],xmm0[2],xmm15[2],xmm0[3],xmm15[3],xmm0[4],xmm15[4],xmm0[5],xmm15[5],xmm0[6],xmm15[6],xmm0[7],xmm15[7]
; AVX2-FP-NEXT:    vpunpcklbw {{.*#+}} xmm6 = xmm13[0],xmm12[0],xmm13[1],xmm12[1],xmm13[2],xmm12[2],xmm13[3],xmm12[3],xmm13[4],xmm12[4],xmm13[5],xmm12[5],xmm13[6],xmm12[6],xmm13[7],xmm12[7]
; AVX2-FP-NEXT:    vpmovsxwq {{.*#+}} xmm15 = [1284,1798]
; AVX2-FP-NEXT:    vpshufb %xmm15, %xmm6, %xmm7
; AVX2-FP-NEXT:    vpmovzxwq {{.*#+}} xmm8 = xmm6[0],zero,zero,zero,xmm6[1],zero,zero,zero
...
; AVX2-FP-NEXT:    vpshufb %ymm12, %ymm0, %ymm8
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm7 = ymm7[0],ymm8[1],ymm7[2,3,4],ymm8[5],ymm7[6,7,8],ymm8[9],ymm7[10,11,12],ymm8[13],ymm7[14,15]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm4 = ymm7[0],ymm4[1],ymm7[2],ymm4[3],ymm7[4],ymm4[5],ymm7[6],ymm4[7]
; AVX2-FP-NEXT:    vpshufb %ymm5, %ymm1, %ymm1
; AVX2-FP-NEXT:    vmovdqa {{.*#+}} ymm5 = [0,1,2,3,8,9,10,11,8,9,10,11,10,11,14,15,0,1,2,3,12,13,10,11,12,13,10,11,14,15,14,15]
...
; AVX2-FP-NEXT:    vpshufb %ymm10, %ymm0, %ymm0
; AVX2-FP-NEXT:    vinserti128 $1, %xmm6, %ymm6, %ymm2
; AVX2-FP-NEXT:    vpshufb %ymm9, %ymm2, %ymm2
; AVX2-FP-NEXT:    vmovdqa %ymm9, %ymm13
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm2[0],ymm0[1],ymm2[2,3,4],ymm0[5],ymm2[6,7,8],ymm0[9],ymm2[10,11,12],ymm0[13],ymm2[14,15]
; AVX2-FP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0],ymm1[1],ymm0[2],ymm1[3],ymm0[4],ymm1[5],ymm0[6],ymm1[7]
...
; AVX2-FP-NEXT:    vinserti128 $1, %xmm1, %ymm1, %ymm1
; AVX2-FP-NEXT:    vpshufb %ymm3, %ymm1, %ymm6
; AVX2-FP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; AVX2-FP-NEXT:    vpshufb %ymm11, %ymm2, %ymm7
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm6 = ymm7[0,1,2],ymm6[3],ymm7[4,5,6],ymm6[7],ymm7[8,9,10],ymm6[11],ymm7[12,13,14],ymm6[15]
; AVX2-FP-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm7 # 16-byte Reload
; AVX2-FP-NEXT:    vpunpckhbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm7, %xmm7 # 16-byte Folded Reload
; AVX2-FP-NEXT:    # xmm7 = xmm7[8],mem[8],xmm7[9],mem[9],xmm7[10],mem[10],xmm7[11],mem[11],xmm7[12],mem[12],xmm7[13],mem[13],xmm7[14],mem[14],xmm7[15],mem[15]
...
; AVX2-FP-NEXT:    vpshufb %xmm15, %xmm8, %xmm9
; AVX2-FP-NEXT:    vpmovzxwq {{.*#+}} xmm10 = xmm8[0],zero,zero,zero,xmm8[1],zero,zero,zero
; AVX2-FP-NEXT:    vinserti128 $1, %xmm9, %ymm10, %ymm9
; AVX2-FP-NEXT:    vinserti128 $1, %xmm7, %ymm7, %ymm7
; AVX2-FP-NEXT:    vpshufb %ymm12, %ymm7, %ymm10
...
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm1 = ymm1[0,1,2,3,8,9,8,9,8,9,8,9,12,13,10,11,16,17,18,19,24,25,28,29,24,25,28,29,28,29,30,31]
; AVX2-FP-NEXT:    vpshufb %ymm5, %ymm2, %ymm2
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm1 = ymm2[0,1,2],ymm1[3],ymm2[4,5,6],ymm1[7],ymm2[8,9,10],ymm1[11],ymm2[12,13,14],ymm1[15]
; AVX2-FP-NEXT:    vpshufb {{.*#+}} ymm2 = ymm7[8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,24,25,28,29,20,21,22,23,28,29,30,31,28,29,30,31]
; AVX2-FP-NEXT:    vinserti128 $1, %xmm8, %ymm8, %ymm7
; AVX2-FP-NEXT:    vpshufb %ymm13, %ymm7, %ymm7
; AVX2-FP-NEXT:    vpblendw {{.*#+}} ymm2 = ymm7[0],ymm2[1],ymm7[2,3,4],ymm2[5],ymm7[6,7,8],ymm2[9],ymm7[10,11,12],ymm2[13],ymm7[14,15]
...
; AVX2-FP-NEXT:    vmovdqa %ymm4, 128(%rax)
; AVX2-FP-NEXT:    vmovdqa %ymm14, 224(%rax)
; AVX2-FP-NEXT:    vmovups (%rsp), %ymm0 # 32-byte Reload
...
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm0[0],xmm1[0],xmm0[1],xmm1[1],xmm0[2],xmm1[2],xmm0[3],xmm1[3],xmm0[4],xmm1[4],xmm0[5],xmm1[5],xmm0[6],xmm1[6],xmm0[7],xmm1[7]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm1
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm0 = ymm1[0,1,2,3,8,9,8,9,8,9,8,9,12,13,10,11,16,17,18,19,24,25,28,29,24,25,28,29,28,29,30,31]
...
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm2[0],xmm3[0],xmm2[1],xmm3[1],xmm2[2],xmm3[2],xmm2[3],xmm3[3],xmm2[4],xmm3[4],xmm2[5],xmm3[5],xmm2[6],xmm3[6],xmm2[7],xmm3[7]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm5 = ymm2[0,1,2,3,8,9,10,11,8,9,10,11,10,11,14,15,16,17,18,19,28,29,26,27,28,29,26,27,30,31,30,31]
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm5[0,1,2],ymm0[3],ymm5[4,5,6],ymm0[7],ymm5[8,9,10],ymm0[11],ymm5[12,13,14],ymm0[15]
; AVX2-FCP-NEXT:    vmovdqa (%rcx), %xmm3
; AVX2-FCP-NEXT:    vmovdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FCP-NEXT:    vmovdqa (%rdx), %xmm4
; AVX2-FCP-NEXT:    vmovdqa %xmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm5 = xmm4[0],xmm3[0],xmm4[1],xmm3[1],xmm4[2],xmm3[2],xmm4[3],xmm3[3],xmm4[4],xmm3[4],xmm4[5],xmm3[5],xmm4[6],xmm3[6],xmm4[7],xmm3[7]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm5, %ymm5, %ymm5
; AVX2-FCP-NEXT:    vmovdqa (%rsi), %xmm3
; AVX2-FCP-NEXT:    vmovdqa %xmm3, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FCP-NEXT:    vmovdqa (%rdi), %xmm4
; AVX2-FCP-NEXT:    vmovdqa %xmm4, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm6 = xmm4[0],xmm3[0],xmm4[1],xmm3[1],xmm4[2],xmm3[2],xmm4[3],xmm3[3],xmm4[4],xmm3[4],xmm4[5],xmm3[5],xmm4[6],xmm3[6],xmm4[7],xmm3[7]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm6, %ymm6, %ymm7
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm7 = ymm7[8,9,u,u,u,u,u,u,10,11,u,u,u,u,u,u,28,29,u,u,u,u,u,u,30,31,u,u,u,u,u,u]
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm14 = ymm5[8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,24,25,28,29,20,21,22,23,28,29,30,31,28,29,30,31]
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm7 = ymm7[0],ymm14[1],ymm7[2,3,4],ymm14[5],ymm7[6,7,8],ymm14[9],ymm7[10,11,12],ymm14[13],ymm7[14,15]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm7[0],ymm0[1],ymm7[2],ymm0[3],ymm7[4],ymm0[5],ymm7[6],ymm0[7]
; AVX2-FCP-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm0 = [0,1,0,1,0,1,0,1,8,9,10,11,4,5,2,3,0,1,4,5,0,1,4,5,8,9,10,11,4,5,6,7]
; AVX2-FCP-NEXT:    vpshufb %ymm0, %ymm1, %ymm7
; AVX2-FCP-NEXT:    vmovdqa %ymm0, %ymm1
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm4 = [0,1,2,3,0,1,2,3,8,9,10,11,2,3,6,7,4,5,2,3,4,5,2,3,8,9,10,11,6,7,6,7]
; AVX2-FCP-NEXT:    vpshufb %ymm4, %ymm2, %ymm2
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm2 = ymm2[0,1,2],ymm7[3],ymm2[4,5,6],ymm7[7],ymm2[8,9,10],ymm7[11],ymm2[12,13,14],ymm7[15]
; AVX2-FCP-NEXT:    vpmovsxwq {{.*#+}} xmm12 = [1284,1798]
; AVX2-FCP-NEXT:    vpshufb %xmm12, %xmm6, %xmm7
; AVX2-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm6 = xmm6[0],zero,zero,zero,xmm6[1],zero,zero,zero
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm7, %ymm6, %ymm6
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm11 = [0,1,0,1,4,5,2,3,4,5,2,3,12,13,14,15,0,1,4,5,4,5,6,7,4,5,6,7,12,13,14,15]
; AVX2-FCP-NEXT:    vpshufb %ymm11, %ymm5, %ymm5
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm5 = ymm6[0],ymm5[1],ymm6[2,3,4],ymm5[5],ymm6[6,7,8],ymm5[9],ymm6[10,11,12],ymm5[13],ymm6[14,15]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm5[0],ymm2[1],ymm5[2],ymm2[3],ymm5[4],ymm2[5],ymm5[6],ymm2[7]
; AVX2-FCP-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovdqa 48(%r10), %xmm9
; AVX2-FCP-NEXT:    vmovdqa 48(%rax), %xmm5
; AVX2-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm6 = xmm5[8],xmm9[8],xmm5[9],xmm9[9],xmm5[10],xmm9[10],xmm5[11],xmm9[11],xmm5[12],xmm9[12],xmm5[13],xmm9[13],xmm5[14],xmm9[14],xmm5[15],xmm9[15]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm6, %ymm6, %ymm6
; AVX2-FCP-NEXT:    vmovdqa 48(%r9), %xmm7
; AVX2-FCP-NEXT:    vmovdqa 48(%r8), %xmm3
; AVX2-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm10 = xmm3[8],xmm7[8],xmm3[9],xmm7[9],xmm3[10],xmm7[10],xmm3[11],xmm7[11],xmm3[12],xmm7[12],xmm3[13],xmm7[13],xmm3[14],xmm7[14],xmm3[15],xmm7[15]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm10, %ymm10, %ymm10
; AVX2-FCP-NEXT:    vpshufb %ymm1, %ymm6, %ymm0
; AVX2-FCP-NEXT:    vpshufb %ymm4, %ymm10, %ymm13
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm4 = ymm13[0,1,2],ymm0[3],ymm13[4,5,6],ymm0[7],ymm13[8,9,10],ymm0[11],ymm13[12,13,14],ymm0[15]
; AVX2-FCP-NEXT:    vmovdqa 48(%rsi), %xmm13
; AVX2-FCP-NEXT:    vmovdqa 48(%rdi), %xmm8
; AVX2-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm8[8],xmm13[8],xmm8[9],xmm13[9],xmm8[10],xmm13[10],xmm8[11],xmm13[11],xmm8[12],xmm13[12],xmm8[13],xmm13[13],xmm8[14],xmm13[14],xmm8[15],xmm13[15]
; AVX2-FCP-NEXT:    vpshufb %xmm12, %xmm0, %xmm1
; AVX2-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm12 = xmm0[0],zero,zero,zero,xmm0[1],zero,zero,zero
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm1, %ymm12, %ymm1
; AVX2-FCP-NEXT:    vmovdqa 48(%rcx), %xmm12
; AVX2-FCP-NEXT:    vmovdqa 48(%rdx), %xmm2
; AVX2-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm15 = xmm2[8],xmm12[8],xmm2[9],xmm12[9],xmm2[10],xmm12[10],xmm2[11],xmm12[11],xmm2[12],xmm12[12],xmm2[13],xmm12[13],xmm2[14],xmm12[14],xmm2[15],xmm12[15]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm15, %ymm15, %ymm15
; AVX2-FCP-NEXT:    vpshufb %ymm11, %ymm15, %ymm14
...
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm11 = [0,1,2,3,8,9,8,9,8,9,8,9,12,13,10,11,0,1,2,3,8,9,12,13,8,9,12,13,12,13,14,15]
; AVX2-FCP-NEXT:    vpshufb %ymm11, %ymm6, %ymm1
...
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm1 = ymm4[0,1,2],ymm1[3],ymm4[4,5,6],ymm1[7],ymm4[8,9,10],ymm1[11],ymm4[12,13,14],ymm1[15]
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm14 = [8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,8,9,12,13,4,5,6,7,12,13,14,15,12,13,14,15]
; AVX2-FCP-NEXT:    vpshufb %ymm14, %ymm15, %ymm4
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
...
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0],ymm1[1],ymm0[2],ymm1[3],ymm0[4],ymm1[5],ymm0[6],ymm1[7]
; AVX2-FCP-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm5[0],xmm9[0],xmm5[1],xmm9[1],xmm5[2],xmm9[2],xmm5[3],xmm9[3],xmm5[4],xmm9[4],xmm5[5],xmm9[5],xmm5[6],xmm9[6],xmm5[7],xmm9[7]
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm3[0],xmm7[0],xmm3[1],xmm7[1],xmm3[2],xmm7[2],xmm3[3],xmm7[3],xmm3[4],xmm7[4],xmm3[5],xmm7[5],xmm3[6],xmm7[6],xmm3[7],xmm7[7]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm1, %ymm1, %ymm1
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm7 = [0,1,0,1,0,1,0,1,8,9,10,11,4,5,2,3,0,1,4,5,0,1,4,5,8,9,10,11,4,5,6,7]
; AVX2-FCP-NEXT:    vpshufb %ymm7, %ymm0, %ymm3
...
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm3 = ymm4[0,1,2],ymm3[3],ymm4[4,5,6],ymm3[7],ymm4[8,9,10],ymm3[11],ymm4[12,13,14],ymm3[15]
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm2[0],xmm12[0],xmm2[1],xmm12[1],xmm2[2],xmm12[2],xmm2[3],xmm12[3],xmm2[4],xmm12[4],xmm2[5],xmm12[5],xmm2[6],xmm12[6],xmm2[7],xmm12[7]
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm8[0],xmm13[0],xmm8[1],xmm13[1],xmm8[2],xmm13[2],xmm8[3],xmm13[3],xmm8[4],xmm13[4],xmm8[5],xmm13[5],xmm8[6],xmm13[6],xmm8[7],xmm13[7]
; AVX2-FCP-NEXT:    vpmovsxwq {{.*#+}} xmm12 = [1284,1798]
; AVX2-FCP-NEXT:    vpshufb %xmm12, %xmm4, %xmm5
; AVX2-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm6 = xmm4[0],zero,zero,zero,xmm4[1],zero,zero,zero
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm5, %ymm6, %ymm5
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm15 = [0,1,0,1,4,5,2,3,4,5,2,3,12,13,14,15,0,1,4,5,4,5,6,7,4,5,6,7,12,13,14,15]
; AVX2-FCP-NEXT:    vpshufb %ymm15, %ymm2, %ymm6
...
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm1 = ymm1[0,1,2,3,8,9,10,11,8,9,10,11,10,11,14,15,16,17,18,19,28,29,26,27,28,29,26,27,30,31,30,31]
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm1[0,1,2],ymm0[3],ymm1[4,5,6],ymm0[7],ymm1[8,9,10],ymm0[11],ymm1[12,13,14],ymm0[15]
; AVX2-FCP-NEXT:    vpshufb %ymm14, %ymm2, %ymm1
...
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm1[0],ymm0[1],ymm1[2],ymm0[3],ymm1[4],ymm0[5],ymm1[6],ymm0[7]
; AVX2-FCP-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovdqa 32(%r10), %xmm0
; AVX2-FCP-NEXT:    vmovdqa 32(%rax), %xmm1
; AVX2-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm1[8],xmm0[8],xmm1[9],xmm0[9],xmm1[10],xmm0[10],xmm1[11],xmm0[11],xmm1[12],xmm0[12],xmm1[13],xmm0[13],xmm1[14],xmm0[14],xmm1[15],xmm0[15]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; AVX2-FCP-NEXT:    vmovdqa 32(%r9), %xmm3
; AVX2-FCP-NEXT:    vmovdqa 32(%r8), %xmm4
; AVX2-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm5 = xmm4[8],xmm3[8],xmm4[9],xmm3[9],xmm4[10],xmm3[10],xmm4[11],xmm3[11],xmm4[12],xmm3[12],xmm4[13],xmm3[13],xmm4[14],xmm3[14],xmm4[15],xmm3[15]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm5, %ymm5, %ymm5
; AVX2-FCP-NEXT:    vpshufb %ymm7, %ymm2, %ymm6
...
; AVX2-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm10 = xmm9[8],xmm8[8],xmm9[9],xmm8[9],xmm9[10],xmm8[10],xmm9[11],xmm8[11],xmm9[12],xmm8[12],xmm9[13],xmm8[13],xmm9[14],xmm8[14],xmm9[15],xmm8[15]
; AVX2-FCP-NEXT:    vpshufb %xmm12, %xmm10, %xmm7
; AVX2-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm12 = xmm10[0],zero,zero,zero,xmm10[1],zero,zero,zero
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm7, %ymm12, %ymm7
; AVX2-FCP-NEXT:    vmovdqa 32(%rcx), %xmm12
; AVX2-FCP-NEXT:    vmovdqa 32(%rdx), %xmm13
; AVX2-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm14 = xmm13[8],xmm12[8],xmm13[9],xmm12[9],xmm13[10],xmm12[10],xmm13[11],xmm12[11],xmm13[12],xmm12[12],xmm13[13],xmm12[13],xmm13[14],xmm12[14],xmm13[15],xmm12[15]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm14, %ymm14, %ymm14
; AVX2-FCP-NEXT:    vmovdqa %ymm15, %ymm11
; AVX2-FCP-NEXT:    vpshufb %ymm15, %ymm14, %ymm15
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm7 = ymm7[0],ymm15[1],ymm7[2,3,4],ymm15[5],ymm7[6,7,8],ymm15[9],ymm7[10,11,12],ymm15[13],ymm7[14,15]
...
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm7 = [0,1,2,3,8,9,8,9,8,9,8,9,12,13,10,11,0,1,2,3,8,9,12,13,8,9,12,13,12,13,14,15]
...
; AVX2-FCP-NEXT:    vpshufb %ymm15, %ymm5, %ymm5
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm2 = ymm5[0,1,2],ymm2[3],ymm5[4,5,6],ymm2[7],ymm5[8,9,10],ymm2[11],ymm5[12,13,14],ymm2[15]
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm5 = [8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,8,9,12,13,4,5,6,7,12,13,14,15,12,13,14,15]
; AVX2-FCP-NEXT:    vpshufb %ymm5, %ymm14, %ymm5
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm10, %ymm10, %ymm6
; AVX2-FCP-NEXT:    vpmovsxwq {{.*#+}} ymm10 = [2312,2826,3340,3854]
; AVX2-FCP-NEXT:    vpshufb %ymm10, %ymm6, %ymm6
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm5 = ymm6[0],ymm5[1],ymm6[2,3,4],ymm5[5],ymm6[6,7,8],ymm5[9],ymm6[10,11,12],ymm5[13],ymm6[14,15]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm2 = ymm5[0],ymm2[1],ymm5[2],ymm2[3],ymm5[4],ymm2[5],ymm5[6],ymm2[7]
; AVX2-FCP-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm4[0],xmm3[0],xmm4[1],xmm3[1],xmm4[2],xmm3[2],xmm4[3],xmm3[3],xmm4[4],xmm3[4],xmm4[5],xmm3[5],xmm4[6],xmm3[6],xmm4[7],xmm3[7]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm1, %ymm1, %ymm1
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm14 = [0,1,0,1,0,1,0,1,8,9,10,11,4,5,2,3,0,1,4,5,0,1,4,5,8,9,10,11,4,5,6,7]
; AVX2-FCP-NEXT:    vpshufb %ymm14, %ymm0, %ymm2
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm6 = [0,1,2,3,0,1,2,3,8,9,10,11,2,3,6,7,4,5,2,3,4,5,2,3,8,9,10,11,6,7,6,7]
; AVX2-FCP-NEXT:    vpshufb %ymm6, %ymm1, %ymm3
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm2 = ymm3[0,1,2],ymm2[3],ymm3[4,5,6],ymm2[7],ymm3[8,9,10],ymm2[11],ymm3[12,13,14],ymm2[15]
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm3 = xmm13[0],xmm12[0],xmm13[1],xmm12[1],xmm13[2],xmm12[2],xmm13[3],xmm12[3],xmm13[4],xmm12[4],xmm13[5],xmm12[5],xmm13[6],xmm12[6],xmm13[7],xmm12[7]
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm9[0],xmm8[0],xmm9[1],xmm8[1],xmm9[2],xmm8[2],xmm9[3],xmm8[3],xmm9[4],xmm8[4],xmm9[5],xmm8[5],xmm9[6],xmm8[6],xmm9[7],xmm8[7]
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} xmm5 = xmm4[4,5,u,u,u,u,u,u,6,7,u,u,u,u,u,u]
; AVX2-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm8 = xmm4[0],zero,zero,zero,xmm4[1],zero,zero,zero
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm5, %ymm8, %ymm5
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm3, %ymm3, %ymm3
; AVX2-FCP-NEXT:    vpshufb %ymm11, %ymm3, %ymm8
...
; AVX2-FCP-NEXT:    vmovdqa %ymm15, %ymm11
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm1[0,1,2],ymm0[3],ymm1[4,5,6],ymm0[7],ymm1[8,9,10],ymm0[11],ymm1[12,13,14],ymm0[15]
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm1 = ymm3[8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,24,25,28,29,20,21,22,23,28,29,30,31,28,29,30,31]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm4, %ymm4, %ymm2
; AVX2-FCP-NEXT:    vpshufb %ymm10, %ymm2, %ymm2
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm1 = ymm2[0],ymm1[1],ymm2[2,3,4],ymm1[5],ymm2[6,7,8],ymm1[9],ymm2[10,11,12],ymm1[13],ymm2[14,15]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm1[0],ymm0[1],ymm1[2],ymm0[3],ymm1[4],ymm0[5],ymm1[6],ymm0[7]
; AVX2-FCP-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovdqa 16(%r10), %xmm2
; AVX2-FCP-NEXT:    vmovdqa 16(%rax), %xmm1
; AVX2-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm3 = xmm1[8],xmm2[8],xmm1[9],xmm2[9],xmm1[10],xmm2[10],xmm1[11],xmm2[11],xmm1[12],xmm2[12],xmm1[13],xmm2[13],xmm1[14],xmm2[14],xmm1[15],xmm2[15]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm3, %ymm3, %ymm3
; AVX2-FCP-NEXT:    vmovdqa 16(%r9), %xmm4
; AVX2-FCP-NEXT:    vmovdqa 16(%r8), %xmm8
; AVX2-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm9 = xmm8[8],xmm4[8],xmm8[9],xmm4[9],xmm8[10],xmm4[10],xmm8[11],xmm4[11],xmm8[12],xmm4[12],xmm8[13],xmm4[13],xmm8[14],xmm4[14],xmm8[15],xmm4[15]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm9, %ymm9, %ymm9
; AVX2-FCP-NEXT:    vpshufb %ymm14, %ymm3, %ymm10
; AVX2-FCP-NEXT:    vpshufb %ymm6, %ymm9, %ymm12
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm10 = ymm12[0,1,2],ymm10[3],ymm12[4,5,6],ymm10[7],ymm12[8,9,10],ymm10[11],ymm12[12,13,14],ymm10[15]
; AVX2-FCP-NEXT:    vmovdqa 16(%rsi), %xmm12
; AVX2-FCP-NEXT:    vmovdqa 16(%rdi), %xmm13
; AVX2-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm14 = xmm13[8],xmm12[8],xmm13[9],xmm12[9],xmm13[10],xmm12[10],xmm13[11],xmm12[11],xmm13[12],xmm12[12],xmm13[13],xmm12[13],xmm13[14],xmm12[14],xmm13[15],xmm12[15]
; AVX2-FCP-NEXT:    vpmovsxwq {{.*#+}} xmm0 = [1284,1798]
; AVX2-FCP-NEXT:    vpshufb %xmm0, %xmm14, %xmm15
; AVX2-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm7 = xmm14[0],zero,zero,zero,xmm14[1],zero,zero,zero
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm15, %ymm7, %ymm7
; AVX2-FCP-NEXT:    vmovdqa 16(%rcx), %xmm15
; AVX2-FCP-NEXT:    vmovdqa 16(%rdx), %xmm0
; AVX2-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm6 = xmm0[8],xmm15[8],xmm0[9],xmm15[9],xmm0[10],xmm15[10],xmm0[11],xmm15[11],xmm0[12],xmm15[12],xmm0[13],xmm15[13],xmm0[14],xmm15[14],xmm0[15],xmm15[15]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm6, %ymm6, %ymm6
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm5 = ymm6[0,1,0,1,4,5,2,3,4,5,2,3,12,13,14,15,16,17,20,21,20,21,22,23,20,21,22,23,28,29,30,31]
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm5 = ymm7[0],ymm5[1],ymm7[2,3,4],ymm5[5],ymm7[6,7,8],ymm5[9],ymm7[10,11,12],ymm5[13],ymm7[14,15]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm5 = ymm5[0],ymm10[1],ymm5[2],ymm10[3],ymm5[4],ymm10[5],ymm5[6],ymm10[7]
; AVX2-FCP-NEXT:    vmovdqu %ymm5, (%rsp) # 32-byte Spill
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm5 = [0,1,2,3,8,9,8,9,8,9,8,9,12,13,10,11,0,1,2,3,8,9,12,13,8,9,12,13,12,13,14,15]
; AVX2-FCP-NEXT:    vpshufb %ymm5, %ymm3, %ymm3
; AVX2-FCP-NEXT:    vpshufb %ymm11, %ymm9, %ymm7
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm3 = ymm7[0,1,2],ymm3[3],ymm7[4,5,6],ymm3[7],ymm7[8,9,10],ymm3[11],ymm7[12,13,14],ymm3[15]
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm10 = [8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,8,9,12,13,4,5,6,7,12,13,14,15,12,13,14,15]
; AVX2-FCP-NEXT:    vpshufb %ymm10, %ymm6, %ymm6
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm14, %ymm14, %ymm7
; AVX2-FCP-NEXT:    vpmovsxwq {{.*#+}} ymm9 = [2312,2826,3340,3854]
...
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm14 = ymm6[0],ymm3[1],ymm6[2],ymm3[3],ymm6[4],ymm3[5],ymm6[6],ymm3[7]
...
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm8[0],xmm4[0],xmm8[1],xmm4[1],xmm8[2],xmm4[2],xmm8[3],xmm4[3],xmm8[4],xmm4[4],xmm8[5],xmm4[5],xmm8[6],xmm4[6],xmm8[7],xmm4[7]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm1, %ymm1, %ymm1
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm3 = [0,1,0,1,0,1,0,1,8,9,10,11,4,5,2,3,0,1,4,5,0,1,4,5,8,9,10,11,4,5,6,7]
; AVX2-FCP-NEXT:    vpshufb %ymm3, %ymm1, %ymm4
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm11 = [0,1,2,3,0,1,2,3,8,9,10,11,2,3,6,7,4,5,2,3,4,5,2,3,8,9,10,11,6,7,6,7]
; AVX2-FCP-NEXT:    vpshufb %ymm11, %ymm2, %ymm6
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm4 = ymm6[0,1,2],ymm4[3],ymm6[4,5,6],ymm4[7],ymm6[8,9,10],ymm4[11],ymm6[12,13,14],ymm4[15]
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm0[0],xmm15[0],xmm0[1],xmm15[1],xmm0[2],xmm15[2],xmm0[3],xmm15[3],xmm0[4],xmm15[4],xmm0[5],xmm15[5],xmm0[6],xmm15[6],xmm0[7],xmm15[7]
; AVX2-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm6 = xmm13[0],xmm12[0],xmm13[1],xmm12[1],xmm13[2],xmm12[2],xmm13[3],xmm12[3],xmm13[4],xmm12[4],xmm13[5],xmm12[5],xmm13[6],xmm12[6],xmm13[7],xmm12[7]
; AVX2-FCP-NEXT:    vpmovsxwq {{.*#+}} xmm15 = [1284,1798]
; AVX2-FCP-NEXT:    vpshufb %xmm15, %xmm6, %xmm7
; AVX2-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm8 = xmm6[0],zero,zero,zero,xmm6[1],zero,zero,zero
...
; AVX2-FCP-NEXT:    vpshufb %ymm12, %ymm0, %ymm8
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm7 = ymm7[0],ymm8[1],ymm7[2,3,4],ymm8[5],ymm7[6,7,8],ymm8[9],ymm7[10,11,12],ymm8[13],ymm7[14,15]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm4 = ymm7[0],ymm4[1],ymm7[2],ymm4[3],ymm7[4],ymm4[5],ymm7[6],ymm4[7]
; AVX2-FCP-NEXT:    vpshufb %ymm5, %ymm1, %ymm1
; AVX2-FCP-NEXT:    vmovdqa {{.*#+}} ymm5 = [0,1,2,3,8,9,10,11,8,9,10,11,10,11,14,15,0,1,2,3,12,13,10,11,12,13,10,11,14,15,14,15]
; AVX2-FCP-NEXT:    vpshufb %ymm5, %ymm2, %ymm2
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm1 = ymm2[0,1,2],ymm1[3],ymm2[4,5,6],ymm1[7],ymm2[8,9,10],ymm1[11],ymm2[12,13,14],ymm1[15]
; AVX2-FCP-NEXT:    vpshufb %ymm10, %ymm0, %ymm0
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm6, %ymm6, %ymm2
; AVX2-FCP-NEXT:    vpshufb %ymm9, %ymm2, %ymm2
; AVX2-FCP-NEXT:    vmovdqa %ymm9, %ymm13
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm0 = ymm2[0],ymm0[1],ymm2[2,3,4],ymm0[5],ymm2[6,7,8],ymm0[9],ymm2[10,11,12],ymm0[13],ymm2[14,15]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm0 = ymm0[0],ymm1[1],ymm0[2],ymm1[3],ymm0[4],ymm1[5],ymm0[6],ymm1[7]
...
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm1, %ymm1, %ymm1
; AVX2-FCP-NEXT:    vpshufb %ymm3, %ymm1, %ymm6
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; AVX2-FCP-NEXT:    vpshufb %ymm11, %ymm2, %ymm7
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm6 = ymm7[0,1,2],ymm6[3],ymm7[4,5,6],ymm6[7],ymm7[8,9,10],ymm6[11],ymm7[12,13,14],ymm6[15]
; AVX2-FCP-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm7 # 16-byte Reload
; AVX2-FCP-NEXT:    vpunpckhbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm7, %xmm7 # 16-byte Folded Reload
; AVX2-FCP-NEXT:    # xmm7 = xmm7[8],mem[8],xmm7[9],mem[9],xmm7[10],mem[10],xmm7[11],mem[11],xmm7[12],mem[12],xmm7[13],mem[13],xmm7[14],mem[14],xmm7[15],mem[15]
...
; AVX2-FCP-NEXT:    vpshufb %xmm15, %xmm8, %xmm9
; AVX2-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm10 = xmm8[0],zero,zero,zero,xmm8[1],zero,zero,zero
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm9, %ymm10, %ymm9
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm7, %ymm7, %ymm7
; AVX2-FCP-NEXT:    vpshufb %ymm12, %ymm7, %ymm10
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm9 = ymm9[0],ymm10[1],ymm9[2,3,4],ymm10[5],ymm9[6,7,8],ymm10[9],ymm9[10,11,12],ymm10[13],ymm9[14,15]
; AVX2-FCP-NEXT:    vpblendd {{.*#+}} ymm6 = ymm9[0],ymm6[1],ymm9[2],ymm6[3],ymm9[4],ymm6[5],ymm9[6],ymm6[7]
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm1 = ymm1[0,1,2,3,8,9,8,9,8,9,8,9,12,13,10,11,16,17,18,19,24,25,28,29,24,25,28,29,28,29,30,31]
; AVX2-FCP-NEXT:    vpshufb %ymm5, %ymm2, %ymm2
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm1 = ymm2[0,1,2],ymm1[3],ymm2[4,5,6],ymm1[7],ymm2[8,9,10],ymm1[11],ymm2[12,13,14],ymm1[15]
; AVX2-FCP-NEXT:    vpshufb {{.*#+}} ymm2 = ymm7[8,9,8,9,4,5,6,7,12,13,10,11,12,13,10,11,24,25,28,29,20,21,22,23,28,29,30,31,28,29,30,31]
; AVX2-FCP-NEXT:    vinserti128 $1, %xmm8, %ymm8, %ymm7
; AVX2-FCP-NEXT:    vpshufb %ymm13, %ymm7, %ymm7
; AVX2-FCP-NEXT:    vpblendw {{.*#+}} ymm2 = ymm7[0],ymm2[1],ymm7[2,3,4],ymm2[5],ymm7[6,7,8],ymm2[9],ymm7[10,11,12],ymm2[13],ymm7[14,15]
...
; AVX2-FCP-NEXT:    vmovdqa %ymm4, 128(%rax)
; AVX2-FCP-NEXT:    vmovdqa %ymm14, 224(%rax)
; AVX2-FCP-NEXT:    vmovups (%rsp), %ymm0 # 32-byte Reload
...
; AVX512-NEXT:    vmovdqa 48(%rcx), %xmm13
; AVX512-NEXT:    vmovdqa (%rdx), %xmm1
; AVX512-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512-NEXT:    vmovdqa 48(%rdx), %xmm14
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm1[8],xmm0[8],xmm1[9],xmm0[9],xmm1[10],xmm0[10],xmm1[11],xmm0[11],xmm1[12],xmm0[12],xmm1[13],xmm0[13],xmm1[14],xmm0[14],xmm1[15],xmm0[15]
...
; AVX512-NEXT:    vinserti32x4 $1, %xmm2, %ymm3, %ymm27
; AVX512-NEXT:    vmovdqa (%r10), %xmm0
; AVX512-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512-NEXT:    vmovdqa 48(%r10), %xmm2
; AVX512-NEXT:    vmovdqa (%rax), %xmm1
; AVX512-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512-NEXT:    vmovdqa 48(%rax), %xmm3
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm4 = xmm1[8],xmm0[8],xmm1[9],xmm0[9],xmm1[10],xmm0[10],xmm1[11],xmm0[11],xmm1[12],xmm0[12],xmm1[13],xmm0[13],xmm1[14],xmm0[14],xmm1[15],xmm0[15]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm4[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm4[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm7, %ymm5, %ymm0
; AVX512-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm4[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm4[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm4, %ymm5, %ymm0
; AVX512-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512-NEXT:    vmovdqa (%r9), %xmm0
; AVX512-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512-NEXT:    vmovdqa 48(%r9), %xmm4
; AVX512-NEXT:    vmovdqa (%r8), %xmm1
; AVX512-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512-NEXT:    vmovdqa 48(%r8), %xmm5
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm7 = xmm1[8],xmm0[8],xmm1[9],xmm0[9],xmm1[10],xmm0[10],xmm1[11],xmm0[11],xmm1[12],xmm0[12],xmm1[13],xmm0[13],xmm1[14],xmm0[14],xmm1[15],xmm0[15]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm8 = xmm7[0,1,1,3,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm9 = xmm7[2,1,3,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm9, %ymm8, %ymm0
; AVX512-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm7[0,1,2,3,4,5,5,7]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm7 = xmm7[0,1,2,3,6,5,7,7]
; AVX512-NEXT:    vinserti128 $1, %xmm7, %ymm8, %ymm0
; AVX512-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm9 = xmm8[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm8[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm10, %ymm9, %ymm0
; AVX512-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm8[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm8[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm8, %ymm9, %ymm0
; AVX512-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm8 = xmm3[0],xmm2[0],xmm3[1],xmm2[1],xmm3[2],xmm2[2],xmm3[3],xmm2[3],xmm3[4],xmm2[4],xmm3[5],xmm2[5],xmm3[6],xmm2[6],xmm3[7],xmm2[7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm9 = xmm8[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm8[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm11, %ymm9, %ymm0
; AVX512-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm8[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm8[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm8, %ymm9, %ymm0
; AVX512-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm8 = xmm5[0],xmm4[0],xmm5[1],xmm4[1],xmm5[2],xmm4[2],xmm5[3],xmm4[3],xmm5[4],xmm4[4],xmm5[5],xmm4[5],xmm5[6],xmm4[6],xmm5[7],xmm4[7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm9 = xmm8[0,1,1,3,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm8[2,1,3,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm11, %ymm9, %ymm0
; AVX512-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512-NEXT:    vmovdqa 32(%rdx), %xmm7
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm8[0,1,2,3,4,5,5,7]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm8[0,1,2,3,6,5,7,7]
; AVX512-NEXT:    vinserti128 $1, %xmm8, %ymm9, %ymm0
; AVX512-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512-NEXT:    vmovdqa 32(%r10), %xmm10
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm8 = xmm14[8],xmm13[8],xmm14[9],xmm13[9],xmm14[10],xmm13[10],xmm14[11],xmm13[11],xmm14[12],xmm13[12],xmm14[13],xmm13[13],xmm14[14],xmm13[14],xmm14[15],xmm13[15]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm9 = xmm8[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm8[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm11, %ymm9, %ymm0
; AVX512-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512-NEXT:    vmovdqa 32(%rax), %xmm6
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm8[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm8[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm8, %ymm9, %ymm29
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm3[8],xmm2[8],xmm3[9],xmm2[9],xmm3[10],xmm2[10],xmm3[11],xmm2[11],xmm3[12],xmm2[12],xmm3[13],xmm2[13],xmm3[14],xmm2[14],xmm3[15],xmm2[15]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm8 = xmm2[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm8, %ymm3, %ymm28
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm2[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm2, %ymm3, %ymm23
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm5[8],xmm4[8],xmm5[9],xmm4[9],xmm5[10],xmm4[10],xmm5[11],xmm4[11],xmm5[12],xmm4[12],xmm5[13],xmm4[13],xmm5[14],xmm4[14],xmm5[15],xmm4[15]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[0,1,1,3,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm2[2,1,3,3,4,5,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm4, %ymm3, %ymm21
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm2[0,1,2,3,4,5,5,7]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,6,5,7,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm2, %ymm3, %ymm19
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm7[0],xmm12[0],xmm7[1],xmm12[1],xmm7[2],xmm12[2],xmm7[3],xmm12[3],xmm7[4],xmm12[4],xmm7[5],xmm12[5],xmm7[6],xmm12[6],xmm7[7],xmm12[7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm2[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm4, %ymm3, %ymm17
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm2[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm2, %ymm3, %ymm16
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm6[0],xmm10[0],xmm6[1],xmm10[1],xmm6[2],xmm10[2],xmm6[3],xmm10[3],xmm6[4],xmm10[4],xmm6[5],xmm10[5],xmm6[6],xmm10[6],xmm6[7],xmm10[7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm8 = xmm2[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm8, %ymm3, %ymm20
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm2[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm2, %ymm3, %ymm18
...
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[0,1,1,3,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm15 = xmm2[2,1,3,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm15, %ymm3, %ymm14
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm15 = xmm2[0,1,2,3,4,5,5,7]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,6,5,7,7]
; AVX512-NEXT:    vinserti128 $1, %xmm2, %ymm15, %ymm13
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm7 = xmm7[8],xmm12[8],xmm7[9],xmm12[9],xmm7[10],xmm12[10],xmm7[11],xmm12[11],xmm7[12],xmm12[12],xmm7[13],xmm12[13],xmm7[14],xmm12[14],xmm7[15],xmm12[15]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm12 = xmm7[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm15 = xmm7[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm15, %ymm12, %ymm2
; AVX512-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm12 = xmm7[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm7 = xmm7[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm7, %ymm12, %ymm2
; AVX512-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm6 = xmm6[8],xmm10[8],xmm6[9],xmm10[9],xmm6[10],xmm10[10],xmm6[11],xmm10[11],xmm6[12],xmm10[12],xmm6[13],xmm10[13],xmm6[14],xmm10[14],xmm6[15],xmm10[15]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm6[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm6[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm10, %ymm7, %ymm2
; AVX512-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm7 = xmm6[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm6 = xmm6[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm6, %ymm7, %ymm2
; AVX512-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm6 = xmm0[2,1,3,3,4,5,6,7]
...
; AVX512-NEXT:    vmovdqa 16(%rdx), %xmm1
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm1[0],xmm4[0],xmm1[1],xmm4[1],xmm1[2],xmm4[2],xmm1[3],xmm4[3],xmm1[4],xmm4[4],xmm1[5],xmm4[5],xmm1[6],xmm4[6],xmm1[7],xmm4[7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm6 = xmm2[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm6, %ymm3, %ymm0
; AVX512-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm2[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,4,6,6,7]
...
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm5 = xmm8[0],xmm9[0],xmm8[1],xmm9[1],xmm8[2],xmm9[2],xmm8[3],xmm9[3],xmm8[4],xmm9[4],xmm8[5],xmm9[5],xmm8[6],xmm9[6],xmm8[7],xmm9[7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm6 = xmm5[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm5[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm7, %ymm6, %ymm30
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm6 = xmm5[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm5[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm5, %ymm6, %ymm31
; AVX512-NEXT:    vmovdqa 16(%r9), %xmm3
; AVX512-NEXT:    vmovdqa 16(%r8), %xmm2
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm2[0],xmm3[0],xmm2[1],xmm3[1],xmm2[2],xmm3[2],xmm2[3],xmm3[3],xmm2[4],xmm3[4],xmm2[5],xmm3[5],xmm2[6],xmm3[6],xmm2[7],xmm3[7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm0[0,1,1,3,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm6 = xmm0[2,1,3,3,4,5,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm6, %ymm5, %ymm25
; AVX512-NEXT:    vmovdqa 48(%rsi), %xmm5
; AVX512-NEXT:    vmovdqa 48(%rdi), %xmm6
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm7 = xmm6[0],xmm5[0],xmm6[1],xmm5[1],xmm6[2],xmm5[2],xmm6[3],xmm5[3],xmm6[4],xmm5[4],xmm6[5],xmm5[5],xmm6[6],xmm5[6],xmm6[7],xmm5[7]
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm10 = xmm6[8],xmm5[8],xmm6[9],xmm5[9],xmm6[10],xmm5[10],xmm6[11],xmm5[11],xmm6[12],xmm5[12],xmm6[13],xmm5[13],xmm6[14],xmm5[14],xmm6[15],xmm5[15]
; AVX512-NEXT:    vmovdqa (%rsi), %xmm11
; AVX512-NEXT:    vmovdqa (%rdi), %xmm5
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm6 = xmm5[8],xmm11[8],xmm5[9],xmm11[9],xmm5[10],xmm11[10],xmm5[11],xmm11[11],xmm5[12],xmm11[12],xmm5[13],xmm11[13],xmm5[14],xmm11[14],xmm5[15],xmm11[15]
; AVX512-NEXT:    vpmovzxwq {{.*#+}} zmm22 = xmm6[0],zero,zero,zero,xmm6[1],zero,zero,zero,xmm6[2],zero,zero,zero,xmm6[3],zero,zero,zero,xmm6[4],zero,zero,zero,xmm6[5],zero,zero,zero,xmm6[6],zero,zero,zero,xmm6[7],zero,zero,zero
; AVX512-NEXT:    vpmovzxwq {{.*#+}} zmm24 = xmm7[0],zero,zero,zero,xmm7[1],zero,zero,zero,xmm7[2],zero,zero,zero,xmm7[3],zero,zero,zero,xmm7[4],zero,zero,zero,xmm7[5],zero,zero,zero,xmm7[6],zero,zero,zero,xmm7[7],zero,zero,zero
; AVX512-NEXT:    vpshufd {{.*#+}} ymm6 = ymm26[0,1,1,3,4,5,5,7]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm7 = ymm27[2,1,3,3,6,5,7,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm7, %zmm6, %zmm7
; AVX512-NEXT:    vpbroadcastq {{.*#+}} zmm6 = [65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535]
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm22 = zmm22 | (zmm7 & ~zmm6)
; AVX512-NEXT:    vpshufd $96, {{[-0-9]+}}(%r{{[sb]}}p), %ymm7 # 32-byte Folded Reload
; AVX512-NEXT:    # ymm7 = mem[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd $232, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15 # 32-byte Folded Reload
; AVX512-NEXT:    # ymm15 = mem[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm15, %zmm7, %zmm15
; AVX512-NEXT:    vpshufd $96, {{[-0-9]+}}(%r{{[sb]}}p), %ymm7 # 32-byte Folded Reload
; AVX512-NEXT:    # ymm7 = mem[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd $232, {{[-0-9]+}}(%r{{[sb]}}p), %ymm26 # 32-byte Folded Reload
; AVX512-NEXT:    # ymm26 = mem[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm26, %zmm7, %zmm26
...
; AVX512-NEXT:    vpandnq %zmm15, %zmm7, %zmm15
; AVX512-NEXT:    vpandq %zmm7, %zmm26, %zmm26
; AVX512-NEXT:    movw $-21846, %ax # imm = 0xAAAA
; AVX512-NEXT:    kmovw %eax, %k1
; AVX512-NEXT:    vpord %zmm15, %zmm26, %zmm22 {%k1}
; AVX512-NEXT:    vpshufd $212, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15 # 32-byte Folded Reload
; AVX512-NEXT:    # ymm15 = mem[0,1,1,3,4,5,5,7]
; AVX512-NEXT:    vpshufd $246, {{[-0-9]+}}(%r{{[sb]}}p), %ymm26 # 32-byte Folded Reload
; AVX512-NEXT:    # ymm26 = mem[2,1,3,3,6,5,7,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm26, %zmm15, %zmm15
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm24 = zmm24 | (zmm15 & ~zmm6)
; AVX512-NEXT:    vpshufd $96, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15 # 32-byte Folded Reload
; AVX512-NEXT:    # ymm15 = mem[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd $232, {{[-0-9]+}}(%r{{[sb]}}p), %ymm26 # 32-byte Folded Reload
; AVX512-NEXT:    # ymm26 = mem[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm26, %zmm15, %zmm15
; AVX512-NEXT:    vpshufd $96, {{[-0-9]+}}(%r{{[sb]}}p), %ymm26 # 32-byte Folded Reload
; AVX512-NEXT:    # ymm26 = mem[0,0,2,1,4,4,6,5]
...
; AVX512-NEXT:    vpandnq %zmm15, %zmm7, %zmm15
; AVX512-NEXT:    vpandq %zmm7, %zmm26, %zmm26
; AVX512-NEXT:    vpord %zmm15, %zmm26, %zmm24 {%k1}
; AVX512-NEXT:    vpshufd $212, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15 # 32-byte Folded Reload
; AVX512-NEXT:    # ymm15 = mem[0,1,1,3,4,5,5,7]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm26 = ymm29[2,1,3,3,6,5,7,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm26, %zmm15, %zmm15
; AVX512-NEXT:    vpmovzxwq {{.*#+}} zmm26 = xmm10[0],zero,zero,zero,xmm10[1],zero,zero,zero,xmm10[2],zero,zero,zero,xmm10[3],zero,zero,zero,xmm10[4],zero,zero,zero,xmm10[5],zero,zero,zero,xmm10[6],zero,zero,zero,xmm10[7],zero,zero,zero
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm26 = zmm26 | (zmm15 & ~zmm6)
; AVX512-NEXT:    vpshufd {{.*#+}} ymm15 = ymm28[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm23 = ymm23[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm23, %zmm15, %zmm15
; AVX512-NEXT:    vpshufd {{.*#+}} ymm21 = ymm21[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm19 = ymm19[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm19, %zmm21, %zmm19
; AVX512-NEXT:    vpandnq %zmm15, %zmm7, %zmm15
; AVX512-NEXT:    vpandq %zmm7, %zmm19, %zmm19
; AVX512-NEXT:    vpord %zmm15, %zmm19, %zmm26 {%k1}
; AVX512-NEXT:    vpshufd {{.*#+}} ymm15 = ymm17[0,1,1,3,4,5,5,7]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm16 = ymm16[2,1,3,3,6,5,7,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm16, %zmm15, %zmm15
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm0[0,1,2,3,4,5,5,7]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,6,5,7,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm0, %ymm10, %ymm16
...
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm1[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm1[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm10, %ymm4, %ymm17
; AVX512-NEXT:    vmovdqa 32(%rsi), %xmm0
; AVX512-NEXT:    vmovdqa 32(%rdi), %xmm10
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm10[0],xmm0[0],xmm10[1],xmm0[1],xmm10[2],xmm0[2],xmm10[3],xmm0[3],xmm10[4],xmm0[4],xmm10[5],xmm0[5],xmm10[6],xmm0[6],xmm10[7],xmm0[7]
...
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm4 = zmm4 | (zmm15 & ~zmm6)
; AVX512-NEXT:    vpshufd {{.*#+}} ymm15 = ymm20[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm18 = ymm18[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm18, %zmm15, %zmm15
; AVX512-NEXT:    vpshufd {{.*#+}} ymm14 = ymm14[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm13 = ymm13[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm13, %zmm14, %zmm13
; AVX512-NEXT:    vpandnq %zmm15, %zmm7, %zmm14
; AVX512-NEXT:    vpandq %zmm7, %zmm13, %zmm13
; AVX512-NEXT:    vpord %zmm14, %zmm13, %zmm4 {%k1}
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm13 = xmm1[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm1, %ymm13, %ymm18
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm8 = xmm8[8],xmm9[8],xmm8[9],xmm9[9],xmm8[10],xmm9[10],xmm8[11],xmm9[11],xmm8[12],xmm9[12],xmm8[13],xmm9[13],xmm8[14],xmm9[14],xmm8[15],xmm9[15]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm9 = xmm8[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm13 = xmm8[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm13, %ymm9, %ymm19
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm13 = xmm8[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm8[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti32x4 $1, %xmm8, %ymm13, %ymm20
...
; AVX512-NEXT:    vinserti32x4 $1, %xmm13, %ymm3, %ymm21
...
; AVX512-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm1, %xmm13 # 16-byte Folded Reload
; AVX512-NEXT:    # xmm13 = xmm1[0],mem[0],xmm1[1],mem[1],xmm1[2],mem[2],xmm1[3],mem[3],xmm1[4],mem[4],xmm1[5],mem[5],xmm1[6],mem[6],xmm1[7],mem[7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm14 = xmm13[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm15 = xmm13[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm15, %ymm14, %ymm14
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm15 = xmm13[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm13 = xmm13[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm13, %ymm15, %ymm13
; AVX512-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Reload
; AVX512-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm1, %xmm15 # 16-byte Folded Reload
; AVX512-NEXT:    # xmm15 = xmm1[0],mem[0],xmm1[1],mem[1],xmm1[2],mem[2],xmm1[3],mem[3],xmm1[4],mem[4],xmm1[5],mem[5],xmm1[6],mem[6],xmm1[7],mem[7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm15[0,0,2,1,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm12 = xmm15[0,2,2,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm12, %ymm1, %ymm1
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm12 = xmm15[0,1,2,3,4,4,6,5]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm15 = xmm15[0,1,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm15, %ymm12, %ymm12
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm10[8],xmm0[8],xmm10[9],xmm0[9],xmm10[10],xmm0[10],xmm10[11],xmm0[11],xmm10[12],xmm0[12],xmm10[13],xmm0[13],xmm10[14],xmm0[14],xmm10[15],xmm0[15]
; AVX512-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Reload
; AVX512-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm3, %xmm10 # 16-byte Folded Reload
; AVX512-NEXT:    # xmm10 = xmm3[0],mem[0],xmm3[1],mem[1],xmm3[2],mem[2],xmm3[3],mem[3],xmm3[4],mem[4],xmm3[5],mem[5],xmm3[6],mem[6],xmm3[7],mem[7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm15 = xmm10[0,1,1,3,4,5,6,7]
; AVX512-NEXT:    vpshuflw {{.*#+}} xmm9 = xmm10[2,1,3,3,4,5,6,7]
; AVX512-NEXT:    vinserti128 $1, %xmm9, %ymm15, %ymm9
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm15 = xmm10[0,1,2,3,4,5,5,7]
; AVX512-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm10[0,1,2,3,6,5,7,7]
; AVX512-NEXT:    vinserti128 $1, %xmm10, %ymm15, %ymm10
; AVX512-NEXT:    vmovdqa 16(%rsi), %xmm15
; AVX512-NEXT:    vmovdqa 16(%rdi), %xmm8
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm3 = xmm8[0],xmm15[0],xmm8[1],xmm15[1],xmm8[2],xmm15[2],xmm8[3],xmm15[3],xmm8[4],xmm15[4],xmm8[5],xmm15[5],xmm8[6],xmm15[6],xmm8[7],xmm15[7]
; AVX512-NEXT:    vpunpckhbw {{.*#+}} xmm8 = xmm8[8],xmm15[8],xmm8[9],xmm15[9],xmm8[10],xmm15[10],xmm8[11],xmm15[11],xmm8[12],xmm15[12],xmm8[13],xmm15[13],xmm8[14],xmm15[14],xmm8[15],xmm15[15]
; AVX512-NEXT:    vpunpcklbw {{.*#+}} xmm5 = xmm5[0],xmm11[0],xmm5[1],xmm11[1],xmm5[2],xmm11[2],xmm5[3],xmm11[3],xmm5[4],xmm11[4],xmm5[5],xmm11[5],xmm5[6],xmm11[6],xmm5[7],xmm11[7]
; AVX512-NEXT:    vpshufd $212, {{[-0-9]+}}(%r{{[sb]}}p), %ymm11 # 32-byte Folded Reload
; AVX512-NEXT:    # ymm11 = mem[0,1,1,3,4,5,5,7]
; AVX512-NEXT:    vpshufd $246, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15 # 32-byte Folded Reload
; AVX512-NEXT:    # ymm15 = mem[2,1,3,3,6,5,7,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm15, %zmm11, %zmm11
...
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm0 = zmm0 | (zmm11 & ~zmm6)
...
; AVX512-NEXT:    vpshufd $96, {{[-0-9]+}}(%r{{[sb]}}p), %ymm11 # 32-byte Folded Reload
; AVX512-NEXT:    # ymm11 = mem[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd $232, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15 # 32-byte Folded Reload
; AVX512-NEXT:    # ymm15 = mem[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm15, %zmm11, %zmm11
; AVX512-NEXT:    vpshufd $96, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15 # 32-byte Folded Reload
...
; AVX512-NEXT:    vinserti64x4 $1, %ymm23, %zmm15, %zmm15
; AVX512-NEXT:    vpandnq %zmm11, %zmm7, %zmm11
; AVX512-NEXT:    vpandq %zmm7, %zmm15, %zmm15
; AVX512-NEXT:    vpord %zmm11, %zmm15, %zmm0 {%k1}
; AVX512-NEXT:    vpshufd $212, {{[-0-9]+}}(%r{{[sb]}}p), %ymm11 # 32-byte Folded Reload
; AVX512-NEXT:    # ymm11 = mem[0,1,1,3,4,5,5,7]
; AVX512-NEXT:    vpshufd $246, (%rsp), %ymm15 # 32-byte Folded Reload
; AVX512-NEXT:    # ymm15 = mem[2,1,3,3,6,5,7,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm15, %zmm11, %zmm11
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm3 = zmm3 | (zmm11 & ~zmm6)
; AVX512-NEXT:    vpshufd {{.*#+}} ymm11 = ymm30[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm15 = ymm31[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm15, %zmm11, %zmm11
; AVX512-NEXT:    vpshufd {{.*#+}} ymm15 = ymm25[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm16 = ymm16[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm16, %zmm15, %zmm15
; AVX512-NEXT:    vpandnq %zmm11, %zmm7, %zmm11
; AVX512-NEXT:    vpandq %zmm7, %zmm15, %zmm15
; AVX512-NEXT:    vpord %zmm11, %zmm15, %zmm3 {%k1}
; AVX512-NEXT:    vpshufd {{.*#+}} ymm11 = ymm17[0,1,1,3,4,5,5,7]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm15 = ymm18[2,1,3,3,6,5,7,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm15, %zmm11, %zmm11
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm8 = zmm8 | (zmm11 & ~zmm6)
; AVX512-NEXT:    vpshufd {{.*#+}} ymm11 = ymm19[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm15 = ymm20[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm15, %zmm11, %zmm11
; AVX512-NEXT:    vpshufd {{.*#+}} ymm15 = ymm21[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm2 = ymm2[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm2, %zmm15, %zmm2
; AVX512-NEXT:    vpandnq %zmm11, %zmm7, %zmm11
; AVX512-NEXT:    vpandq %zmm7, %zmm2, %zmm2
; AVX512-NEXT:    vpord %zmm11, %zmm2, %zmm8 {%k1}
; AVX512-NEXT:    vpshufd {{.*#+}} ymm2 = ymm14[0,1,1,3,4,5,5,7]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm11 = ymm13[2,1,3,3,6,5,7,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm11, %zmm2, %zmm2
; AVX512-NEXT:    vpternlogq {{.*#+}} zmm5 = zmm5 | (zmm2 & ~zmm6)
; AVX512-NEXT:    vpshufd {{.*#+}} ymm1 = ymm1[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm2 = ymm12[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm2, %zmm1, %zmm1
; AVX512-NEXT:    vpshufd {{.*#+}} ymm2 = ymm9[0,0,2,1,4,4,6,5]
; AVX512-NEXT:    vpshufd {{.*#+}} ymm6 = ymm10[0,2,2,3,4,6,6,7]
; AVX512-NEXT:    vinserti64x4 $1, %ymm6, %zmm2, %zmm2
; AVX512-NEXT:    vpandnq %zmm1, %zmm7, %zmm1
; AVX512-NEXT:    vpandq %zmm7, %zmm2, %zmm2
; AVX512-NEXT:    vpord %zmm1, %zmm2, %zmm5 {%k1}
; AVX512-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX512-NEXT:    vmovdqa64 %zmm5, (%rax)
...
; AVX512-NEXT:    vmovdqa64 %zmm26, 448(%rax)
...
; AVX512-FCP:       # %bb.0:
; AVX512-FCP-NEXT:    subq $312, %rsp # imm = 0x138
; AVX512-FCP-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX512-FCP-NEXT:    movq {{[0-9]+}}(%rsp), %r10
; AVX512-FCP-NEXT:    vmovdqa (%rcx), %xmm15
; AVX512-FCP-NEXT:    vmovdqa 48(%rcx), %xmm5
; AVX512-FCP-NEXT:    vmovdqa (%rdx), %xmm0
; AVX512-FCP-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512-FCP-NEXT:    vmovdqa 48(%rdx), %xmm4
; AVX512-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm0[8],xmm15[8],xmm0[9],xmm15[9],xmm0[10],xmm15[10],xmm0[11],xmm15[11],xmm0[12],xmm15[12],xmm0[13],xmm15[13],xmm0[14],xmm15[14],xmm0[15],xmm15[15]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
...
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm3, %zmm2, %zmm0
; AVX512-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vmovdqa (%r10), %xmm0
; AVX512-FCP-NEXT:    vmovdqa (%rax), %xmm1
; AVX512-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm1[8],xmm0[8],xmm1[9],xmm0[9],xmm1[10],xmm0[10],xmm1[11],xmm0[11],xmm1[12],xmm0[12],xmm1[13],xmm0[13],xmm1[14],xmm0[14],xmm1[15],xmm0[15]
...
; AVX512-FCP-NEXT:    vmovdqa {{.*#+}} ymm12 = [0,1,0,1,0,1,0,1,8,9,10,11,4,5,2,3,0,1,4,5,0,1,4,5,8,9,10,11,4,5,6,7]
...
; AVX512-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm1[8],xmm0[8],xmm1[9],xmm0[9],xmm1[10],xmm0[10],xmm1[11],xmm0[11],xmm1[12],xmm0[12],xmm1[13],xmm0[13],xmm1[14],xmm0[14],xmm1[15],xmm0[15]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; AVX512-FCP-NEXT:    vmovdqa {{.*#+}} ymm7 = [0,1,2,3,8,9,10,11,8,9,10,11,10,11,14,15,0,1,2,3,12,13,10,11,12,13,10,11,14,15,14,15]
; AVX512-FCP-NEXT:    vpshufb %ymm7, %ymm2, %ymm3
; AVX512-FCP-NEXT:    vmovdqa {{.*#+}} ymm10 = [0,1,2,3,0,1,2,3,8,9,10,11,2,3,6,7,4,5,2,3,4,5,2,3,8,9,10,11,6,7,6,7]
; AVX512-FCP-NEXT:    vpshufb %ymm10, %ymm2, %ymm2
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm3, %zmm2, %zmm21
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm4[0],xmm5[0],xmm4[1],xmm5[1],xmm4[2],xmm5[2],xmm4[3],xmm5[3],xmm4[4],xmm5[4],xmm4[5],xmm5[5],xmm4[6],xmm5[6],xmm4[7],xmm5[7]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; AVX512-FCP-NEXT:    vpshufb %ymm6, %ymm2, %ymm3
; AVX512-FCP-NEXT:    vpshufb %ymm8, %ymm2, %ymm2
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm3, %zmm2, %zmm0
...
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm14 = xmm3[0],xmm2[0],xmm3[1],xmm2[1],xmm3[2],xmm2[2],xmm3[3],xmm2[3],xmm3[4],xmm2[4],xmm3[5],xmm2[5],xmm3[6],xmm2[6],xmm3[7],xmm2[7]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm14, %ymm14, %ymm14
; AVX512-FCP-NEXT:    vpshufb %ymm11, %ymm14, %ymm0
; AVX512-FCP-NEXT:    vpshufb %ymm12, %ymm14, %ymm14
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm0, %zmm14, %zmm0
; AVX512-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vmovdqa 48(%r9), %xmm1
; AVX512-FCP-NEXT:    vmovdqa 48(%r8), %xmm14
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm13 = xmm14[0],xmm1[0],xmm14[1],xmm1[1],xmm14[2],xmm1[2],xmm14[3],xmm1[3],xmm14[4],xmm1[4],xmm14[5],xmm1[5],xmm14[6],xmm1[6],xmm14[7],xmm1[7]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm13, %ymm13, %ymm13
; AVX512-FCP-NEXT:    vpshufb %ymm7, %ymm13, %ymm0
; AVX512-FCP-NEXT:    vpshufb %ymm10, %ymm13, %ymm13
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm0, %zmm13, %zmm0
; AVX512-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm4[8],xmm5[8],xmm4[9],xmm5[9],xmm4[10],xmm5[10],xmm4[11],xmm5[11],xmm4[12],xmm5[12],xmm4[13],xmm5[13],xmm4[14],xmm5[14],xmm4[15],xmm5[15]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX512-FCP-NEXT:    vpshufb %ymm6, %ymm0, %ymm4
...
; AVX512-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm14[8],xmm1[8],xmm14[9],xmm1[9],xmm14[10],xmm1[10],xmm14[11],xmm1[11],xmm14[12],xmm1[12],xmm14[13],xmm1[13],xmm14[14],xmm1[14],xmm14[15],xmm1[15]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm1, %ymm1, %ymm1
; AVX512-FCP-NEXT:    vpshufb %ymm7, %ymm1, %ymm3
; AVX512-FCP-NEXT:    vpshufb %ymm10, %ymm1, %ymm1
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm3, %zmm1, %zmm18
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm2[0],xmm0[0],xmm2[1],xmm0[1],xmm2[2],xmm0[2],xmm2[3],xmm0[3],xmm2[4],xmm0[4],xmm2[5],xmm0[5],xmm2[6],xmm0[6],xmm2[7],xmm0[7]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm1, %ymm1, %ymm1
; AVX512-FCP-NEXT:    vpshufb %ymm6, %ymm1, %ymm3
; AVX512-FCP-NEXT:    vpshufb %ymm8, %ymm1, %ymm1
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm3, %zmm1, %zmm20
; AVX512-FCP-NEXT:    vmovdqa 32(%r10), %xmm1
; AVX512-FCP-NEXT:    vmovdqa 32(%rax), %xmm3
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm3[0],xmm1[0],xmm3[1],xmm1[1],xmm3[2],xmm1[2],xmm3[3],xmm1[3],xmm3[4],xmm1[4],xmm3[5],xmm1[5],xmm3[6],xmm1[6],xmm3[7],xmm1[7]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm4, %ymm4, %ymm4
...
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm13 = xmm5[0],xmm4[0],xmm5[1],xmm4[1],xmm5[2],xmm4[2],xmm5[3],xmm4[3],xmm5[4],xmm4[4],xmm5[5],xmm4[5],xmm5[6],xmm4[6],xmm5[7],xmm4[7]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm13, %ymm13, %ymm13
; AVX512-FCP-NEXT:    vpshufb %ymm7, %ymm13, %ymm14
; AVX512-FCP-NEXT:    vpshufb %ymm10, %ymm13, %ymm13
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm14, %zmm13, %zmm23
...
; AVX512-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm3[8],xmm1[8],xmm3[9],xmm1[9],xmm3[10],xmm1[10],xmm3[11],xmm1[11],xmm3[12],xmm1[12],xmm3[13],xmm1[13],xmm3[14],xmm1[14],xmm3[15],xmm1[15]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
...
; AVX512-FCP-NEXT:    vpshufb %ymm7, %ymm13, %ymm14
; AVX512-FCP-NEXT:    vpshufb %ymm10, %ymm13, %ymm13
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm14, %zmm13, %zmm29
...
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm9
; AVX512-FCP-NEXT:    vmovdqa (%rsi), %xmm4
; AVX512-FCP-NEXT:    vmovdqa (%rdi), %xmm5
; AVX512-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm5[8],xmm4[8],xmm5[9],xmm4[9],xmm5[10],xmm4[10],xmm5[11],xmm4[11],xmm5[12],xmm4[12],xmm5[13],xmm4[13],xmm5[14],xmm4[14],xmm5[15],xmm4[15]
; AVX512-FCP-NEXT:    vpmovsxwq {{.*#+}} xmm13 = [1284,1798]
...
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm0, %zmm1, %zmm2
...
; AVX512-FCP-NEXT:    vpternlogq $226, {{[-0-9]+}}(%r{{[sb]}}p), %zmm3, %zmm2 # 64-byte Folded Reload
; AVX512-FCP-NEXT:    # zmm2 = mem ^ (zmm3 & (zmm2 ^ mem))
; AVX512-FCP-NEXT:    vpbroadcastq {{.*#+}} zmm1 = [65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0]
; AVX512-FCP-NEXT:    vpandnq %zmm19, %zmm1, %zmm19
; AVX512-FCP-NEXT:    vpandq %zmm1, %zmm21, %zmm21
; AVX512-FCP-NEXT:    movw $-21846, %ax # imm = 0xAAAA
; AVX512-FCP-NEXT:    kmovw %eax, %k1
; AVX512-FCP-NEXT:    vpord %zmm19, %zmm21, %zmm2 {%k1}
; AVX512-FCP-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm15 = xmm0[0],xmm15[0],xmm0[1],xmm15[1],xmm0[2],xmm15[2],xmm0[3],xmm15[3],xmm0[4],xmm15[4],xmm0[5],xmm15[5],xmm0[6],xmm15[6],xmm0[7],xmm15[7]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm15, %ymm15, %ymm15
...
; AVX512-FCP-NEXT:    vmovdqa 48(%rsi), %xmm8
; AVX512-FCP-NEXT:    vmovdqa 48(%rdi), %xmm15
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm6 = xmm15[0],xmm8[0],xmm15[1],xmm8[1],xmm15[2],xmm8[2],xmm15[3],xmm8[3],xmm15[4],xmm8[4],xmm15[5],xmm8[5],xmm15[6],xmm8[6],xmm15[7],xmm8[7]
; AVX512-FCP-NEXT:    vpshufb %xmm13, %xmm6, %xmm0
...
; AVX512-FCP-NEXT:    vpshufb %ymm14, %ymm6, %ymm6
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm6, %zmm0, %zmm0
; AVX512-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm6 = xmm15[8],xmm8[8],xmm15[9],xmm8[9],xmm15[10],xmm8[10],xmm15[11],xmm8[11],xmm15[12],xmm8[12],xmm15[13],xmm8[13],xmm15[14],xmm8[14],xmm15[15],xmm8[15]
; AVX512-FCP-NEXT:    vpshufb %xmm13, %xmm6, %xmm8
; AVX512-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm15 = xmm6[0],zero,zero,zero,xmm6[1],zero,zero,zero
...
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm8 = xmm8[0],xmm15[0],xmm8[1],xmm15[1],xmm8[2],xmm15[2],xmm8[3],xmm15[3],xmm8[4],xmm15[4],xmm8[5],xmm15[5],xmm8[6],xmm15[6],xmm8[7],xmm15[7]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm8, %ymm8, %ymm8
; AVX512-FCP-NEXT:    vpshufb %ymm11, %ymm8, %ymm11
; AVX512-FCP-NEXT:    vpshufb %ymm12, %ymm8, %ymm8
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm11, %zmm8, %zmm21
; AVX512-FCP-NEXT:    vmovdqa 32(%rsi), %xmm11
; AVX512-FCP-NEXT:    vmovdqa 32(%rdi), %xmm12
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm15 = xmm12[0],xmm11[0],xmm12[1],xmm11[1],xmm12[2],xmm11[2],xmm12[3],xmm11[3],xmm12[4],xmm11[4],xmm12[5],xmm11[5],xmm12[6],xmm11[6],xmm12[7],xmm11[7]
; AVX512-FCP-NEXT:    vpshufb %xmm13, %xmm15, %xmm8
; AVX512-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm16 = xmm15[0],zero,zero,zero,xmm15[1],zero,zero,zero
; AVX512-FCP-NEXT:    vinserti32x4 $1, %xmm8, %ymm16, %ymm8
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm15, %ymm15, %ymm15
; AVX512-FCP-NEXT:    vpshufb %ymm14, %ymm15, %ymm15
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm15, %zmm8, %zmm8
; AVX512-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm11 = xmm12[8],xmm11[8],xmm12[9],xmm11[9],xmm12[10],xmm11[10],xmm12[11],xmm11[11],xmm12[12],xmm11[12],xmm12[13],xmm11[13],xmm12[14],xmm11[14],xmm12[15],xmm11[15]
; AVX512-FCP-NEXT:    vpshufb %xmm13, %xmm11, %xmm12
; AVX512-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm15 = xmm11[0],zero,zero,zero,xmm11[1],zero,zero,zero
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm12, %ymm15, %ymm12
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm11, %ymm11, %ymm11
; AVX512-FCP-NEXT:    vpshufb %ymm14, %ymm11, %ymm11
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm11, %zmm12, %zmm11
; AVX512-FCP-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm12 # 16-byte Reload
; AVX512-FCP-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm12, %xmm12 # 16-byte Folded Reload
; AVX512-FCP-NEXT:    # xmm12 = xmm12[0],mem[0],xmm12[1],mem[1],xmm12[2],mem[2],xmm12[3],mem[3],xmm12[4],mem[4],xmm12[5],mem[5],xmm12[6],mem[6],xmm12[7],mem[7]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm12, %ymm12, %ymm12
; AVX512-FCP-NEXT:    vpshufb %ymm7, %ymm12, %ymm7
; AVX512-FCP-NEXT:    vpshufb %ymm10, %ymm12, %ymm10
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm7, %zmm10, %zmm16
; AVX512-FCP-NEXT:    vmovdqa 16(%rsi), %xmm10
; AVX512-FCP-NEXT:    vmovdqa 16(%rdi), %xmm12
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm15 = xmm12[0],xmm10[0],xmm12[1],xmm10[1],xmm12[2],xmm10[2],xmm12[3],xmm10[3],xmm12[4],xmm10[4],xmm12[5],xmm10[5],xmm12[6],xmm10[6],xmm12[7],xmm10[7]
; AVX512-FCP-NEXT:    vpshufb %xmm13, %xmm15, %xmm7
; AVX512-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm17 = xmm15[0],zero,zero,zero,xmm15[1],zero,zero,zero
; AVX512-FCP-NEXT:    vinserti32x4 $1, %xmm7, %ymm17, %ymm7
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm15, %ymm15, %ymm15
; AVX512-FCP-NEXT:    vpshufb %ymm14, %ymm15, %ymm15
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm15, %zmm7, %zmm7
; AVX512-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm10 = xmm12[8],xmm10[8],xmm12[9],xmm10[9],xmm12[10],xmm10[10],xmm12[11],xmm10[11],xmm12[12],xmm10[12],xmm12[13],xmm10[13],xmm12[14],xmm10[14],xmm12[15],xmm10[15]
; AVX512-FCP-NEXT:    vpshufb %xmm13, %xmm10, %xmm12
; AVX512-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm15 = xmm10[0],zero,zero,zero,xmm10[1],zero,zero,zero
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm12, %ymm15, %ymm12
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm10, %ymm10, %ymm10
; AVX512-FCP-NEXT:    vpshufb %ymm14, %ymm10, %ymm10
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm10, %zmm12, %zmm10
; AVX512-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm5[0],xmm4[0],xmm5[1],xmm4[1],xmm5[2],xmm4[2],xmm5[3],xmm4[3],xmm5[4],xmm4[4],xmm5[5],xmm4[5],xmm5[6],xmm4[6],xmm5[7],xmm4[7]
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm4, %ymm4, %ymm5
; AVX512-FCP-NEXT:    vpshufb %ymm14, %ymm5, %ymm5
; AVX512-FCP-NEXT:    vpshufb %xmm13, %xmm4, %xmm12
; AVX512-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm4 = xmm4[0],zero,zero,zero,xmm4[1],zero,zero,zero
; AVX512-FCP-NEXT:    vinserti128 $1, %xmm12, %ymm4, %ymm4
; AVX512-FCP-NEXT:    vinserti64x4 $1, %ymm5, %zmm4, %zmm4
; AVX512-FCP-NEXT:    vpternlogq $226, {{[-0-9]+}}(%r{{[sb]}}p), %zmm3, %zmm0 # 64-byte Folded Reload
; AVX512-FCP-NEXT:    # zmm0 = mem ^ (zmm3 & (zmm0 ^ mem))
; AVX512-FCP-NEXT:    vpandnq {{[-0-9]+}}(%r{{[sb]}}p), %zmm1, %zmm5 # 64-byte Folded Reload
; AVX512-FCP-NEXT:    vpandq {{[-0-9]+}}(%r{{[sb]}}p), %zmm1, %zmm12 # 64-byte Folded Reload
; AVX512-FCP-NEXT:    vpord %zmm5, %zmm12, %zmm0 {%k1}
; AVX512-FCP-NEXT:    vpternlogq $226, {{[-0-9]+}}(%r{{[sb]}}p), %zmm3, %zmm6 # 64-byte Folded Reload
; AVX512-FCP-NEXT:    # zmm6 = mem ^ (zmm3 & (zmm6 ^ mem))
; AVX512-FCP-NEXT:    vpandnq {{[-0-9]+}}(%r{{[sb]}}p), %zmm1, %zmm5 # 64-byte Folded Reload
; AVX512-FCP-NEXT:    vpandq %zmm1, %zmm18, %zmm12
; AVX512-FCP-NEXT:    vpord %zmm5, %zmm12, %zmm6 {%k1}
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} zmm8 = zmm20 ^ (zmm3 & (zmm8 ^ zmm20))
; AVX512-FCP-NEXT:    vpandnq %zmm22, %zmm1, %zmm5
; AVX512-FCP-NEXT:    vpandq %zmm1, %zmm23, %zmm12
; AVX512-FCP-NEXT:    vpord %zmm5, %zmm12, %zmm8 {%k1}
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} zmm11 = zmm24 ^ (zmm3 & (zmm11 ^ zmm24))
; AVX512-FCP-NEXT:    vpandnq %zmm25, %zmm1, %zmm5
; AVX512-FCP-NEXT:    vpandq %zmm1, %zmm26, %zmm12
; AVX512-FCP-NEXT:    vpord %zmm5, %zmm12, %zmm11 {%k1}
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} zmm7 = zmm27 ^ (zmm3 & (zmm7 ^ zmm27))
; AVX512-FCP-NEXT:    vpandnq %zmm28, %zmm1, %zmm5
; AVX512-FCP-NEXT:    vpandq %zmm1, %zmm29, %zmm12
; AVX512-FCP-NEXT:    vpord %zmm5, %zmm12, %zmm7 {%k1}
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} zmm10 = zmm30 ^ (zmm3 & (zmm10 ^ zmm30))
; AVX512-FCP-NEXT:    vpandnq %zmm31, %zmm1, %zmm5
; AVX512-FCP-NEXT:    vpandq %zmm1, %zmm9, %zmm9
; AVX512-FCP-NEXT:    vpord %zmm5, %zmm9, %zmm10 {%k1}
; AVX512-FCP-NEXT:    vpternlogq {{.*#+}} zmm4 = zmm19 ^ (zmm3 & (zmm4 ^ zmm19))
; AVX512-FCP-NEXT:    vpandnq %zmm21, %zmm1, %zmm3
; AVX512-FCP-NEXT:    vpandq %zmm1, %zmm16, %zmm1
; AVX512-FCP-NEXT:    vpord %zmm3, %zmm1, %zmm4 {%k1}
; AVX512-FCP-NEXT:    movq {{[0-9]+}}(%rsp), %rax
...
; AVX512-FCP-NEXT:    vmovdqa64 %zmm6, 448(%rax)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm0, 384(%rax)
; AVX512-FCP-NEXT:    vmovdqa64 %zmm2, 64(%rax)
; AVX512-FCP-NEXT:    addq $312, %rsp # imm = 0x138
; AVX512-FCP-NEXT:    vzeroupper
; AVX512-FCP-NEXT:    retq
;
...
; AVX512DQ-NEXT:    vmovdqa 48(%rcx), %xmm13
; AVX512DQ-NEXT:    vmovdqa (%rdx), %xmm1
; AVX512DQ-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512DQ-NEXT:    vmovdqa 48(%rdx), %xmm14
...
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm2, %ymm3, %ymm27
; AVX512DQ-NEXT:    vmovdqa (%r10), %xmm0
; AVX512DQ-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512DQ-NEXT:    vmovdqa 48(%r10), %xmm2
; AVX512DQ-NEXT:    vmovdqa (%rax), %xmm1
; AVX512DQ-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512DQ-NEXT:    vmovdqa 48(%rax), %xmm3
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm4 = xmm1[8],xmm0[8],xmm1[9],xmm0[9],xmm1[10],xmm0[10],xmm1[11],xmm0[11],xmm1[12],xmm0[12],xmm1[13],xmm0[13],xmm1[14],xmm0[14],xmm1[15],xmm0[15]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm4[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm4[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm7, %ymm5, %ymm0
; AVX512DQ-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm4[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm4 = xmm4[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm4, %ymm5, %ymm0
; AVX512DQ-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512DQ-NEXT:    vmovdqa (%r9), %xmm0
; AVX512DQ-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512DQ-NEXT:    vmovdqa 48(%r9), %xmm4
; AVX512DQ-NEXT:    vmovdqa (%r8), %xmm1
; AVX512DQ-NEXT:    vmovdqa %xmm1, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512DQ-NEXT:    vmovdqa 48(%r8), %xmm5
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm7 = xmm1[8],xmm0[8],xmm1[9],xmm0[9],xmm1[10],xmm0[10],xmm1[11],xmm0[11],xmm1[12],xmm0[12],xmm1[13],xmm0[13],xmm1[14],xmm0[14],xmm1[15],xmm0[15]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm8 = xmm7[0,1,1,3,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm9 = xmm7[2,1,3,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm9, %ymm8, %ymm0
; AVX512DQ-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm7[0,1,2,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm7 = xmm7[0,1,2,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm7, %ymm8, %ymm0
; AVX512DQ-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm9 = xmm8[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm8[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm10, %ymm9, %ymm0
; AVX512DQ-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm8[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm8[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm8, %ymm9, %ymm0
; AVX512DQ-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm8 = xmm3[0],xmm2[0],xmm3[1],xmm2[1],xmm3[2],xmm2[2],xmm3[3],xmm2[3],xmm3[4],xmm2[4],xmm3[5],xmm2[5],xmm3[6],xmm2[6],xmm3[7],xmm2[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm9 = xmm8[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm8[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm11, %ymm9, %ymm0
; AVX512DQ-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm8[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm8[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm8, %ymm9, %ymm0
; AVX512DQ-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm8 = xmm5[0],xmm4[0],xmm5[1],xmm4[1],xmm5[2],xmm4[2],xmm5[3],xmm4[3],xmm5[4],xmm4[4],xmm5[5],xmm4[5],xmm5[6],xmm4[6],xmm5[7],xmm4[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm9 = xmm8[0,1,1,3,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm8[2,1,3,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm11, %ymm9, %ymm0
; AVX512DQ-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512DQ-NEXT:    vmovdqa 32(%rdx), %xmm7
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm8[0,1,2,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm8[0,1,2,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm8, %ymm9, %ymm0
; AVX512DQ-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512DQ-NEXT:    vmovdqa 32(%r10), %xmm10
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm8 = xmm14[8],xmm13[8],xmm14[9],xmm13[9],xmm14[10],xmm13[10],xmm14[11],xmm13[11],xmm14[12],xmm13[12],xmm14[13],xmm13[13],xmm14[14],xmm13[14],xmm14[15],xmm13[15]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm9 = xmm8[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm11 = xmm8[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm11, %ymm9, %ymm0
; AVX512DQ-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512DQ-NEXT:    vmovdqa 32(%rax), %xmm6
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm9 = xmm8[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm8[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm8, %ymm9, %ymm29
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm3[8],xmm2[8],xmm3[9],xmm2[9],xmm3[10],xmm2[10],xmm3[11],xmm2[11],xmm3[12],xmm2[12],xmm3[13],xmm2[13],xmm3[14],xmm2[14],xmm3[15],xmm2[15]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm8 = xmm2[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm8, %ymm3, %ymm28
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm2[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm2, %ymm3, %ymm23
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm5[8],xmm4[8],xmm5[9],xmm4[9],xmm5[10],xmm4[10],xmm5[11],xmm4[11],xmm5[12],xmm4[12],xmm5[13],xmm4[13],xmm5[14],xmm4[14],xmm5[15],xmm4[15]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[0,1,1,3,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm2[2,1,3,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm4, %ymm3, %ymm21
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm2[0,1,2,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm2, %ymm3, %ymm19
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm7[0],xmm12[0],xmm7[1],xmm12[1],xmm7[2],xmm12[2],xmm7[3],xmm12[3],xmm7[4],xmm12[4],xmm7[5],xmm12[5],xmm7[6],xmm12[6],xmm7[7],xmm12[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm2[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm4, %ymm3, %ymm17
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm2[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm2, %ymm3, %ymm16
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm6[0],xmm10[0],xmm6[1],xmm10[1],xmm6[2],xmm10[2],xmm6[3],xmm10[3],xmm6[4],xmm10[4],xmm6[5],xmm10[5],xmm6[6],xmm10[6],xmm6[7],xmm10[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm8 = xmm2[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm8, %ymm3, %ymm20
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm2[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm2, %ymm3, %ymm18
...
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[0,1,1,3,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm15 = xmm2[2,1,3,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm15, %ymm3, %ymm14
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm15 = xmm2[0,1,2,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm2, %ymm15, %ymm13
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm7 = xmm7[8],xmm12[8],xmm7[9],xmm12[9],xmm7[10],xmm12[10],xmm7[11],xmm12[11],xmm7[12],xmm12[12],xmm7[13],xmm12[13],xmm7[14],xmm12[14],xmm7[15],xmm12[15]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm12 = xmm7[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm15 = xmm7[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm15, %ymm12, %ymm2
; AVX512DQ-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm12 = xmm7[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm7 = xmm7[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm7, %ymm12, %ymm2
; AVX512DQ-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm6 = xmm6[8],xmm10[8],xmm6[9],xmm10[9],xmm6[10],xmm10[10],xmm6[11],xmm10[11],xmm6[12],xmm10[12],xmm6[13],xmm10[13],xmm6[14],xmm10[14],xmm6[15],xmm10[15]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm6[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm6[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm10, %ymm7, %ymm2
; AVX512DQ-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm7 = xmm6[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm6 = xmm6[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm6, %ymm7, %ymm2
; AVX512DQ-NEXT:    vmovdqu %ymm2, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
...
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm6 = xmm0[2,1,3,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm6, %ymm1, %ymm1
...
; AVX512DQ-NEXT:    vmovdqa 16(%rdx), %xmm1
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm2 = xmm1[0],xmm4[0],xmm1[1],xmm4[1],xmm1[2],xmm4[2],xmm1[3],xmm4[3],xmm1[4],xmm4[4],xmm1[5],xmm4[5],xmm1[6],xmm4[6],xmm1[7],xmm4[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm3 = xmm2[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm6 = xmm2[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm6, %ymm3, %ymm0
; AVX512DQ-NEXT:    vmovdqu %ymm0, {{[-0-9]+}}(%r{{[sb]}}p) # 32-byte Spill
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm3 = xmm2[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm2 = xmm2[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm2, %ymm3, %ymm0
; AVX512DQ-NEXT:    vmovdqu %ymm0, (%rsp) # 32-byte Spill
; AVX512DQ-NEXT:    vmovdqa 16(%r10), %xmm9
; AVX512DQ-NEXT:    vmovdqa 16(%rax), %xmm8
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm5 = xmm8[0],xmm9[0],xmm8[1],xmm9[1],xmm8[2],xmm9[2],xmm8[3],xmm9[3],xmm8[4],xmm9[4],xmm8[5],xmm9[5],xmm8[6],xmm9[6],xmm8[7],xmm9[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm6 = xmm5[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm7 = xmm5[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm7, %ymm6, %ymm30
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm6 = xmm5[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm5 = xmm5[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm5, %ymm6, %ymm31
; AVX512DQ-NEXT:    vmovdqa 16(%r9), %xmm3
; AVX512DQ-NEXT:    vmovdqa 16(%r8), %xmm2
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm0 = xmm2[0],xmm3[0],xmm2[1],xmm3[1],xmm2[2],xmm3[2],xmm2[3],xmm3[3],xmm2[4],xmm3[4],xmm2[5],xmm3[5],xmm2[6],xmm3[6],xmm2[7],xmm3[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm5 = xmm0[0,1,1,3,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm6 = xmm0[2,1,3,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm6, %ymm5, %ymm25
; AVX512DQ-NEXT:    vmovdqa 48(%rsi), %xmm5
; AVX512DQ-NEXT:    vmovdqa 48(%rdi), %xmm6
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm7 = xmm6[0],xmm5[0],xmm6[1],xmm5[1],xmm6[2],xmm5[2],xmm6[3],xmm5[3],xmm6[4],xmm5[4],xmm6[5],xmm5[5],xmm6[6],xmm5[6],xmm6[7],xmm5[7]
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm10 = xmm6[8],xmm5[8],xmm6[9],xmm5[9],xmm6[10],xmm5[10],xmm6[11],xmm5[11],xmm6[12],xmm5[12],xmm6[13],xmm5[13],xmm6[14],xmm5[14],xmm6[15],xmm5[15]
; AVX512DQ-NEXT:    vmovdqa (%rsi), %xmm11
; AVX512DQ-NEXT:    vmovdqa (%rdi), %xmm5
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm6 = xmm5[8],xmm11[8],xmm5[9],xmm11[9],xmm5[10],xmm11[10],xmm5[11],xmm11[11],xmm5[12],xmm11[12],xmm5[13],xmm11[13],xmm5[14],xmm11[14],xmm5[15],xmm11[15]
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} zmm22 = xmm6[0],zero,zero,zero,xmm6[1],zero,zero,zero,xmm6[2],zero,zero,zero,xmm6[3],zero,zero,zero,xmm6[4],zero,zero,zero,xmm6[5],zero,zero,zero,xmm6[6],zero,zero,zero,xmm6[7],zero,zero,zero
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} zmm24 = xmm7[0],zero,zero,zero,xmm7[1],zero,zero,zero,xmm7[2],zero,zero,zero,xmm7[3],zero,zero,zero,xmm7[4],zero,zero,zero,xmm7[5],zero,zero,zero,xmm7[6],zero,zero,zero,xmm7[7],zero,zero,zero
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm6 = ymm26[0,1,1,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm7 = ymm27[2,1,3,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm7, %zmm6, %zmm7
; AVX512DQ-NEXT:    vpbroadcastq {{.*#+}} zmm6 = [65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535]
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm22 = zmm22 | (zmm7 & ~zmm6)
; AVX512DQ-NEXT:    vpshufd $96, {{[-0-9]+}}(%r{{[sb]}}p), %ymm7 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm7 = mem[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd $232, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm15 = mem[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm15, %zmm7, %zmm15
; AVX512DQ-NEXT:    vpshufd $96, {{[-0-9]+}}(%r{{[sb]}}p), %ymm7 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm7 = mem[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd $232, {{[-0-9]+}}(%r{{[sb]}}p), %ymm26 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm26 = mem[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm26, %zmm7, %zmm26
...
; AVX512DQ-NEXT:    vpandnq %zmm15, %zmm7, %zmm15
; AVX512DQ-NEXT:    vpandq %zmm7, %zmm26, %zmm26
; AVX512DQ-NEXT:    movw $-21846, %ax # imm = 0xAAAA
; AVX512DQ-NEXT:    kmovw %eax, %k1
; AVX512DQ-NEXT:    vpord %zmm15, %zmm26, %zmm22 {%k1}
; AVX512DQ-NEXT:    vpshufd $212, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm15 = mem[0,1,1,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufd $246, {{[-0-9]+}}(%r{{[sb]}}p), %ymm26 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm26 = mem[2,1,3,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm26, %zmm15, %zmm15
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm24 = zmm24 | (zmm15 & ~zmm6)
; AVX512DQ-NEXT:    vpshufd $96, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm15 = mem[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd $232, {{[-0-9]+}}(%r{{[sb]}}p), %ymm26 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm26 = mem[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm26, %zmm15, %zmm15
; AVX512DQ-NEXT:    vpshufd $96, {{[-0-9]+}}(%r{{[sb]}}p), %ymm26 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm26 = mem[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd $232, {{[-0-9]+}}(%r{{[sb]}}p), %ymm27 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm27 = mem[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm27, %zmm26, %zmm26
; AVX512DQ-NEXT:    vpandnq %zmm15, %zmm7, %zmm15
; AVX512DQ-NEXT:    vpandq %zmm7, %zmm26, %zmm26
; AVX512DQ-NEXT:    vpord %zmm15, %zmm26, %zmm24 {%k1}
; AVX512DQ-NEXT:    vpshufd $212, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm15 = mem[0,1,1,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm26 = ymm29[2,1,3,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm26, %zmm15, %zmm15
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} zmm26 = xmm10[0],zero,zero,zero,xmm10[1],zero,zero,zero,xmm10[2],zero,zero,zero,xmm10[3],zero,zero,zero,xmm10[4],zero,zero,zero,xmm10[5],zero,zero,zero,xmm10[6],zero,zero,zero,xmm10[7],zero,zero,zero
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm26 = zmm26 | (zmm15 & ~zmm6)
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm15 = ymm28[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm23 = ymm23[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm23, %zmm15, %zmm15
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm21 = ymm21[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm19 = ymm19[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm19, %zmm21, %zmm19
; AVX512DQ-NEXT:    vpandnq %zmm15, %zmm7, %zmm15
; AVX512DQ-NEXT:    vpandq %zmm7, %zmm19, %zmm19
; AVX512DQ-NEXT:    vpord %zmm15, %zmm19, %zmm26 {%k1}
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm15 = ymm17[0,1,1,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm16 = ymm16[2,1,3,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm16, %zmm15, %zmm15
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm0[0,1,2,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm0 = xmm0[0,1,2,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm0, %ymm10, %ymm16
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm1[8],xmm4[8],xmm1[9],xmm4[9],xmm1[10],xmm4[10],xmm1[11],xmm4[11],xmm1[12],xmm4[12],xmm1[13],xmm4[13],xmm1[14],xmm4[14],xmm1[15],xmm4[15]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm4 = xmm1[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm10 = xmm1[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm10, %ymm4, %ymm17
; AVX512DQ-NEXT:    vmovdqa 32(%rsi), %xmm0
; AVX512DQ-NEXT:    vmovdqa 32(%rdi), %xmm10
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm10[0],xmm0[0],xmm10[1],xmm0[1],xmm10[2],xmm0[2],xmm10[3],xmm0[3],xmm10[4],xmm0[4],xmm10[5],xmm0[5],xmm10[6],xmm0[6],xmm10[7],xmm0[7]
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} zmm4 = xmm4[0],zero,zero,zero,xmm4[1],zero,zero,zero,xmm4[2],zero,zero,zero,xmm4[3],zero,zero,zero,xmm4[4],zero,zero,zero,xmm4[5],zero,zero,zero,xmm4[6],zero,zero,zero,xmm4[7],zero,zero,zero
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm4 = zmm4 | (zmm15 & ~zmm6)
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm15 = ymm20[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm18 = ymm18[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm18, %zmm15, %zmm15
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm14 = ymm14[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm13 = ymm13[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm13, %zmm14, %zmm13
; AVX512DQ-NEXT:    vpandnq %zmm15, %zmm7, %zmm14
; AVX512DQ-NEXT:    vpandq %zmm7, %zmm13, %zmm13
; AVX512DQ-NEXT:    vpord %zmm14, %zmm13, %zmm4 {%k1}
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm13 = xmm1[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm1 = xmm1[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm1, %ymm13, %ymm18
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm8 = xmm8[8],xmm9[8],xmm8[9],xmm9[9],xmm8[10],xmm9[10],xmm8[11],xmm9[11],xmm8[12],xmm9[12],xmm8[13],xmm9[13],xmm8[14],xmm9[14],xmm8[15],xmm9[15]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm9 = xmm8[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm13 = xmm8[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm13, %ymm9, %ymm19
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm13 = xmm8[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm8 = xmm8[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm8, %ymm13, %ymm20
...
; AVX512DQ-NEXT:    vinserti32x4 $1, %xmm13, %ymm3, %ymm21
...
; AVX512DQ-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm1, %xmm13 # 16-byte Folded Reload
; AVX512DQ-NEXT:    # xmm13 = xmm1[0],mem[0],xmm1[1],mem[1],xmm1[2],mem[2],xmm1[3],mem[3],xmm1[4],mem[4],xmm1[5],mem[5],xmm1[6],mem[6],xmm1[7],mem[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm14 = xmm13[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm15 = xmm13[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm15, %ymm14, %ymm14
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm15 = xmm13[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm13 = xmm13[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm13, %ymm15, %ymm13
; AVX512DQ-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm1 # 16-byte Reload
; AVX512DQ-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm1, %xmm15 # 16-byte Folded Reload
; AVX512DQ-NEXT:    # xmm15 = xmm1[0],mem[0],xmm1[1],mem[1],xmm1[2],mem[2],xmm1[3],mem[3],xmm1[4],mem[4],xmm1[5],mem[5],xmm1[6],mem[6],xmm1[7],mem[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm1 = xmm15[0,0,2,1,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm12 = xmm15[0,2,2,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm12, %ymm1, %ymm1
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm12 = xmm15[0,1,2,3,4,4,6,5]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm15 = xmm15[0,1,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm15, %ymm12, %ymm12
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm10[8],xmm0[8],xmm10[9],xmm0[9],xmm10[10],xmm0[10],xmm10[11],xmm0[11],xmm10[12],xmm0[12],xmm10[13],xmm0[13],xmm10[14],xmm0[14],xmm10[15],xmm0[15]
; AVX512DQ-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm3 # 16-byte Reload
; AVX512DQ-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm3, %xmm10 # 16-byte Folded Reload
; AVX512DQ-NEXT:    # xmm10 = xmm3[0],mem[0],xmm3[1],mem[1],xmm3[2],mem[2],xmm3[3],mem[3],xmm3[4],mem[4],xmm3[5],mem[5],xmm3[6],mem[6],xmm3[7],mem[7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm15 = xmm10[0,1,1,3,4,5,6,7]
; AVX512DQ-NEXT:    vpshuflw {{.*#+}} xmm9 = xmm10[2,1,3,3,4,5,6,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm9, %ymm15, %ymm9
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm15 = xmm10[0,1,2,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufhw {{.*#+}} xmm10 = xmm10[0,1,2,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti128 $1, %xmm10, %ymm15, %ymm10
; AVX512DQ-NEXT:    vmovdqa 16(%rsi), %xmm15
; AVX512DQ-NEXT:    vmovdqa 16(%rdi), %xmm8
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm3 = xmm8[0],xmm15[0],xmm8[1],xmm15[1],xmm8[2],xmm15[2],xmm8[3],xmm15[3],xmm8[4],xmm15[4],xmm8[5],xmm15[5],xmm8[6],xmm15[6],xmm8[7],xmm15[7]
; AVX512DQ-NEXT:    vpunpckhbw {{.*#+}} xmm8 = xmm8[8],xmm15[8],xmm8[9],xmm15[9],xmm8[10],xmm15[10],xmm8[11],xmm15[11],xmm8[12],xmm15[12],xmm8[13],xmm15[13],xmm8[14],xmm15[14],xmm8[15],xmm15[15]
; AVX512DQ-NEXT:    vpunpcklbw {{.*#+}} xmm5 = xmm5[0],xmm11[0],xmm5[1],xmm11[1],xmm5[2],xmm11[2],xmm5[3],xmm11[3],xmm5[4],xmm11[4],xmm5[5],xmm11[5],xmm5[6],xmm11[6],xmm5[7],xmm11[7]
; AVX512DQ-NEXT:    vpshufd $212, {{[-0-9]+}}(%r{{[sb]}}p), %ymm11 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm11 = mem[0,1,1,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufd $246, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm15 = mem[2,1,3,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm15, %zmm11, %zmm11
...
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm0 = zmm0 | (zmm11 & ~zmm6)
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} zmm3 = xmm3[0],zero,zero,zero,xmm3[1],zero,zero,zero,xmm3[2],zero,zero,zero,xmm3[3],zero,zero,zero,xmm3[4],zero,zero,zero,xmm3[5],zero,zero,zero,xmm3[6],zero,zero,zero,xmm3[7],zero,zero,zero
...
; AVX512DQ-NEXT:    vpmovzxwq {{.*#+}} zmm5 = xmm5[0],zero,zero,zero,xmm5[1],zero,zero,zero,xmm5[2],zero,zero,zero,xmm5[3],zero,zero,zero,xmm5[4],zero,zero,zero,xmm5[5],zero,zero,zero,xmm5[6],zero,zero,zero,xmm5[7],zero,zero,zero
; AVX512DQ-NEXT:    vpshufd $96, {{[-0-9]+}}(%r{{[sb]}}p), %ymm11 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm11 = mem[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd $232, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm15 = mem[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm15, %zmm11, %zmm11
; AVX512DQ-NEXT:    vpshufd $96, {{[-0-9]+}}(%r{{[sb]}}p), %ymm15 # 32-byte Folded Reload
...
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm23, %zmm15, %zmm15
; AVX512DQ-NEXT:    vpandnq %zmm11, %zmm7, %zmm11
; AVX512DQ-NEXT:    vpandq %zmm7, %zmm15, %zmm15
; AVX512DQ-NEXT:    vpord %zmm11, %zmm15, %zmm0 {%k1}
; AVX512DQ-NEXT:    vpshufd $212, {{[-0-9]+}}(%r{{[sb]}}p), %ymm11 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm11 = mem[0,1,1,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufd $246, (%rsp), %ymm15 # 32-byte Folded Reload
; AVX512DQ-NEXT:    # ymm15 = mem[2,1,3,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm15, %zmm11, %zmm11
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm3 = zmm3 | (zmm11 & ~zmm6)
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm11 = ymm30[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm15 = ymm31[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm15, %zmm11, %zmm11
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm15 = ymm25[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm16 = ymm16[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm16, %zmm15, %zmm15
; AVX512DQ-NEXT:    vpandnq %zmm11, %zmm7, %zmm11
; AVX512DQ-NEXT:    vpandq %zmm7, %zmm15, %zmm15
; AVX512DQ-NEXT:    vpord %zmm11, %zmm15, %zmm3 {%k1}
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm11 = ymm17[0,1,1,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm15 = ymm18[2,1,3,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm15, %zmm11, %zmm11
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm8 = zmm8 | (zmm11 & ~zmm6)
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm11 = ymm19[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm15 = ymm20[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm15, %zmm11, %zmm11
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm15 = ymm21[0,0,2,1,4,4,6,5]
...
; AVX512DQ-NEXT:    vpord %zmm11, %zmm2, %zmm8 {%k1}
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm2 = ymm14[0,1,1,3,4,5,5,7]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm11 = ymm13[2,1,3,3,6,5,7,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm11, %zmm2, %zmm2
; AVX512DQ-NEXT:    vpternlogq {{.*#+}} zmm5 = zmm5 | (zmm2 & ~zmm6)
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm1 = ymm1[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm2 = ymm12[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm2, %zmm1, %zmm1
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm2 = ymm9[0,0,2,1,4,4,6,5]
; AVX512DQ-NEXT:    vpshufd {{.*#+}} ymm6 = ymm10[0,2,2,3,4,6,6,7]
; AVX512DQ-NEXT:    vinserti64x4 $1, %ymm6, %zmm2, %zmm2
; AVX512DQ-NEXT:    vpandnq %zmm1, %zmm7, %zmm1
; AVX512DQ-NEXT:    vpandq %zmm7, %zmm2, %zmm2
; AVX512DQ-NEXT:    vpord %zmm1, %zmm2, %zmm5 {%k1}
; AVX512DQ-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX512DQ-NEXT:    vmovdqa64 %zmm5, (%rax)
...
; AVX512DQ-NEXT:    vmovdqa64 %zmm26, 448(%rax)
...
; AVX512DQ-FCP:       # %bb.0:
; AVX512DQ-FCP-NEXT:    subq $312, %rsp # imm = 0x138
; AVX512DQ-FCP-NEXT:    movq {{[0-9]+}}(%rsp), %rax
; AVX512DQ-FCP-NEXT:    movq {{[0-9]+}}(%rsp), %r10
; AVX512DQ-FCP-NEXT:    vmovdqa (%rcx), %xmm15
; AVX512DQ-FCP-NEXT:    vmovdqa 48(%rcx), %xmm5
; AVX512DQ-FCP-NEXT:    vmovdqa (%rdx), %xmm0
; AVX512DQ-FCP-NEXT:    vmovdqa %xmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 16-byte Spill
; AVX512DQ-FCP-NEXT:    vmovdqa 48(%rdx), %xmm4
; AVX512DQ-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm0[8],xmm15[8],xmm0[9],xmm15[9],xmm0[10],xmm15[10],xmm0[11],xmm15[11],xmm0[12],xmm15[12],xmm0[13],xmm15[13],xmm0[14],xmm15[14],xmm0[15],xmm15[15]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
...
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm3, %zmm2, %zmm0
...
; AVX512DQ-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm1[8],xmm0[8],xmm1[9],xmm0[9],xmm1[10],xmm0[10],xmm1[11],xmm0[11],xmm1[12],xmm0[12],xmm1[13],xmm0[13],xmm1[14],xmm0[14],xmm1[15],xmm0[15]
...
; AVX512DQ-FCP-NEXT:    vmovdqa {{.*#+}} ymm12 = [0,1,0,1,0,1,0,1,8,9,10,11,4,5,2,3,0,1,4,5,0,1,4,5,8,9,10,11,4,5,6,7]
...
; AVX512DQ-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm2 = xmm1[8],xmm0[8],xmm1[9],xmm0[9],xmm1[10],xmm0[10],xmm1[11],xmm0[11],xmm1[12],xmm0[12],xmm1[13],xmm0[13],xmm1[14],xmm0[14],xmm1[15],xmm0[15]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm2, %ymm2, %ymm2
; AVX512DQ-FCP-NEXT:    vmovdqa {{.*#+}} ymm7 = [0,1,2,3,8,9,10,11,8,9,10,11,10,11,14,15,0,1,2,3,12,13,10,11,12,13,10,11,14,15,14,15]
; AVX512DQ-FCP-NEXT:    vpshufb %ymm7, %ymm2, %ymm3
; AVX512DQ-FCP-NEXT:    vmovdqa {{.*#+}} ymm10 = [0,1,2,3,0,1,2,3,8,9,10,11,2,3,6,7,4,5,2,3,4,5,2,3,8,9,10,11,6,7,6,7]
...
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm14 = xmm3[0],xmm2[0],xmm3[1],xmm2[1],xmm3[2],xmm2[2],xmm3[3],xmm2[3],xmm3[4],xmm2[4],xmm3[5],xmm2[5],xmm3[6],xmm2[6],xmm3[7],xmm2[7]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm14, %ymm14, %ymm14
; AVX512DQ-FCP-NEXT:    vpshufb %ymm11, %ymm14, %ymm0
; AVX512DQ-FCP-NEXT:    vpshufb %ymm12, %ymm14, %ymm14
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm0, %zmm14, %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vmovdqa 48(%r9), %xmm1
; AVX512DQ-FCP-NEXT:    vmovdqa 48(%r8), %xmm14
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm13 = xmm14[0],xmm1[0],xmm14[1],xmm1[1],xmm14[2],xmm1[2],xmm14[3],xmm1[3],xmm14[4],xmm1[4],xmm14[5],xmm1[5],xmm14[6],xmm1[6],xmm14[7],xmm1[7]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm13, %ymm13, %ymm13
; AVX512DQ-FCP-NEXT:    vpshufb %ymm7, %ymm13, %ymm0
; AVX512DQ-FCP-NEXT:    vpshufb %ymm10, %ymm13, %ymm13
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm0, %zmm13, %zmm0
; AVX512DQ-FCP-NEXT:    vmovdqu64 %zmm0, {{[-0-9]+}}(%r{{[sb]}}p) # 64-byte Spill
; AVX512DQ-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm4[8],xmm5[8],xmm4[9],xmm5[9],xmm4[10],xmm5[10],xmm4[11],xmm5[11],xmm4[12],xmm5[12],xmm4[13],xmm5[13],xmm4[14],xmm5[14],xmm4[15],xmm5[15]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX512DQ-FCP-NEXT:    vpshufb %ymm6, %ymm0, %ymm4
...
; AVX512DQ-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm1 = xmm14[8],xmm1[8],xmm14[9],xmm1[9],xmm14[10],xmm1[10],xmm14[11],xmm1[11],xmm14[12],xmm1[12],xmm14[13],xmm1[13],xmm14[14],xmm1[14],xmm14[15],xmm1[15]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm1, %ymm1, %ymm1
; AVX512DQ-FCP-NEXT:    vpshufb %ymm7, %ymm1, %ymm3
; AVX512DQ-FCP-NEXT:    vpshufb %ymm10, %ymm1, %ymm1
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm3, %zmm1, %zmm18
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm1 = xmm2[0],xmm0[0],xmm2[1],xmm0[1],xmm2[2],xmm0[2],xmm2[3],xmm0[3],xmm2[4],xmm0[4],xmm2[5],xmm0[5],xmm2[6],xmm0[6],xmm2[7],xmm0[7]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm1, %ymm1, %ymm1
; AVX512DQ-FCP-NEXT:    vpshufb %ymm6, %ymm1, %ymm3
; AVX512DQ-FCP-NEXT:    vpshufb %ymm8, %ymm1, %ymm1
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm3, %zmm1, %zmm20
; AVX512DQ-FCP-NEXT:    vmovdqa 32(%r10), %xmm1
; AVX512DQ-FCP-NEXT:    vmovdqa 32(%rax), %xmm3
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm3[0],xmm1[0],xmm3[1],xmm1[1],xmm3[2],xmm1[2],xmm3[3],xmm1[3],xmm3[4],xmm1[4],xmm3[5],xmm1[5],xmm3[6],xmm1[6],xmm3[7],xmm1[7]
...
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm13 = xmm5[0],xmm4[0],xmm5[1],xmm4[1],xmm5[2],xmm4[2],xmm5[3],xmm4[3],xmm5[4],xmm4[4],xmm5[5],xmm4[5],xmm5[6],xmm4[6],xmm5[7],xmm4[7]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm13, %ymm13, %ymm13
; AVX512DQ-FCP-NEXT:    vpshufb %ymm7, %ymm13, %ymm14
; AVX512DQ-FCP-NEXT:    vpshufb %ymm10, %ymm13, %ymm13
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm14, %zmm13, %zmm23
...
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX512DQ-FCP-NEXT:    vpshufb %ymm6, %ymm0, %ymm2
; AVX512DQ-FCP-NEXT:    vpshufb %ymm8, %ymm0, %ymm0
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm2, %zmm0, %zmm24
; AVX512DQ-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm3[8],xmm1[8],xmm3[9],xmm1[9],xmm3[10],xmm1[10],xmm3[11],xmm1[11],xmm3[12],xmm1[12],xmm3[13],xmm1[13],xmm3[14],xmm1[14],xmm3[15],xmm1[15]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
...
; AVX512DQ-FCP-NEXT:    vpshufb %ymm7, %ymm13, %ymm14
; AVX512DQ-FCP-NEXT:    vpshufb %ymm10, %ymm13, %ymm13
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm14, %zmm13, %zmm29
...
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm1, %zmm0, %zmm9
; AVX512DQ-FCP-NEXT:    vmovdqa (%rsi), %xmm4
; AVX512DQ-FCP-NEXT:    vmovdqa (%rdi), %xmm5
; AVX512DQ-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm0 = xmm5[8],xmm4[8],xmm5[9],xmm4[9],xmm5[10],xmm4[10],xmm5[11],xmm4[11],xmm5[12],xmm4[12],xmm5[13],xmm4[13],xmm5[14],xmm4[14],xmm5[15],xmm4[15]
; AVX512DQ-FCP-NEXT:    vpmovsxwq {{.*#+}} xmm13 = [1284,1798]
...
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm0, %ymm0, %ymm0
; AVX512DQ-FCP-NEXT:    vpmovsxwq {{.*#+}} ymm14 = [2312,2826,3340,3854]
; AVX512DQ-FCP-NEXT:    vpshufb %ymm14, %ymm0, %ymm0
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm0, %zmm1, %zmm2
...
; AVX512DQ-FCP-NEXT:    vpternlogq $226, {{[-0-9]+}}(%r{{[sb]}}p), %zmm3, %zmm2 # 64-byte Folded Reload
; AVX512DQ-FCP-NEXT:    # zmm2 = mem ^ (zmm3 & (zmm2 ^ mem))
; AVX512DQ-FCP-NEXT:    vpbroadcastq {{.*#+}} zmm1 = [65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0,65535,65535,65535,0]
; AVX512DQ-FCP-NEXT:    vpandnq %zmm19, %zmm1, %zmm19
; AVX512DQ-FCP-NEXT:    vpandq %zmm1, %zmm21, %zmm21
; AVX512DQ-FCP-NEXT:    movw $-21846, %ax # imm = 0xAAAA
; AVX512DQ-FCP-NEXT:    kmovw %eax, %k1
; AVX512DQ-FCP-NEXT:    vpord %zmm19, %zmm21, %zmm2 {%k1}
; AVX512DQ-FCP-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm0 # 16-byte Reload
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm15 = xmm0[0],xmm15[0],xmm0[1],xmm15[1],xmm0[2],xmm15[2],xmm0[3],xmm15[3],xmm0[4],xmm15[4],xmm0[5],xmm15[5],xmm0[6],xmm15[6],xmm0[7],xmm15[7]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm15, %ymm15, %ymm15
...
; AVX512DQ-FCP-NEXT:    vmovdqa 48(%rsi), %xmm8
; AVX512DQ-FCP-NEXT:    vmovdqa 48(%rdi), %xmm15
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm6 = xmm15[0],xmm8[0],xmm15[1],xmm8[1],xmm15[2],xmm8[2],xmm15[3],xmm8[3],xmm15[4],xmm8[4],xmm15[5],xmm8[5],xmm15[6],xmm8[6],xmm15[7],xmm8[7]
; AVX512DQ-FCP-NEXT:    vpshufb %xmm13, %xmm6, %xmm0
...
; AVX512DQ-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm6 = xmm15[8],xmm8[8],xmm15[9],xmm8[9],xmm15[10],xmm8[10],xmm15[11],xmm8[11],xmm15[12],xmm8[12],xmm15[13],xmm8[13],xmm15[14],xmm8[14],xmm15[15],xmm8[15]
; AVX512DQ-FCP-NEXT:    vpshufb %xmm13, %xmm6, %xmm8
; AVX512DQ-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm15 = xmm6[0],zero,zero,zero,xmm6[1],zero,zero,zero
...
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm8 = xmm8[0],xmm15[0],xmm8[1],xmm15[1],xmm8[2],xmm15[2],xmm8[3],xmm15[3],xmm8[4],xmm15[4],xmm8[5],xmm15[5],xmm8[6],xmm15[6],xmm8[7],xmm15[7]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm8, %ymm8, %ymm8
; AVX512DQ-FCP-NEXT:    vpshufb %ymm11, %ymm8, %ymm11
; AVX512DQ-FCP-NEXT:    vpshufb %ymm12, %ymm8, %ymm8
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm11, %zmm8, %zmm21
; AVX512DQ-FCP-NEXT:    vmovdqa 32(%rsi), %xmm11
; AVX512DQ-FCP-NEXT:    vmovdqa 32(%rdi), %xmm12
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm15 = xmm12[0],xmm11[0],xmm12[1],xmm11[1],xmm12[2],xmm11[2],xmm12[3],xmm11[3],xmm12[4],xmm11[4],xmm12[5],xmm11[5],xmm12[6],xmm11[6],xmm12[7],xmm11[7]
; AVX512DQ-FCP-NEXT:    vpshufb %xmm13, %xmm15, %xmm8
; AVX512DQ-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm16 = xmm15[0],zero,zero,zero,xmm15[1],zero,zero,zero
; AVX512DQ-FCP-NEXT:    vinserti32x4 $1, %xmm8, %ymm16, %ymm8
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm15, %ymm15, %ymm15
; AVX512DQ-FCP-NEXT:    vpshufb %ymm14, %ymm15, %ymm15
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm15, %zmm8, %zmm8
; AVX512DQ-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm11 = xmm12[8],xmm11[8],xmm12[9],xmm11[9],xmm12[10],xmm11[10],xmm12[11],xmm11[11],xmm12[12],xmm11[12],xmm12[13],xmm11[13],xmm12[14],xmm11[14],xmm12[15],xmm11[15]
; AVX512DQ-FCP-NEXT:    vpshufb %xmm13, %xmm11, %xmm12
; AVX512DQ-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm15 = xmm11[0],zero,zero,zero,xmm11[1],zero,zero,zero
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm12, %ymm15, %ymm12
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm11, %ymm11, %ymm11
; AVX512DQ-FCP-NEXT:    vpshufb %ymm14, %ymm11, %ymm11
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm11, %zmm12, %zmm11
; AVX512DQ-FCP-NEXT:    vmovdqa {{[-0-9]+}}(%r{{[sb]}}p), %xmm12 # 16-byte Reload
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{[-0-9]+}}(%r{{[sb]}}p), %xmm12, %xmm12 # 16-byte Folded Reload
; AVX512DQ-FCP-NEXT:    # xmm12 = xmm12[0],mem[0],xmm12[1],mem[1],xmm12[2],mem[2],xmm12[3],mem[3],xmm12[4],mem[4],xmm12[5],mem[5],xmm12[6],mem[6],xmm12[7],mem[7]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm12, %ymm12, %ymm12
; AVX512DQ-FCP-NEXT:    vpshufb %ymm7, %ymm12, %ymm7
; AVX512DQ-FCP-NEXT:    vpshufb %ymm10, %ymm12, %ymm10
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm7, %zmm10, %zmm16
; AVX512DQ-FCP-NEXT:    vmovdqa 16(%rsi), %xmm10
; AVX512DQ-FCP-NEXT:    vmovdqa 16(%rdi), %xmm12
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm15 = xmm12[0],xmm10[0],xmm12[1],xmm10[1],xmm12[2],xmm10[2],xmm12[3],xmm10[3],xmm12[4],xmm10[4],xmm12[5],xmm10[5],xmm12[6],xmm10[6],xmm12[7],xmm10[7]
; AVX512DQ-FCP-NEXT:    vpshufb %xmm13, %xmm15, %xmm7
; AVX512DQ-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm17 = xmm15[0],zero,zero,zero,xmm15[1],zero,zero,zero
; AVX512DQ-FCP-NEXT:    vinserti32x4 $1, %xmm7, %ymm17, %ymm7
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm15, %ymm15, %ymm15
; AVX512DQ-FCP-NEXT:    vpshufb %ymm14, %ymm15, %ymm15
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm15, %zmm7, %zmm7
; AVX512DQ-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm10 = xmm12[8],xmm10[8],xmm12[9],xmm10[9],xmm12[10],xmm10[10],xmm12[11],xmm10[11],xmm12[12],xmm10[12],xmm12[13],xmm10[13],xmm12[14],xmm10[14],xmm12[15],xmm10[15]
; AVX512DQ-FCP-NEXT:    vpshufb %xmm13, %xmm10, %xmm12
; AVX512DQ-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm15 = xmm10[0],zero,zero,zero,xmm10[1],zero,zero,zero
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm12, %ymm15, %ymm12
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm10, %ymm10, %ymm10
; AVX512DQ-FCP-NEXT:    vpshufb %ymm14, %ymm10, %ymm10
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm10, %zmm12, %zmm10
; AVX512DQ-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm4 = xmm5[0],xmm4[0],xmm5[1],xmm4[1],xmm5[2],xmm4[2],xmm5[3],xmm4[3],xmm5[4],xmm4[4],xmm5[5],xmm4[5],xmm5[6],xmm4[6],xmm5[7],xmm4[7]
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm4, %ymm4, %ymm5
; AVX512DQ-FCP-NEXT:    vpshufb %ymm14, %ymm5, %ymm5
; AVX512DQ-FCP-NEXT:    vpshufb %xmm13, %xmm4, %xmm12
; AVX512DQ-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm4 = xmm4[0],zero,zero,zero,xmm4[1],zero,zero,zero
; AVX512DQ-FCP-NEXT:    vinserti128 $1, %xmm12, %ymm4, %ymm4
; AVX512DQ-FCP-NEXT:    vinserti64x4 $1, %ymm5, %zmm4, %zmm4
; AVX512DQ-FCP-NEXT:    vpternlogq $226, {{[-0-9]+}}(%r{{[sb]}}p), %zmm3, %zmm0 # 64-byte Folded Reload
; AVX512DQ-FCP-NEXT:    # zmm0 = mem ^ (zmm3 & (zmm0 ^ mem))
; AVX512DQ-FCP-NEXT:    vpandnq {{[-0-9]+}}(%r{{[sb]}}p), %zmm1, %zmm5 # 64-byte Folded Reload
; AVX512DQ-FCP-NEXT:    vpandq {{[-0-9]+}}(%r{{[sb]}}p), %zmm1, %zmm12 # 64-byte Folded Reload
; AVX512DQ-FCP-NEXT:    vpord %zmm5, %zmm12, %zmm0 {%k1}
; AVX512DQ-FCP-NEXT:    vpternlogq $226, {{[-0-9]+}}(%r{{[sb]}}p), %zmm3, %zmm6 # 64-byte Folded Reload
; AVX512DQ-FCP-NEXT:    # zmm6 = mem ^ (zmm3 & (zmm6 ^ mem))
; AVX512DQ-FCP-NEXT:    vpandnq {{[-0-9]+}}(%r{{[sb]}}p), %zmm1, %zmm5 # 64-byte Folded Reload
; AVX512DQ-FCP-NEXT:    vpandq %zmm1, %zmm18, %zmm12
; AVX512DQ-FCP-NEXT:    vpord %zmm5, %zmm12, %zmm6 {%k1}
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} zmm8 = zmm20 ^ (zmm3 & (zmm8 ^ zmm20))
; AVX512DQ-FCP-NEXT:    vpandnq %zmm22, %zmm1, %zmm5
; AVX512DQ-FCP-NEXT:    vpandq %zmm1, %zmm23, %zmm12
; AVX512DQ-FCP-NEXT:    vpord %zmm5, %zmm12, %zmm8 {%k1}
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} zmm11 = zmm24 ^ (zmm3 & (zmm11 ^ zmm24))
; AVX512DQ-FCP-NEXT:    vpandnq %zmm25, %zmm1, %zmm5
; AVX512DQ-FCP-NEXT:    vpandq %zmm1, %zmm26, %zmm12
; AVX512DQ-FCP-NEXT:    vpord %zmm5, %zmm12, %zmm11 {%k1}
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} zmm7 = zmm27 ^ (zmm3 & (zmm7 ^ zmm27))
; AVX512DQ-FCP-NEXT:    vpandnq %zmm28, %zmm1, %zmm5
; AVX512DQ-FCP-NEXT:    vpandq %zmm1, %zmm29, %zmm12
; AVX512DQ-FCP-NEXT:    vpord %zmm5, %zmm12, %zmm7 {%k1}
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} zmm10 = zmm30 ^ (zmm3 & (zmm10 ^ zmm30))
; AVX512DQ-FCP-NEXT:    vpandnq %zmm31, %zmm1, %zmm5
; AVX512DQ-FCP-NEXT:    vpandq %zmm1, %zmm9, %zmm9
; AVX512DQ-FCP-NEXT:    vpord %zmm5, %zmm9, %zmm10 {%k1}
; AVX512DQ-FCP-NEXT:    vpternlogq {{.*#+}} zmm4 = zmm19 ^ (zmm3 & (zmm4 ^ zmm19))
; AVX512DQ-FCP-NEXT:    vpandnq %zmm21, %zmm1, %zmm3
; AVX512DQ-FCP-NEXT:    vpandq %zmm1, %zmm16, %zmm1
; AVX512DQ-FCP-NEXT:    vpord %zmm3, %zmm1, %zmm4 {%k1}
; AVX512DQ-FCP-NEXT:    movq {{[0-9]+}}(%rsp), %rax
...
; AVX512DQ-FCP-NEXT:    addq $312, %rsp # imm = 0x138
; AVX512DQ-FCP-NEXT:    vzeroupper
; AVX512DQ-FCP-NEXT:    retq
;
...
; AVX512BW-FCP-NEXT:    vmovdqa64 48(%rax), %xmm25
...
; AVX512BW-FCP-NEXT:    vmovdqa64 48(%r9), %xmm26
; AVX512BW-FCP-NEXT:    vmovdqa (%r8), %xmm12
; AVX512BW-FCP-NEXT:    vmovdqa64 48(%r8), %xmm27
...
; AVX512BW-FCP-NEXT:    vpshufb %xmm6, %xmm13, %xmm28
; AVX512BW-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm13 = xmm13[0],zero,zero,zero,xmm13[1],zero,zero,zero
; AVX512BW-FCP-NEXT:    vinserti32x4 $1, %xmm28, %ymm13, %ymm13
...
; AVX512BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm15 = xmm25[0],xmm24[0],xmm25[1],xmm24[1],xmm25[2],xmm24[2],xmm25[3],xmm24[3],xmm25[4],xmm24[4],xmm25[5],xmm24[5],xmm25[6],xmm24[6],xmm25[7],xmm24[7]
; AVX512BW-FCP-NEXT:    vinserti32x4 $1, %xmm15, %ymm15, %ymm28
; AVX512BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm15 = xmm27[0],xmm26[0],xmm27[1],xmm26[1],xmm27[2],xmm26[2],xmm27[3],xmm26[3],xmm27[4],xmm26[4],xmm27[5],xmm26[5],xmm27[6],xmm26[6],xmm27[7],xmm26[7]
; AVX512BW-FCP-NEXT:    vpermt2w %zmm28, %zmm14, %zmm15
...
; AVX512BW-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm28 = xmm16[0],zero,zero,zero,xmm16[1],zero,zero,zero
; AVX512BW-FCP-NEXT:    vinserti32x4 $1, %xmm17, %ymm28, %ymm17
; AVX512BW-FCP-NEXT:    vmovdqa64 32(%r10), %xmm28
...
; AVX512BW-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm17 = xmm25[8],xmm24[8],xmm25[9],xmm24[9],xmm25[10],xmm24[10],xmm25[11],xmm24[11],xmm25[12],xmm24[12],xmm25[13],xmm24[13],xmm25[14],xmm24[14],xmm25[15],xmm24[15]
; AVX512BW-FCP-NEXT:    vinserti32x4 $1, %xmm17, %ymm17, %ymm18
; AVX512BW-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm17 = xmm27[8],xmm26[8],xmm27[9],xmm26[9],xmm27[10],xmm26[10],xmm27[11],xmm26[11],xmm27[12],xmm26[12],xmm27[13],xmm26[13],xmm27[14],xmm26[14],xmm27[15],xmm26[15]
...
; AVX512BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm23 = xmm29[0],xmm28[0],xmm29[1],xmm28[1],xmm29[2],xmm28[2],xmm29[3],xmm28[3],xmm29[4],xmm28[4],xmm29[5],xmm28[5],xmm29[6],xmm28[6],xmm29[7],xmm28[7]
; AVX512BW-FCP-NEXT:    vinserti32x4 $1, %xmm23, %ymm23, %ymm24
; AVX512BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm23 = xmm31[0],xmm30[0],xmm31[1],xmm30[1],xmm31[2],xmm30[2],xmm31[3],xmm30[3],xmm31[4],xmm30[4],xmm31[5],xmm30[5],xmm31[6],xmm30[6],xmm31[7],xmm30[7]
...
; AVX512BW-FCP-NEXT:    vmovdqa64 16(%rcx), %xmm25
...
; AVX512BW-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm20 = xmm31[8],xmm30[8],xmm31[9],xmm30[9],xmm31[10],xmm30[10],xmm31[11],xmm30[11],xmm31[12],xmm30[12],xmm31[13],xmm30[13],xmm31[14],xmm30[14],xmm31[15],xmm30[15]
...
; AVX512BW-FCP-NEXT:    vpshufb %xmm6, %xmm21, %xmm26
...
; AVX512BW-FCP-NEXT:    vinserti64x4 $1, %ymm21, %zmm26, %zmm21
; AVX512BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm26 = xmm27[0],xmm25[0],xmm27[1],xmm25[1],xmm27[2],xmm25[2],xmm27[3],xmm25[3],xmm27[4],xmm25[4],xmm27[5],xmm25[5],xmm27[6],xmm25[6],xmm27[7],xmm25[7]
; AVX512BW-FCP-NEXT:    vinserti32x4 $1, %xmm26, %ymm26, %ymm26
; AVX512BW-FCP-NEXT:    vpermt2w %zmm26, %zmm9, %zmm21
...
; AVX512BW-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm26 = xmm22[0],zero,zero,zero,xmm22[1],zero,zero,zero
; AVX512BW-FCP-NEXT:    vinserti32x4 $1, %xmm24, %ymm26, %ymm24
...
; AVX512BW-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm24 = xmm27[8],xmm25[8],xmm27[9],xmm25[9],xmm27[10],xmm25[10],xmm27[11],xmm25[11],xmm27[12],xmm25[12],xmm27[13],xmm25[13],xmm27[14],xmm25[14],xmm27[15],xmm25[15]
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 48(%rax), %xmm25
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 48(%r9), %xmm26
; AVX512DQ-BW-FCP-NEXT:    vmovdqa (%r8), %xmm12
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 48(%r8), %xmm27
...
; AVX512DQ-BW-FCP-NEXT:    vpshufb %xmm6, %xmm13, %xmm28
; AVX512DQ-BW-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm13 = xmm13[0],zero,zero,zero,xmm13[1],zero,zero,zero
; AVX512DQ-BW-FCP-NEXT:    vinserti32x4 $1, %xmm28, %ymm13, %ymm13
...
; AVX512DQ-BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm15 = xmm25[0],xmm24[0],xmm25[1],xmm24[1],xmm25[2],xmm24[2],xmm25[3],xmm24[3],xmm25[4],xmm24[4],xmm25[5],xmm24[5],xmm25[6],xmm24[6],xmm25[7],xmm24[7]
; AVX512DQ-BW-FCP-NEXT:    vinserti32x4 $1, %xmm15, %ymm15, %ymm28
; AVX512DQ-BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm15 = xmm27[0],xmm26[0],xmm27[1],xmm26[1],xmm27[2],xmm26[2],xmm27[3],xmm26[3],xmm27[4],xmm26[4],xmm27[5],xmm26[5],xmm27[6],xmm26[6],xmm27[7],xmm26[7]
; AVX512DQ-BW-FCP-NEXT:    vpermt2w %zmm28, %zmm14, %zmm15
...
; AVX512DQ-BW-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm28 = xmm16[0],zero,zero,zero,xmm16[1],zero,zero,zero
; AVX512DQ-BW-FCP-NEXT:    vinserti32x4 $1, %xmm17, %ymm28, %ymm17
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 32(%r10), %xmm28
...
; AVX512DQ-BW-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm17 = xmm25[8],xmm24[8],xmm25[9],xmm24[9],xmm25[10],xmm24[10],xmm25[11],xmm24[11],xmm25[12],xmm24[12],xmm25[13],xmm24[13],xmm25[14],xmm24[14],xmm25[15],xmm24[15]
; AVX512DQ-BW-FCP-NEXT:    vinserti32x4 $1, %xmm17, %ymm17, %ymm18
; AVX512DQ-BW-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm17 = xmm27[8],xmm26[8],xmm27[9],xmm26[9],xmm27[10],xmm26[10],xmm27[11],xmm26[11],xmm27[12],xmm26[12],xmm27[13],xmm26[13],xmm27[14],xmm26[14],xmm27[15],xmm26[15]
...
; AVX512DQ-BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm23 = xmm29[0],xmm28[0],xmm29[1],xmm28[1],xmm29[2],xmm28[2],xmm29[3],xmm28[3],xmm29[4],xmm28[4],xmm29[5],xmm28[5],xmm29[6],xmm28[6],xmm29[7],xmm28[7]
; AVX512DQ-BW-FCP-NEXT:    vinserti32x4 $1, %xmm23, %ymm23, %ymm24
; AVX512DQ-BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm23 = xmm31[0],xmm30[0],xmm31[1],xmm30[1],xmm31[2],xmm30[2],xmm31[3],xmm30[3],xmm31[4],xmm30[4],xmm31[5],xmm30[5],xmm31[6],xmm30[6],xmm31[7],xmm30[7]
...
; AVX512DQ-BW-FCP-NEXT:    vmovdqa64 16(%rcx), %xmm25
...
; AVX512DQ-BW-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm20 = xmm31[8],xmm30[8],xmm31[9],xmm30[9],xmm31[10],xmm30[10],xmm31[11],xmm30[11],xmm31[12],xmm30[12],xmm31[13],xmm30[13],xmm31[14],xmm30[14],xmm31[15],xmm30[15]
...
; AVX512DQ-BW-FCP-NEXT:    vpshufb %xmm6, %xmm21, %xmm26
...
; AVX512DQ-BW-FCP-NEXT:    vinserti64x4 $1, %ymm21, %zmm26, %zmm21
; AVX512DQ-BW-FCP-NEXT:    vpunpcklbw {{.*#+}} xmm26 = xmm27[0],xmm25[0],xmm27[1],xmm25[1],xmm27[2],xmm25[2],xmm27[3],xmm25[3],xmm27[4],xmm25[4],xmm27[5],xmm25[5],xmm27[6],xmm25[6],xmm27[7],xmm25[7]
; AVX512DQ-BW-FCP-NEXT:    vinserti32x4 $1, %xmm26, %ymm26, %ymm26
; AVX512DQ-BW-FCP-NEXT:    vpermt2w %zmm26, %zmm9, %zmm21
...
; AVX512DQ-BW-FCP-NEXT:    vpmovzxwq {{.*#+}} xmm26 = xmm22[0],zero,zero,zero,xmm22[1],zero,zero,zero
; AVX512DQ-BW-FCP-NEXT:    vinserti32x4 $1, %xmm24, %ymm26, %ymm24
...
; AVX512DQ-BW-FCP-NEXT:    vpunpckhbw {{.*#+}} xmm24 = xmm27[8],xmm25[8],xmm27[9],xmm25[9],xmm27[10],xmm25[10],xmm27[11],xmm25[11],xmm27[12],xmm25[12],xmm27[13],xmm25[13],xmm27[14],xmm25[14],xmm27[15],xmm25[15]
