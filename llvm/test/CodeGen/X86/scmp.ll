...
; SETZUCC-NEXT:    shlq $42, %rcx
; SETZUCC-NEXT:    shrq $11, %rdi
; SETZUCC-NEXT:    orq %rcx, %rdi
...
; NO-SETZUCC-NEXT:    shrdq $22, %rbx, %r13
...
; NO-SETZUCC-NEXT:    shlq $42, %rcx
; NO-SETZUCC-NEXT:    shrq $11, %rdi
; NO-SETZUCC-NEXT:    orq %rcx, %rdi
