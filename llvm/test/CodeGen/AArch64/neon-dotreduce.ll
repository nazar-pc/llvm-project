...
; CHECK-SD-NEXT:    ld1 { v5.b }[8], [x14]
; CHECK-SD-NEXT:    add x13, sp, #56
; CHECK-SD-NEXT:    add x14, sp, #64
...
; CHECK-SD-NEXT:    ld1 { v5.b }[9], [x10]
; CHECK-SD-NEXT:    add x10, sp, #608
; CHECK-SD-NEXT:    ld1 { v1.b }[14], [x15]
; CHECK-SD-NEXT:    add x15, sp, #488
; CHECK-SD-NEXT:    add x8, sp, #320
; CHECK-SD-NEXT:    ld1 { v0.b }[12], [x12]
; CHECK-SD-NEXT:    ld1 { v7.b }[3], [x15]
; CHECK-SD-NEXT:    ld1 { v2.b }[6], [x8]
; CHECK-SD-NEXT:    ld1 { v4.b }[10], [x10]
; CHECK-SD-NEXT:    add x10, sp, #128
; CHECK-SD-NEXT:    add x8, sp, #624
; CHECK-SD-NEXT:    ld1 { v3.b }[6], [x10]
...
; CHECK-GI-NEXT:    uxtb w18, w22
; CHECK-GI-NEXT:    uxtb w27, w27
; CHECK-GI-NEXT:    mov v20.h[2], w7
; CHECK-GI-NEXT:    mov b7, v2.b[5]
; CHECK-GI-NEXT:    mov v18.h[2], w24
; CHECK-GI-NEXT:    mov v3.h[4], w10
; CHECK-GI-NEXT:    uxtb w10, w3
; CHECK-GI-NEXT:    uxtb w4, w5
; CHECK-GI-NEXT:    fmov s6, w27
; CHECK-GI-NEXT:    fmov w27, s19
...
; CHECK-GI-NEXT:    mov v20.h[7], w10
; CHECK-GI-NEXT:    mov v0.s[3], wzr
; CHECK-GI-NEXT:    mov v6.h[7], w8
; CHECK-GI-NEXT:    umov w8, v1.b[8]
; CHECK-GI-NEXT:    mul v1.8h, v3.8h, v18.8h
; CHECK-GI-NEXT:    mul v2.8h, v4.8h, v20.8h
; CHECK-GI-NEXT:    mul v3.8h, v5.8h, v6.8h
; CHECK-GI-NEXT:    mul w8, w8, w9
; CHECK-GI-NEXT:    umov w9, v1.h[0]
; CHECK-GI-NEXT:    umov w13, v1.h[4]
; CHECK-GI-NEXT:    umov w17, v2.h[0]
; CHECK-GI-NEXT:    umov w1, v2.h[4]
; CHECK-GI-NEXT:    umov w10, v1.h[1]
; CHECK-GI-NEXT:    umov w14, v1.h[5]
; CHECK-GI-NEXT:    umov w18, v2.h[1]
; CHECK-GI-NEXT:    umov w3, v2.h[5]
; CHECK-GI-NEXT:    umov w11, v1.h[2]
; CHECK-GI-NEXT:    umov w12, v1.h[3]
; CHECK-GI-NEXT:    umov w5, v3.h[0]
; CHECK-GI-NEXT:    umov w19, v3.h[4]
; CHECK-GI-NEXT:    umov w6, v3.h[1]
; CHECK-GI-NEXT:    umov w20, v3.h[5]
; CHECK-GI-NEXT:    umov w15, v1.h[6]
; CHECK-GI-NEXT:    umov w16, v1.h[7]
; CHECK-GI-NEXT:    fmov s1, w9
; CHECK-GI-NEXT:    fmov s4, w13
; CHECK-GI-NEXT:    fmov s5, w17
; CHECK-GI-NEXT:    fmov s6, w1
; CHECK-GI-NEXT:    fmov s17, w8
; CHECK-GI-NEXT:    umov w0, v2.h[2]
; CHECK-GI-NEXT:    fmov s7, w5
; CHECK-GI-NEXT:    fmov s16, w19
; CHECK-GI-NEXT:    umov w4, v2.h[6]
; CHECK-GI-NEXT:    umov w7, v3.h[2]
; CHECK-GI-NEXT:    umov w9, v3.h[6]
; CHECK-GI-NEXT:    mov v1.s[1], w10
; CHECK-GI-NEXT:    mov v4.s[1], w14
; CHECK-GI-NEXT:    mov v5.s[1], w18
...
; CHECK-GI-NEXT:    umov w8, v2.h[3]
; CHECK-GI-NEXT:    umov w10, v2.h[7]
; CHECK-GI-NEXT:    umov w13, v3.h[3]
; CHECK-GI-NEXT:    umov w14, v3.h[7]
; CHECK-GI-NEXT:    mov v1.s[2], w11
; CHECK-GI-NEXT:    mov v4.s[2], w15
; CHECK-GI-NEXT:    mov v5.s[2], w0
; CHECK-GI-NEXT:    mov v6.s[2], w4
; CHECK-GI-NEXT:    mov v7.s[2], w7
; CHECK-GI-NEXT:    mov v16.s[2], w9
; CHECK-GI-NEXT:    mov v17.s[2], wzr
; CHECK-GI-NEXT:    mov v1.s[3], w12
; CHECK-GI-NEXT:    mov v4.s[3], w16
...
; CHECK-GI-NEXT:    mov b21, v2.b[12]
; CHECK-GI-NEXT:    fmov w7, s3
; CHECK-GI-NEXT:    mov b3, v2.b[11]
; CHECK-GI-NEXT:    fmov w5, s5
; CHECK-GI-NEXT:    mov b5, v2.b[13]
; CHECK-GI-NEXT:    fmov w10, s6
...
; CHECK-GI-NEXT:    mov b22, v2.b[15]
; CHECK-GI-NEXT:    ldp q4, q2, [x0]
; CHECK-GI-NEXT:    fmov w0, s3
; CHECK-GI-NEXT:    mov b3, v1.b[3]
; CHECK-GI-NEXT:    fmov w14, s5
; CHECK-GI-NEXT:    mov b5, v1.b[5]
; CHECK-GI-NEXT:    fmov w8, s17
; CHECK-GI-NEXT:    sxtb w28, w6
...
; CHECK-GI-NEXT:    mov b18, v4.b[13]
; CHECK-GI-NEXT:    fmov w1, s19
; CHECK-GI-NEXT:    sxtb w29, w29
; CHECK-GI-NEXT:    sxtb w25, w25
; CHECK-GI-NEXT:    mov b19, v4.b[6]
; CHECK-GI-NEXT:    fmov w26, s7
; CHECK-GI-NEXT:    fmov w6, s5
; CHECK-GI-NEXT:    fmov s5, w30
; CHECK-GI-NEXT:    fmov w9, s16
; CHECK-GI-NEXT:    mov b16, v4.b[2]
; CHECK-GI-NEXT:    fmov w15, s21
; CHECK-GI-NEXT:    mov b17, v4.b[3]
; CHECK-GI-NEXT:    mov b21, v4.b[5]
; CHECK-GI-NEXT:    fmov w16, s20
; CHECK-GI-NEXT:    mov b20, v4.b[9]
; CHECK-GI-NEXT:    mov v3.h[2], w28
; CHECK-GI-NEXT:    sxtb w9, w9
; CHECK-GI-NEXT:    fmov w28, s6
; CHECK-GI-NEXT:    fmov w30, s18
; CHECK-GI-NEXT:    fmov s18, w29
; CHECK-GI-NEXT:    fmov w7, s19
; CHECK-GI-NEXT:    mov b19, v4.b[14]
; CHECK-GI-NEXT:    mov v5.h[1], w25
; CHECK-GI-NEXT:    sxtb w25, w26
; CHECK-GI-NEXT:    fmov w13, s22
; CHECK-GI-NEXT:    sxtb w26, w28
; CHECK-GI-NEXT:    mov b22, v2.b[1]
; CHECK-GI-NEXT:    mov b7, v4.b[10]
; CHECK-GI-NEXT:    fmov w27, s16
; CHECK-GI-NEXT:    mov b16, v4.b[11]
; CHECK-GI-NEXT:    fmov w22, s17
; CHECK-GI-NEXT:    mov b17, v4.b[12]
; CHECK-GI-NEXT:    fmov w19, s21
...
; CHECK-GI-NEXT:    mov b6, v2.b[2]
; CHECK-GI-NEXT:    fmov w28, s19
; CHECK-GI-NEXT:    fmov s19, w26
; CHECK-GI-NEXT:    sxtb w24, w24
; CHECK-GI-NEXT:    fmov w26, s22
; CHECK-GI-NEXT:    mov v4.h[1], w23
; CHECK-GI-NEXT:    sxtb w25, w25
; CHECK-GI-NEXT:    fmov w23, s7
; CHECK-GI-NEXT:    mov b7, v2.b[3]
; CHECK-GI-NEXT:    mov v19.h[1], w24
...
; CHECK-GI-NEXT:    mov v18.h[2], w27
; CHECK-GI-NEXT:    mov b16, v2.b[4]
; CHECK-GI-NEXT:    fmov w25, s7
; CHECK-GI-NEXT:    mov v5.h[2], w4
; CHECK-GI-NEXT:    sxtb w24, w24
; CHECK-GI-NEXT:    mov v6.h[1], w26
; CHECK-GI-NEXT:    mov v19.h[2], w23
; CHECK-GI-NEXT:    fmov w20, s17
; CHECK-GI-NEXT:    mov b17, v2.b[5]
; CHECK-GI-NEXT:    mov v3.h[4], w10
; CHECK-GI-NEXT:    sxtb w4, w25
; CHECK-GI-NEXT:    sxtb w10, w15
; CHECK-GI-NEXT:    mov v4.h[3], w0
; CHECK-GI-NEXT:    sxtb w0, w5
; CHECK-GI-NEXT:    mov v18.h[3], w22
; CHECK-GI-NEXT:    fmov w26, s16
; CHECK-GI-NEXT:    sxtb w15, w20
; CHECK-GI-NEXT:    mov v6.h[2], w24
; CHECK-GI-NEXT:    mov v5.h[3], w3
; CHECK-GI-NEXT:    mov v19.h[3], w0
; CHECK-GI-NEXT:    sxtb w0, w21
; CHECK-GI-NEXT:    mov b20, v2.b[6]
; CHECK-GI-NEXT:    fmov w27, s17
; CHECK-GI-NEXT:    mov v4.h[4], w10
; CHECK-GI-NEXT:    sxtb w10, w19
; CHECK-GI-NEXT:    mov v18.h[4], w0
; CHECK-GI-NEXT:    sxtb w0, w1
; CHECK-GI-NEXT:    sxtb w1, w26
; CHECK-GI-NEXT:    ldp x26, x25, [sp, #32] // 16-byte Folded Reload
; CHECK-GI-NEXT:    mov v6.h[3], w4
...
; CHECK-GI-NEXT:    mul v2.8h, v4.8h, v19.8h
; CHECK-GI-NEXT:    mul v3.8h, v5.8h, v6.8h
...
; CHECK-GI-NEXT:    smov w17, v2.h[0]
; CHECK-GI-NEXT:    smov w1, v2.h[4]
; CHECK-GI-NEXT:    smov w18, v2.h[1]
; CHECK-GI-NEXT:    smov w5, v3.h[0]
; CHECK-GI-NEXT:    smov w19, v3.h[4]
; CHECK-GI-NEXT:    smov w3, v2.h[5]
; CHECK-GI-NEXT:    smov w6, v3.h[1]
; CHECK-GI-NEXT:    smov w20, v3.h[5]
; CHECK-GI-NEXT:    smov w12, v1.h[3]
; CHECK-GI-NEXT:    smov w15, v1.h[6]
; CHECK-GI-NEXT:    smov w16, v1.h[7]
; CHECK-GI-NEXT:    fmov s1, w9
; CHECK-GI-NEXT:    fmov s4, w13
; CHECK-GI-NEXT:    fmov s5, w17
; CHECK-GI-NEXT:    fmov s6, w1
...
; CHECK-GI-NEXT:    fmov s16, w19
; CHECK-GI-NEXT:    fmov s17, w8
; CHECK-GI-NEXT:    smov w0, v2.h[2]
; CHECK-GI-NEXT:    smov w4, v2.h[6]
; CHECK-GI-NEXT:    smov w7, v3.h[2]
; CHECK-GI-NEXT:    smov w21, v3.h[6]
; CHECK-GI-NEXT:    mov v1.s[1], w10
; CHECK-GI-NEXT:    mov v4.s[1], w14
; CHECK-GI-NEXT:    mov v5.s[1], w18
; CHECK-GI-NEXT:    mov v6.s[1], w3
...
; CHECK-GI-NEXT:    ldp x20, x19, [sp, #80] // 16-byte Folded Reload
; CHECK-GI-NEXT:    mov v17.s[1], wzr
; CHECK-GI-NEXT:    smov w8, v2.h[3]
; CHECK-GI-NEXT:    smov w9, v2.h[7]
; CHECK-GI-NEXT:    smov w10, v3.h[3]
; CHECK-GI-NEXT:    smov w13, v3.h[7]
; CHECK-GI-NEXT:    mov v1.s[2], w11
; CHECK-GI-NEXT:    mov v4.s[2], w15
; CHECK-GI-NEXT:    mov v5.s[2], w0
; CHECK-GI-NEXT:    mov v6.s[2], w4
; CHECK-GI-NEXT:    mov v7.s[2], w7
; CHECK-GI-NEXT:    mov v16.s[2], w21
; CHECK-GI-NEXT:    mov v0.s[3], wzr
; CHECK-GI-NEXT:    ldp x22, x21, [sp, #64] // 16-byte Folded Reload
; CHECK-GI-NEXT:    mov v17.s[2], wzr
; CHECK-GI-NEXT:    mov v1.s[3], w12
...
; CHECK-SD-NEXT:    ld1 { v23.b }[4], [x12]
; CHECK-SD-NEXT:    ld1 { v21.b }[4], [x13]
...
; CHECK-SD-NEXT:    ld1 { v23.b }[6], [x12]
; CHECK-SD-NEXT:    ld1 { v21.b }[6], [x13]
...
; CHECK-SD-NEXT:    smull v3.8h, v22.8b, v19.8b
; CHECK-SD-NEXT:    smull v4.8h, v21.8b, v23.8b
; CHECK-SD-NEXT:    mov v17.s[0], v18.s[0]
; CHECK-SD-NEXT:    smull v5.8h, v7.8b, v6.8b
; CHECK-SD-NEXT:    mov v16.s[0], v20.s[0]
...
; CHECK-GI-NEXT:    ldr w9, [sp, #576]
; CHECK-GI-NEXT:    sbfx w11, w11, #8, #8
; CHECK-GI-NEXT:    mov v19.h[2], w14
; CHECK-GI-NEXT:    ldr w14, [sp, #632]
; CHECK-GI-NEXT:    lsl w10, w10, #8
; CHECK-GI-NEXT:    sbfx w15, w15, #8, #8
; CHECK-GI-NEXT:    lsl w9, w9, #8
; CHECK-GI-NEXT:    mov v20.h[1], w11
; CHECK-GI-NEXT:    ldr w11, [sp, #688]
; CHECK-GI-NEXT:    lsl w14, w14, #8
; CHECK-GI-NEXT:    sbfx w10, w10, #8, #8
; CHECK-GI-NEXT:    mov v18.h[4], w12
; CHECK-GI-NEXT:    sbfx w9, w9, #8, #8
...
; CHECK-GI-NEXT:    sbfx w14, w14, #8, #8
; CHECK-GI-NEXT:    lsl w11, w11, #8
; CHECK-GI-NEXT:    mov v20.h[3], w9
; CHECK-GI-NEXT:    ldr w9, [sp, #648]
; CHECK-GI-NEXT:    lsl w12, w12, #8
; CHECK-GI-NEXT:    sbfx w15, w15, #8, #8
; CHECK-GI-NEXT:    mov v21.h[2], w14
...
; CHECK-GI-NEXT:    sbfx w9, w9, #8, #8
; CHECK-GI-NEXT:    ldr w11, [sp, #656]
; CHECK-GI-NEXT:    lsl w15, w15, #8
; CHECK-GI-NEXT:    mov v21.h[3], w12
; CHECK-GI-NEXT:    sbfx w14, w14, #8, #8
; CHECK-GI-NEXT:    ldr w12, [sp, #608]
; CHECK-GI-NEXT:    mov v20.h[4], w9
; CHECK-GI-NEXT:    lsl w11, w11, #8
; CHECK-GI-NEXT:    sbfx w15, w15, #8, #8
; CHECK-GI-NEXT:    lsl w10, w10, #8
; CHECK-GI-NEXT:    mov v19.h[6], w14
; CHECK-GI-NEXT:    ldr w14, [sp, #720]
; CHECK-GI-NEXT:    lsl w12, w12, #8
; CHECK-GI-NEXT:    sbfx w11, w11, #8, #8
; CHECK-GI-NEXT:    mov v21.h[4], w15
; CHECK-GI-NEXT:    sbfx w10, w10, #8, #8
; CHECK-GI-NEXT:    lsl w14, w14, #8
; CHECK-GI-NEXT:    ldr w9, [sp, #664]
; CHECK-GI-NEXT:    sbfx w12, w12, #8, #8
; CHECK-GI-NEXT:    mov v20.h[5], w11
...
; CHECK-GI-NEXT:    lsl w13, w13, #8
; CHECK-GI-NEXT:    lsl w12, w12, #8
; CHECK-GI-NEXT:    mov v20.h[6], w9
; CHECK-GI-NEXT:    smov w9, v7.h[2]
; CHECK-GI-NEXT:    lsl w15, w15, #8
...
; CHECK-GI-NEXT:    smov w13, v7.h[5]
; CHECK-GI-NEXT:    mov v21.h[7], w10
; CHECK-GI-NEXT:    smov w10, v16.h[4]
; CHECK-GI-NEXT:    ldr w14, [sp, #544]
; CHECK-GI-NEXT:    fmov s19, w11
; CHECK-GI-NEXT:    smov w11, v16.h[1]
...
; CHECK-GI-NEXT:    smov w9, v7.h[6]
; CHECK-GI-NEXT:    sxtb w12, w12
; CHECK-GI-NEXT:    mul v18.8h, v18.8h, v21.8h
; CHECK-GI-NEXT:    fmov s21, w10
; CHECK-GI-NEXT:    mov v19.s[1], w13
; CHECK-GI-NEXT:    smov w10, v16.h[2]
; CHECK-GI-NEXT:    smov w13, v7.h[3]
; CHECK-GI-NEXT:    mov v20.s[1], w11
; CHECK-GI-NEXT:    smov w11, v16.h[6]
; CHECK-GI-NEXT:    smov w8, v17.h[1]
; CHECK-GI-NEXT:    mov v21.s[1], w15
; CHECK-GI-NEXT:    smov w15, v17.h[0]
; CHECK-GI-NEXT:    mov v19.s[2], w9
; CHECK-GI-NEXT:    mul w9, w14, w12
; CHECK-GI-NEXT:    smov w12, v17.h[4]
; CHECK-GI-NEXT:    smov w14, v17.h[5]
; CHECK-GI-NEXT:    mov v6.s[3], w13
; CHECK-GI-NEXT:    mov v20.s[2], w10
; CHECK-GI-NEXT:    smov w10, v18.h[0]
; CHECK-GI-NEXT:    mov v21.s[2], w11
; CHECK-GI-NEXT:    smov w11, v7.h[7]
...
; CHECK-GI-NEXT:    fmov w8, s17
; CHECK-GI-NEXT:    mov b17, v7.b[11]
; CHECK-GI-NEXT:    mov b27, v7.b[12]
; CHECK-GI-NEXT:    fmov w12, s19
; CHECK-GI-NEXT:    mov b19, v7.b[13]
; CHECK-GI-NEXT:    fmov w13, s20
; CHECK-GI-NEXT:    mov b20, v7.b[14]
; CHECK-GI-NEXT:    mov b28, v7.b[15]
...
; CHECK-GI-NEXT:    mov b24, v16.b[4]
; CHECK-GI-NEXT:    fmov w24, s19
; CHECK-GI-NEXT:    mov b19, v16.b[7]
; CHECK-GI-NEXT:    fmov w3, s20
; CHECK-GI-NEXT:    mov b20, v16.b[8]
; CHECK-GI-NEXT:    uxtb w10, w10
; CHECK-GI-NEXT:    mov v7.h[3], w12
; CHECK-GI-NEXT:    uxtb w12, w13
; CHECK-GI-NEXT:    uxtb w13, w15
; CHECK-GI-NEXT:    uxtb w15, w16
; CHECK-GI-NEXT:    uxtb w24, w24
...
; CHECK-GI-NEXT:    fmov w4, s23
; CHECK-GI-NEXT:    mov b23, v16.b[12]
; CHECK-GI-NEXT:    uxtb w25, w25
; CHECK-GI-NEXT:    mov v7.h[4], w12
; CHECK-GI-NEXT:    fmov w11, s25
; CHECK-GI-NEXT:    uxtb w26, w26
; CHECK-GI-NEXT:    mov v17.h[1], w15
; CHECK-GI-NEXT:    mov b25, v16.b[14]
; CHECK-GI-NEXT:    uxtb w4, w4
; CHECK-GI-NEXT:    fmov w27, s16
; CHECK-GI-NEXT:    fmov w23, s27
; CHECK-GI-NEXT:    uxtb w11, w11
; CHECK-GI-NEXT:    fmov w14, s24
; CHECK-GI-NEXT:    mov b24, v16.b[13]
; CHECK-GI-NEXT:    mov b27, v16.b[15]
; CHECK-GI-NEXT:    ldr q16, [x0, #16]
; CHECK-GI-NEXT:    fmov w8, s19
; CHECK-GI-NEXT:    uxtb w27, w27
; CHECK-GI-NEXT:    uxtb w23, w23
; CHECK-GI-NEXT:    mov v17.h[2], w21
; CHECK-GI-NEXT:    uxtb w14, w14
; CHECK-GI-NEXT:    mov b19, v18.b[1]
; CHECK-GI-NEXT:    fmov w7, s20
; CHECK-GI-NEXT:    uxtb w8, w8
; CHECK-GI-NEXT:    mov b20, v18.b[2]
; CHECK-GI-NEXT:    fmov w5, s26
; CHECK-GI-NEXT:    mov b26, v18.b[3]
; CHECK-GI-NEXT:    fmov w18, s21
; CHECK-GI-NEXT:    mov b21, v18.b[4]
; CHECK-GI-NEXT:    uxtb w7, w7
; CHECK-GI-NEXT:    fmov w17, s22
; CHECK-GI-NEXT:    fmov w16, s23
; CHECK-GI-NEXT:    uxtb w5, w5
; CHECK-GI-NEXT:    mov b22, v18.b[5]
; CHECK-GI-NEXT:    mov b23, v18.b[6]
; CHECK-GI-NEXT:    uxtb w18, w18
; CHECK-GI-NEXT:    mov v7.h[5], w19
; CHECK-GI-NEXT:    fmov w30, s18
; CHECK-GI-NEXT:    uxtb w17, w17
; CHECK-GI-NEXT:    uxtb w16, w16
; CHECK-GI-NEXT:    fmov w13, s25
; CHECK-GI-NEXT:    mov b25, v18.b[8]
; CHECK-GI-NEXT:    mov v17.h[3], w22
; CHECK-GI-NEXT:    fmov w15, s24
; CHECK-GI-NEXT:    uxtb w30, w30
; CHECK-GI-NEXT:    mov b24, v18.b[7]
; CHECK-GI-NEXT:    fmov w12, s27
; CHECK-GI-NEXT:    fmov w19, s19
; CHECK-GI-NEXT:    mov b19, v18.b[9]
; CHECK-GI-NEXT:    fmov w21, s20
; CHECK-GI-NEXT:    mov b20, v18.b[10]
; CHECK-GI-NEXT:    fmov w28, s26
; CHECK-GI-NEXT:    mov b26, v18.b[11]
; CHECK-GI-NEXT:    fmov w29, s21
; CHECK-GI-NEXT:    mov b21, v18.b[12]
; CHECK-GI-NEXT:    mov v7.h[6], w20
; CHECK-GI-NEXT:    uxtb w19, w19
; CHECK-GI-NEXT:    uxtb w21, w21
; CHECK-GI-NEXT:    fmov w20, s22
...
; CHECK-GI-NEXT:    uxtb w29, w29
; CHECK-GI-NEXT:    mov b27, v18.b[15]
; CHECK-GI-NEXT:    fmov s18, w27
; CHECK-GI-NEXT:    uxtb w20, w20
; CHECK-GI-NEXT:    mov v17.h[4], w23
; CHECK-GI-NEXT:    fmov w23, s25
; CHECK-GI-NEXT:    fmov s25, w30
; CHECK-GI-NEXT:    fmov w27, s19
; CHECK-GI-NEXT:    mov b19, v16.b[2]
; CHECK-GI-NEXT:    mov v18.h[1], w25
...
; CHECK-GI-NEXT:    uxtb w27, w27
; CHECK-GI-NEXT:    mov v25.h[1], w19
; CHECK-GI-NEXT:    mov b24, v16.b[1]
; CHECK-GI-NEXT:    fmov w25, s20
; CHECK-GI-NEXT:    mov v17.h[5], w24
; CHECK-GI-NEXT:    fmov w24, s26
; CHECK-GI-NEXT:    mov v18.h[2], w26
; CHECK-GI-NEXT:    mov b26, v16.b[8]
; CHECK-GI-NEXT:    fmov w19, s22
; CHECK-GI-NEXT:    mov b22, v16.b[5]
; CHECK-GI-NEXT:    mov b20, v16.b[3]
; CHECK-GI-NEXT:    fmov w26, s23
; CHECK-GI-NEXT:    uxtb w24, w24
; CHECK-GI-NEXT:    mov v25.h[2], w21
; CHECK-GI-NEXT:    fmov w21, s24
...
; CHECK-GI-NEXT:    uxtb w7, w28
; CHECK-GI-NEXT:    uxtb w21, w21
; CHECK-GI-NEXT:    fmov w28, s20
; CHECK-GI-NEXT:    uxtb w9, w9
; CHECK-GI-NEXT:    mov b20, v16.b[10]
; CHECK-GI-NEXT:    mov v17.h[6], w3
; CHECK-GI-NEXT:    uxtb w4, w4
; CHECK-GI-NEXT:    mov v25.h[3], w7
; CHECK-GI-NEXT:    fmov w7, s21
; CHECK-GI-NEXT:    fmov s21, w23
; CHECK-GI-NEXT:    mov v19.h[1], w5
; CHECK-GI-NEXT:    uxtb w5, w25
; CHECK-GI-NEXT:    fmov w25, s16
; CHECK-GI-NEXT:    fmov w23, s22
; CHECK-GI-NEXT:    mov b22, v16.b[11]
; CHECK-GI-NEXT:    mov v18.h[4], w14
; CHECK-GI-NEXT:    fmov w3, s27
; CHECK-GI-NEXT:    mov v17.h[7], w9
; CHECK-GI-NEXT:    mov v21.h[1], w27
; CHECK-GI-NEXT:    mov v25.h[4], w29
; CHECK-GI-NEXT:    fmov w29, s26
; CHECK-GI-NEXT:    uxtb w25, w25
; CHECK-GI-NEXT:    fmov w27, s23
; CHECK-GI-NEXT:    mov b23, v16.b[12]
; CHECK-GI-NEXT:    mov v19.h[2], w18
; CHECK-GI-NEXT:    uxtb w18, w30
; CHECK-GI-NEXT:    mov b26, v16.b[13]
; CHECK-GI-NEXT:    uxtb w29, w29
; CHECK-GI-NEXT:    mov v18.h[5], w11
; CHECK-GI-NEXT:    mov v5.s[1], wzr
; CHECK-GI-NEXT:    mov v21.h[2], w5
; CHECK-GI-NEXT:    fmov w5, s24
; CHECK-GI-NEXT:    fmov s24, w25
; CHECK-GI-NEXT:    fmov w25, s20
; CHECK-GI-NEXT:    mov v25.h[5], w20
; CHECK-GI-NEXT:    uxtb w20, w28
; CHECK-GI-NEXT:    mov v19.h[3], w17
; CHECK-GI-NEXT:    uxtb w17, w6
; CHECK-GI-NEXT:    mov b20, v16.b[14]
; CHECK-GI-NEXT:    uxtb w5, w5
; CHECK-GI-NEXT:    mov v24.h[1], w21
; CHECK-GI-NEXT:    fmov w21, s22
; CHECK-GI-NEXT:    uxtb w25, w25
; CHECK-GI-NEXT:    fmov s22, w29
; CHECK-GI-NEXT:    mov v21.h[3], w24
; CHECK-GI-NEXT:    fmov w29, s23
; CHECK-GI-NEXT:    mov v18.h[6], w10
; CHECK-GI-NEXT:    uxtb w10, w13
; CHECK-GI-NEXT:    uxtb w14, w21
; CHECK-GI-NEXT:    mov v19.h[4], w16
; CHECK-GI-NEXT:    fmov w24, s20
; CHECK-GI-NEXT:    mov v22.h[1], w5
; CHECK-GI-NEXT:    mov v24.h[2], w4
; CHECK-GI-NEXT:    uxtb w4, w22
; CHECK-GI-NEXT:    uxtb w11, w29
; CHECK-GI-NEXT:    ldp x22, x21, [sp, #64] // 16-byte Folded Reload
; CHECK-GI-NEXT:    mov v21.h[4], w18
; CHECK-GI-NEXT:    uxtb w18, w7
; CHECK-GI-NEXT:    mov v25.h[6], w4
; CHECK-GI-NEXT:    fmov w5, s26
; CHECK-GI-NEXT:    mov b20, v16.b[7]
; CHECK-GI-NEXT:    mov b16, v16.b[15]
; CHECK-GI-NEXT:    mov v22.h[2], w25
; CHECK-GI-NEXT:    mov v24.h[3], w20
; CHECK-GI-NEXT:    mov v18.h[7], w8
; CHECK-GI-NEXT:    mov v6.s[1], wzr
; CHECK-GI-NEXT:    mov v0.s[1], wzr
; CHECK-GI-NEXT:    mov v1.s[1], wzr
; CHECK-GI-NEXT:    uxtb w9, w5
; CHECK-GI-NEXT:    mov v25.h[7], w17
; CHECK-GI-NEXT:    mov v3.s[1], wzr
; CHECK-GI-NEXT:    mov v2.s[1], wzr
; CHECK-GI-NEXT:    mov v4.s[1], wzr
; CHECK-GI-NEXT:    mov v5.s[2], wzr
; CHECK-GI-NEXT:    mov v22.h[3], w14
; CHECK-GI-NEXT:    uxtb w14, w19
; CHECK-GI-NEXT:    mov v24.h[4], w18
; CHECK-GI-NEXT:    ldp x20, x19, [sp, #80] // 16-byte Folded Reload
; CHECK-GI-NEXT:    mov v6.s[2], wzr
; CHECK-GI-NEXT:    mov v21.h[5], w14
; CHECK-GI-NEXT:    uxtb w14, w15
; CHECK-GI-NEXT:    uxtb w15, w23
; CHECK-GI-NEXT:    mul v7.8h, v7.8h, v25.8h
; CHECK-GI-NEXT:    mov v0.s[2], wzr
; CHECK-GI-NEXT:    mov v1.s[2], wzr
; CHECK-GI-NEXT:    mov v22.h[4], w11
; CHECK-GI-NEXT:    uxtb w11, w26
; CHECK-GI-NEXT:    mov v19.h[5], w14
; CHECK-GI-NEXT:    ldp x26, x25, [sp, #32] // 16-byte Folded Reload
...
; CHECK-GI-NEXT:    mov v3.s[2], wzr
; CHECK-GI-NEXT:    ldp x28, x27, [sp, #16] // 16-byte Folded Reload
; CHECK-GI-NEXT:    umov w8, v7.h[0]
; CHECK-GI-NEXT:    mov v22.h[5], w9
; CHECK-GI-NEXT:    uxtb w9, w3
; CHECK-GI-NEXT:    mov v19.h[6], w10
; CHECK-GI-NEXT:    uxtb w10, w24
; CHECK-GI-NEXT:    ldp x24, x23, [sp, #48] // 16-byte Folded Reload
; CHECK-GI-NEXT:    mov v21.h[7], w9
...
; CHECK-GI-NEXT:    umov w10, v7.h[1]
; CHECK-GI-NEXT:    mov v19.h[7], w9
; CHECK-GI-NEXT:    uxtb w9, w12
; CHECK-GI-NEXT:    umov w12, v7.h[4]
; CHECK-GI-NEXT:    mov v4.s[2], wzr
; CHECK-GI-NEXT:    uxtb w11, w11
; CHECK-GI-NEXT:    mul v16.8h, v17.8h, v21.8h
; CHECK-GI-NEXT:    fmov s17, w8
; CHECK-GI-NEXT:    umov w8, v7.h[2]
; CHECK-GI-NEXT:    mov v5.s[3], wzr
; CHECK-GI-NEXT:    mov v6.s[3], wzr
; CHECK-GI-NEXT:    mov v24.h[7], w11
; CHECK-GI-NEXT:    umov w11, v7.h[5]
; CHECK-GI-NEXT:    mov v22.h[7], w9
; CHECK-GI-NEXT:    ldrb w9, [x0, #32]
; CHECK-GI-NEXT:    mov v17.s[1], w10
; CHECK-GI-NEXT:    ldrb w10, [x1, #32]
; CHECK-GI-NEXT:    umov w13, v16.h[0]
; CHECK-GI-NEXT:    umov w15, v16.h[4]
; CHECK-GI-NEXT:    fmov s20, w12
; CHECK-GI-NEXT:    mul w9, w10, w9
; CHECK-GI-NEXT:    umov w14, v16.h[1]
; CHECK-GI-NEXT:    umov w12, v7.h[6]
; CHECK-GI-NEXT:    mul v18.8h, v18.8h, v24.8h
; CHECK-GI-NEXT:    mul v19.8h, v19.8h, v22.8h
; CHECK-GI-NEXT:    mov v0.s[3], wzr
; CHECK-GI-NEXT:    mov v20.s[1], w11
; CHECK-GI-NEXT:    umov w11, v16.h[5]
; CHECK-GI-NEXT:    mov v17.s[2], w8
; CHECK-GI-NEXT:    fmov s21, w13
; CHECK-GI-NEXT:    umov w8, v7.h[3]
; CHECK-GI-NEXT:    umov w13, v7.h[7]
; CHECK-GI-NEXT:    fmov s7, w15
; CHECK-GI-NEXT:    umov w15, v16.h[6]
; CHECK-GI-NEXT:    mov v1.s[3], wzr
; CHECK-GI-NEXT:    umov w10, v18.h[0]
; CHECK-GI-NEXT:    mov v3.s[3], wzr
; CHECK-GI-NEXT:    mov v2.s[3], wzr
; CHECK-GI-NEXT:    mov v21.s[1], w14
; CHECK-GI-NEXT:    umov w14, v16.h[2]
; CHECK-GI-NEXT:    mov v20.s[2], w12
; CHECK-GI-NEXT:    mov v7.s[1], w11
; CHECK-GI-NEXT:    umov w11, v18.h[1]
; CHECK-GI-NEXT:    mov v17.s[3], w8
; CHECK-GI-NEXT:    umov w8, v16.h[3]
; CHECK-GI-NEXT:    umov w12, v18.h[4]
...
; CHECK-GI-NEXT:    umov w15, v16.h[7]
; CHECK-GI-NEXT:    fmov s16, w10
; CHECK-GI-NEXT:    umov w10, v19.h[1]
; CHECK-GI-NEXT:    umov w14, v18.h[5]
; CHECK-GI-NEXT:    fmov s22, w12
; CHECK-GI-NEXT:    umov w12, v18.h[6]
; CHECK-GI-NEXT:    add v2.4s, v2.4s, v4.4s
; CHECK-GI-NEXT:    add v0.4s, v0.4s, v5.4s
; CHECK-GI-NEXT:    mov v16.s[1], w11
; CHECK-GI-NEXT:    umov w11, v18.h[2]
; CHECK-GI-NEXT:    mov v21.s[3], w8
; CHECK-GI-NEXT:    umov w8, v19.h[4]
; CHECK-GI-NEXT:    fmov s23, w13
; CHECK-GI-NEXT:    umov w13, v19.h[5]
; CHECK-GI-NEXT:    mov v22.s[1], w14
; CHECK-GI-NEXT:    umov w14, v19.h[2]
; CHECK-GI-NEXT:    mov v7.s[3], w15
; CHECK-GI-NEXT:    add v6.4s, v17.4s, v20.4s
; CHECK-GI-NEXT:    add v1.4s, v1.4s, v2.4s
; CHECK-GI-NEXT:    mov v23.s[1], w10
; CHECK-GI-NEXT:    umov w10, v18.h[3]
; CHECK-GI-NEXT:    mov v16.s[2], w11
; CHECK-GI-NEXT:    umov w11, v18.h[7]
; CHECK-GI-NEXT:    fmov s18, w8
; CHECK-GI-NEXT:    umov w8, v19.h[6]
; CHECK-GI-NEXT:    mov v22.s[2], w12
; CHECK-GI-NEXT:    umov w12, v19.h[3]
; CHECK-GI-NEXT:    add v7.4s, v21.4s, v7.4s
...
; CHECK-GI-NEXT:    mov b17, v7.b[12]
; CHECK-GI-NEXT:    fmov w9, s18
; CHECK-GI-NEXT:    mov b18, v7.b[13]
; CHECK-GI-NEXT:    fmov w10, s19
; CHECK-GI-NEXT:    mov b19, v7.b[14]
; CHECK-GI-NEXT:    mov b28, v7.b[15]
; CHECK-GI-NEXT:    fmov s7, w11
; CHECK-GI-NEXT:    sxtb w13, w8
; CHECK-GI-NEXT:    fmov w12, s20
; CHECK-GI-NEXT:    fmov w7, s23
; CHECK-GI-NEXT:    sxtb w9, w9
; CHECK-GI-NEXT:    sxtb w18, w10
; CHECK-GI-NEXT:    mov b23, v16.b[4]
; CHECK-GI-NEXT:    mov v7.h[1], w13
; CHECK-GI-NEXT:    fmov w15, s24
; CHECK-GI-NEXT:    mov b20, v16.b[1]
; CHECK-GI-NEXT:    sxtb w12, w12
; CHECK-GI-NEXT:    sxtb w30, w7
; CHECK-GI-NEXT:    fmov w21, s21
; CHECK-GI-NEXT:    mov b21, v16.b[2]
; CHECK-GI-NEXT:    fmov w22, s22
; CHECK-GI-NEXT:    mov b22, v16.b[3]
; CHECK-GI-NEXT:    sxtb w15, w15
; CHECK-GI-NEXT:    mov b24, v16.b[5]
; CHECK-GI-NEXT:    fmov w16, s25
; CHECK-GI-NEXT:    sxtb w21, w21
; CHECK-GI-NEXT:    mov v7.h[2], w9
; CHECK-GI-NEXT:    fmov w24, s17
; CHECK-GI-NEXT:    sxtb w22, w22
; CHECK-GI-NEXT:    fmov w13, s23
; CHECK-GI-NEXT:    mov b25, v16.b[6]
; CHECK-GI-NEXT:    ldp q23, q17, [x0]
; CHECK-GI-NEXT:    sxtb w16, w16
; CHECK-GI-NEXT:    sxtb w24, w24
; CHECK-GI-NEXT:    fmov w17, s26
; CHECK-GI-NEXT:    mov b26, v16.b[7]
; CHECK-GI-NEXT:    sxtb w13, w13
; CHECK-GI-NEXT:    mov v7.h[3], w18
; CHECK-GI-NEXT:    fmov w23, s27
; CHECK-GI-NEXT:    mov b27, v16.b[8]
; CHECK-GI-NEXT:    mov b29, v16.b[9]
; CHECK-GI-NEXT:    fmov w25, s18
; CHECK-GI-NEXT:    mov b18, v16.b[10]
; CHECK-GI-NEXT:    fmov w3, s19
; CHECK-GI-NEXT:    fmov w8, s28
; CHECK-GI-NEXT:    sxtb w23, w23
; CHECK-GI-NEXT:    mov b19, v16.b[11]
; CHECK-GI-NEXT:    fmov w19, s20
; CHECK-GI-NEXT:    sxtb w25, w25
; CHECK-GI-NEXT:    mov v7.h[4], w12
; CHECK-GI-NEXT:    mov b20, v16.b[12]
; CHECK-GI-NEXT:    sxtb w3, w3
; CHECK-GI-NEXT:    sxtb w8, w8
; CHECK-GI-NEXT:    fmov w5, s21
; CHECK-GI-NEXT:    sxtb w19, w19
; CHECK-GI-NEXT:    mov b21, v16.b[13]
; CHECK-GI-NEXT:    fmov w14, s22
; CHECK-GI-NEXT:    mov b22, v16.b[14]
; CHECK-GI-NEXT:    fmov w26, s16
; CHECK-GI-NEXT:    mov b28, v16.b[15]
; CHECK-GI-NEXT:    sxtb w5, w5
; CHECK-GI-NEXT:    fmov s16, w15
; CHECK-GI-NEXT:    sxtb w15, w17
; CHECK-GI-NEXT:    sxtb w14, w14
; CHECK-GI-NEXT:    mov v7.h[5], w21
; CHECK-GI-NEXT:    fmov w11, s24
; CHECK-GI-NEXT:    sxtb w26, w26
; CHECK-GI-NEXT:    mov b24, v23.b[1]
; CHECK-GI-NEXT:    fmov w4, s18
; CHECK-GI-NEXT:    mov v16.h[1], w16
; CHECK-GI-NEXT:    mov b18, v23.b[4]
; CHECK-GI-NEXT:    fmov w9, s25
; CHECK-GI-NEXT:    sxtb w11, w11
; CHECK-GI-NEXT:    mov b25, v23.b[2]
; CHECK-GI-NEXT:    fmov w17, s20
; CHECK-GI-NEXT:    sxtb w4, w4
; CHECK-GI-NEXT:    mov v7.h[6], w22
; CHECK-GI-NEXT:    fmov w22, s23
; CHECK-GI-NEXT:    fmov w27, s24
; CHECK-GI-NEXT:    mov b24, v23.b[10]
; CHECK-GI-NEXT:    mov b20, v23.b[6]
; CHECK-GI-NEXT:    mov v16.h[2], w15
; CHECK-GI-NEXT:    fmov w28, s18
; CHECK-GI-NEXT:    fmov s18, w26
; CHECK-GI-NEXT:    sxtb w22, w22
; CHECK-GI-NEXT:    fmov w10, s26
; CHECK-GI-NEXT:    mov b26, v23.b[3]
; CHECK-GI-NEXT:    sxtb w26, w27
; CHECK-GI-NEXT:    fmov w15, s22
; CHECK-GI-NEXT:    mov b22, v23.b[8]
; CHECK-GI-NEXT:    sxtb w28, w28
; CHECK-GI-NEXT:    fmov w27, s24
; CHECK-GI-NEXT:    fmov s24, w22
; CHECK-GI-NEXT:    sxtb w10, w10
; CHECK-GI-NEXT:    mov v16.h[3], w23
; CHECK-GI-NEXT:    fmov w21, s25
; CHECK-GI-NEXT:    fmov w20, s27
; CHECK-GI-NEXT:    fmov w18, s19
; CHECK-GI-NEXT:    mov b19, v23.b[5]
; CHECK-GI-NEXT:    mov v24.h[1], w26
; CHECK-GI-NEXT:    mov b27, v23.b[9]
; CHECK-GI-NEXT:    mov v18.h[1], w19
; CHECK-GI-NEXT:    sxtb w19, w21
; CHECK-GI-NEXT:    fmov w23, s26
; CHECK-GI-NEXT:    mov v7.h[7], w30
; CHECK-GI-NEXT:    sxtb w20, w20
; CHECK-GI-NEXT:    sxtb w18, w18
; CHECK-GI-NEXT:    mov v16.h[4], w24
; CHECK-GI-NEXT:    fmov w24, s20
; CHECK-GI-NEXT:    mov b20, v17.b[1]
; CHECK-GI-NEXT:    fmov w30, s22
; CHECK-GI-NEXT:    mov b22, v17.b[3]
; CHECK-GI-NEXT:    mov v24.h[2], w19
; CHECK-GI-NEXT:    fmov w6, s29
; CHECK-GI-NEXT:    fmov w29, s19
; CHECK-GI-NEXT:    mov b19, v23.b[14]
; CHECK-GI-NEXT:    mov v18.h[2], w5
; CHECK-GI-NEXT:    sxtb w5, w23
; CHECK-GI-NEXT:    mov v16.h[5], w25
; CHECK-GI-NEXT:    fmov w25, s27
; CHECK-GI-NEXT:    sxtb w6, w6
; CHECK-GI-NEXT:    fmov w23, s20
; CHECK-GI-NEXT:    fmov s20, w20
; CHECK-GI-NEXT:    sxtb w20, w30
; CHECK-GI-NEXT:    fmov w16, s21
; CHECK-GI-NEXT:    mov b21, v23.b[7]
; CHECK-GI-NEXT:    sxtb w25, w25
; CHECK-GI-NEXT:    fmov w12, s28
; CHECK-GI-NEXT:    mov b25, v23.b[11]
; CHECK-GI-NEXT:    sxtb w23, w23
; CHECK-GI-NEXT:    mov b26, v23.b[12]
; CHECK-GI-NEXT:    mov b28, v23.b[13]
; CHECK-GI-NEXT:    mov b23, v23.b[15]
; CHECK-GI-NEXT:    mov v24.h[3], w5
; CHECK-GI-NEXT:    fmov w5, s22
; CHECK-GI-NEXT:    sxtb w12, w12
; CHECK-GI-NEXT:    fmov s22, w20
; CHECK-GI-NEXT:    mov v16.h[6], w3
; CHECK-GI-NEXT:    fmov w3, s19
; CHECK-GI-NEXT:    mov b19, v17.b[8]
; CHECK-GI-NEXT:    mov v20.h[1], w6
; CHECK-GI-NEXT:    sxtb w6, w27
; CHECK-GI-NEXT:    sxtb w5, w5
; CHECK-GI-NEXT:    fmov w27, s17
; CHECK-GI-NEXT:    fmov w19, s23
; CHECK-GI-NEXT:    mov b23, v17.b[9]
; CHECK-GI-NEXT:    mov v22.h[1], w25
; CHECK-GI-NEXT:    fmov w7, s21
; CHECK-GI-NEXT:    mov b21, v17.b[2]
; CHECK-GI-NEXT:    mov v24.h[4], w28
; CHECK-GI-NEXT:    sxtb w27, w27
; CHECK-GI-NEXT:    fmov w28, s19
; CHECK-GI-NEXT:    mov b27, v17.b[6]
; CHECK-GI-NEXT:    fmov w22, s25
; CHECK-GI-NEXT:    mov b25, v17.b[4]
; CHECK-GI-NEXT:    mov v20.h[2], w4
; CHECK-GI-NEXT:    sxtb w4, w29
; CHECK-GI-NEXT:    mov v22.h[2], w6
; CHECK-GI-NEXT:    fmov w6, s23
; CHECK-GI-NEXT:    sxtb w28, w28
; CHECK-GI-NEXT:    fmov s23, w27
; CHECK-GI-NEXT:    fmov w30, s21
; CHECK-GI-NEXT:    sxtb w22, w22
; CHECK-GI-NEXT:    mov b21, v17.b[10]
; CHECK-GI-NEXT:    fmov w27, s27
; CHECK-GI-NEXT:    sxtb w6, w6
; CHECK-GI-NEXT:    fmov s27, w28
; CHECK-GI-NEXT:    fmov w26, s26
; CHECK-GI-NEXT:    sxtb w29, w30
; CHECK-GI-NEXT:    mov v23.h[1], w23
; CHECK-GI-NEXT:    mov b26, v17.b[5]
; CHECK-GI-NEXT:    fmov w20, s25
; CHECK-GI-NEXT:    mov b25, v17.b[11]
; CHECK-GI-NEXT:    mov v22.h[3], w22
; CHECK-GI-NEXT:    sxtb w22, w24
; CHECK-GI-NEXT:    sxtb w24, w26
; CHECK-GI-NEXT:    fmov w28, s21
; CHECK-GI-NEXT:    mov v27.h[1], w6
; CHECK-GI-NEXT:    mov v18.h[3], w14
; CHECK-GI-NEXT:    sxtb w14, w17
; CHECK-GI-NEXT:    sxtb w17, w7
; CHECK-GI-NEXT:    mov v23.h[2], w29
; CHECK-GI-NEXT:    fmov w25, s26
; CHECK-GI-NEXT:    sxtb w28, w28
; CHECK-GI-NEXT:    mov b26, v17.b[12]
; CHECK-GI-NEXT:    fmov w23, s25
; CHECK-GI-NEXT:    mov v24.h[5], w4
; CHECK-GI-NEXT:    fmov w21, s28
; CHECK-GI-NEXT:    mov b19, v17.b[13]
; CHECK-GI-NEXT:    mov v27.h[2], w28
; CHECK-GI-NEXT:    mov v20.h[3], w18
; CHECK-GI-NEXT:    mov v22.h[4], w24
; CHECK-GI-NEXT:    sxtb w23, w23
; CHECK-GI-NEXT:    mov v23.h[3], w5
; CHECK-GI-NEXT:    sxtb w5, w20
; CHECK-GI-NEXT:    sxtb w18, w21
; CHECK-GI-NEXT:    fmov w6, s26
; CHECK-GI-NEXT:    mov v18.h[4], w13
; CHECK-GI-NEXT:    sxtb w13, w16
; CHECK-GI-NEXT:    sxtb w16, w25
; CHECK-GI-NEXT:    mov v24.h[6], w22
; CHECK-GI-NEXT:    ldp x22, x21, [sp, #64] // 16-byte Folded Reload
; CHECK-GI-NEXT:    mov v27.h[3], w23
; CHECK-GI-NEXT:    sxtb w6, w6
; CHECK-GI-NEXT:    ldp x24, x23, [sp, #48] // 16-byte Folded Reload
; CHECK-GI-NEXT:    ldp x26, x25, [sp, #32] // 16-byte Folded Reload
; CHECK-GI-NEXT:    mov v23.h[4], w5
; CHECK-GI-NEXT:    mov b21, v17.b[14]
; CHECK-GI-NEXT:    fmov w30, s19
; CHECK-GI-NEXT:    mov v20.h[4], w14
; CHECK-GI-NEXT:    sxtb w14, w3
; CHECK-GI-NEXT:    mov v22.h[5], w18
; CHECK-GI-NEXT:    mov v18.h[5], w11
; CHECK-GI-NEXT:    sxtb w11, w27
; CHECK-GI-NEXT:    ldp x28, x27, [sp, #16] // 16-byte Folded Reload
; CHECK-GI-NEXT:    mov b19, v17.b[7]
; CHECK-GI-NEXT:    mov v24.h[7], w17
; CHECK-GI-NEXT:    sxtb w17, w30
; CHECK-GI-NEXT:    mov v27.h[4], w6
; CHECK-GI-NEXT:    mov v23.h[5], w16
; CHECK-GI-NEXT:    mov v16.h[7], w8
; CHECK-GI-NEXT:    sxtb w8, w9
; CHECK-GI-NEXT:    sxtb w9, w15
; CHECK-GI-NEXT:    fmov w4, s21
; CHECK-GI-NEXT:    mov v20.h[5], w13
; CHECK-GI-NEXT:    sxtb w13, w19
; CHECK-GI-NEXT:    mov v22.h[6], w14
; CHECK-GI-NEXT:    ldp x20, x19, [sp, #80] // 16-byte Folded Reload
; CHECK-GI-NEXT:    mov b17, v17.b[15]
; CHECK-GI-NEXT:    sxtb w14, w4
; CHECK-GI-NEXT:    mov v18.h[6], w8
; CHECK-GI-NEXT:    fmov w8, s19
; CHECK-GI-NEXT:    mov v27.h[5], w17
; CHECK-GI-NEXT:    mul v7.8h, v7.8h, v24.8h
...
; CHECK-GI-NEXT:    smov w11, v7.h[0]
; CHECK-GI-NEXT:    mov v23.h[7], w8
; CHECK-GI-NEXT:    sxtb w9, w9
; CHECK-GI-NEXT:    ldrsb w8, [x0, #32]
; CHECK-GI-NEXT:    smov w13, v7.h[1]
; CHECK-GI-NEXT:    mul v16.8h, v16.8h, v22.8h
; CHECK-GI-NEXT:    mov v20.h[7], w12
; CHECK-GI-NEXT:    smov w12, v7.h[5]
; CHECK-GI-NEXT:    mul w8, w10, w8
; CHECK-GI-NEXT:    smov w10, v7.h[3]
; CHECK-GI-NEXT:    mov v5.s[1], wzr
; CHECK-GI-NEXT:    mov v27.h[7], w9
; CHECK-GI-NEXT:    fmov s17, w11
; CHECK-GI-NEXT:    mul v18.8h, v18.8h, v23.8h
; CHECK-GI-NEXT:    smov w11, v7.h[4]
; CHECK-GI-NEXT:    smov w9, v7.h[2]
; CHECK-GI-NEXT:    mov v4.s[1], wzr
; CHECK-GI-NEXT:    sxth w8, w8
...
; CHECK-GI-NEXT:    mov v17.s[1], w13
; CHECK-GI-NEXT:    smov w13, v16.h[0]
; CHECK-GI-NEXT:    smov w16, v16.h[5]
; CHECK-GI-NEXT:    mul v19.8h, v20.8h, v27.8h
; CHECK-GI-NEXT:    mov v6.s[1], wzr
; CHECK-GI-NEXT:    mov v0.s[1], wzr
; CHECK-GI-NEXT:    fmov s20, w11
; CHECK-GI-NEXT:    smov w11, v18.h[0]
; CHECK-GI-NEXT:    mov v1.s[2], wzr
; CHECK-GI-NEXT:    mov v3.s[2], wzr
; CHECK-GI-NEXT:    mov v2.s[2], wzr
; CHECK-GI-NEXT:    mov v5.s[2], wzr
...
; CHECK-GI-NEXT:    smov w12, v18.h[1]
; CHECK-GI-NEXT:    smov w13, v7.h[7]
; CHECK-GI-NEXT:    fmov s7, w14
; CHECK-GI-NEXT:    fmov s22, w11
; CHECK-GI-NEXT:    smov w14, v16.h[2]
; CHECK-GI-NEXT:    mov v21.s[1], w15
; CHECK-GI-NEXT:    smov w15, v16.h[6]
; CHECK-GI-NEXT:    smov w11, v18.h[4]
; CHECK-GI-NEXT:    mov v17.s[3], w10
; CHECK-GI-NEXT:    smov w10, v18.h[5]
; CHECK-GI-NEXT:    mov v4.s[2], wzr
...
; CHECK-GI-NEXT:    mov v21.s[2], w14
; CHECK-GI-NEXT:    smov w14, v19.h[4]
; CHECK-GI-NEXT:    fmov s23, w11
...
; CHECK-GI-NEXT:    smov w15, v16.h[3]
; CHECK-GI-NEXT:    fmov s16, w12
; CHECK-GI-NEXT:    smov w12, v19.h[5]
; CHECK-GI-NEXT:    mov v22.s[2], w16
; CHECK-GI-NEXT:    smov w16, v18.h[3]
; CHECK-GI-NEXT:    mov v23.s[1], w10
; CHECK-GI-NEXT:    smov w10, v18.h[6]
; CHECK-GI-NEXT:    mov v1.s[3], wzr
; CHECK-GI-NEXT:    mov v16.s[1], w9
; CHECK-GI-NEXT:    smov w9, v18.h[7]
...
; CHECK-GI-NEXT:    mov v23.s[2], w10
; CHECK-GI-NEXT:    smov w10, v19.h[3]
; CHECK-GI-NEXT:    mov v20.s[3], w13
...
; CHECK-GI-NEXT:    add v2.4s, v2.4s, v5.4s
; CHECK-GI-NEXT:    mov v18.s[2], w12
; CHECK-GI-NEXT:    smov w12, v19.h[7]
; CHECK-GI-NEXT:    fmov s19, w8
; CHECK-GI-NEXT:    mov v23.s[3], w9
; CHECK-GI-NEXT:    add v3.4s, v4.4s, v6.4s
; CHECK-GI-NEXT:    add v4.4s, v17.4s, v20.4s
; CHECK-GI-NEXT:    mov v16.s[3], w10
; CHECK-GI-NEXT:    add v5.4s, v21.4s, v7.4s
; CHECK-GI-NEXT:    mov v19.s[1], wzr
; CHECK-GI-NEXT:    add v0.4s, v0.4s, v1.4s
; CHECK-GI-NEXT:    mov v18.s[3], w12
; CHECK-GI-NEXT:    add v1.4s, v2.4s, v3.4s
; CHECK-GI-NEXT:    add v6.4s, v22.4s, v23.4s
; CHECK-GI-NEXT:    add v2.4s, v4.4s, v5.4s
; CHECK-GI-NEXT:    mov v19.s[2], wzr
; CHECK-GI-NEXT:    add v0.4s, v0.4s, v1.4s
; CHECK-GI-NEXT:    add v7.4s, v16.4s, v18.4s
; CHECK-GI-NEXT:    mov v19.s[3], wzr
; CHECK-GI-NEXT:    add v3.4s, v6.4s, v7.4s
; CHECK-GI-NEXT:    add v1.4s, v2.4s, v3.4s
; CHECK-GI-NEXT:    add v0.4s, v19.4s, v0.4s
...
; CHECK-SD-NEXT:    ld1 { v17.b }[1], [x10]
; CHECK-SD-NEXT:    add x10, sp, #944
...
; CHECK-SD-NEXT:    ld1 { v16.b }[7], [x12]
; CHECK-SD-NEXT:    add x12, sp, #728
; CHECK-SD-NEXT:    smull v20.8h, v22.8b, v20.8b
...
; CHECK-SD-NEXT:    mov v23.s[0], v21.s[0]
; CHECK-SD-NEXT:    ldr b21, [sp, #608]
...
; CHECK-SD-NEXT:    smull v21.8h, v21.8b, v22.8b
; CHECK-SD-NEXT:    sshll v20.4s, v20.4h, #0
; CHECK-SD-NEXT:    smull v0.8h, v1.8b, v0.8b
...
; CHECK-SD-NEXT:    saddl2 v6.4s, v16.8h, v21.8h
; CHECK-SD-NEXT:    saddw v1.4s, v1.4s, v21.4h
...
; CHECK-GI:       // %bb.0: // %entry
; CHECK-GI-NEXT:    str d14, [sp, #-64]! // 8-byte Folded Spill
; CHECK-GI-NEXT:    stp d13, d12, [sp, #8] // 16-byte Folded Spill
; CHECK-GI-NEXT:    stp d11, d10, [sp, #24] // 16-byte Folded Spill
; CHECK-GI-NEXT:    stp d9, d8, [sp, #40] // 16-byte Folded Spill
; CHECK-GI-NEXT:    str x29, [sp, #56] // 8-byte Spill
...
; CHECK-GI-NEXT:    lsl w10, w10, #8
; CHECK-GI-NEXT:    mov v23.h[1], w8
; CHECK-GI-NEXT:    ldr w8, [sp, #88]
; CHECK-GI-NEXT:    sbfx w16, w16, #8, #8
; CHECK-GI-NEXT:    ldr w15, [sp, #168]
; CHECK-GI-NEXT:    movi d19, #0000000000000000
; CHECK-GI-NEXT:    mov v22.h[2], w9
; CHECK-GI-NEXT:    sbfx w10, w10, #8, #8
; CHECK-GI-NEXT:    sbfx w9, w11, #8, #8
; CHECK-GI-NEXT:    lsl w8, w8, #8
; CHECK-GI-NEXT:    lsl w11, w4, #8
; CHECK-GI-NEXT:    fmov s27, w16
; CHECK-GI-NEXT:    mov v23.h[2], w10
...
; CHECK-GI-NEXT:    lsl w11, w11, #8
; CHECK-GI-NEXT:    lsl w10, w10, #8
; CHECK-GI-NEXT:    mov v22.h[5], w14
; CHECK-GI-NEXT:    ldr w14, [sp, #160]
...
; CHECK-GI-NEXT:    mov v24.h[3], w9
; CHECK-GI-NEXT:    mov v23.h[7], w11
...
; CHECK-GI-NEXT:    sbfx w12, w12, #8, #8
; CHECK-GI-NEXT:    lsl w10, w10, #8
; CHECK-GI-NEXT:    mov v27.h[2], w9
; CHECK-GI-NEXT:    movi d4, #0000000000000000
; CHECK-GI-NEXT:    mov v25.h[1], w11
; CHECK-GI-NEXT:    ldr w11, [sp, #336]
; CHECK-GI-NEXT:    sbfx w9, w13, #8, #8
...
; CHECK-GI-NEXT:    mov v27.h[3], w14
; CHECK-GI-NEXT:    mov v25.h[2], w9
; CHECK-GI-NEXT:    ldr w9, [sp, #344]
; CHECK-GI-NEXT:    sbfx w11, w11, #8, #8
; CHECK-GI-NEXT:    sbfx w13, w13, #8, #8
...
; CHECK-GI-NEXT:    mov v24.h[6], w8
; CHECK-GI-NEXT:    lsl w14, w14, #8
; CHECK-GI-NEXT:    mov v27.h[4], w16
...
; CHECK-GI-NEXT:    lsl w16, w16, #8
; CHECK-GI-NEXT:    ldr w8, [sp, #312]
; CHECK-GI-NEXT:    mov v26.h[2], w9
; CHECK-GI-NEXT:    lsl w13, w13, #8
; CHECK-GI-NEXT:    ldr w9, [sp, #304]
; CHECK-GI-NEXT:    sbfx w16, w16, #8, #8
; CHECK-GI-NEXT:    lsl w8, w8, #8
; CHECK-GI-NEXT:    sbfx w15, w15, #8, #8
; CHECK-GI-NEXT:    mov v25.h[4], w14
; CHECK-GI-NEXT:    ldr w14, [sp, #392]
; CHECK-GI-NEXT:    sbfx w13, w13, #8, #8
; CHECK-GI-NEXT:    lsl w9, w9, #8
; CHECK-GI-NEXT:    sbfx w8, w8, #8, #8
; CHECK-GI-NEXT:    mov v27.h[5], w15
; CHECK-GI-NEXT:    lsl w14, w14, #8
...
; CHECK-GI-NEXT:    lsl w14, w14, #8
; CHECK-GI-NEXT:    ldr w13, [sp, #464]
; CHECK-GI-NEXT:    sbfx w9, w9, #8, #8
; CHECK-GI-NEXT:    mov v25.h[6], w8
; CHECK-GI-NEXT:    ldr w8, [sp, #416]
; CHECK-GI-NEXT:    sbfx w16, w16, #8, #8
; CHECK-GI-NEXT:    sbfx w14, w14, #8, #8
; CHECK-GI-NEXT:    lsl w13, w13, #8
; CHECK-GI-NEXT:    mov v26.h[5], w9
; CHECK-GI-NEXT:    ldr w9, [sp, #376]
; CHECK-GI-NEXT:    lsl w8, w8, #8
; CHECK-GI-NEXT:    mov v28.h[2], w16
; CHECK-GI-NEXT:    fmov s30, w14
; CHECK-GI-NEXT:    ldr w16, [sp, #472]
; CHECK-GI-NEXT:    lsl w9, w9, #8
; CHECK-GI-NEXT:    sbfx w13, w13, #8, #8
; CHECK-GI-NEXT:    ldr w14, [sp, #424]
; CHECK-GI-NEXT:    sbfx w8, w8, #8, #8
; CHECK-GI-NEXT:    lsl w16, w16, #8
; CHECK-GI-NEXT:    mov v25.h[7], w15
; CHECK-GI-NEXT:    sbfx w9, w9, #8, #8
; CHECK-GI-NEXT:    mov v30.h[1], w13
; CHECK-GI-NEXT:    lsl w14, w14, #8
; CHECK-GI-NEXT:    mov v28.h[3], w8
...
; CHECK-GI-NEXT:    lsl w8, w8, #8
; CHECK-GI-NEXT:    mul v31.8h, v22.8h, v25.8h
; CHECK-GI-NEXT:    mov v30.h[2], w16
; CHECK-GI-NEXT:    lsl w9, w9, #8
...
; CHECK-GI-NEXT:    lsl w14, w14, #8
; CHECK-GI-NEXT:    ldr w15, [sp, #448]
; CHECK-GI-NEXT:    mov v30.h[3], w8
; CHECK-GI-NEXT:    ldr w8, [sp, #496]
; CHECK-GI-NEXT:    sbfx w10, w10, #8, #8
; CHECK-GI-NEXT:    mov v28.h[5], w9
; CHECK-GI-NEXT:    mov v26.h[7], w13
; CHECK-GI-NEXT:    sbfx w14, w14, #8, #8
; CHECK-GI-NEXT:    sbfx w16, w16, #8, #8
...
; CHECK-GI-NEXT:    mov v27.h[7], w11
; CHECK-GI-NEXT:    smov w11, v31.h[4]
; CHECK-GI-NEXT:    mov v28.h[7], w10
; CHECK-GI-NEXT:    sbfx w8, w13, #8, #8
; CHECK-GI-NEXT:    smov w13, v26.h[0]
; CHECK-GI-NEXT:    mov v22.s[1], w15
; CHECK-GI-NEXT:    smov w15, v26.h[4]
; CHECK-GI-NEXT:    smov w12, v31.h[2]
; CHECK-GI-NEXT:    lsl w9, w9, #8
; CHECK-GI-NEXT:    smov w10, v31.h[5]
; CHECK-GI-NEXT:    ldr w14, [sp, #528]
; CHECK-GI-NEXT:    mov v30.h[6], w8
; CHECK-GI-NEXT:    smov w8, v26.h[1]
; CHECK-GI-NEXT:    fmov s23, w11
; CHECK-GI-NEXT:    smov w11, v26.h[5]
; CHECK-GI-NEXT:    mul v29.8h, v24.8h, v28.8h
; CHECK-GI-NEXT:    fmov s24, w13
; CHECK-GI-NEXT:    fmov s25, w15
; CHECK-GI-NEXT:    mov v22.s[2], w12
; CHECK-GI-NEXT:    smov w12, v31.h[3]
; CHECK-GI-NEXT:    smov w13, v26.h[2]
; CHECK-GI-NEXT:    ldr w16, [sp, #536]
; CHECK-GI-NEXT:    mov v23.s[1], w10
; CHECK-GI-NEXT:    mov v24.s[1], w8
; CHECK-GI-NEXT:    sbfx w8, w9, #8, #8
; CHECK-GI-NEXT:    smov w9, v26.h[6]
; CHECK-GI-NEXT:    mov v25.s[1], w11
; CHECK-GI-NEXT:    smov w15, v29.h[0]
; CHECK-GI-NEXT:    smov w10, v31.h[6]
; CHECK-GI-NEXT:    mov v30.h[7], w8
; CHECK-GI-NEXT:    smov w8, v29.h[1]
; CHECK-GI-NEXT:    mov v22.s[3], w12
; CHECK-GI-NEXT:    smov w12, v26.h[3]
; CHECK-GI-NEXT:    smov w11, v31.h[7]
; CHECK-GI-NEXT:    movi d3, #0000000000000000
; CHECK-GI-NEXT:    mov v24.s[2], w13
; CHECK-GI-NEXT:    ldr w13, [sp, #552]
; CHECK-GI-NEXT:    movi d5, #0000000000000000
; CHECK-GI-NEXT:    mov v25.s[2], w9
; CHECK-GI-NEXT:    smov w9, v26.h[7]
; CHECK-GI-NEXT:    fmov s26, w15
; CHECK-GI-NEXT:    smov w15, v29.h[2]
; CHECK-GI-NEXT:    mul v31.8h, v27.8h, v30.8h
; CHECK-GI-NEXT:    mov v23.s[2], w10
; CHECK-GI-NEXT:    ldr w10, [sp, #544]
; CHECK-GI-NEXT:    lsl w13, w13, #8
; CHECK-GI-NEXT:    movi d1, #0000000000000000
; CHECK-GI-NEXT:    mov v26.s[1], w8
; CHECK-GI-NEXT:    lsl w8, w14, #8
; CHECK-GI-NEXT:    mov v24.s[3], w12
; CHECK-GI-NEXT:    lsl w12, w16, #8
; CHECK-GI-NEXT:    smov w16, v29.h[4]
...
; CHECK-GI-NEXT:    fmov s8, w8
; CHECK-GI-NEXT:    fmov s27, w16
; CHECK-GI-NEXT:    lsl w9, w9, #8
; CHECK-GI-NEXT:    ldr w8, [sp, #600]
; CHECK-GI-NEXT:    sbfx w10, w10, #8, #8
; CHECK-GI-NEXT:    ldr w16, [sp, #608]
; CHECK-GI-NEXT:    sbfx w13, w13, #8, #8
; CHECK-GI-NEXT:    mov v8.h[1], w12
; CHECK-GI-NEXT:    sbfx w9, w9, #8, #8
; CHECK-GI-NEXT:    lsl w8, w8, #8
; CHECK-GI-NEXT:    mov v27.s[1], w15
; CHECK-GI-NEXT:    smov w15, v31.h[0]
; CHECK-GI-NEXT:    lsl w16, w16, #8
; CHECK-GI-NEXT:    fmov s9, w9
; CHECK-GI-NEXT:    sbfx w8, w8, #8, #8
; CHECK-GI-NEXT:    lsl w11, w11, #8
; CHECK-GI-NEXT:    sbfx w16, w16, #8, #8
; CHECK-GI-NEXT:    ldr w14, [sp, #568]
; CHECK-GI-NEXT:    ldr w12, [sp, #576]
; CHECK-GI-NEXT:    mov v8.h[2], w10
; CHECK-GI-NEXT:    smov w10, v31.h[1]
; CHECK-GI-NEXT:    sbfx w11, w11, #8, #8
; CHECK-GI-NEXT:    fmov s28, w15
; CHECK-GI-NEXT:    mov v9.h[1], w8
...
; CHECK-GI-NEXT:    smov w10, v31.h[2]
; CHECK-GI-NEXT:    lsl w8, w8, #8
; CHECK-GI-NEXT:    mov v9.h[2], w16
; CHECK-GI-NEXT:    ldr w16, [sp, #656]
; CHECK-GI-NEXT:    mov v27.s[2], w15
; CHECK-GI-NEXT:    ldr w15, [sp, #664]
; CHECK-GI-NEXT:    mov v8.h[3], w13
; CHECK-GI-NEXT:    sbfx w8, w8, #8, #8
...
; CHECK-GI-NEXT:    lsl w15, w15, #8
; CHECK-GI-NEXT:    mov v9.h[3], w8
; CHECK-GI-NEXT:    ldr w8, [sp, #672]
; CHECK-GI-NEXT:    lsl w13, w13, #8
; CHECK-GI-NEXT:    sbfx w10, w10, #8, #8
; CHECK-GI-NEXT:    sbfx w15, w15, #8, #8
; CHECK-GI-NEXT:    mov v8.h[4], w11
; CHECK-GI-NEXT:    smov w11, v31.h[4]
; CHECK-GI-NEXT:    lsl w8, w8, #8
...
; CHECK-GI-NEXT:    sbfx w14, w14, #8, #8
; CHECK-GI-NEXT:    mov v8.h[6], w12
; CHECK-GI-NEXT:    ldr w12, [sp, #696]
; CHECK-GI-NEXT:    mov v10.h[2], w8
...
; CHECK-GI-NEXT:    sbfx w8, w8, #8, #8
; CHECK-GI-NEXT:    lsl w13, w13, #8
; CHECK-GI-NEXT:    mov v9.h[7], w15
; CHECK-GI-NEXT:    sbfx w11, w11, #8, #8
; CHECK-GI-NEXT:    mov v10.h[5], w12
...
; CHECK-GI-NEXT:    mov v11.h[4], w13
; CHECK-GI-NEXT:    lsl w12, w12, #8
; CHECK-GI-NEXT:    lsl w8, w8, #8
; CHECK-GI-NEXT:    lsl w16, w16, #8
; CHECK-GI-NEXT:    ldr w13, [sp, #840]
; CHECK-GI-NEXT:    ldr w11, [sp, #848]
; CHECK-GI-NEXT:    mov v12.h[2], w15
; CHECK-GI-NEXT:    ldr w15, [sp, #872]
; CHECK-GI-NEXT:    sbfx w12, w12, #8, #8
; CHECK-GI-NEXT:    sbfx w8, w8, #8, #8
; CHECK-GI-NEXT:    sbfx w16, w16, #8, #8
; CHECK-GI-NEXT:    lsl w13, w13, #8
...
; CHECK-GI-NEXT:    lsl w15, w15, #8
; CHECK-GI-NEXT:    mov v13.h[1], w12
; CHECK-GI-NEXT:    ldr w12, [sp, #880]
; CHECK-GI-NEXT:    mov v10.h[6], w16
; CHECK-GI-NEXT:    mov v12.h[3], w14
; CHECK-GI-NEXT:    lsl w9, w9, #8
; CHECK-GI-NEXT:    ldr w14, [sp, #928]
; CHECK-GI-NEXT:    sbfx w15, w15, #8, #8
; CHECK-GI-NEXT:    lsl w12, w12, #8
; CHECK-GI-NEXT:    ldr w16, [sp, #832]
; CHECK-GI-NEXT:    mov v11.h[6], w10
; CHECK-GI-NEXT:    ldr w10, [sp, #984]
; CHECK-GI-NEXT:    sbfx w9, w9, #8, #8
; CHECK-GI-NEXT:    lsl w14, w14, #8
; CHECK-GI-NEXT:    mov v13.h[2], w15
...
; CHECK-GI-NEXT:    sbfx w10, w10, #8, #8
; CHECK-GI-NEXT:    lsl w8, w8, #8
; CHECK-GI-NEXT:    smov w9, v29.h[3]
; CHECK-GI-NEXT:    mov v13.h[3], w12
; CHECK-GI-NEXT:    ldr w12, [sp, #1000]
; CHECK-GI-NEXT:    lsl w16, w16, #8
; CHECK-GI-NEXT:    mov v14.h[1], w14
; CHECK-GI-NEXT:    smov w14, v29.h[7]
...
; CHECK-GI-NEXT:    lsl w12, w12, #8
; CHECK-GI-NEXT:    sbfx w13, w13, #8, #8
; CHECK-GI-NEXT:    mov v29.h[1], w8
; CHECK-GI-NEXT:    ldr w8, [sp, #944]
; CHECK-GI-NEXT:    lsl w10, w10, #8
; CHECK-GI-NEXT:    sbfx w15, w15, #8, #8
; CHECK-GI-NEXT:    mov v12.h[5], w16
; CHECK-GI-NEXT:    ldr w16, [sp, #1008]
; CHECK-GI-NEXT:    sbfx w12, w12, #8, #8
; CHECK-GI-NEXT:    sbfx w10, w10, #8, #8
; CHECK-GI-NEXT:    lsl w8, w8, #8
; CHECK-GI-NEXT:    mov v14.h[2], w15
; CHECK-GI-NEXT:    ldr w15, [sp, #896]
; CHECK-GI-NEXT:    lsl w16, w16, #8
; CHECK-GI-NEXT:    mov v29.h[2], w12
; CHECK-GI-NEXT:    sbfx w8, w8, #8, #8
; CHECK-GI-NEXT:    mov v13.h[4], w10
; CHECK-GI-NEXT:    ldr w10, [sp, #952]
; CHECK-GI-NEXT:    sbfx w16, w16, #8, #8
; CHECK-GI-NEXT:    lsl w15, w15, #8
; CHECK-GI-NEXT:    ldr w12, [sp, #904]
; CHECK-GI-NEXT:    mov v12.h[6], w13
; CHECK-GI-NEXT:    ldr w13, [sp, #960]
; CHECK-GI-NEXT:    mov v14.h[3], w8
; CHECK-GI-NEXT:    ldr w8, [sp, #1016]
; CHECK-GI-NEXT:    lsl w10, w10, #8
...
; CHECK-GI-NEXT:    lsl w12, w12, #8
; CHECK-GI-NEXT:    sbfx w10, w10, #8, #8
; CHECK-GI-NEXT:    mov v29.h[5], w13
; CHECK-GI-NEXT:    mov v12.h[7], w11
; CHECK-GI-NEXT:    ldr w11, [sp, #712]
; CHECK-GI-NEXT:    mov v13.h[7], w15
...
; CHECK-GI-NEXT:    lsl w11, w11, #8
; CHECK-GI-NEXT:    smov w8, v31.h[3]
; CHECK-GI-NEXT:    smov w16, v31.h[6]
; CHECK-GI-NEXT:    mov v29.h[6], w12
; CHECK-GI-NEXT:    lsl w12, w13, #8
; CHECK-GI-NEXT:    mul v8.8h, v8.8h, v12.8h
; CHECK-GI-NEXT:    lsl w10, w10, #8
; CHECK-GI-NEXT:    lsl w13, w15, #8
; CHECK-GI-NEXT:    sbfx w11, w11, #8, #8
; CHECK-GI-NEXT:    sbfx w12, w12, #8, #8
; CHECK-GI-NEXT:    smov w15, v31.h[7]
; CHECK-GI-NEXT:    mul v31.8h, v9.8h, v13.8h
; CHECK-GI-NEXT:    sbfx w10, w10, #8, #8
; CHECK-GI-NEXT:    sbfx w13, w13, #8, #8
; CHECK-GI-NEXT:    mov v10.h[7], w11
; CHECK-GI-NEXT:    mov v11.h[7], w12
; CHECK-GI-NEXT:    smov w11, v8.h[4]
; CHECK-GI-NEXT:    mov v26.s[3], w9
; CHECK-GI-NEXT:    mov v14.h[7], w10
; CHECK-GI-NEXT:    mov v29.h[7], w13
; CHECK-GI-NEXT:    smov w10, v8.h[0]
; CHECK-GI-NEXT:    smov w9, v8.h[1]
; CHECK-GI-NEXT:    smov w12, v8.h[5]
; CHECK-GI-NEXT:    smov w13, v31.h[0]
; CHECK-GI-NEXT:    mov v28.s[3], w8
; CHECK-GI-NEXT:    smov w8, v31.h[1]
; CHECK-GI-NEXT:    mov v30.s[2], w16
; CHECK-GI-NEXT:    mov v27.s[3], w14
; CHECK-GI-NEXT:    mov v16.s[1], wzr
; CHECK-GI-NEXT:    mov v18.s[1], wzr
; CHECK-GI-NEXT:    mul v9.8h, v10.8h, v14.8h
; CHECK-GI-NEXT:    mul v29.8h, v11.8h, v29.8h
; CHECK-GI-NEXT:    fmov s10, w10
; CHECK-GI-NEXT:    fmov s11, w11
; CHECK-GI-NEXT:    fmov s12, w13
; CHECK-GI-NEXT:    smov w10, v8.h[2]
; CHECK-GI-NEXT:    smov w11, v31.h[2]
; CHECK-GI-NEXT:    mov v30.s[3], w15
; CHECK-GI-NEXT:    smov w15, v31.h[5]
; CHECK-GI-NEXT:    mov v10.s[1], w9
; CHECK-GI-NEXT:    smov w9, v8.h[6]
; CHECK-GI-NEXT:    smov w13, v8.h[7]
; CHECK-GI-NEXT:    mov v11.s[1], w12
; CHECK-GI-NEXT:    mov v12.s[1], w8
; CHECK-GI-NEXT:    smov w12, v31.h[4]
; CHECK-GI-NEXT:    smov w14, v9.h[0]
; CHECK-GI-NEXT:    smov w8, v8.h[3]
; CHECK-GI-NEXT:    smov w16, v9.h[1]
; CHECK-GI-NEXT:    mov v17.s[1], wzr
; CHECK-GI-NEXT:    mov v20.s[1], wzr
; CHECK-GI-NEXT:    mov v6.s[1], wzr
; CHECK-GI-NEXT:    mov v10.s[2], w10
; CHECK-GI-NEXT:    smov w10, v31.h[3]
; CHECK-GI-NEXT:    mov v7.s[1], wzr
; CHECK-GI-NEXT:    mov v11.s[2], w9
; CHECK-GI-NEXT:    smov w9, v9.h[4]
; CHECK-GI-NEXT:    mov v12.s[2], w11
; CHECK-GI-NEXT:    smov w11, v9.h[5]
; CHECK-GI-NEXT:    fmov s8, w12
; CHECK-GI-NEXT:    fmov s13, w14
; CHECK-GI-NEXT:    smov w12, v31.h[6]
; CHECK-GI-NEXT:    smov w14, v9.h[2]
; CHECK-GI-NEXT:    mov v2.s[1], wzr
; CHECK-GI-NEXT:    mov v10.s[3], w8
; CHECK-GI-NEXT:    smov w8, v29.h[4]
; CHECK-GI-NEXT:    mov v4.s[1], wzr
; CHECK-GI-NEXT:    fmov s14, w9
; CHECK-GI-NEXT:    mov v8.s[1], w15
; CHECK-GI-NEXT:    smov w15, v9.h[6]
; CHECK-GI-NEXT:    mov v13.s[1], w16
; CHECK-GI-NEXT:    smov w16, v29.h[0]
; CHECK-GI-NEXT:    smov w9, v29.h[1]
; CHECK-GI-NEXT:    mov v12.s[3], w10
; CHECK-GI-NEXT:    ldr w10, [sp, #520]
; CHECK-GI-NEXT:    mov v11.s[3], w13
; CHECK-GI-NEXT:    mov v14.s[1], w11
; CHECK-GI-NEXT:    ldr w11, [sp, #256]
; CHECK-GI-NEXT:    smov w13, v29.h[5]
; CHECK-GI-NEXT:    mov v8.s[2], w12
; CHECK-GI-NEXT:    ldr w12, [sp, #784]
; CHECK-GI-NEXT:    sxtb w10, w10
; CHECK-GI-NEXT:    mov v13.s[2], w14
; CHECK-GI-NEXT:    smov w14, v31.h[7]
; CHECK-GI-NEXT:    fmov s31, w16
; CHECK-GI-NEXT:    smov w16, v9.h[7]
; CHECK-GI-NEXT:    sxtb w11, w11
; CHECK-GI-NEXT:    sxtb w12, w12
; CHECK-GI-NEXT:    mov v14.s[2], w15
; CHECK-GI-NEXT:    smov w15, v9.h[3]
; CHECK-GI-NEXT:    fmov s9, w8
; CHECK-GI-NEXT:    ldr w8, [sp, #1048]
; CHECK-GI-NEXT:    mov v31.s[1], w9
; CHECK-GI-NEXT:    smov w9, v29.h[2]
; CHECK-GI-NEXT:    mov v3.s[1], wzr
; CHECK-GI-NEXT:    mov v5.s[1], wzr
; CHECK-GI-NEXT:    mul w10, w11, w10
; CHECK-GI-NEXT:    sxtb w8, w8
; CHECK-GI-NEXT:    mov v9.s[1], w13
; CHECK-GI-NEXT:    smov w13, v29.h[6]
; CHECK-GI-NEXT:    mov v1.s[1], wzr
; CHECK-GI-NEXT:    mov v0.s[1], wzr
; CHECK-GI-NEXT:    mov v19.s[2], wzr
; CHECK-GI-NEXT:    mul w8, w12, w8
; CHECK-GI-NEXT:    mov v31.s[2], w9
; CHECK-GI-NEXT:    sxth w9, w10
...
; CHECK-GI-NEXT:    add v24.4s, v26.4s, v27.4s
; CHECK-GI-NEXT:    fmov s26, w9
; CHECK-GI-NEXT:    fmov s27, w8
; CHECK-GI-NEXT:    mov v9.s[2], w13
; CHECK-GI-NEXT:    smov w9, v29.h[3]
; CHECK-GI-NEXT:    smov w8, v29.h[7]
; CHECK-GI-NEXT:    mov v1.s[2], wzr
; CHECK-GI-NEXT:    mov v0.s[2], wzr
; CHECK-GI-NEXT:    mov v19.s[3], wzr
...
; CHECK-GI-NEXT:    mov v8.s[3], w14
; CHECK-GI-NEXT:    mov v13.s[3], w15
; CHECK-GI-NEXT:    mov v14.s[3], w16
; CHECK-GI-NEXT:    mov v1.s[3], wzr
; CHECK-GI-NEXT:    mov v31.s[3], w9
; CHECK-GI-NEXT:    mov v9.s[3], w8
; CHECK-GI-NEXT:    mov v0.s[3], wzr
...
; CHECK-GI-NEXT:    fmov w9, s0
; CHECK-GI-NEXT:    add w0, w8, w9
; CHECK-GI-NEXT:    ldr d14, [sp], #64 // 8-byte Folded Reload
; CHECK-GI-NEXT:    ret
entry:
...
; CHECK-GI-NEXT:    movi d0, #0000000000000000
; CHECK-GI-NEXT:    movi d1, #0000000000000000
; CHECK-GI-NEXT:    mov v28.s[2], w12
; CHECK-GI-NEXT:    ldr w12, [sp, #216]
...
; CHECK-GI-NEXT:    ldr w12, [sp, #576]
; CHECK-GI-NEXT:    fmov s8, w11
; CHECK-GI-NEXT:    fmov s9, w8
; CHECK-GI-NEXT:    ldr w11, [sp, #624]
; CHECK-GI-NEXT:    sxtb w9, w9
; CHECK-GI-NEXT:    sxtb w10, w10
; CHECK-GI-NEXT:    sxtb w12, w12
; CHECK-GI-NEXT:    ldr w8, [sp, #584]
; CHECK-GI-NEXT:    sxtb w11, w11
; CHECK-GI-NEXT:    movi d2, #0000000000000000
; CHECK-GI-NEXT:    movi d4, #0000000000000000
; CHECK-GI-NEXT:    mov v9.s[1], w9
; CHECK-GI-NEXT:    ldr w9, [sp, #608]
; CHECK-GI-NEXT:    mov v30.s[3], w10
; CHECK-GI-NEXT:    ldr w10, [sp, #632]
; CHECK-GI-NEXT:    mov v31.s[2], w12
...
; CHECK-GI-NEXT:    add v6.4s, v18.4s, v16.4s
...
; CHECK-SD-NEXT:    ld1 { v3.b }[12], [x11]
; CHECK-SD-NEXT:    add x11, sp, #416
; CHECK-SD-NEXT:    ld1 { v6.b }[12], [x10]
...
; CHECK-SD-NEXT:    ld1 { v1.b }[11], [x9]
; CHECK-SD-NEXT:    add x9, sp, #1424
; CHECK-SD-NEXT:    add x8, sp, #520
; CHECK-SD-NEXT:    ld1 { v7.b }[8], [x9]
; CHECK-SD-NEXT:    ld1 { v2.b }[7], [x8]
; CHECK-SD-NEXT:    add x8, sp, #1040
; CHECK-SD-NEXT:    add x9, sp, #48
; CHECK-SD-NEXT:    ld1 { v16.b }[8], [x8]
; CHECK-SD-NEXT:    add x10, sp, #528
; CHECK-SD-NEXT:    ld1 { v1.b }[12], [x9]
; CHECK-SD-NEXT:    add x9, sp, #1432
...
; CHECK-GI-NEXT:    ldr w11, [sp, #1360]
; CHECK-GI-NEXT:    mov v16.b[1], w8
; CHECK-GI-NEXT:    ldr w8, [sp, #984]
; CHECK-GI-NEXT:    mov v6.b[15], w10
; CHECK-GI-NEXT:    fmov s17, w9
; CHECK-GI-NEXT:    ldr w9, [sp, #1104]
; CHECK-GI-NEXT:    ldr w10, [sp, #856]
; CHECK-GI-NEXT:    mov v18.b[1], w8
...
; CHECK-GI-NEXT:    mov v20.b[3], w10
; CHECK-GI-NEXT:    ldr w10, [sp, #1008]
; CHECK-GI-NEXT:    mov v21.b[3], w9
...
; CHECK-GI-NEXT:    mov v20.b[13], w10
; CHECK-GI-NEXT:    ldr w10, [sp, #1088]
; CHECK-GI-NEXT:    mov v21.b[13], w9
...
; CHECK-GI-NEXT:    ldr w10, [sp, #1472]
; CHECK-GI-NEXT:    ldr w11, [sp, #840]
; CHECK-GI-NEXT:    mov v19.b[14], w8
; CHECK-GI-NEXT:    ldr w8, [sp, #968]
; CHECK-GI-NEXT:    mov v20.b[14], w9
; CHECK-GI-NEXT:    mov v21.b[14], w10
...
; CHECK-GI-NEXT:    mov v18.b[15], w9
; CHECK-GI-NEXT:    sdot v23.4s, v3.16b, v6.16b
; CHECK-GI-NEXT:    mov v19.b[15], w10
