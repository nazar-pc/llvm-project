...
; CHECK-i32-SD-NEXT:    mov h24, v6.h[3]
; CHECK-i32-SD-NEXT:    fcvt s4, h4
; CHECK-i32-SD-NEXT:    fcvt s5, h5
; CHECK-i32-SD-NEXT:    fcvt s6, h6
...
; CHECK-i32-SD-NEXT:    fcvtzs w9, s16
; CHECK-i32-SD-NEXT:    fcvtzs w8, s17
; CHECK-i32-SD-NEXT:    fcvtzs w12, s18
; CHECK-i32-SD-NEXT:    mov h16, v0.h[1]
; CHECK-i32-SD-NEXT:    mov h17, v0.h[2]
; CHECK-i32-SD-NEXT:    fcvtzs w13, s20
; CHECK-i32-SD-NEXT:    mov h18, v0.h[3]
; CHECK-i32-SD-NEXT:    fcvt s20, h24
...
; CHECK-i32-SD-NEXT:    frintx s18, s18
; CHECK-i32-SD-NEXT:    fcvtzs w16, s20
; CHECK-i32-SD-NEXT:    fcvt s20, h26
; CHECK-i32-SD-NEXT:    fcvt s23, h23
; CHECK-i32-SD-NEXT:    frintx s19, s19
; CHECK-i32-SD-NEXT:    fcvt s26, h27
; CHECK-i32-SD-NEXT:    fcvtzs w17, s21
; CHECK-i32-SD-NEXT:    fcvt s0, h0
; CHECK-i32-SD-NEXT:    fcvtzs w18, s22
; CHECK-i32-SD-NEXT:    fcvtzs w0, s16
; CHECK-i32-SD-NEXT:    fcvtzs w1, s17
; CHECK-i32-SD-NEXT:    frintx s16, s24
; CHECK-i32-SD-NEXT:    fcvtzs w2, s18
; CHECK-i32-SD-NEXT:    frintx s17, s25
; CHECK-i32-SD-NEXT:    frintx s18, s20
; CHECK-i32-SD-NEXT:    frintx s21, s23
; CHECK-i32-SD-NEXT:    fcvtzs w3, s19
; CHECK-i32-SD-NEXT:    frintx s19, s26
; CHECK-i32-SD-NEXT:    fcvt s20, h7
; CHECK-i32-SD-NEXT:    frintx s0, s0
; CHECK-i32-SD-NEXT:    mov h22, v3.h[3]
; CHECK-i32-SD-NEXT:    fcvtzs w5, s16
; CHECK-i32-SD-NEXT:    fcvt s16, h1
; CHECK-i32-SD-NEXT:    fcvtzs w6, s17
; CHECK-i32-SD-NEXT:    fcvt s17, h2
; CHECK-i32-SD-NEXT:    fcvtzs w7, s18
; CHECK-i32-SD-NEXT:    fcvt s18, h3
...
; CHECK-i32-SD-NEXT:    fcvtzs s2, s16
; CHECK-i32-SD-NEXT:    fcvt s16, h21
; CHECK-i32-SD-NEXT:    mov v1.s[1], w11
; CHECK-i32-SD-NEXT:    fcvtzs s4, s17
; CHECK-i32-SD-NEXT:    fcvt s17, h22
; CHECK-i32-SD-NEXT:    mov v3.s[1], w12
; CHECK-i32-SD-NEXT:    fcvtzs s6, s18
...
; CHECK-i32-SD-NEXT:    mov v7.s[1], w17
...
; CHECK-i32-SD-NEXT:    mov v0.s[2], w1
...
; CHECK-i64-SD-NEXT:    fcvtzs x10, s19
; CHECK-i64-SD-NEXT:    mov h19, v3.h[2]
; CHECK-i64-SD-NEXT:    mov h25, v7.h[1]
...
; CHECK-i64-SD-NEXT:    fcvt s23, h28
; CHECK-i64-SD-NEXT:    fcvtzs x15, s24
; CHECK-i64-SD-NEXT:    mov h24, v3.h[3]
; CHECK-i64-SD-NEXT:    fcvtzs x14, s17
...
; CHECK-i64-SD-NEXT:    mov h19, v7.h[2]
...
; CHECK-i64-SD-NEXT:    fcvtzs x15, s24
; CHECK-i64-SD-NEXT:    mov h24, v6.h[3]
...
; CHECK-i64-SD-NEXT:    frintx s0, s0
; CHECK-i64-SD-NEXT:    fcvt s24, h24
; CHECK-i64-SD-NEXT:    fcvt s19, h19
; CHECK-i64-SD-NEXT:    fcvt s7, h7
...
; CHECK-i64-SD-NEXT:    fcvt s21, h21
; CHECK-i64-SD-NEXT:    fcvt s5, h5
; CHECK-i64-SD-NEXT:    mov v23.d[1], x13
; CHECK-i64-SD-NEXT:    mov v26.d[1], x14
; CHECK-i64-SD-NEXT:    fcvt s4, h4
; CHECK-i64-SD-NEXT:    frintx s22, s24
...
; CHECK-i64-SD-NEXT:    stp q26, q23, [x8, #64]
; CHECK-i64-SD-NEXT:    fmov d23, x15
; CHECK-i64-SD-NEXT:    frintx s4, s4
