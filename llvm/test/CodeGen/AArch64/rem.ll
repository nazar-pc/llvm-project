...
; CHECK-SD-NEXT:    str w8, [sp, #80] // 4-byte Spill
; CHECK-SD-NEXT:    sdiv w10, w9, w8
; CHECK-SD-NEXT:    smov w8, v2.b[0]
; CHECK-SD-NEXT:    str w9, [sp, #88] // 4-byte Spill
; CHECK-SD-NEXT:    smov w9, v0.b[0]
; CHECK-SD-NEXT:    ldr w30, [sp, #80] // 4-byte Reload
...
; CHECK-SD-NEXT:    str w8, [sp, #32] // 4-byte Spill
; CHECK-SD-NEXT:    smov w21, v3.b[9]
; CHECK-SD-NEXT:    smov w20, v1.b[9]
; CHECK-SD-NEXT:    str w9, [sp, #40] // 4-byte Spill
; CHECK-SD-NEXT:    ldr w29, [sp, #32] // 4-byte Reload
; CHECK-SD-NEXT:    sdiv w11, w9, w8
; CHECK-SD-NEXT:    smov w8, v2.b[2]
; CHECK-SD-NEXT:    smov w9, v0.b[2]
; CHECK-SD-NEXT:    str w10, [sp, #96] // 4-byte Spill
...
; CHECK-SD-NEXT:    str w10, [sp, #24] // 4-byte Spill
; CHECK-SD-NEXT:    sdiv w10, w9, w8
; CHECK-SD-NEXT:    smov w8, v2.b[4]
; CHECK-SD-NEXT:    str w8, [sp, #28] // 4-byte Spill
; CHECK-SD-NEXT:    stp w9, w10, [sp, #56] // 8-byte Folded Spill
; CHECK-SD-NEXT:    smov w9, v0.b[4]
; CHECK-SD-NEXT:    sdiv w28, w0, w5
; CHECK-SD-NEXT:    str w9, [sp, #36] // 4-byte Spill
; CHECK-SD-NEXT:    sdiv w10, w9, w8
; CHECK-SD-NEXT:    smov w8, v2.b[5]
; CHECK-SD-NEXT:    smov w9, v0.b[5]
; CHECK-SD-NEXT:    str w8, [sp, #76] // 4-byte Spill
; CHECK-SD-NEXT:    str w9, [sp, #84] // 4-byte Spill
; CHECK-SD-NEXT:    str w10, [sp, #44] // 4-byte Spill
; CHECK-SD-NEXT:    sdiv w10, w9, w8
; CHECK-SD-NEXT:    smov w8, v2.b[6]
; CHECK-SD-NEXT:    smov w9, v0.b[6]
; CHECK-SD-NEXT:    stp w8, w9, [sp, #64] // 8-byte Folded Spill
; CHECK-SD-NEXT:    str w10, [sp, #92] // 4-byte Spill
; CHECK-SD-NEXT:    sdiv w10, w9, w8
...
; CHECK-SD-NEXT:    str w10, [sp, #72] // 4-byte Spill
...
; CHECK-SD-NEXT:    str w8, [sp, #152] // 4-byte Spill
; CHECK-SD-NEXT:    str w9, [sp, #160] // 4-byte Spill
; CHECK-SD-NEXT:    sdiv w10, w9, w8
; CHECK-SD-NEXT:    smov w8, v2.b[13]
; CHECK-SD-NEXT:    smov w9, v0.b[13]
; CHECK-SD-NEXT:    stp w8, w9, [sp, #196] // 8-byte Folded Spill
; CHECK-SD-NEXT:    str w10, [sp, #168] // 4-byte Spill
; CHECK-SD-NEXT:    sdiv w10, w9, w8
...
; CHECK-SD-NEXT:    str w10, [sp, #204] // 4-byte Spill
; CHECK-SD-NEXT:    sdiv w10, w9, w8
; CHECK-SD-NEXT:    smov w8, v2.b[15]
; CHECK-SD-NEXT:    str w8, [sp, #148] // 4-byte Spill
; CHECK-SD-NEXT:    stp w9, w10, [sp, #188] // 8-byte Folded Spill
; CHECK-SD-NEXT:    smov w9, v0.b[15]
; CHECK-SD-NEXT:    sdiv w23, w11, w12
; CHECK-SD-NEXT:    str w9, [sp, #156] // 4-byte Spill
; CHECK-SD-NEXT:    sdiv w10, w9, w8
; CHECK-SD-NEXT:    str w10, [sp, #164] // 4-byte Spill
; CHECK-SD-NEXT:    smov w10, v1.b[0]
; CHECK-SD-NEXT:    sdiv w9, w7, w19
; CHECK-SD-NEXT:    sdiv w8, w3, w6
; CHECK-SD-NEXT:    sdiv w22, w10, w13
; CHECK-SD-NEXT:    stp w8, w9, [sp, #8] // 8-byte Folded Spill
; CHECK-SD-NEXT:    ldr w8, [sp, #96] // 4-byte Reload
; CHECK-SD-NEXT:    ldr w9, [sp, #88] // 4-byte Reload
; CHECK-SD-NEXT:    msub w9, w8, w30, w9
; CHECK-SD-NEXT:    ldr w8, [sp, #48] // 4-byte Reload
; CHECK-SD-NEXT:    ldr w30, [sp, #40] // 4-byte Reload
; CHECK-SD-NEXT:    msub w8, w8, w29, w30
; CHECK-SD-NEXT:    ldp x29, x30, [sp, #208] // 16-byte Folded Reload
; CHECK-SD-NEXT:    fmov s0, w8
; CHECK-SD-NEXT:    msub w10, w22, w13, w10
; CHECK-SD-NEXT:    sdiv w24, w14, w15
; CHECK-SD-NEXT:    msub w13, w28, w5, w0
; CHECK-SD-NEXT:    ldr w5, [sp, #16] // 4-byte Reload
; CHECK-SD-NEXT:    mov v0.b[1], w9
; CHECK-SD-NEXT:    msub w9, w23, w12, w11
...
; CHECK-SD-NEXT:    ldr w5, [sp, #52] // 4-byte Reload
; CHECK-SD-NEXT:    smov w10, v3.b[10]
; CHECK-SD-NEXT:    sdiv w27, w1, w4
...
; CHECK-SD-NEXT:    ldr w17, [sp, #28] // 4-byte Reload
; CHECK-SD-NEXT:    ldr w16, [sp, #36] // 4-byte Reload
; CHECK-SD-NEXT:    msub w12, w12, w5, w13
; CHECK-SD-NEXT:    ldr w13, [sp, #44] // 4-byte Reload
; CHECK-SD-NEXT:    ldr w5, [sp, #136] // 4-byte Reload
; CHECK-SD-NEXT:    mov v2.b[3], w8
; CHECK-SD-NEXT:    msub w8, w24, w15, w14
; CHECK-SD-NEXT:    ldr w15, [sp, #92] // 4-byte Reload
; CHECK-SD-NEXT:    mov v0.b[3], w12
; CHECK-SD-NEXT:    msub w13, w13, w17, w16
; CHECK-SD-NEXT:    ldr w17, [sp, #76] // 4-byte Reload
; CHECK-SD-NEXT:    sdiv w26, w18, w2
; CHECK-SD-NEXT:    ldr w16, [sp, #84] // 4-byte Reload
; CHECK-SD-NEXT:    smov w12, v3.b[11]
; CHECK-SD-NEXT:    msub w15, w15, w17, w16
; CHECK-SD-NEXT:    smov w14, v1.b[11]
; CHECK-SD-NEXT:    mov v2.b[4], w8
; CHECK-SD-NEXT:    msub w8, w27, w4, w1
; CHECK-SD-NEXT:    ldr w1, [sp, #64] // 4-byte Reload
; CHECK-SD-NEXT:    mov v0.b[4], w13
; CHECK-SD-NEXT:    ldr w4, [sp, #100] // 4-byte Reload
...
; CHECK-SD-NEXT:    ldr w2, [sp, #112] // 4-byte Reload
...
; CHECK-SD-NEXT:    mov v2.b[6], w8
; CHECK-SD-NEXT:    ldr w8, [sp, #12] // 4-byte Reload
...
; CHECK-SD-NEXT:    mov v2.b[7], w8
; CHECK-SD-NEXT:    ldr w8, [sp, #8] // 4-byte Reload
...
; CHECK-SD-NEXT:    ldr w5, [sp, #124] // 4-byte Reload
...
; CHECK-SD-NEXT:    ldr w4, [sp, #172] // 4-byte Reload
...
; CHECK-SD-NEXT:    ldr w1, [sp, #152] // 4-byte Reload
; CHECK-SD-NEXT:    msub w11, w11, w4, w3
; CHECK-SD-NEXT:    sdiv w16, w17, w15
; CHECK-SD-NEXT:    msub w8, w13, w12, w14
; CHECK-SD-NEXT:    ldr w13, [sp, #168] // 4-byte Reload
; CHECK-SD-NEXT:    ldr w14, [sp, #160] // 4-byte Reload
...
; CHECK-SD-NEXT:    ldr w17, [sp, #196] // 4-byte Reload
...
; CHECK-SD-NEXT:    ldr w18, [sp, #184] // 4-byte Reload
...
; CHECK-SD-NEXT:    ldr w9, [sp, #164] // 4-byte Reload
; CHECK-SD-NEXT:    ldr w12, [sp, #148] // 4-byte Reload
; CHECK-SD-NEXT:    ldr w10, [sp, #156] // 4-byte Reload
; CHECK-SD-NEXT:    mov v2.b[14], w8
...
; CHECK-GI-NEXT:    mov w22, v17.s[1]
; CHECK-GI-NEXT:    mov w23, v17.s[2]
; CHECK-GI-NEXT:    mov w24, v17.s[3]
...
; CHECK-GI-NEXT:    sdiv w13, w12, w13
; CHECK-GI-NEXT:    mov w12, v4.s[1]
; CHECK-GI-NEXT:    str w8, [sp, #12] // 4-byte Spill
; CHECK-GI-NEXT:    ldr w11, [sp, #12] // 4-byte Reload
...
; CHECK-GI-NEXT:    sdiv w22, w7, w22
; CHECK-GI-NEXT:    mov w7, v16.s[2]
; CHECK-GI-NEXT:    fmov s25, w21
; CHECK-GI-NEXT:    sdiv w23, w7, w23
...
; CHECK-GI-NEXT:    sdiv w7, w7, w24
; CHECK-GI-NEXT:    fmov w24, s18
; CHECK-GI-NEXT:    mov v25.s[2], w23
...
; CHECK-GI-NEXT:    udiv w8, w8, w9
; CHECK-GI-NEXT:    mov w9, v3.s[1]
; CHECK-GI-NEXT:    udiv w9, w10, w9
; CHECK-GI-NEXT:    mov w10, v3.s[2]
; CHECK-GI-NEXT:    udiv w10, w11, w10
; CHECK-GI-NEXT:    mov w11, v3.s[3]
; CHECK-GI-NEXT:    ushll2 v3.4s, v1.8h, #0
; CHECK-GI-NEXT:    fmov w13, s3
; CHECK-GI-NEXT:    udiv w11, w12, w11
; CHECK-GI-NEXT:    fmov w12, s2
; CHECK-GI-NEXT:    udiv w12, w12, w13
; CHECK-GI-NEXT:    mov w13, v3.s[1]
; CHECK-GI-NEXT:    udiv w13, w14, w13
; CHECK-GI-NEXT:    mov w14, v3.s[2]
; CHECK-GI-NEXT:    fmov s4, w12
; CHECK-GI-NEXT:    udiv w14, w15, w14
; CHECK-GI-NEXT:    mov w15, v3.s[3]
; CHECK-GI-NEXT:    fmov s3, w8
; CHECK-GI-NEXT:    mov v4.h[1], w13
; CHECK-GI-NEXT:    mov v3.h[1], w9
; CHECK-GI-NEXT:    mov v3.h[2], w10
; CHECK-GI-NEXT:    udiv w8, w16, w15
; CHECK-GI-NEXT:    mov v4.h[2], w14
; CHECK-GI-NEXT:    mov v3.h[3], w11
; CHECK-GI-NEXT:    umlsl v0.4s, v3.4h, v1.4h
; CHECK-GI-NEXT:    mov v4.h[3], w8
; CHECK-GI-NEXT:    umlsl v2.4s, v4.4h, v5.4h
...
; CHECK-GI-NEXT:    mov w16, v4.s[3]
; CHECK-GI-NEXT:    fmov w17, s6
; CHECK-GI-NEXT:    udiv w10, w8, w9
; CHECK-GI-NEXT:    mov w8, v5.s[1]
; CHECK-GI-NEXT:    mov w9, v2.s[1]
; CHECK-GI-NEXT:    udiv w11, w9, w8
; CHECK-GI-NEXT:    mov w8, v5.s[2]
; CHECK-GI-NEXT:    mov w9, v2.s[2]
; CHECK-GI-NEXT:    udiv w9, w9, w8
; CHECK-GI-NEXT:    mov w8, v5.s[3]
; CHECK-GI-NEXT:    ushll2 v5.4s, v3.8h, #0
; CHECK-GI-NEXT:    fmov w13, s5
; CHECK-GI-NEXT:    udiv w8, w12, w8
; CHECK-GI-NEXT:    fmov w12, s4
; CHECK-GI-NEXT:    udiv w14, w12, w13
; CHECK-GI-NEXT:    mov w12, v5.s[1]
; CHECK-GI-NEXT:    mov w13, v4.s[1]
; CHECK-GI-NEXT:    udiv w15, w13, w12
; CHECK-GI-NEXT:    mov w12, v5.s[2]
; CHECK-GI-NEXT:    mov w13, v4.s[2]
; CHECK-GI-NEXT:    fmov s7, w14
; CHECK-GI-NEXT:    udiv w13, w13, w12
; CHECK-GI-NEXT:    mov w12, v5.s[3]
; CHECK-GI-NEXT:    ushll2 v5.8h, v0.16b, #0
; CHECK-GI-NEXT:    mov v7.h[1], w15
; CHECK-GI-NEXT:    ushll v0.4s, v5.4h, #0
; CHECK-GI-NEXT:    ushll2 v5.4s, v5.8h, #0
; CHECK-GI-NEXT:    mov w18, v0.s[1]
; CHECK-GI-NEXT:    mov w0, v0.s[2]
; CHECK-GI-NEXT:    mov w1, v0.s[3]
; CHECK-GI-NEXT:    mov w3, v5.s[1]
; CHECK-GI-NEXT:    mov w4, v5.s[2]
; CHECK-GI-NEXT:    mov w5, v5.s[3]
; CHECK-GI-NEXT:    udiv w12, w16, w12
; CHECK-GI-NEXT:    fmov w16, s0
; CHECK-GI-NEXT:    mov v7.h[2], w13
; CHECK-GI-NEXT:    udiv w16, w16, w17
; CHECK-GI-NEXT:    mov w17, v6.s[1]
; CHECK-GI-NEXT:    mov v7.h[3], w12
; CHECK-GI-NEXT:    umlsl v4.4s, v7.4h, v18.4h
; CHECK-GI-NEXT:    udiv w17, w18, w17
; CHECK-GI-NEXT:    mov w18, v6.s[2]
; CHECK-GI-NEXT:    fmov s16, w16
; CHECK-GI-NEXT:    udiv w18, w0, w18
; CHECK-GI-NEXT:    mov w0, v6.s[3]
; CHECK-GI-NEXT:    ushll2 v6.4s, v1.8h, #0
; CHECK-GI-NEXT:    mov v16.h[1], w17
; CHECK-GI-NEXT:    fmov w2, s6
; CHECK-GI-NEXT:    udiv w0, w1, w0
; CHECK-GI-NEXT:    fmov w1, s5
; CHECK-GI-NEXT:    mov v16.h[2], w18
; CHECK-GI-NEXT:    udiv w1, w1, w2
; CHECK-GI-NEXT:    mov w2, v6.s[1]
; CHECK-GI-NEXT:    mov v16.h[3], w0
; CHECK-GI-NEXT:    umlsl v0.4s, v16.4h, v1.4h
; CHECK-GI-NEXT:    udiv w2, w3, w2
; CHECK-GI-NEXT:    mov w3, v6.s[2]
; CHECK-GI-NEXT:    fmov s17, w1
; CHECK-GI-NEXT:    udiv w3, w4, w3
; CHECK-GI-NEXT:    mov w4, v6.s[3]
; CHECK-GI-NEXT:    fmov s6, w10
; CHECK-GI-NEXT:    mov v17.h[1], w2
; CHECK-GI-NEXT:    mov v6.h[1], w11
; CHECK-GI-NEXT:    mov v6.h[2], w9
; CHECK-GI-NEXT:    udiv w10, w5, w4
; CHECK-GI-NEXT:    mov v17.h[2], w3
; CHECK-GI-NEXT:    mov v6.h[3], w8
; CHECK-GI-NEXT:    umlsl v2.4s, v6.4h, v3.4h
; CHECK-GI-NEXT:    mov v17.h[3], w10
; CHECK-GI-NEXT:    uzp1 v1.8h, v2.8h, v4.8h
; CHECK-GI-NEXT:    umlsl v5.4s, v17.4h, v19.4h
; CHECK-GI-NEXT:    uzp1 v0.8h, v0.8h, v5.8h
; CHECK-GI-NEXT:    uzp1 v0.16b, v1.16b, v0.16b
; CHECK-GI-NEXT:    ret
entry:
  %s = urem <16 x i8> %d, %e
...
; CHECK-SD-NEXT:    udiv w23, w11, w12
; CHECK-SD-NEXT:    str w9, [sp, #156] // 4-byte Spill
; CHECK-SD-NEXT:    udiv w10, w9, w8
; CHECK-SD-NEXT:    str w10, [sp, #164] // 4-byte Spill
...
; CHECK-SD-NEXT:    udiv w22, w10, w13
; CHECK-SD-NEXT:    stp w8, w9, [sp, #8] // 8-byte Folded Spill
; CHECK-SD-NEXT:    ldr w8, [sp, #96] // 4-byte Reload
; CHECK-SD-NEXT:    ldr w9, [sp, #88] // 4-byte Reload
; CHECK-SD-NEXT:    msub w9, w8, w30, w9
...
; CHECK-GI-NEXT:    ushll v16.8h, v3.8b, #0
...
; CHECK-GI-NEXT:    fmov w8, s6
; CHECK-GI-NEXT:    fmov w9, s7
; CHECK-GI-NEXT:    mov w10, v7.s[1]
; CHECK-GI-NEXT:    mov w12, v7.s[3]
; CHECK-GI-NEXT:    fmov w13, s5
; CHECK-GI-NEXT:    mov w16, v5.s[3]
; CHECK-GI-NEXT:    fmov w6, s18
; CHECK-GI-NEXT:    mov w7, v18.s[3]
; CHECK-GI-NEXT:    fmov w21, s16
; CHECK-GI-NEXT:    udiv w9, w8, w9
; CHECK-GI-NEXT:    mov w8, v6.s[1]
; CHECK-GI-NEXT:    mov w24, v16.s[3]
; CHECK-GI-NEXT:    udiv w11, w8, w10
; CHECK-GI-NEXT:    mov w8, v6.s[2]
; CHECK-GI-NEXT:    mov w10, v7.s[2]
; CHECK-GI-NEXT:    fmov s19, w9
; CHECK-GI-NEXT:    udiv w10, w8, w10
; CHECK-GI-NEXT:    mov w8, v6.s[3]
; CHECK-GI-NEXT:    mov v19.h[1], w11
; CHECK-GI-NEXT:    udiv w8, w8, w12
; CHECK-GI-NEXT:    fmov w12, s4
; CHECK-GI-NEXT:    mov v19.h[2], w10
; CHECK-GI-NEXT:    udiv w14, w12, w13
; CHECK-GI-NEXT:    mov w12, v4.s[1]
; CHECK-GI-NEXT:    mov w13, v5.s[1]
; CHECK-GI-NEXT:    mov v19.h[3], w8
...
; CHECK-GI-NEXT:    ushll v6.4s, v5.4h, #0
; CHECK-GI-NEXT:    ushll v26.4s, v0.4h, #0
...
; CHECK-GI-NEXT:    mov w16, v6.s[1]
; CHECK-GI-NEXT:    mov w17, v7.s[1]
; CHECK-GI-NEXT:    mov v20.h[3], w12
; CHECK-GI-NEXT:    umlsl v0.4s, v20.4h, v28.4h
; CHECK-GI-NEXT:    udiv w1, w16, w17
; CHECK-GI-NEXT:    mov w16, v6.s[2]
; CHECK-GI-NEXT:    mov w17, v7.s[2]
; CHECK-GI-NEXT:    fmov s21, w0
; CHECK-GI-NEXT:    uzp1 v0.8h, v26.8h, v0.8h
; CHECK-GI-NEXT:    udiv w18, w16, w17
; CHECK-GI-NEXT:    mov w16, v6.s[3]
; CHECK-GI-NEXT:    mov w17, v7.s[3]
; CHECK-GI-NEXT:    ushll2 v6.4s, v5.8h, #0
; CHECK-GI-NEXT:    ushll2 v7.4s, v4.8h, #0
; CHECK-GI-NEXT:    mov v21.h[1], w1
; CHECK-GI-NEXT:    ushll v5.4s, v5.4h, #0
; CHECK-GI-NEXT:    fmov w2, s7
; CHECK-GI-NEXT:    mov w5, v6.s[3]
; CHECK-GI-NEXT:    udiv w16, w16, w17
; CHECK-GI-NEXT:    fmov w17, s6
; CHECK-GI-NEXT:    mov v21.h[2], w18
; CHECK-GI-NEXT:    udiv w3, w17, w2
; CHECK-GI-NEXT:    mov w17, v7.s[1]
; CHECK-GI-NEXT:    mov w2, v6.s[1]
; CHECK-GI-NEXT:    mov v21.h[3], w16
; CHECK-GI-NEXT:    umlsl v5.4s, v21.4h, v4.4h
; CHECK-GI-NEXT:    udiv w4, w2, w17
; CHECK-GI-NEXT:    mov w17, v7.s[2]
; CHECK-GI-NEXT:    mov w2, v6.s[2]
; CHECK-GI-NEXT:    udiv w2, w2, w17
; CHECK-GI-NEXT:    mov w17, v7.s[3]
; CHECK-GI-NEXT:    ushll v7.8h, v1.8b, #0
; CHECK-GI-NEXT:    ushll v17.4s, v7.4h, #0
; CHECK-GI-NEXT:    ushll2 v7.4s, v7.8h, #0
; CHECK-GI-NEXT:    udiv w17, w5, w17
; CHECK-GI-NEXT:    fmov w5, s17
; CHECK-GI-NEXT:    udiv w19, w5, w6
; CHECK-GI-NEXT:    mov w5, v17.s[1]
; CHECK-GI-NEXT:    mov w6, v18.s[1]
; CHECK-GI-NEXT:    udiv w20, w5, w6
; CHECK-GI-NEXT:    mov w5, v17.s[2]
; CHECK-GI-NEXT:    mov w6, v18.s[2]
; CHECK-GI-NEXT:    fmov s22, w19
; CHECK-GI-NEXT:    udiv w6, w5, w6
; CHECK-GI-NEXT:    mov w5, v17.s[3]
; CHECK-GI-NEXT:    mov v22.h[1], w20
; CHECK-GI-NEXT:    ldp x20, x19, [sp, #80] // 16-byte Folded Reload
; CHECK-GI-NEXT:    udiv w5, w5, w7
; CHECK-GI-NEXT:    fmov w7, s7
; CHECK-GI-NEXT:    mov v22.h[2], w6
; CHECK-GI-NEXT:    udiv w22, w7, w21
; CHECK-GI-NEXT:    mov w7, v7.s[1]
; CHECK-GI-NEXT:    mov w21, v16.s[1]
; CHECK-GI-NEXT:    mov v22.h[3], w5
; CHECK-GI-NEXT:    udiv w23, w7, w21
; CHECK-GI-NEXT:    mov w7, v7.s[2]
; CHECK-GI-NEXT:    mov w21, v16.s[2]
; CHECK-GI-NEXT:    ushll2 v16.8h, v1.16b, #0
; CHECK-GI-NEXT:    fmov s23, w22
; CHECK-GI-NEXT:    ushll v1.8h, v1.8b, #0
; CHECK-GI-NEXT:    ushll v17.4s, v16.4h, #0
; CHECK-GI-NEXT:    ushll v27.4s, v1.4h, #0
; CHECK-GI-NEXT:    ushll2 v1.4s, v1.8h, #0
; CHECK-GI-NEXT:    udiv w21, w7, w21
; CHECK-GI-NEXT:    mov w7, v7.s[3]
; CHECK-GI-NEXT:    ushll2 v7.8h, v3.16b, #0
...
; CHECK-GI-NEXT:    mov w26, v18.s[1]
; CHECK-GI-NEXT:    mov w27, v18.s[2]
; CHECK-GI-NEXT:    mov w28, v18.s[3]
; CHECK-GI-NEXT:    ushll2 v18.4s, v7.8h, #0
; CHECK-GI-NEXT:    udiv w7, w7, w24
; CHECK-GI-NEXT:    fmov w24, s17
; CHECK-GI-NEXT:    mov v23.h[2], w21
; CHECK-GI-NEXT:    ldp x22, x21, [sp, #64] // 16-byte Folded Reload
; CHECK-GI-NEXT:    fmov w29, s18
; CHECK-GI-NEXT:    mov w9, v18.s[2]
; CHECK-GI-NEXT:    mov w10, v18.s[3]
; CHECK-GI-NEXT:    udiv w24, w24, w25
; CHECK-GI-NEXT:    mov w25, v17.s[1]
; CHECK-GI-NEXT:    mov v23.h[3], w7
; CHECK-GI-NEXT:    umlsl v1.4s, v23.4h, v30.4h
; CHECK-GI-NEXT:    udiv w25, w25, w26
; CHECK-GI-NEXT:    mov w26, v17.s[2]
; CHECK-GI-NEXT:    fmov s24, w24
; CHECK-GI-NEXT:    uzp1 v1.8h, v27.8h, v1.8h
; CHECK-GI-NEXT:    ldp x24, x23, [sp, #48] // 16-byte Folded Reload
; CHECK-GI-NEXT:    udiv w26, w26, w27
; CHECK-GI-NEXT:    mov w27, v17.s[3]
; CHECK-GI-NEXT:    ushll2 v17.4s, v16.8h, #0
; CHECK-GI-NEXT:    mov v24.h[1], w25
; CHECK-GI-NEXT:    ushll v16.4s, v16.4h, #0
; CHECK-GI-NEXT:    mov w30, v17.s[1]
; CHECK-GI-NEXT:    mov w11, v17.s[2]
; CHECK-GI-NEXT:    mov w8, v17.s[3]
; CHECK-GI-NEXT:    udiv w27, w27, w28
; CHECK-GI-NEXT:    fmov w28, s17
; CHECK-GI-NEXT:    mov v24.h[2], w26
; CHECK-GI-NEXT:    ldp x26, x25, [sp, #32] // 16-byte Folded Reload
; CHECK-GI-NEXT:    udiv w28, w28, w29
; CHECK-GI-NEXT:    mov w29, v18.s[1]
; CHECK-GI-NEXT:    fmov s18, w3
; CHECK-GI-NEXT:    mov v24.h[3], w27
; CHECK-GI-NEXT:    mov v18.h[1], w4
; CHECK-GI-NEXT:    umlsl v16.4s, v24.4h, v7.4h
; CHECK-GI-NEXT:    mov v18.h[2], w2
; CHECK-GI-NEXT:    udiv w29, w30, w29
; CHECK-GI-NEXT:    fmov s25, w28
; CHECK-GI-NEXT:    ldp x28, x27, [sp, #16] // 16-byte Folded Reload
; CHECK-GI-NEXT:    mov v18.h[3], w17
; CHECK-GI-NEXT:    umlsl v6.4s, v18.4h, v29.4h
; CHECK-GI-NEXT:    udiv w9, w11, w9
; CHECK-GI-NEXT:    mov v25.h[1], w29
; CHECK-GI-NEXT:    uzp1 v2.8h, v5.8h, v6.8h
; CHECK-GI-NEXT:    uzp1 v0.16b, v0.16b, v2.16b
; CHECK-GI-NEXT:    udiv w8, w8, w10
; CHECK-GI-NEXT:    mov v25.h[2], w9
; CHECK-GI-NEXT:    mov v25.h[3], w8
; CHECK-GI-NEXT:    umlsl v17.4s, v25.4h, v31.4h
; CHECK-GI-NEXT:    uzp1 v3.8h, v16.8h, v17.8h
; CHECK-GI-NEXT:    uzp1 v1.16b, v1.16b, v3.16b
...
; CHECK-SD-NEXT:    str w9, [sp, #60] // 4-byte Spill
; CHECK-SD-NEXT:    ldr w20, [sp, #60] // 4-byte Reload
; CHECK-SD-NEXT:    msub w21, w20, w21, w23
; CHECK-SD-NEXT:    sdiv w9, w3, w1
; CHECK-SD-NEXT:    str w8, [sp, #12] // 4-byte Spill
...
; CHECK-SD-NEXT:    ldr w20, [sp, #24] // 4-byte Reload
; CHECK-SD-NEXT:    msub w1, w20, w1, w3
; CHECK-SD-NEXT:    str w9, [sp, #40] // 4-byte Spill
; CHECK-SD-NEXT:    str w8, [sp, #48] // 4-byte Spill
; CHECK-SD-NEXT:    fmov s0, w1
; CHECK-SD-NEXT:    ldr w1, [sp, #12] // 4-byte Reload
; CHECK-SD-NEXT:    msub w1, w1, w19, w22
; CHECK-SD-NEXT:    ldr w19, [sp, #28] // 4-byte Reload
; CHECK-SD-NEXT:    sdiv w9, w9, w8
...
; CHECK-SD-NEXT:    str w9, [sp, #56] // 4-byte Spill
; CHECK-SD-NEXT:    sdiv w9, w4, w8
; CHECK-SD-NEXT:    mov v0.h[3], w18
; CHECK-SD-NEXT:    ldr w18, [sp, #40] // 4-byte Reload
...
; CHECK-SD-NEXT:    ldr w12, [sp, #20] // 4-byte Reload
; CHECK-SD-NEXT:    ldr w17, [sp, #48] // 4-byte Reload
...
; CHECK-SD-NEXT:    ldr w16, [sp, #56] // 4-byte Reload
; CHECK-SD-NEXT:    mov v2.h[4], w8
...
; CHECK-SD-NEXT:    ldr w11, [sp, #16] // 4-byte Reload
...
; CHECK-GI-NEXT:    udiv w8, w12, w11
; CHECK-GI-NEXT:    mov v2.h[2], w10
; CHECK-GI-NEXT:    mov v2.h[3], w8
; CHECK-GI-NEXT:    umlsl v0.4s, v2.4h, v1.4h
; CHECK-GI-NEXT:    xtn v0.4h, v0.4s
; CHECK-GI-NEXT:    ret
entry:
  %s = urem <4 x i16> %d, %e
...
; CHECK-GI-NEXT:    mov v4.h[2], w14
; CHECK-GI-NEXT:    mov v3.h[3], w11
; CHECK-GI-NEXT:    umlsl v2.4s, v3.4h, v1.4h
; CHECK-GI-NEXT:    mov v4.h[3], w8
; CHECK-GI-NEXT:    umlsl v0.4s, v4.4h, v5.4h
; CHECK-GI-NEXT:    uzp1 v0.8h, v2.8h, v0.8h
; CHECK-GI-NEXT:    ret
entry:
  %s = urem <8 x i16> %d, %e
...
; CHECK-GI-NEXT:    mov w12, v5.s[3]
; CHECK-GI-NEXT:    fmov w17, s6
; CHECK-GI-NEXT:    mov w18, v6.s[1]
; CHECK-GI-NEXT:    mov w0, v6.s[2]
; CHECK-GI-NEXT:    mov w1, v6.s[3]
...
; CHECK-GI-NEXT:    mov w18, v5.s[2]
; CHECK-GI-NEXT:    fmov s16, w16
; CHECK-GI-NEXT:    udiv w18, w18, w0
; CHECK-GI-NEXT:    mov w0, v5.s[3]
...
; CHECK-GI-NEXT:    mov w2, v6.s[1]
; CHECK-GI-NEXT:    mov v16.h[3], w0
; CHECK-GI-NEXT:    umlsl v1.4s, v16.4h, v3.4h
; CHECK-GI-NEXT:    udiv w2, w3, w2
; CHECK-GI-NEXT:    mov w3, v6.s[2]
; CHECK-GI-NEXT:    fmov s17, w1
; CHECK-GI-NEXT:    udiv w3, w4, w3
...
; CHECK-GI-NEXT:    mov v17.h[2], w3
; CHECK-GI-NEXT:    mov v6.h[3], w8
; CHECK-GI-NEXT:    umlsl v0.4s, v6.4h, v2.4h
; CHECK-GI-NEXT:    mov v17.h[3], w10
; CHECK-GI-NEXT:    uzp1 v0.8h, v0.8h, v4.8h
; CHECK-GI-NEXT:    umlsl v5.4s, v17.4h, v19.4h
; CHECK-GI-NEXT:    uzp1 v1.8h, v1.8h, v5.8h
; CHECK-GI-NEXT:    ret
entry:
  %s = urem <16 x i16> %d, %e
  ret <16 x i16> %s
...
; CHECK-SD-NEXT:    mov x21, x0
; CHECK-SD-NEXT:    mov x22, x1
; CHECK-SD-NEXT:    ldr x2, [sp, #8] // 8-byte Reload
