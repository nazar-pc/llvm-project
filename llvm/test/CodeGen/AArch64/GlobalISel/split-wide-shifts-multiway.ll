...
; GISEL-NEXT:    lsl x3, x10, x12
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    sub x19, x14, x13
; GISEL-NEXT:    lsr x5, x10, x19
; GISEL-NEXT:    lsl x2, x11, x13
; GISEL-NEXT:    and x13, x8, #0x3f
; GISEL-NEXT:    csel x12, x3, xzr, eq
; GISEL-NEXT:    cmp x9, #1
; GISEL-NEXT:    lsr x21, x11, x19
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #2
...
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #4
; GISEL-NEXT:    and x26, x8, #0x3f
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #5
; GISEL-NEXT:    mov x27, x3
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #6
; GISEL-NEXT:    str x1, [sp, #328] ; 8-byte Spill
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #7
; GISEL-NEXT:    str x2, [sp, #312] ; 8-byte Spill
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #8
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #9
...
; GISEL-NEXT:    ldp x12, x14, [x1, #16]
; GISEL-NEXT:    csel x10, x10, xzr, eq
; GISEL-NEXT:    cmp x9, #1
; GISEL-NEXT:    csel x10, x3, x10, eq
; GISEL-NEXT:    cmp x9, #2
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x9, #3
; GISEL-NEXT:    lsl x23, x12, x13
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x9, #4
; GISEL-NEXT:    lsr x15, x12, x19
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x9, #5
; GISEL-NEXT:    lsl x13, x14, x16
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x9, #6
; GISEL-NEXT:    lsr x17, x14, x19
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x9, #7
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x9, #8
...
; GISEL-NEXT:    csel x10, xzr, x21, eq
; GISEL-NEXT:    cmp x9, #0
...
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x9, #14
; GISEL-NEXT:    ldp x11, x12, [x1, #32]
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x9, #15
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    lsl x0, x11, x16
; GISEL-NEXT:    csel x10, x14, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x10, [sp, #208] ; 8-byte Spill
; GISEL-NEXT:    csel x10, xzr, x17, eq
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    orr x10, x0, x10
; GISEL-NEXT:    lsr x7, x11, x19
; GISEL-NEXT:    lsl x24, x12, x16
; GISEL-NEXT:    csel x10, x10, xzr, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    mov x16, x15
; GISEL-NEXT:    csel x14, xzr, x15, eq
; GISEL-NEXT:    cmp x9, #1
; GISEL-NEXT:    lsr x30, x12, x19
; GISEL-NEXT:    orr x14, x13, x14
; GISEL-NEXT:    str x16, [sp, #88] ; 8-byte Spill
; GISEL-NEXT:    csel x10, x14, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x0, [sp, #296] ; 8-byte Spill
; GISEL-NEXT:    csel x14, xzr, x21, eq
; GISEL-NEXT:    cmp x9, #2
; GISEL-NEXT:    orr x14, x23, x14
; GISEL-NEXT:    csel x10, x14, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x14, xzr, x5, eq
; GISEL-NEXT:    cmp x9, #3
; GISEL-NEXT:    orr x14, x2, x14
; GISEL-NEXT:    csel x10, x14, x10, eq
; GISEL-NEXT:    cmp x9, #4
; GISEL-NEXT:    csel x10, x3, x10, eq
; GISEL-NEXT:    cmp x9, #5
...
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x9, #14
; GISEL-NEXT:    ldp x11, x14, [x1, #48]
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x9, #15
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    lsl x5, x11, x15
; GISEL-NEXT:    csel x10, x12, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x10, [sp, #192] ; 8-byte Spill
; GISEL-NEXT:    csel x10, xzr, x30, eq
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    orr x10, x5, x10
; GISEL-NEXT:    lsl x4, x14, x15
; GISEL-NEXT:    lsr x28, x14, x19
; GISEL-NEXT:    csel x10, x10, xzr, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    cmp x9, #4
; GISEL-NEXT:    orr x11, x13, x11
; GISEL-NEXT:    mov x13, x7
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x13, [sp, #320] ; 8-byte Spill
; GISEL-NEXT:    csel x11, xzr, x21, eq
; GISEL-NEXT:    cmp x9, #5
; GISEL-NEXT:    orr x11, x23, x11
; GISEL-NEXT:    csel x10, x11, x10, eq
...
; GISEL-NEXT:    csel x10, x14, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    lsl x22, x11, x26
; GISEL-NEXT:    csel x12, xzr, x28, eq
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    str x10, [sp, #176] ; 8-byte Spill
; GISEL-NEXT:    orr x12, x22, x12
; GISEL-NEXT:    mov x10, x20
; GISEL-NEXT:    mov x26, x25
; GISEL-NEXT:    csel x12, x12, xzr, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    mov x1, x26
; GISEL-NEXT:    csel x14, xzr, x20, eq
; GISEL-NEXT:    cmp x9, #1
; GISEL-NEXT:    mov x20, x24
; GISEL-NEXT:    orr x14, x4, x14
; GISEL-NEXT:    str x20, [sp, #264] ; 8-byte Spill
; GISEL-NEXT:    csel x12, x14, x12, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x14, xzr, x30, eq
; GISEL-NEXT:    cmp x9, #2
; GISEL-NEXT:    orr x14, x5, x14
; GISEL-NEXT:    csel x12, x14, x12, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    lsr x24, x11, x19
; GISEL-NEXT:    str x7, [sp, #240] ; 8-byte Spill
; GISEL-NEXT:    csel x12, x14, x12, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x14, xzr, x17, eq
; GISEL-NEXT:    cmp x9, #4
; GISEL-NEXT:    stp x24, x30, [sp, #64] ; 16-byte Folded Spill
; GISEL-NEXT:    orr x14, x0, x14
; GISEL-NEXT:    csel x12, x14, x12, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x14, xzr, x16, eq
; GISEL-NEXT:    cmp x9, #5
; GISEL-NEXT:    orr x14, x15, x14
; GISEL-NEXT:    csel x12, x14, x12, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x14, xzr, x21, eq
; GISEL-NEXT:    cmp x9, #6
...
; GISEL-NEXT:    csel x12, x14, x12, eq
; GISEL-NEXT:    cmp x9, #8
; GISEL-NEXT:    mov x14, x10
; GISEL-NEXT:    csel x12, x3, x12, eq
; GISEL-NEXT:    cmp x9, #9
; GISEL-NEXT:    mov x3, x4
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #10
; GISEL-NEXT:    str x14, [sp, #80] ; 8-byte Spill
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #11
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #12
...
; GISEL-NEXT:    lsl x25, x6, x11
; GISEL-NEXT:    csel x11, xzr, x24, eq
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    orr x11, x25, x11
; GISEL-NEXT:    str x25, [sp, #272] ; 8-byte Spill
...
; GISEL-NEXT:    mov x4, x5
; GISEL-NEXT:    csel x11, x12, x11, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x4, [sp, #256] ; 8-byte Spill
; GISEL-NEXT:    csel x12, xzr, x30, eq
; GISEL-NEXT:    cmp x9, #3
; GISEL-NEXT:    orr x12, x5, x12
; GISEL-NEXT:    mov x5, x21
; GISEL-NEXT:    csel x11, x12, x11, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x5, [sp, #304] ; 8-byte Spill
...
; GISEL-NEXT:    csel x12, xzr, x21, eq
; GISEL-NEXT:    cmp x9, #7
; GISEL-NEXT:    ldr x21, [sp, #328] ; 8-byte Reload
; GISEL-NEXT:    orr x12, x23, x12
; GISEL-NEXT:    csel x11, x12, x11, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    cmp x9, #8
; GISEL-NEXT:    orr x12, x2, x12
; GISEL-NEXT:    mov x2, x27
; GISEL-NEXT:    csel x11, x12, x11, eq
; GISEL-NEXT:    cmp x9, #9
; GISEL-NEXT:    csel x11, x27, x11, eq
; GISEL-NEXT:    cmp x9, #10
; GISEL-NEXT:    mov x27, x3
...
; GISEL-NEXT:    csel x11, xzr, x11, eq
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    ldp x12, x26, [x21, #80]
; GISEL-NEXT:    csel x10, x6, x11, eq
; GISEL-NEXT:    str x10, [sp, #160] ; 8-byte Spill
; GISEL-NEXT:    lsr x10, x6, x19
; GISEL-NEXT:    and x11, x8, #0x3f
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    lsl x6, x12, x11
; GISEL-NEXT:    csel x11, xzr, x10, eq
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    mov x21, x10
; GISEL-NEXT:    stp x10, x3, [sp, #32] ; 16-byte Folded Spill
; GISEL-NEXT:    orr x11, x6, x11
; GISEL-NEXT:    stp x19, x6, [sp, #48] ; 16-byte Folded Spill
; GISEL-NEXT:    csel x11, x11, xzr, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x10, xzr, x24, eq
; GISEL-NEXT:    cmp x9, #1
; GISEL-NEXT:    orr x10, x25, x10
; GISEL-NEXT:    csel x10, x10, x11, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x11, xzr, x7, eq
; GISEL-NEXT:    cmp x9, #2
...
; GISEL-NEXT:    cmp x9, #5
; GISEL-NEXT:    mov x13, x26
; GISEL-NEXT:    orr x11, x20, x11
; GISEL-NEXT:    mov x20, x30
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x11, xzr, x17, eq
; GISEL-NEXT:    cmp x9, #6
...
; GISEL-NEXT:    mov x15, x5
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x11, xzr, x5, eq
; GISEL-NEXT:    cmp x9, #8
; GISEL-NEXT:    mov x5, x2
; GISEL-NEXT:    orr x11, x23, x11
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    cmp x9, #10
; GISEL-NEXT:    and x11, x8, #0x3f
; GISEL-NEXT:    csel x10, x2, x10, eq
; GISEL-NEXT:    cmp x9, #11
; GISEL-NEXT:    lsr x2, x12, x19
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x9, #12
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x9, #13
; GISEL-NEXT:    str x2, [sp, #288] ; 8-byte Spill
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x9, #14
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x9, #15
...
; GISEL-NEXT:    csel x12, xzr, x7, eq
; GISEL-NEXT:    cmp x9, #3
; GISEL-NEXT:    ldr x7, [sp, #320] ; 8-byte Reload
; GISEL-NEXT:    orr x12, x22, x12
; GISEL-NEXT:    csel x10, x12, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x12, xzr, x14, eq
; GISEL-NEXT:    cmp x9, #4
; GISEL-NEXT:    mov x14, x16
; GISEL-NEXT:    orr x12, x27, x12
; GISEL-NEXT:    ldr x27, [sp, #264] ; 8-byte Reload
; GISEL-NEXT:    csel x10, x12, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x12, xzr, x30, eq
; GISEL-NEXT:    cmp x9, #5
; GISEL-NEXT:    ldr x30, [sp, #240] ; 8-byte Reload
; GISEL-NEXT:    orr x12, x4, x12
; GISEL-NEXT:    ldr x4, [sp, #328] ; 8-byte Reload
; GISEL-NEXT:    csel x10, x12, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x12, xzr, x7, eq
; GISEL-NEXT:    cmp x9, #6
...
; GISEL-NEXT:    csel x12, xzr, x16, eq
; GISEL-NEXT:    cmp x9, #8
; GISEL-NEXT:    mov x16, x3
; GISEL-NEXT:    orr x12, x3, x12
; GISEL-NEXT:    mov x3, x5
; GISEL-NEXT:    csel x10, x12, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x9, #15
; GISEL-NEXT:    ldp x12, x5, [x4, #96]
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    mov x4, x1
; GISEL-NEXT:    csel x10, x13, x10, eq
; GISEL-NEXT:    lsr x13, x13, x19
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    lsl x11, x12, x11
; GISEL-NEXT:    str x10, [sp, #144] ; 8-byte Spill
...
; GISEL-NEXT:    ldr x26, [sp, #32] ; 8-byte Reload
; GISEL-NEXT:    csel x10, x10, x11, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    cmp x9, #6
; GISEL-NEXT:    mov x20, x17
; GISEL-NEXT:    orr x11, x28, x11
; GISEL-NEXT:    mov x28, x22
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x11, xzr, x7, eq
; GISEL-NEXT:    cmp x9, #7
...
; GISEL-NEXT:    mov x27, x16
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x11, xzr, x17, eq
; GISEL-NEXT:    cmp x9, #8
; GISEL-NEXT:    mov x17, x2
; GISEL-NEXT:    orr x11, x0, x11
; GISEL-NEXT:    ldr x0, [sp, #280] ; 8-byte Reload
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x11, xzr, x14, eq
; GISEL-NEXT:    cmp x9, #9
; GISEL-NEXT:    ldr x14, [sp, #304] ; 8-byte Reload
...
; GISEL-NEXT:    cmp x9, #10
; GISEL-NEXT:    orr x11, x23, x11
; GISEL-NEXT:    ldp x25, x23, [sp, #64] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x11, xzr, x1, eq
; GISEL-NEXT:    cmp x9, #11
...
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    cmp x9, #12
; GISEL-NEXT:    lsr x11, x12, x24
; GISEL-NEXT:    csel x10, x3, x10, eq
; GISEL-NEXT:    cmp x9, #13
; GISEL-NEXT:    mov x24, x5
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x9, #14
; GISEL-NEXT:    str x11, [sp, #112] ; 8-byte Spill
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x9, #15
; GISEL-NEXT:    mov x3, x14
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    csel x10, x12, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    cmp x9, #5
; GISEL-NEXT:    orr x11, x22, x11
; GISEL-NEXT:    ldr x22, [sp, #80] ; 8-byte Reload
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x11, xzr, x22, eq
; GISEL-NEXT:    cmp x9, #6
; GISEL-NEXT:    orr x11, x2, x11
; GISEL-NEXT:    ldp x2, x16, [sp, #256] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x11, xzr, x23, eq
; GISEL-NEXT:    cmp x9, #7
...
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    ldp x11, x1, [x1, #112]
; GISEL-NEXT:    csel x10, x24, x10, eq
; GISEL-NEXT:    str x10, [sp, #120] ; 8-byte Spill
; GISEL-NEXT:    ldr x10, [sp, #48] ; 8-byte Reload
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    lsr x6, x24, x10
; GISEL-NEXT:    str x1, [sp, #8] ; 8-byte Spill
; GISEL-NEXT:    and x1, x8, #0x3f
; GISEL-NEXT:    lsl x21, x11, x1
; GISEL-NEXT:    ldr x24, [sp, #96] ; 8-byte Reload
; GISEL-NEXT:    csel x1, xzr, x6, eq
; GISEL-NEXT:    str x6, [sp, #24] ; 8-byte Spill
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    str x21, [sp, #328] ; 8-byte Spill
; GISEL-NEXT:    orr x1, x21, x1
; GISEL-NEXT:    ldp x21, x6, [sp, #104] ; 16-byte Folded Reload
...
; GISEL-NEXT:    ldr x0, [sp, #288] ; 8-byte Reload
; GISEL-NEXT:    csel x1, x30, x1, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x30, xzr, x0, eq
; GISEL-NEXT:    cmp x9, #3
; GISEL-NEXT:    orr x30, x15, x30
; GISEL-NEXT:    mov x15, x26
; GISEL-NEXT:    csel x1, x30, x1, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x30, xzr, x26, eq
; GISEL-NEXT:    ldr x26, [sp, #56] ; 8-byte Reload
; GISEL-NEXT:    cmp x9, #4
...
; GISEL-NEXT:    ldr x19, [sp, #240] ; 8-byte Reload
; GISEL-NEXT:    csel x1, x30, x1, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    ldr x14, [sp, #136] ; 8-byte Reload
; GISEL-NEXT:    csel x1, x30, x1, eq
; GISEL-NEXT:    ldp x30, x3, [sp, #8] ; 16-byte Folded Reload
; GISEL-NEXT:    cmp x9, #14
; GISEL-NEXT:    csel x1, x3, x1, eq
; GISEL-NEXT:    cmp x9, #15
; GISEL-NEXT:    csel x1, xzr, x1, eq
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    csel x11, x11, x1, eq
; GISEL-NEXT:    lsl x1, x30, x10
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x2, xzr, x2, eq
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    ldr x10, [sp, #24] ; 8-byte Reload
; GISEL-NEXT:    orr x1, x1, x2
; GISEL-NEXT:    csel x1, x1, xzr, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x13, xzr, x10, eq
; GISEL-NEXT:    ldr x10, [sp, #328] ; 8-byte Reload
; GISEL-NEXT:    cmp x9, #1
; GISEL-NEXT:    orr x10, x10, x13
; GISEL-NEXT:    csel x10, x10, x1, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x13, xzr, x6, eq
; GISEL-NEXT:    cmp x9, #2
; GISEL-NEXT:    orr x12, x24, x13
...
; GISEL-NEXT:    cmp x9, #3
; GISEL-NEXT:    orr x12, x13, x12
; GISEL-NEXT:    ldr x13, [sp, #248] ; 8-byte Reload
; GISEL-NEXT:    csel x10, x12, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    cmp x9, #6
; GISEL-NEXT:    orr x12, x13, x12
; GISEL-NEXT:    ldr x13, [sp, #256] ; 8-byte Reload
; GISEL-NEXT:    csel x10, x12, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x12, xzr, x19, eq
; GISEL-NEXT:    cmp x9, #7
...
; GISEL-NEXT:    csel x10, x12, x10, eq
; GISEL-NEXT:    ldr x12, [sp, #320] ; 8-byte Reload
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #10
; GISEL-NEXT:    orr x12, x16, x12
; GISEL-NEXT:    csel x10, x12, x10, eq
; GISEL-NEXT:    ldp x12, x13, [sp, #224] ; 16-byte Folded Reload
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    stp x13, x12, [x14]
; GISEL-NEXT:    ldr x13, [sp, #296] ; 8-byte Reload
; GISEL-NEXT:    csel x12, xzr, x20, eq
; GISEL-NEXT:    cmp x9, #11
...
; GISEL-NEXT:    csel x10, x12, x10, eq
; GISEL-NEXT:    ldp x12, x15, [sp, #200] ; 16-byte Folded Reload
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x12, [x14, #32]
; GISEL-NEXT:    csel x12, xzr, x5, eq
; GISEL-NEXT:    cmp x9, #12
; GISEL-NEXT:    orr x12, x27, x12
; GISEL-NEXT:    stp x13, x15, [x14, #16]
; GISEL-NEXT:    ldr x13, [sp, #192] ; 8-byte Reload
; GISEL-NEXT:    csel x10, x12, x10, eq
; GISEL-NEXT:    ldp x12, x15, [sp, #176] ; 16-byte Folded Reload
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    ldp x28, x27, [sp, #336] ; 16-byte Folded Reload
; GISEL-NEXT:    str x12, [x14, #56]
; GISEL-NEXT:    ldr x12, [sp, #304] ; 8-byte Reload
; GISEL-NEXT:    stp x13, x15, [x14, #40]
; GISEL-NEXT:    ldr x13, [sp, #168] ; 8-byte Reload
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #13
; GISEL-NEXT:    orr x12, x7, x12
; GISEL-NEXT:    csel x10, x12, x10, eq
; GISEL-NEXT:    ldp x12, x15, [sp, #152] ; 16-byte Folded Reload
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    stp x13, x15, [x14, #64]
; GISEL-NEXT:    ldr x13, [sp, #312] ; 8-byte Reload
; GISEL-NEXT:    str x12, [x14, #80]
...
; GISEL-NEXT:    stp x13, x9, [x14, #88]
; GISEL-NEXT:    csel x9, x3, x10, eq
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    ldr x8, [sp, #120] ; 8-byte Reload
; GISEL-NEXT:    stp x8, x11, [x14, #104]
; GISEL-NEXT:    csel x8, x30, x9, eq
...
; GISEL-NEXT:    cmp x9, #5
; GISEL-NEXT:    orr x11, x3, x11
; GISEL-NEXT:    str x13, [sp, #120] ; 8-byte Spill
; GISEL-NEXT:    lsr x5, x12, x14
; GISEL-NEXT:    csel x10, x11, x10, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    stp x13, x12, [sp, #88] ; 16-byte Folded Spill
; GISEL-NEXT:    cmp x9, #12
...
; GISEL-NEXT:    stp x10, x12, [sp, #72] ; 16-byte Folded Spill
; GISEL-NEXT:    cmp x9, #13
...
; GISEL-NEXT:    lsr x10, x10, x14
; GISEL-NEXT:    orr x30, x12, x30
; GISEL-NEXT:    stp x12, x11, [sp, #56] ; 16-byte Folded Spill
; GISEL-NEXT:    mov x2, x24
; GISEL-NEXT:    csel x1, x30, x1, eq
; GISEL-NEXT:    cmp x9, #15
; GISEL-NEXT:    str x10, [sp, #48] ; 8-byte Spill
; GISEL-NEXT:    csel x1, x10, x1, eq
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    stp x20, x7, [sp, #24] ; 16-byte Folded Spill
; GISEL-NEXT:    csel x10, x6, x1, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    ldp x13, x12, [sp, #144] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x1, x1, xzr, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    ldp x14, x11, [sp, #128] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x1, x19, x1, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x19, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #2
; GISEL-NEXT:    orr x19, x17, x19
; GISEL-NEXT:    ldp x15, x16, [sp, #112] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x1, x19, x1, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x19, xzr, x13, eq
; GISEL-NEXT:    cmp x9, #3
; GISEL-NEXT:    orr x19, x11, x19
; GISEL-NEXT:    ldp x25, x24, [sp, #48] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x1, x19, x1, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    ldp x5, x30, [sp, #96] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x1, x19, x1, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    ldp x7, x6, [sp, #80] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x1, x19, x1, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x19, xzr, x20, eq
; GISEL-NEXT:    cmp x9, #10
; GISEL-NEXT:    orr x19, x22, x19
; GISEL-NEXT:    ldp x21, x20, [sp, #64] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x1, x19, x1, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    csel x19, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #1
; GISEL-NEXT:    mov x12, x16
; GISEL-NEXT:    orr x19, x17, x19
; GISEL-NEXT:    ldp x17, x4, [sp, #16] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x1, x19, x1, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x19, xzr, x13, eq
; GISEL-NEXT:    cmp x9, #2
...
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x19, xzr, x15, eq
; GISEL-NEXT:    ldp x16, x15, [sp, #32] ; 16-byte Folded Reload
; GISEL-NEXT:    cmp x9, #5
...
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x10, [sp, #232] ; 8-byte Spill
; GISEL-NEXT:    ldr x10, [sp, #296] ; 8-byte Reload
...
; GISEL-NEXT:    csel x10, x10, x1, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x1, xzr, x13, eq
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    str x10, [sp, #296] ; 8-byte Spill
; GISEL-NEXT:    orr x1, x11, x1
; GISEL-NEXT:    ldr x10, [sp, #176] ; 8-byte Reload
; GISEL-NEXT:    mov x11, x3
; GISEL-NEXT:    csel x1, x1, xzr, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x19, xzr, x14, eq
; GISEL-NEXT:    cmp x9, #1
; GISEL-NEXT:    orr x19, x22, x19
; GISEL-NEXT:    mov x22, x17
; GISEL-NEXT:    csel x1, x19, x1, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x19, xzr, x0, eq
; GISEL-NEXT:    cmp x9, #2
...
; GISEL-NEXT:    csel x10, x10, x1, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    mov x1, x5
; GISEL-NEXT:    csel x0, xzr, x0, eq
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    str x10, [sp, #184] ; 8-byte Spill
; GISEL-NEXT:    orr x17, x12, x0
...
; GISEL-NEXT:    csel x17, x0, x17, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x0, xzr, x21, eq
; GISEL-NEXT:    cmp x9, #8
; GISEL-NEXT:    orr x0, x24, x0
; GISEL-NEXT:    csel x17, x0, x17, eq
; GISEL-NEXT:    cmp x9, #9
; GISEL-NEXT:    csel x17, x25, x17, eq
; GISEL-NEXT:    cmp x9, #10
; GISEL-NEXT:    csel x17, xzr, x17, eq
; GISEL-NEXT:    cmp x9, #11
; GISEL-NEXT:    csel x17, xzr, x17, eq
...
; GISEL-NEXT:    csel x13, x25, x13, eq
; GISEL-NEXT:    cmp x9, #6
; GISEL-NEXT:    csel x13, xzr, x13, eq
; GISEL-NEXT:    cmp x9, #7
; GISEL-NEXT:    csel x13, xzr, x13, eq
...
; GISEL-NEXT:    cmp x9, #1
; GISEL-NEXT:    orr x3, x24, x3
; GISEL-NEXT:    csel x2, x3, x2, eq
; GISEL-NEXT:    cmp x9, #2
; GISEL-NEXT:    ldr x3, [sp, #264] ; 8-byte Reload
; GISEL-NEXT:    csel x2, x25, x2, eq
; GISEL-NEXT:    cmp x9, #3
; GISEL-NEXT:    csel x2, xzr, x2, eq
; GISEL-NEXT:    cmp x9, #4
; GISEL-NEXT:    csel x2, xzr, x2, eq
...
; GISEL-NEXT:    csel x15, xzr, x21, eq
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    orr x15, x24, x15
; GISEL-NEXT:    ldp x22, x21, [sp, #352] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x15, x15, xzr, eq
; GISEL-NEXT:    cmp x9, #1
; GISEL-NEXT:    csel x15, x25, x15, eq
; GISEL-NEXT:    cmp x9, #2
; GISEL-NEXT:    csel x15, xzr, x15, eq
; GISEL-NEXT:    cmp x9, #3
; GISEL-NEXT:    csel x15, xzr, x15, eq
...
; GISEL-NEXT:    csel x14, x25, xzr, eq
; GISEL-NEXT:    cmp x9, #1
; GISEL-NEXT:    csel x14, xzr, x14, eq
; GISEL-NEXT:    cmp x9, #2
...
; GISEL-NEXT:    csel x14, xzr, x14, eq
; GISEL-NEXT:    cmp x9, #8
; GISEL-NEXT:    stp x4, x3, [x16, #16]
; GISEL-NEXT:    csel x14, xzr, x14, eq
; GISEL-NEXT:    cmp x9, #9
; GISEL-NEXT:    ldr x3, [sp, #184] ; 8-byte Reload
; GISEL-NEXT:    csel x12, xzr, x14, eq
; GISEL-NEXT:    cmp x9, #10
; GISEL-NEXT:    stp x1, x2, [x16, #96]
; GISEL-NEXT:    csel x10, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #11
; GISEL-NEXT:    stp x19, x3, [x16, #32]
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x9, #12
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x9, #13
...
; GISEL-NEXT:    .cfi_offset w27, -88
; GISEL-NEXT:    .cfi_offset w28, -96
; GISEL-NEXT:    str x0, [sp, #312] ; 8-byte Spill
; GISEL-NEXT:    mov w8, w2
; GISEL-NEXT:    mov w9, #64 ; =0x40
; GISEL-NEXT:    ldp x19, x0, [x1]
; GISEL-NEXT:    and x15, x8, #0x3f
...
; GISEL-NEXT:    csel x12, xzr, x13, eq
; GISEL-NEXT:    lsl x6, x17, x14
; GISEL-NEXT:    cmp x10, #1
; GISEL-NEXT:    orr x12, x20, x12
; GISEL-NEXT:    ldp x13, x16, [x1, #32]
; GISEL-NEXT:    csel x9, x12, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    lsr x30, x17, x15
; GISEL-NEXT:    csel x12, xzr, x6, eq
; GISEL-NEXT:    cmp x10, #2
; GISEL-NEXT:    str x17, [sp, #232] ; 8-byte Spill
; GISEL-NEXT:    lsl x27, x13, x14
; GISEL-NEXT:    orr x12, x2, x12
; GISEL-NEXT:    str x2, [sp, #176] ; 8-byte Spill
; GISEL-NEXT:    csel x9, x12, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    stp x13, x16, [sp, #192] ; 16-byte Folded Spill
; GISEL-NEXT:    csel x12, xzr, x27, eq
; GISEL-NEXT:    lsr x2, x13, x15
...
; GISEL-NEXT:    csel x9, x12, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x17, [sp, #168] ; 8-byte Spill
; GISEL-NEXT:    csel x12, xzr, x17, eq
; GISEL-NEXT:    cmp x10, #4
; GISEL-NEXT:    str x16, [sp, #328] ; 8-byte Spill
; GISEL-NEXT:    lsl x17, x13, x14
; GISEL-NEXT:    orr x12, x2, x12
; GISEL-NEXT:    stp x13, x0, [sp, #208] ; 16-byte Folded Spill
; GISEL-NEXT:    csel x9, x12, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    lsr x23, x13, x15
; GISEL-NEXT:    csel x12, xzr, x17, eq
; GISEL-NEXT:    stp x2, x17, [sp, #336] ; 16-byte Folded Spill
; GISEL-NEXT:    cmp x10, #5
; GISEL-NEXT:    orr x12, x16, x12
; GISEL-NEXT:    lsl x17, x0, x14
; GISEL-NEXT:    lsr x21, x0, x15
; GISEL-NEXT:    ldp x16, x13, [x1, #64]
; GISEL-NEXT:    csel x9, x12, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x17, [sp, #160] ; 8-byte Spill
; GISEL-NEXT:    csel x12, xzr, x17, eq
; GISEL-NEXT:    cmp x10, #6
...
; GISEL-NEXT:    str x13, [sp, #240] ; 8-byte Spill
; GISEL-NEXT:    ldp x13, x5, [x1, #80]
; GISEL-NEXT:    csel x9, x12, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    lsr x3, x17, x15
; GISEL-NEXT:    str x6, [sp, #112] ; 8-byte Spill
; GISEL-NEXT:    csel x17, xzr, x0, eq
; GISEL-NEXT:    cmp x10, #8
; GISEL-NEXT:    stp x30, x27, [sp, #48] ; 16-byte Folded Spill
; GISEL-NEXT:    orr x17, x3, x17
; GISEL-NEXT:    lsl x4, x13, x14
; GISEL-NEXT:    str x13, [sp, #248] ; 8-byte Spill
; GISEL-NEXT:    csel x17, x17, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    lsr x9, x16, x15
; GISEL-NEXT:    str x4, [sp, #320] ; 8-byte Spill
; GISEL-NEXT:    csel x4, xzr, x4, eq
; GISEL-NEXT:    cmp x10, #9
; GISEL-NEXT:    orr x4, x9, x4
; GISEL-NEXT:    lsl x22, x5, x14
; GISEL-NEXT:    lsr x25, x13, x15
; GISEL-NEXT:    ldp x12, x13, [x1, #96]
; GISEL-NEXT:    csel x17, x4, x17, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    lsr x26, x5, x15
...
; GISEL-NEXT:    lsl x7, x12, x14
; GISEL-NEXT:    stp x5, x12, [sp, #264] ; 16-byte Folded Spill
; GISEL-NEXT:    csel x17, x4, x17, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    lsl x5, x13, x14
; GISEL-NEXT:    csel x4, xzr, x7, eq
; GISEL-NEXT:    cmp x10, #11
; GISEL-NEXT:    lsr x24, x12, x15
; GISEL-NEXT:    orr x4, x26, x4
; GISEL-NEXT:    mov x12, x9
; GISEL-NEXT:    stp x13, x9, [sp, #288] ; 16-byte Folded Spill
; GISEL-NEXT:    csel x17, x4, x17, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    lsl x4, x9, x14
; GISEL-NEXT:    csel x1, xzr, x5, eq
; GISEL-NEXT:    cmp x10, #12
; GISEL-NEXT:    lsr x9, x13, x15
; GISEL-NEXT:    orr x1, x24, x1
; GISEL-NEXT:    lsr x12, x12, x15
; GISEL-NEXT:    lsl x16, x11, x14
...
; GISEL-NEXT:    lsl x17, x28, x14
; GISEL-NEXT:    mov x9, x28
; GISEL-NEXT:    csel x13, x13, x1, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    lsr x9, x9, x15
; GISEL-NEXT:    csel x28, xzr, x17, eq
; GISEL-NEXT:    cmp x10, #14
; GISEL-NEXT:    mov x1, x17
; GISEL-NEXT:    orr x28, x12, x28
; GISEL-NEXT:    str x9, [sp, #120] ; 8-byte Spill
; GISEL-NEXT:    ldr x15, [sp, #320] ; 8-byte Reload
; GISEL-NEXT:    csel x12, x28, x13, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    stp x5, x7, [sp, #72] ; 16-byte Folded Spill
; GISEL-NEXT:    csel x28, xzr, x16, eq
; GISEL-NEXT:    cmp x10, #15
; GISEL-NEXT:    str x22, [sp, #88] ; 8-byte Spill
; GISEL-NEXT:    orr x28, x9, x28
; GISEL-NEXT:    ldp x13, x17, [sp, #168] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x9, x28, x12, eq
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    str x1, [sp, #32] ; 8-byte Spill
; GISEL-NEXT:    csel x9, x19, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    ldr x19, [sp, #328] ; 8-byte Reload
; GISEL-NEXT:    str x9, [sp, #184] ; 8-byte Spill
; GISEL-NEXT:    ldr x9, [sp, #144] ; 8-byte Reload
; GISEL-NEXT:    ldp x28, x12, [sp, #336] ; 16-byte Folded Reload
; GISEL-NEXT:    str x16, [sp, #104] ; 8-byte Spill
; GISEL-NEXT:    csel x9, xzr, x9, eq
; GISEL-NEXT:    cmp x10, #0
; GISEL-NEXT:    str x25, [sp, #96] ; 8-byte Spill
; GISEL-NEXT:    orr x9, x20, x9
; GISEL-NEXT:    str x24, [sp, #64] ; 8-byte Spill
; GISEL-NEXT:    csel x9, x9, x11, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x2, [sp, #40] ; 8-byte Spill
; GISEL-NEXT:    csel x20, xzr, x6, eq
; GISEL-NEXT:    cmp x10, #1
; GISEL-NEXT:    str x26, [sp, #24] ; 8-byte Spill
; GISEL-NEXT:    orr x20, x17, x20
; GISEL-NEXT:    ldp x6, x14, [sp, #152] ; 16-byte Folded Reload
...
; GISEL-NEXT:    csel x9, x20, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x20, xzr, x22, eq
; GISEL-NEXT:    cmp x10, #9
; GISEL-NEXT:    mov x22, x1
; GISEL-NEXT:    orr x20, x25, x20
; GISEL-NEXT:    mov x25, x12
; GISEL-NEXT:    csel x9, x20, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x20, xzr, x7, eq
; GISEL-NEXT:    cmp x10, #10
...
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x20, xzr, x1, eq
; GISEL-NEXT:    ldp x7, x1, [sp, #120] ; 16-byte Folded Reload
; GISEL-NEXT:    cmp x10, #13
; GISEL-NEXT:    orr x20, x1, x20
; GISEL-NEXT:    csel x9, x20, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    csel x9, x16, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x9, [sp, #280] ; 8-byte Spill
...
; GISEL-NEXT:    csel x20, xzr, x27, eq
; GISEL-NEXT:    cmp x10, #1
; GISEL-NEXT:    ldr x27, [sp, #64] ; 8-byte Reload
; GISEL-NEXT:    orr x20, x30, x20
; GISEL-NEXT:    mov x30, x21
; GISEL-NEXT:    csel x9, x20, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x20, xzr, x13, eq
; GISEL-NEXT:    cmp x10, #2
; GISEL-NEXT:    mov x13, x28
; GISEL-NEXT:    orr x20, x28, x20
; GISEL-NEXT:    mov x28, x23
; GISEL-NEXT:    csel x9, x20, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x28, [sp, #16] ; 8-byte Spill
; GISEL-NEXT:    csel x20, xzr, x12, eq
; GISEL-NEXT:    cmp x10, #3
; GISEL-NEXT:    mov x12, x19
; GISEL-NEXT:    orr x20, x19, x20
; GISEL-NEXT:    csel x9, x20, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x20, xzr, x14, eq
...
; GISEL-NEXT:    csel x20, xzr, x0, eq
; GISEL-NEXT:    cmp x10, #6
; GISEL-NEXT:    ldr x0, [sp, #256] ; 8-byte Reload
; GISEL-NEXT:    orr x20, x3, x20
; GISEL-NEXT:    ldp x3, x16, [sp, #72] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x9, x20, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x20, xzr, x15, eq
; GISEL-NEXT:    cmp x10, #7
; GISEL-NEXT:    ldr x15, [sp, #104] ; 8-byte Reload
; GISEL-NEXT:    orr x20, x6, x20
; GISEL-NEXT:    ldp x19, x6, [sp, #88] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x9, x20, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    str x9, [sp, #256] ; 8-byte Spill
; GISEL-NEXT:    ldp x0, x9, [sp, #48] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x9, xzr, x9, eq
; GISEL-NEXT:    cmp x10, #0
; GISEL-NEXT:    orr x9, x0, x9
; GISEL-NEXT:    mov x0, x28
; GISEL-NEXT:    csel x9, x9, x11, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x20, xzr, x24, eq
; GISEL-NEXT:    cmp x10, #1
; GISEL-NEXT:    orr x20, x13, x20
...
; GISEL-NEXT:    orr x20, x12, x20
; GISEL-NEXT:    ldr x12, [sp, #232] ; 8-byte Reload
; GISEL-NEXT:    csel x9, x20, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x20, xzr, x14, eq
; GISEL-NEXT:    cmp x10, #3
...
; GISEL-NEXT:    orr x20, x23, x20
; GISEL-NEXT:    mov x23, x19
; GISEL-NEXT:    csel x9, x20, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x20, xzr, x2, eq
; GISEL-NEXT:    cmp x10, #6
; GISEL-NEXT:    ldr x2, [sp, #32] ; 8-byte Reload
; GISEL-NEXT:    orr x20, x21, x20
; GISEL-NEXT:    csel x9, x20, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x20, xzr, x19, eq
; GISEL-NEXT:    cmp x10, #7
; GISEL-NEXT:    mov x19, x6
; GISEL-NEXT:    orr x20, x6, x20
; GISEL-NEXT:    mov x6, x23
; GISEL-NEXT:    csel x9, x20, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x20, xzr, x16, eq
; GISEL-NEXT:    cmp x10, #8
...
; GISEL-NEXT:    orr x20, x26, x20
; GISEL-NEXT:    mov x26, x3
; GISEL-NEXT:    csel x9, x20, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x20, xzr, x3, eq
; GISEL-NEXT:    cmp x10, #9
; GISEL-NEXT:    mov x3, x28
; GISEL-NEXT:    orr x20, x27, x20
; GISEL-NEXT:    csel x9, x20, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x20, xzr, x4, eq
...
; GISEL-NEXT:    csel x9, x12, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    ldr x12, [sp, #336] ; 8-byte Reload
; GISEL-NEXT:    str x9, [sp, #232] ; 8-byte Spill
; GISEL-NEXT:    csel x9, xzr, x24, eq
; GISEL-NEXT:    cmp x10, #0
; GISEL-NEXT:    orr x9, x12, x9
...
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x20, xzr, x13, eq
; GISEL-NEXT:    ldr x13, [sp, #328] ; 8-byte Reload
; GISEL-NEXT:    cmp x10, #1
; GISEL-NEXT:    orr x20, x13, x20
; GISEL-NEXT:    csel x9, x20, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    mov x23, x19
; GISEL-NEXT:    orr x20, x19, x20
; GISEL-NEXT:    mov x19, x25
; GISEL-NEXT:    csel x9, x20, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x20, xzr, x25, eq
; GISEL-NEXT:    ldr x25, [sp, #24] ; 8-byte Reload
; GISEL-NEXT:    cmp x10, #7
; GISEL-NEXT:    orr x20, x25, x20
; GISEL-NEXT:    csel x9, x20, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
...
; GISEL-NEXT:    ldr x9, [sp, #344] ; 8-byte Reload
; GISEL-NEXT:    csel x9, xzr, x9, eq
; GISEL-NEXT:    cmp x10, #0
; GISEL-NEXT:    orr x9, x13, x9
...
; GISEL-NEXT:    csel x9, x11, x9, eq
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    csel x3, x12, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    ldr x12, [sp, #216] ; 8-byte Reload
...
; GISEL-NEXT:    csel x9, x11, x9, eq
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    csel x0, x12, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    ldr x12, [sp, #224] ; 8-byte Reload
; GISEL-NEXT:    csel x9, xzr, x14, eq
; GISEL-NEXT:    cmp x10, #0
; GISEL-NEXT:    orr x9, x26, x9
; GISEL-NEXT:    csel x9, x9, x11, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x13, xzr, x16, eq
; GISEL-NEXT:    cmp x10, #1
...
; GISEL-NEXT:    csel x9, x11, x9, eq
; GISEL-NEXT:    cmp x8, #0
; GISEL-NEXT:    csel x13, x12, x9, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x9, xzr, x16, eq
; GISEL-NEXT:    cmp x10, #0
...
; GISEL-NEXT:    csel x12, x12, x11, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x16, xzr, x19, eq
; GISEL-NEXT:    cmp x10, #1
; GISEL-NEXT:    orr x16, x25, x16
; GISEL-NEXT:    csel x12, x16, x12, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x16, xzr, x22, eq
; GISEL-NEXT:    cmp x10, #2
...
; GISEL-NEXT:    csel x16, xzr, x17, eq
; GISEL-NEXT:    cmp x10, #4
; GISEL-NEXT:    orr x16, x1, x16
; GISEL-NEXT:    csel x12, x16, x12, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x16, xzr, x15, eq
; GISEL-NEXT:    cmp x10, #5
; GISEL-NEXT:    orr x16, x7, x16
; GISEL-NEXT:    csel x12, x16, x12, eq
; GISEL-NEXT:    cmp x10, #6
...
; GISEL-NEXT:    csel x16, x16, x11, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x2, xzr, x22, eq
; GISEL-NEXT:    cmp x10, #1
; GISEL-NEXT:    orr x2, x27, x2
; GISEL-NEXT:    csel x16, x2, x16, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x2, xzr, x4, eq
; GISEL-NEXT:    cmp x10, #2
; GISEL-NEXT:    orr x2, x5, x2
; GISEL-NEXT:    csel x16, x2, x16, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x2, xzr, x17, eq
; GISEL-NEXT:    cmp x10, #3
; GISEL-NEXT:    orr x2, x1, x2
; GISEL-NEXT:    csel x16, x2, x16, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x2, xzr, x15, eq
; GISEL-NEXT:    cmp x10, #4
; GISEL-NEXT:    orr x2, x7, x2
; GISEL-NEXT:    csel x16, x2, x16, eq
; GISEL-NEXT:    cmp x10, #5
; GISEL-NEXT:    ldr x2, [sp, #264] ; 8-byte Reload
; GISEL-NEXT:    csel x16, x11, x16, eq
; GISEL-NEXT:    cmp x10, #6
; GISEL-NEXT:    csel x16, x11, x16, eq
; GISEL-NEXT:    cmp x10, #7
; GISEL-NEXT:    csel x16, x11, x16, eq
...
; GISEL-NEXT:    csel x2, x2, x11, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x6, xzr, x4, eq
; GISEL-NEXT:    cmp x10, #1
; GISEL-NEXT:    orr x6, x5, x6
; GISEL-NEXT:    ldp x28, x27, [sp, #352] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x2, x6, x2, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x6, xzr, x17, eq
; GISEL-NEXT:    cmp x10, #2
; GISEL-NEXT:    orr x6, x1, x6
; GISEL-NEXT:    csel x2, x6, x2, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x6, xzr, x15, eq
; GISEL-NEXT:    cmp x10, #3
...
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x5, xzr, x17, eq
; GISEL-NEXT:    cmp x10, #1
; GISEL-NEXT:    orr x5, x1, x5
; GISEL-NEXT:    csel x4, x5, x4, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x5, xzr, x15, eq
; GISEL-NEXT:    cmp x10, #2
; GISEL-NEXT:    orr x5, x7, x5
; GISEL-NEXT:    csel x4, x5, x4, eq
; GISEL-NEXT:    cmp x10, #3
...
; GISEL-NEXT:    csel x4, x5, x4, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    ldr x5, [sp, #184] ; 8-byte Reload
; GISEL-NEXT:    csel x17, xzr, x17, eq
; GISEL-NEXT:    cmp x10, #0
; GISEL-NEXT:    orr x17, x1, x17
; GISEL-NEXT:    csel x17, x17, x11, eq
; GISEL-NEXT:    tst x8, #0x3f
; GISEL-NEXT:    csel x1, xzr, x15, eq
; GISEL-NEXT:    cmp x10, #1
; GISEL-NEXT:    orr x1, x7, x1
...
; GISEL-NEXT:    cmp x10, #0
; GISEL-NEXT:    ldr x15, [sp, #312] ; 8-byte Reload
; GISEL-NEXT:    orr x14, x7, x14
; GISEL-NEXT:    csel x14, x14, x11, eq
; GISEL-NEXT:    cmp x10, #1
; GISEL-NEXT:    stp x13, x9, [x15, #64]
; GISEL-NEXT:    csel x14, x11, x14, eq
; GISEL-NEXT:    cmp x10, #2
; GISEL-NEXT:    stp x5, x1, [x15]
; GISEL-NEXT:    csel x14, x11, x14, eq
; GISEL-NEXT:    cmp x10, #3
; GISEL-NEXT:    ldr x5, [sp, #256] ; 8-byte Reload
; GISEL-NEXT:    csel x14, x11, x14, eq
; GISEL-NEXT:    cmp x10, #4
; GISEL-NEXT:    ldr x1, [sp, #232] ; 8-byte Reload
; GISEL-NEXT:    csel x14, x11, x14, eq
; GISEL-NEXT:    cmp x10, #5
; GISEL-NEXT:    stp x3, x0, [x15, #48]
; GISEL-NEXT:    csel x14, x11, x14, eq
; GISEL-NEXT:    cmp x10, #6
; GISEL-NEXT:    stp x5, x1, [x15, #16]
; GISEL-NEXT:    csel x14, x11, x14, eq
; GISEL-NEXT:    cmp x10, #7
; GISEL-NEXT:    ldr x1, [sp, #336] ; 8-byte Reload
; GISEL-NEXT:    csel x14, x11, x14, eq
; GISEL-NEXT:    cmp x10, #8
; GISEL-NEXT:    stp x12, x16, [x15, #80]
; GISEL-NEXT:    csel x14, x11, x14, eq
; GISEL-NEXT:    cmp x10, #9
; GISEL-NEXT:    stp x1, x20, [x15, #32]
; GISEL-NEXT:    csel x14, x11, x14, eq
; GISEL-NEXT:    cmp x10, #10
; GISEL-NEXT:    stp x2, x4, [x15, #96]
; GISEL-NEXT:    csel x13, x11, x14, eq
; GISEL-NEXT:    cmp x10, #11
; GISEL-NEXT:    csel x9, x11, x13, eq
; GISEL-NEXT:    cmp x10, #12
; GISEL-NEXT:    csel x9, x11, x9, eq
; GISEL-NEXT:    cmp x10, #13
; GISEL-NEXT:    csel x9, x11, x9, eq
