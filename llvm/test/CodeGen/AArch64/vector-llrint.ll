...
; CHECK-SD-NEXT:    fcvtzs x10, s19
; CHECK-SD-NEXT:    mov h19, v3.h[2]
; CHECK-SD-NEXT:    mov h25, v7.h[1]
...
; CHECK-SD-NEXT:    fcvt s21, h21
; CHECK-SD-NEXT:    fcvt s5, h5
; CHECK-SD-NEXT:    mov v23.d[1], x13
; CHECK-SD-NEXT:    mov v26.d[1], x14
; CHECK-SD-NEXT:    fcvt s4, h4
; CHECK-SD-NEXT:    frintx s22, s24
...
; CHECK-SD-NEXT:    stp q26, q23, [x8, #64]
; CHECK-SD-NEXT:    fmov d23, x15
; CHECK-SD-NEXT:    frintx s4, s4
