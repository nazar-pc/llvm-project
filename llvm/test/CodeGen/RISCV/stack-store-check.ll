...
; CHECK-NEXT:    lw s4, 52(sp) # 4-byte Folded Reload
; CHECK-NEXT:    sw s4, 232(sp)
...
; CHECK-NEXT:    sw s1, 380(sp)
; CHECK-NEXT:    sw s2, 384(sp)
; CHECK-NEXT:    sw s3, 388(sp)
; CHECK-NEXT:    call __multf3
