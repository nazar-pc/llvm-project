...
define i32 @vdot4a_vv(<16 x i8> %a, <16 x i8> %b) {
...
define i32 @vdot4a_vx_constant(<16 x i8> %a) {
; CHECK-LABEL: vdot4a_vx_constant:
; CHECK:       # %bb.0: # %entry
...
define i32 @vdot4a_vx_constant_swapped(<16 x i8> %a) {
; CHECK-LABEL: vdot4a_vx_constant_swapped:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; CHECK-NEXT:    vsext.vf2 v12, v8
; CHECK-NEXT:    li a0, 23
...
define i32 @vdot4au_vv(<16 x i8> %a, <16 x i8> %b) {
; NODOT-LABEL: vdot4au_vv:
; NODOT:       # %bb.0: # %entry
; NODOT-NEXT:    vsetivli zero, 16, e32, m1, ta, ma
; NODOT-NEXT:    vmv.s.x v12, zero
; NODOT-NEXT:    vsetivli zero, 16, e8, m1, ta, ma
; NODOT-NEXT:    vwmulu.vv v10, v8, v9
; NODOT-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; NODOT-NEXT:    vwredsumu.vs v8, v10, v12
; NODOT-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; NODOT-NEXT:    vmv.x.s a0, v8
; NODOT-NEXT:    ret
;
; DOT-LABEL: vdot4au_vv:
; DOT:       # %bb.0: # %entry
; DOT-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; DOT-NEXT:    vmv.v.i v10, 0
; DOT-NEXT:    vdot4au.vv v10, v8, v9
; DOT-NEXT:    vmv.s.x v8, zero
; DOT-NEXT:    vredsum.vs v8, v10, v8
; DOT-NEXT:    vmv.x.s a0, v8
; DOT-NEXT:    ret
...
define i32 @vdot4au_vx_constant(<16 x i8> %a) {
; CHECK-LABEL: vdot4au_vx_constant:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
...
define i32 @vdot4asu_vv(<16 x i8> %a, <16 x i8> %b) {
...
; NODOT-NEXT:    ret
;
; DOT-LABEL: vdot4asu_vv:
; DOT:       # %bb.0: # %entry
; DOT-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; DOT-NEXT:    vmv.v.i v10, 0
; DOT-NEXT:    vdot4asu.vv v10, v8, v9
; DOT-NEXT:    vmv.s.x v8, zero
; DOT-NEXT:    vredsum.vs v8, v10, v8
; DOT-NEXT:    vmv.x.s a0, v8
; DOT-NEXT:    ret
...
define i32 @vdot4asu_vv_swapped(<16 x i8> %a, <16 x i8> %b) {
...
define i32 @vdot4a_vv_accum(<16 x i8> %a, <16 x i8> %b, <16 x i32> %x) {
; NODOT-LABEL: vdot4a_vv_accum:
; NODOT:       # %bb.0: # %entry
; NODOT-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; NODOT-NEXT:    vsext.vf2 v10, v9
; NODOT-NEXT:    vsext.vf2 v16, v8
; NODOT-NEXT:    vwmacc.vv v12, v16, v10
; NODOT-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; NODOT-NEXT:    vmv.s.x v8, zero
; NODOT-NEXT:    vredsum.vs v8, v12, v8
; NODOT-NEXT:    vmv.x.s a0, v8
...
define i32 @vdot4au_vv_accum(<16 x i8> %a, <16 x i8> %b, <16 x i32> %x) {
; NODOT-LABEL: vdot4au_vv_accum:
; NODOT:       # %bb.0: # %entry
; NODOT-NEXT:    vsetivli zero, 16, e8, m1, ta, ma
; NODOT-NEXT:    vwmulu.vv v10, v8, v9
; NODOT-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
...
define i32 @vdot4asu_vv_accum(<16 x i8> %a, <16 x i8> %b, <16 x i32> %x) {
; NODOT-LABEL: vdot4asu_vv_accum:
; NODOT:       # %bb.0: # %entry
; NODOT-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; NODOT-NEXT:    vzext.vf2 v10, v9
; NODOT-NEXT:    vsext.vf2 v16, v8
; NODOT-NEXT:    vwmaccsu.vv v12, v16, v10
; NODOT-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; NODOT-NEXT:    vmv.s.x v8, zero
; NODOT-NEXT:    vredsum.vs v8, v12, v8
; NODOT-NEXT:    vmv.x.s a0, v8
...
; DOT-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; DOT-NEXT:    vmv1r.v v16, v12
; DOT-NEXT:    vdot4asu.vv v16, v8, v9
; DOT-NEXT:    vsetivli zero, 4, e32, m4, tu, ma
; DOT-NEXT:    vmv.v.v v12, v16
; DOT-NEXT:    vmv.s.x v8, zero
; DOT-NEXT:    vsetivli zero, 16, e32, m4, ta, ma
...
define i32 @vdot4a_vv_scalar_add(<16 x i8> %a, <16 x i8> %b, i32 %x) {
...
; NODOT-NEXT:    ret
;
; DOT-LABEL: vdot4a_vv_scalar_add:
; DOT:       # %bb.0: # %entry
; DOT-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; DOT-NEXT:    vmv.v.i v10, 0
; DOT-NEXT:    vdot4a.vv v10, v8, v9
...
define i32 @vdot4au_vv_scalar_add(<16 x i8> %a, <16 x i8> %b, i32 %x) {
; NODOT-LABEL: vdot4au_vv_scalar_add:
; NODOT:       # %bb.0: # %entry
; NODOT-NEXT:    vsetivli zero, 16, e32, m1, ta, ma
; NODOT-NEXT:    vmv.s.x v12, a0
; NODOT-NEXT:    vsetivli zero, 16, e8, m1, ta, ma
...
; NODOT-NEXT:    ret
;
; DOT-LABEL: vdot4au_vv_scalar_add:
; DOT:       # %bb.0: # %entry
; DOT-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; DOT-NEXT:    vmv.v.i v10, 0
; DOT-NEXT:    vdot4au.vv v10, v8, v9
...
define i32 @vdot4asu_vv_scalar_add(<16 x i8> %a, <16 x i8> %b, i32 %x) {
...
; NODOT-NEXT:    ret
;
; DOT-LABEL: vdot4asu_vv_scalar_add:
; DOT:       # %bb.0: # %entry
; DOT-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; DOT-NEXT:    vmv.v.i v10, 0
; DOT-NEXT:    vdot4asu.vv v10, v8, v9
...
define i32 @vdot4a_vv_split(<16 x i8> %a, <16 x i8> %b, <16 x i8> %c, <16 x i8> %d) {
...
define <1 x i32> @vdot4a_vv_partial_reduce_v1i32_v4i8(<4 x i8> %a, <4 x i8> %b) {
; NODOT-LABEL: vdot4a_vv_partial_reduce_v1i32_v4i8:
; NODOT:       # %bb.0: # %entry
...
; NODOT-NEXT:    vslidedown.vi v11, v9, 1
; NODOT-NEXT:    vsetivli zero, 1, e32, mf2, ta, ma
; NODOT-NEXT:    vadd.vv v8, v8, v9
; NODOT-NEXT:    vadd.vv v9, v11, v10
; NODOT-NEXT:    vadd.vv v8, v9, v8
; NODOT-NEXT:    ret
;
; DOT-LABEL: vdot4a_vv_partial_reduce_v1i32_v4i8:
; DOT:       # %bb.0: # %entry
...
define <1 x i32> @vdot4au_vv_partial_reduce_v1i32_v4i8(<4 x i8> %a, <4 x i8> %b) {
; NODOT-LABEL: vdot4au_vv_partial_reduce_v1i32_v4i8:
; NODOT:       # %bb.0: # %entry
...
; NODOT-NEXT:    vslidedown.vi v11, v8, 1
; NODOT-NEXT:    vsetivli zero, 1, e32, mf2, ta, ma
; NODOT-NEXT:    vadd.vv v8, v9, v8
; NODOT-NEXT:    vadd.vv v9, v11, v10
; NODOT-NEXT:    vadd.vv v8, v9, v8
; NODOT-NEXT:    ret
;
; DOT-LABEL: vdot4au_vv_partial_reduce_v1i32_v4i8:
; DOT:       # %bb.0: # %entry
; DOT-NEXT:    vsetivli zero, 1, e32, mf2, ta, ma
; DOT-NEXT:    vmv.s.x v10, zero
; DOT-NEXT:    vdot4au.vv v10, v8, v9
...
define <1 x i32> @vdot4au_vx_partial_reduce(<4 x i8> %a, <4 x i8> %b) {
; NODOT-LABEL: vdot4au_vx_partial_reduce:
; NODOT:       # %bb.0: # %entry
...
; NODOT-NEXT:    ret
;
; DOT-LABEL: vdot4au_vx_partial_reduce:
; DOT:       # %bb.0: # %entry
; DOT-NEXT:    li a0, 128
; DOT-NEXT:    vsetivli zero, 4, e8, mf4, ta, ma
; DOT-NEXT:    vmv.v.x v10, a0
; DOT-NEXT:    vsetvli zero, zero, e32, m1, ta, ma
; DOT-NEXT:    vmv.s.x v9, zero
; DOT-NEXT:    vsetivli zero, 1, e32, mf2, ta, ma
; DOT-NEXT:    vdot4au.vv v9, v8, v10
...
define <1 x i32> @vdot4a_vx_partial_reduce(<4 x i8> %a, <4 x i8> %b) {
; NODOT-LABEL: vdot4a_vx_partial_reduce:
; NODOT:       # %bb.0: # %entry
; NODOT-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
...
; NODOT-NEXT:    ret
;
; DOT-LABEL: vdot4a_vx_partial_reduce:
; DOT:       # %bb.0: # %entry
; DOT-NEXT:    li a0, 128
; DOT-NEXT:    vsetivli zero, 4, e8, mf4, ta, ma
; DOT-NEXT:    vmv.v.x v10, a0
...
define <1 x i32> @vdot4asu_vv_partial_reduce_v1i32_v4i8(<4 x i8> %a, <4 x i8> %b) {
; NODOT-LABEL: vdot4asu_vv_partial_reduce_v1i32_v4i8:
; NODOT:       # %bb.0: # %entry
; NODOT-NEXT:    vsetivli zero, 4, e16, mf2, ta, ma
; NODOT-NEXT:    vsext.vf2 v10, v8
...
; NODOT-NEXT:    ret
;
; DOT-LABEL: vdot4asu_vv_partial_reduce_v1i32_v4i8:
; DOT:       # %bb.0: # %entry
; DOT-NEXT:    vsetivli zero, 1, e32, mf2, ta, ma
; DOT-NEXT:    vmv.s.x v10, zero
; DOT-NEXT:    vdot4asu.vv v10, v8, v9
...
define <1 x i32> @vdot4asu_vv_partial_reduce_swapped(<4 x i8> %a, <4 x i8> %b) {
; NODOT-LABEL: vdot4asu_vv_partial_reduce_swapped:
; NODOT:       # %bb.0: # %entry
; NODOT-NEXT:    vsetivli zero, 4, e16, mf2, ta, ma
; NODOT-NEXT:    vsext.vf2 v10, v8
; NODOT-NEXT:    vzext.vf2 v8, v9
...
; NODOT-NEXT:    ret
;
; DOT-LABEL: vdot4asu_vv_partial_reduce_swapped:
; DOT:       # %bb.0: # %entry
; DOT-NEXT:    vsetivli zero, 1, e32, mf2, ta, ma
; DOT-NEXT:    vmv.s.x v10, zero
; DOT-NEXT:    vdot4asu.vv v10, v8, v9
...
define <1 x i32> @vdot4asu_vx_partial_reduce(<4 x i8> %a, <4 x i8> %b) {
; CHECK-LABEL: vdot4asu_vx_partial_reduce:
; CHECK:       # %bb.0: # %entry
...
define <2 x i32> @vdot4a_vv_partial_reduce_v2i32_v8i8(<8 x i8> %a, <8 x i8> %b) {
; NODOT-LABEL: vdot4a_vv_partial_reduce_v2i32_v8i8:
; NODOT:       # %bb.0: # %entry
...
; NODOT-NEXT:    vslidedown.vi v12, v8, 4
; NODOT-NEXT:    vsetivli zero, 2, e32, m1, ta, ma
; NODOT-NEXT:    vslidedown.vi v9, v8, 2
; NODOT-NEXT:    vsetivli zero, 2, e32, mf2, ta, ma
; NODOT-NEXT:    vadd.vv v8, v10, v8
; NODOT-NEXT:    vadd.vv v9, v9, v12
; NODOT-NEXT:    vadd.vv v8, v9, v8
; NODOT-NEXT:    ret
;
; DOT-LABEL: vdot4a_vv_partial_reduce_v2i32_v8i8:
; DOT:       # %bb.0: # %entry
...
define <2 x i32> @vdot4a_vv_partial_reduce_v2i32_v64i8(<64 x i8> %a, <64 x i8> %b) {
; CHECK-LABEL: vdot4a_vv_partial_reduce_v2i32_v64i8:
; CHECK:       # %bb.0: # %entry
...
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0e, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0x90, 0x01, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 144 * vlenb
; CHECK-NEXT:    li a0, 32
...
; CHECK-NEXT:    vwmul.vv v8, v20, v24
; CHECK-NEXT:    vsetivli zero, 2, e32, m8, ta, ma
...
; CHECK-NEXT:    vslidedown.vi v12, v16, 14
; CHECK-NEXT:    csrr a0, vlenb
; CHECK-NEXT:    slli a0, a0, 2
; CHECK-NEXT:    add a0, sp, a0
; CHECK-NEXT:    addi a0, a0, 16
...
; CHECK-NEXT:    vslidedown.vi v20, v8, 12
; CHECK-NEXT:    csrr a0, vlenb
; CHECK-NEXT:    slli a0, a0, 4
; CHECK-NEXT:    add a0, sp, a0
; CHECK-NEXT:    addi a0, a0, 16
...
; CHECK-NEXT:    addi a0, a0, 16
; CHECK-NEXT:    vs4r.v v20, (a0) # vscale x 32-byte Folded Spill
; CHECK-NEXT:    vslidedown.vi v20, v8, 8
; CHECK-NEXT:    csrr a0, vlenb
; CHECK-NEXT:    slli a0, a0, 3
; CHECK-NEXT:    add a0, sp, a0
; CHECK-NEXT:    addi a0, a0, 16
...
; CHECK-NEXT:    vslidedown.vi v10, v16, 6
; CHECK-NEXT:    vslidedown.vi v14, v16, 4
; CHECK-NEXT:    vslidedown.vi v26, v8, 6
; CHECK-NEXT:    vslidedown.vi v30, v8, 4
; CHECK-NEXT:    vsetivli zero, 2, e32, m1, ta, ma
; CHECK-NEXT:    vslidedown.vi v9, v16, 2
; CHECK-NEXT:    csrr a0, vlenb
; CHECK-NEXT:    slli a0, a0, 3
; CHECK-NEXT:    mv a1, a0
; CHECK-NEXT:    slli a0, a0, 4
...
; CHECK-NEXT:    vadd.vv v14, v16, v24
...
; CHECK-NEXT:    addi a0, a0, 16
; CHECK-NEXT:    vl4r.v v20, (a0) # vscale x 32-byte Folded Reload
; CHECK-NEXT:    vadd.vv v9, v20, v16
; CHECK-NEXT:    csrr a0, vlenb
; CHECK-NEXT:    slli a0, a0, 3
; CHECK-NEXT:    add a0, sp, a0
; CHECK-NEXT:    addi a0, a0, 16
; CHECK-NEXT:    vl4r.v v16, (a0) # vscale x 32-byte Folded Reload
; CHECK-NEXT:    vadd.vv v15, v26, v16
; CHECK-NEXT:    vadd.vv v10, v10, v30
; CHECK-NEXT:    vadd.vv v8, v12, v8
; CHECK-NEXT:    vadd.vv v11, v13, v11
; CHECK-NEXT:    vadd.vv v9, v9, v14
; CHECK-NEXT:    vadd.vv v10, v10, v15
...
define <4 x i32> @vdot4a_vv_partial_reduce_v4i32_v16i8(<16 x i8> %a, <16 x i8> %b) {
; NODOT-LABEL: vdot4a_vv_partial_reduce_v4i32_v16i8:
; NODOT:       # %bb.0: # %entry
; NODOT-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; NODOT-NEXT:    vsext.vf2 v12, v8
; NODOT-NEXT:    vsext.vf2 v14, v9
...
; NODOT-NEXT:    vslidedown.vi v16, v8, 8
; NODOT-NEXT:    vsetivli zero, 4, e32, m2, ta, ma
; NODOT-NEXT:    vslidedown.vi v10, v8, 4
; NODOT-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; NODOT-NEXT:    vadd.vv v8, v12, v8
; NODOT-NEXT:    vadd.vv v9, v10, v16
; NODOT-NEXT:    vadd.vv v8, v9, v8
; NODOT-NEXT:    ret
;
; DOT-LABEL: vdot4a_vv_partial_reduce_v4i32_v16i8:
; DOT:       # %bb.0: # %entry
; DOT-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; DOT-NEXT:    vmv.v.i v10, 0
; DOT-NEXT:    vdot4a.vv v10, v8, v9
...
define <16 x i32> @vdot4a_vv_partial_reduce_v16i32_v64i8(<64 x i8> %a, <64 x i8> %b) {
; NODOT-LABEL: vdot4a_vv_partial_reduce_v16i32_v64i8:
; NODOT:       # %bb.0: # %entry
; NODOT-NEXT:    li a0, 32
...
; NODOT-NEXT:    vslidedown.vi v24, v16, 16
...
; NODOT-NEXT:    vsext.vf2 v28, v12
; NODOT-NEXT:    vwmul.vv v8, v20, v28
; NODOT-NEXT:    vsetivli zero, 16, e32, m8, ta, ma
; NODOT-NEXT:    vslidedown.vi v0, v8, 16
; NODOT-NEXT:    vsetivli zero, 16, e32, m4, ta, ma
; NODOT-NEXT:    vadd.vv v8, v16, v8
; NODOT-NEXT:    vadd.vv v8, v24, v8
; NODOT-NEXT:    vadd.vv v8, v0, v8
; NODOT-NEXT:    ret
;
; DOT-LABEL: vdot4a_vv_partial_reduce_v16i32_v64i8:
; DOT:       # %bb.0: # %entry
; DOT-NEXT:    vsetivli zero, 16, e32, m4, ta, ma
; DOT-NEXT:    vmv.v.i v16, 0
; DOT-NEXT:    vdot4a.vv v16, v8, v12
...
define <4 x i32> @vdot4a_vv_partial_reduce_m1_accum(<16 x i8> %a, <16 x i8> %b, <4 x i32> %accum) {
; NODOT-LABEL: vdot4a_vv_partial_reduce_m1_accum:
; NODOT:       # %bb.0: # %entry
; NODOT-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; NODOT-NEXT:    vsext.vf2 v16, v9
; NODOT-NEXT:    vsext.vf2 v18, v8
; NODOT-NEXT:    vwmul.vv v12, v18, v16
; NODOT-NEXT:    vsetivli zero, 4, e32, m4, ta, ma
; NODOT-NEXT:    vslidedown.vi v16, v12, 12
; NODOT-NEXT:    vslidedown.vi v20, v12, 8
; NODOT-NEXT:    vsetivli zero, 4, e32, m2, ta, ma
; NODOT-NEXT:    vslidedown.vi v8, v12, 4
; NODOT-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; NODOT-NEXT:    vadd.vv v9, v10, v12
; NODOT-NEXT:    vadd.vv v9, v16, v9
; NODOT-NEXT:    vadd.vv v8, v8, v20
; NODOT-NEXT:    vadd.vv v8, v8, v9
; NODOT-NEXT:    ret
;
; DOT-LABEL: vdot4a_vv_partial_reduce_m1_accum:
; DOT:       # %bb.0: # %entry
; DOT-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; DOT-NEXT:    vdot4a.vv v10, v8, v9
; DOT-NEXT:    vmv.v.v v8, v10
...
define <16 x i32> @vdot4a_vv_partial_reduce3(<16 x i8> %a, <16 x i8> %b) {
; CHECK-LABEL: vdot4a_vv_partial_reduce3:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; CHECK-NEXT:    vsext.vf2 v12, v8
...
define <64 x i32> @vdot4asu_vv_partial_v64i32_v256i8(<256 x i8> %a, <256 x i8> %b) {
; NODOT-LABEL: vdot4asu_vv_partial_v64i32_v256i8:
; NODOT:       # %bb.0: # %entry
; NODOT-NEXT:    addi sp, sp, -16
; NODOT-NEXT:    .cfi_def_cfa_offset 16
; NODOT-NEXT:    csrr a1, vlenb
; NODOT-NEXT:    slli a1, a1, 6
; NODOT-NEXT:    sub sp, sp, a1
; NODOT-NEXT:    .cfi_escape 0x0f, 0x0e, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0xc0, 0x00, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 64 * vlenb
; NODOT-NEXT:    csrr a1, vlenb
...
; NODOT-NEXT:    addi a3, a0, 128
; NODOT-NEXT:    vslidedown.vx v8, v24, a1
; NODOT-NEXT:    csrr a4, vlenb
; NODOT-NEXT:    slli a4, a4, 5
; NODOT-NEXT:    add a4, sp, a4
; NODOT-NEXT:    addi a4, a4, 16
; NODOT-NEXT:    vs8r.v v8, (a4) # vscale x 64-byte Folded Spill
; NODOT-NEXT:    vsetvli zero, a2, e8, m8, ta, ma
; NODOT-NEXT:    vle8.v v0, (a3)
; NODOT-NEXT:    vsetvli zero, a1, e8, m8, ta, ma
; NODOT-NEXT:    vslidedown.vx v8, v0, a1
; NODOT-NEXT:    csrr a3, vlenb
; NODOT-NEXT:    slli a3, a3, 3
; NODOT-NEXT:    mv a4, a3
; NODOT-NEXT:    slli a3, a3, 2
; NODOT-NEXT:    add a3, a3, a4
; NODOT-NEXT:    add a3, sp, a3
; NODOT-NEXT:    addi a3, a3, 16
; NODOT-NEXT:    vs8r.v v8, (a3) # vscale x 64-byte Folded Spill
; NODOT-NEXT:    vsetvli zero, a2, e8, m8, ta, ma
; NODOT-NEXT:    vle8.v v8, (a0)
; NODOT-NEXT:    vsetvli zero, a1, e8, m8, ta, ma
...
; NODOT-NEXT:    add a1, sp, a1
; NODOT-NEXT:    addi a1, a1, 16
; NODOT-NEXT:    vl8r.v v24, (a1) # vscale x 64-byte Folded Reload
; NODOT-NEXT:    vsetvli zero, a0, e8, m4, ta, ma
; NODOT-NEXT:    vslidedown.vx v12, v24, a0
; NODOT-NEXT:    csrr a1, vlenb
...
; NODOT-NEXT:    addi a1, a1, 16
; NODOT-NEXT:    vl8r.v v24, (a1) # vscale x 64-byte Folded Reload
; NODOT-NEXT:    vslidedown.vx v4, v24, a0
; NODOT-NEXT:    csrr a1, vlenb
; NODOT-NEXT:    slli a1, a1, 4
; NODOT-NEXT:    mv a2, a1
; NODOT-NEXT:    slli a1, a1, 1
...
; NODOT-NEXT:    addi a1, a1, 16
; NODOT-NEXT:    vs4r.v v12, (a1) # vscale x 32-byte Folded Spill
; NODOT-NEXT:    vslidedown.vx v12, v8, a0
; NODOT-NEXT:    vslidedown.vx v20, v0, a0
...
; NODOT-NEXT:    vl8r.v v24, (a1) # vscale x 64-byte Folded Reload
; NODOT-NEXT:    vsetvli zero, a0, e16, m4, ta, ma
; NODOT-NEXT:    vsext.vf2 v28, v24
; NODOT-NEXT:    vzext.vf2 v24, v8
; NODOT-NEXT:    vsext.vf2 v20, v4
; NODOT-NEXT:    vzext.vf2 v4, v12
; NODOT-NEXT:    vwmulsu.vv v8, v20, v4
; NODOT-NEXT:    vwmaccsu.vv v8, v28, v24
; NODOT-NEXT:    csrr a0, vlenb
; NODOT-NEXT:    slli a0, a0, 5
; NODOT-NEXT:    add a0, sp, a0
; NODOT-NEXT:    addi a0, a0, 16
; NODOT-NEXT:    vl8r.v v24, (a0) # vscale x 64-byte Folded Reload
; NODOT-NEXT:    vsext.vf2 v20, v24
; NODOT-NEXT:    vzext.vf2 v24, v16
; NODOT-NEXT:    vwmaccsu.vv v8, v20, v24
; NODOT-NEXT:    csrr a0, vlenb
...
; NODOT-NEXT:    add a0, sp, a0
; NODOT-NEXT:    addi a0, a0, 16
; NODOT-NEXT:    vl4r.v v24, (a0) # vscale x 32-byte Folded Reload
; NODOT-NEXT:    vzext.vf2 v20, v24
; NODOT-NEXT:    vwmaccsu.vv v8, v16, v20
; NODOT-NEXT:    csrr a0, vlenb
...
; NODOT-NEXT:    vl4r.v v16, (a0) # vscale x 32-byte Folded Reload
; NODOT-NEXT:    vzext.vf2 v0, v16
; NODOT-NEXT:    vwmulsu.vv v16, v4, v0
; NODOT-NEXT:    vwmaccsu.vv v16, v24, v28
; NODOT-NEXT:    csrr a0, vlenb
; NODOT-NEXT:    slli a0, a0, 3
; NODOT-NEXT:    mv a1, a0
; NODOT-NEXT:    slli a0, a0, 1
...
; NODOT-NEXT:    add a0, sp, a0
; NODOT-NEXT:    addi a0, a0, 16
; NODOT-NEXT:    vl4r.v v28, (a0) # vscale x 32-byte Folded Reload
; NODOT-NEXT:    vsext.vf2 v24, v28
; NODOT-NEXT:    csrr a0, vlenb
; NODOT-NEXT:    slli a0, a0, 4
; NODOT-NEXT:    add a0, sp, a0
; NODOT-NEXT:    addi a0, a0, 16
; NODOT-NEXT:    vl4r.v v4, (a0) # vscale x 32-byte Folded Reload
; NODOT-NEXT:    vzext.vf2 v28, v4
; NODOT-NEXT:    vwmaccsu.vv v16, v24, v28
; NODOT-NEXT:    csrr a0, vlenb
; NODOT-NEXT:    slli a0, a0, 6
...
; NODOT-NEXT:    ret
;
; DOT-LABEL: vdot4asu_vv_partial_v64i32_v256i8:
; DOT:       # %bb.0: # %entry
...
; DOT-NEXT:    csrr a2, vlenb
; DOT-NEXT:    slli a2, a2, 3
; DOT-NEXT:    add a2, sp, a2
; DOT-NEXT:    addi a2, a2, 16
; DOT-NEXT:    vs8r.v v8, (a2) # vscale x 64-byte Folded Spill
; DOT-NEXT:    vmv8r.v v0, v24
; DOT-NEXT:    addi a0, a0, 128
; DOT-NEXT:    vle8.v v8, (a0)
...
; DOT-NEXT:    addi a0, sp, 16
; DOT-NEXT:    vl8r.v v8, (a0) # vscale x 64-byte Folded Reload
; DOT-NEXT:    vdot4asu.vv v24, v16, v8
...
define <4 x i31> @vdot4asu_vv_partial_v4i31_v16i7(<16 x i7> %a, <16 x i7> %b) {
; NODOT-LABEL: vdot4asu_vv_partial_v4i31_v16i7:
; NODOT:       # %bb.0: # %entry
; NODOT-NEXT:    li a0, 127
; NODOT-NEXT:    vsetivli zero, 16, e32, m4, ta, ma
; NODOT-NEXT:    vzext.vf4 v12, v8
; NODOT-NEXT:    vsll.vi v12, v12, 25
; NODOT-NEXT:    vsra.vi v12, v12, 25
; NODOT-NEXT:    vsetvli zero, zero, e8, m1, ta, ma
; NODOT-NEXT:    vand.vx v16, v9, a0
; NODOT-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; NODOT-NEXT:    vzext.vf4 v8, v16
; NODOT-NEXT:    vmul.vv v8, v8, v12
...
; NODOT-NEXT:    ret
;
; DOT-LABEL: vdot4asu_vv_partial_v4i31_v16i7:
; DOT:       # %bb.0: # %entry
; DOT-NEXT:    li a0, 127
; DOT-NEXT:    vsetivli zero, 16, e8, m1, ta, ma
...
; DOT-NEXT:    vdot4asu.vv v8, v10, v9
; DOT-NEXT:    ret
entry:
...
define <1 x i32> @vdot4asu_vv_partial_v1i32_v2i8(<2 x i8> %a, <2 x i8> %b) {
; CHECK-LABEL: vdot4asu_vv_partial_v1i32_v2i8:
; CHECK:       # %bb.0: # %entry
...
; a pair of slides + two vdot4asu_vv here.  Or alternatively, the mul
; sequence + one vredsum, or a vadd reduce tree.
define <1 x i32> @vdot4asu_vv_partial_v1i32_v8i8(<8 x i8> %a, <8 x i8> %b) {
; CHECK-LABEL: vdot4asu_vv_partial_v1i32_v8i8:
; CHECK:       # %bb.0: # %entry
...
; NODOT-NEXT:    vslidedown.vi v16, v12, 8
; NODOT-NEXT:    vsetivli zero, 4, e32, m2, ta, ma
...
define i32 @vdot4a_vv_accum_disjoint_or(<16 x i8> %a, <16 x i8> %b, <16 x i32> %x) {
; NODOT-LABEL: vdot4a_vv_accum_disjoint_or:
; NODOT:       # %bb.0: # %entry
; NODOT-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; NODOT-NEXT:    vsext.vf2 v16, v8
...
; NODOT-NEXT:    ret
;
; DOT-LABEL: vdot4a_vv_accum_disjoint_or:
; DOT:       # %bb.0: # %entry
; DOT-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; DOT-NEXT:    vmv1r.v v16, v12
; DOT-NEXT:    vdot4a.vv v16, v8, v9
...
define i32 @vdot4a_vv_accum_or(<16 x i8> %a, <16 x i8> %b, <16 x i32> %x) {
; CHECK-LABEL: vdot4a_vv_accum_or:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
...
define i32 @vdot4au_vv_accum_disjoint_or(<16 x i8> %a, <16 x i8> %b, <16 x i32> %x) {
; NODOT-LABEL: vdot4au_vv_accum_disjoint_or:
; NODOT:       # %bb.0: # %entry
; NODOT-NEXT:    vsetivli zero, 16, e8, m1, ta, ma
; NODOT-NEXT:    vwmulu.vv v10, v8, v9
; NODOT-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
...
; NODOT-NEXT:    ret
;
; DOT-LABEL: vdot4au_vv_accum_disjoint_or:
; DOT:       # %bb.0: # %entry
; DOT-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; DOT-NEXT:    vmv1r.v v16, v12
; DOT-NEXT:    vdot4au.vv v16, v8, v9
...
define i32 @vdot4asu_vv_accum_disjoint_or(<16 x i8> %a, <16 x i8> %b, <16 x i32> %x) {
; NODOT-LABEL: vdot4asu_vv_accum_disjoint_or:
; NODOT:       # %bb.0: # %entry
; NODOT-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; NODOT-NEXT:    vsext.vf2 v16, v8
...
; NODOT-NEXT:    ret
;
; DOT-LABEL: vdot4asu_vv_accum_disjoint_or:
; DOT:       # %bb.0: # %entry
; DOT-NEXT:    vsetivli zero, 4, e32, m1, ta, ma
; DOT-NEXT:    vmv1r.v v16, v12
; DOT-NEXT:    vdot4asu.vv v16, v8, v9
