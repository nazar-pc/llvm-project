...
; RV64-NEXT:    addi a1, a1, 32
; RV64-NEXT:    vl8r.v v8, (a1) # vscale x 64-byte Folded Reload
; RV64-NEXT:    vsub.vv v24, v8, v24
; RV64-NEXT:    vl8re64.v v16, (s1)
; RV64-NEXT:    csrr a1, vlenb
