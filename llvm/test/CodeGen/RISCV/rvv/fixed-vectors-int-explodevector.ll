...
; RV32-NEXT:    addi a1, a1, 16
; RV32-NEXT:    vs4r.v v16, (a1) # vscale x 32-byte Folded Spill
; RV32-NEXT:    vsrl.vx v0, v12, a0
; RV32-NEXT:    vsrl.vx v16, v20, a0
...
; RV32-NEXT:    mul s10, s10, s11
; RV32-NEXT:    lw s11, 4(sp) # 4-byte Folded Reload
; RV32-NEXT:    add s10, sp, s10
; RV32-NEXT:    addi s10, s10, 32
; RV32-NEXT:    vl8r.v v8, (s10) # vscale x 64-byte Folded Reload
; RV32-NEXT:    vmv.x.s s10, v8
; RV32-NEXT:    add a5, s9, a5
; RV32-NEXT:    sltu s9, a5, s9
; RV32-NEXT:    add a0, a0, s9
; RV32-NEXT:    add a0, a0, a4
; RV32-NEXT:    add a6, a5, a6
; RV32-NEXT:    csrr a4, vlenb
; RV32-NEXT:    li s9, 88
; RV32-NEXT:    mul a4, a4, s9
...
; RV32-NEXT:    sltu a5, t5, t3
; RV32-NEXT:    add s0, t5, s0
; RV32-NEXT:    add a5, a5, t6
; RV32-NEXT:    sltu a6, s0, t5
; RV32-NEXT:    add a0, a0, a1
...
; RV32-NEXT:    vmv.x.s a1, v8
; RV32-NEXT:    sltu a6, s2, s0
; RV32-NEXT:    sltu a7, s3, s2
; RV32-NEXT:    add a3, a3, a7
; RV32-NEXT:    add s5, s3, s5
; RV32-NEXT:    add a3, a3, s4
; RV32-NEXT:    sltu a7, s5, s3
; RV32-NEXT:    add a5, a5, a6
; RV32-NEXT:    add a3, a3, a7
; RV32-NEXT:    add a5, a0, a5
; RV32-NEXT:    add a3, a3, s6
; RV32-NEXT:    add s7, s5, s7
; RV32-NEXT:    vmv.x.s a6, v0
; RV32-NEXT:    sltu a0, s7, s5
; RV32-NEXT:    add s10, s7, s10
; RV32-NEXT:    add a3, a3, a0
; RV32-NEXT:    sltu a0, s10, s7
; RV32-NEXT:    add a0, s8, a0
; RV32-NEXT:    add a2, s10, a2
; RV32-NEXT:    add a0, a0, a4
; RV32-NEXT:    sltu a4, a2, s10
; RV32-NEXT:    add a4, a0, a4
; RV32-NEXT:    add a0, a2, a1
