...
; RV64I-NEXT:    srli a6, a3, 56
; RV64I-NEXT:    srli t1, a3, 48
; RV64I-NEXT:    srli t2, a3, 40
; RV64I-NEXT:    srli t3, a3, 32
; RV64I-NEXT:    sb t3, 28(a2)
; RV64I-NEXT:    sb t2, 29(a2)
; RV64I-NEXT:    sb t1, 30(a2)
; RV64I-NEXT:    sb a6, 31(a2)
; RV64I-NEXT:    srli a6, a3, 24
...
; RV32I-NEXT:    srli s2, a5, 16
; RV32I-NEXT:    srli s3, a5, 8
...
; RV32I-NEXT:    srli t0, t1, 8
; RV32I-NEXT:    sb a6, 8(a2)
; RV32I-NEXT:    sb t0, 9(a2)
; RV32I-NEXT:    sb a7, 10(a2)
; RV32I-NEXT:    sb a5, 11(a2)
; RV32I-NEXT:    srli a5, t5, 24
; RV32I-NEXT:    srli a6, t5, 16
; RV32I-NEXT:    srli a7, t5, 8
...
; RV32I-NEXT:    sub a7, a4, a0
; RV32I-NEXT:    lw t0, 0(a7)
; RV32I-NEXT:    lw a5, 4(a7)
; RV32I-NEXT:    slli t1, a1, 3
; RV32I-NEXT:    lw a6, 8(a7)
; RV32I-NEXT:    andi a0, t1, 24
; RV32I-NEXT:    lw t2, 12(a7)
; RV32I-NEXT:    xori t3, a0, 31
; RV32I-NEXT:    srli a0, t0, 1
; RV32I-NEXT:    sll a1, a5, t1
; RV32I-NEXT:    srl a0, a0, t3
; RV32I-NEXT:    or a0, a1, a0
; RV32I-NEXT:    srli a3, a6, 1
; RV32I-NEXT:    sll a4, t2, t1
; RV32I-NEXT:    srl a3, a3, t3
; RV32I-NEXT:    or a3, a4, a3
; RV32I-NEXT:    lw t4, 16(a7)
; RV32I-NEXT:    srli a5, a5, 1
; RV32I-NEXT:    lw t5, 20(a7)
; RV32I-NEXT:    sll a6, a6, t1
; RV32I-NEXT:    srl a5, a5, t3
; RV32I-NEXT:    or a5, a6, a5
; RV32I-NEXT:    lw t6, 24(a7)
; RV32I-NEXT:    lw a7, 28(a7)
; RV32I-NEXT:    srli s0, t4, 1
; RV32I-NEXT:    sll s1, t5, t1
; RV32I-NEXT:    srl s0, s0, t3
; RV32I-NEXT:    or s0, s1, s0
; RV32I-NEXT:    srli t2, t2, 1
; RV32I-NEXT:    sll t4, t4, t1
; RV32I-NEXT:    srl t2, t2, t3
; RV32I-NEXT:    or t2, t4, t2
; RV32I-NEXT:    srli s2, t6, 1
; RV32I-NEXT:    sll a7, a7, t1
; RV32I-NEXT:    srl s2, s2, t3
; RV32I-NEXT:    or s2, a7, s2
; RV32I-NEXT:    srli t5, t5, 1
; RV32I-NEXT:    sll t6, t6, t1
; RV32I-NEXT:    srl t3, t5, t3
; RV32I-NEXT:    or t3, t6, t3
; RV32I-NEXT:    sll t0, t0, t1
; RV32I-NEXT:    srli t1, t6, 24
; RV32I-NEXT:    srli t5, t3, 16
...
; RV64I-NEXT:    srli a3, t0, 48
; RV64I-NEXT:    srli a5, t0, 32
...
; RV64I-NEXT:    srli a3, t1, 16
; RV64I-NEXT:    srli a4, t1, 8
...
; RV64I-NEXT:    sll a5, t1, a5
; RV64I-NEXT:    or a5, a3, a5
; RV64I-NEXT:    sra a1, a7, a1
; RV64I-NEXT:    srli a7, a3, 24
; RV64I-NEXT:    srli t1, a3, 16
; RV64I-NEXT:    srli t2, a3, 8
; RV64I-NEXT:    sb a3, 16(a2)
; RV64I-NEXT:    sb t2, 17(a2)
