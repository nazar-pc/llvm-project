...
; CHECK-NEXT:    asr.w r12, r4, #31
; CHECK-NEXT:    ldr r4, [r5]
; CHECK-NEXT:    adc r11, r12, #0
; CHECK-NEXT:    mov r12, r3
; CHECK-NEXT:    muls r0, r4, r0
; CHECK-NEXT:    add.w r0, r0, #-2147483648
; CHECK-NEXT:    asrl r8, r11, r0
; CHECK-NEXT:    smull r0, r5, r4, r8
; CHECK-NEXT:    lsll r0, r5, #30
; CHECK-NEXT:    asrs r3, r5, #31
; CHECK-NEXT:    mov r0, r5
; CHECK-NEXT:    mov r5, r2
; CHECK-NEXT:    ldr r2, [sp, #4] @ 4-byte Reload
; CHECK-NEXT:    lsll r0, r3, r4
; CHECK-NEXT:    lsrl r0, r3, #2
; CHECK-NEXT:    mul r2, r2, r10
; CHECK-NEXT:    adds r2, #2
; CHECK-NEXT:    lsll r0, r3, r2
; CHECK-NEXT:    ldr r2, [sp] @ 4-byte Reload
; CHECK-NEXT:    add.w r0, r0, #-2147483648
; CHECK-NEXT:    add.w r3, r12, #4
; CHECK-NEXT:    asrl r6, r1, r0
; CHECK-NEXT:    movs r0, #2
; CHECK-NEXT:    lsrl r6, r1, #2
